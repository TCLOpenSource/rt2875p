...
#define flush_cache_all() // RTK_FIXME_64

#if IS_ENABLED(CONFIG_REALTEK_MEMORY_MANAGEMENT)
//RTK_FIXME_64 : dmac_flush_range, dmac_inv_range
#define dmac_flush_range(a, b)    __flush_dcache_area((void *)(a), (size_t)((unsigned long)(b) - (unsigned long)(a)))
#define dmac_inv_range(a, b)      __inval_dcache_area((void *)(a), (size_t)((unsigned long)(b) - (unsigned long)(a)))
