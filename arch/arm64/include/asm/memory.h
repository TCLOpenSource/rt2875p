...
// RTK_FIXME_64 : EARLYCON_IOBASE(added), PCI_IO_END(modified), EARLYCON_END(added)
//#define EARLYCON_IOBASE     (VMEMMAP_START - SZ_4M)
#define RBUS_PHYADDR        (UL(0x18000000))
#define RBUS_LENGTH         (UL(0x00200000))
#define RBUS_VIRTOFFSET     (UL(0xffffffff00000000))
#define EARLYCON_IOBASE  	(RBUS_VIRTOFFSET + RBUS_PHYADDR)
#define EARLYCON_END  	    (EARLYCON_IOBASE + RBUS_LENGTH)
