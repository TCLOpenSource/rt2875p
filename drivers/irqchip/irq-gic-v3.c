...
struct gic_chip_data {
	...
	// RTK_FIXME_64 : added, to save and restore the context of GIC
...
// RTK_FIXME_64 : remove __init annotation
static void gic_dist_init(void)
{
	...
	/* FIXME KTASKWBS-19462 :
	 *    skip forcing affinity to boot CPU.
	 *    becuase some SPIs need to go to Audio ARM core.
	 */
#if 0
			    ...
			    bool force)
{
	...
	/* [KTASKWBS-19626] : for 1 of N distribution */
...
#ifdef CONFIG_CPU_PM
// RTK_FIXME_64 : added, gic_cpu_save, gic_cpu_restore, gic_dist_save, gic_dist_restore
//                to save and restore the context of GIC
...
{
	// RTK_FIXME_64 : modified and added, for save and restore the context of GIC
	if (cmd == CPU_PM_EXIT) {
...
{
	// RTK_FIXME_64 : added saved_ppi_register
