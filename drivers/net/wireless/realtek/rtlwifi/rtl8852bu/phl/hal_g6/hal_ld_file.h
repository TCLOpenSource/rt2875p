...
enum _halrf_pw_lmt_regulation_type {
	...
	_PW_LMT_REGU_CHILE = REGULATION_MAX + TPO_CHILE,
	_PW_LMT_REGU_MEX = REGULATION_MEX,
	_PW_LMT_REGU_UKRAINE = REGULATION_MAX + TPO_UKRAINE,
	_PW_LMT_REGU_CN = REGULATION_MAX + TPO_CN,
	_PW_LMT_REGU_QATAR = REGULATION_MAX + TPO_QATAR,
