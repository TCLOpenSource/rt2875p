		...
		struct rtw_para_pwrlmt_info_t *para_info)
{
	...
	else if (_os_strncmp((char *)sregulation, (const char *)"NCC", 3) == 0)
		regulation = _PW_LMT_REGU_NCC;
	else if (_os_strncmp((char *)sregulation, (const char *)"CHILE", 5) == 0)
		regulation = _PW_LMT_REGU_CHILE;
	else if (_os_strncmp((char *)sregulation, (const char *)"MAXICO", 6) == 0)
		regulation = _PW_LMT_REGU_MEX;
	else if (_os_strncmp((char *)sregulation, (const char *)"UKRAINE", 7) == 0)
		regulation = _PW_LMT_REGU_UKRAINE;
	else if (_os_strncmp((char *)sregulation, (const char *)"CN", 2) == 0)
		regulation = _PW_LMT_REGU_CN;
	else if (_os_strncmp((char *)sregulation, (const char *)"QATAR", 5) == 0)
		regulation = _PW_LMT_REGU_QATAR;
	else {
