...
#include "rtk_cec_debug.h"
#include "rtk_cm_buff.h"

extern struct bus_type rtk_cec_bus_type;
...
#define PBYTES              unsigned int
#else
#define PBYTES              unsigned char *
#endif
...
typedef struct {
    ...
    int (*set_cec_hotplug) (cec_device *dev, unsigned long onoff);
    int (*set_cec_global_interrupt)(cec_device *dev, unsigned long onoff);
    int (*suspend) (cec_device *dev);
    int (*resume) (cec_device *dev);
    int (*set_timing)(cec_device *dev, unsigned char *name, unsigned int value);
    int (*get_timing)(cec_device *dev, unsigned char *name, unsigned int *p_value);
