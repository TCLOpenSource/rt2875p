/*************************************************************************
	> File Name: rtk_mmc_6702.h
	> Author: bennychen
	> Mail: bennytschen@realtek.com
	> Created Time: Wed, 26 May 2021 13:32:11 +0800
 ************************************************************************/
#ifndef _RTK_MMC_6702_H_
#define _RTK_MMC_6702_H_
...
#define RTK_IOPAD_CFG1          (PINMUX_EMMCCLK_CFG_0_reg)  //EMMCCLK_CFG_0
#define RTK_IOPAD_CFG2          (PINMUX_EMMC_CFG_0_reg)  //EMMC_CFG_0
#define RTK_IOPAD_CFG3          (PINMUX_EMMC_CFG_1_reg)  //EMMC_CFG_1

#define RTK_IOPAD_SET1          (PINMUX_EMMCCLK_EXTRACFG_NP4E_0_reg)  //EMMCCLK_EXTRACFG_NP4E_0
#define RTK_IOPAD_SET2          (PINMUX_EMMC_EXTRACFG_NP4E_0_reg)  //EMMC_EXTRACFG_NP4E_0
#define RTK_IOPAD_SET3          (PINMUX_EMMC_EXTRACFG_NP4E_1_reg)  //EMMC_EXTRACFG_NP4E_1
#define RTK_IOPAD_SET4          (PINMUX_EMMC_EXTRACFG_NP4E_2_reg)  //EMMC_EXTRACFG_NP4E_2
...
#define RTK_WRAP_MBIST          (EMMC_WRAP_emmc_wrap_bist_and_emmc_ip_bist_reg)  //EMMC_WRAP_emmc_wrap_bist_and_emmc_ip_bist_reg
#define RTK_WRAP_MBIST_LS_SHIFT (EMMC_WRAP_emmc_wrap_bist_and_emmc_ip_bist_emmc_wrap_ls_shift)  //EMMC_WRAP_emmc_wrap_bist_and_emmc_ip_bist_emmc_wrap_ls_mask
#define RTK_WRAP_MBIST_LS_MASK  (EMMC_WRAP_emmc_wrap_bist_and_emmc_ip_bist_emmc_wrap_ls_mask>>RTK_WRAP_MBIST_LS_SHIFT)  //EMMC_WRAP_emmc_wrap_bist_and_emmc_ip_bist_emmc_wrap_ls_mask
...
#define RTK_EMMC_33V_SEL        PINMUX_emmc_33v_sel_reg
