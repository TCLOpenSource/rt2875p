...
#define RTK_WRAP_MBIST          (EMMC_WRAP_emmc_wrap_bist_reg)  //emmc_wrap_bist
#define RTK_WRAP_MBIST_LS_SHIFT (EMMC_WRAP_emmc_wrap_bist_emmc_wrap_ls_shift)  //emmc_wrap_bist
#define RTK_WRAP_MBIST_LS_MASK  (EMMC_WRAP_emmc_wrap_bist_emmc_wrap_ls_mask>>RTK_WRAP_MBIST_LS_SHIFT)  //emmc_wrap_bist
