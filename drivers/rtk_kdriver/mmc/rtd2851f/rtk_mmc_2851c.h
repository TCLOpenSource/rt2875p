...
//#define MIS_PINMUX_BASE     (PINMUX_GPIO_TLEFT_CFG_0_reg)	//PINMUX_MAIN_GPIO_TLEFT_CFG_0_reg
#define MIS_PINMUX_BASE     (PINMUX_MAIN_GPIO_TLEFT_CFG_0_reg)
...
#define ISO_PINMUX_BASE     (PINMUX_MAIN_ST_GPIO_ST_CFG_0_reg)
