...
#define EM_CLK_OUT_DELAY             EM_INT_DUMMY0
...
#define PS_SCPU_STOP                   BIT(2)
#define PS_SCPU_STATUS                 BIT(1)
#define PS_SCPU_SEL                    BIT(0)

//EM_INT_STATUS             //0x18010804
#define PS_DMA_RD_DONE_S               BIT(2)
#define PS_DMA_WR_DONE_S               BIT(1)
#define PS_STOP_BY_KCPU_FORCE_S        BIT(0)

//EM_INT_MASK               //0x18010808
#define PS_DMA_RD_DONE_MASK_S          BIT(2)
#define PS_DMA_WD_DONE_MASK_S          BIT(1)
#define PS_STOP_BY_KCPU_FORCE_MASK_S   BIT(0)

//EM_CLK_OUT_DELAY          //0x1801080C
#define CLK_OUT_DELAY_EN               BIT(8)

//EM_KCPU_SEL               //0x18010810
#define PS_KCPU_FORCE_EN               BIT(3)
#define PS_PROTECT_ADDR_EN             BIT(2)
#define PS_KCPU_STATUS                 BIT(1)
#define PS_KCPU_SEL                    BIT(0)

//EM_INT_STATUS_KCPU        //0x1801081C
#define PS_DMA_RD_DONE_K               BIT(2)
#define PS_DMA_WR_DONE_K               BIT(1)
#define PS_PROTECT_HIT_K               BIT(0)

//EM_INT_MASK_KCPU          //0x18010820
#define PS_DMA_RD_DONE_MASK_K          BIT(2)
#define PS_DMA_WR_DONE_MASK_K          BIT(1)
#define PS_PROTECT_HIT_MASK_K          BIT(0)

//EM_WARP_CTRL              //0x18010830
#define PS_CP_BLK_LEN_SHT              (16)
#define PS_CP_BLK_LEN_MASK             (0x7FFFUL<<CP_BLK_LEN_SHT)
#define PS_CP_MODE_EN                  BIT(15)
#define PS_CCLK_IN_SAMPLE_EXT_SEL      BIT(13)
#define PS_CCLK_IN_SAMPLE_EXT_EN       BIT(12)
#define PS_ECO_OPTION0_DIS             BIT(11)
#define PS_M_HBIG_ENDIAN               BIT(10)
#define PS_S_HBIG_ENDIAN               BIT(9)
#define PS_CCLK_OUT_SRC_SEL            BIT(8)
#define PS_WARP_VERSION                BIT(7)
#define PS_DEBUG_MUX_SHT               (1)
#define PS_DEBUG_MUX_MASK              (0x3FUL<<DEBUG_MUX_SHT)
#define PS_DEBUG_CTRL                  BIT(0)

//EM_WARP_STATUS0           //0x18010834
#define PS_REAL_DUMMY0_SHT             (16)
#define PS_REAL_DUMMY0_MASK            (0xFFFFUL<<REAL_DUMMY0_SHT)
#define PS_RBUS_ERR                    BIT(2)
#define PS_DBUS_DMA_BUSY               BIT(1)
#define PS_DBUS_WRITE_FLAG             BIT(0)
...
#define PS_RTK_HS400                   BIT(23)
#define PS_RTK_HS200_POS               BIT(22)
#define PS_RTK_HS200                   BIT(21)
#define PS_BYPASS_DS_TUNE              BIT(20)
#define PS_BYPASS_DS_PH_SEL_SHT        (15)
#define PS_BYPASS_DS_PH_SEL_MASK       (0x1FUL<<BYPASS_DS_PH_SEL_SHT)
#define PS_RW_CNT_RESET                BIT(14)
#define PS_WR_ADR_P_0_TRAN_SEL         BIT(13)
#define PS_RW_CNT_REF_ALIGN_EN         BIT(12)
#define PS_FW_SET_PLUSE                BIT(9)
...
#define PS_SYNC_CAL_DLYN               BIT(2)
#define PS_AUTO_CAL                    BIT(1)
#define PS_DQS_DEL_OFFST_EN            BIT(0)
...
#define PS_CPMASK_SEL                  BIT(0)

//EM_HALF_CYCLE_CAL_EN      //0x1801108C
#define PS_FW_MODE                     BIT(18)
#define PS_HALH_CYCLE_CAL_SEL          BIT(17)
...
#define PS_HALH_CYCLE_CAL_EN           BIT(0)
...
#define SDMMC_CTRL_OD_PULLUP_EN     BIT(24)
...
#define SDMMC_CMD_USE_HREG		BIT(29)
...
#define SDMMC_DAT0_BUSY         BIT(9)   //1: card busy; 0: card not busy;
...
#define SDMMC_DE            BIT(7)
#define SDMMC_FB            BIT(1)
#define SDMMC_SWR           BIT(0)
