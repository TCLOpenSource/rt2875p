...
static const MODULE_INFO module_info[] =
{
	...
	MODULE_STR(TVSB2_SNR),
	MODULE_STR(TVSB2_IPQMASK),
...
//	{MODULE_SB1_USB,        "SB1_USB"},
	...
	MODULE_STR(SB1_SSB1_NAG_DMA_KC),
	MODULE_STR(SB1_SSB1_NF_KC),
	MODULE_STR(SB1_SSB1_TP2_KC),
	MODULE_STR(SB1_SSB1_TP_KC),
	MODULE_STR(SB1_SSB1_NAG_DMA_NKC),
	MODULE_STR(SB1_SSB1_NF_NKC),
	MODULE_STR(SB1_SSB1_TP2_NKC),
	MODULE_STR(SB1_SSB1_TP_NKC),
	MODULE_STR(SB1_SSB1_NAG_DMA_PB),
	MODULE_STR(SB1_SSB1_TP2_PB),
	MODULE_STR(SB1_SSB1_TP_PB),
	MODULE_STR(SB1_SSB1),
	...
	MODULE_STR(TVSB3_HEVC_EN),
	MODULE_STR(TVSB3_VP8ENC),

	{MODULE_TVSB3,  "TVSB3"},

	{MODULE_GPU_NONK,       "GPU_NONK"},
	{MODULE_GPU_KCPU,       "GPU_KCPU"},
...
//	{MODULE_TVSB5_USB3,     "TVSB5_USB3"},
	...
	MODULE_STR(TVSB4_SRNN_3DLUT_R),
	MODULE_STR(TVSB4_M_CAP),
	MODULE_STR(TVSB4_M_DISP),
	MODULE_STR(TVSB4_S_CAP),
	MODULE_STR(TVSB4_M_DISP),
	MODULE_STR(TVSB4),

	{MODULE_MEMC_ME_W,      		"MEMC_ME_W"},
	{MODULE_MEMC_ME_R,      		"MEMC_ME_R"},
	 MODULE_STR(MEMC_KMC_W0),
	 MODULE_STR(MEMC_KMC_W1),
	 MODULE_STR(MEMC_KMC_R0),
	 MODULE_STR(MEMC_KMC_R1),
	 MODULE_STR(MEMC_KMC_R2),
	 MODULE_STR(MEMC_KMC_R3),
	 MODULE_STR(MEMC_KME_W1),
	 MODULE_STR(MEMC_KME_R1),
	 MODULE_STR(MEMC_MVINFO_W),
	 MODULE_STR(MEMC_MVINFO_R),
	 MODULE_STR(MEMC_KMC_W3),
	 MODULE_STR(MEMC_KMC_R4),
	 MODULE_STR(MEMC_KMC_R5),
