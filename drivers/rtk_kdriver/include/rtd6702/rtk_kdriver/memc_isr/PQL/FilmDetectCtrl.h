...
typedef struct  
{
	...
	unsigned char u1_YT_resize_chg_flg;
	unsigned char u1_YT_resize_chg_status;
	unsigned char u1_hdmi_gamemode_chg_flg;
	unsigned char u1_hdmi_gamemode_chg_status;
