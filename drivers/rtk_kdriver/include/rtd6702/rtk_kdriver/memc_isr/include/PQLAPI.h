...
typedef enum
{
	...
	_PQL_IN_3840x540,
	_PQL_IN_1920x2160,
	_PQL_IN_768x480,						///< 768X480 resolution for FPGA Validation
	_PQL_IN_1280x720,						///< 1280X720 resolution for FPGA Validation
	_PQL_IN_7680x4320,					///< 7680X4320 resolution 
...
typedef enum
{
	...
	_PQL_OUT_3840x1080,
	_PQL_OUT_3840x540,
	_PQL_OUT_768x480,						///< 768X480 resolution for FPGA Validation
	_PQL_OUT_1280x720,						///< 1280X720 resolution for FPGA Validation
	_PQL_OUT_7680x4320,					///< 7680X4320 resolution 
