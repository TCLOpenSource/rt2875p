...
#define DEMOD_CARVED_OUT 0x02000000  //compatible for previous released version.
    ...
    //? can all these get from carvedout_buf?

    //? It's checked if (KMEMC_TOTAL_SIZE > SCALER_MEMC_SIZE) then #error in scalerDrvCommon.h
    //?  but the real one is with different name per layout. (e.g. 'DISP_8K_'SCALER_MEMC_SIZE vs SCALER_MEMC_SIZE).
    //? The real is supposed to get by calling carvedout_buf_query( ) if necessary.
    #define SCALER_MEMC_SIZE 0 //(87*_MB_) // test if the reference is meaningless

#else // no RTK_MEM_LAYOUT_DEVICETREE
...
#define VBM_START_ADDRESS_KERNEL       0x20000000  // + c800000 (+ 200M)
#define MEMC_START_ADDRESS_KERNEL      0x2c800000  // + 5700000 (+  87M)
#define MDOMAIN_START_ADDRESS_KERNEL   0x31f00000  // + 0d00000 (+  13M)
#define DI_NR_START_ADDRESS_KERNEL     0x32c00000  // + 0d00000 (+  13M)
#define VIP_START_ADDRESS_KERNEL       0x33900000  // + 0200000 (+   2M)
#define OD_START_ADDRESS_KERNEL        0x33b00000  // + 0400000 (+   4M)
#define NN_START_ADDRESS_KERNEL        0x33f00000  // + 0100000 (+   1M)
#define TP_START_ADDRESS_KERNEL        0x34000000  //
...
#define SCALER_MEMC_SIZE (87*_MB_)
...
#define SCALER_MDOMAIN_SIZE (13*_MB_) // 13MB for 2K FRC, 37MB if 4K FRC is needed
...
#define DEMUX_TP_BUFFER_SIZE 24*_MB_  // must be 4MB page block alignment
#else
...
#define DDR_1G5_VIP_START_ADDRESS_KERNEL       0x32900000  // + 0200000 (+   2M)
#define DDR_1G5_OD_START_ADDRESS_KERNEL        0x32b00000  // + 0400000 (+   4M)
...
#define DDR_1GB_VIP_START_ADDRESS_KERNEL       0x27a00000  // + 0200000 (+   2M)
#define DDR_1GB_OD_START_ADDRESS_KERNEL        0x27c00000  // + 0400000 (+   4M)
...
#define DISP_8K_VBM_START_ADDRESS_KERNEL       0x20000000  // + 24000000 (+ 576 M)
#define DISP_8K_MEMC_START_ADDRESS_KERNEL      0x44000000  // + 15100000 (+ 337 M)
#define DISP_8K_MDOMAIN_START_ADDRESS_KERNEL   0x59100000  // + 14300000 (+ 323 M)
#define DISP_8K_DI_NR_START_ADDRESS_KERNEL     0x6d400000  // +  3400000 (+  52 M)
#define DISP_8K_VIP_START_ADDRESS_KERNEL       0x70800000  // +  0800000 (+   8 M)
#define DISP_8K_OD_START_ADDRESS_KERNEL        0x71000000  // +  1100000 (+  17 M)
#define DISP_8K_NN_START_ADDRESS_KERNEL        0x72100000  // +  0400000 (+   4 M)
#define DISP_8K_TP_START_ADDRESS_KERNEL        0x72800000  // +  1800000 (+  24 M)
...
#define DISP_8K_VDEC_BUFFER_SIZE 576*_MB_    // 8K decode (chroma/luma all 60%, 13 frame 498 MB + more 2 occupied frames 38.25x2, and need 4MB aligned
...
#define DISP_4K_VIP_START_ADDRESS_KERNEL       0x4d900000  // +  0200000 (+   2 M)
#define DISP_4K_OD_START_ADDRESS_KERNEL        0x4db00000  // +  0400000 (+   4 M)
...
#define DISP_4K_SCALER_VIP_SIZE  (2*_MB_)
...
#define DISP_4K_SCALER_OD_SIZE  4*_MB_
...
#define M7_8K_MDOMAIN_START_ADDRESS_KERNEL   0x48000000  // +  0d00000 (+  13 M)
#define M7_8K_DI_NR_START_ADDRESS_KERNEL     0x48d00000  // +  0d00000 (+  13 M)
#define M7_8K_VIP_START_ADDRESS_KERNEL       0x49a00000  // +  0200000 (+   2 M)
#define M7_8K_OD_START_ADDRESS_KERNEL        0x49c00000  // +  0400000 (+   4 M)
#define M7_8K_NN_START_ADDRESS_KERNEL        0x4a000000  // +        0 (+   0 M)
#define M7_8K_TP_START_ADDRESS_KERNEL        0x4a000000  // +  1800000 (+  24 M)
...
#define M7_8K_SCALER_VIP_SIZE  (2*_MB_)
...
#define M7_8K_SCALER_OD_SIZE  4*_MB_
...
#define M7_8K_VIP_START_ADDRESS_KERNEL       0x43100000  // +  0200000 (+   2 M)
#define M7_8K_OD_START_ADDRESS_KERNEL        0x43300000  // +  0400000 (+   4 M)
...
#define CMA_HIGHMEM_LARGE 640*_MB_
