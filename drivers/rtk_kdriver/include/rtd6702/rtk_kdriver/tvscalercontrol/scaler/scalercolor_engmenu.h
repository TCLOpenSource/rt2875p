...
typedef enum _HAL_VPQ_AI_ID_NUM
{
	HAL_VPQ_ENG_AI_FACE_MODE = 0,
	HAL_VPQ_ENG_AI_SQM_MODE,
	HAL_VPQ_ENG_AI_SCENE_MODE,
	HAL_VPQ_AI_ID_MAX_NUM,
}HAL_VPQ_AI_ID_NUM;
 ...
 * Structure
 ******************************************************************************/
#define HAL_VPQ_ENG_ID_MAX_NUM (HAL_VPQ_Coef_ID_MAX_NUM+HAL_VPQ_Extend_Coef_ID_MAX_NUM+HAL_VPQ_OTHER_ID_MAX_NUM+HAL_VPQ_HDR_ID_MAX_NUM+HAL_VPQ_AI_ID_MAX_NUM)
