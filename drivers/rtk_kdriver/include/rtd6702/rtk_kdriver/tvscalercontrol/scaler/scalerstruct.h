...
#if 1 // #ifdef H5X_HDMITX_FIXME
	SLR_INPUT_PIXEL_CLOCK,
	SLR_INPUT_RGB_QUANTIZATION_RANGE,
	SLR_INPUT_YCC_QUANTIZATION_RANGE,
	SLR_INPUT_EXT_COLORIMETRY,
	SLR_INPUT_CLK_4PIXEL_MODE,
