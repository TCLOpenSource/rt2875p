...
#define VIP_DMAto3DTable_TC_LUT_and_SIP1_and_SLC_SIZE (100 * 1024)	//  SIP1 : table0_bitwidth * table0_num_x = 0x6000 * 0x20 = 786432, "coef1.tbl" = 0x8190000~0x81A7FFC
...
typedef enum _VIP_DMAto3DTABLE_INDEX {
	...
	DMAto3DTABLE_SLC = DMAto3DTABLE_SIP_1,
...
void fwif_color_Set_NN_SRCtrl(unsigned char Index );
