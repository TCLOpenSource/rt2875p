...
#if 1//juwen, tc v140
typedef struct _sl_hdr_metadata_variables_140 {
...
}sl_hdr_metadata_variables_140;

typedef struct _sl_hdr_metadata_tables {
...
typedef struct _SL_HDR_metadata_140 {
  int partID;
  int majorSpecVersionID;
  int minorSpecVersionID;
  int payloadMode;
 ...
 union
  {
     sl_hdr_metadata_variables_140 variables;
     //sl_hdr_metadata_tables_140 tables;
  } u;
}SL_HDR_metadata_140;
...
//FW ctrl items--------------------------------------------------------
typedef enum _VIP_TC_HDR_PROC_MODE_ITEMS {
	TC_Proc_Mode_Unknow = 0,
	TC_Proc_Mode_HDR,
	TC_Proc_Mode_SDR,

	TC_HDR_PROC_MODE_MAX

} VIP_TC_HDR_PROC_MODE_ITEMS;

typedef enum _VIP_TC_HDR_YUV_RANGE_ITEMS {
	TC_YUV_Range_Limit = 0,
	TC_YUV_Range_Full,

	TC_YUV_Range_Mode_MAX

} VIP_TC_HDR_YUV_RANGE_ITEMS;
...
typedef struct _VIP_TC_HDR_DMA_CTRL {
	unsigned int size;
...
typedef struct _DRV_TC_HDR_CTRL {
	...
	VIP_TC_HDR_DMA_CTRL C_LUT_DMA;
	VIP_TC_HDR_DMA_CTRL I_LUT_DMA;
	VIP_TC_HDR_DMA_CTRL S_LUT_DMA;
	VIP_TC_HDR_DMA_CTRL P_LUT_DMA;
	VIP_TC_HDR_DMA_CTRL D_LUT_DMA;
...
char drvif_color_set_TC_Write_C_LUT_By_DMA(unsigned short *d_lut_coef_ptr, unsigned int addr, unsigned int* vir_addr);
char drvif_color_set_TC_Write_P_LUT_By_DMA(unsigned short *d_lut_coef_ptr, unsigned int addr, unsigned int* vir_addr);
char drvif_color_set_TC_Write_I_LUT_By_DMA(unsigned short *d_lut_coef_ptr, unsigned int addr, unsigned int* vir_addr);
char drvif_color_set_TC_Write_S_LUT_By_DMA(unsigned short *d_lut_coef_ptr, unsigned int addr, unsigned int* vir_addr);
