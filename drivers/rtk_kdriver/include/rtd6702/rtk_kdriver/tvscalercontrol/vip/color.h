...
/*h5x, txsoc*/
#define _txsoc_m11							0x00
#define _txsoc_m12							0x01
#define _txsoc_m13							0x02
#define _txsoc_m21							0x03
#define _txsoc_m22							0x04
#define _txsoc_m23							0x05
#define _txsoc_m31							0x06
#define _txsoc_m32							0x07
#define _txsoc_m33							0x08
#define _txsoc_Yo							    0x09
#define _txsoc_Y_gain						0x0a
#define _txsoc_sel_RGB						0x0b
#define _txsoc_set_Yin_offset				0x0c
#define _txsoc_set_UV_out_offset		    0x0d
#define _txsoc_sel_UV_off					0x0e
#define _txsoc_Matrix_bypass				0x0f
#define _txsoc_Enable_Y_gain				0x10
#define _txsoc_2x_gain						0x11
#define _txsoc_rgb_in_offset				0x12
#define _txsoc_rgb_sel_sign					0x13
...
typedef struct{
// HDR 2
/*0*/	HDR_IP_ctrl_bits Gamma1_ctrl;
/*1*/	unsigned int Gamma1_table;
/*2*/	HDR_IP_ctrl_bits Color_Mapping_ctrl;
/*3*/	unsigned char Color_Mapping_value;
/*4*/	HDR_IP_ctrl_bits Gamma2_ctrl;
/*5*/	unsigned char Gamma2_table;
// HDR 1_2
/*6*/	HDR_IP_ctrl_bits CSC3_ctrl;
/*7*/	unsigned char CSC3_table;
/*8*/	HDR_IP_ctrl_bits HDR_33_1_ctrl;
/*9*/	unsigned char HDR_33_1_SPtable; 	/*define special index: HFC_RGB2OPT_OFF*/
/*10*/	HDR_IP_ctrl_bits HDR_33_2_ctrl;
/*11*/	unsigned char HDR_33_2_table;
/*12*/	HDR_IP_ctrl_bits EOTF_ctrl;
/*13*/	unsigned char EOTF_SPtable; 		/*define special index: HFC_EOTF_OFF*/
/*14*/	HDR_IP_ctrl_bits OETF_ctrl;
/*15*/	unsigned char OETF_SPtable; 		/*define special index: HFC_OETF_CTRL_BY_MAXCLL, HFC_OETF_OFF*/
/*16*/	HDR_IP_ctrl_bits tone_mapping_ctrl;
/*17*/	unsigned char tone_mapping_table;
/*18*/	HDR_IP_ctrl_bits DM2_gamma_ctrl;
/*19*/	unsigned char DM2_gamma_enable;
/*20*/	HDR_IP_ctrl_bits CSC3_INDEX_ctrl;
/*21*/	unsigned char CSC3_INDEX_table;

} HDR_sub_flow_control;
...
typedef enum _HDR_sub_flow_control_timing {
	HFC_HDR_sub_SDR = 0,
	HFC_HDR_sub_MAX_RGB,
	HFC_HDR_sub_HDR10,
	HFC_HDR_sub_HLG,

	HFC_HDR_sub_TIMING_NUM,
} HDR_sub_flow_control_timing;
...
typedef enum TXSOC_RGB2YUV_COEF_MATRIX_MODE {
	TXSOC_RGB2YUV_COEF_BYPASS_NORMAL_GAIN = 0,
	TXSOC_RGB2YUV_COEF_BYPASS_0_255_TO_16_235,
	TXSOC_RGB2YUV_COEF_RGB_0_255_TO_YCC601_16_235,
	TXSOC_RGB2YUV_COEF_RGB_16_235_TO_YCC601_16_235,
	TXSOC_RGB2YUV_COEF_RGB_0_255_TO_YCC709_16_235,
	TXSOC_RGB2YUV_COEF_RGB_16_235_TO_YCC709_16_235,
	TXSOC_RGB2YUV_COEF_RGB_0_255_TO_YCC709_0_255,
	TXSOC_RGB2YUV_COEF_TV006_YPP_LOW,
	TXSOC_RGB2YUV_COEF_RGB_0_255_TO_YCC2020_16_235,
	TXSOC_RGB2YUV_COEF_RGB_0_255_TO_YCC2020_0_255,
	TXSOC_RGB2YUV_COEF_YCC601_0_255_TO_YCC709_0_255,
	TXSOC_RGB2YUV_COEF_YCC2020_16_235_TO_YCC709_16_235,
	TXSOC_RGB2YUV_COEF_YCC2020_0_255_TO_YCC709_16_235,
	TXSOC_RGB2YUV_COEF_MATRIX_MODE_Max,
} TXSOC_RGB2YUV_COEF_MATRIX_MODE;


typedef enum TXSOC_RGB2YUV_COEF_MATRIX_ITEMS {
	TXSOC_M11=0,
	TXSOC_M12,
	TXSOC_M13,
	TXSOC_M21,
	...
	TXSOC_Y_GAIN	,
	TXSOC_SEL_RGB,
	TXSOC_SET_YIN_OFFSET,
	TXSOC_SET_UV_OUT_OFFSET	,
	TXSOC_SEL_UV_OFF,
	TXSOC_MATRIX_BYPASS,
	TXSOC_ENABLE_Y_GAIN,
	TXSOC_2X_GAIN		,
	TXSOC_RGB_IN_OFFSET,
	TXSOC_RGB_SEL_SIGN	,
	TXSOC_RGB2YUV_COEF_MATRIX_ITEMS_MAX,
} TXSOC_RGB2YUV_COEF_MATRIX_ITEMS;
...
/* Mark2 use frame_burst_num */
// Mark2 frame_burst_num= ceil(frame table total bits/128)
// frame_size=frame_burst_num*128/8
// 3 plane: 
// 241x136: Y: ceil(242*136*3*1/7)=14106; RGB: ceil(242*136*3*3/7)=42316
// 481x271: Y: ceil(482*271*3*1/7)=55981; RGB: ceil(482*271*3*3/7)=167943
// 4 plane: 
// 241x136: Y: ceil(242*136*4*1/5)=26330; RGB: ceil(242*136*4*3/5)=78989
// 481x271: Y: ceil(482*271*4*1/5)=104498; RGB: ceil(482*271*4*3/5)=313493
// 5 plane: 
// 241x136: Y: ceil(242*136*5*1/4)=41140; RGB: ceil(242*136*5*3/4)=123420
// 481x271: Y: ceil(482*271*5*1/4)=163278; RGB: ceil(482*271*5*3/4)=489833
#define VIP_DemuraTBL_frame_burst_num_Y_481x271_3Plane 18661
#define VIP_DemuraTBL_frame_burst_num_Y_481x271_4Plane 26125
#define VIP_DemuraTBL_frame_burst_num_Y_481x271_5Plane 32656
#define VIP_DemuraTBL_frame_burst_num_Y_241x136_3Plane 4702
#define VIP_DemuraTBL_frame_burst_num_Y_241x136_4Plane 6583
#define VIP_DemuraTBL_frame_burst_num_Y_241x136_5Plane 8228
#define VIP_DemuraTBL_frame_burst_num_RGB_481x271_3Plane 55981
#define VIP_DemuraTBL_frame_burst_num_RGB_481x271_4Plane 78374
#define VIP_DemuraTBL_frame_burst_num_RGB_481x271_5Plane 97967
#define VIP_DemuraTBL_frame_burst_num_RGB_241x136_3Plane 14106
#define VIP_DemuraTBL_frame_burst_num_RGB_241x136_4Plane 19748
#define VIP_DemuraTBL_frame_burst_num_RGB_241x136_5Plane 24684

#define VIP_DemuraTBL_frame_burst_num_12bit_Y_481x271_3Plane 37244
#define VIP_DemuraTBL_frame_burst_num_12bit_Y_481x271_4Plane 52141
#define VIP_DemuraTBL_frame_burst_num_12bit_Y_481x271_5Plane 65176
#define VIP_DemuraTBL_frame_burst_num_12bit_Y_241x136_3Plane 9365
#define VIP_DemuraTBL_frame_burst_num_12bit_Y_241x136_4Plane 13111
#define VIP_DemuraTBL_frame_burst_num_12bit_Y_241x136_5Plane 16388
#define VIP_DemuraTBL_frame_burst_num_12bit_RGB_481x271_3Plane 111730
#define VIP_DemuraTBL_frame_burst_num_12bit_RGB_481x271_4Plane 156422
#define VIP_DemuraTBL_frame_burst_num_12bit_RGB_481x271_5Plane 195527
#define VIP_DemuraTBL_frame_burst_num_12bit_RGB_241x136_3Plane 28094
#define VIP_DemuraTBL_frame_burst_num_12bit_RGB_241x136_4Plane 39332
#define VIP_DemuraTBL_frame_burst_num_12bit_RGB_241x136_5Plane 49164
...
typedef struct  _DRV_DeMura_CTRL_TBL {
	...
	unsigned char demura_block_size; 			// demura block size, 0: 8x8, 1: 16x16, 2: 4x4, 3: set H and V block size sepereately
	unsigned char demura_table_mode; 			// 0: 241x136, 1: 481x271
	unsigned char demura_block_size_v;			// 0: 8, 1: 16, 2: 4
	unsigned char demura_block_size_h;			// 0: 8, 1: 16, 2: 4
	unsigned char demura_12bitmode_en;		// BOE 12bit mode
	...
	*/
	...
	//Mark2 add, demura table gain and offset
	//R channel
...
typedef struct  _DRV_DeMura_DMA_TBL {
	...
	unsigned int frame_burst_num; //mark2 add
	unsigned char table_decmp_en; //mark2 add
...
// unsigned char drvif_DM2_HDR_histogram_Get(unsigned int *histogram_table24);	// //reading process is controlled in isr, don;t access
...
//void drvif_DM2_HDR_Hist_Position(unsigned char hdr_hist_position);	//hdr_hist_position is controlled in isr, don;t access
