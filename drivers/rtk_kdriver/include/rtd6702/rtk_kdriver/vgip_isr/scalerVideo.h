...
/* 0*/ VD_STATUS_HIFREQ_NOT_SMALL = 0,
/* 1*/ VD_STATUS_HOR_C_CHANGE,
/* 2*/ VD_STATUS_TEMPORAL_SPD_SMALL,
/* 3*/ VD_STATUS_MGHF_FLAG,
/* 4*/ VD_STATUS_NOISE_VARIANCE_MEAN,
/* 5*/ VD_STATUS_NOISE_DENSITY,
/* 6*/ VD_STATUS_NOISE_LARGE_VARIANCE_MEAN,
       // VD firmware special flag
/* 7*/ VD_STATUS_SMD,                       // This flag is TRUE when SMD Flag = TRUE
/* 8*/ VD_STATUS_SMD_STRONG,                // This flag is TRUE when VD SMD Flag = TRUE
/* 9*/ VD_STATUS_SMD_IEGSM,                 // Preserved from before
/*10*/ VD_STATUS_MOVING_CAN                 // Preserved from before
} VD_STATUS;
...
typedef enum _VDPQ_AV_NTSC_APPLY_SET
{
  ...
  /* 13*/ VDPQ_NTSC_MOVING_CAN,                     // DOS[75]
  /* 14*/ VDPQ_NTSC_DEXC,                           // DOS Avoid DeXC TNRXC on still low frequency
  /* 15*/ VDPQ_NTSC_SMD_0,
  /* 16*/ VDPQ_NTSC_SMD_1,
  /* 17*/ VDPQ_NTSC_SMD_2,
  /* 18*/ VDPQ_NTSC_SUN_FLOWER_ROOF,                // DOS[5]
  /* 19*/ VDPQ_NTSC_STRONG_VD_SMD,
  /* 20*/ VDPQ_NTSC_SMD_IRON_TOWER,                 // DOS[39]
  /* 21*/ VDPQ_NTSC_MONO_HUE_AVOID_MOTION_BLUR,     // DOS[4][5]
  /* 22*/ VDPQ_NTSC_LOW_SAT_REMOVE_COLOR,
  /* 23*/ VDPQ_NTSC_XC_REDUCE_BY_C_BPF,             // DOS[40] dexc will make color boundary blur, change to use C mid BPF to remove XC
  /* 24*/ VDPQ_NTSC_HIGH_FREQ_LOW_SAT,              // DOS[41] and Multiburst-liked patterns have large DI high freq.
  /* 25*/ VDPQ_NTSC_2D3D_SWITCH,                    // DOS[42] background 2D to 3D convergence speed
  /* 26*/ VDPQ_NTSC_LOW_SAT_STILL,                  // DOS[38]
  /* 27*/ VDPQ_NTSC_DYNAMIC_HIGH_FREQ_LOW_SAT_Y,    // TG45 CZP, Horizontal motion, Y level < 65, keep clear
  /* 28*/ VDPQ_NTSC_DYNAMIC_HIGH_FREQ_LOW_SAT_XC,   // TG45 CZP, Horizontal motion, Y level < 65, remove cross color
  /* 29*/ VDPQ_NTSC_DYNAMIC_DIRECTIONAL_3D,			// DOS[75]
  /* 30*/ AV_NTSC_SETTING_END
...
typedef enum _VDPQ_FUNCTIONAL_APPLY_SET
{
  ...
  /*  3*/ VDPQ_FUNC_WRITE_ADAPTIVE_REG_VAL, // The case to write the register value
  /*  4*/ VDPQ_FUNC_AV_EXP,
  /*  5*/ VDPQ_FUNC_ATV_EXP,
  /*  6*/ FUNCTIONAL_SETTING_END,
  /*  7*/ VDPQ_SETTING_TBL_END
...
// void scalerVideo_Disable_DCrestore(void);//Mark unsed code
