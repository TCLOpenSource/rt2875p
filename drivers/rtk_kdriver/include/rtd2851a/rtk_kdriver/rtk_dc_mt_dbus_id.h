...
static const MODULE_INFO module_info[] =
{
    ...
    {MODULE_SB1_NF_KC,      "SB1_NF_KC"},
    {MODULE_SB1_NF_NKC,     "SB1_NF_NKC"},
    ...
    {MODULE_SB3_MD_KC,      "SB3_MD_KC"},
    {MODULE_SB3_UART_DMA,   "SB3_UART_DMA"},
    {MODULE_SB3_MD_NKC,     "SB3_MD_NKC"},
    {MODULE_SB3_MD_VC,      "SB3_MD_VC"},
    {MODULE_SB3,    "SB3"},
...
unsigned char key_table_usb[] = {MODULE_SB1_USB2};
unsigned char key_table_tp[] = {MODULE_SB1_TP_NKC,MODULE_SB1_TP_KC,MODULE_SB1_TP2_KC,MODULE_SB1_TP2_NKC};
...
unsigned char trap_table_kcputp[] = {MODULE_SB1_TP_KC,};
unsigned char trap_table_scputp[] = {MODULE_SB1_TP_NKC};
