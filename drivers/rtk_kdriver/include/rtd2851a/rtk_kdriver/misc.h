...
#define MISC_SET_DDR_SSC_PARAM    	_IOWR(MISC_IOC_MAGIC, 6,int)
...
#endif
#define MISC_GET_MODULE_TEST_PIN          _IOR(MISC_IOC_MAGIC, 15, int)
...
extern unsigned int rtk_dbg_atomic_inc_read(void);
extern unsigned int rtk_dbg_atomic_read(void);
extern void rtk_dbg_atomic_val_set(unsigned int val);
