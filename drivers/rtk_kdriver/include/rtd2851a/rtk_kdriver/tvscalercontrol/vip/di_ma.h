...
typedef struct {
	//unsigned char en; //mac6p removed
	unsigned char ratio;
...
typedef struct {
	...
	DRV_di_ma_hmc_blending_with_MA di_ma_hmc_blending_with_MA;		/* 4*/
} DRV_di_ma_hmc_table;
...
typedef struct {
	unsigned char ma_onedirectionweaveen;
	//unsigned char ma_preferintra; //mac6p removed
...
//void drvif_color_Set_di_FRZ_CNT_ISR(unsigned char display, unsigned char force_freeze);
