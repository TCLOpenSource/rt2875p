...
#define HDMI_4K120_QMS_ONLINE_ENABLE_MASK (_BIT4 | _BIT5 | _BIT10  | _BIT11 | _BIT13 | _BIT21 | _BIT22)//HDMI 4k120 QMS
...
#define HDMI_QMS_ONLINE_ENABLE_MASK	 (_BIT2 | _BIT4 | _BIT5 | _BIT8 | _BIT9 | _BIT11 | _BIT13 | _BIT21)//HDMI QMS
...
void set_scaler_run_hdmi_hfr_mode(unsigned char mode);//save last time run 4k120, we need reset setting at reset mode
