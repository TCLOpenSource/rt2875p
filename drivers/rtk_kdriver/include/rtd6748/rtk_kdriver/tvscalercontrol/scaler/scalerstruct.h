...
typedef struct _ModeInformationType{
	...
	unsigned int IHFreq;					// Input Horizontal Frequency
	unsigned int IVFreq;					// Input Vertical Frequency
...
{
	LIVE_ZOOM_OFF = 0,/*means livezoom and magnifier off*/
	LIVE_ZOOM_ON,/*means livezoom or magnifier on*/
} LIVE_ZOOM_TYPE_T;
...
#define VD_MOTION_STEP		8
 ...
 typedef struct{
    int ott_delay_frame[2]; //0: 24fps, 1:60fps
    int hdmi_delay_frame[2]; //0: 24fps, 1:60fps
}frame_delay_T;

typedef struct{
    unsigned int ui_0_adim;
    unsigned int ui_0_pdim;

    unsigned int ui_25_adim;
    unsigned int ui_25_pdim;

    unsigned int ui_50_adim;
    unsigned int ui_50_pdim;

    unsigned int ui_75_adim;
    unsigned int ui_75_pdim;

    unsigned int ui_100_adim;
    unsigned int ui_100_pdim;

    unsigned int ui_turnp_adim;
    unsigned int ui_turnp_pdim;
}ui_value_arr;


typedef struct{
    unsigned char ui_node_0;
    unsigned char ui_node_1;
    unsigned char ui_node_2;
    unsigned char ui_node_3;
    unsigned char ui_node_4;
    unsigned char ui_node_turnp;
}ui_node_arr;


typedef struct{
    unsigned int dm_node_0;
    unsigned int dm_node_1;
    unsigned int dm_node_2;
    unsigned int dm_node_3;
    unsigned int dm_node_4;
    unsigned int dm_node_turnp;
}dm_node_arr;
