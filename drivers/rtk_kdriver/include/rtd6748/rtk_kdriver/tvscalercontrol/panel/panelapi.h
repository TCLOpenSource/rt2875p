...
void Panel_TurnOn_By_KernelAp(unsigned int enable);
...
typedef enum {
    ...
    P_VBY1_4K2K,                //V By 1	 output 4k2k timing only	//Position cannot be replaced due to dependency on TCL panel.ini (index=1)
    P_VBY1_3K1K,                //V By 1	 output 3k1k timing only
...
typedef enum {
    ...
    VBY_ONE_PANEL_AUO_4K2K_144HZ_4S_16L,
    VBY_ONE_PANEL_KONKA_OLED_4K2K_120HZ_1S_16L,
    VBY_ONE_PANEL_HSR_4K2k120_4K1K240,
    VBY_ONE_PANEL_COMMERCIAL_4K2K_600M_1S_8L_DUPLICATE,
    VBY_ONE_PANEL_WQHD_165HZ_2S_16L,
    VBY_ONE_PANEL_HSR_4K2K60_4K1K120,
    VBY_ONE_PANEL_HSR_4K2K144_4K1K288,
	...
	/* VBY_ONE_OLED panel */
	VBY_ONE_OLED_PANEL_BEGIN=0x31,
	//VBY_ONE_OLED_PANEL_XX_YY_ZZ=0x31,

	VBY_ONE_OLED_PANEL_MAX=0x40, //if not enough, it can extend to 0x50


	VBY_ONE_PANEL_RTK_VB1_4K2K_TO_LVDS=61,
