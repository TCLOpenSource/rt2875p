...
#define MODULE_VE_CMP           		MODULE_ID(0x5 ,0xf)
...
#define MODULE_TVSB3_SETFBC0_R_Q0                        MODULE_ID(0x6 ,8)
#define MODULE_TVSB3_SETFBC0_R_Q1                        MODULE_ID(0x6 ,9)
#define MODULE_TVSB3_SETFBC1_R_Q0                        MODULE_ID(0x6 ,0xa)
#define MODULE_TVSB3_SETFBC1_R_Q1                        MODULE_ID(0x6 ,0xb)
#define MODULE_TVSB3									 MODULE_ID(0x6 ,0xf)	

#define MODULE_GPU_KC                       	MODULE_ID(0x7 ,0)
#define MODULE_GPU_NKC_VB                       MODULE_ID(0x7 ,1)
#define MODULE_GPU_10                       	MODULE_ID(0x7 ,2)
#define MODULE_GPU_11                       	MODULE_ID(0x7 ,3)
#define MODULE_GPU_NKC_VA			MODULE_ID(0x7 ,8)
...
#define MODULE_VE2_VM2          				MODULE_ID(0xa ,1)
#define MODULE_VE2_PRD          				MODULE_ID(0xa ,2)
#define MODULE_VE2_DBK          				MODULE_ID(0xa ,3)
#define MODULE_VE2_MVD          				MODULE_ID(0xa ,4)
#define MODULE_VE2_NDPB2        				MODULE_ID(0xa ,5)
#define MODULE_VE2_R1_SEQ       				MODULE_ID(0xa ,6)
#define MODULE_VE2_BS           				MODULE_ID(0xa ,7)
#define MODULE_VE2_R1_BLOCK 					MODULE_ID(0xa ,8)
#define MODULE_VE2_VEP2COM      				MODULE_ID(0xa ,9)
...
#define MODULE_VE2           					MODULE_ID(0x5 ,0xf)
...
#define MODULE_TVSB4_OSD_TFBC_1					MODULE_ID(0xb, 9)
#define MODULE_TVSB4_OSD_TFBC_2					MODULE_ID(0xb, 0xa)
#define MODULE_TVSB4_DMATOSRNN     				MODULE_ID(0xb, 0xb)
#define MODULE_TVSB4_D_PQMASK_D   				MODULE_ID(0xb, 0xc)
#define MODULE_TVSB4_RTK_LD                   	MODULE_ID(0xb, 0xd)
