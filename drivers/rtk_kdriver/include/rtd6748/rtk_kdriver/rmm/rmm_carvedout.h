...
#define CARVEDOUT_AUDIO             4
#define CARVEDOUT_K_BOOT            5
#define CARVEDOUT_K_OS              6

#define CARVEDOUT_MAP_GIC           7
#define CARVEDOUT_MAP_RBUS          8
#define CARVEDOUT_GPU_FW            9   //deprecated?

#define CARVEDOUT_V_OS              10
#define CARVEDOUT_MAP_RPC           11

#define CARVEDOUT_A_OS              12
#define CARVEDOUT_LOGBUF            13
#define CARVEDOUT_ROMCODE           14
#define CARVEDOUT_RAMOOPS           15

#define CARVEDOUT_IR_TABLE          16
#define CARVEDOUT_DDR_BOUNDARY      17
#define CARVEDOUT_DDR_BOUNDARY_2    18

    /* device */
#define CARVEDOUT_VDEC_RINGBUF      19
