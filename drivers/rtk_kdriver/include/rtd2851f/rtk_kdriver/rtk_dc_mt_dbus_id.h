...
//	{MODULE_SB1_MD_KC,    "SB1_MD_KC"},
	{MODULE_SB1_USB_OTG,    "SB1_USB_OTG"},
	{MODULE_SB1_USB2,        "SB1_USB2"},
	{MODULE_SB1_RBUSDMA,    "SB1_RBUSDMA"},
	{MODULE_SB1_TP2_KC,         "SB1_TP2_KC"},
	...
	MODULE_STR(SB3_MD_KC),
	MODULE_STR(SB3_UART_DMA),
	MODULE_STR(SB3_MD_NKC_NVC),
	MODULE_STR(SB3_MD_VC),
	MODULE_STR(SB3),
...
unsigned char key_table_usb[] = {MODULE_SB1_USB_OTG, MODULE_SB1_USB2, MODULE_SB1_USB_EX};
unsigned char key_table_tp[] = {MODULE_SB1_TP_KC, MODULE_SB1_TP2_KC, MODULE_SB1_TP, MODULE_SB1_TP2};

//unsigned char key_table_uart[] = {MODULE_SB2_UART,MODULE_SB3_UART2};
unsigned char key_table_uart[] = {MODULE_SB2_UART};

unsigned char key_table_md[] = {MODULE_SB3_MD_NKC_NVC,MODULE_SB3_MD_VC};
...
unsigned char trap_table_kcputp[] = {MODULE_SB1_TP_KC,MODULE_SB1_TP2_KC};
unsigned char trap_table_scputp[] = {MODULE_SB1_TP, MODULE_SB1_TP2};
unsigned char trap_table_kcpumd[] = {MODULE_SB3_MD_KC};
unsigned char trap_table_scpumd[] = {MODULE_SB3_MD_NKC_NVC};
