...
typedef struct _PANEL_CONFIG_PARAMETER{
	...
	UINT8 iCONFIG_DISP_RESVER05;
	UINT8 iCONFIG_EDP_LINK_RATE;
	UINT8 iCONFIG_EDP_MAC_NUM;
	UINT8 iCONFIG_EDP_FORCE_MSA_ENHANCE_FRAMING;
	UINT8 iCONFIG_EDP_FORCE_MSA_DOWN_SPREAD;
	UINT8 iCONFIG_EDP_FORCE_ALTERNATE_SR_CAP; //sizeof is 100byte now. don't add more item
    ...
    UINT8 iCONFIG_PANEL_DITHER_ENABLE;
    UINT8 iCONFIG_PANEL_DITHER_TEMPORAL_ENABLE;
    UINT8 iCONFIG_PANEL_DITHER_BIT_TABLE_SELECT;
    UINT8 iCONFIG_PANEL_DITHER_OLED_TH_EN;
    UINT16 iCONFIG_PANEL_DITHER_OLED_TH;
#endif
   //96 bytes
