...
#define GDMA_CONFIG_OSD_2893_ENABLE			_IOR(GDMA_IOC_MAGIC, 54, int)
#define GDMA_CONFIG_OSD_ESTICKER_ENABLE	        _IOR(GDMA_IOC_MAGIC, 55, GDMA_GAMMA_OP)
...
#define GDMA_SET_OSD_RECOVER_BLENDING  _IOR(GDMA_IOC_MAGIC, 74, int)

#define GDMA_IOC_MAXNR                 75
