...
typedef struct _StructScreenModeInfo{
      ...
      unsigned char Hsync_Polarity_Indicator; // Hsync Polarity Indicator
...
typedef enum {
	REPORT_ZERO_TIMING = _BIT0,
	SOURCE_GOOD_TIMING_READY = _BIT1,
	CLEAR_ZERO_FLAG = 0,
}ZERO_TIMING_CHECK;

// From source.h
enum _SCALER_STRUCTURE_INFO_IDX {
    //main
    MAIN_SCALER_STOP_IDX = 0,//Main_Scaler_Stop_flag
    MAIN_RUN_SCALER_IDX,//Main_Run_Scaler_flag
    MAIN_RESET_MODE_IDX,
    MAIN_SMT_SET_IDX,//Main_smooth_toggle_set_flag
    MAIN_SMT_IS_FROM_MUTEOFF_IDX, //Main_run_smooth_toggle_from_mute_off
    MAIN_REQUEST_SMT_FROM_MUTEOFF_IDX, //Main_SetOutput_request_muteoff_smooth_toggle_set_flag
    MAIN_OUTPUT_SET_IDX,//Main_Output_Set_flag

    //sub
    SUB_SCALER_STOP_IDX,//Sub_Scaler_Stop_flag
    SUB_RUN_SCALER_IDX,//Sub_Run_Scaler_flag
    SUB_RESET_MODE_IDX,
    SUB_SMT_SET_IDX,//Sub_smooth_toggle_set_flag
    SUB_OUTPUT_SET_IDX,//sub_Output_Set_flag
};
