...
/*	
	// chen 170531
	unsigned char nintra_dy_vertical_diff_th_en;  //	0
	unsigned char nintra_diff_s_v_divd; 					//	0
	unsigned char nintra_dy_hdiff_th_en;          //	0(1)
	unsigned char nintra_hdiff_th2_lo;         		// 12
	unsigned char nintra_hdiff_th1_lo;            //	2
		// end chen 170531
*/
// end chen 170809		
