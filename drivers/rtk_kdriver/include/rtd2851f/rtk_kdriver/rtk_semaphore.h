...
#define RTK_SEM_INFO(fmt, args...)    rtd_pr_sema_info(fmt, ## args)
#define RTK_SEM_WARNING(fmt, args...) rtd_pr_sema_warn(fmt, ## args)
#define RTK_SEM_ERR(fmt, args...)     rtd_pr_sema_err(fmt, ## args)
