...
#define DISEQC_DBG(fmt, args...)	rtd_pr_diseqc_debug("[DEBUG]" fmt, ##args);
#define DISEQC_INFO(fmt, args...)	rtd_pr_diseqc_info("[INFO]" fmt, ##args);
#define DISEQC_WARN(fmt, args...)	rtd_pr_diseqc_warn("[WARN]" fmt, ##args);
#define DISEQC_ERROR(fmt, args...)	rtd_pr_diseqc_err("[Error]" fmt, ## args)
