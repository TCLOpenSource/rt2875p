...
typedef struct
{
	...
	_PARAM_PERIODIC_MANAGE     _param_periodic_manage;
	_PARAM_PRD_MANAGE          _param_prd_manage;
}_PQLPARAMETER;
...
typedef struct
{
	...
	_OUTPUT_PERIODIC_MANAGE     _output_periodic_manage;
	_OUTPUT_PRD_MANAGE     		_output_prd_manage;
}_PQLCONTEXT;
