...
#define PIX_LOGO_RG_PIXCNT_GOLDEN	(120*135)
#define PIX_LOGO_PIXCNT_GOLDEN		(960*540)
#define BLK_LOGO_RG_BLKCNT_GOLDEN	(30*34)
#define BLK_LOGO_BLKCNT_GOLDEN		(240*135)
#define RG_15               (15)
...
typedef struct
{
	...
	unsigned int dh_logo_RgnThr_15rgn[7][15];	// 7 thr, 15regions
#else
	// HS merlin7
		UINT32 dh_logo_RgnThr_15rgn[7][15]; // 7 thr, 15regions
	// HS merlin7
#endif
