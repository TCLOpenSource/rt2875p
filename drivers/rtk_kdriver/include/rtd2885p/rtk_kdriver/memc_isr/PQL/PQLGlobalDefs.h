...
#define _IncreaseCurveMapping(v, th, min, max, slp, p) (_CLIP_((_MAX_((int			)(v) - (int			)(th), 0))*(slp)>>(p), (min), (max)))
#define _IncreaseCurveMapping2(v, th, max, slp, p) (_CLIP_UBOUND_((_MAX_((int			)(v) - (int			)(th), 0))*(slp)>>(p), (max)))

#define _DecreaseCurveMapping(v, th, min, max, slp, p) (_CLIP_(((max) - ((_MAX_((int			)(th) - (int			)(v), 0))*(slp)>>(p))), (min), (max)))
