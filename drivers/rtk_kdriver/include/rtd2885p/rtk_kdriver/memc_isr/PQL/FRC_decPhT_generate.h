...
#if 1
#if CONFIG_MC_9_BUFFER
#define _PHASE_FRC_ME1_TOTAL_BUF_SIZE_     9
#else
...
#define _PHASE_FRC_MC_TOTAL_BUF_SIZE_      9
#define _PHASE_FRC_MCFRM_BUF_SIZE_	9
#define _PHASE_FRC_ME1FRM_BUF_SIZE_    9
#else
