...
typedef struct
{
	...
	unsigned int u12_rmv_avg;
	unsigned int u16_rmv_totalNum;
	unsigned int u32_new_saddiff_th_without_rp_gain;
	unsigned int u32_sad_sc_th_without_rp_gain;
	...
	unsigned char u8_dh_condition_horshake_bypass; 
	...
	unsigned char u8_dh_highapllesedtl_flag;
	...
	unsigned char u8_dh_condition_equalbgcnt_bigmvx;//k23
    ...
    unsigned char u8_me1_condition_relativemotion_lessDTL_flag;
    unsigned char u8_me1_condition_preden_mvdiffth_flag;
    ...
    unsigned char u8_me1_condition_blkheadbroken_flag;
    ...
    unsigned char u8_me1_condition_blue_midfghalo_flag ;//49
    unsigned char u8_me1_condition_49_halo_flag;//49
    unsigned char u8_me1_condition_419_flag ;//419
    unsigned char u8_me1_condition_173_end_2k_flag;
    unsigned char u8_me1_condition_apl_suddenchange_2k_flag;//479
    unsigned char u8_me1_condition_bgmidstable_fgmotion_2k_flag;//300
    unsigned char u8_me1_condition_random_bgmid_2k_flag;//335
    unsigned char u8_me1_condition_halobefore_flag;
    unsigned char u8_me1_condition_whitebgbroken_2k_flag;
    unsigned char u8_me1_condition_rotatebroken_2k_flag;
    unsigned char u8_me1_condition_rotateblackbroken_2k_flag;

    unsigned char u8_me1_condition_fixgmv_2k_flag;
    unsigned char u8_me1_condition_onlymv_flag;

    unsigned char u8_dh_condition_dhbypass_add; 
    unsigned char u8_dh_condition_bypass_check_add; 
    unsigned char u8_dh_condition_dhbypass_hold_cnt_add;     
    unsigned char u8_dh_condition_ver_clearbg_flag;     

    unsigned char u8_me1_condition_horblackmotion_QHD_flag;
    unsigned char u8_me1_condition_horfast_end_QHD_flag;
    unsigned char u8_me1_condition_similarapl_QHD_flag;
    unsigned char u8_me1_condition_darkapl_QHD_flag;
