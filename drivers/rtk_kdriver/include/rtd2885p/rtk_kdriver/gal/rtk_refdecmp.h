...
#define GPU_decmp_fifo_status	(GPU_REF_DECMP_WRAP_GPU_decmp_fifo_status_reg)
...
#define GDECMP_CMD_GET_HW_VERSION  (0xb2)



#define GDECMP_CMD_ALLOC_ADDR  (0x11)
#define GDECMP_CMD_ALLOC_ADDR_DMAHEAP  (0x12)
#define GDECMP_CMD_ALLOC_ADDR_VBM  (0x13)
