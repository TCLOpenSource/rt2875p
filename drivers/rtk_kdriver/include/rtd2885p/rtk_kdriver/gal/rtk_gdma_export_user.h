...
#define GDMA_ALPHA_TABLE_NUM 8
#define TFBC_HWC_NON_COMPRESS 8
...
typedef struct {
	unsigned int alpha_table[GDMA_ALPHA_TABLE_NUM];
} GDMA_ALPHA_TABLE;

#define BUF_PHY_NUM 3

typedef struct {
	unsigned int buf_phy_buffers[BUF_PHY_NUM];
} GDMA_PHY_BUFFERS;
...
#define GDMA_CONFIG_OSD4_MIXER_ENABLE  _IOR(GDMA_IOC_MAGIC, 41, int)
#define GDMA_CONFIG_OSD1OSD4_MIXER_ORDER  _IOR(GDMA_IOC_MAGIC, 42, int)
...
#define GDMA_GET_OSD_DETECTION_STATUS _IOR(GDMA_IOC_MAGIC, 47, int)
#define GDMA_SET_OSD_DETECTION_PARAMETER _IOR(GDMA_IOC_MAGIC, 48, int)
#define GDMA_CONFIG_GETOSDSPLIT            _IOR(GDMA_IOC_MAGIC, 49, int)
#define GDMA_CONFIG_SEND_ES_OSD            _IOR(GDMA_IOC_MAGIC, 50, int)
...
#define GDMA_CONFIG_OSD_2893_EANBLE			_IOR(GDMA_IOC_MAGIC, 54, int)
#define GDMA_CONFIG_OSD_ESTICKER_EANBLE			_IOR(GDMA_IOC_MAGIC, 55, GDMA_GAMMA_OP)

#define GDMA_CONFIG_OSD_ESTICKER_X_P			_IOR(GDMA_IOC_MAGIC, 56, int)
#define GDMA_CONFIG_OSD_ESTICKER_Y_P			_IOR(GDMA_IOC_MAGIC, 57, int)
#define GDMA_CAPTURE_FRAMEFUBBER			_IOR(GDMA_IOC_MAGIC, 58, int)

#define GDMA_CONFIG_OSD_SET_GOLBAL_ALPHA              _IOR(GDMA_IOC_MAGIC, 59, int)
#define GDMA_CONFIG_OSD_GET_GOLBAL_ALPHA        	  _IOR(GDMA_IOC_MAGIC, 60, GDMA_ALPHA_TABLE)
#define GDMA_CONFIG_OSD_GET_GOLBAL_ALPHA_VALUE        _IOR(GDMA_IOC_MAGIC, 61, int)

#define GDMA_GET_FENCE_INFO _IOR(GDMA_IOC_MAGIC, 62, int)
#define GDMA_GET_RELEASE_FENCE_INFO _IOR(GDMA_IOC_MAGIC, 63, int)
#define GDMA_GET_SIGNAL_FENCE_INFO _IOR(GDMA_IOC_MAGIC, 64, int)
#define GDMA_READ_UI_RESOLUTION     _IOR(GDMA_IOC_MAGIC, 65, int)

#define GDMA_GET_OSD1_PHY _IOR(GDMA_IOC_MAGIC, 66, int)
#define GDMA_GET_OSD1_SIZE _IOR(GDMA_IOC_MAGIC, 67, int)
#define GDMA_GET_OSD1_WIDTH _IOR(GDMA_IOC_MAGIC, 68, int)
#define GDMA_GET_OSD1_HEIGHT _IOR(GDMA_IOC_MAGIC, 69, int)
#define GDMA_GET_OSD1_BUFFS _IOR(GDMA_IOC_MAGIC, 70, int)
#define GDMA_CONFIG_OSD_STOP_UPDATE  _IOR(GDMA_IOC_MAGIC, 71, int)

#define GDMA_CONFIG_OSD_MONITOR_WIN  _IOR(GDMA_IOC_MAGIC, 72, OSD_MONITOR_WIN_CTL)


#define GDMA_IOC_MAXNR                 73
...
typedef struct {
    ...
    int32_t gdma_fence_magic_key;  /* = 'GDMA' = 0x65776871 */
    uint64_t gdma_fence_handle;     /* fence handle got from GDMA_GetFenceInfo */
