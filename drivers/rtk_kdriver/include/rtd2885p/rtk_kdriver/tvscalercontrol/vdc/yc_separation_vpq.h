...
enum {
	VPQ_HANDLE_STATUS_DISABLE = 0,
	VPQ_HANDLE_STATUS_ENABLE,
};

/* FUNCTION PROTOTYPE ************************************************************************/
void drvif_module_vpq_YcSeparation(unsigned char ucInputSrc, unsigned char uc3DEnable); // Main entry
unsigned char drvif_module_vpq_check_3d_off_on(unsigned char PrintInterVal);
