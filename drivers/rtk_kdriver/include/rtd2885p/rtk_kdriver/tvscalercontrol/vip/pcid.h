...
extern unsigned char RgnIncludeTbl_1_10[3][4];
extern unsigned char RgnIncludeTbl_4_7[4][4];
...
typedef struct {
	...
	unsigned int HorIdx[6];
	unsigned int VerIdx[9];
	unsigned char HorBldStep[6];
...
} DRV_pcid_pattern_ctrl_t;

typedef struct {
	DRV_pcid_pattern_ctrl_t Pattern;
} DRV_pcid_ctrl_t;
