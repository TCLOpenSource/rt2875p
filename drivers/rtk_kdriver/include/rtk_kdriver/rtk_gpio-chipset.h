...
#define MIO_GPIO_OFST       700     // MIO Group  : Output only Pads (Max: 100)
#define ISO_GPIO_MIO_OFST       800     // ISO GPIO MIO Group  : Output only Pads (Max: 100)
...
#define RTK_GPIO_CHIP_DBG(fmt, args ...)     rtd_pr_gpio_warn(fmt, ##args)
#else
