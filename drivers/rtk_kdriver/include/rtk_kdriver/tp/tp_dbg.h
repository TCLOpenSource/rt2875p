...
#define TP_LOG_MASK_BIT_13 1 << 13
#define TP_LOG_MASK_BIT_14 1 << 14
...
enum TP_LOG_BLOCK_MASK_BIT {
        ...
        TP_LOG_BLOCK_TPI_RATE_CNT   = TP_LOG_MASK_BIT_12,
        TP_LOG_BLOCK_CHANNEL_SCAN   = TP_LOG_MASK_BIT_13,
        TP_LOG_BLOCK_TPO_CLK        = TP_LOG_MASK_BIT_14,
...
enum TP_STATUS_LOG_FLAG_MASK_BIT {
        ...
        TP_STATUS_LOG_FLAG_TPI_RATE_CNT  = TP_LOG_MASK_BIT_9,
...
#define tp_debug_emerg_log(fmt, args...)        {rtd_pr_tp_emerg(fmt, ## args);}
...
#define tp_debug_dbg_log(fmt, args...)  {rtd_pr_tp_debug(fmt, ## args);}
