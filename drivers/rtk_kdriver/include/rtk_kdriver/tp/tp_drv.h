...
typedef struct {
        ...
        /* frame rate control */
        tp_prefix_fr_clk_rate_RBUS         prefix_fr_clk_rate_reg;
        ...
        /* ATSC30 */
        tp_tp_atsc_src_cntl_RBUS           tp_atsc_src_cntl;
        tp_tp_atsc_config1_RBUS            tp_atsc_config1;
        tp_tp_atsc_config2_RBUS            tp_atsc_config2;
        tp_tp_atsc_config3_RBUS            tp_atsc_config3;
        tp_tp_atsc_plp_filter1_RBUS        tp_atsc_plp_filter1;
        tp_tp_atsc_plp_filter2_RBUS        tp_atsc_plp_filter2;
        tp_tp_atsc_d_limit_RBUS            tp_atsc_d_limit;
        tp_tp_atsc_d_base_RBUS             tp_atsc_d_base;
        tp_tp_atsc_d_rp_RBUS               tp_atsc_d_rp;
        tp_tp_atsc_d_wp_RBUS               tp_atsc_d_wp;
        tp_tp_atsc_i_limit_RBUS            tp_atsc_i_limit;
        tp_tp_atsc_i_base_RBUS             tp_atsc_i_base;
        tp_tp_atsc_i_rp_RBUS               tp_atsc_i_rp;
        tp_tp_atsc_i_wp_RBUS               tp_atsc_i_wp;

#ifdef CONFIG_RTK_TP_WITH_MIO
		/* mio TP */
        iso_spi_synchronizer_tp_ctrl_RBUS      mio_tp_ctrl;
        iso_spi_synchronizer_tp_t2p_cfg_RBUS   mio_tp_t2p_cfg;
        iso_spi_synchronizer_tp_t2p_ctrl_RBUS  mio_tp_t2p_ctrl;
        iso_spi_synchronizer_tp_p2t_cfg_RBUS   mio_tp_p2t_cfg;
        iso_spi_synchronizer_tp_p2t_ctrl_RBUS  mio_tp_p2t_ctrl;
        iso_spi_synchronizer_tp_dbg_ctrl_RBUS  mio_tp_dbg_ctrl;
        iso_spi_synchronizer_tp_dbg_RBUS       mio_tp_dbg;
        iso_spi_synchronizer_tp_dft_t2p_RBUS   mio_tp_dft_t2p;
        iso_spi_synchronizer_tp_dft_p2t_RBUS   mio_tp_dft_p2t;
        iso_spi_synchronizer_tp_dmya_RBUS      mio_tp_dmya;
        iso_spi_synchronizer_tp_dmyb_RBUS      mio_tp_dmyb;
#endif
        /* TPO CLK */
        UINT32                             tpout_clk_reg;

        UINT32                             tpout_pinshare_buf_th;
} TP_REG_INFO;
