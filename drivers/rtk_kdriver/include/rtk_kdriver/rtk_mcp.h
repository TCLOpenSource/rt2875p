...
} __attribute__((aligned(16))) mcp_desc;
...
#define SHA256_PADDING_MAX_SIZE                72
...
/*if use MCP_SHA256, you need to insure the input_data must  One-shot execution*/
/* otherwise, you should use the api MCP_SHA256_PADDING + MCP_SHA256_DataHash */
...
extern int mcp_pm_runtime_on(void);
extern int mcp_pm_runtime_off(void);
