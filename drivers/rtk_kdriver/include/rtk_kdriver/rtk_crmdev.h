...
#define MAX_PROVIDER_COUNT (64)
#define MAX_REQUIRES_COUNT (8)
#define MAX_FORMAT_COUNT (128)
...
typedef enum _rtk_crmdev_codec_type_t {
  ...
  RTK_CRMDEV_CODEC_TYPE_AV1,
  RTK_CRMDEV_CODEC_TYPE_VVC,
  RTK_CRMDEV_CODEC_TYPE_AVS3,
  ...
  RTK_CRMDEV_CODEC_TYPE_DTS_X,

  RTK_CRMDEV_CODEC_TYPE_VIDEO_DISPLAY = 0x4000,
  RTK_CRMDEV_CODEC_TYPE_DISPLAY_VP,
  RTK_CRMDEV_CODEC_TYPE_DISPLAY_VP0,
  RTK_CRMDEV_CODEC_TYPE_DISPLAY_VP1,

  RTK_CRMDEV_CODEC_TYPE_VIDEO_SCALE_CONTROL = 0x8000,
  RTK_CRMDEV_CODEC_TYPE_VSC_WIN0,
  RTK_CRMDEV_CODEC_TYPE_VSC_WIN1,
...
typedef struct _rtk_crmdev_clear_resource_t {
  rtk_crmdev_codec_resource_t resource;
} rtk_crmdev_clear_resource_t;
...
typedef union _rtk_crmdev_data_t {
  ...
  rtk_crmdev_clear_resource_t clear_resource;
} rtk_crmdev_data_t;
