...
typedef struct{
	...
	CHIP_TNRY_T TNR_Y;
	CHIP_TNRC_T TNR_C;
}CHIP_NOISE_REDUCTION_T, RTK_NOISE_REDUCTION_T;
...
}CHIP_MPEG_NOISE_REDUCTION_T, RTK_MPEG_NOISE_REDUCTION_T;
typedef struct{
...
extern unsigned char (*get_DM2_Hist_AutoMode_Flag)(void);
void set_DM2_Hist_AutoMode_Counter(unsigned char value);
extern unsigned char (*get_DM2_Hist_AutoMode_Counter)(void);
