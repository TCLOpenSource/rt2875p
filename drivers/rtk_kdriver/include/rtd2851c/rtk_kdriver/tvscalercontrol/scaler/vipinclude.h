...
#ifndef OSD_FOUR_LEVEL_MAPPING_ENABLE
...
typedef struct _StructColorDataType {
	...
	unsigned char MBSUPeaking;// Merlin3
	...
	unsigned char ScaleUpH_12tap;		/*20140327 roger*/
	unsigned char ScaleUpV_8tap;		/*20140327 roger*/
	...
	unsigned short ICM_7Axis_adjust_enable;
