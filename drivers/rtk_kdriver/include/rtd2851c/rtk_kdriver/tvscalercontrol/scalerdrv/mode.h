...
#define HDMI_NORMAL_ONLINE_ENABLE_MASK  (_BIT7 | _BIT8 | _BIT9 | _BIT10 | _BIT11 | _BIT13 | _BIT15 | _BIT21)//HDMI normal
#else
...
#define HDMI_NORMAL_ONLINE_ENABLE_MASK  (_BIT7 | _BIT8 | _BIT9 | _BIT10 | _BIT11 | _BIT13 | _BIT15)//HDMI normal
#endif
#define DP_VRR_ONLINE_ENABLE_MASK  (_BIT2 | _BIT4 | _BIT5 | _BIT8 | _BIT9 | _BIT11 | _BIT13 | _BIT22)//DP VRR
#define DP_FREESYNC_ONLINE_ENABLE_MASK  (_BIT5 | _BIT8 | _BIT9 | _BIT13 | _BIT22)//DP Freesync
#define DP_NORMAL_ONLINE_ENABLE_MASK  (_BIT7 | _BIT8 | _BIT9 | _BIT10 | _BIT11 | _BIT13 | _BIT15)//DP normal
...
void save_online_enable_time(unsigned char display);//the api is use to save the 90k counter online measure enable time
