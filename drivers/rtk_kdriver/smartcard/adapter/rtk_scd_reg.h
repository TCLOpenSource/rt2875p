...
#include <rbus/misc_smartcard1_reg.h>

#ifdef CONFIG_ARCH_RTK2885P
#else
#ifndef defined(CONFIG_ARCH_RTK2851C) || defined(CONFIG_ARCH_RTK2851F)
...
#define SC_FAST_RSTWAIT_MODE(x) (((x) & 0x00000001)<<22)
...
#define SC_FIFO_VALID0  0x1
#define SC_FIFO_VALID1  0x2
#define SC_FIFO_VALID2  0x4
#define SC_FIFO_VALID3  0x8
...
#define IFD_MODOLE              "RTD285O"
#ifdef CONFIG_RTK_KDRV_MIO_SMARTCARD 

#ifdef CONFIG_ARCH_RTK6702
#define SYSTEM_CLK              100000000  /*180000000 ?*/
#else
...
static const SC_REG SCReg[MAX_IFD_CNT] = {
#ifdef CONFIG_RTK_KDRV_MIO_SMARTCARD
		{
				...
				.INT_MASK = 0,
				.ISR      = MISC_isr_reg,
				.ISR_MASK = MISC_isr_sc0_int_mask,
				.FP       = MISC_SMARTCARD1_SC_FP_reg,
				.CR       = MISC_SMARTCARD1_SC_CR_reg,
				.PCR      = MISC_SMARTCARD1_SC_PCR_reg,
				.TXFIFO   = MISC_SMARTCARD1_SC_TXFIFO_reg,
				.RXFIFO   = MISC_SMARTCARD1_SC_RXFIFO_reg,
				.RXLENR   = MISC_SMARTCARD1_SC_RXLENR_reg,
				.FCR      = MISC_SMARTCARD1_SC_FCR_reg,
				.IRSR     = MISC_SMARTCARD1_SC_IRSR_reg,
				.IRER     = MISC_SMARTCARD1_SC_IRER_reg,
				.FIFO_VALID = MISC_SMARTCARD1_SC_FIFO_VALID_reg,
		},
#else
		{
				.INT_EN   = MISC_isr_reg,  
