...
#define KP_EMERG(fmt, args...)      \
	rtd_pr_keypad_emerg(fmt , ## args)

#define KP_ALERT(fmt, args...)   \
	rtd_pr_keypad_alert(fmt , ## args)

#define KP_CRIT(fmt, args...)   \
	rtd_pr_keypad_crit(fmt , ## args)

#define KP_ERR(fmt, args...)   \
	rtd_pr_keypad_err(fmt , ## args)

#define KP_WARNING(fmt, args...)   \
	rtd_pr_keypad_warn(fmt , ## args)

#define KP_NOTICE(fmt, args...)   \
	rtd_pr_keypad_notice(fmt , ## args)

#define KP_INFO(fmt, args...)   \
	rtd_pr_keypad_info(fmt , ## args)

#define KP_DEBUG(fmt, args...)   \
	rtd_pr_keypad_debug(fmt , ## args)
