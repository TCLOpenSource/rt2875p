#ifndef _RTK_UART_DMA_H_
#define _RTK_UART_DMA_H_
...
#define UR1_DMA_RST                                    (0x18039228)
#define UR1_DMA_RST_reg                                    (0xb8039228)
#define UR1_TX_DMA_FSM(x)                          ((x) << 0)
