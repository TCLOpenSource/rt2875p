...
phydm_rfe_8822e(struct dm_struct *dm, enum bb_path path)
{
	...
	if (rfe_type == 21 || rfe_type == 22) {
		...
		case BB_PATH_NON:
			...
			break;
		case BB_PATH_A:
			odm_set_bb_reg(dm, R_0x1840, MASKDWORD, 0x00003000);
			odm_set_bb_reg(dm, R_0x1844, MASKDWORD, 0x00000002);
			odm_set_bb_reg(dm, R_0x4140, MASKDWORD, 0x70700000);
			odm_set_bb_reg(dm, R_0x4144, MASKDWORD, 0x00000070);
			break;
		case BB_PATH_B:
			odm_set_bb_reg(dm, R_0x1840, MASKDWORD, 0x00007000);
			odm_set_bb_reg(dm, R_0x1844, MASKDWORD, 0x00007007);
			odm_set_bb_reg(dm, R_0x4140, MASKDWORD, 0x20300000);
			odm_set_bb_reg(dm, R_0x4144, MASKDWORD, 0x00000000);
			break;
		case BB_PATH_AB:
			odm_set_bb_reg(dm, R_0x1840, MASKDWORD, 0x00003000);
			odm_set_bb_reg(dm, R_0x1844, MASKDWORD, 0x00000002);
...
void phydm_spur_eliminate_8822e(struct dm_struct *dm, u8 central_ch)
{
	...
	if (central_ch == 153 && (*dm->band_width == CHANNEL_WIDTH_20)) {
		...
		phydm_set_csi_mask_8822e(dm, 111);
		phydm_set_csi_mask_8822e(dm, 112);
		phydm_set_csi_mask_8822e(dm, 113);
		...
		phydm_set_nbi_wa_para_8822e(dm, true, *dm->band_width);
		phydm_set_csi_mask_8822e(dm, 15);
		phydm_set_csi_mask_8822e(dm, 16);
		phydm_set_csi_mask_8822e(dm, 17);
		...
		phydm_set_nbi_wa_para_8822e(dm, true, *dm->band_width);
		phydm_set_csi_mask_8822e(dm, 207);
		phydm_set_csi_mask_8822e(dm, 208);
		phydm_set_csi_mask_8822e(dm, 209);
