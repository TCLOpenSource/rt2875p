...
void _halrf_txgapk_bb_dpk_8822e(
...
void _halrf_txgapk_afe_dpk_8822e(
	void *dm_void, u8 path)
{
	struct dm_struct *dm = (struct dm_struct *)dm_void;
...
void _halrf_txgapk_afe_dpk_restore_8822e(
	void *dm_void, u8 path)
{
	struct dm_struct *dm = (struct dm_struct *)dm_void;
...
void _halrf_txgapk_bb_dpk_restore_8822e(
	void *dm_void, u8 path)
{
	struct dm_struct *dm = (struct dm_struct *)dm_void;
	...
	void *dm_void, u8 path)
{
	...
	u32 set_1b00_cfg1[MAX_PATH_NUM_8822E] = {0x00000d18, 0x00000d2a};
	u32 set_1b00_cfg2[MAX_PATH_NUM_8822E] = {0x00000d19, 0x00000d2b};
	...
	void *dm_void)
{
	...
	for (path_idx = 0; path_idx < MAX_PATH_NUM_8822E; path_idx++) {
		_halrf_txgapk_bb_dpk_8822e(dm, path_idx);
		_halrf_txgapk_afe_dpk_8822e(dm, path_idx);
		_halrf_txgapk_calculate_offset_8822e(dm, path_idx);
		_halrf_txgapk_rf_restore_8822e(dm, path_idx);
		_halrf_txgapk_afe_dpk_restore_8822e(dm, path_idx);
		_halrf_txgapk_bb_dpk_restore_8822e(dm, path_idx);
	}
