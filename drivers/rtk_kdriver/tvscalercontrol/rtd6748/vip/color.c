...
static VIP_IP_Status_Check_List VIP_IP_Status_Check_List_TBL[] =
{
	...
	{"I_DCTI_en", IDCTI_I_DCTI_CTRL_1_reg, IDCTI_I_DCTI_CTRL_1_dcti_en_mask, 0, 0},
...
unsigned char drvif_color_get_inv_gamma_enable(void)
{
	inv_gamma_inv_gamma_ctrl_2_RBUS inv_gamma_ctrl_2_REG;
	
	inv_gamma_ctrl_2_REG.regValue = IoReg_Read32(INV_GAMMA_INV_GAMMA_CTRL_2_reg);
	return (unsigned char)inv_gamma_ctrl_2_REG.inv_gamma_m_tab_sel;
}
...
unsigned char drvif_color_get_gamma_enable(void)
{
	...
	return (unsigned char)gamma_gamma_ctrl_2_RBUS_reg.gamma_m_tab_sel;
}
...
void drvif_DM2_set_B05_1D_LUT_Enable(unsigned char En)
{
	...
	dm_dm_b05_lut_ctrl2_Reg.b05_1d_lut_en = En;
...
unsigned char drvif_DM2_get_B05_1D_LUT_Enable(void)
{
	...
	return dm_dm_b05_lut_ctrl2_Reg.b05_1d_lut_en ;
...
char drvif_DM2_set_B05_1D_LUT_Index(unsigned int *pLut_Idx)
{
	...
	if (pLut_Idx == NULL) {
		rtd_pr_vpq_emerg("drvif_DM2_set_B05_1D_LUT_Index, NULL!!!!\n");
		return -1;
	}
		
	for (i=0;i<(HDR_DM2_B05_1D_LUT_Size-2);i++)
		IoReg_Write32(DM_B05_1D_XPOS_0_reg + (i * 4), *(pLut_Idx+i));
...
char drvif_DM2_get_B05_1D_LUT_Index(unsigned int *pLut_Idx)
{
	...
	if (pLut_Idx == NULL) {
		rtd_pr_vpq_emerg("drvif_DM2_get_B05_1D_LUT_Index, NULL!!!!\n");
		return -1;
	}
		
	for (i=0;i<(HDR_DM2_B05_1D_LUT_Size-2);i++)
		*(pLut_Idx+i) = IoReg_Read32(DM_B05_1D_XPOS_0_reg + (i * 4));
...
char drvif_DM2_set_B05_1D_LUT(unsigned int *pLut)
{
	...
	unsigned char size;
	if (pLut == NULL) {
		rtd_pr_vpq_emerg("drvif_DM2_set_B05_1D_LUT, NULL!!!!\n");
		return -1;
	}
	
	size = (HDR_DM2_B05_1D_LUT_Size>>1) + 1;	
	for (i=0;i<size;i++) {
		IoReg_Write32(DM_B05_1D_LUT_0_reg + (i * 4), *(pLut+i));	// {lut_1, lut_0}
	}
...
char drvif_DM2_get_B05_1D_LUT(unsigned int *pLut)
{
	...
	unsigned char size;
	if (pLut == NULL) {
		rtd_pr_vpq_emerg("drvif_DM2_get_B05_1D_LUT, NULL!!!!\n");
		return -1;
	}
	
	size = (HDR_DM2_B05_1D_LUT_Size>>1) + 1;	
	for (i=0;i<size;i++) {
		*(pLut+i) = IoReg_Read32(DM_B05_1D_LUT_0_reg + (i * 4));	// {lut_1, lut_0}
	}
	return 0;
...
char drvif_color_set_PQ_ByPass(unsigned char bypass_item, unsigned char isInterlaceMode)
{
	...
	switch(bypass_item) {
		...
		case PQ_ByPass_VC_en:
			IoReg_Mask32(COLOR_D_VC_Global_CTRL_reg, ~COLOR_D_VC_Global_CTRL_m_vc_en_shift, (COLOR_D_VC_Global_CTRL_write_enable_11_shift));
		break;
...
char drvif_color_set_PQ_ByPass_Resort(unsigned char Resort_item)
{
	...
	switch(Resort_item) {
		...
		case PQ_ByPass_MPEG_NR:
			IoReg_SetBits(NR_DCH1_MPEGNR1_reg, NR_DCH1_MPEGNR1_cp_mpegenable_y_c_mask);
			IoReg_SetBits(NR_DCH1_MPEGNR1_reg, NR_DCH1_MPEGNR1_cp_mpegenable_y_y_mask);

			IoReg_SetBits(MPEGNR_ICH1_MPEGNR2_reg, MPEGNR_ICH1_MPEGNR2_cp_mpegenable_x_mask);//_BIT0
			IoReg_SetBits(MPEGNR_ICH1_MPEGNR_DB_CTRL_reg, MPEGNR_ICH1_MPEGNR_DB_CTRL_mpegnr_db_en_mask); /* MPEGNR DB apply */
		break;
...
*/
		...
		case PQ_ByPass_RTNR_Y:
			if((IoReg_Read32(DI_IM_DI_RTNR_Y_16_K0_K7_reg)!=0)&&(IoReg_Read32(DI_IM_DI_RTNR_Y_16_K8_K15_reg)!=0)){
		...
		case PQ_ByPass_RTNR_C:
			if(IoReg_Read32(DI_IM_DI_RTNR_C_K_reg)!=0){
		...
		case PQ_ByPass_I_Peaking:
			//IoReg_SetBits(PEAKING_ICH1_PEAKING_FILTER_reg, PEAKING_ICH1_PEAKING_FILTER_peaking_enable_mask);//_BIT26 //mac6 no I-Peaking
		break;
		...
		case PQ_ByPass_I_Peaking_Sub:
			//IoReg_SetBits(PEAKING_ICH2_PEAKING_FILTER_reg, PEAKING_ICH2_PEAKING_FILTER_peaking_enable_mask);//_BIT26 //mac6 no I-Peaking
		break;
#endif //VIP_CONFIG_DUAL_CHANNEL
		...
		case PQ_ByPass_DCC:
			IoReg_Mask32(COLOR_D_VC_Global_CTRL_reg, ~COLOR_D_VC_Global_CTRL_dcc_en_mask, (COLOR_D_VC_Global_CTRL_write_enable_1_mask | COLOR_D_VC_Global_CTRL_dcc_en_mask));
		...
		case PQ_ByPass_ICM:
			IoReg_Mask32(COLOR_D_VC_Global_CTRL_reg, ~COLOR_D_VC_Global_CTRL_m_icm_en_mask, (COLOR_D_VC_Global_CTRL_write_enable_3_mask | COLOR_D_VC_Global_CTRL_m_icm_en_mask));
		break;

		case PQ_ByPass_SHP:
			IoReg_Mask32(COLOR_D_VC_Global_CTRL_reg, ~COLOR_D_VC_Global_CTRL_m_sharp_en_mask, (COLOR_D_VC_Global_CTRL_write_enable_4_mask | COLOR_D_VC_Global_CTRL_m_sharp_en_mask));
		break;
		...
		case PQ_ByPass_ICM_Sub:
			//IoReg_SetBits(COLOR_D_VC_Global_CTRL_0_reg, COLOR_D_VC_Global_CTRL_0_s_icm_en_mask);//_BIT18 //mac6p merged to main
		break;
		...
		case PQ_ByPass_COLOR_MAP_Sub:
			IoReg_SetBits(COLORMAP_D_CMRGB2RGB_Control_reg, COLORMAP_D_CMRGB2RGB_Control_cmrgb2rgb_sub_en_mask);//_BIT0|_BIT1
		break;
		...
		case PQ_ByPass_I_DI:
			IoReg_ClearBits(DI_IM_DI_WEAVE_WINDOW_CONTROL_reg, DI_IM_DI_WEAVE_WINDOW_CONTROL_force2d_mask);	/* force 2D*/
			IoReg_SetBits(DI_db_reg_ctl_reg, DI_db_reg_ctl_db_apply_mask);	/* HW do not clear this bit, alway turn on, setting will be apply while v_sync*/
		break;

		case PQ_ByPass_De_XCXL:
#ifdef CONFIG_HW_SUPPORT_I_DE_XC
			IoReg_SetBits(DE_XCXL_De_XCXL_CTRL_reg,DE_XCXL_De_XCXL_CTRL_dexc_en_mask);
			IoReg_SetBits(DE_XCXL_DE_XCXL_db_reg_ctl_reg,DE_XCXL_DE_XCXL_db_reg_ctl_db_apply_mask);
#endif
		break;
		...
		case PQ_ByPass_LC:
			IoReg_Mask32(COLOR_D_VC_Global_CTRL_reg, ~COLOR_D_VC_Global_CTRL_m_lc_comp_en_shift, (COLOR_D_VC_Global_CTRL_write_enable_12_shift | COLOR_D_VC_Global_CTRL_m_lc_comp_en_shift));
		break;

		case PQ_ByPass_SU_PEAKING:
#ifdef CONFIG_HW_SUPPORT_SU_PEAKING
			IoReg_SetBits(COLOR_MB_SU_PEAKING_MB_SU_PEAKING_CTRL_reg,COLOR_MB_SU_PEAKING_MB_SU_PEAKING_CTRL_mb_peaking_en_mask);
#endif
		break;

		case PQ_ByPass_UV_Delay:
			IoReg_SetBits(COLOR_DLCTI_UV_Delay_reg,COLOR_DLCTI_UV_Delay_uv_delay_en_mask);
		break;

		case PQ_ByPass_UVC_CONTROL:
			//IoReg_Mask32(COLOR_D_VC_Global_CTRL_0_reg, ~COLOR_D_VC_Global_CTRL_0_ms_ctrl_uvcoring_mask, (COLOR_D_VC_Global_CTRL_0_write_enable_20_mask | COLOR_D_VC_Global_CTRL_0_ms_ctrl_uvcoring_mask));
		break;

		case PQ_ByPass_DEMURA:
			IoReg_SetBits(DEMURA_DEMURA_CONTROL_reg,DEMURA_DEMURA_CONTROL_demura_en_mask);
		break;

		case PQ_ByPass_CONBRI:
			IoReg_SetBits(CON_BRI_DM_COLOR_RGB_CTRL_reg,CON_BRI_DM_COLOR_RGB_CTRL_m_bri_en_mask);
			IoReg_SetBits(CON_BRI_DM_COLOR_RGB_CTRL_reg,CON_BRI_DM_COLOR_RGB_CTRL_m_con_en_mask);
		break;

		case PQ_ByPass_OUT_GAMMA:
			IoReg_Mask32(OUTPUTGAMMA_OUT_GAMMA_CTRL_1_reg, ~OUTPUTGAMMA_OUT_GAMMA_CTRL_1_out_gamma_en_mask, OUTPUTGAMMA_OUT_GAMMA_CTRL_1_out_gamma_en_mask);
		break;

		case PQ_ByPass_INV_OUT_GAMMA:
			IoReg_Mask32(INVOUTPUTGAMMA_INV_OUT_GAMMA_CTRL_1_reg, ~INVOUTPUTGAMMA_INV_OUT_GAMMA_CTRL_1_inv_out_gamma_en_mask, INVOUTPUTGAMMA_INV_OUT_GAMMA_CTRL_1_inv_out_gamma_en_mask);
		break;

		case PQ_ByPass_BS_CONTROL:
#ifdef CONFIG_HW_SUPPORT_BLUE_STRETCH
			IoReg_SetBits(GAMMA_GAMMA_BS_CONTROL_reg,GAMMA_GAMMA_BS_CONTROL_gamma_m_bs_en_mask);
#endif
		break;

		case PQ_ByPass_3DLUT_CTRL:
			IoReg_SetBits(C3DLUT_C3DLUT_LUT_CTRL_reg,C3DLUT_C3DLUT_LUT_CTRL_c3dlut_ctrl_main_mask);
			IoReg_SetBits(C3DLUT_C3DLUT_db_ctl_0_reg,C3DLUT_C3DLUT_db_ctl_0_db_apply_0_mask);
		break;

		case PQ_ByPass_I_RGB2YUV:
			IoReg_SetBits(RGB2YUV_ICH1_RGB2YUV_CTRL_reg, RGB2YUV_ICH1_RGB2YUV_CTRL_en_rgb2yuv_mask);
			IoReg_SetBits(RGB2YUV_ICH1_RGB2YUV_CTRL_reg, RGB2YUV_ICH1_RGB2YUV_CTRL_rgb2yuv_db_apply_mask);
		break;

		case PQ_ByPass_D_YUV2RGB:
			IoReg_SetBits(YUV2RGB_D_YUV2RGB_Control_reg, YUV2RGB_D_YUV2RGB_Control_yuv2rgb_main_en_mask);

		break;

		case PQ_ByPass_I_UZD:
			IoReg_SetBits(SCALEDOWN_ICH1_UZD_Ctrl0_reg, SCALEDOWN_ICH1_UZD_Ctrl0_h_zoom_en_mask);
			IoReg_SetBits(SCALEDOWN_ICH1_UZD_DB_CTRL_reg, SCALEDOWN_ICH1_UZD_DB_CTRL_h_db_apply_mask);
			IoReg_SetBits(SCALEDOWN_ICH1_UZD_Ctrl0_reg, SCALEDOWN_ICH1_UZD_Ctrl0_v_zoom_en_mask);
			IoReg_SetBits(SCALEDOWN_ICH1_UZD_DB_CTRL_reg, SCALEDOWN_ICH1_UZD_DB_CTRL_v_db_apply_mask);
		break;

		case PQ_ByPass_D_UZU:
			IoReg_D_domain_SetBits(SCALEUP_DM_UZU_Ctrl_reg, SCALEUP_DM_UZU_Ctrl_h_zoom_en_mask);
			IoReg_D_domain_SetBits(SCALEUP_DM_UZU_Ctrl_reg, SCALEUP_DM_UZU_Ctrl_v_zoom_en_mask);
			IoReg_SetBits(SCALEUP_DM_UZU_DB_CTRL_reg, SCALEUP_DM_UZU_DB_CTRL_db_apply_mask);
		break;

		case PQ_ByPass_VC_en:
			IoReg_Mask32(COLOR_D_VC_Global_CTRL_reg, ~COLOR_D_VC_Global_CTRL_m_vc_en_shift, (COLOR_D_VC_Global_CTRL_write_enable_11_shift | COLOR_D_VC_Global_CTRL_m_vc_en_shift));
		break;
...
{
	if(bEnable)
		drvif_color_set_PQ_ByPass(bypass_item, Scaler_DispGetStatus(SLR_MAIN_DISPLAY, SLR_DISP_INTERLACE));
	else
		drvif_color_set_PQ_ByPass_Resort(bypass_item);
	return 0;
}
...
{
	UINT32 count = 0xC00;//0x600;  //0x0325000;
	dm_hdr_double_buffer_ctrl_RBUS dm_double_buffer_ctrl_reg;
	do {
		dm_double_buffer_ctrl_reg.regValue = rtd_inl(DM_HDR_Double_Buffer_CTRL_reg);
...
unsigned long drvif_I_Main_DITHER_Y_HISTOGRAM_Get_ISR(unsigned int *pHist_32, unsigned short *pMAX, unsigned short *pMIN)
{
	unsigned long total;
	unsigned char i;
	...
	*pMIN = main_dither_i_main_dither_y_histogram_max_min_reg.hist_min;
	total = ((((unsigned long)main_dither_i_main_dither_y_histogram_high_reg.hist_sumval_high)&0x1FF)<<32) 
...
{/*DEMURA1*/1, /*DEMURA2*/0, /*SRNN*/0, /*SRS*/0, /*HCIC*/0, /*SLD*/0, /*LINE_OD*/1, /*PCLRC*/0, /*VALC*/1, /*POD*/0, /*A10*/0, /*OD*/1},	/* MEX_UNKNOW  */
{/*DEMURA1*/1, /*DEMURA2*/0, /*SRNN*/0, /*SRS*/0, /*HCIC*/0, /*SLD*/0, /*LINE_OD*/1, /*PCLRC*/0, /*VALC*/1, /*POD*/0, /*A10*/0, /*OD*/1},	/* MEX_SlAVE_IC  */
{/*DEMURA1*/1, /*DEMURA2*/0, /*SRNN*/0, /*SRS*/0, /*HCIC*/1, /*SLD*/0, /*LINE_OD*/1, /*PCLRC*/0, /*VALC*/1, /*POD*/1, /*A10*/0, /*OD*/1},	/* MEX_LGD */
{/*DEMURA1*/1, /*DEMURA2*/0, /*SRNN*/0, /*SRS*/0, /*HCIC*/1, /*SLD*/0, /*LINE_OD*/1, /*PCLRC*/0, /*VALC*/1, /*POD*/1, /*A10*/0, /*OD*/1},	/* MEX_LGD_120  */
{/*DEMURA1*/1, /*DEMURA2*/0, /*SRNN*/0, /*SRS*/0, /*HCIC*/0, /*SLD*/1, /*LINE_OD*/1, /*PCLRC*/0, /*VALC*/1, /*POD*/0, /*A10*/0, /*OD*/1},	/* MEX_LGD_OLED  */
{/*DEMURA1*/1, /*DEMURA2*/1, /*SRNN*/0, /*SRS*/0, /*HCIC*/0, /*SLD*/0, /*LINE_OD*/1, /*PCLRC*/0, /*VALC*/1, /*POD*/0, /*A10*/0, /*OD*/1},	/* MEX_BOE  */
{/*DEMURA1*/1, /*DEMURA2*/1, /*SRNN*/0, /*SRS*/0, /*HCIC*/0, /*SLD*/0, /*LINE_OD*/1, /*PCLRC*/0, /*VALC*/1, /*POD*/0, /*A10*/0, /*OD*/1},	/* MEX_BOE_120  */
...
{/*DEMURA1*/1, /*DEMURA2*/0, /*SRNN*/0, /*SRS*/0, /*HCIC*/0, /*SLD*/0, /*LINE_OD*/1, /*PCLRC*/0, /*VALC*/1, /*POD*/0, /*A10*/0, /*OD*/1},	/* MEX_S_AUO  */
{/*DEMURA1*/1, /*DEMURA2*/1, /*SRNN*/0, /*SRS*/0, /*HCIC*/1, /*SLD*/1, /*LINE_OD*/1, /*PCLRC*/0, /*VALC*/1, /*POD*/1, /*A10*/1, /*OD*/1},	/* MEX_Force_En_All  */
};
...
void drvif_color_data_access_debug_check(VIP_DRV_DataAccess_Debug data)
{
	...
	unsigned char MEMC_mux_bBgEn = PPOVERLAY_MEMC_MUX_CTRL_get_memc_out_bg_en(IoReg_Read32(PPOVERLAY_MEMC_MUX_CTRL_reg));
#else
