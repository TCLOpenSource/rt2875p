...
void drvif_color_get_valc_SpatialPattern(DRV_valc_pattern_ctrl_t* pPATCtrl)
{
	...
	pPATCtrl->Cyclic_H = valc_valc_sp_ctrl_reg.valc_sp_h;
	pPATCtrl->Cyclic_V = valc_valc_sp_ctrl_reg.valc_sp_v;

	// line0
	value=valc_valc_sp_0_reg.valc_sp_line0;
	for(i=15; i>=0; i--)
	{
		pPATCtrl->Pattern[0][i] = value&0x01;
		value = value>>1;
	}

	// line1
	value=valc_valc_sp_0_reg.valc_sp_line1;
	for(i=15; i>=0; i--)
	{
		pPATCtrl->Pattern[1][i] = value&0x01;
		value = value>>1;
	}

	// line2
	value=valc_valc_sp_1_reg.valc_sp_line2;
	for(i=15; i>=0; i--)
	{
		pPATCtrl->Pattern[2][i] = value&0x01;
		value = value>>1;
	}

	// line3
	value=valc_valc_sp_1_reg.valc_sp_line3;
	for(i=15; i>=0; i--)
	{
		pPATCtrl->Pattern[3][i] = value&0x01;
		value = value>>1;
	}

	// line4
	value=valc_valc_sp_2_reg.valc_sp_line4;
	for(i=15; i>=0; i--)
	{
		pPATCtrl->Pattern[4][i] = value&0x01;
		value = value>>1;
	}

	// line5
	value=valc_valc_sp_2_reg.valc_sp_line5;
	for(i=15; i>=0; i--)
	{
		pPATCtrl->Pattern[5][i] = value&0x01;
		value = value>>1;
	}

	// line6
	value=valc_valc_sp_l3_reg.valc_sp_line6;
	for(i=15; i>=0; i--)
	{
		pPATCtrl->Pattern[6][i] = value&0x01;
		value = value>>1;
	}

	// line7
	value=valc_valc_sp_l3_reg.valc_sp_line7;
	for(i=15; i>=0; i--)
	{
		pPATCtrl->Pattern[7][i] = value&0x01;
		value = value>>1;
	}
...
void drvif_color_get_valc_HPF_protect(DRV_valc_hpf_ctrl_t* pHPFCtrl)
{
	...
	pHPFCtrl->ClipSel = valc_pcid_valc_ctrl_reg.valc_hpf_clip;

	pHPFCtrl->Weight[0] = valc_pcid_valc_hpf_1_reg.valc_hpf_w0;
	pHPFCtrl->Weight[1] = valc_pcid_valc_hpf_1_reg.valc_hpf_w1;
	pHPFCtrl->Weight[2] = valc_pcid_valc_hpf_1_reg.valc_hpf_w2;
	pHPFCtrl->Weight[3] = valc_pcid_valc_hpf_1_reg.valc_hpf_w3;
	pHPFCtrl->Weight[4] = valc_pcid_valc_hpf_1_reg.valc_hpf_w4;
	pHPFCtrl->Weight[5] = valc_pcid_valc_hpf_1_reg.valc_hpf_w5;
	pHPFCtrl->Weight[6] = valc_pcid_valc_hpf_1_reg.valc_hpf_w6;
	pHPFCtrl->Weight[7] = valc_pcid_valc_hpf_1_reg.valc_hpf_w7;

	pHPFCtrl->Weight[8] = valc_pcid_valc_hpf_0_reg.valc_hpf_w8;
	pHPFCtrl->Weight[9] = valc_pcid_valc_hpf_0_reg.valc_hpf_w9;
	pHPFCtrl->Weight[10] = valc_pcid_valc_hpf_0_reg.valc_hpf_w10;
	pHPFCtrl->Weight[11] = valc_pcid_valc_hpf_0_reg.valc_hpf_w11;
	pHPFCtrl->Weight[12] = valc_pcid_valc_hpf_0_reg.valc_hpf_w12;
	pHPFCtrl->Weight[13] = valc_pcid_valc_hpf_0_reg.valc_hpf_w13;
	pHPFCtrl->Weight[14] = valc_pcid_valc_hpf_0_reg.valc_hpf_w14;
	pHPFCtrl->Weight[15] = valc_pcid_valc_hpf_0_reg.valc_hpf_w15;
...
void drvif_color_get_valc_SAT_protect(DRV_valc_sat_ctrl_t* pSATCtrl)
{
	...
	pSATCtrl->Weight[0] = valc_pcid_valc_sat_1_reg.valc_sat_w0;
	pSATCtrl->Weight[1] = valc_pcid_valc_sat_1_reg.valc_sat_w1;
	pSATCtrl->Weight[2] = valc_pcid_valc_sat_1_reg.valc_sat_w2;
	pSATCtrl->Weight[3] = valc_pcid_valc_sat_1_reg.valc_sat_w3;
	pSATCtrl->Weight[4] = valc_pcid_valc_sat_1_reg.valc_sat_w4;
	pSATCtrl->Weight[5] = valc_pcid_valc_sat_1_reg.valc_sat_w5;
	pSATCtrl->Weight[6] = valc_pcid_valc_sat_1_reg.valc_sat_w6;
	pSATCtrl->Weight[7] = valc_pcid_valc_sat_1_reg.valc_sat_w7;

	pSATCtrl->Weight[8] = valc_pcid_valc_sat_0_reg.valc_sat_w8;
	pSATCtrl->Weight[9] = valc_pcid_valc_sat_0_reg.valc_sat_w9;
	pSATCtrl->Weight[10] = valc_pcid_valc_sat_0_reg.valc_sat_w10;
	pSATCtrl->Weight[11] = valc_pcid_valc_sat_0_reg.valc_sat_w11;
	pSATCtrl->Weight[12] = valc_pcid_valc_sat_0_reg.valc_sat_w12;
	pSATCtrl->Weight[13] = valc_pcid_valc_sat_0_reg.valc_sat_w13;
	pSATCtrl->Weight[14] = valc_pcid_valc_sat_0_reg.valc_sat_w14;
	pSATCtrl->Weight[15] = valc_pcid_valc_sat_0_reg.valc_sat_w15;
...
void drvif_color_set_valc_location(char set)
{
	valc_pcid_valc_ctrl_RBUS valc_pcid_valc_ctrl_reg;
	valc_pcid_valc_ctrl_reg.regValue = IoReg_Read32(VALC_PCID_VALC_CTRL_reg);
	valc_pcid_valc_ctrl_reg.valc_location= set;
	//valc_pcid_valc_ctrl_reg.valc_func_en = 1;
	IoReg_Write32(VALC_PCID_VALC_CTRL_reg, valc_pcid_valc_ctrl_reg.regValue);
}
