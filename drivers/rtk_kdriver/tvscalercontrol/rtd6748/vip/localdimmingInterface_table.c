...
/*table0:test*/
	{
                {1, 0, VSYNC_MODE, 0, 0, 0, 1, 1, 0, 0, 0, 0},/*DRV_LDINTERFACE_Basic_Ctrl:\
                ld_mode,seperate_block,send_mode(trigger/dvs/freeRun),send_trigger,out_data_align, in_data_align, as_led_with_cs,as_led_reset,as_force_tx,w_package_repeater,free_run_period, vsync_delay*/
                {8, LD8BIT, 0,LD8BIT,0,LD8BIT,LD8BIT,DATSEP_DEFAULT, 0, 0},/*DRV_LDINTERFACE_Output: \
                outputUnit(real unit),out_format,tailer_unit,tailer_format,header_unit,header_format,multiDelay_format*/
