...
extern DRV_film_table_t2 gFilmInitTable[7];
extern DRV_Intra_Ver2_Table gVipIntra_Set_Ver2_tab;
extern DRV_NEW_UVC gUVCTable[new_UVC_MAX];
//extern DRV_Gamma_BS gBSTable[Blue_Stretch_MAX];//k5l hw remove
...
extern unsigned char PCID_table;
extern unsigned char PCID2_Table;
			...
			if (vpq_file) {
				...
				if(strcmp(File_Title, "VPQGEN")==0){		// check title
					...
					for(i=0; i<File_item; i++){
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_m_defaultYPbPrGainOffsetData,(void*) &m_defaultYPbPrGainOffsetData, sizeof(m_defaultYPbPrGainOffsetData));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_m_defaultVgaGainOffset,(void*) &m_defaultVgaGainOffset, sizeof(m_defaultVgaGainOffset));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_m_defaultColorDataTable,(void*) &m_defaultColorDataTable, sizeof(VIP_TABLE_DATA_STRUCT));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_m_defaultColorFacTable,(void*) &m_defaultColorFacTable, sizeof(VIP_TABLE_DATA_STRUCT));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_m_defaultPictureModeTable, (void*)&m_defaultPictureModeTable, sizeof(VIP_TABLE_DATA_STRUCT_EX));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_m_defaultColorTempTable,(void*) &m_defaultColorTempTable, sizeof(VIP_TABLE_DATA_STRUCT));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_m_defaultVipTable, (void*)&m_defaultVipTable, sizeof(m_defaultVipTable));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_m_customVipTable, (void*)&m_customVipTable, sizeof(m_customVipTable));
//						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_m_customVipTable_demo_tv002, &m_customVipTable_demo_tv002, sizeof(m_customVipTable_demo_tv002));

						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_S_RPC_AutoMA_Flag, (void*)&S_RPC_AutoMA_Flag, sizeof(S_RPC_AutoMA_Flag));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_tVipNewDcti_auto_adjust,(void*) &tVipNewDcti_auto_adjust, sizeof(tVipNewDcti_auto_adjust));
						//VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_gVipDNewDcti_Table, (void*)&gVipDNewDcti_Table, sizeof(gVipDNewDcti_Table));
						//VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_gVipINewDcti_Table,(void*) &gVipINewDcti_Table, sizeof(gVipINewDcti_Table));
						//VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_gVipVcti_Table, (void*)&gVipVcti_Table, sizeof(gVipVcti_Table));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_gVipVcti_lpf_Table,(void*) &gVipVcti_lpf_Table, sizeof(gVipVcti_lpf_Table));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_gVipUV_Delay_TOP_Table,(void*) &gVipUV_Delay_TOP_Table, sizeof(gVipUV_Delay_TOP_Table));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_g_Chroma_Compensation_Curve,(void*) &g_Chroma_Compensation_Curve, sizeof(g_Chroma_Compensation_Curve));
//						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_Dnoise_Coef, &Dnoise_Coef, sizeof(Dnoise_Coef));
//						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_Dnoise_Level, &Dnoise_Level, sizeof(Dnoise_Level));
					//	VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_SUFIR256_CEC1x00_Hamm, &SUFIR256_CEC1x00_Hamm, sizeof(SUFIR256_CEC1x00_Hamm));
					//	VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_SUFIR256_CEP0x75, &SUFIR256_CEP0x75, sizeof(SUFIR256_CEP0x75));
					//	VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_SUFIR256_PM41x5_32, &SUFIR256_PM41x5_32, sizeof(SUFIR256_PM41x5_32));
					//	VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_SUFIR256_PM46_32, &SUFIR256_PM46_32, sizeof(SUFIR256_PM46_32));
					//	VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_SUFIR256_PM56_32, &SUFIR256_PM56_32, sizeof(SUFIR256_PM56_32));
					//	VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_SUFIR256_CLS0x80, &SUFIR256_CLS0x80, sizeof(SUFIR256_CLS0x80));
					//	VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_SUFIR256_Sinc3z_Hamm, &SUFIR256_Sinc3z_Hamm, sizeof(SUFIR256_Sinc3z_Hamm));
					//	VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_SUFIRcls256_96s2_45, &SUFIRcls256_96s2_45, sizeof(SUFIRcls256_96s2_45));
//						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_SU_table_8tap, &SU_table_8tap, sizeof(SU_table_8tap));
					//	VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_SUFIR192_Sinc2x6_Hamm, &SUFIR192_Sinc2x6_Hamm, sizeof(SUFIR192_Sinc2x6_Hamm));
					//	VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_SUFIR192_PM52_32, &SUFIR192_PM52_32, sizeof(SUFIR192_PM52_32));
					//	VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_SUFIR192_Sinc2x4_Hamm, &SUFIR192_Sinc2x4_Hamm, sizeof(SUFIR192_Sinc2x4_Hamm));
					//	VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_SUFIR192_PM56_32, &SUFIR192_PM56_32, sizeof(SUFIR192_PM56_32));
					//	VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_SUFIR192_PM52_36, &SUFIR192_PM52_36, sizeof(SUFIR192_PM52_36));
					//	VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_SUFIR192_Sinc2x2_Hamm, &SUFIR192_Sinc2x2_Hamm, sizeof(SUFIR192_Sinc2x2_Hamm));
					//	VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_SUFIR192_Hann0x70, &SUFIR192_Hann0x70, sizeof(SUFIR192_Hann0x70));
					//	VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_SUFIRcls192_84s2_55, &SUFIRcls192_84s2_55, sizeof(SUFIRcls192_84s2_55));
//						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_SU_table_6tap, &SU_table_6tap, sizeof(SU_table_6tap));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_gVipDirsu_Table, (void*)&gVipDirsu_Table, sizeof(gVipDirsu_Table));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_gSMDtable, (void*)&gSMDtable, sizeof(gSMDtable));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_gHMETable, (void*)&gHMETable, sizeof(gHMETable));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_gHMCTable, (void*)&gHMCTable, sizeof(gHMCTable));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_gPanTable, (void*)&gPanTable, sizeof(gPanTable));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_gFilmInitTable,(void*) &gFilmInitTable, sizeof(gFilmInitTable));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_gVipIntra_Set_Ver2_tab, (void*)&gVipIntra_Set_Ver2_tab, sizeof(gVipIntra_Set_Ver2_tab));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_gUVCTable,(void*) &gUVCTable, sizeof(gUVCTable));
						//VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_gBSTable, (void*)&gBSTable, sizeof(gBSTable));//k5l hw remove
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_gVipSupk_Mask,(void*) &gVipSupk_Mask, sizeof(gVipSupk_Mask));
//						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_gVipSkipir_Ring, &gVipSkipir_Ring, sizeof(gVipSkipir_Ring));
//						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_gVipSkipir_Islet, &gVipSkipir_Islet, sizeof(gVipSkipir_Islet));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_gVipEmfMk2, (void*)&gVipEmfMk2, sizeof(gVipEmfMk2));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_gVip2Dpk_Seg, (void*)&gVip2Dpk_Seg, sizeof(gVip2Dpk_Seg));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_gVip2Dpk_Tex_Detect,(void*) &gVip2Dpk_Tex_Detect, sizeof(gVip2Dpk_Tex_Detect));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_gVipOSD_sharp, (void*)&gVipOSD_sharp, sizeof(gVipOSD_sharp));
						//VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_D_DLTI_Table, (void*)&D_DLTI_Table, sizeof(D_DLTI_Table));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_gVipUn_Shp_Mask, (void*)&gVipUn_Shp_Mask, sizeof(gVipUn_Shp_Mask));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_gCMTable, (void*)&gCMTable, sizeof(gCMTable));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_Curve_boundary_table,(void*) &Curve_boundary_table, sizeof(Curve_boundary_table));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_Advance_control_table, (void*)&Advance_control_table, sizeof(Advance_control_table));
						//VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_sRGB_Hue_Mapping, (void*)&sRGB_Hue_Mapping, sizeof(sRGB_Hue_Mapping));
						//VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_sRGB_RGB_LUT, (void*)&sRGB_RGB_LUT, sizeof(sRGB_RGB_LUT));
						//VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_sRGB_YUV2RGB, (void*)&sRGB_YUV2RGB, sizeof(sRGB_YUV2RGB));
						//VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_sRGB_RGB2YUV, (void*)&sRGB_RGB2YUV, sizeof(sRGB_RGB2YUV));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_sRGB_APPLY, (void*)&sRGB_APPLY, sizeof(sRGB_APPLY));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_YUV2RGB_Matrix_COEF_601_YCbCr, (void*)&YUV2RGB_Matrix_COEF_601_YCbCr, sizeof(YUV2RGB_Matrix_COEF_601_YCbCr));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_tYUV2RGB_COEF_TVBOX_SD, (void*)&tYUV2RGB_COEF_TVBOX_SD, sizeof(tYUV2RGB_COEF_TVBOX_SD));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_tYUV2RGB_COEF_TVBOX_HD, (void*)&tYUV2RGB_COEF_TVBOX_HD, sizeof(tYUV2RGB_COEF_TVBOX_HD));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_tYUV2RGB_COEF_601_YCbCr_NOClampY, (void*)&tYUV2RGB_COEF_601_YCbCr_NOClampY, sizeof(tYUV2RGB_COEF_601_YCbCr_NOClampY));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_tYUV2RGB_COEF,(void*) &tYUV2RGB_COEF, sizeof(tYUV2RGB_COEF));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_ConBriMapping_Offset_Table, (void*)&ConBriMapping_Offset_Table, sizeof(ConBriMapping_Offset_Table));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_AVBlackLevelMapping_Table, (void*)&AVBlackLevelMapping_Table, sizeof(AVBlackLevelMapping_Table));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_ATVBlackLevelMapping_Table, (void*)&ATVBlackLevelMapping_Table, sizeof(ATVBlackLevelMapping_Table));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_tRGB2YUV_COEF_709_YUV_0_255, (void*)&tRGB2YUV_COEF_709_YUV_0_255, sizeof(tRGB2YUV_COEF_709_YUV_0_255));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_tRGB2YUV_COEF_709_YUV_16_235, (void*)&tRGB2YUV_COEF_709_YUV_16_235, sizeof(tRGB2YUV_COEF_709_YUV_16_235));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_tRGB2YUV_COEF_709_RGB_0_255, (void*)&tRGB2YUV_COEF_709_RGB_0_255, sizeof(tRGB2YUV_COEF_709_RGB_0_255));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_tRGB2YUV_COEF_709_RGB_16_235,(void*) &tRGB2YUV_COEF_709_RGB_16_235, sizeof(tRGB2YUV_COEF_709_RGB_16_235));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_tRGB2YUV_COEF_601_RGB_0_255, (void*)&tRGB2YUV_COEF_601_RGB_0_255, sizeof(tRGB2YUV_COEF_601_RGB_0_255));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_tRGB2YUV_COEF_601_RGB_16_235, (void*)&tRGB2YUV_COEF_601_RGB_16_235, sizeof(tRGB2YUV_COEF_601_RGB_16_235));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_tRGB2YUV_COEF_601_YCbCr_0_255, (void*)&tRGB2YUV_COEF_601_YCbCr_0_255, sizeof(tRGB2YUV_COEF_601_YCbCr_0_255));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_tRGB2YUV_COEF_601_YCbCr_16_235,(void*) &tRGB2YUV_COEF_601_YCbCr_16_235, sizeof(tRGB2YUV_COEF_601_YCbCr_16_235));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_tRGB2YUV_COEF_601_YCbCr_16_255, (void*)&tRGB2YUV_COEF_601_YCbCr_16_255, sizeof(tRGB2YUV_COEF_601_YCbCr_16_255));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_tRGB2YUV_COEF_TVBOX_720, (void*)&tRGB2YUV_COEF_TVBOX_720, sizeof(tRGB2YUV_COEF_TVBOX_720));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_tRGB2YUV_COEF_TVBOX_1080, (void*)&tRGB2YUV_COEF_TVBOX_1080, sizeof(tRGB2YUV_COEF_TVBOX_1080));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_tRGB2YUV_COEF, (void*)&tRGB2YUV_COEF, sizeof(tRGB2YUV_COEF));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_Local_Dimming_Table,(void*) &Local_Dimming_Table, sizeof(Local_Dimming_Table));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_LD_Backlight_Profile_Interpolation_table,(void*) &LD_Backlight_Profile_Interpolation_table, sizeof(LD_Backlight_Profile_Interpolation_table));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_LD_Data_Compensation_NewMode_2DTable,(void*) &LD_Data_Compensation_NewMode_2DTable, sizeof(LD_Data_Compensation_NewMode_2DTable));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_DI_MA_Init_Table, (void*)&DI_MA_Init_Table, sizeof(DI_MA_Init_Table));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_DI_MA_Adjust_Table,(void*) &DI_MA_Adjust_Table, sizeof(DI_MA_Adjust_Table));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_di_TNR_XC_table,(void*) &di_TNR_XC_table, sizeof(di_TNR_XC_table));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_Scaler_DI_Coef_table, (void*)&Scaler_DI_Coef_table, sizeof(Scaler_DI_Coef_table));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_Adaptive_Gamma_Ctrl_Table, (void*)&Adaptive_Gamma_Ctrl_Table, sizeof(Adaptive_Gamma_Ctrl_Table));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_FIR_Coef_Ctrl, (void*)&FIR_Coef_Ctrl, sizeof(FIR_Coef_Ctrl));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_TwoStepSU_Table, (void*)&TwoStepSU_Table, sizeof(TwoStepSU_Table));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_ScaleDown_COEF_TAB,(void*) &ScaleDown_COEF_TAB, sizeof(ScaleDown_COEF_TAB));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_PCID_table, (void*)&PCID_table, sizeof(PCID_table));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_PCID2_Table, (void*)&PCID2_Table, sizeof(PCID2_Table));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_PCID2_Pol_Table_R,(void*) &PCID2_Pol_Table_R, sizeof(PCID2_Pol_Table_R));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_PCID2_Pol_Table_G, (void*)&PCID2_Pol_Table_G, sizeof(PCID2_Pol_Table_G));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_PCID2_Pol_Table_B, (void*)&PCID2_Pol_Table_B, sizeof(PCID2_Pol_Table_B));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_pq_misc_MA_SNR_IESM_TBL, (void*)&pq_misc_MA_SNR_IESM_TBL, sizeof(pq_misc_MA_SNR_IESM_TBL));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_t_inv_GAMMA, (void*)&t_inv_GAMMA, sizeof(t_inv_GAMMA));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_t_gamma_curve_22, (void*)&t_gamma_curve_22, sizeof(t_gamma_curve_22));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_Power1div22Gamma,(void*) &Power1div22Gamma, sizeof(Power1div22Gamma));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_Power22InvGamma,(void*) &Power22InvGamma, sizeof(Power22InvGamma));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_LinearInvGamma, (void*)&LinearInvGamma, sizeof(LinearInvGamma));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_LEDOutGamma, (void*)&LEDOutGamma, sizeof(LEDOutGamma));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_gVip_Profile_Table, (void*)&gVip_Profile_Table, sizeof(gVip_Profile_Table));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_PQ_ByPass_Struct, (void*)&PQ_ByPass_Struct, sizeof(PQ_ByPass_Struct));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_PQ_check_source_table, (void*)&PQ_check_source_table, sizeof(PQ_check_source_table));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_PQ_check_register_table,(void*) &PQ_check_register_table, sizeof(PQ_check_register_table));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_PQ_check_register_diff_table, (void*)&PQ_check_register_diff_table, sizeof(PQ_check_register_diff_table));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_I_De_XC_TBL, (void*)&I_De_XC_TBL, sizeof(I_De_XC_TBL));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_I_De_Contour_TBL,(void*) &I_De_Contour_TBL, sizeof(I_De_Contour_TBL));
						//VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_BOE_RGBW_TAB_160624, (void*)&BOE_RGBW_TAB_160624, sizeof(BOE_RGBW_TAB_160624));
						//VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_BOE_RGBW_TAB_160713,(void*) &BOE_RGBW_TAB_160713, sizeof(BOE_RGBW_TAB_160713));
						//VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_Output_InvOutput_Gamma,(void*) &Output_InvOutput_Gamma, sizeof(Output_InvOutput_Gamma));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_hdr_table, (void*)&hdr_table, sizeof(hdr_table));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_hdr_YUV2RGB,(void*) &hdr_YUV2RGB, sizeof(hdr_YUV2RGB));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_hdr_RGB2OPT, (void*)&hdr_RGB2OPT, sizeof(hdr_RGB2OPT));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_HDR10_3DLUT_17x17x17, (void*)&HDR10_3DLUT_17x17x17, sizeof(HDR10_3DLUT_17x17x17));
//						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_EOTF_LUT_HLG_DEFAULT, &EOTF_LUT_HLG_DEFAULT, sizeof(EOTF_LUT_HLG_DEFAULT));
//						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_OETF_LUT_HLG_DEFAULT, &OETF_LUT_HLG_DEFAULT, sizeof(OETF_LUT_HLG_DEFAULT));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_EOTF_LUT_R, (void*)&EOTF_LUT_R, sizeof(EOTF_LUT_R));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_OETF_LUT_R, (void*)&OETF_LUT_R, sizeof(OETF_LUT_R));
						//VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_Tone_Mapping_LUT_R, &Tone_Mapping_LUT_R, sizeof(Tone_Mapping_LUT_R));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_HDR10_3DLUT_24x24x24, (void*)&HDR10_3DLUT_24x24x24, sizeof(HDR10_3DLUT_24x24x24));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_HLG_3DLUT_24x24x24,(void*) &HLG_3DLUT_24x24x24, sizeof(HLG_3DLUT_24x24x24));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_HLG_OETF_LUT_R, (void*)&HLG_OETF_LUT_R, sizeof(HLG_OETF_LUT_R));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_HLG_EOTF_LUT_R, (void*)&HLG_EOTF_LUT_R, sizeof(HLG_EOTF_LUT_R));
#if 0	/* juwen, move to "tc_hdr", elieli */
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_TCHDR_Table, &TCHDR_Table, sizeof(TCHDR_Table));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_TCHDR_COEF_C_LUT_TBL, &TCHDR_COEF_C_LUT_TBL, sizeof(TCHDR_COEF_C_LUT_TBL));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_TCHDR_COEF_I_LUT_TBL, &TCHDR_COEF_I_LUT_TBL, sizeof(TCHDR_COEF_I_LUT_TBL));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_TCHDR_COEF_S_LUT_TBL, &TCHDR_COEF_S_LUT_TBL, sizeof(TCHDR_COEF_S_LUT_TBL));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_TCHDR_COEF_P_LUT_TBL, &TCHDR_COEF_P_LUT_TBL, sizeof(TCHDR_COEF_P_LUT_TBL));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_TCHDR_COEF_D_LUT_TBL, &TCHDR_COEF_D_LUT_TBL, sizeof(TCHDR_COEF_D_LUT_TBL));
#endif
					}
	...
	switch (cmd){
		...
		case VPQUT_IOC_REG_BIT:
		{
			...
			if (copy_from_user(&buf, (int __user *)arg, sizeof(VPQUT_REG_struct))) {
				...
				unsigned int bit0 = 0, bit1 = 0; //coverity tainted_data
				...
				if(buf.type == 'r'){
					...
					buf.value = IoReg_Read32(buf.reg);
					buf.value = (buf.value & (andREG_Table2[bit0] & andREG_Table1[bit1]))>>bit1;
					if(copy_to_user((void __user *)arg, (void *)&buf, sizeof(VPQUT_REG_struct))){
					ret = -1;
					}
				}else if(buf.type == 'w'){
					printk(KERN_EMERG "VPQUT_IOC_REG_BIT write\n");
					buf.value = (IoReg_Read32(buf.reg) & ((andREG_Table1[bit0]<<1) | (andREG_Table2[bit1]>>1))) | (buf.value<<bit1);
					IoReg_Write32(buf.reg, buf.value);
				}
			}
		}
