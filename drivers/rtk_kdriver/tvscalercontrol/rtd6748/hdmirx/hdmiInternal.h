...
typedef enum
{
    ...
    HDMIMS_SUCCESS_NORMAL_BY_OFMS_HV = 0x00,
    HDMIMS_SUCCESS_VRR_BY_VIC,
    HDMIMS_SUCCESS_VRR_BY_OFMS,
    HDMIMS_SUCCESS_NO_H_WITH_VIC,
    HDMIMS_SUCCESS_NO_H_FIND_TABLE_BY_OFMS_DE,
    HDMIMS_SUCCESS_NUM = 0x0F,

    //-------------Measure fail code--------------
    HDMIMS_FAIL_OFMS_NOT_FINISH = 0x10,
    HDMIMS_FAIL_HACT_OVER_HTOTAL,
    HDMIMS_FAIL_VACT_OVER_VTOTAL,
    HDMIMS_FAIL_HACT_UNDER_MIN,
    HDMIMS_FAIL_VACT_UNDER_MIN,
    HDMIMS_FAIL_IS_SKIP_TIMING,
    HDMIMS_FAIL_HTOTAL_DIFF,
    HDMIMS_FAIL_VTOTAL_DIFF,
    HDMIMS_FAIL_HACT_DIFF,
    HDMIMS_FAIL_VACT_DIFF,
    HDMIMS_FAIL_HFREQ_DIFF,
    HDMIMS_FAIL_VFREQ_DIFF,
    HDMIMS_FAIL_SEARCH_VIC_TABLE,
    HDMIMS_FAIL_CORRECTION_BY_VIC,
}HDMIMS_RESULT_CODE;
...
extern HDMIMS_RESULT_CODE newbase_hdmims_measure_video(unsigned char port, HDMI_TIMING_T *tm, unsigned char frl_mode);
...
extern unsigned char lib_hdmims_offline_measure(HDMI_TIMING_T *tm, unsigned char frl_mode, OFFMS_MSMODE ms_mode);
...
extern unsigned int lib_hdmims_get_onms3_vfreq(void);
...
extern void lib_hdmims_offms_config_before_startms(OFFMS_MSMODE ms_mode);
...
typedef enum{
    HDCP22_ERROR_NORMAL,
    HDCP22_ERROR_TX_READ_HPRIME_TIMEOUT,
}HDCP22_ERROR_TYPE;

typedef struct{
	unsigned char scdc_tmds_config_update;
	unsigned char write_edid_ex;
	unsigned char resume_first_display;
	HDCP22_ERROR_TYPE  hdcp22_error_type;
	unsigned int retry_hdcp_cnt;
	unsigned int retry_phy_cnt;
}HDMI_FLOW_FLAG_T;

typedef enum
{
    HDMI_OPTION_CEC_STATUS = 0,     ///< CEC开关
    HDMI_OPTION_ARC_STATUS,         ///< ARC开关
    HDMI_OPTION_EARC_STATUS,        ///< EARC开关
    HDMI_OPTION_WAKEUP_STATUS,      ///< TV跟随CEC设备开机
    HDMI_OPTION_SYSTEM_CEC_CONTROL, ///< CEC控制开关
    HDMI_OPTION_MAX
}HDMI_CEC_OPTION_TYPE_E;
