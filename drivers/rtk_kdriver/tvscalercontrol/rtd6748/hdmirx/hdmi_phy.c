...
HDMI_PHY_PARAM_T hdmi_phy_param[] =
{
	...
	{3319,2844,  0x10,0x0,0x0,0x1,0x0,  0x1,0x3,0xb,0x0,0x2,  0x3,0x0,0x1,0x0,0x0,  0x0,0x2,0x1,(0x2<<2),0x0,   0x1,0x0,0x0,0x0,0x0,  0x0,0x0,0x3,0x0, "T2"},
	...
	{1659,1422,  0x10,0x1,0x0,0x0,0x1,  0x1,0x3,0xd,0x0,0x2,  0x3,0x1,0x2,0x1,0x1,  0x0,0x2,0x1,(0x8<<2),0x0,   0x1,0x0,0x0,0x0,0x0,  0x0,0x0,0x3,0x0, "T4"},	
	...
	{830,590,    0x10,0x0,0x0,0x0,0x1,  0x1,0x3,0xd,0x0,0x2,  0x3,0x2,0x3,0x2,0x1,  0x0,0x2,0x1,(0x8<<2),0x0,   0x0,0x0,0x0,0x0,0x0,  0x0,0x0,0x3,0x0, "T6"},	
	...
	{415,356,    0x24,0x0,0x0,0x0,0x1,  0x1,0x3,0xb,0x1,0x2,  0x3,0x3,0x3,0x2,0x1,  0x0,0x2,0x1,(0x8<<2),0x0,   0x0,0x0,0x0,0x0,0x0,  0x0,0x0,0x3,0x0, "T8"},
...
unsigned char CLK_Wake_Up=0;	//Need to be modified
...
void lib_hdmi_stb_tmds_clk_wakeup_en(unsigned char en)
{
	...
	if (en) {
		...
		hdmi_mask(HDMIRX_2P0_PHY_Z0POW_reg, ~(HDMIRX_2P0_PHY_Z0POW_reg_z0_z300pow_mask|HDMIRX_2P0_PHY_Z0POW_reg_z0_z0pow_ck_mask), 
			(HDMIRX_2P0_PHY_Z0POW_reg_z0_z300pow_mask|HDMIRX_2P0_PHY_Z0POW_reg_z0_z0pow_ck_mask)); //[1] Noff [0]poff :0 =>normal
		...
		hdmi_mask(HDMIRX_2P0_PHY_Z0POW_reg,~(_BIT21|_BIT20),(port1_window<<20));	
		//port-1 CK-detect(standby mode use) hysteresis window select
		
		hdmi_mask(HDMIRX_2P0_PHY_MD_reg,~(_BIT5),0);		// REG_CK_LATCH=0, CK_LATCH=0
		hdmi_mask(HDMIRX_2P0_PHY_MD_reg,~(_BIT5),_BIT5);	 // REG_CK_LATCH=1, CK_LATCH=1
...
void lib_hdmi_z0_set(unsigned char port, unsigned char lane, unsigned char enable, unsigned char CLK_Wake_Up)
{
	...
	unsigned int Z0bmask = HDMIRX_2P0_PHY_Z0POW_reg_z0_z0pow_ck(1<<(port%HDMI_2P0_TOTAL_NUM))|HDMIRX_2P0_PHY_Z0POW_reg_z0_z0pow_b(1<<(port%HDMI_2P0_TOTAL_NUM))|
									HDMIRX_2P0_PHY_Z0POW_reg_z0_z0pow_g(1<<(port%HDMI_2P0_TOTAL_NUM))|HDMIRX_2P0_PHY_Z0POW_reg_z0_z0pow_r(1<<(port%HDMI_2P0_TOTAL_NUM));
	...
	hdmi_mask(HDMIRX_2P0_PHY_Z0POW_reg, ~Z0bmask, enable?bmask:0);
	...
	HDMI_INFO("Z0POW_reg=%x, TOP_IN_reg=%x, bmask=%x\n", hdmi_in(HDMIRX_2P0_PHY_Z0POW_reg),hdmi_in(HDMIRX_2P0_PHY_TOP_IN_reg),bmask);
...
void lib_hdmi_set_dfe(unsigned char nport, unsigned int b, unsigned char dfe_mode, unsigned char lane_mode)
{
	...
	hdmi_mask(DFE_REG_DFE_MODE_reg,
		...
		DFE_P0_REG_DFE_MODE_P0_servo_delay_p0(1)|DFE_P0_REG_DFE_MODE_P0_gray_en_p0(0xBF)|
		DFE_P0_REG_DFE_MODE_P0_tap0_notrans_p0_mask));
...
// LCB6			(DFE_REG_DFE_LIMIT0_tap1_min(0x35)|DFE_REG_DFE_LIMIT0_tap2_max(0x0a)|DFE_REG_DFE_LIMIT0_tap2_min(0x5)));
	...
	//Vth_min=0,Vth_max=0x7,Vth_th=7,Tap0_th=1
	hdmi_mask(DFE_REG_DFE_LIMIT1_reg,~(DFE_P0_REG_DFE_LIMIT1_P0_vth_min_p0_mask|DFE_P0_REG_DFE_LIMIT1_P0_vth_max_p0_mask|DFE_P0_REG_DFE_LIMIT1_P0_vth_threshold_p0_mask|DFE_P0_REG_DFE_LIMIT1_P0_tap0_threshold_p0_mask|DFE_P0_REG_DFE_LIMIT1_P0_tap0_adjust_p0_mask|DFE_P0_REG_DFE_LIMIT1_P0_tap1_trans_p0_mask),(DFE_P0_REG_DFE_LIMIT1_P0_vth_min_p0(0)|DFE_P0_REG_DFE_LIMIT1_P0_vth_max_p0(0x7)|DFE_P0_REG_DFE_LIMIT1_P0_vth_threshold_p0(0x7)|DFE_P0_REG_DFE_LIMIT1_P0_tap0_threshold_p0(0x1)|DFE_P0_REG_DFE_LIMIT1_P0_tap0_adjust_p0(0x02)|DFE_P0_REG_DFE_LIMIT1_P0_tap1_trans_p0_mask));
...
void lib_hdmi_dfe_manual_set(unsigned char nport, unsigned char lane_mode)
{
	...
	hdmi_mask(DFE_REG_DFE_MODE_reg,~DFE_P0_REG_DFE_MODE_P0_gray_en_p0_mask,DFE_P0_REG_DFE_MODE_P0_gray_en_p0(0xBF));//Vth  binary code
