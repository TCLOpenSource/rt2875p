...
#define HDMI_AV_OUT_DISABLE_VSC_PRE_ACTION()       Hdmi_Av_Out_Disable_Vsc_Pre_Action()
...
#define SET_HDMI_DOLBY_VSIF_MODE(x,y)     set_HDMI_Dolby_VSIF_mode(x,y)
