...
static int g_arc_spdif_ch = DEF_ARC_CHANNEL;
...
/*------------------------------------------------
 * Func  : hdmi_arc_is_earc_enabled
 *
 * Desc  : check the ARC is enabled or not 
 *
 * Param : N/A
 *
 * Retn  : 0 : eARC disable, 1 : eARC enabled
 *-----------------------------------------------*/
int hdmi_arc_is_earc_enabled(void)
{
    return EARCMISC_earc_ana_0_get_pow_earc_driver(rtd_inl(EARCMISC_earc_ana_0_reg));
}
