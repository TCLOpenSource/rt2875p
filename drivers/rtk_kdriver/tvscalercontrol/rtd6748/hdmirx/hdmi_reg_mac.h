...
#define  HDMI_HDCP_PCR_enc_tog_sel_mask                                  HDMI_P0_HDCP_PCR_enc_tog_sel_mask
...
#define  HDMI_HDCP_PCR_enc_tog_sel(data)                                 HDMI_P0_HDCP_PCR_enc_tog_sel(data)
...
#define  HDMI_HDCP_PCR_get_enc_tog_sel(data)                             HDMI_P0_HDCP_PCR_get_enc_tog_sel(data)
