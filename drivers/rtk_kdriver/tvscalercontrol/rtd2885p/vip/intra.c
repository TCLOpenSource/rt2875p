...
void drvif_color_Intra_Ver2_table(DRV_Intra_Ver2_Table *ptr)
{
	...
	// chen 170531
	di_im_di_nintra_dyn_search_range_th_RBUS di_im_di_nintra_dyn_search_range_th;
	// end chen 170531
	...
	// chen 170531
	di_im_di_nintra_dyn_search_range_th.regValue	= IoReg_Read32(DI_IM_DI_NINTRA_DYN_SEARCH_RANGE_TH_reg);
	// end chen 170531
	...
	// chen 170531
	di_im_di_nintra_dyn_search_range_th.nintra_dy_vertical_diff_th_en		=ptr->Intra_direction_refine.nintra_dy_vertical_diff_th_en;
	di_im_di_nintra_dyn_search_range_th.nintra_diff_s_v_divd						=ptr->Intra_direction_refine.nintra_diff_s_v_divd;
	di_im_di_nintra_dyn_search_range_th.nintra_dy_hdiff_th_en						=ptr->Intra_direction_refine.nintra_dy_hdiff_th_en;
	di_im_di_nintra_dyn_search_range_th.nintra_hdiff_th2_lo							=ptr->Intra_direction_refine.nintra_hdiff_th2_lo;
	di_im_di_nintra_dyn_search_range_th.nintra_hdiff_th1_lo							=ptr->Intra_direction_refine.nintra_hdiff_th1_lo;
	// end chen 170531
	...
	// chen 170531
	IoReg_Write32(DI_IM_DI_NINTRA_DYN_SEARCH_RANGE_TH_reg, di_im_di_nintra_dyn_search_range_th.regValue);
	// end chen 170531
