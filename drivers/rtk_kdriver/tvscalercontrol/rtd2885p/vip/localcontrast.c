...
void drvif_color_set_LC_Tonemapping_PQmask(DRV_LC_ToneMapping_PQmask *tmap_pqmask)
{
	...
	lc_lc_tonemapping_pqmask_offset_reg.lc_pqmask_tmap_gain=tmap_pqmask->lc_PQmask_tmap_gain;
...
void drvif_color_set_LC_Sharpness_PQmask(DRV_LC_Sharpness_PQmask *shp_pqmask)
{
	...
	lc_lc_tonemapping_pqmask_offset_reg.regValue = IoReg_Read32(LC_LC_ToneMapping_PQmask_Offset_reg);
	lc_lc_tonemapping_pqmask_offset_reg.lc_pqmask_shp_offset=shp_pqmask->lc_PQmask_shp_offset;
	IoReg_Write32(LC_LC_ToneMapping_PQmask_Offset_reg, lc_lc_tonemapping_pqmask_offset_reg.regValue);
...
{
	lc_lc_global_ctrl0_RBUS lc_lc_global_ctrl0_reg;
	lc_lc_global_ctrl1_RBUS blu_lc_global_ctrl1;
	lc_lc_global_ctrl0_reg.regValue = IoReg_Read32(LC_LC_Global_Ctrl0_reg);

	lc_lc_global_ctrl0_reg.lc_rgb2yuv_en = value;

	IoReg_Write32(LC_LC_Global_Ctrl0_reg, lc_lc_global_ctrl0_reg.regValue);
...
{
	lc_lc_texture_gain_RBUS lc_lc_texture_gain_reg;
	lc_lc_texture_tmap_th0_RBUS lc_lc_texture_tmap_th0_reg;
	lc_lc_texture_tmap_th1_RBUS lc_lc_texture_tmap_th1_reg;
	lc_lc_texture_tmap_curve0_RBUS lc_lc_texture_tmap_curve0_reg;
	lc_lc_texture_tmap_curve1_RBUS lc_lc_texture_tmap_curve1_reg;
	lc_lc_texture_shp_th0_RBUS lc_lc_texture_shp_th0_reg;
	lc_lc_texture_shp_th1_RBUS lc_lc_texture_shp_th1_reg;
	lc_lc_texture_shp_curve0_RBUS lc_lc_texture_shp_curve0_reg;
	lc_lc_texture_shp_curve1_RBUS lc_lc_texture_shp_curve1_reg;
	lc_lc_global_ctrl1_RBUS blu_lc_global_ctrl1;
	
	lc_lc_texture_gain_reg.regValue = IoReg_Read32(LC_LC_Texture_Gain_reg);
	lc_lc_texture_gain_reg.lc_tex_gain = tex->lc_tex_ctrl.lc_tex_gain;
	lc_lc_texture_gain_reg.lc_tex_shp_en= tex->lc_tex_ctrl.lc_tex_shp_en;
	lc_lc_texture_gain_reg.lc_tex_tmap_en= tex->lc_tex_ctrl.lc_tex_tmap_en;
	IoReg_Write32(LC_LC_Texture_Gain_reg, lc_lc_texture_gain_reg.regValue);

	lc_lc_texture_tmap_th0_reg.regValue = IoReg_Read32(LC_LC_Texture_tmap_th0_reg);
	lc_lc_texture_tmap_th0_reg.lc_tex_tmap_th0 = 0; // 1st th is fixed to 0
	lc_lc_texture_tmap_th0_reg.lc_tex_tmap_th1 = tex->lc_tex_tmap.th[0];
	lc_lc_texture_tmap_th0_reg.lc_tex_tmap_th2 = tex->lc_tex_tmap.th[1];
	IoReg_Write32(LC_LC_Texture_tmap_th0_reg, lc_lc_texture_tmap_th0_reg.regValue);

	lc_lc_texture_tmap_th1_reg.regValue = IoReg_Read32(LC_LC_Texture_tmap_th1_reg);
	lc_lc_texture_tmap_th1_reg.lc_tex_tmap_th3 = tex->lc_tex_tmap.th[2];
	lc_lc_texture_tmap_th1_reg.lc_tex_tmap_th4 = 255;  // the last th is fixed to 255
	IoReg_Write32(LC_LC_Texture_tmap_th1_reg, lc_lc_texture_tmap_th1_reg.regValue);

	lc_lc_texture_tmap_curve0_reg.regValue = IoReg_Read32(LC_LC_Texture_tmap_curve0_reg);
	lc_lc_texture_tmap_curve0_reg.lc_tex_tmap_curve0 = tex->lc_tex_tmap.curve[0];
	lc_lc_texture_tmap_curve0_reg.lc_tex_tmap_curve1 = tex->lc_tex_tmap.curve[1];
	lc_lc_texture_tmap_curve0_reg.lc_tex_tmap_curve2 = tex->lc_tex_tmap.curve[2];
	IoReg_Write32(LC_LC_Texture_tmap_curve0_reg, lc_lc_texture_tmap_curve0_reg.regValue);

	lc_lc_texture_tmap_curve1_reg.regValue = IoReg_Read32(LC_LC_Texture_tmap_curve1_reg);
	lc_lc_texture_tmap_curve1_reg.lc_tex_tmap_curve3 = tex->lc_tex_tmap.curve[3];
	lc_lc_texture_tmap_curve1_reg.lc_tex_tmap_curve4 = tex->lc_tex_tmap.curve[4];
	IoReg_Write32(LC_LC_Texture_tmap_curve1_reg, lc_lc_texture_tmap_curve1_reg.regValue);

	lc_lc_texture_shp_th0_reg.regValue = IoReg_Read32(LC_LC_Texture_shp_th0_reg);
	lc_lc_texture_shp_th0_reg.lc_tex_shp_th0 = 0; // 1st th is fixed to 0
	lc_lc_texture_shp_th0_reg.lc_tex_shp_th1 = tex->lc_tex_shp.th[0];
	lc_lc_texture_shp_th0_reg.lc_tex_shp_th2 = tex->lc_tex_shp.th[1];
	IoReg_Write32(LC_LC_Texture_shp_th0_reg, lc_lc_texture_shp_th0_reg.regValue);

	lc_lc_texture_shp_th1_reg.regValue = IoReg_Read32(LC_LC_Texture_shp_th1_reg);
	lc_lc_texture_shp_th1_reg.lc_tex_shp_th3 = tex->lc_tex_shp.th[2];
	lc_lc_texture_shp_th1_reg.lc_tex_shp_th4 = 255;  // the last th is fixed to 255
	IoReg_Write32(LC_LC_Texture_shp_th1_reg, lc_lc_texture_shp_th1_reg.regValue);

	lc_lc_texture_shp_curve0_reg.regValue = IoReg_Read32(LC_LC_Texture_shp_curve0_reg);
	lc_lc_texture_shp_curve0_reg.lc_tex_shp_curve0 = tex->lc_tex_shp.curve[0];
	lc_lc_texture_shp_curve0_reg.lc_tex_shp_curve1 = tex->lc_tex_shp.curve[1];
	lc_lc_texture_shp_curve0_reg.lc_tex_shp_curve2 = tex->lc_tex_shp.curve[2];
	IoReg_Write32(LC_LC_Texture_shp_curve0_reg, lc_lc_texture_shp_curve0_reg.regValue);

	lc_lc_texture_shp_curve1_reg.regValue = IoReg_Read32(LC_LC_Texture_shp_curve1_reg);
	lc_lc_texture_shp_curve1_reg.lc_tex_shp_curve3 = tex->lc_tex_shp.curve[3];
	lc_lc_texture_shp_curve1_reg.lc_tex_shp_curve4 = tex->lc_tex_shp.curve[4];
	IoReg_Write32(LC_LC_Texture_shp_curve1_reg, lc_lc_texture_shp_curve1_reg.regValue);
...
{
	lc_lc_texture_crop0_RBUS lc_lc_texture_crop0_reg;
	lc_lc_texture_crop1_RBUS lc_lc_texture_crop1_reg;
	lc_lc_global_ctrl1_RBUS blu_lc_global_ctrl1;
	
	lc_lc_texture_crop0_reg.regValue = IoReg_Read32(LC_LC_Texture_crop0_reg);
	lc_lc_texture_crop0_reg.lc_crop_en = crop->crop_en;
	lc_lc_texture_crop0_reg.lc_hact_sta = crop->hact_sta;
	lc_lc_texture_crop0_reg.lc_hact_end = crop->hact_end;
	IoReg_Write32(LC_LC_Texture_crop0_reg, lc_lc_texture_crop0_reg.regValue);

	lc_lc_texture_crop1_reg.regValue = IoReg_Read32(LC_LC_Texture_crop1_reg);
	lc_lc_texture_crop1_reg.lc_vact_sta = crop->vact_sta;
	lc_lc_texture_crop1_reg.lc_vact_end = crop->vact_end;
	IoReg_Write32(LC_LC_Texture_crop1_reg, lc_lc_texture_crop1_reg.regValue);
