...
unsigned char RgnIncludeTbl_1_10[3][4] =
{
	/* 0*/ {  0,  1,  2  ,3  },
	/* 1*/ {  4,  5,  0  ,0  },
	/* 2*/ {  6,  7,  8  ,9  }
...
unsigned char RgnIncludeTbl_4_7[4][4] =
{
	/* 0*/ {   0,   1,   2,  3  },
	/* 1*/ {   4,   5,   6,  7, },
	/* 2*/ {   8,   9,  10, 11, },
...
void drvif_color_set_pcid_data_setting(DRV_pcid_data_t* pPcid2Setting)
{
	...
	pcid_ctrl_reg.polarity_mode = pPcid2Setting->polarity_mode;
...
void drvif_color_set_pcid_SpatialPattern(DRV_pcid_pattern_ctrl_t* pPATCtrl)
{
	unsigned int i=0;
	unsigned int value=0;

	pcid_pcid_sp_ctrl_RBUS pcid_pcid_sp_ctrl_reg;
	pcid_pcid_sp_0_RBUS pcid_pcid_sp_0_reg;
	pcid_pcid_sp_1_RBUS pcid_pcid_sp_1_reg;
	pcid_pcid_sp_2_RBUS pcid_pcid_sp_2_reg;
	pcid_pcid_sp_l3_RBUS pcid_pcid_sp_l3_reg;
	//pcid_pcid_db_RBUS pcid_pcid_db_reg;
	//ppoverlay_display_timing_ctrl2_RBUS pcid_pcid_db_reg;

	//pcid_pcid_db_reg.regValue = IoReg_Fpga_Read32(PPOVERLAY_Display_Timing_CTRL2_reg);
	//pcid_pcid_db_reg.lineod_en = 0;
	//IoReg_Fpga_Write32(PPOVERLAY_Display_Timing_CTRL2_reg, pcid_pcid_db_reg.regValue);


	pcid_pcid_sp_ctrl_reg.regValue = IoReg_Read32(PCID_PCID_SP_CTRL_reg);
	pcid_pcid_sp_0_reg.regValue = IoReg_Read32(PCID_PCID_SP_0_reg);
	pcid_pcid_sp_1_reg.regValue = IoReg_Read32(PCID_PCID_SP_1_reg);
	pcid_pcid_sp_2_reg.regValue = IoReg_Read32(PCID_PCID_SP_2_reg);
	pcid_pcid_sp_l3_reg.regValue = IoReg_Read32(PCID_PCID_SP_L3_reg);

	pcid_pcid_sp_ctrl_reg.pcid_sp_h = pPATCtrl->Cyclic_H;
	pcid_pcid_sp_ctrl_reg.pcid_sp_v = pPATCtrl->Cyclic_V;
	...
	pcid_pcid_sp_0_reg.pcid_sp_line0 = value;
	...
	pcid_pcid_sp_0_reg.pcid_sp_line1 = value;
	...
	pcid_pcid_sp_1_reg.pcid_sp_line2 = value;
	...
	pcid_pcid_sp_1_reg.pcid_sp_line3 = value;
	...
	pcid_pcid_sp_2_reg.pcid_sp_line4 = value;
	...
	pcid_pcid_sp_2_reg.pcid_sp_line5 = value;
	...
	pcid_pcid_sp_l3_reg.pcid_sp_line6 = value;
	...
	pcid_pcid_sp_l3_reg.pcid_sp_line7 = value;

	IoReg_Write32(PCID_PCID_SP_CTRL_reg, pcid_pcid_sp_ctrl_reg.regValue);
	IoReg_Write32(PCID_PCID_SP_0_reg, pcid_pcid_sp_0_reg.regValue);
	IoReg_Write32(PCID_PCID_SP_1_reg, pcid_pcid_sp_1_reg.regValue);
	IoReg_Write32(PCID_PCID_SP_2_reg, pcid_pcid_sp_2_reg.regValue);
	IoReg_Write32(PCID_PCID_SP_L3_reg, pcid_pcid_sp_l3_reg.regValue);
