...
void drvif_color_icm_hue_histo_init()
{
	...
	hue_hist_settings1_reg.hue_hist_itn_hb = 5846;
	hue_hist_settings1_reg.hue_hist_itn_lb = -1752;
	hue_hist_settings0_reg.hue_hist_sat_lb = 0;
...
unsigned char drvif_color_icm_Write3DTable(COLORELEM ICM_TAB_ACCESS[ITNSEGMAX][SATSEGMAX][HUESEGMAX])
{
	...
	if(h_pillar_num % 2 == 0 && h_pillar_num >= 2)
	{
...
unsigned char drvif_color_icm_Write3DTable_By_DMA(COLORELEM ICM_TAB_ACCESS[ITNSEGMAX][SATSEGMAX][HUESEGMAX], unsigned int addr, unsigned int* vir_addr,  unsigned char h_pillar_num, unsigned char s_pillar_num, unsigned char i_pillar_num)
{
	...
	buf = (unsigned int *)dvr_malloc(buf_size * sizeof(unsigned int));
//	buf = (unsigned int *)dvr_malloc_specific(buf_size * sizeof(unsigned int), GFP_DCU2_FIRST);
	...
	if (buf == NULL)
	{
		rtd_pr_vpq_emerg("ICM :buf PQ warning ,  drvif_color_icm_Write3DTable_By_DMA size(%zx) memory allocate fail!\n", (buf_size * sizeof(unsigned int)));
	...
	if (pVirtAddr != NULL) {
		...
		rtd_pr_vpq_emerg("ICM :pVirtAddrPQ warning , pVirtAddr drvif_color_icm_Write3DTable_By_DMA map virt memory fail!\n");
...
unsigned char drvif_color_icm_Set_RGB_Offset_Table(int rgb_offset_curve[3][HUESEGMAX], unsigned char rgb_offset_s_gain[SATSEGMAX], unsigned char rgb_offset_i_gain[ITNSEGMAX])
{
	...
	for(addr = 0; addr < (HUESEGMAX / 2); addr++)
	{
		...
		if(timeout <= 0)
		{
		    rtd_pr_vpq_emerg("drvif_color_icm_Set_RGB_Offset_Table write rgb offset table error: address = %d\n", addr);
				return false;
		}
	}
...
void drvif_color_icm_AI_debugbox_fadeInOut(int debugbox_en,unsigned int debugbox_width,unsigned int debugbox_color,int debugbox_blendingRatio)
{
	/*
		Parameter:
		debugbox_en:total enable.
		debugbox_width: 0~15,real width=2*reg+1.
		debugbox_color:
					0:white
					1:black
					2:yellow
					...
					5:pink
					6~7:reserved
		debugbox_blendingRatio: 0~64(0:no debugbox,64:full debugbox)
	*/

	color_icm_d_icm_ai_7_RBUS  icm_d_icm_ai_7_reg;
	color_icm_d_icm_ai_debug_box0_RBUS color_icm_d_icm_ai_debug_box0_reg;
	color_icm_d_icm_ai_debug_box1_RBUS color_icm_d_icm_ai_debug_box1_reg;
	color_icm_d_icm_ai_debug_box2_RBUS color_icm_d_icm_ai_debug_box2_reg;	
		
	icm_d_icm_ai_7_reg.regValue = IoReg_Read32(COLOR_ICM_D_ICM_AI_7_reg);	
	color_icm_d_icm_ai_debug_box0_reg.regValue = IoReg_Read32(COLOR_ICM_D_ICM_AI_DEBUG_BOX0_reg);	
	color_icm_d_icm_ai_debug_box1_reg.regValue = IoReg_Read32(COLOR_ICM_D_ICM_AI_DEBUG_BOX1_reg);	
	color_icm_d_icm_ai_debug_box2_reg.regValue = IoReg_Read32(COLOR_ICM_D_ICM_AI_DEBUG_BOX2_reg);		
	
	icm_d_icm_ai_7_reg.ai_debug_mode_box_en = debugbox_en;
	
	color_icm_d_icm_ai_debug_box0_reg.ai_debug_box_line_width0 = debugbox_width & 0xf;
	color_icm_d_icm_ai_debug_box0_reg.ai_debug_box_line_width1 = (debugbox_width >> 4) & 0xf;
	color_icm_d_icm_ai_debug_box1_reg.ai_debug_box_line_width2 = (debugbox_width >> 8) & 0xf;
	color_icm_d_icm_ai_debug_box1_reg.ai_debug_box_line_width3 = (debugbox_width >> 12) & 0xf;
	color_icm_d_icm_ai_debug_box2_reg.ai_debug_box_line_width4 = (debugbox_width >> 16) & 0xf;
	color_icm_d_icm_ai_debug_box2_reg.ai_debug_box_line_width5 = (debugbox_width >> 20) & 0xf;

	color_icm_d_icm_ai_debug_box0_reg.ai_debug_box_color0 = debugbox_color & 0x7;
	color_icm_d_icm_ai_debug_box0_reg.ai_debug_box_color1 = (debugbox_color >> 3) & 0x7;
	color_icm_d_icm_ai_debug_box1_reg.ai_debug_box_color2 = (debugbox_color >> 6) & 0x7;
	color_icm_d_icm_ai_debug_box1_reg.ai_debug_box_color3 = (debugbox_color >> 9) & 0x7;
	color_icm_d_icm_ai_debug_box2_reg.ai_debug_box_color4 = (debugbox_color >> 12) & 0x7;
	color_icm_d_icm_ai_debug_box2_reg.ai_debug_box_color5 = (debugbox_color >> 15) & 0x7;

	color_icm_d_icm_ai_debug_box0_reg.ai_debug_box_blending_ratio0 = debugbox_blendingRatio;
	color_icm_d_icm_ai_debug_box0_reg.ai_debug_box_blending_ratio1 = debugbox_blendingRatio;
	color_icm_d_icm_ai_debug_box1_reg.ai_debug_box_blending_ratio2 = debugbox_blendingRatio;
	color_icm_d_icm_ai_debug_box1_reg.ai_debug_box_blending_ratio3 = debugbox_blendingRatio;
	color_icm_d_icm_ai_debug_box2_reg.ai_debug_box_blending_ratio4 = debugbox_blendingRatio;
	color_icm_d_icm_ai_debug_box2_reg.ai_debug_box_blending_ratio5 = debugbox_blendingRatio;
	
	IoReg_Write32(COLOR_ICM_D_ICM_AI_7_reg, icm_d_icm_ai_7_reg.regValue);
	IoReg_Write32(COLOR_ICM_D_ICM_AI_DEBUG_BOX0_reg, color_icm_d_icm_ai_debug_box0_reg.regValue);
	IoReg_Write32(COLOR_ICM_D_ICM_AI_DEBUG_BOX1_reg, color_icm_d_icm_ai_debug_box1_reg.regValue);
	IoReg_Write32(COLOR_ICM_D_ICM_AI_DEBUG_BOX2_reg, color_icm_d_icm_ai_debug_box2_reg.regValue);
	
}

void drvif_color_icm_Set_pqmask_hue(unsigned int bEnable, unsigned int gain) {
#ifdef K24_PQ_COMPILE
	color_icm_d_icm_pq_mask_ctrl_RBUS color_icm_d_icm_pq_mask_ctrl_reg;

	color_icm_d_icm_pq_mask_ctrl_reg.regValue = IoReg_Read32(COLOR_ICM_D_ICM_PQ_MASK_CTRL_reg);

	color_icm_d_icm_pq_mask_ctrl_reg.pq_mask_h_en = bEnable;
	color_icm_d_icm_pq_mask_ctrl_reg.pq_mask_gain_h = gain;

	IoReg_Write32(COLOR_ICM_D_ICM_PQ_MASK_CTRL_reg, color_icm_d_icm_pq_mask_ctrl_reg.regValue);
#endif
}
...
#ifdef K24_PQ_COMPILE
	color_icm_d_icm_pq_mask_ctrl_RBUS color_icm_d_icm_pq_mask_ctrl_reg;
	color_icm_d_icm_pq_mask_offset_RBUS color_icm_d_icm_pq_mask_offset_reg;

	color_icm_d_icm_pq_mask_ctrl_reg.regValue = IoReg_Read32(COLOR_ICM_D_ICM_PQ_MASK_CTRL_reg);
	color_icm_d_icm_pq_mask_offset_reg.regValue = IoReg_Read32(COLOR_ICM_D_ICM_PQ_MASK_OFFSET_reg);

	color_icm_d_icm_pq_mask_ctrl_reg.pq_mask_s_en = bEnable;
	color_icm_d_icm_pq_mask_ctrl_reg.pq_mask_gain_s = gain;

	color_icm_d_icm_pq_mask_offset_reg.pq_mask_offset_s = offset;

	IoReg_Write32(COLOR_ICM_D_ICM_PQ_MASK_CTRL_reg, color_icm_d_icm_pq_mask_ctrl_reg.regValue);
	IoReg_Write32(COLOR_ICM_D_ICM_PQ_MASK_OFFSET_reg, color_icm_d_icm_pq_mask_offset_reg.regValue);
#endif
}
...
void drvif_color_icm_Set_pqmask_int(unsigned int bEnable, unsigned int gain, unsigned int offset) {
	...
	color_icm_d_icm_pq_mask_ctrl_reg.pq_mask_i_en = bEnable;
	color_icm_d_icm_pq_mask_ctrl_reg.pq_mask_gain_i = gain;

	color_icm_d_icm_pq_mask_offset_reg.pq_mask_offset_i = offset;
...
void drvif_color_icm_Set_pqmask_debug_gain(unsigned char Gain) {
	...
	color_icm_d_icm_pq_mask_ctrl_reg.pq_mask_debug_gain = Gain;
...
/**
 * @description: 
 * 		SET the icm pqmask input source.
 * 		0: w0 weight
 * 		1: w1 weight
 * 		2: w2 weight
 * @return {*}
									   ...
									   unsigned char obj2_h_sel)
{
	...
	color_icm_d_icm_pqmask_mux_RBUS color_icm_d_icm_pqmask_mux_REG;

	color_icm_d_icm_pqmask_mux_REG.regValue = IoReg_Read32(COLOR_ICM_D_ICM_PQMASK_MUX_reg);
	color_icm_d_icm_pqmask_mux_REG.icm_pqmask_int_sel = int_sel;
	color_icm_d_icm_pqmask_mux_REG.icm_pqmask_obj1sat_sel = obj1_s_sel;
	color_icm_d_icm_pqmask_mux_REG.icm_pqmask_obj2sat_sel = obj2_s_sel;
	color_icm_d_icm_pqmask_mux_REG.icm_pqmask_obj1hue_sel = obj1_h_sel;
	color_icm_d_icm_pqmask_mux_REG.icm_pqmask_obj2hue_sel = obj2_h_sel;
	IoReg_Write32(COLOR_ICM_D_ICM_PQMASK_MUX_reg,color_icm_d_icm_pqmask_mux_REG.regValue);
}
								   ...
								   unsigned char pqmask_obj2_h_en)
{
	...
	color_icm_d_icm_pq_mask_ctrl_REG.regValue = IoReg_Read32(COLOR_ICM_D_ICM_PQ_MASK_CTRL_reg);
	color_icm_d_icm_pq_mask_ctrl_REG.pq_mask_obj1_h_en = pqmask_obj1_h_en;
	color_icm_d_icm_pq_mask_ctrl_REG.pq_mask_obj2_h_en = pqmask_obj2_h_en;
	color_icm_d_icm_pq_mask_ctrl_REG.pq_mask_obj1_s_en = pqmask_obj1_s_en;
	color_icm_d_icm_pq_mask_ctrl_REG.pq_mask_obj2_s_en = pqmask_obj2_s_en;
	color_icm_d_icm_pq_mask_ctrl_REG.pq_mask_i_en = pqmask_i_en;
	IoReg_Write32(COLOR_ICM_D_ICM_PQ_MASK_CTRL_reg,color_icm_d_icm_pq_mask_ctrl_REG.regValue);
...
/**
 * @description: 
 * 		set icm pqmask debug mode
 * 		debug mode : 0-h,1-s,2-i
 * 		debug gain : enhance debug mode performance.
 * 		debug high and low : mark the range tobe red color.
 * @return {*}
 */
...
{
	color_icm_d_icm_pq_mask_ctrl_RBUS color_icm_d_icm_pq_mask_ctrl_REG;
	color_icm_dm_icm_pamask_int_debug_RBUS color_icm_dm_icm_pamask_int_debug_REG;
	color_icm_dm_icm_pamask_sat_debug_RBUS color_icm_dm_icm_pamask_sat_debug_REG;

	color_icm_d_icm_pq_mask_ctrl_REG.regValue = IoReg_Read32(COLOR_ICM_D_ICM_PQ_MASK_CTRL_reg);

	color_icm_d_icm_pq_mask_ctrl_REG.pq_mask_debug_en = debug_en;
	color_icm_d_icm_pq_mask_ctrl_REG.pq_mask_debug_mode = debug_mode;
	color_icm_d_icm_pq_mask_ctrl_REG.pq_mask_debug_gain = debug_gain;

	IoReg_Write32(COLOR_ICM_D_ICM_PQ_MASK_CTRL_reg,color_icm_d_icm_pq_mask_ctrl_REG.regValue);

	color_icm_dm_icm_pamask_int_debug_REG.regValue = IoReg_Read32(COLOR_ICM_DM_ICM_PAMASK_INT_DEBUG_reg);
	color_icm_dm_icm_pamask_int_debug_REG.pqmask_int_debug_low = int_debug_low;
	color_icm_dm_icm_pamask_int_debug_REG.pqmask_int_debug_high = int_debug_high;
	IoReg_Write32(COLOR_ICM_DM_ICM_PAMASK_INT_DEBUG_reg,color_icm_dm_icm_pamask_int_debug_REG.regValue);

	color_icm_dm_icm_pamask_sat_debug_REG.regValue = IoReg_Read32(COLOR_ICM_DM_ICM_PAMASK_SAT_DEBUG_reg);
	color_icm_dm_icm_pamask_sat_debug_REG.pqmask_sat_debug_low = sat_debug_low;
	color_icm_dm_icm_pamask_sat_debug_REG.pqmask_sat_debug_high = sat_debug_high;
	IoReg_Write32(COLOR_ICM_DM_ICM_PAMASK_SAT_DEBUG_reg,color_icm_dm_icm_pamask_sat_debug_REG.regValue);
}

/**
 * @description: 
 * 		modify the input data range.
 * @return {*}
 */
										...
										unsigned int in_s_offset)
{
	color_icm_d_icm_pq_mask_ctrl_RBUS color_icm_d_icm_pq_mask_ctrl_REG;
	color_icm_d_icm_pq_mask_offset_RBUS color_icm_d_icm_pq_mask_offset_REG;
	color_icm_dm_icm_pamask_input_gain_RBUS color_icm_dm_icm_pamask_input_gain_REG;

	color_icm_d_icm_pq_mask_ctrl_REG.regValue = IoReg_Read32(COLOR_ICM_D_ICM_PQ_MASK_CTRL_reg);
	color_icm_d_icm_pq_mask_ctrl_REG.pq_mask_gain_i = in_i_gain;
	IoReg_Write32(COLOR_ICM_D_ICM_PQ_MASK_CTRL_reg,color_icm_d_icm_pq_mask_ctrl_REG.regValue);

	color_icm_d_icm_pq_mask_offset_REG.regValue = IoReg_Read32(COLOR_ICM_D_ICM_PQ_MASK_OFFSET_reg);
	color_icm_d_icm_pq_mask_offset_REG.pq_mask_offset_i = in_i_offset;
	IoReg_Write32(COLOR_ICM_D_ICM_PQ_MASK_OFFSET_reg,color_icm_d_icm_pq_mask_offset_REG.regValue);

	color_icm_dm_icm_pamask_input_gain_REG.regValue = IoReg_Read32(COLOR_ICM_DM_ICM_PAMASK_INPUT_GAIN_reg);
	color_icm_dm_icm_pamask_input_gain_REG.pqmask_input_gain_s = in_s_gain;
	color_icm_dm_icm_pamask_input_gain_REG.pqmask_input_offset_s = in_s_offset;
	IoReg_Write32(COLOR_ICM_DM_ICM_PAMASK_INPUT_GAIN_reg,color_icm_dm_icm_pamask_input_gain_REG.regValue);
}

/**
 * @description: 
 * 		set sat gainby sat to reg from buffer.
 * @return {*}
 */
void drvif_color_icm_pqmask_SatGainBySat(unsigned char obj1_sat_bysat_en,
										 ...
										 unsigned int *p_obj1_sat_bysat_GainCurve,
										 unsigned int *p_obj2_sat_bysat_GainCurve)
{
	color_icm_d_icm_pq_mask_gainbysat_1_RBUS color_icm_d_icm_pq_mask_gainbysat_1_REG;
	color_icm_d_icm_pq_mask_gainbysat_2_RBUS color_icm_d_icm_pq_mask_gainbysat_2_REG;
	color_icm_d_icm_pq_mask_gainbysat_4_RBUS color_icm_d_icm_pq_mask_gainbysat_4_REG;
	color_icm_d_icm_pq_mask_gainbysat_5_RBUS color_icm_d_icm_pq_mask_gainbysat_5_REG;

	color_icm_d_icm_pq_mask_gainbysat_1_REG.regValue = IoReg_Read32(COLOR_ICM_D_ICM_PQ_MASK_GAINBYSAT_1_reg);
	color_icm_d_icm_pq_mask_gainbysat_1_REG.pq_mask_obj1_sat_bysatgain_0 = p_obj1_sat_bysat_GainCurve[0];
	color_icm_d_icm_pq_mask_gainbysat_1_REG.pq_mask_obj1_sat_bysatgain_1 = p_obj1_sat_bysat_GainCurve[1];
	color_icm_d_icm_pq_mask_gainbysat_1_REG.pq_mask_obj1_sat_bysatgain_2 = p_obj1_sat_bysat_GainCurve[2];
	color_icm_d_icm_pq_mask_gainbysat_1_REG.pq_mask_obj1_sat_bysatgain_3 = p_obj1_sat_bysat_GainCurve[3];
	color_icm_d_icm_pq_mask_gainbysat_1_REG.pq_mask_obj1_sat_bysat_enable = obj1_sat_bysat_en;
	IoReg_Write32(COLOR_ICM_D_ICM_PQ_MASK_GAINBYSAT_1_reg,color_icm_d_icm_pq_mask_gainbysat_1_REG.regValue);

	color_icm_d_icm_pq_mask_gainbysat_2_REG.regValue = IoReg_Read32(COLOR_ICM_D_ICM_PQ_MASK_GAINBYSAT_2_reg);
	color_icm_d_icm_pq_mask_gainbysat_2_REG.pq_mask_obj1_sat_bysatgain_4 = p_obj1_sat_bysat_GainCurve[4];
	color_icm_d_icm_pq_mask_gainbysat_2_REG.pq_mask_obj1_sat_bysatgain_5 = p_obj1_sat_bysat_GainCurve[5];
	color_icm_d_icm_pq_mask_gainbysat_2_REG.pq_mask_obj1_sat_bysatgain_6 = p_obj1_sat_bysat_GainCurve[6];
	color_icm_d_icm_pq_mask_gainbysat_2_REG.pq_mask_obj1_sat_bysatgain_7 = p_obj1_sat_bysat_GainCurve[7];
	color_icm_d_icm_pq_mask_gainbysat_2_REG.pq_mask_obj1_sat_bysat_modesel = boj1_sat_bysat_valueRange_mode;
	IoReg_Write32(COLOR_ICM_D_ICM_PQ_MASK_GAINBYSAT_2_reg,color_icm_d_icm_pq_mask_gainbysat_2_REG.regValue);

	color_icm_d_icm_pq_mask_gainbysat_4_REG.regValue = IoReg_Read32(COLOR_ICM_D_ICM_PQ_MASK_GAINBYSAT_4_reg);
	color_icm_d_icm_pq_mask_gainbysat_4_REG.pq_mask_obj2_sat_bysatgain_0 = p_obj2_sat_bysat_GainCurve[0];
	color_icm_d_icm_pq_mask_gainbysat_4_REG.pq_mask_obj2_sat_bysatgain_1 = p_obj2_sat_bysat_GainCurve[1];
	color_icm_d_icm_pq_mask_gainbysat_4_REG.pq_mask_obj2_sat_bysatgain_2 = p_obj2_sat_bysat_GainCurve[2];
	color_icm_d_icm_pq_mask_gainbysat_4_REG.pq_mask_obj2_sat_bysatgain_3 = p_obj2_sat_bysat_GainCurve[3];
	color_icm_d_icm_pq_mask_gainbysat_4_REG.pq_mask_obj2_sat_bysat_enable = obj2_sat_bysat_en;
	IoReg_Write32(COLOR_ICM_D_ICM_PQ_MASK_GAINBYSAT_4_reg,color_icm_d_icm_pq_mask_gainbysat_4_REG.regValue);

	color_icm_d_icm_pq_mask_gainbysat_5_REG.regValue = IoReg_Read32(COLOR_ICM_D_ICM_PQ_MASK_GAINBYSAT_5_reg);
	color_icm_d_icm_pq_mask_gainbysat_5_REG.pq_mask_obj2_sat_bysatgain_4 = p_obj2_sat_bysat_GainCurve[4];
	color_icm_d_icm_pq_mask_gainbysat_5_REG.pq_mask_obj2_sat_bysatgain_5 = p_obj2_sat_bysat_GainCurve[5];
	color_icm_d_icm_pq_mask_gainbysat_5_REG.pq_mask_obj2_sat_bysatgain_6 = p_obj2_sat_bysat_GainCurve[6];
	color_icm_d_icm_pq_mask_gainbysat_5_REG.pq_mask_obj2_sat_bysatgain_7 = p_obj2_sat_bysat_GainCurve[7];
	color_icm_d_icm_pq_mask_gainbysat_5_REG.pq_mask_obj2_sat_bysat_modesel = boj2_sat_bysat_valueRange_mode;
	IoReg_Write32(COLOR_ICM_D_ICM_PQ_MASK_GAINBYSAT_5_reg,color_icm_d_icm_pq_mask_gainbysat_5_REG.regValue);

}

/**
 * @description: 
 * 		set the obj1_GlbBldRatio \ obj2_GlbBldRatio to calculate the final offset_sat.
 * 			step1: obj1/2_GainbyHue: current pixel hue data to hue_curve and get the obj1/2_GainbyHue(0~31).
 * 			step2: obj1/2_GainbySat: current pixel hue data to sat_curve and get the obj1/2_GainbySat(0~31).
 * 			step3: obj1_sat_offset = input_s_weight * obj1_GainbyHue * obj1_GainbySat
 * 			step4: obj2_sat_offset = input_s_weight * obj2_GainbyHue * obj2_GainbySat
 * 			step5: final_sat_offset = (obj1_sat_offset * obj1_GlbBldRatio + obj2_sat_offset * obj2_GlbBldRatio)/1024
 * @return {*}
 */
void drvif_color_icm_pqmask_Sat_Final_Ctrl(unsigned int obj1_GlbBldRatio,
										   unsigned int obj2_GlbBldRatio)
{
	color_icm_d_icm_pq_mask_enable_RBUS color_icm_d_icm_pq_mask_enable_REG;

	color_icm_d_icm_pq_mask_enable_REG.regValue = IoReg_Read32(COLOR_ICM_D_ICM_PQ_MASK_ENABLE_reg);
	color_icm_d_icm_pq_mask_enable_REG.pq_mask_obj1_satglbratio = obj1_GlbBldRatio;
	color_icm_d_icm_pq_mask_enable_REG.pq_mask_obj2_satglbratio = obj2_GlbBldRatio;
	IoReg_Write32(COLOR_ICM_D_ICM_PQ_MASK_ENABLE_reg,color_icm_d_icm_pq_mask_enable_REG.regValue);

}

/**
 * @description: 
 * 		set hue gainby hue to SRAM from buffer.
 * @return {*}
 */
void drvif_color_icm_pqmask_Hue_byhue_Ctrl(unsigned char obj1_hue_byhue_en,
										   unsigned char obj2_hue_byhue_en,
										   unsigned int *p_obj1_hue_byhue_curve,
										   unsigned int *p_obj2_hue_byhue_curve,
										   unsigned int obj1_target_hue,
										   unsigned int obj2_target_hue)
{
	/*fix me later, this part is hue by hue.*/
	unsigned short cnt = 10000;
	unsigned char status = 1;
	unsigned char i=0;
	color_icm_d_icm_pq_mask_enable_RBUS color_icm_d_icm_pq_mask_enable_REG;
	color_icm_d_icm_pq_mask_target_RBUS color_icm_d_icm_pq_mask_target_REG;
	color_icm_dm_icm_gainby_hue_sram_ctrl_RBUS color_icm_dm_icm_gainby_hue_sram_ctrl_REG;
	color_icm_dm_icm_gainby_hue_sram_wr_data0_RBUS color_icm_dm_icm_gainby_hue_sram_wr_data0_REG;
	color_icm_dm_icm_gainby_hue_sram_wr_data1_RBUS color_icm_dm_icm_gainby_hue_sram_wr_data1_REG;

	color_icm_d_icm_pq_mask_enable_REG.regValue = IoReg_Read32(COLOR_ICM_D_ICM_PQ_MASK_ENABLE_reg);
	color_icm_d_icm_pq_mask_enable_REG.pq_mask_obj1_hue_byhue_enable = obj1_hue_byhue_en;
	color_icm_d_icm_pq_mask_enable_REG.pq_mask_obj2_hue_byhue_enable = obj2_hue_byhue_en;
	IoReg_Write32(COLOR_ICM_D_ICM_PQ_MASK_ENABLE_reg,color_icm_d_icm_pq_mask_enable_REG.regValue);

	color_icm_d_icm_pq_mask_target_REG.regValue = IoReg_Read32(COLOR_ICM_D_ICM_PQ_MASK_TARGET_reg);
	color_icm_d_icm_pq_mask_target_REG.pq_mask_obj1_target_h = obj1_target_hue;
	color_icm_d_icm_pq_mask_target_REG.pq_mask_obj2_target_h = obj2_target_hue;
	IoReg_Write32(COLOR_ICM_D_ICM_PQ_MASK_TARGET_reg,color_icm_d_icm_pq_mask_target_REG.regValue);

	/* write sat_gainbyhue*/
	for(i=0;i<24;i++){

		color_icm_dm_icm_gainby_hue_sram_ctrl_REG.regValue = IoReg_Read32(COLOR_ICM_DM_ICM_GAINBY_HUE_SRAM_CTRL_reg);
		color_icm_dm_icm_gainby_hue_sram_ctrl_REG.gainby_hue_addr = i;													// step1. set addr.
		IoReg_Write32(COLOR_ICM_DM_ICM_GAINBY_HUE_SRAM_CTRL_reg,color_icm_dm_icm_gainby_hue_sram_ctrl_REG.regValue);
	
		color_icm_dm_icm_gainby_hue_sram_wr_data0_REG.wr_gainby_hue_curve_h0 = p_obj1_hue_byhue_curve[i*2];				// step2: set obj1 satGainByHue 2*i
		IoReg_Write32(COLOR_ICM_DM_ICM_GAINBY_HUE_SRAM_WR_DATA0_reg,color_icm_dm_icm_gainby_hue_sram_wr_data0_REG.regValue);

		color_icm_dm_icm_gainby_hue_sram_wr_data1_REG.wr_gainby_hue_curve_h0_1 = p_obj1_hue_byhue_curve[i*2+1];			// step3: set obj1 satGainByHue 2*i + 1
		IoReg_Write32(COLOR_ICM_DM_ICM_GAINBY_HUE_SRAM_WR_DATA1_reg,color_icm_dm_icm_gainby_hue_sram_wr_data1_REG.regValue);

		color_icm_dm_icm_gainby_hue_sram_wr_data0_REG.wr_gainby_hue_curve_h1 = p_obj2_hue_byhue_curve[i*2];				// step4: set obj2 satGainByHue 2*i
		IoReg_Write32(COLOR_ICM_DM_ICM_GAINBY_HUE_SRAM_WR_DATA0_reg,color_icm_dm_icm_gainby_hue_sram_wr_data0_REG.regValue);

		color_icm_dm_icm_gainby_hue_sram_wr_data1_REG.wr_gainby_hue_curve_h1_1 = p_obj2_hue_byhue_curve[i*2+1];			// step5: set obj2 satGainByHue 2*i + 1
		IoReg_Write32(COLOR_ICM_DM_ICM_GAINBY_HUE_SRAM_WR_DATA1_reg,color_icm_dm_icm_gainby_hue_sram_wr_data1_REG.regValue);

		color_icm_dm_icm_gainby_hue_sram_ctrl_REG.gainby_hue_write_en = 0x1;											// step6: set satGainByHue enable.
		IoReg_Write32(COLOR_ICM_DM_ICM_GAINBY_HUE_SRAM_CTRL_reg,color_icm_dm_icm_gainby_hue_sram_ctrl_REG.regValue);

		while ((cnt--) && (status)) { 																					// step7: wait satGainByHue enable hardware clear.
			color_icm_dm_icm_gainby_hue_sram_ctrl_REG.regValue = IoReg_Read32(COLOR_ICM_DM_ICM_GAINBY_HUE_SRAM_CTRL_reg);
			status =  (color_icm_dm_icm_gainby_hue_sram_ctrl_REG.gainby_hue_write_en == 0) ? 0 : 1;
		}
	}
}
...
void drvif_color_icm_pqmask_SatHue_byhue_Ctrl(unsigned char obj1_hue_byhue_en,
											  ...
											  unsigned int *p_obj1_sat_GainByHue_Cureve,										 
											  unsigned int *p_obj2_sat_GainByHue_Cureve,
										      unsigned int obj1_target_hue,
										      unsigned int obj2_target_hue)
{
	/*fix me later, this part is hue by hue.*/
	...
	color_icm_d_icm_pq_mask_enable_REG.regValue = IoReg_Read32(COLOR_ICM_D_ICM_PQ_MASK_ENABLE_reg);
	color_icm_d_icm_pq_mask_enable_REG.pq_mask_obj1_sat_byhue_enable = obj1_sat_byhue_en;
	color_icm_d_icm_pq_mask_enable_REG.pq_mask_obj2_sat_byhue_enable = obj2_sat_byhue_en;
	IoReg_Write32(COLOR_ICM_D_ICM_PQ_MASK_ENABLE_reg,color_icm_d_icm_pq_mask_enable_REG.regValue);
	...
	for(i=0;i<24;i++){
		...
		color_icm_dm_icm_gainby_hue_sram_wr_data0_REG.wr_gainby_hue_curve_s0 = p_obj1_sat_GainByHue_Cureve[i*2];	
		color_icm_dm_icm_gainby_hue_sram_wr_data0_REG.wr_gainby_hue_curve_h0 = p_obj1_hue_byhue_curve[i*2];				// step2: set obj1 satGainByHue 2*i
		IoReg_Write32(COLOR_ICM_DM_ICM_GAINBY_HUE_SRAM_WR_DATA0_reg,color_icm_dm_icm_gainby_hue_sram_wr_data0_REG.regValue);

		color_icm_dm_icm_gainby_hue_sram_wr_data1_REG.wr_gainby_hue_curve_s0_1 = p_obj1_sat_GainByHue_Cureve[i*2+1];
		color_icm_dm_icm_gainby_hue_sram_wr_data1_REG.wr_gainby_hue_curve_h0_1 = p_obj1_hue_byhue_curve[i*2+1];			// step3: set obj1 satGainByHue 2*i + 1
		IoReg_Write32(COLOR_ICM_DM_ICM_GAINBY_HUE_SRAM_WR_DATA1_reg,color_icm_dm_icm_gainby_hue_sram_wr_data1_REG.regValue);

		color_icm_dm_icm_gainby_hue_sram_wr_data0_REG.wr_gainby_hue_curve_s1 = p_obj2_sat_GainByHue_Cureve[i*2];
		color_icm_dm_icm_gainby_hue_sram_wr_data0_REG.wr_gainby_hue_curve_h1 = p_obj2_hue_byhue_curve[i*2];				// step4: set obj2 satGainByHue 2*i
		IoReg_Write32(COLOR_ICM_DM_ICM_GAINBY_HUE_SRAM_WR_DATA0_reg,color_icm_dm_icm_gainby_hue_sram_wr_data0_REG.regValue);

		color_icm_dm_icm_gainby_hue_sram_wr_data1_REG.wr_gainby_hue_curve_s1_1 = p_obj2_sat_GainByHue_Cureve[i*2+1];
		color_icm_dm_icm_gainby_hue_sram_wr_data1_REG.wr_gainby_hue_curve_h1_1 = p_obj2_hue_byhue_curve[i*2+1];			// step5: set obj2 satGainByHue 2*i + 1
		IoReg_Write32(COLOR_ICM_DM_ICM_GAINBY_HUE_SRAM_WR_DATA1_reg,color_icm_dm_icm_gainby_hue_sram_wr_data1_REG.regValue);
