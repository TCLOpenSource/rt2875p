...
///////////////////////////////////////////////////////////////////////////////////////
extern void lib_hdmi_dsc_crt_reset(void);
...
extern void lib_hdmi_dsc_set_crc_en(unsigned char enable);
extern unsigned int lib_hdmi_dsc_get_dscd_out_crc(void);
extern unsigned int lib_hdmi_dsc_get_dscd_in_crc(void);
extern unsigned int lib_hdmi_dsc_get_dscd_pps_crc(void);
extern unsigned char lib_hdmi_dsc_get_crt_on(void);
...
extern unsigned int lib_hdmi_dsc_get_timing_monitor_result(DSCD_TIMING_MONITOR_RESULT_INDEX result_index);
...
extern MEASURE_TIMING_T* newbase_hdmi_hd21_dsc_get_current_pps_timing(void);
...
#define newbase_hdmi_check_dscd_output_valid()  (0)
