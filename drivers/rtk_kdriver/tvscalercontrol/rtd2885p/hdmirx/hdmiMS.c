...
unsigned char lib_hdmi_skiptiming_condition(MEASURE_TIMING_T *timing);
...
void lib_hdmims_offms_config_before_startms(OFFMS_MSMODE ms_mode)
{
	...
	case OFFMS_CONTINUOUS_MODE:
		if(is_measure_continuous_init == FALSE)
		{
			...
			hdmi_mask(OFFMS_SP_MS3Ctrl_reg, ~(OFFMS_SP_MS3Ctrl_off_meas_source_mask), OFFMS_SP_MS3Ctrl_off_meas_source(8) ); 
...
unsigned char lib_hdmims_offline_measure(MEASURE_TIMING_T *tm, unsigned char frl_mode, OFFMS_MSMODE ms_mode)
{
...
unsigned char lib_hdmims_offline_measure_demode(MEASURE_TIMING_T *tm, unsigned char frl_mode)
{
...
unsigned char lib_hdmims_offline_measure_native(MEASURE_TIMING_T *tm, unsigned char frl_mode)
{
	unsigned int raw_h_sync_width = 0;
	unsigned int raw_v_sync_width = 0;
...
unsigned char lib_hdmims_measure(MEASURE_TIMING_T *tm, unsigned char frl_mode, unsigned char is_HV_Mode)
{
...
HDMIMS_RESULT_CODE newbase_hdmims_measure_video(unsigned char port, MEASURE_TIMING_T *tm, unsigned char frl_mode)
{
	...
	{// Non VRR, no h sync
		...
		else
		{
			...
			{// get timing info by DSCD PPS
				MEASURE_TIMING_T* dsc_ppc_timing =newbase_hdmi_hd21_dsc_get_current_pps_timing();
...
unsigned char lib_hdmims_online1_measure(MEASURE_TIMING_T *tm)
{
...
unsigned char lib_hdmims_online3_measure(MEASURE_TIMING_T *tm)
{
...
unsigned char lib_hdmims_online3_demode_measure(MEASURE_TIMING_T *tm)
{
...
unsigned char lib_hdmims_calc_freq(MEASURE_TIMING_T *tm)
{
