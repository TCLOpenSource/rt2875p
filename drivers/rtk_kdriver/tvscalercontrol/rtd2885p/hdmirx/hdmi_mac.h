...
// Packet Absence
extern void lib_hdmi_pa_irq_en(unsigned char nport, unsigned char enable);
extern unsigned char lib_hdmi_get_pa_irq_status(unsigned char nport);
extern void lib_hdmi_clr_pa_irq_status(unsigned char nport);
extern unsigned char lib_hdmi_get_pa_frame_count(unsigned char nport);
extern void lib_hdmi_set_pa_frame_count(unsigned char nport, unsigned char frame_cnt);
#endif
