...
//EMP error status
extern unsigned int lib_hdmi_hd21_rmzp_get_less_empacket_err(unsigned char nport);
extern void lib_hdmi_hd21_rmzp_clr_less_empacket_err(unsigned char nport);
extern unsigned int lib_hdmi_hd21_rmzp_get_more_empacket_err(unsigned char nport);
