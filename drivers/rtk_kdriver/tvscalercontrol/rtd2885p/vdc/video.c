...
void drvif_module_vdc_108M_FrontDigitalFilterEnable(VDC_VIDEO_108M_FrontDigitalFilter mode)
{
	...
	case VDC_108M_FDF_85MHZ:
		...
		vd_inout_ctrl_reg.fe_fil_sel = 1;
		break;
	case VDC_216M_FDF_75MHZ:
		drvif_module_vdc_input_filter_sel(0, INPUT_FILTER_216_75MHZ);
		vd_inout_ctrl_reg.fe_fil_sel = 1;
		break;
	}
...
unsigned char drvif_module_vdc_Read_108M_FrontDigitalFilter_info(void)
{
	...
	if (vd_inout_ctrl_reg.fe_fil_sel != 0) {
		...
		else if (input_flt_tap_0_1_reg.input_flt_tap1 == INPUT_FILTER_216_75MHZ[1])
			return VDC_216M_FDF_75MHZ;
		else
...
void drvif_module_vdc_CheckInputStatus(unsigned char ucInputSrc, unsigned char ucCheckStart)
{
	...
	//vd_ifd_input_vd_adc_lsb_ctrl_RBUS vd_ifd_input_vd_adc_lsb_ctrl_reg;
	...
	if (vdc_LockStatus & ucCheckStart) {
		...
		if (((vdcf_inl(VDTOP_NOISE_STATUS_reg) > 0x10) || (adc_over_under_flag_reg.ad4_value_big == 1)) && (agc_gate_width_reg.data_path_dgain_limit_low != 0x200))
		{
