...
void module_vdc_ADC_common_setting(void)
{
	...
	if (vd_opt==1){											//vd_otp : otp done flag
		...
		VDADC_ADC_CTRL_LDO1V0_sel = 0x1;					//default valure = 0x001(0.908V)
	}

	tv_sb1_ana_vdadc_core_lpf_ctrl_reg.regValue = rtdf_inl(TV_SB1_ANA_VDADC_CORE_LPF_CTRL_reg);
	tv_sb1_ana_vdadc_core_lpf_ctrl_reg.reg_vdadc_adc_ctrl_15_14 = 0x3;  // 2_0054[31:30]=3, T12 modify, Reference Buffer Source Current Selection 0x3
	// tv_sb1_ana_vdadc_core_lpf_ctrl_reg.reg_vdadc_adc_ctrl_13_12 = 0x0; 	/* 2_0054[29]=0 */
	...
	tv_sb1_ana_vdadc_core_lpf_ctrl_reg.reg_vdadc_adc_ctrl_7_6 = 0x2;    // 2_0054[23:22]=2, T12 modify parameters, DAC Shifting Selection
	...
	tv_sb1_ana_vdadc_core_lpf_ctrl_reg.reg_vdadc_adc_ctrl_1 = 0x1;      // 2_0054[17]=1, T12 modify parameters, SAR ADC DAC Reset
	...
	tv_sb1_ana_vdadc_ck_ctl_reg.reg_vdadc_ckout_sel_4 = 0x1;	/* 2_0058[4]=1, T12 modify parameters ADADC 108M output clock drivider polarity */
...
unsigned char drvif_AV_Detect_Signal_PlugInOut(unsigned char source)
{
	...
	if (g_ucSrcType == _SRC_CVBS){ //VD clk source
...
void module_vdc_PathSelect(unsigned char ucSourceIndex, void* stPath)
{
	...
	if (ucSourceIndex != _SRC_TV) {
		...
		// for merlin7 CVBS plug_inout detection
		sys_clksel_reg.regValue = rtdf_inl(SYS_REG_SYS_CLKSEL_reg);	/* 0_0204 */
