...
#define MEMC_AUTOTEST_INTERNAL_PTG_NUM	(6*3)//INTERNAL_AUTOTEST_NUM
#define MEMC_AUTOTEST_REAL_PATTERN_NUM	(1*3)//REALPATTERN_AUTOTEST_NUM
#define MEMC_AUTOREGRESSION_NUM			(4*3)//AUTOREGRESSION_TYPE_NUM
...
extern void Get_AutoRegression_Result(unsigned short *u16_result);
...
{TOOLACCESS_MEMC_AUTOREGRESSION,			VIP_UINT16, MEMC_AUTOREGRESSION_NUM,															"TOOLACCESS_MEMC_AutoRegression"		},
...
int rtice_get_vip_table(ap_data_param rtice_param, unsigned char *num_type, unsigned char *buf)
{
	...
	unsigned short u16_AutoRegression_Result[MEMC_AUTOREGRESSION_NUM]={0};
	...
	case TOOLACCESS_ISR_Print_Ctrl:
		...
		*num_type = VIP_UINT32;
		...
		case TOOLACCESS_MEMC_AUTOREGRESSION:
			if(size > MEMC_AUTOREGRESSION_NUM*sizeof(unsigned short))
				return -ID_SIZE_ERR;
			
			Get_AutoRegression_Result((unsigned short*)u16_AutoRegression_Result);
			
			// unsigned int to unsigned short
			for(u8_i=0;u8_i<size;u8_i++){
				buf[2*u8_i] = (u16_AutoRegression_Result[u8_i]>>8)&0xff;
				buf[2*u8_i+1] = (u16_AutoRegression_Result[u8_i])&0xff;
			}
...
// end lesley 1016
	...
	case TOOLACCESS_AI_PQMASK_Control: /*1275 get*/
		...
		if(rtice_param.mode0 == 0) { // performance
			...
			if (size > 27*sizeof(unsigned int))
				return -ID_SIZE_ERR;
			...
			if (size > 12*sizeof(unsigned int))
				return -ID_SIZE_ERR;
	...
	case TOOLACCESS_NNSR_VIP_TABLE:
	{
		...
		if(rtice_param.mode0 == 4) {
			unsigned short *pAddr[] = {
				gVipSRNNTbl.SRNN_Param.Param_SRNN_60HZ_1X,
				gVipSRNNTbl.SRNN_Param.Param_SRNN_60HZ_1_33X,
				gVipSRNNTbl.SRNN_Param.Param_SRNN_60HZ_1_5X_576,
				gVipSRNNTbl.SRNN_Param.Param_SRNN_60HZ_1_5X_720,
				gVipSRNNTbl.SRNN_Param.Param_SRNN_60HZ_2X_576,
				gVipSRNNTbl.SRNN_Param.Param_SRNN_60HZ_2X_720,
				gVipSRNNTbl.SRNN_Param.Param_SRNN_60HZ_2X_PREDOWN,
				gVipSRNNTbl.SRNN_Param.Param_SRNN_60HZ_3X_576,
				gVipSRNNTbl.SRNN_Param.Param_SRNN_60HZ_3X_720,
				gVipSRNNTbl.SRNN_Param.Param_SRNN_60HZ_4X,
				gVipSRNNTbl.SRNN_Param.Param_SRNN_120HZ_2X_576,
				gVipSRNNTbl.SRNN_Param.Param_SRNN_120HZ_2X_720,
				gVipSRNNTbl.SRNN_Param.Param_SRNN_120HZ_3X_576,
				gVipSRNNTbl.SRNN_Param.Param_SRNN_120HZ_3X_720,
				gVipSRNNTbl.SRNN_Param.Param_SRNN_120HZ_4X,
				gVipSRNNTbl.SRNN_Param.Param_SRNN_HSR_1X,
				gVipSRNNTbl.SRNN_Param.Param_SRNN_HSR_1_33X,
				gVipSRNNTbl.SRNN_Param.Param_SRNN_HSR_1_5X_576,
				gVipSRNNTbl.SRNN_Param.Param_SRNN_HSR_1_5X_720,
				gVipSRNNTbl.SRNN_Param.Param_SRNN_HSR_2X_576,
				gVipSRNNTbl.SRNN_Param.Param_SRNN_HSR_2X_720,
				gVipSRNNTbl.SRNN_Param.Param_SRNN_HSR_2X_PREDOWN,
				gVipSRNNTbl.SRNN_Param.Param_SRNN_HSR_3X_576,
				gVipSRNNTbl.SRNN_Param.Param_SRNN_HSR_3X_720,
				gVipSRNNTbl.SRNN_Param.Param_SRNN_HSR_4X,
				gVipSRNNTbl.SRNN_Param.Param_SRNN_SQM_4K_4K,
				gVipSRNNTbl.SRNN_Param.Param_SRNN_SQM_4K_2KGOOD,
				gVipSRNNTbl.SRNN_Param.Param_SRNN_SQM_4K_2KNORM,
				gVipSRNNTbl.SRNN_Param.Param_SRNN_SQM_4K_720,
				gVipSRNNTbl.SRNN_Param.Param_SRNN_SQM_4K_480,
				gVipSRNNTbl.SRNN_Param.Param_SRNN_SQM_2K_2KGOOD,
				gVipSRNNTbl.SRNN_Param.Param_SRNN_SQM_2K_2KNORM,
				gVipSRNNTbl.SRNN_Param.Param_SRNN_SQM_2K_720,
				gVipSRNNTbl.SRNN_Param.Param_SRNN_SQM_2K_480,
			};
			unsigned int ParaNum = sizeof(pAddr)/sizeof(unsigned short *);
			unsigned long EndAddr = (unsigned long)(&gVipSRNNTbl.SRNN_Param) + sizeof(DRV_SRNN_PARAM);
			...
			if (size) {
				memcpy(buf, ((unsigned char *)&gVipSRNNTbl.SRNN_Ctrl_Tbl[rtice_param.mode1])+start_addr, size);
			}
		} else if(rtice_param.mode0 == 2) {
			...
			if (size) {
				memcpy(buf, ((unsigned char *)gVipSRNNTbl.Depth_SRNN_WeightTable[rtice_param.mode1])+start_addr, size);
			}
		} else if(rtice_param.mode0 == 1) {
			...
			if (size) {
				memcpy(buf, ((unsigned char *)gVipSRNNTbl.PQMask_SRNN_WeightTable[rtice_param.mode1])+start_addr, size);
			}
		} else {
			...
			if (size) {
				memcpy(buf, ((unsigned char *)&gVipSRNNTbl.Label)+start_addr, size);
			}
		}
		*num_type = VIP_UINT8;
		break;
...
// end lesley 1016
	...
	case TOOLACCESS_NNSR_Weight_Tbl:
		...
		fwif_color_set_NNSR_model_TBL(rtice_param.mode0, rtice_param.mode1, pwUINT16Temp);
