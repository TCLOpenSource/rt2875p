    ...
    */
	...
	do {
      ...
      /** Copy RTX value */
		...
		if(hdcp2_Rx_CheckTxcaps(message + 1 + RTX_SIZE) == H2_ERROR)
		{
			rtd_pr_hdcp_emerg("AKE_INIT txcaps version is error!\n");
			return -1;
		}
