...
unsigned int Get_Val_smooth_toggle_game_mode_timeout_trigger_flag(void);
...
unsigned char is_scaler_run_i3ddma_vo_path(void);
bool IsPcModeTiming(vfe_hdmi_timing_info_t *info);
...
#endif
void Scaler_SET_VSCDispinfo_WithVFEDP(unsigned char display);
