...
void Mac8p_Pure_HDMI_TMDS_Main_Seq(unsigned char nport, VALUE_PARAM_T value_param)
{
	HDMI_WARN("Pure_HDMI_TMDS_Main_Seq Ver.2022_02_02\n");
...
void DPHY_Fix_1_func(unsigned char nport, VALUE_PARAM_T value_param)
{
	//VCO band manual
...
void DPHY_Param_1_func(unsigned char nport, VALUE_PARAM_T value_param)
{
	//DPHY DCDR KP&KI
	_phy_rtd_part_outl(0x1800db00, 9, 8, DPHY_Param_1[value_param].KP_2); //DCDR KP format 4.2 (.2)
	_phy_rtd_part_outl(0x1800db00, 13, 10, DPHY_Param_1[value_param].KP_3); //DCDR KP format 4.2 (4)
	_phy_rtd_part_outl(0x1800db00, 7, 5, DPHY_Param_1[value_param].KI_4); //DCDR KI
	_phy_rtd_part_outl(0x1800db00, 19, 17, DPHY_Param_1[value_param].RATE_SEL_5); //REG_P0_RATE_SEL
}

void DPHY_Init_Flow_1_func(unsigned char nport, VALUE_PARAM_T value_param)
{
	//VCO band manual
...
void APHY_Fix_1_func(unsigned char nport, VALUE_PARAM_T value_param)
{
	//TOP 
	...
	_phy_rtd_part_outl(0x1800da28, 0, 0, APHY_Fix_1[value_param].CK_CKXTAL_SEL_24); //REG_P0_CK_CKXTAL_SEL
	_phy_rtd_part_outl(0x1800da28, 1, 1, APHY_Fix_1[value_param].CK_SEL_CKIN_25); //REG_P0_CK_SEL_CKIN
...
void APHY_Param_1_func(unsigned char nport, VALUE_PARAM_T value_param)
{
	//CK lane
	_phy_rtd_part_outl(0x1800da20, 11, 10, APHY_Param_1[value_param].CK_SEL_BAND_CAP_2); //REG_P0_CK_SEL_BAND_CAP
	_phy_rtd_part_outl(0x1800da20, 13, 13, APHY_Param_1[value_param].CK_POW_CP2_3); //REG_P0_CK_POW_CP2
	_phy_rtd_part_outl(0x1800da20, 17, 14, APHY_Param_1[value_param].CK_SEL_ICP_4); //REG_P0_CK_SEL_ICP
	_phy_rtd_part_outl(0x1800da20, 24, 22, APHY_Param_1[value_param].CK_SEL_LPF_RES_5); //REG_P0_CK_SEL_LPF_RES
	_phy_rtd_part_outl(0x1800da24, 8, 0, APHY_Param_1[value_param].CK_SEL_M_DIV_6); //REG_P0_CK_SEL_M_DIV
	...
	//BGR lane
	_phy_rtd_part_outl(0x1800da38, 18, 18, 1); //REG_P0_B_PI_CSEL
	_phy_rtd_part_outl(0x1800da48, 18, 18, 1); //REG_P0_B_PI_CSEL
	_phy_rtd_part_outl(0x1800da58, 18, 18, 1); //REG_P0_B_PI_CSEL
	_phy_rtd_part_outl(0x1800da38, 22, 20, APHY_Param_1[value_param].B_PI_ISEL_11); //REG_P0_B_PI_ISEL
	_phy_rtd_part_outl(0x1800da48, 22, 20, APHY_Param_1[value_param].B_PI_ISEL_11_16); //REG_P0_B_PI_ISEL
	_phy_rtd_part_outl(0x1800da58, 22, 20, APHY_Param_1[value_param].B_PI_ISEL_11_32); //REG_P0_B_PI_ISEL
	_phy_rtd_part_outl(0x1800da38, 25, 23, APHY_Param_1[value_param].B_PI_SEL_DATARATE_12); //REG_P0_B_PI_SEL_DATARATE
	_phy_rtd_part_outl(0x1800da48, 25, 23, APHY_Param_1[value_param].B_PI_SEL_DATARATE_12_16); //REG_P0_B_PI_SEL_DATARATE
	_phy_rtd_part_outl(0x1800da58, 25, 23, APHY_Param_1[value_param].B_PI_SEL_DATARATE_12_32); //REG_P0_B_PI_SEL_DATARATE
	_phy_rtd_part_outl(0x1800da38, 15, 15, APHY_Param_1[value_param].B_DEMUX_DIV5_10_SEL_13); //REG_P0_B_DEMUX_DIV5_10_SEL
	_phy_rtd_part_outl(0x1800da48, 15, 15, APHY_Param_1[value_param].B_DEMUX_DIV5_10_SEL_13_16); //REG_P0_B_DEMUX_DIV5_10_SEL
	_phy_rtd_part_outl(0x1800da58, 15, 15, APHY_Param_1[value_param].B_DEMUX_DIV5_10_SEL_13_32); //REG_P0_B_DEMUX_DIV5_10_SEL
	_phy_rtd_part_outl(0x1800da38, 17, 16, APHY_Param_1[value_param].B_DEMUX_RATE_SEL_14); //REG_P0_B_DEMUX_RATE_SEL
	_phy_rtd_part_outl(0x1800da48, 17, 16, APHY_Param_1[value_param].B_DEMUX_RATE_SEL_14_16); //REG_P0_B_DEMUX_RATE_SEL
	_phy_rtd_part_outl(0x1800da58, 17, 16, APHY_Param_1[value_param].B_DEMUX_RATE_SEL_14_32); //REG_P0_B_DEMUX_RATE_SEL
	_phy_rtd_part_outl(0x1800da38, 13, 13, APHY_Param_1[value_param].B_DFE_TAP_EN_15); //REG_P0_B_DFE_TAP_EN, Tap1 enable
	_phy_rtd_part_outl(0x1800da48, 13, 13, APHY_Param_1[value_param].B_DFE_TAP_EN_15_16); //REG_P0_B_DFE_TAP_EN, Tap1 enable
	_phy_rtd_part_outl(0x1800da58, 13, 13, APHY_Param_1[value_param].B_DFE_TAP_EN_15_32); //REG_P0_B_DFE_TAP_EN, Tap1 enable
	_phy_rtd_part_outl(0x1800da38, 14, 14, APHY_Param_1[value_param].B_DFE_TAP_EN_16); //REG_P0_B_DFE_TAP_EN, Tap2 enable
	_phy_rtd_part_outl(0x1800da48, 14, 14, APHY_Param_1[value_param].B_DFE_TAP_EN_16_16); //REG_P0_B_DFE_TAP_EN, Tap2 enable
	_phy_rtd_part_outl(0x1800da58, 14, 14, APHY_Param_1[value_param].B_DFE_TAP_EN_16_32); //REG_P0_B_DFE_TAP_EN, Tap2 enable
	...
	_phy_rtd_part_outl(0x1800da30, 13, 12, APHY_Param_1[value_param].B_LE_IHALF_LE_18); //REG_P0_B_LE_IHALF_LE
	_phy_rtd_part_outl(0x1800da40, 13, 12, APHY_Param_1[value_param].B_LE_IHALF_LE_18_16); //REG_P0_B_LE_IHALF_LE
	_phy_rtd_part_outl(0x1800da50, 13, 12, APHY_Param_1[value_param].B_LE_IHALF_LE_18_32); //REG_P0_B_LE_IHALF_LE
	...
	_phy_rtd_part_outl(0x1800da30, 19, 16, APHY_Param_1[value_param].B_LE_ISEL_LE1_21); //REG_P0_B_LE_ISEL_LE1
	_phy_rtd_part_outl(0x1800da40, 19, 16, APHY_Param_1[value_param].B_LE_ISEL_LE1_21_16); //REG_P0_B_LE_ISEL_LE1
	_phy_rtd_part_outl(0x1800da50, 19, 16, APHY_Param_1[value_param].B_LE_ISEL_LE1_21_32); //REG_P0_B_LE_ISEL_LE1
	_phy_rtd_part_outl(0x1800da30, 23, 20, APHY_Param_1[value_param].B_LE_ISEL_LE2_22); //REG_P0_B_LE_ISEL_LE2
	_phy_rtd_part_outl(0x1800da40, 23, 20, APHY_Param_1[value_param].B_LE_ISEL_LE2_22_16); //REG_P0_B_LE_ISEL_LE2
	_phy_rtd_part_outl(0x1800da50, 23, 20, APHY_Param_1[value_param].B_LE_ISEL_LE2_22_32); //REG_P0_B_LE_ISEL_LE2
	_phy_rtd_part_outl(0x1800da30, 27, 24, APHY_Param_1[value_param].B_LE_ISEL_NC_23); //REG_P0_B_LE_ISEL_NC
	_phy_rtd_part_outl(0x1800da40, 27, 24, APHY_Param_1[value_param].B_LE_ISEL_NC_23_16); //REG_P0_B_LE_ISEL_NC
	_phy_rtd_part_outl(0x1800da50, 27, 24, APHY_Param_1[value_param].B_LE_ISEL_NC_23_32); //REG_P0_B_LE_ISEL_NC
	_phy_rtd_part_outl(0x1800da30, 31, 28, APHY_Param_1[value_param].B_LE_ISEL_TAP0_24); //REG_P0_B_LE_ISEL_TAP0
	_phy_rtd_part_outl(0x1800da40, 31, 28, APHY_Param_1[value_param].B_LE_ISEL_TAP0_24_16); //REG_P0_B_LE_ISEL_TAP0
	_phy_rtd_part_outl(0x1800da50, 31, 28, APHY_Param_1[value_param].B_LE_ISEL_TAP0_24_32); //REG_P0_B_LE_ISEL_TAP0
	_phy_rtd_part_outl(0x1800da34, 1, 0, APHY_Param_1[value_param].B_LE_RLSEL_LE2_25); //REG_P0_B_LE_RLSEL_LE2
	_phy_rtd_part_outl(0x1800da44, 1, 0, APHY_Param_1[value_param].B_LE_RLSEL_LE2_25_16); //REG_P0_B_LE_RLSEL_LE2
	_phy_rtd_part_outl(0x1800da54, 1, 0, APHY_Param_1[value_param].B_LE_RLSEL_LE2_25_32); //REG_P0_B_LE_RLSEL_LE2
	_phy_rtd_part_outl(0x1800da34, 3, 2, APHY_Param_1[value_param].B_LE_RLSEL_LE11_26); //REG_P0_B_LE_RLSEL_LE11
	_phy_rtd_part_outl(0x1800da44, 3, 2, APHY_Param_1[value_param].B_LE_RLSEL_LE11_26_16); //REG_P0_B_LE_RLSEL_LE11
	_phy_rtd_part_outl(0x1800da54, 3, 2, APHY_Param_1[value_param].B_LE_RLSEL_LE11_26_32); //REG_P0_B_LE_RLSEL_LE11
	_phy_rtd_part_outl(0x1800da34, 5, 4, APHY_Param_1[value_param].B_LE_RLSEL_LE12_27); //REG_P0_B_LE_RLSEL_LE12
	_phy_rtd_part_outl(0x1800da44, 5, 4, APHY_Param_1[value_param].B_LE_RLSEL_LE12_27_16); //REG_P0_B_LE_RLSEL_LE12
	_phy_rtd_part_outl(0x1800da54, 5, 4, APHY_Param_1[value_param].B_LE_RLSEL_LE12_27_32); //REG_P0_B_LE_RLSEL_LE12
	_phy_rtd_part_outl(0x1800da34, 7, 6, APHY_Param_1[value_param].B_LE_RLSEL_NC1_28); //REG_P0_B_LE_RLSEL_NC1
	_phy_rtd_part_outl(0x1800da44, 7, 6, APHY_Param_1[value_param].B_LE_RLSEL_NC1_28_16); //REG_P0_B_LE_RLSEL_NC1
	_phy_rtd_part_outl(0x1800da54, 7, 6, APHY_Param_1[value_param].B_LE_RLSEL_NC1_28_32); //REG_P0_B_LE_RLSEL_NC1
	_phy_rtd_part_outl(0x1800da34, 9, 8, APHY_Param_1[value_param].B_LE_RLSEL_NC2_29); //REG_P0_B_LE_RLSEL_NC2
	_phy_rtd_part_outl(0x1800da44, 9, 8, APHY_Param_1[value_param].B_LE_RLSEL_NC2_29_16); //REG_P0_B_LE_RLSEL_NC2
	_phy_rtd_part_outl(0x1800da54, 9, 8, APHY_Param_1[value_param].B_LE_RLSEL_NC2_29_32); //REG_P0_B_LE_RLSEL_NC2
	_phy_rtd_part_outl(0x1800da34, 11, 10, APHY_Param_1[value_param].B_LE_RLSEL_TAP0_30); //REG_P0_B_LE_RLSEL_TAP0
	_phy_rtd_part_outl(0x1800da44, 11, 10, APHY_Param_1[value_param].B_LE_RLSEL_TAP0_30_16); //REG_P0_B_LE_RLSEL_TAP0
	_phy_rtd_part_outl(0x1800da54, 11, 10, APHY_Param_1[value_param].B_LE_RLSEL_TAP0_30_32); //REG_P0_B_LE_RLSEL_TAP0
	_phy_rtd_part_outl(0x1800da34, 14, 12, APHY_Param_1[value_param].B_LE_RSSEL_LE2_31); //REG_P0_B_LE_RSSEL_LE2
	_phy_rtd_part_outl(0x1800da44, 14, 12, APHY_Param_1[value_param].B_LE_RSSEL_LE2_31_16); //REG_P0_B_LE_RSSEL_LE2
	_phy_rtd_part_outl(0x1800da54, 14, 12, APHY_Param_1[value_param].B_LE_RSSEL_LE2_31_32); //REG_P0_B_LE_RSSEL_LE2
	_phy_rtd_part_outl(0x1800da34, 17, 15, APHY_Param_1[value_param].B_LE_RSSEL_LE11_32); //REG_P0_B_LE_RSSEL_LE11
	_phy_rtd_part_outl(0x1800da44, 17, 15, APHY_Param_1[value_param].B_LE_RSSEL_LE11_32_16); //REG_P0_B_LE_RSSEL_LE11
	_phy_rtd_part_outl(0x1800da54, 17, 15, APHY_Param_1[value_param].B_LE_RSSEL_LE11_32_32); //REG_P0_B_LE_RSSEL_LE11
	_phy_rtd_part_outl(0x1800da34, 20, 18, APHY_Param_1[value_param].B_LE_RSSEL_LE12_33); //REG_P0_B_LE_RSSEL_LE12
	_phy_rtd_part_outl(0x1800da44, 20, 18, APHY_Param_1[value_param].B_LE_RSSEL_LE12_33_16); //REG_P0_B_LE_RSSEL_LE12
	_phy_rtd_part_outl(0x1800da54, 20, 18, APHY_Param_1[value_param].B_LE_RSSEL_LE12_33_32); //REG_P0_B_LE_RSSEL_LE12
	_phy_rtd_part_outl(0x1800da34, 22, 21, APHY_Param_1[value_param].B_LE_RSSEL_TAP0_34); //REG_P0_B_LE_RSSEL_TAP0
	_phy_rtd_part_outl(0x1800da44, 22, 21, APHY_Param_1[value_param].B_LE_RSSEL_TAP0_34_16); //REG_P0_B_LE_RSSEL_TAP0
	_phy_rtd_part_outl(0x1800da54, 22, 21, APHY_Param_1[value_param].B_LE_RSSEL_TAP0_34_32); //REG_P0_B_LE_RSSEL_TAP0
	...
	_phy_rtd_part_outl(0x1800da34, 27, 27, APHY_Param_1[value_param].B_POW_NC1_LEQ_38); //REG_P0_B_POW_NC1_LEQ
	_phy_rtd_part_outl(0x1800da44, 27, 27, APHY_Param_1[value_param].B_POW_NC1_LEQ_38_16); //REG_P0_B_POW_NC1_LEQ
	_phy_rtd_part_outl(0x1800da54, 27, 27, APHY_Param_1[value_param].B_POW_NC1_LEQ_38_32); //REG_P0_B_POW_NC1_LEQ
...
void APHY_Init_Flow_1_func(unsigned char nport, VALUE_PARAM_T value_param)
{
	//CK lane
...
void DCDR_settings_1_func(unsigned char nport, VALUE_PARAM_T value_param)
{
...
void DFE_ini_1_func(unsigned char nport, VALUE_PARAM_T value_param)
{
	//=========================================Adapt initial =================================================
	...
	_phy_rtd_part_outl(0x1800de38, 25, 20, DFE_ini_1[value_param].tap1_min_p2_6); //tap1_min<5:0>
	...
	_phy_rtd_part_outl(0x1800de04, 13, 7, DFE_ini_1[value_param].tap0_init_lane0_p2_11); //B-Lane, tap0_init<6:0>
	_phy_rtd_part_outl(0x1800de14, 13, 7, DFE_ini_1[value_param].tap0_init_lane0_p2_11_16); //B-Lane, tap0_init<6:0>
	_phy_rtd_part_outl(0x1800de24, 13, 7, DFE_ini_1[value_param].tap0_init_lane0_p2_11_32); //B-Lane, tap0_init<6:0>
	_phy_rtd_part_outl(0x1800de00, 15, 11, DFE_ini_1[value_param].le_min_lane0_p2_12); //B-Lane, le_min<4:0>
	_phy_rtd_part_outl(0x1800de10, 15, 11, DFE_ini_1[value_param].le_min_lane0_p2_12_16); //B-Lane, le_min<4:0>
	_phy_rtd_part_outl(0x1800de20, 15, 11, DFE_ini_1[value_param].le_min_lane0_p2_12_32); //B-Lane, le_min<4:0>
	_phy_rtd_part_outl(0x1800de00, 10, 6, DFE_ini_1[value_param].le_init_lane0_p2_13); //B-Lane, le_init<4:0>
	_phy_rtd_part_outl(0x1800de10, 10, 6, DFE_ini_1[value_param].le_init_lane0_p2_13_16); //B-Lane, le_init<4:0>
	_phy_rtd_part_outl(0x1800de20, 10, 6, DFE_ini_1[value_param].le_init_lane0_p2_13_32); //B-Lane, le_init<4:0>
	_phy_rtd_part_outl(0x1800de04, 19, 14, DFE_ini_1[value_param].tap1_init_lane0_p2_14); //B-Lane, tap1_init<5:0>
	_phy_rtd_part_outl(0x1800de14, 19, 14, DFE_ini_1[value_param].tap1_init_lane0_p2_14_16); //B-Lane, tap1_init<5:0>
	_phy_rtd_part_outl(0x1800de24, 19, 14, DFE_ini_1[value_param].tap1_init_lane0_p2_14_32); //B-Lane, tap1_init<5:0>
	...
	//===================== Adapt mode setting =====================
	_phy_rtd_part_outl(0x1800de30, 31, 30, DFE_ini_1[value_param].adapt_mode_p2_20); //adapt_mode_p2<1:0>
...
void Koffset_1_func(unsigned char nport, VALUE_PARAM_T value_param)
{
...
void DCDR_settings_2_func(unsigned char nport, VALUE_PARAM_T value_param)
{
	//DEMUX_Reset
...
void LEQ_TAP0_Adapt_1_func(unsigned char nport, VALUE_PARAM_T value_param)
{
	//===================== Adapt EN =====================
	_phy_rtd_part_outl(0x1800da38, 0, 0, LEQ_TAP0_Adapt_1[value_param].B_DFE_ADAPT_EN_2); //B-Lane, DFE_ADAPT_EN (APHY)
	_phy_rtd_part_outl(0x1800da48, 0, 0, LEQ_TAP0_Adapt_1[value_param].B_DFE_ADAPT_EN_2_16); //B-Lane, DFE_ADAPT_EN (APHY)
	_phy_rtd_part_outl(0x1800da58, 0, 0, LEQ_TAP0_Adapt_1[value_param].B_DFE_ADAPT_EN_2_32); //B-Lane, DFE_ADAPT_EN (APHY)
	_phy_rtd_part_outl(0x1800de00, 30, 30, LEQ_TAP0_Adapt_1[value_param].timer_ctrl_en_lane0_p2_3); //B-Lane, timer_ctrl_en
	_phy_rtd_part_outl(0x1800de10, 30, 30, LEQ_TAP0_Adapt_1[value_param].timer_ctrl_en_lane0_p2_3_16); //B-Lane, timer_ctrl_en
	_phy_rtd_part_outl(0x1800de20, 30, 30, LEQ_TAP0_Adapt_1[value_param].timer_ctrl_en_lane0_p2_3_32); //B-Lane, timer_ctrl_en
	_phy_rtd_part_outl(0x1800de00, 22, 22, LEQ_TAP0_Adapt_1[value_param].dfe_adapt_en_lane0_p2_4); //B-Lane, dfe_adapt_en enable Vth adapt
	_phy_rtd_part_outl(0x1800de10, 22, 22, LEQ_TAP0_Adapt_1[value_param].dfe_adapt_en_lane0_p2_4_16); //B-Lane, dfe_adapt_en enable Vth adapt
	_phy_rtd_part_outl(0x1800de20, 22, 22, LEQ_TAP0_Adapt_1[value_param].dfe_adapt_en_lane0_p2_4_32); //B-Lane, dfe_adapt_en enable Vth adapt
	_phy_rtd_part_outl(0x1800de00, 16, 16, LEQ_TAP0_Adapt_1[value_param].dfe_adapt_en_lane0_p2_5); //B-Lane, dfe_adapt_en enable Tap0 adapt
	_phy_rtd_part_outl(0x1800de10, 16, 16, LEQ_TAP0_Adapt_1[value_param].dfe_adapt_en_lane0_p2_5_16); //B-Lane, dfe_adapt_en enable Tap0 adapt
	_phy_rtd_part_outl(0x1800de20, 16, 16, LEQ_TAP0_Adapt_1[value_param].dfe_adapt_en_lane0_p2_5_32); //B-Lane, dfe_adapt_en enable Tap0 adapt
	ScalerTimer_DelayXms(1);
	_phy_rtd_part_outl(0x1800de00, 23, 23, LEQ_TAP0_Adapt_1[value_param].dfe_adapt_en_lane0_p2_6); //B-Lane, dfe_adapt_en enable Le adapt
	_phy_rtd_part_outl(0x1800de10, 23, 23, LEQ_TAP0_Adapt_1[value_param].dfe_adapt_en_lane0_p2_6_16); //B-Lane, dfe_adapt_en enable Le adapt
	_phy_rtd_part_outl(0x1800de20, 23, 23, LEQ_TAP0_Adapt_1[value_param].dfe_adapt_en_lane0_p2_6_32); //B-Lane, dfe_adapt_en enable Le adapt
	_phy_rtd_part_outl(0x1800de00, 17, 17, LEQ_TAP0_Adapt_1[value_param].dfe_adapt_en_lane0_p2_7); //B-Lane, dfe_adapt_en enable Tap1 adapt
	_phy_rtd_part_outl(0x1800de10, 17, 17, LEQ_TAP0_Adapt_1[value_param].dfe_adapt_en_lane0_p2_7_16); //B-Lane, dfe_adapt_en enable Tap1 adapt
	_phy_rtd_part_outl(0x1800de20, 17, 17, LEQ_TAP0_Adapt_1[value_param].dfe_adapt_en_lane0_p2_7_32); //B-Lane, dfe_adapt_en enable Tap1 adapt
	ScalerTimer_DelayXms(1);
	_phy_rtd_part_outl(0x1800de00, 18, 18, LEQ_TAP0_Adapt_1[value_param].dfe_adapt_en_lane0_p2_8); //B-Lane, dfe_adapt_en enable Tap2 adapt
	_phy_rtd_part_outl(0x1800de10, 18, 18, LEQ_TAP0_Adapt_1[value_param].dfe_adapt_en_lane0_p2_8_16); //B-Lane, dfe_adapt_en enable Tap2 adapt
	_phy_rtd_part_outl(0x1800de20, 18, 18, LEQ_TAP0_Adapt_1[value_param].dfe_adapt_en_lane0_p2_8_32); //B-Lane, dfe_adapt_en enable Tap2 adapt
	ScalerTimer_DelayXms(1);
	//===================== Adapt disable =====================
	_phy_rtd_part_outl(0x1800de00, 23, 16, 0); //B-Lane, dfe_adapt_en disable
	_phy_rtd_part_outl(0x1800de10, 23, 16, 0); //B-Lane, dfe_adapt_en disable
...
void TAP0_2_Adapt_1_func(unsigned char nport, VALUE_PARAM_T value_param)
{
	//===================== Adapt EN =====================
	_phy_rtd_part_outl(0x1800da38, 0, 0, TAP0_2_Adapt_1[value_param].B_DFE_ADAPT_EN_2); //B-Lane, DFE_ADAPT_EN (APHY)
	_phy_rtd_part_outl(0x1800da48, 0, 0, TAP0_2_Adapt_1[value_param].B_DFE_ADAPT_EN_2_16); //B-Lane, DFE_ADAPT_EN (APHY)
	_phy_rtd_part_outl(0x1800da58, 0, 0, TAP0_2_Adapt_1[value_param].B_DFE_ADAPT_EN_2_32); //B-Lane, DFE_ADAPT_EN (APHY)
	_phy_rtd_part_outl(0x1800de00, 30, 30, TAP0_2_Adapt_1[value_param].timer_ctrl_en_lane0_p2_3); //B-Lane, timer_ctrl_en
	_phy_rtd_part_outl(0x1800de10, 30, 30, TAP0_2_Adapt_1[value_param].timer_ctrl_en_lane0_p2_3_16); //B-Lane, timer_ctrl_en
	_phy_rtd_part_outl(0x1800de20, 30, 30, TAP0_2_Adapt_1[value_param].timer_ctrl_en_lane0_p2_3_32); //B-Lane, timer_ctrl_en
	_phy_rtd_part_outl(0x1800de00, 22, 22, TAP0_2_Adapt_1[value_param].dfe_adapt_en_lane0_p2_4); //B-Lane, dfe_adapt_en enable Vth adapt
	_phy_rtd_part_outl(0x1800de10, 22, 22, TAP0_2_Adapt_1[value_param].dfe_adapt_en_lane0_p2_4_16); //B-Lane, dfe_adapt_en enable Vth adapt
	_phy_rtd_part_outl(0x1800de20, 22, 22, TAP0_2_Adapt_1[value_param].dfe_adapt_en_lane0_p2_4_32); //B-Lane, dfe_adapt_en enable Vth adapt
	_phy_rtd_part_outl(0x1800de00, 16, 16, TAP0_2_Adapt_1[value_param].dfe_adapt_en_lane0_p2_5); //B-Lane, dfe_adapt_en enable Tap0 adapt
	_phy_rtd_part_outl(0x1800de10, 16, 16, TAP0_2_Adapt_1[value_param].dfe_adapt_en_lane0_p2_5_16); //B-Lane, dfe_adapt_en enable Tap0 adapt
	_phy_rtd_part_outl(0x1800de20, 16, 16, TAP0_2_Adapt_1[value_param].dfe_adapt_en_lane0_p2_5_32); //B-Lane, dfe_adapt_en enable Tap0 adapt
	ScalerTimer_DelayXms(1);
	_phy_rtd_part_outl(0x1800de00, 23, 23, TAP0_2_Adapt_1[value_param].dfe_adapt_en_lane0_p2_6); //B-Lane, dfe_adapt_en enable Le adapt
	_phy_rtd_part_outl(0x1800de10, 23, 23, TAP0_2_Adapt_1[value_param].dfe_adapt_en_lane0_p2_6_16); //B-Lane, dfe_adapt_en enable Le adapt
	_phy_rtd_part_outl(0x1800de20, 23, 23, TAP0_2_Adapt_1[value_param].dfe_adapt_en_lane0_p2_6_32); //B-Lane, dfe_adapt_en enable Le adapt
	_phy_rtd_part_outl(0x1800de00, 17, 17, TAP0_2_Adapt_1[value_param].dfe_adapt_en_lane0_p2_7); //B-Lane, dfe_adapt_en enable Tap1 adapt
	_phy_rtd_part_outl(0x1800de10, 17, 17, TAP0_2_Adapt_1[value_param].dfe_adapt_en_lane0_p2_7_16); //B-Lane, dfe_adapt_en enable Tap1 adapt
	_phy_rtd_part_outl(0x1800de20, 17, 17, TAP0_2_Adapt_1[value_param].dfe_adapt_en_lane0_p2_7_32); //B-Lane, dfe_adapt_en enable Tap1 adapt
	ScalerTimer_DelayXms(1);
	_phy_rtd_part_outl(0x1800de00, 18, 18, TAP0_2_Adapt_1[value_param].dfe_adapt_en_lane0_p2_8); //B-Lane, dfe_adapt_en enable Tap2 adapt
	_phy_rtd_part_outl(0x1800de10, 18, 18, TAP0_2_Adapt_1[value_param].dfe_adapt_en_lane0_p2_8_16); //B-Lane, dfe_adapt_en enable Tap2 adapt
	_phy_rtd_part_outl(0x1800de20, 18, 18, TAP0_2_Adapt_1[value_param].dfe_adapt_en_lane0_p2_8_32); //B-Lane, dfe_adapt_en enable Tap2 adapt
	ScalerTimer_DelayXms(1);
	//===================== Adapt disable =====================
	_phy_rtd_part_outl(0x1800de00, 23, 16, 0); //B-Lane, dfe_adapt_en disable
	_phy_rtd_part_outl(0x1800de10, 23, 16, 0); //B-Lane, dfe_adapt_en disable
...
void Manual_DFE_1_func(unsigned char nport, VALUE_PARAM_T value_param)
{
	_phy_rtd_part_outl(0x1800de00, 23, 16, 0); //B-Lane, dfe_adapt_en disable
	_phy_rtd_part_outl(0x1800de10, 23, 16, 0); //B-Lane, dfe_adapt_en disable
	_phy_rtd_part_outl(0x1800de20, 23, 16, 0); //B-Lane, dfe_adapt_en disable
	...
	_phy_rtd_part_outl(0x1800de3c, 18, 15, 7); //vth_max<3:0>
	_phy_rtd_part_outl(0x1800de40, 15, 9, 36); //tap0_max<6:0>
	_phy_rtd_part_outl(0x1800de38, 25, 20, Manual_DFE_1[value_param].tap1_min_p2_7); //tap1_min<5:0>
	_phy_rtd_part_outl(0x1800de38, 19, 15, 31); //tap2_max<4:0>
	_phy_rtd_part_outl(0x1800de38, 14, 10, Manual_DFE_1[value_param].tap2_min_p2_9); //tap2_min<4:0>
	_phy_rtd_part_outl(0x1800de04, 3, 0, Manual_DFE_1[value_param].vth_init_lane0_p2_10); //B-Lane, vth_init<3:0>
	_phy_rtd_part_outl(0x1800de14, 3, 0, Manual_DFE_1[value_param].vth_init_lane0_p2_10_16); //B-Lane, vth_init<3:0>
	_phy_rtd_part_outl(0x1800de24, 3, 0, Manual_DFE_1[value_param].vth_init_lane0_p2_10_32); //B-Lane, vth_init<3:0>
...
void Mac8p_TMDS_setting_Main_Seq(unsigned char nport, VALUE_PARAM_T value_param)
{
...
void DFE_ini_tmds_1_func(unsigned char nport, VALUE_PARAM_T value_param)
{
...
void DPHY_Fix_tmds_1_func(unsigned char nport, VALUE_PARAM_T value_param)
{
	//DPHY fix start
...
void DPHY_Para_tmds_1_func(unsigned char nport, VALUE_PARAM_T value_param)
{
	// DPHY para start
...
void APHY_Fix_tmds_1_func(unsigned char nport, VALUE_PARAM_T value_param)
{
	//APHY fix start
...
void APHY_Para_tmds_1_func(unsigned char nport, VALUE_PARAM_T value_param)
{
	// APHY para start
...
void DPHY_Init_Flow_tmds_1_func(unsigned char nport, VALUE_PARAM_T value_param)
{
...
void APHY_Init_Flow_tmds_1_func(unsigned char nport, VALUE_PARAM_T value_param)
{
...
void DCDR_settings_tmds_1_func(unsigned char nport, VALUE_PARAM_T value_param)
{
...
void DCDR_settings_tmds_2_func(unsigned char nport, VALUE_PARAM_T value_param)
{
...
void Koffset_tmds_1_func(unsigned char nport, VALUE_PARAM_T value_param)
{
...
void LEQ_VTH_Tap0_3_4_Adapt_tmds_1_func(unsigned char nport, VALUE_PARAM_T value_param)
{
...
void Tap0_to_Tap4_Adapt_tmds_1_func(unsigned char nport, VALUE_PARAM_T value_param)
{
	_phy_rtd_part_outl(0x1803bcb0, 15, 15, 1); //offset_code/vth select
	_phy_rtd_part_outl(0x1803bcb0, 14, 14, 1); //offset_code/vth select
	_phy_rtd_part_outl(0x1803bcb0, 13, 13, 1); //offset_code/vth select
...
void DCDR_settings_tmds_3_func(unsigned char nport, VALUE_PARAM_T value_param)
{
...
void Manual_DFE_tmds_1_func(unsigned char nport, VALUE_PARAM_T value_param)
{
	// *************************************************************************************************************************************
	//B-Lane_initial DFE Value_Start
	_phy_rtd_part_outl(0x1803bcb0, 15, 15, 1); //offset_code/vth select
...
{  
	...
	VALUE_PARAM_T TMDS_Timing = TMDS_5p94G;
...
void lib_hdmi_z300_sel(unsigned char nport, unsigned char mode)  // 0: active mode 1:vcm mode
{
	...
	if (mode) {
		hdmi_mask(GDIRX_HDMI20_PHY_P0_Z0POW_reg, ~(GDIRX_HDMI20_PHY_P0_Z0POW_reg_p0_z0_z0pow_fix_mask),1);
	} else {
		hdmi_mask(GDIRX_HDMI20_PHY_P0_Z0POW_reg, ~(GDIRX_HDMI20_PHY_P0_Z0POW_reg_p0_z0_z0pow_fix_mask), 0);
	}
	}
	else
	{
		if (mode) {
			hdmi_mask(HDMIRX_PHY_Z0K_reg, ~(HDMIRX_PHY_Z0K_reg_p0_z0_z0pow_fix_mask), HDMIRX_PHY_Z0K_get_reg_p0_z0_z0pow_fix(1));
		} else {
			hdmi_mask(HDMIRX_PHY_Z0K_reg, ~(HDMIRX_PHY_Z0K_reg_p0_z0_z0pow_fix_mask), HDMIRX_PHY_Z0K_get_reg_p0_z0_z0pow_fix(0));
		}
