...
#include "../tvscalercontrol/rtd2851a/hdmirx/hdmiInternal.h"
...
//	spu_print(ks, 16);
	...
	#if ENABLE_DDC_WRITE
	#if defined(NEWBASE_FUNC)
	if (lib_hdmi_hdcp22_set_ks(nport,ks)<0)
	{
		HDCP_WARN("[HDMIp%d] set KS failed, set reauth flag to force reauth\n", nport);
...
H2status hdcp2_load_from_default(void)
{
	...
	//rtd_pr_hdcp_emerg("hdcp2_load_from_flash no used\n");
	//return H2_OK;
