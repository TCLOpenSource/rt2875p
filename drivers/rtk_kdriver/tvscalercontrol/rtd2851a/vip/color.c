...
yuvdata Domain_3DLUT_16[9*9*9]={0};
yuvdata temp_Domain_3DLUT_16[9*9*9]={0};
...
/*uv half mid ctl0*/
	{
	color_sharp_shp_dcti_uv_half_mid_ctrl_0_RBUS dm_dcti_uvhalfmid_REG_0;
	dm_dcti_uvhalfmid_REG_0.regValue = IoReg_Read32(COLOR_SHARP_SHP_DCTI_UV_HALF_MID_CTRL_0_reg);
	dm_dcti_uvhalfmid_REG_0.halfmid_en = ptr->VipNewDDcti_uvhalfmid_ctl0.halfmid_en;
	dm_dcti_uvhalfmid_REG_0.halfmid_consi_align_en = ptr->VipNewDDcti_uvhalfmid_ctl0.halfmid_consi_align_en;
	dm_dcti_uvhalfmid_REG_0.halfmid_filter_mode = ptr->VipNewDDcti_uvhalfmid_ctl0.halfmid_filter_mode;
	dm_dcti_uvhalfmid_REG_0.halfmid_hp_mode = ptr->VipNewDDcti_uvhalfmid_ctl0.halfmid_hp_mode;
	dm_dcti_uvhalfmid_REG_0.halfmid_th_coring = ptr->VipNewDDcti_uvhalfmid_ctl0.halfmid_th_coring;
	dm_dcti_uvhalfmid_REG_0.halfmid_steep_mode = ptr->VipNewDDcti_uvhalfmid_ctl0.halfmid_steep_mode;
	dm_dcti_uvhalfmid_REG_0.halfmid_th_steep = ptr->VipNewDDcti_uvhalfmid_ctl0.halfmid_th_steep;
	dm_dcti_uvhalfmid_REG_0.halfmid_rate_steep = ptr->VipNewDDcti_uvhalfmid_ctl0.halfmid_rate_steep;
	IoReg_Write32(COLOR_SHARP_SHP_DCTI_UV_HALF_MID_CTRL_0_reg, dm_dcti_uvhalfmid_REG_0.regValue);
	}
/*uv half mid ctl1*/
	{
	color_sharp_shp_dcti_uv_half_mid_ctrl_1_RBUS dm_dcti_uvhalfmid_REG_1;
	dm_dcti_uvhalfmid_REG_1.regValue = IoReg_Read32(COLOR_SHARP_SHP_DCTI_UV_HALF_MID_CTRL_1_reg);
	dm_dcti_uvhalfmid_REG_1.slopediff_maxmin_en = ptr->VipNewDDcti_uvhalfmid_ctl1.slopediff_maxmin_en;
	dm_dcti_uvhalfmid_REG_1.slopediff_fixlen = ptr->VipNewDDcti_uvhalfmid_ctl1.slopediff_fixlen;
	dm_dcti_uvhalfmid_REG_1.slopediff_mode = ptr->VipNewDDcti_uvhalfmid_ctl1.slopediff_mode;
	dm_dcti_uvhalfmid_REG_1.rate_slopediff_sum = ptr->VipNewDDcti_uvhalfmid_ctl1.rate_slopediff_sum;
	dm_dcti_uvhalfmid_REG_1.th_slopediff_sum = ptr->VipNewDDcti_uvhalfmid_ctl1.th_slopediff_sum;
	dm_dcti_uvhalfmid_REG_1.halfmid_psmth = ptr->VipNewDDcti_uvhalfmid_ctl1.halfmid_psmth;
	IoReg_Write32(COLOR_SHARP_SHP_DCTI_UV_HALF_MID_CTRL_1_reg, dm_dcti_uvhalfmid_REG_1.regValue);
	}
/*uv half mid ctl2*/
	{
	color_sharp_shp_dcti_uv_half_mid_ctrl_2_RBUS dm_dcti_uvhalfmid_REG_2;
	dm_dcti_uvhalfmid_REG_2.regValue = IoReg_Read32(COLOR_SHARP_SHP_DCTI_UV_HALF_MID_CTRL_2_reg);
	dm_dcti_uvhalfmid_REG_2.halfmid_blending = ptr->VipNewDDcti_uvhalfmid_ctl2.halfmid_blending;
	dm_dcti_uvhalfmid_REG_2.offs_enhance_val = ptr->VipNewDDcti_uvhalfmid_ctl2.offs_enhance_val;
	dm_dcti_uvhalfmid_REG_2.offs_enhance_bit = ptr->VipNewDDcti_uvhalfmid_ctl2.offs_enhance_bit;
	dm_dcti_uvhalfmid_REG_2.offs_enhance_mode = ptr->VipNewDDcti_uvhalfmid_ctl2.offs_enhance_mode;
	dm_dcti_uvhalfmid_REG_2.halfmid_rate_eng = ptr->VipNewDDcti_uvhalfmid_ctl2.halfmid_rate_eng;
	dm_dcti_uvhalfmid_REG_2.halfmid_th_eng = ptr->VipNewDDcti_uvhalfmid_ctl2.halfmid_th_eng;
	IoReg_Write32(COLOR_SHARP_SHP_DCTI_UV_HALF_MID_CTRL_2_reg, dm_dcti_uvhalfmid_REG_2.regValue);
	}
/*V ctl0*/
	{
...
//	out_gamma_port_REG.regValue = IoReg_Read32(OUTPUTGAMMA_OUT_GAMMA_PORT_reg);
	...
	if (display == SLR_MAIN_DISPLAY) {
//		out_gamma_port_REG.out_gamma_tab_index = 0;
...
//	inv_out_gamma_port_REG.regValue = IoReg_Read32(INVOUTPUTGAMMA_INV_OUT_GAMMA_PORT_reg);
	...
	if (display == SLR_MAIN_DISPLAY) {
//		inv_out_gamma_port_REG.inv_out_gamma_tab_index = 0;
...
/*Ctl4_v*/
	...
	ich1_newdcti_reg_4_v.rate_align_weight_v = ptr->VipNewIDcti_ctl4_v.rate_align_weight_v;
	...
	ich1_newdcti_reg_4_v.th_align_weight_v = ptr->VipNewIDcti_ctl4_v.th_align_weight_v;
...
*/
		...
		case PQ_ByPass_I_DCTI:
			ret = (IoReg_Read32(IDCTI_I_DCTI_CTRL_1_reg)&IDCTI_I_DCTI_CTRL_1_dcti_en_mask)>>IDCTI_I_DCTI_CTRL_1_dcti_en_shift;
		break;
...
char drvif_color_set_DeMura(DRV_DeMura_DMA_TBL* pDMA_TBL, DRV_DeMura_CTRL_TBL *ptr, unsigned char *pArray, unsigned int addr, unsigned int *vir_addr, unsigned int TBL_Line_size)
{
	...
	*/
	...
	demura_demura_control_reg.demura_table_scale_l = ptr->demura_table_scale_L;/*juwen, mac6p*/
	demura_demura_control_reg.demura_table_scale_m= ptr->demura_table_scale_M;/*juwen, mac6p*/
	demura_demura_control_reg.demura_table_scale_h= ptr->demura_table_scale_H;/*juwen, mac6p*/
