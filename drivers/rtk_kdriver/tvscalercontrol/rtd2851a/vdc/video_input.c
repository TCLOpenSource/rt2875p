...
//	vd_adc_clamp_ctl_1_reg.vdadc_clamp_ctrl0_7_4 = 0xe;		/* 2_0048[23:20] = 0xe, 1.28v */
	...
	/*20170316 review OK*/
    vd_opt = ((rtdf_inl(EFUSE_DATAO_49_reg)&0x80000000)>>31);  //Add OTP address to set VDADC_ADC_CTRL_LDO1V0  2020/06/05
    if (vd_opt==1){                                             //vd_otp : otp done flag
		VDADC_ADC_CTRL_LDO1V0_sel = ((rtdf_inl(EFUSE_DATAO_49_reg)&0x70000000)>>28);
	}else {
		VDADC_ADC_CTRL_LDO1V0_sel = 0x1;                        //default valure = 0x001(0.95V)
	}
	vdadc_core_lpf_ctrl_rbus_reg.vdadc_adc_ctrl_15_14 = 0x1;	/* 2_0054[31:30]=01 */
	vdadc_core_lpf_ctrl_rbus_reg.vdadc_adc_ctrl_13 = 0x0;		/* 2_0054[29]=0 */
	...
	vdadc_core_lpf_ctrl_rbus_reg.vdadc_adc_ctrl_0 = 0x0;		/* 2_0054[16]=0, default ADC S/H gain. (0:1X, 1:1.6X) normal signal setting=0x0 after m7p */
