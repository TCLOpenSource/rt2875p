...
void lib_hdmi_mac_crt_perport_on(unsigned char nport)
{
    ...
    lib_hdmi_hdcp22_reset_aes_engine(nport);   // Mac7p/8p/...series have to run this .Reset AES engine (After reset HDCP, we need to reset AES engine as well)
}
...
void lib_hdmi_crt_on(unsigned char nport)
{
    ...
    val |= HDMI_hdmi_rst0_rstn_hdmi_common_mask;
    ...
    val |= HDMI_hdmi_clken0_clken_hdmi_common_mask;
...
void lib_hdmi_crt_off_hdmi_common(void)
{
    // reset HDMI2.0 MAC common : including DEEP Color, YUV420, CRC, MD_Detect...
    HDMI_INFO("[CRT] lib_hdmi_crt_off_hdmi_common\n");
...
unsigned char lib_hdmi_crt_is_hdmi_common_enabled(void)
{
...
{
    HDMI_WARN("[lib_hdmi_power nport:%d] enable=%d\n", nport, enable);
    if (enable) {
...
#define FVCO_MAX    500
    ...
    {
        HDMI_EMG("[ERR] lib_hdmi_set_video_pll failed, not support FRL mode\n");
        return FALSE;
    }
    ...
    *pll_pixelclockx1024 =pixel_clockx1024;
    ...
    if (frl_mode == MODE_TMDS)
    {
        ...
        if (i >= tabsize)
        {
            ...
            //if (frl_mode == MODE_TMDS) (always reach this statement)
                fpfd1024 = (b_clk * 27 * 1024 / 256) / (bpsin + ((1-bpsin) * n));
            /*else  //frl mode   (Logically dead code : can't reach this statement)
...
void lib_hdmi_set_video_pll_power_down(unsigned char nport)
{
...
void lib_hdmi_set_video_pll_power_up(unsigned char nport)
{
...
void lib_hdmi_crc_continue_mode_en(unsigned char enable)
{
    if(enable)
...
int lib_hdmi_get_crc_auto_cmp_status(void)
{
    return HDMI_P0_CRC_Ctrl_get_crc_auto_cmp_en(hdmi_in(HDMI_CRC_Ctrl_reg));
}

int lib_hdmi_read_video_common_crc(unsigned char res_sel, unsigned int* p_crc, unsigned char is_continue_mode)
{// Common crc
    if(is_continue_mode)
    {
...
// HD20/21 CTRL
//------------------------------------------------------------------
void lib_hdmi_set_hd20_21_ctrl_pixel_mode(unsigned char nport, unsigned char pixel_mode)
...
{
    unsigned int offset = nport * 0x100;
    ...
    // ----------------------------------------- EX PHY FIFO -------------------------------------------------
    // 1. ex phy fifo ck en
    hdmi_mask(HDMI_PURE_EX_P0_EX_PHY_FIFO_CR0_reg + offset,
        ~(HDMI_PURE_EX_P0_EX_PHY_FIFO_CR0_port0_b_afifo_en_mask|HDMI_PURE_EX_P0_EX_PHY_FIFO_CR0_port0_g_afifo_en_mask|HDMI_PURE_EX_P0_EX_PHY_FIFO_CR0_port0_r_afifo_en_mask),
        (HDMI_PURE_EX_P0_EX_PHY_FIFO_CR0_port0_b_afifo_en_mask|HDMI_PURE_EX_P0_EX_PHY_FIFO_CR0_port0_g_afifo_en_mask|HDMI_PURE_EX_P0_EX_PHY_FIFO_CR0_port0_r_afifo_en_mask));    // Port0
    hdmi_mask(HDMI_PURE_EX_P0_EX_PHY_FIFO_CR0_reg + offset,
        ~(HDMI_PURE_EX_P0_EX_PHY_FIFO_CR0_port1_b_afifo_en_mask|HDMI_PURE_EX_P0_EX_PHY_FIFO_CR0_port1_g_afifo_en_mask|HDMI_PURE_EX_P0_EX_PHY_FIFO_CR0_port1_r_afifo_en_mask),
        (HDMI_PURE_EX_P0_EX_PHY_FIFO_CR0_port1_b_afifo_en_mask|HDMI_PURE_EX_P0_EX_PHY_FIFO_CR0_port1_g_afifo_en_mask|HDMI_PURE_EX_P0_EX_PHY_FIFO_CR0_port1_r_afifo_en_mask));    // Port1
    hdmi_mask(HDMI_PURE_EX_P0_EX_PHY_FIFO_CR0_reg + offset,
        ~(HDMI_PURE_EX_P0_EX_PHY_FIFO_CR0_port2_b_afifo_en_mask|HDMI_PURE_EX_P0_EX_PHY_FIFO_CR0_port2_g_afifo_en_mask|HDMI_PURE_EX_P0_EX_PHY_FIFO_CR0_port2_r_afifo_en_mask),
        (HDMI_PURE_EX_P0_EX_PHY_FIFO_CR0_port2_b_afifo_en_mask|HDMI_PURE_EX_P0_EX_PHY_FIFO_CR0_port2_g_afifo_en_mask|HDMI_PURE_EX_P0_EX_PHY_FIFO_CR0_port2_r_afifo_en_mask));    // Port2
    hdmi_mask(HDMI_PURE_EX_P0_EX_PHY_FIFO_CR0_reg + offset,
        ~(HDMI_PURE_EX_P0_EX_PHY_FIFO_CR0_port3_b_afifo_en_mask|HDMI_PURE_EX_P0_EX_PHY_FIFO_CR0_port3_g_afifo_en_mask|HDMI_PURE_EX_P0_EX_PHY_FIFO_CR0_port3_r_afifo_en_mask),
        (HDMI_PURE_EX_P0_EX_PHY_FIFO_CR0_port3_b_afifo_en_mask|HDMI_PURE_EX_P0_EX_PHY_FIFO_CR0_port3_g_afifo_en_mask|HDMI_PURE_EX_P0_EX_PHY_FIFO_CR0_port3_r_afifo_en_mask));    // Port2

    // 2. ex phy afifo en
    hdmi_mask(HDMI_PURE_EX_P0_EX_PHY_FIFO_CR2_reg + offset,
        ~(HDMI_PURE_EX_P0_EX_PHY_FIFO_CR2_port0_c_afifo_en_mask|HDMI_PURE_EX_P0_EX_PHY_FIFO_CR2_port1_c_afifo_en_mask),
        (HDMI_PURE_EX_P0_EX_PHY_FIFO_CR2_port0_c_afifo_en_mask|HDMI_PURE_EX_P0_EX_PHY_FIFO_CR2_port1_c_afifo_en_mask));    // Port0_c_afifo_en & Port1_c_afifo_en = 1

    hdmi_mask(HDMI_PURE_EX_P0_EX_PHY_FIFO_CR2_reg + offset,
        ~(HDMI_PURE_EX_P0_EX_PHY_FIFO_CR2_port2_c_afifo_en_mask|HDMI_PURE_EX_P0_EX_PHY_FIFO_CR2_port3_c_afifo_en_mask),
        (HDMI_PURE_EX_P0_EX_PHY_FIFO_CR2_port2_c_afifo_en_mask|HDMI_PURE_EX_P0_EX_PHY_FIFO_CR2_port3_c_afifo_en_mask));    // Port2_c_afifo_en & Port3_c_afifo_en = 1

    // 3. ex mac  clk invert
    hdmi_mask(HDMI_PURE_EX_P0_EX_PHY_FIFO_CR1_reg + offset,
        ~(HDMI_PURE_EX_P0_EX_PHY_FIFO_CR1_port0_rclk_inv_mask|HDMI_PURE_EX_P0_EX_PHY_FIFO_CR1_port0_gclk_inv_mask|HDMI_PURE_EX_P0_EX_PHY_FIFO_CR1_port0_bclk_inv_mask),
       (HDMI_PURE_EX_P0_EX_PHY_FIFO_CR1_port0_rclk_inv_mask|HDMI_PURE_EX_P0_EX_PHY_FIFO_CR1_port0_gclk_inv_mask|HDMI_PURE_EX_P0_EX_PHY_FIFO_CR1_port0_bclk_inv_mask));    // port0
    hdmi_mask(HDMI_PURE_EX_P0_EX_PHY_FIFO_CR1_reg + offset,
        ~(HDMI_PURE_EX_P0_EX_PHY_FIFO_CR1_port1_rclk_inv_mask|HDMI_PURE_EX_P0_EX_PHY_FIFO_CR1_port1_gclk_inv_mask|HDMI_PURE_EX_P0_EX_PHY_FIFO_CR1_port1_bclk_inv_mask),
       (HDMI_PURE_EX_P0_EX_PHY_FIFO_CR1_port1_rclk_inv_mask|HDMI_PURE_EX_P0_EX_PHY_FIFO_CR1_port1_gclk_inv_mask|HDMI_PURE_EX_P0_EX_PHY_FIFO_CR1_port1_bclk_inv_mask));    // port1

    hdmi_mask(HDMI_PURE_EX_P0_EX_PHY_FIFO_CR1_reg + offset,
        ~(HDMI_PURE_EX_P0_EX_PHY_FIFO_CR1_port2_rclk_inv_mask|HDMI_PURE_EX_P0_EX_PHY_FIFO_CR1_port2_gclk_inv_mask|HDMI_PURE_EX_P0_EX_PHY_FIFO_CR1_port2_bclk_inv_mask),
       (HDMI_PURE_EX_P0_EX_PHY_FIFO_CR1_port2_rclk_inv_mask|HDMI_PURE_EX_P0_EX_PHY_FIFO_CR1_port2_gclk_inv_mask|HDMI_PURE_EX_P0_EX_PHY_FIFO_CR1_port2_bclk_inv_mask));    // port2

    hdmi_mask(HDMI_PURE_EX_P0_EX_PHY_FIFO_CR1_reg + offset,
        ~(HDMI_PURE_EX_P0_EX_PHY_FIFO_CR1_port3_rclk_inv_mask|HDMI_PURE_EX_P0_EX_PHY_FIFO_CR1_port3_gclk_inv_mask|HDMI_PURE_EX_P0_EX_PHY_FIFO_CR1_port3_bclk_inv_mask),
       (HDMI_PURE_EX_P0_EX_PHY_FIFO_CR1_port3_rclk_inv_mask|HDMI_PURE_EX_P0_EX_PHY_FIFO_CR1_port3_gclk_inv_mask|HDMI_PURE_EX_P0_EX_PHY_FIFO_CR1_port3_bclk_inv_mask));    // port3

    // 4. ex phy fifo c clk inv
    hdmi_mask(HDMI_PURE_EX_P0_EX_PHY_FIFO_CR3_reg + offset,
        ~(HDMI_PURE_EX_P0_EX_PHY_FIFO_CR3_port0_cclk_inv_shift| HDMI_PURE_EX_P0_EX_PHY_FIFO_CR3_port1_cclk_inv_shift),
        (HDMI_PURE_EX_P0_EX_PHY_FIFO_CR3_port0_cclk_inv_shift| HDMI_PURE_EX_P0_EX_PHY_FIFO_CR3_port1_cclk_inv_shift));    //Port0_cclk_inv & Port1_cclk_inv = 1



    // 5. PHY FIFO R/G/B ch async fifo enable
    hdmi_mask(HDMI_PHY_FIFO_CR0_reg,
        ~(HDMI_P0_PHY_FIFO_CR0_port0_b_afifo_en_mask|HDMI_P0_PHY_FIFO_CR0_port0_g_afifo_en_mask|HDMI_P0_PHY_FIFO_CR0_port0_r_afifo_en_mask),
        (HDMI_P0_PHY_FIFO_CR0_port0_b_afifo_en_mask|HDMI_P0_PHY_FIFO_CR0_port0_g_afifo_en_mask|HDMI_P0_PHY_FIFO_CR0_port0_r_afifo_en_mask));    // Port0
    hdmi_mask(HDMI_PHY_FIFO_CR0_reg,
        ~(HDMI_P0_PHY_FIFO_CR0_port1_b_afifo_en_mask|HDMI_P0_PHY_FIFO_CR0_port1_g_afifo_en_mask|HDMI_P0_PHY_FIFO_CR0_port1_r_afifo_en_mask),
        (HDMI_P0_PHY_FIFO_CR0_port1_b_afifo_en_mask|HDMI_P0_PHY_FIFO_CR0_port1_g_afifo_en_mask|HDMI_P0_PHY_FIFO_CR0_port1_r_afifo_en_mask));    // Port1
    hdmi_mask(HDMI_PHY_FIFO_CR0_reg,
        ~(HDMI_P0_PHY_FIFO_CR0_port2_b_afifo_en_mask|HDMI_P0_PHY_FIFO_CR0_port2_g_afifo_en_mask|HDMI_P0_PHY_FIFO_CR0_port2_r_afifo_en_mask),
        (HDMI_P0_PHY_FIFO_CR0_port2_b_afifo_en_mask|HDMI_P0_PHY_FIFO_CR0_port2_g_afifo_en_mask|HDMI_P0_PHY_FIFO_CR0_port2_r_afifo_en_mask));    // Port2
    hdmi_mask(HDMI_PHY_FIFO_CR0_reg,
        ~(HDMI_P0_PHY_FIFO_CR0_port3_b_afifo_en_mask|HDMI_P0_PHY_FIFO_CR0_port3_g_afifo_en_mask|HDMI_P0_PHY_FIFO_CR0_port3_r_afifo_en_mask),
        (HDMI_P0_PHY_FIFO_CR0_port3_b_afifo_en_mask|HDMI_P0_PHY_FIFO_CR0_port3_g_afifo_en_mask|HDMI_P0_PHY_FIFO_CR0_port3_r_afifo_en_mask));    // Port3
    ...
    // 20161018: SL8800 HDCP CTS1.4, contiune test without disconnect tmds_clock.//hdmi_out(HDMI_HDMI_SCR_reg , 0x163);//DVI/HDMI condition(A,B) select  /* hdcp cts1.4 : Bstatus (MSB): 0x00*/
    hdmi_mask(HDMI_HDMI_SCR_reg,~(HDMI_HDMI_SCR_no_vs_det_en_mask|HDMI_HDMI_SCR_cabs_mask|HDMI_HDMI_SCR_fcddip_mask)
        ,(HDMI_HDMI_SCR_no_vs_det_en_mask|HDMI_P0_HDMI_SCR_cabs_mask|HDMI_P0_HDMI_SCR_fcddip_mask));
    hdmi_mask(HDMI_HDMI_SCR_reg,~(HDMI_HDMI_SCR_nval_mask),HDMI_HDMI_SCR_nval(1));
...
unsigned char lib_hdmi_get_mac_h_sync(unsigned char nport, unsigned is_per_port)
{
