...
#define VIPprintf1(fmt, args...)	/*rtd_pr_vpq_info(fmt, ##args)*/
...
void  IoReg_D_domain_SetBits(unsigned int addr, unsigned int Mask)
{
	...
	switch(Mask)
	{
		case COLOR_D_VC_Global_CTRL_m_dcti_en_mask:
			write_mask = COLOR_D_VC_Global_CTRL_write_enable_2_mask;
			break;
		case COLOR_D_VC_Global_CTRL_reg_bypass_pq_mask:
			write_mask = COLOR_D_VC_Global_CTRL_write_enable_6_mask;
			break;
		case COLOR_D_VC_Global_CTRL_hlw_shpnr_out_sel_mask:
			write_mask = COLOR_D_VC_Global_CTRL_write_enable_7_mask;
			break;
		case COLOR_D_VC_Global_CTRL_hlw_shpnr_enhance_en_mask:
			write_mask = COLOR_D_VC_Global_CTRL_write_enable_8_mask;
			break;
		case COLOR_D_VC_Global_CTRL_icm_dcc_swap_mask:
			write_mask = COLOR_D_VC_Global_CTRL_write_enable_9_mask;
			break;
		case COLOR_D_VC_Global_CTRL_highlightwin_inv_mask:
			write_mask = COLOR_D_VC_Global_CTRL_write_enable_10_mask;
			break;
		case COLOR_D_VC_Global_CTRL_ms_vc_en_mask:
			write_mask = COLOR_D_VC_Global_CTRL_write_enable_11_mask;
			break;
	...
	IoReg_Mask32(addr, ~Mask, (Mask | write_mask));
}
...
void  IoReg_D_domain_ClearBits(unsigned int addr, unsigned int Mask)
{
	...
	IoReg_Mask32(addr, ~Mask, write_mask);
}
...
void  IoReg_D_domain_VC_Set_MainSub_Modes(unsigned int addr, unsigned int mask, VC_MS_MODE mode)
{
	...
	switch(mask)
	{
		case COLOR_D_VC_Global_CTRL_0_ms_ctrl_icm_mask:
			shift = COLOR_D_VC_Global_CTRL_0_ms_ctrl_icm_shift;
			write_mask = COLOR_D_VC_Global_CTRL_0_write_enable_3_mask;
			break;
		case COLOR_D_VC_Global_CTRL_0_m_lc_comp_en_mask:
			shift = COLOR_D_VC_Global_CTRL_0_m_lc_comp_en_shift;
			write_mask = COLOR_D_VC_Global_CTRL_0_write_enable_12_mask;
			break;
		case COLOR_D_VC_Global_CTRL_0_ms_ctrl_dcc_mask:
			shift = COLOR_D_VC_Global_CTRL_0_ms_ctrl_dcc_shift;
			write_mask = COLOR_D_VC_Global_CTRL_0_write_enable_1_mask;
			break;
		case COLOR_D_VC_Global_CTRL_0_ms_ctrl_uvcoring_mask:
			shift = COLOR_D_VC_Global_CTRL_0_ms_ctrl_uvcoring_shift;
			write_mask = COLOR_D_VC_Global_CTRL_0_write_enable_20_mask;
			break;
		case COLOR_D_VC_Global_CTRL_0_ms_ctrl_sharp_mask:
			shift = COLOR_D_VC_Global_CTRL_0_ms_ctrl_sharp_shift;
			write_mask = COLOR_D_VC_Global_CTRL_0_write_enable_4_mask;
			break;
		default:
			return;
			;
	...
	IoReg_Mask32(addr, ~mask, write_mask | (mode << shift));
}
...
#endif
// Mac6 only have 17x17x17 table, 20170815 jimmy
#define    dimC1 17 //24
#define    dimC2 17 //24
#define    dimC3 17 //24

static yuvdata table[dimC1*dimC2*dimC3];
static yuvdata DDR_TABLE[dimC1*dimC2*dimC3];
//static yuvdata Domain_3DLUT_16[9*9*9]={0};
//static yuvdata temp_Domain_3DLUT_16[9*9*9]={0};
static yuvdata Domain_3DLUT_16[17*17*17]={0};
static yuvdata temp_Domain_3DLUT_16[17*17*17]={0};
...
static VIP_IP_Status_Check_List VIP_IP_Status_Check_List_TBL[] = 
{
	...
	{"D1_sharpness_en", COLOR_D_VC_Global_CTRL_0_reg, COLOR_D_VC_Global_CTRL_0_ms_ctrl_sharp_mask, 0, 0},
	{"D1_sharpness_line_mode", PPOVERLAY_Display_Timing_CTRL2_reg, PPOVERLAY_Display_Timing_CTRL2_shpnr_line_mode_mask, 0, 0},
	...
	{"D1_ICM_en", COLOR_D_VC_Global_CTRL_0_reg, COLOR_D_VC_Global_CTRL_0_ms_ctrl_icm_mask, 0, 0},
...
{
	color_temp_color_temp_dither_ctrl1_RBUS color_temp_dither_reg;
	color_temp_dither_reg.regValue = IoReg_Read32(COLOR_TEMP_Color_Temp_DITHER_CTRL1_reg);
	color_temp_dither_reg.main_dither_value_sign = 1;
	color_temp_dither_reg.main_dither_en = enable;
	color_temp_dither_reg.main_dither_temporal_enable = enable;
	IoReg_Write32(COLOR_TEMP_Color_Temp_DITHER_CTRL1_reg, color_temp_dither_reg.regValue);
}
...
void drvif_color_set_HDMI_Dither_Enable(unsigned char enable)
{
	...
	//hdmi_dither_ctrl1_reg.dither_bit_sel = 0; // this bit have to ctrl by i3ddma setting
...
{
	sub_dither_i_sub_dither_ctrl1_RBUS sub_dither_ctrl1_reg;
	sub_dither_ctrl1_reg.regValue = IoReg_Read32(SUB_DITHER_I_Sub_Dither_CTRL1_reg);
	sub_dither_ctrl1_reg.sub_dither_value_sign = 0;	
	sub_dither_ctrl1_reg.sub_dither_bit_sel = 0; 
	sub_dither_ctrl1_reg.sub_dither_en= enable;
	sub_dither_ctrl1_reg.sub_dither_temporal_enable= enable;
	IoReg_Write32(SUB_DITHER_I_Sub_Dither_CTRL1_reg, sub_dither_ctrl1_reg.regValue);
}
...
void drvif_color_set_HSD_Dither_Enable(unsigned char enable)
{
	...
	sd_dither_ctrl1_reg.ch1_dithering_table_select = enable; /* enable dither*/
	sd_dither_ctrl1_reg.ch1_temporal_enable = enable; /* enable temporal dither*/
	...
	sd_dither_ctrl1_reg.ch1_field_odd_temporal_offset_select = 0;	 /* 0: odd field use temporal table -1, 1: odd field use temporal table -2*/
...
void drvif_color_set_Dynamic_Dither(unsigned char enable, unsigned char * tDDither_Coef)
{
	...
	dithering_dd_th_b_reg.dd_en = enable;

	/*R*/
	dithering_dd_th_r_reg.dd_r_0_th = tDDither_Coef[0];
	dithering_dd_th_r_reg.dd_r_1_th = tDDither_Coef[1];
	dithering_dd_th_r_reg.dd_r_b0_type = tDDither_Coef[2];	/*0:8bit, 1:7bit, 2:6bit*/
	dithering_dd_th_r_reg.dd_r_b1_type = tDDither_Coef[3];
	dithering_dd_th_r_reg.dd_r_b2_type = tDDither_Coef[4];

	/*G*/
	dithering_dd_th_g_reg.dd_g_0_th = tDDither_Coef[5];
	dithering_dd_th_g_reg.dd_g_1_th = tDDither_Coef[6];
	dithering_dd_th_g_reg.dd_g_b0_type = tDDither_Coef[7];
	dithering_dd_th_g_reg.dd_g_b1_type = tDDither_Coef[8];
	dithering_dd_th_g_reg.dd_g_b2_type = tDDither_Coef[9];

	/*B*/
	dithering_dd_th_b_reg.dd_b_0_th = tDDither_Coef[10];
	dithering_dd_th_b_reg.dd_b_1_th = tDDither_Coef[11];
	dithering_dd_th_b_reg.dd_b_b0_type = tDDither_Coef[12];
	dithering_dd_th_b_reg.dd_b_b1_type = tDDither_Coef[13];
	dithering_dd_th_b_reg.dd_b_b2_type = tDDither_Coef[14];
...
{
#ifdef CONFIG_HW_SUPPORT_PCID_DITHER
	pcid_pcid_dither_ctrl_RBUS pcid_dither_ctrl_reg;
	pcid_dither_ctrl_reg.regValue = IoReg_Read32(PCID_PCID_DITHER_CTRL_reg);
	pcid_dither_ctrl_reg.pcid_dither_en = enable;
	pcid_dither_ctrl_reg.pcid_temporal_enable = enable;
	IoReg_Write32(PCID_PCID_DITHER_CTRL_reg, pcid_dither_ctrl_reg.regValue);
#endif //CONFIG_HW_SUPPORT_PCID_DITHER
}
void drvif_color_set_LGD_Dither_Enable(unsigned char enable)
{
#ifdef CONFIG_MAC8P_REMOVE
			...
			switch(DitherIP) {
				...
				case VIP_DITHER_IP_PCID:
					if (jj == 3) {
						switch (ii) {
						case 0:/* red*/
								IoReg_Write32(PCID_PCID_DITHER_SEQ_R_00_15_reg, dither_32BIT_DATA);
								break;
						case 1:/* green*/
								IoReg_Write32(PCID_PCID_DITHER_SEQ_G_00_15_reg, dither_32BIT_DATA);
								break;
						case 2:/* blue*/
								IoReg_Write32(PCID_PCID_DITHER_SEQ_B_00_15_reg, dither_32BIT_DATA);
								break;
						}
					}
					if (jj == 7) {
						switch (ii) {
						case 0: /* red*/
								IoReg_Write32(PCID_PCID_DITHER_SEQ_R_16_31_reg, dither_32BIT_DATA);
								break;
						case 1: /* green*/
								IoReg_Write32(PCID_PCID_DITHER_SEQ_G_16_31_reg, dither_32BIT_DATA);
								break;
						case 2: /* blue*/
								IoReg_Write32(PCID_PCID_DITHER_SEQ_B_16_31_reg, dither_32BIT_DATA);
								break;
						}
					}
					break;
				...
				switch(DitherIP) {
					...
					case VIP_DITHER_IP_PCID:
						if (jj == 1) {
							switch (ii) {
							case 0: /* red*/
									IoReg_Write32(PCID_PCID_DITHER_TB_R_01_reg, dither_32BIT_DATA);
									break;
							case 1: /* green*/
									IoReg_Write32(PCID_PCID_DITHER_TB_G_01_reg, dither_32BIT_DATA);
									break;
							case 2: /* blue*/
									IoReg_Write32(PCID_PCID_DITHER_TB_B_01_reg, dither_32BIT_DATA);
									break;
							}
						}
						...
						if (jj == 3) {
							switch (ii) {
							case 0: /* red*/
									IoReg_Write32(PCID_PCID_DITHER_TB_R_23_reg, dither_32BIT_DATA);
									break;
							case 1: /* green*/
									IoReg_Write32(PCID_PCID_DITHER_TB_G_23_reg, dither_32BIT_DATA);
									break;
							case 2: /* blue*/
									IoReg_Write32(PCID_PCID_DITHER_TB_B_23_reg, dither_32BIT_DATA);
									break;
							}
						}
						break;
			...
			switch(DitherIP) {
				...
				case VIP_DITHER_IP_MEMC_MUX:
						...
						for (kk = 0; kk < VIP_DITHERLUT_DEP_MAX; kk++) {
							/* KWarning: checked ok by allen_zhang*/
							dither_32BIT_DATA += (pDITHER_TABLE[ii][jj][kk] >> Panel_Bit) << data_shift;
							data_shift += 6;
						}
					switch (ii) {
					case 0: /* red*/
				...
				case VIP_DITHER_IP_PANEL:
						...
						for (kk = 0; kk < VIP_DITHERLUT_DEP_MAX; kk++) {
							...
							if(Panel_Bit == 0){//6bit
								dither_32BIT_DATA += pDITHER_TABLE[ii][jj][kk]  << data_shift;
								dithering_ctrl_reg.table_shift = 2;
							}
							else if(Panel_Bit == 1){//7bit
								dither_32BIT_DATA += pDITHER_TABLE[ii][jj][kk]  << data_shift;
								dithering_ctrl_reg.table_shift = 1;								
							}
							else if(Panel_Bit == 2){//8bit
								dither_32BIT_DATA += pDITHER_TABLE[ii][jj][kk]  << data_shift;
								dithering_ctrl_reg.table_shift = 0;
							}
							else if(Panel_Bit == 3){//9bit
...
void drvif_color_set_Dither_Temporal(unsigned char DitherIP,unsigned char * pDITHER_TEMPORAL)
{
	...
	switch(DitherIP) {
		...
		case VIP_DITHER_IP_HSD:
			//IoReg_Write32(HSD_DITHER_SD_Dither_Temporal_offset_Tab_1_reg, dither_32BIT_DATA);//mac7p pq compile fix
			//IoReg_Write32(HSD_DITHER_SD_Dither_Temporal_offset_Tab_2_reg, dither_32BIT_DATA);//mac7p pq compile fix
			break;
		#ifdef CONFIG_HW_SUPPORT_MEMC
		case VIP_DITHER_IP_MEMC_MUX:
...
#ifdef CONFIG_HW_SUPPORT_PCID_DITHER
		case VIP_DITHER_IP_PCID:
			IoReg_Write32(PCID_PCID_DITHER_Temp_reg, dither_32BIT_DATA);
			break;
#endif //CONFIG_HW_SUPPORT_PCID_DITHER
		case VIP_DITHER_IP_PANEL:
...
void drvif_color_colorspacergb2yuvtransfer(unsigned char channel, unsigned short *table_index)
{
	...
	//IoReg_SetBits(RGB2YUV_ICH1_RGB2YUV_CTRL_reg, RGB2YUV_ICH1_RGB2YUV_CTRL_rgb2yuv_db_en_mask); // DB en, mac7p main/sub db different

	if (channel == _CHANNEL1)  { /*main always access tab-1*/
		ich1_RGB2YUV_CTRL_REG.regValue = IoReg_Read32(RGB2YUV_ICH1_RGB2YUV_CTRL_reg);	 
	        IoReg_SetBits(RGB2YUV_ICH1_RGB2YUV_CTRL_reg, RGB2YUV_ICH1_RGB2YUV_CTRL_rgb2yuv_db_en_mask); // main DB en
		//ich1_RGB2YUV_CTRL_REG.sel_table = 0;//mac7p pq compile fix, mac7p HW remove sel_table
		...
		/*ich1_RGB2YUV_CTRL_REG.sel_y_gain = 1;*/
		IoReg_Write32(RGB2YUV_ICH1_RGB2YUV_CTRL_reg, ich1_RGB2YUV_CTRL_REG.regValue);
		IoReg_SetBits(RGB2YUV_ICH1_RGB2YUV_CTRL_reg, RGB2YUV_ICH1_RGB2YUV_CTRL_rgb2yuv_db_apply_mask); // main DB apply
	    ...
	    IoReg_SetBits(RGB2YUV_ICH1_RGB2YUV_CTRL_reg, RGB2YUV_ICH1_RGB2YUV_CTRL_rgb2yuv_db_read_mask); // mac7p HW bug, set db_read=1 before sub db_en R/W
		...
		IoReg_Write32(RGB2YUV_ICH2_RGB2YUV_CTRL_reg, ich2_RGB2YUV_CTRL_REG.regValue);
	    IoReg_SetBits(RGB2YUV_ICH1_RGB2YUV_CTRL_reg, RGB2YUV_ICH1_RGB2YUV_CTRL_rgb2yuv_db_read_mask); // mac7p HW bug, set db_read=1 before sub DB apply R/W		
...
#endif
	//IoReg_SetBits(RGB2YUV_ICH1_RGB2YUV_CTRL_reg, RGB2YUV_ICH1_RGB2YUV_CTRL_rgb2yuv_db_apply_mask); // DB apply, mac7p main/sub db different
}
/*============================================================================*/
/**
 * ColorSpaceTransfer
 ...
 void drvif_color_set422to444(unsigned char channel, unsigned char bEnable)
{
...
#ifdef CONFIG_DUAL_CHENNEL//juwen, 170815, compile error
	rgb2yuv_ich2_422to444_ctrl_RBUS ich2_422to444_CTRL_REG;
#endif

	IoReg_SetBits(RGB2YUV_ICH1_422to444_CTRL_DB_reg, RGB2YUV_ICH1_422to444_CTRL_DB_db_en_mask); //DB en
	ich1_422to444_CTRL_REG.regValue = IoReg_Read32(RGB2YUV_ICH1_422to444_CTRL_reg);
	ich1_422to444_CTRL_REG.dup = 0;
	ich1_422to444_CTRL_REG.cr_dly_cb = 0;
#ifdef CONFIG_DUAL_CHENNEL//juwen, 170815, compile error
	IoReg_SetBits(RGB2YUV_ICH2_422to444_CTRL_reg, RGB2YUV_ICH2_422to444_CTRL_db_en_mask); //DB en
	ich2_422to444_CTRL_REG.regValue = IoReg_Read32(RGB2YUV_ICH2_422to444_CTRL_reg);
	...
	if (channel == _CHANNEL1) {
		...
		IoReg_SetBits(RGB2YUV_ICH1_422to444_CTRL_DB_reg, RGB2YUV_ICH1_422to444_CTRL_DB_db_apply_mask); //DB apply
	}
#ifdef CONFIG_DUAL_CHENNEL
	else {
		if (bEnable)
		...
		ich2_422to444_CTRL_REG.db_apply = 1;
...
void drvif_color_output_gamma_control_front(unsigned char display)
{
	...
	if (display == SLR_MAIN_DISPLAY) {
		...
		out_gamma_ctrl_1_REG.out_gamma_ax_rw_sel = 1; /* writing table*/
	}
...
void drvif_color_output_gamma_control_back(unsigned char display)
{
	...
	if (display == SLR_MAIN_DISPLAY) {
		out_gamma_ctrl_1_REG.out_gamma_ax_rw_sel = 0; /* read table*/
		out_gamma_ctrl_1_REG.out_gamma_en = 1;
	}
...
void drvif_color_inv_output_gamma_control_front(unsigned char display)
{
	...
	if (display == SLR_MAIN_DISPLAY) {
		inv_out_gamma_ctrl_1_REG.inv_out_gamma_en = 1;
		inv_out_gamma_ctrl_1_REG.inv_out_gamma_ax_rw_sel = 1; /* writing table*/
	}
...
void drvif_color_inv_output_gamma_control_back(unsigned char display)
{
	...
	if (display == SLR_MAIN_DISPLAY) {
		inv_out_gamma_ctrl_1_REG.inv_out_gamma_ax_rw_sel = 0; /* read table*/
		inv_out_gamma_ctrl_1_REG.inv_out_gamma_en = 1;
	}
...
void drvif_color_colorwritegamma(unsigned int *pArray)
{
	...
	for (ii = 0; ii < (Bin_Num_Gamma>>1); ii++) { 
        ...
        gamma_port_REG.gamma_tab_d0=gammatemp_port_REG.out_gamma_tab_d0;
        gamma_port_REG.gamma_tab_d1=gammatemp_port_REG.out_gamma_tab_d1;

        gamma_port_2_REG.gamma_tab_index= gammatemp_port_REG.out_gamma_tab_index;
...
void drvif_color_colorwrite_gamma_enhance(unsigned int *pArray_d0d1,unsigned int *pArray_index)
{
	...
	for (ii = 0; ii < (Bin_Num_Gamma>>1); ii++) { 
		...
		gamma_port_REG.gamma_tab_d0=(pArray_d0d1[ii]>>10)&0x3ff;
...
void drvif_color_colorread_gamma_enhance(unsigned int *pArray, unsigned int *pArray_index, VIP_GAMMA_CHANNEL_RGB RGB_chanel_idx)
{
	...
	for (ii = 0; ii < (Bin_Num_Gamma>>1); ii++) {
		...
		pArray[ii] = (gamma_port_REG.gamma_tab_d0<<10) + gamma_port_REG.gamma_tab_d1;
...
void drvif_color_Gamma_Curve_Write_enhance(unsigned int *pArray_d0d1,unsigned int *pArray_index, VIP_GAMMA_CHANNEL_RGB RGB_chanel_idx)
{
	...
	gamma_ctrl_1_REG.gamma_ax_ch_sel = RGB_chanel_idx;
	IoReg_Write32(GAMMA_GAMMA_CTRL_1_reg, gamma_ctrl_1_REG.regValue);
	drvif_color_colorwrite_gamma_enhance(pArray_d0d1, pArray_index);
}
...
#ifdef CONFIG_DUAL_CHANNEL
	dm_color_rgb_ctrl_REG.m_blending_factor = BlendRatio;
#endif //CONFIG_DUAL_CHANNEL
	IoReg_Write32(CON_BRI_DM_COLOR_RGB_CTRL_reg, dm_color_rgb_ctrl_REG.regValue);
}
...
void drvif_color_bypass(Color_Fun_Bypass *ptr, unsigned char ipNum)
{
	...
	for (i = 0; i < ipNum; i++) {
		...
		case BYPASS_VIVID_COLOR:
			d_vc_global_ctrl_Reg.regValue = IoReg_Read32(COLOR_D_VC_Global_CTRL_reg);
			d_vc_global_ctrl_Reg.ms_vc_en = ptr[i].bypass_switch;
...
void drvif_color_colorwrite_outGamma(unsigned int *pArray)
{
	...
	for (ii = 0; ii < (Bin_Num_Gamma>>1); ii++) {
		...
		cnt = 10000;
		gammatemp_port_REG.regValue = pArray[ii];
        out_gamma_port_REG.out_gamma_tab_d0=gammatemp_port_REG.out_gamma_tab_d0;
        out_gamma_port_REG.out_gamma_tab_d1=gammatemp_port_REG.out_gamma_tab_d1;

        out_gamma_port_2_REG.out_gamma_tab_index = gammatemp_port_REG.out_gamma_tab_index;
...
void drvif_color_colorwrite_outGamma_enhance(unsigned int *pArray, unsigned int *pArray_index)
{
	...
	for (ii = 0; ii < (Bin_Num_Gamma>>1); ii++) {
		...
		cnt = 10000;
		// gammatemp_port_REG.regValue = pArray[ii];
        out_gamma_port_REG.out_gamma_tab_d0=(pArray[ii]>>10)&0x3ff;
...
void drvif_color_Out_Gamma_Curve_Write_Enhance(unsigned int *pArray, unsigned int *pArray_index, VIP_GAMMA_CHANNEL_RGB RGB_chanel_idx)
{
	...
	IoReg_Write32(OUTPUTGAMMA_OUT_GAMMA_CTRL_1_reg, out_gamma_ctrl_1_REG.regValue);
	drvif_color_colorwrite_outGamma_enhance(pArray, pArray_index);
}
...
void drvif_color_colorRead_outGamma(unsigned int *pArray, VIP_GAMMA_CHANNEL_RGB RGB_chanel_idx)
{
	...
	for (ii = 0; ii < (Bin_Num_Gamma>>1); ii++) {
		...
		pArray[ii] = (out_gamma_port_REG.out_gamma_tab_d0<<8) + out_gamma_port_REG.out_gamma_tab_d1 + (out_gamma_port_2_REG.out_gamma_tab_index<<20);
	}
...
void drvif_color_colorRead_outGamma_enhance(unsigned int *pArray, unsigned int *pArray_index, VIP_GAMMA_CHANNEL_RGB RGB_chanel_idx)
{
	...
	for (ii = 0; ii < (Bin_Num_Gamma>>1); ii++) {
        out_gamma_port_2_REG.regValue = IoReg_Read32(OUTPUTGAMMA_OUT_GAMMA_PORT_2_reg);
        out_gamma_port_REG.regValue = IoReg_Read32(OUTPUTGAMMA_OUT_GAMMA_PORT_reg);
		pArray[ii] = (out_gamma_port_REG.out_gamma_tab_d0<<10) + out_gamma_port_REG.out_gamma_tab_d1;
...
void drvif_color_set_new_uvc(DRV_NEW_UVC *ptr)
{
	...
	/*	DRV_NEW_UVC_Ctrl	*/ /*	10*/
	color_d_vc_global_ctrl_0_reg.ms_ctrl_uvcoring = ptr->UVC_ctrl.UVC_main_en+(ptr->UVC_ctrl.UVC_sub_en*6);
	color_d_vc_global_ctrl_0_reg.write_enable_20 = 1;
	//color_uvcoring_uvc_control_reg.uvc_overlay_sel = ptr->UVC_ctrl.UVC_overlay_sel;//juwen, 170815, mac6 remove
	...
	IoReg_Write32(COLOR_D_VC_Global_CTRL_0_reg, color_d_vc_global_ctrl_0_reg.regValue);
}
...
#endif //CONFIG_HW_SUPPORT_BLUE_STRETCH
}
...
void drvif_color_set_Color_Mapping_out_offset(unsigned char display, int offset_R, int offset_G, int offset_B)
{
	if (display== SLR_MAIN_DISPLAY) {
		...
		cmrgb2rgb_tab1_out_offset_0_reg.roffset = offset_R;
		cmrgb2rgb_tab1_out_offset_0_reg.goffset = offset_G;
		cmrgb2rgb_tab1_out_offset_1_reg.boffset = offset_B;
		...
		/* output offset*/
		cmrgb2rgb_tab2_out_offset_0_reg.roffset = offset_R;
		cmrgb2rgb_tab2_out_offset_0_reg.goffset = offset_G;
		cmrgb2rgb_tab2_out_offset_1_reg.boffset = offset_B;
...
char drvif_color_D_3dLUT(unsigned char LUT_Ctrl, unsigned int *pArray)//flora@20150617
{
	...
	// en DB
	IoReg_SetBits(C3DLUT_C3DLUT_db_ctl_0_reg, C3DLUT_C3DLUT_db_ctl_0_db_en_0_mask);
	...
	if(type == MACH_ARCH_RTK2851A) {	// RTK2851A	
		for(B=0; B < 9 ; B++ )
			for( G=0; G < 9 ; G++)
			{
				...
				if (status == 1) {
					...
					rtd_pr_vpq_emerg("drvif_color_D_3dLUT, table time out! cnt=%d,\n", cnt);
					return -1;	/* return fail, then re-write */
				}				
			}
		...
		if (LUT_Ctrl <= 2)
			...
			c3dlut_lut_ctr_REG.c3dlut_ctrl_main = EN_status;
		//fwif_color_WaitFor_DEN_STOP_UZUDTG();
		IoReg_Write32(C3DLUT_C3DLUT_LUT_CTRL_reg, c3dlut_lut_ctr_REG.regValue);
		
	} else {	// MACH_ARCH_RTK2851F
		ii=0;
		...
		for(B=0; B < 9 ; B++ )
			for( G=0; G < 9 ; G++)
			{
				...
				if (status == 1) {
					...
					IoReg_SetBits(C3DLUT_C3DLUT_db_ctl_0_reg, C3DLUT_C3DLUT_db_ctl_0_db_apply_0_mask);
					rtd_pr_vpq_emerg("drvif_color_D_3dLUT, table time out! cnt=%d,\n", cnt);
					return; /* return fail, then re-write */
				}				
...
unsigned char drvif_color_D_3dLUT_By_DMA(unsigned char LUT_Ctrl, unsigned int *pArray, unsigned int addr, unsigned int* vir_addr)
{
	...
	if ((addr == 0) || (vir_addr == NULL)) {
		rtd_pr_vpq_emerg("drvif_color_D_3dLUT_By_DMA, table NULL, addr = %x, vi_addr = %p\n",
			 addr, vir_addr);
		return false;
	}
	...
	if (type == MACH_ARCH_RTK2851A) {
		/* phy addr setting*/
		IoReg_Write32(DMATO3DLUT_DMAto3DLUT_Table1_Addr_reg, (addr/*-0x200*/));//Set D-3DLUT dma address

		for(B=0; B < 9; B++ ) {
			for( G=0; G < 9; G++) {
				for( R=0; R < 9; R++)
				{
					Domain_3DLUT_16[B*81+G*9+R].y = pArray[B*289*4 + G*17*4 + (4*R)]>>16;
					Domain_3DLUT_16[B*81+G*9+R].u = pArray[B*289*4 + G*17*4 + (4*R)]&0xffff;
					Domain_3DLUT_16[B*81+G*9+R].v = pArray[B*289*4 + G*17*4 + (4*R) + 1]&0xffff;
				}
			}
		}
		...
		for( z=0;z<(9+1)/2;z++) {
			for( y=0;y<(9+1)/2;y++) {
				for( x=0;x<(9+1)/2;x++) {
					temp_Domain_3DLUT_16[lut_idx++] = Domain_3DLUT_16[2*x + 2*y*9 + 2*z*81];
					if(x<(9/2))
						temp_Domain_3DLUT_16[lut_idx++] = Domain_3DLUT_16[ (2*x+1) + 2*y*9 + 2*z*81];
					if(y<(9/2)) {
						temp_Domain_3DLUT_16[lut_idx++] = Domain_3DLUT_16[2*x + (2*y+1)*9 + 2*z*81];
						if(x<(9/2))
						temp_Domain_3DLUT_16[lut_idx++] = Domain_3DLUT_16[(2*x+1) + (2*y+1)*9 + 2*z*81];
					}
					if(z<(9/2)) {
						temp_Domain_3DLUT_16[lut_idx++] = Domain_3DLUT_16[2*x + 2*y*9 + (2*z+1)*81];
						if(x<(9/2))
						 	temp_Domain_3DLUT_16[lut_idx++] = Domain_3DLUT_16[ (2*x+1) + 2*y*9 + (2*z+1)*81];
						if(y<(9/2)) {
							temp_Domain_3DLUT_16[lut_idx++] = Domain_3DLUT_16[2*x + (2*y+1)*9 + (2*z+1)*81];
							if(x<(9/2))
								temp_Domain_3DLUT_16[lut_idx++] = (Domain_3DLUT_16[(2*x+1) + (2*y+1)*9 + (2*z+1)*81]);
						}
					}
				}
			}
...
void drvif_color_set_Vivid_Color_Enable(unsigned char ucEnable)
{
	...
	d_vc_global_ctrl_REG.ms_vc_en = ucEnable;
	d_vc_global_ctrl_REG.write_enable_11 = 1;
...
void drvif_color_disable_VIP(void)
{
	...
	IoReg_D_domain_VC_Set_MainSub_Modes(COLOR_D_VC_Global_CTRL_0_reg,COLOR_D_VC_Global_CTRL_0_ms_ctrl_sharp_mask, VC_MS_ALL_DISABLE);
	IoReg_D_domain_VC_Set_MainSub_Modes(COLOR_D_VC_Global_CTRL_0_reg,COLOR_D_VC_Global_CTRL_0_ms_ctrl_dcc_mask, VC_MS_ALL_DISABLE);
	IoReg_D_domain_VC_Set_MainSub_Modes(COLOR_D_VC_Global_CTRL_0_reg,COLOR_D_VC_Global_CTRL_0_ms_ctrl_icm_mask, VC_MS_ALL_DISABLE);
	...
	//IoReg_D_domain_ClearBits(COLOR_D_VC_Global_CTRL_0_reg,COLOR_D_VC_Global_CTRL_0_s_icm_en_mask); //mac6p merged to main
...
bool drvif_color_inv_gamma_enable(unsigned char display, unsigned char enable, unsigned char useRPC)
{
	...
	if(useRPC && display == SLR_MAIN_DISPLAY) {
		...
		//SCALERIOC_GAMMA_ENABLE_PATCH is ptach only for TV006, Gamma and InvGamma_en sync at the same time.
		//Please don't use it for other function
...
char drvif_DM2_EOTF_Set_By_DMA(unsigned int *EOTF_table32_R, unsigned int *EOTF_table32_G, unsigned int *EOTF_table32_B, unsigned int addr, unsigned int* vir_addr)
{
	...
	//rtd_pr_vpq_info("\n vpq eotf : Eotf_phys %x , virtaddr %p \n",addr, vir_addr );
...
char drvif_DM2_OETF_Set(unsigned short *OETF_table16_R, unsigned short *OETF_table16_G, unsigned short *OETF_table16_B)
{
	...
	for(i=0;i<timeoutcnt_rw_addr;i++)//switch read/write , address will clean to 0 (some time not work)
	{
		...
		if(DM_HDR_OETF_LUT_CTRL1_Reg.oetf_lut_rw_addr!=0)
			rtd_pr_vpq_debug("PQ WARNING, Set HDR OETF table wrong, rw_address not 0 ,times=%d",i);
		else
			break;
	} // read/write OE/EO table havt to check rw_address is 0
...
char drvif_DM2_OETF_Set_By_DMA(unsigned short *OETF_table16_R, unsigned short *OETF_table16_G, unsigned short *OETF_table16_B, unsigned int addr, unsigned int* vir_addr)
{
	...
	//rtd_pr_vpq_info("OETF_phys = %x, OETF_virt = %p\n", addr, vir_addr);
...
void drvif_DM2_OETF_Set_Prog_Index( VIP_HDR_OETF_Prog_Idx_TBL* OETF_prog_idx_tbl )
{
	...
	for(i = 1; i<7; i++) // data check
	{
		if(OETF_prog_idx_tbl->oetf_grid_num_th[i] < OETF_prog_idx_tbl->oetf_grid_num_th[i-1])
			{rtd_pr_vpq_debug("PQ WARNING, HDR OETF table wrong, OETF_grid_num[%d] = %d > OETF_grid_num[%d] = %d\n", i - 1, OETF_prog_idx_tbl->oetf_grid_num_th[i - 1], i, OETF_prog_idx_tbl->oetf_grid_num_th[i]);}
	}
...
char drvif_DM2_OETF_Set_Prog_Index_th(unsigned int *OETF_Prog_Idx_th_TBL)
{
	...
	if (OETF_Prog_Idx_th_TBL == NULL) {
		rtd_pr_vpq_debug("drvif_DM2_OETF_Set_Prog_Index, NULL TBL\n");
		return -1;
	}
...
#ifdef CONFIG_HW_SUPPORT_HDR_DOVI // gamma_out_shift_en removed because there is no B02
...
#endif // CONFIG_HW_SUPPORT_HDR_DOVI
...
void drvif_DM2_BBCGain_Enable(UINT8 BBCGain_En)
{
	...
	dm_hdr_path_sel_Reg.dm_b05_22bit_path = BBCGain_En; //mac6p modify BBC
	dm_hdr_path_sel_Reg.b05_position = BBCGain_En?3:0; //mac6p modify BBC
	rtd_outl(DM_HDR_PATH_SEL_reg, dm_hdr_path_sel_Reg.regValue);
...
void drvif_Set_dm_sel_hdr_hist_position_ISR(unsigned char mode)
{
	...
	dm_hdr_path_sel_reg.dm_b05_22bit_path = mode;
...
char drvif_DM2_HDR_histogram_Get_ISR(unsigned int *histogram_table24)
{
	...
	for (i = 0; i < HDR_Histogram_size; i = i + 4)
	{
		...
		if (timeoutcnt2 < 10)
		{
			...
			rtd_pr_vpq_debug("HDR_histogram data lenth!t=%d,i=%d\n", timeoutcnt2, i);
...
unsigned char drvif_DM2_HDR_histogram_Get(unsigned int *histogram_table24)
{
	...
	while((dm_y_histogram_status0_Reg.hist_valid == 0) && timeoutcnt1 > 10);
	...
	if (rc % 91 == 0)
		for (i = 0; i < 128; i++)
			rtd_pr_vpq_info("histogram_table24[%d] = %d\n", i, histogram_table24[i]);
	#endif
...
char drvif_Wait_VGIP_start(short delay0, short delay1, unsigned short timeout)
{
	...
	/*rtd_pr_vpq_info("drvif_Wait_VGIP_start,vstart=%d,d0=%d,d1=%d\n",vstart,delay0,delay1);*/
	...
	}while (((lineCnt_in < (vstart + delay0)) || (lineCnt_in > vstart + delay1)) && ((time_end-time_str)<timeout) && (timeoutcnt-- > 10));
	//rtd_pr_vpq_info("drvif_Wait_VGIP_start,delay0=%d,%d,lineCnt_in=%d\n",delay0,delay1,lineCnt_in);
	if ((time_end-time_str) >= timeout || timeoutcnt <= 10) {
		rtd_pr_vpq_err("drvif_Wait_VGIP_start timeout=%d, timeoutcnt=%d\n", timeout, timeoutcnt);
		return -1;
	} else
		return 0;
...
char drvif_Set_DM_HDR_3dLUT_24x24x24_16(unsigned char enable, unsigned short *pArray)
{
	...
	if (VIP_system_info_structure_table ->HDR_flag == HAL_VPQ_HDR_MODE_HDR10_VIVID)
		threedlut_minmaxc2_reg.regValue = 0xffff0000;//0xffff0000;//MaxC2/MinC2
	else
...
char drvif_Set_DM_HDR_3dLUT_24x24x24_16_By_DMA(unsigned char enable, unsigned short *pArray, unsigned int addr, unsigned int* vir_addr)
{
	...
	if ((pArray == NULL) || (addr == 0) || (vir_addr == NULL)) {
		rtd_pr_vpq_emerg("drvif_Set_DM_HDR_3dLUT_24x24x24_16_By_DMA, table NULL, pArray=%x, addr = %x, vi_addr = %x\n",
...
char drvif_DM_HDR_3dLUT_16(unsigned char enable, unsigned short *pArray)/*flora@20150617, modify by juwen*/
{
	...
	threedlut_minmaxinv1_reg.regValue = 0x00004000;//iDisxC1Inv
	threedlut_minmaxinv2_reg.regValue = 0x00004000;//iDisxC2Inv
	threedlut_minmaxinv3_reg.regValue = 0x00004000;//iDisxC3Inv
	#else
	threedlut_minmaxinv1_reg.regValue = 0x00008000;//iDisxC1Inv
	threedlut_minmaxinv2_reg.regValue = 0x00008000;//iDisxC2Inv
	threedlut_minmaxinv3_reg.regValue = 0x00008000;//iDisxC3Inv
	#endif
...
char drvif_Set_DM_HDR_3dLUT_17x17x17_16_By_DMA(unsigned char enable, unsigned short *pArray, unsigned int addr, unsigned int* vir_addr)
{
	...
	dmato3dtable_dmato3dtable_table0_burst_reg.regValue = IoReg_Read32(DMATO3DTABLE_DMAto3DTable_Table0_Burst_reg);
	dmato3dtable_dmato3dtable_table0_burst_reg.table0_burst_num = 0x56;
	IoReg_Write32(DMATO3DTABLE_DMAto3DTable_Table0_Burst_reg,dmato3dtable_dmato3dtable_table0_burst_reg.regValue);

	dmato3dtable_dmato3dtable_table0_dma_reg.regValue = IoReg_Read32(DMATO3DTABLE_DMAto3DTable_Table0_DMA_reg);
	dmato3dtable_dmato3dtable_table0_dma_reg.table0_remain = 0x6;
	IoReg_Write32(DMATO3DTABLE_DMAto3DTable_Table0_DMA_reg,dmato3dtable_dmato3dtable_table0_dma_reg.regValue);
...
{
	unsigned int prot_hdr3dlut = 0;
	extern int HDR_3DLUT_offset	;
	...
	HDR10_OETF_ByLuminace_TBL_cur.OETF_setting[32] = ((HDR10_OETF_ByLuminace_TBL_cur.OETF_setting[32] & 0xFFFFFFFF) == 0) ? 0x00004000: HDR10_OETF_ByLuminace_TBL_cur.OETF_setting[32];
	prot_hdr3dlut = min(max((int)HDR10_OETF_ByLuminace_TBL_cur.OETF_setting[32] + HDR_3DLUT_offset, 0), 0x000FFFFF); 
	threedlut_minmaxinv1_reg.regValue = prot_hdr3dlut;
	threedlut_minmaxinv2_reg.regValue = prot_hdr3dlut;
	threedlut_minmaxinv3_reg.regValue = prot_hdr3dlut;
...
unsigned char drvif_color_set_HDR10_Enable(unsigned char* enable)
{
	...
	if (enable[HDR_EN])
	{
		...
		if (VIP_system_info_structure_table->HDR_flag == HAL_VPQ_HDR_MODE_HDR10_VIVID)
			signal_range_reg.regValue = 0x3fff0000;
		else
...
*/
		...
		case PQ_ByPass_I_Peaking:
			//IoReg_ClearBits(PEAKING_ICH1_PEAKING_FILTER_reg, PEAKING_ICH1_PEAKING_FILTER_peaking_enable_mask);//_BIT26 //mac6 no I-Peaking
		break;
		...
		case PQ_ByPass_MB_Peaking:
			...
			IoReg_SetBits(COLOR_MB_PEAKING_MB_Double_Buffer_CTRL_reg, COLOR_MB_PEAKING_MB_Double_Buffer_CTRL_mb_db_apply_mask);
		break;
		...
		case PQ_ByPass_I_Peaking_Sub:
			//IoReg_ClearBits(PEAKING_ICH2_PEAKING_FILTER_reg, PEAKING_ICH2_PEAKING_FILTER_peaking_enable_mask);//_BIT26 //mac6 no I-Peaking
		break;
		...
		case PQ_ByPass_ICM_Sub:
			//IoReg_ClearBits(COLOR_D_VC_Global_CTRL_0_reg, COLOR_D_VC_Global_CTRL_0_s_icm_en_mask);//_BIT18 //mac6p merged to main
		break;
		...
		case PQ_ByPass_I_DI_IP_Enable:
		{
			...
			IoReg_SetBits(DI_db_reg_ctl_reg, DI_db_reg_ctl_db_apply_mask);	/* HW do not clear this bit, alway turn on, setting will be apply while v_sync*/
			IoReg_SetBits(VGIP_VGIP_CHN1_DOUBLE_BUFFER_CTRL_reg, VGIP_VGIP_CHN1_DOUBLE_BUFFER_CTRL_ch1_db_rdy_mask);	/* path double buffer*/
			db_ready = VGIP_VGIP_CHN1_DOUBLE_BUFFER_CTRL_get_ch1_db_rdy(IoReg_Read32(VGIP_VGIP_CHN1_DOUBLE_BUFFER_CTRL_reg));
			db_en = VGIP_VGIP_CHN1_DOUBLE_BUFFER_CTRL_get_ch1_db_en(IoReg_Read32(VGIP_VGIP_CHN1_DOUBLE_BUFFER_CTRL_reg));
		...
		case PQ_ByPass_LC:
			IoReg_D_domain_VC_Set_MainSub_Modes(COLOR_D_VC_Global_CTRL_0_reg, COLOR_D_VC_Global_CTRL_0_m_lc_comp_en_mask, VC_MS_ALL_DISABLE);
		break;
		...
		case PQ_ByPass_UVC_CONTROL:
			IoReg_D_domain_VC_Set_MainSub_Modes(COLOR_D_VC_Global_CTRL_0_reg,COLOR_D_VC_Global_CTRL_0_ms_ctrl_uvcoring_mask, VC_MS_ALL_DISABLE);
		break;
...
char drvif_color_set_PQ_Module(unsigned char bypass_item,unsigned char bEnable)
{
	...
	switch(bypass_item) {
		...
		case PQ_ByPass_Iedge_Smooth:
			if(bEnable){
				IoReg_SetBits(IEDGE_SMOOTH_dejagging_ctrl0_reg, IEDGE_SMOOTH_dejagging_ctrl0_i_dejag_en_mask);
			}
			else{
				IoReg_ClearBits(IEDGE_SMOOTH_dejagging_ctrl0_reg, IEDGE_SMOOTH_dejagging_ctrl0_i_dejag_en_mask);//_BIT0
			}
		...
		case PQ_ByPass_MPEG_NR:
			...
			IoReg_SetBits(MPEGNR_ICH1_MPEGNR_DB_CTRL_reg, MPEGNR_ICH1_MPEGNR_DB_CTRL_mpegnr_db_apply_mask); /* MPEGNR DB apply */
		break;
...
*/
		...
		case PQ_ByPass_MB_Peaking:
			...
			IoReg_SetBits(COLOR_MB_PEAKING_MB_Double_Buffer_CTRL_reg, COLOR_MB_PEAKING_MB_Double_Buffer_CTRL_mb_db_apply_mask); // DB apply
		break;
		...
		case PQ_ByPass_DCC:
			tmp = (((IoReg_Read32(COLOR_D_VC_Global_CTRL_0_reg)&COLOR_D_VC_Global_CTRL_0_ms_ctrl_dcc_mask)>>COLOR_D_VC_Global_CTRL_0_ms_ctrl_dcc_shift)&0x2)>>1;
			if (tmp) //sub status
				IoReg_D_domain_VC_Set_MainSub_Modes(COLOR_D_VC_Global_CTRL_0_reg, COLOR_D_VC_Global_CTRL_0_ms_ctrl_dcc_mask, bEnable?VC_MS_ALL_ENABLE:VC_MS_SUB_AND_OVERLAY);
			else
				IoReg_D_domain_VC_Set_MainSub_Modes(COLOR_D_VC_Global_CTRL_0_reg, COLOR_D_VC_Global_CTRL_0_ms_ctrl_dcc_mask, bEnable?VC_MS_MAIN_ONLY:VC_MS_ALL_DISABLE);
		break;
		...
		case PQ_ByPass_ICM:
			tmp = (((IoReg_Read32(COLOR_D_VC_Global_CTRL_0_reg)&COLOR_D_VC_Global_CTRL_0_ms_ctrl_icm_mask)>>COLOR_D_VC_Global_CTRL_0_ms_ctrl_icm_shift)&0x2)>>1;
			if (tmp) //sub status
				IoReg_D_domain_VC_Set_MainSub_Modes(COLOR_D_VC_Global_CTRL_0_reg, COLOR_D_VC_Global_CTRL_0_ms_ctrl_icm_mask, bEnable?VC_MS_ALL_ENABLE:VC_MS_SUB_AND_OVERLAY);
			else
				IoReg_D_domain_VC_Set_MainSub_Modes(COLOR_D_VC_Global_CTRL_0_reg, COLOR_D_VC_Global_CTRL_0_ms_ctrl_icm_mask, bEnable?VC_MS_MAIN_ONLY:VC_MS_ALL_DISABLE);
		break;

		case PQ_ByPass_SHP:
			tmp = (((IoReg_Read32(COLOR_D_VC_Global_CTRL_0_reg)&COLOR_D_VC_Global_CTRL_0_ms_ctrl_sharp_mask)>>COLOR_D_VC_Global_CTRL_0_ms_ctrl_sharp_shift)&0x2)>>1;
			if (tmp) //sub status
				IoReg_D_domain_VC_Set_MainSub_Modes(COLOR_D_VC_Global_CTRL_0_reg, COLOR_D_VC_Global_CTRL_0_ms_ctrl_sharp_mask, bEnable?VC_MS_ALL_ENABLE:VC_MS_SUB_AND_OVERLAY);
			else
				IoReg_D_domain_VC_Set_MainSub_Modes(COLOR_D_VC_Global_CTRL_0_reg, COLOR_D_VC_Global_CTRL_0_ms_ctrl_sharp_mask, bEnable?VC_MS_MAIN_ONLY:VC_MS_ALL_DISABLE);
		...
		case PQ_ByPass_DCTI_Sub:
			if(bEnable){
				IoReg_SetBits(COLOR_D_VC_Global_CTRL_reg, COLOR_D_VC_Global_CTRL_s_dcti_en_mask);//_BIT17
			}
			else{
...
#ifdef CONFIG_DUAL_CHANNEL
		case PQ_ByPass_ICM_Sub:
			tmp = ((IoReg_Read32(COLOR_D_VC_Global_CTRL_0_reg)&COLOR_D_VC_Global_CTRL_0_ms_ctrl_icm_mask)>>COLOR_D_VC_Global_CTRL_0_ms_ctrl_icm_shift)&0x1;
			if (tmp) //main status
				IoReg_D_domain_VC_Set_MainSub_Modes(COLOR_D_VC_Global_CTRL_0_reg, COLOR_D_VC_Global_CTRL_0_ms_ctrl_icm_mask, bEnable?VC_MS_ALL_ENABLE:VC_MS_MAIN_ONLY);
			else
				IoReg_D_domain_VC_Set_MainSub_Modes(COLOR_D_VC_Global_CTRL_0_reg, COLOR_D_VC_Global_CTRL_0_ms_ctrl_icm_mask, bEnable?VC_MS_SUB_AND_OVERLAY:VC_MS_ALL_DISABLE);
		break;

		case PQ_ByPass_SHP_Sub:
			tmp = ((IoReg_Read32(COLOR_D_VC_Global_CTRL_0_reg)&COLOR_D_VC_Global_CTRL_0_ms_ctrl_sharp_mask)>>COLOR_D_VC_Global_CTRL_0_ms_ctrl_sharp_shift)&0x1;
			if (tmp) //main status
				IoReg_D_domain_VC_Set_MainSub_Modes(COLOR_D_VC_Global_CTRL_0_reg, COLOR_D_VC_Global_CTRL_0_ms_ctrl_sharp_mask, bEnable?VC_MS_ALL_ENABLE:VC_MS_MAIN_ONLY);
			else
				IoReg_D_domain_VC_Set_MainSub_Modes(COLOR_D_VC_Global_CTRL_0_reg, COLOR_D_VC_Global_CTRL_0_ms_ctrl_sharp_mask, bEnable?VC_MS_SUB_AND_OVERLAY:VC_MS_ALL_DISABLE);
...
unsigned int drvif_color_get_PQ_Module(unsigned char bypass_item)
{
	...
	switch(bypass_item) {
		/*===============I Domain===========*/
		case PQ_ByPass_Iedge_Smooth:
			ret = (IoReg_Read32(IEDGE_SMOOTH_dejagging_ctrl0_reg)&IEDGE_SMOOTH_dejagging_ctrl0_i_dejag_en_mask)>>IEDGE_SMOOTH_dejagging_ctrl0_i_dejag_en_shift;
		break;

		case PQ_ByPass_MPEG_NR:
			ret = (IoReg_Read32(MPEGNR_ICH1_MPEGNR2_reg)&MPEGNR_ICH1_MPEGNR2_cp_mpegenable_x_mask)>>MPEGNR_ICH1_MPEGNR2_cp_mpegenable_x_shift;
		break;

/*//mac7p pq compile fix
		case PQ_ByPass_HSD_DITHER:
			ret = (IoReg_Read32(HSD_DITHER_SD_Dither_CTRL1_reg)&HSD_DITHER_SD_Dither_CTRL1_ch1_dithering_table_select_mask)>>HSD_DITHER_SD_Dither_CTRL1_ch1_dithering_table_select_shift;
		break;

		case PQ_ByPass_HSD_DITHER_Temporal:
			ret = (IoReg_Read32(HSD_DITHER_SD_Dither_CTRL1_reg)&HSD_DITHER_SD_Dither_CTRL1_ch1_temporal_enable_mask)>>HSD_DITHER_SD_Dither_CTRL1_ch1_temporal_enable_shift;
		break;
*/
		case PQ_ByPass_RTNR_Y:
			ret = (IoReg_Read32(DI_IM_DI_RTNR_CONTROL_reg)&DI_IM_DI_RTNR_CONTROL_cp_rtnr_y_enable_mask)>>DI_IM_DI_RTNR_CONTROL_cp_rtnr_y_enable_shift;
		break;

		case PQ_ByPass_RTNR_C:
			ret = (IoReg_Read32(DI_IM_DI_RTNR_CONTROL_reg)&DI_IM_DI_RTNR_CONTROL_cp_rtnr_c_enable_mask)>>DI_IM_DI_RTNR_CONTROL_cp_rtnr_c_enable_shift;
		break;
		case PQ_ByPass_MCNR:
			ret = (IoReg_Read32(DI_IM_DI_RTNR_HMCNR_reg)&DI_IM_DI_RTNR_HMCNR_cp_temporal_hmcnr_y_en_mask)>>DI_IM_DI_RTNR_HMCNR_cp_temporal_hmcnr_y_en_shift;
		break;

		case PQ_ByPass_I_DCTI:
			ret = (IoReg_Read32(PEAKING_I_DCTI_CTRL_1_reg)&PEAKING_I_DCTI_CTRL_1_dcti_en_mask)>>PEAKING_I_DCTI_CTRL_1_dcti_en_shift;
		break;
#ifdef PQ_COMPILER_ERROR
		case PQ_ByPass_ImpulseNR:
			ret = (IoReg_Read32(NR_DCH1_CP_Ctrl_reg)&NR_DCH1_CP_Ctrl_cp_impulseenable_mask)>>NR_DCH1_CP_Ctrl_cp_impulseenable_shift;
		break;
#endif
		case PQ_ByPass_SNR_C:
			ret = (IoReg_Read32(NR_DCH1_CP_Ctrl_reg)&NR_DCH1_CP_Ctrl_cp_spatialenablec_mask)>>NR_DCH1_CP_Ctrl_cp_spatialenablec_shift;
		break;

		case PQ_ByPass_SNR_Y:
			ret = (IoReg_Read32(NR_DCH1_CP_Ctrl_reg)&NR_DCH1_CP_Ctrl_cp_spatialenabley_mask)>>NR_DCH1_CP_Ctrl_cp_spatialenabley_shift;
		break;

		case PQ_ByPass_MosquiutoNR:
			ret = (IoReg_Read32(NR_MOSQUITO_CTRL_reg)&NR_MOSQUITO_CTRL_mosquito_detect_en_mask)>>NR_MOSQUITO_CTRL_mosquito_detect_en_shift;
		break;
		...
		case PQ_ByPass_MB_Peaking:
			ret = (IoReg_Read32(COLOR_MB_PEAKING_MB_PEAKING_CTRL_reg)&COLOR_MB_PEAKING_MB_PEAKING_CTRL_mb_peaking_en_mask)>>COLOR_MB_PEAKING_MB_PEAKING_CTRL_mb_peaking_en_shift;
		break;

		/*Sub*/
#ifdef VIP_CONFIG_DUAL_CHANNEL
		case PQ_ByPass_HSD_DITHER_Sub:
			ret = (IoReg_Read32(SUB_DITHER_I_Sub_Dither_CTRL1_reg)&SUB_DITHER_I_Sub_Dither_CTRL1_ch2_dithering_table_select_mask)>>SUB_DITHER_I_Sub_Dither_CTRL1_ch2_dithering_table_select_shift;
		break;

		case PQ_ByPass_HSD_DITHER_Temporal_Sub:
			ret = (IoReg_Read32(SUB_DITHER_I_Sub_Dither_CTRL1_reg)&SUB_DITHER_I_Sub_Dither_CTRL1_ch2_temporal_enable_mask)>>SUB_DITHER_I_Sub_Dither_CTRL1_ch2_temporal_enable_shift;
		break;

		case PQ_ByPass_I_Peaking_Sub:
			ret = (IoReg_Read32(PEAKING_ICH2_PEAKING_FILTER_reg)&PEAKING_ICH2_PEAKING_FILTER_peaking_enable_mask)>>PEAKING_ICH2_PEAKING_FILTER_peaking_enable_shift;
		break;
#endif
		/*===============D Domain===========*/
		/*Main*/
		...
		case PQ_ByPass_SHP_DLTI:
			ret = (IoReg_Read32(COLOR_SHARP_SHP_DLTI_CTRL_1_reg)&COLOR_SHARP_SHP_DLTI_CTRL_1_dlti_en_mask)>>COLOR_SHARP_SHP_DLTI_CTRL_1_dlti_en_shift;
		break;

		case PQ_ByPass_DCC:
			ret = ((IoReg_Read32(COLOR_D_VC_Global_CTRL_0_reg)&COLOR_D_VC_Global_CTRL_0_ms_ctrl_dcc_mask)>>COLOR_D_VC_Global_CTRL_0_ms_ctrl_dcc_shift)&0x1;
		break;

		case PQ_ByPass_DCTI:
			ret = ((IoReg_Read32(COLOR_D_VC_Global_CTRL_reg)&COLOR_D_VC_Global_CTRL_m_dcti_en_mask)>>COLOR_D_VC_Global_CTRL_m_dcti_en_shift);
		break;

		case PQ_ByPass_ICM:
			ret = ((IoReg_Read32(COLOR_D_VC_Global_CTRL_0_reg)&COLOR_D_VC_Global_CTRL_0_ms_ctrl_icm_mask)>>COLOR_D_VC_Global_CTRL_0_ms_ctrl_icm_shift)&0x1;
		break;

		case PQ_ByPass_SHP:
			ret = ((IoReg_Read32(COLOR_D_VC_Global_CTRL_0_reg)&COLOR_D_VC_Global_CTRL_0_ms_ctrl_sharp_mask)>>COLOR_D_VC_Global_CTRL_0_ms_ctrl_sharp_shift)&0x1;
		break;

		case PQ_ByPass_Dedge_Smooth:
			//ret = (IoReg_Read32(COLOR_D_VC_Global_CTRL_reg)&COLOR_D_VC_Global_CTRL_m_edgesmooth_en_mask)>>COLOR_D_VC_Global_CTRL_m_edgesmooth_en_shift; //mac6p removed
			ret = 0;
		break;

		case PQ_ByPass_CDS:
			ret = (IoReg_Read32(COLOR_SHARP_DM_CDS_CM0_U_BOUND_0_reg)&COLOR_SHARP_DM_CDS_CM0_U_BOUND_0_cds_enable_mask)>>COLOR_SHARP_DM_CDS_CM0_U_BOUND_0_cds_enable_shift;
		break;

		case PQ_ByPass_UV_Offset:
			ret = (IoReg_Read32(YUV2RGB_D_UVOFFSETBYY_CONTROL_reg)&YUV2RGB_D_UVOFFSETBYY_CONTROL_uvoffsetbyy_main_en_mask)>>YUV2RGB_D_UVOFFSETBYY_CONTROL_uvoffsetbyy_main_en_shift;
		break;

		case PQ_ByPass_V_CTI:
			ret = (IoReg_Read32(SCALEUP_DM_MEM_CRC_CTRL_reg)&SCALEUP_DM_MEM_CRC_CTRL_vcti_en_mask)>>SCALEUP_DM_MEM_CRC_CTRL_vcti_en_shift;
		break;
		...
		case PQ_ByPass_Gamma:
			ret = (IoReg_Read32(GAMMA_GAMMA_CTRL_2_reg)&GAMMA_GAMMA_CTRL_2_gamma_m_tab_sel_mask)>>GAMMA_GAMMA_CTRL_2_gamma_m_tab_sel_shift;
		break;

		case PQ_ByPass_InvGamma:
			ret = (IoReg_Read32(INV_GAMMA_INV_GAMMA_CTRL_2_reg)&INV_GAMMA_INV_GAMMA_CTRL_2_inv_gamma_m_tab_sel_mask)>>INV_GAMMA_INV_GAMMA_CTRL_2_inv_gamma_m_tab_sel_shift;
		break;

		case PQ_ByPass_ColorTemp:
			ret = (IoReg_Read32(COLOR_TEMP_Color_Temp_CTRL_reg)&COLOR_TEMP_Color_Temp_CTRL_color_temp_en_mask)>>COLOR_TEMP_Color_Temp_CTRL_color_temp_en_shift;
		break;

		case PQ_ByPass_DITHER:
			ret = (IoReg_Read32(DITHER_DITHERING_CTRL_reg)&DITHER_DITHERING_CTRL_function_enable_mask)>>DITHER_DITHERING_CTRL_function_enable_shift;
		break;

		case PQ_ByPass_DITHER_Temporal:
			ret = (IoReg_Read32(DITHER_DITHERING_CTRL_reg)&DITHER_DITHERING_CTRL_temporal_enable_mask)>>DITHER_DITHERING_CTRL_temporal_enable_shift;
		break;

		/*Sub*/
#ifdef VIP_CONFIG_DUAL_CHANNEL
		case PQ_ByPass_DCTI_Sub:
			ret = (IoReg_Read32(COLOR_D_VC_Global_CTRL_reg)&COLOR_D_VC_Global_CTRL_s_dcti_en_mask)>>COLOR_D_VC_Global_CTRL_s_dcti_en_shift;
		break;
#endif //VIP_CONFIG_DUAL_CHANNEL
#ifdef CONFIG_DUAL_CHANNEL
		case PQ_ByPass_ICM_Sub:
			ret = (((IoReg_Read32(COLOR_D_VC_Global_CTRL_0_reg)&COLOR_D_VC_Global_CTRL_0_ms_ctrl_icm_mask)>>COLOR_D_VC_Global_CTRL_0_ms_ctrl_icm_shift)&0x2)>>1;
		break;

		case PQ_ByPass_SHP_Sub:
			ret = (((IoReg_Read32(COLOR_D_VC_Global_CTRL_0_reg)&COLOR_D_VC_Global_CTRL_0_ms_ctrl_sharp_mask)>>COLOR_D_VC_Global_CTRL_0_ms_ctrl_sharp_shift)&0x2)>>1;
		break;
		...
		case PQ_ByPass_Gamma_Gamma:
			ret = (IoReg_Read32(GAMMA_GAMMA_CTRL_2_reg)&GAMMA_GAMMA_CTRL_2_gamma_s_tab_sel_mask)>>GAMMA_GAMMA_CTRL_2_gamma_s_tab_sel_shift;
		break;

		case PQ_ByPass_InvGamma_Sub:
			ret = (IoReg_Read32(INV_GAMMA_INV_GAMMA_CTRL_2_reg)&INV_GAMMA_INV_GAMMA_CTRL_2_inv_gamma_s_tab_sel_mask)>>INV_GAMMA_INV_GAMMA_CTRL_2_inv_gamma_s_tab_sel_shift;
		break;
#endif

			/* new */
		case PQ_ByPass_I_DI_IP_Enable:
			ret = (IoReg_Read32(DI_IM_DI_CONTROL_reg)&DI_IM_DI_CONTROL_ip_enable_mask)>>DI_IM_DI_CONTROL_ip_enable_shift;
		break;
	}
...
{
	lg_m_plus_m_plus_reg04c_RBUS lg_m_plus_m_plus_reg4c_REG;
	lg_m_plus_m_plus_reg4c_REG.regValue = IoReg_Read32(LG_M_PLUS_M_plus_reg04c_reg);
	lg_m_plus_m_plus_reg4c_REG.wpr_reg4e = nFrameGainLimit >> 8;
 	lg_m_plus_m_plus_reg4c_REG.wpr_reg4f = nFrameGainLimit & 0xff;
	IoReg_Write32(LG_M_PLUS_M_plus_reg04c_reg, lg_m_plus_m_plus_reg4c_REG.regValue);
}
...
{
	lg_m_plus_m_plus_reg064_RBUS lg_m_plus_m_plus_reg64_REG;
	lg_m_plus_m_plus_reg068_RBUS lg_m_plus_m_plus_reg68_REG;

	lg_m_plus_m_plus_reg64_REG.regValue = IoReg_Read32(LG_M_PLUS_M_plus_reg064_reg);
	lg_m_plus_m_plus_reg68_REG.regValue = IoReg_Read32(LG_M_PLUS_M_plus_reg068_reg);

	lg_m_plus_m_plus_reg64_REG.wpr_reg67= nPixelGainLimit >> 8;
	lg_m_plus_m_plus_reg68_REG.wpr_reg68 = nPixelGainLimit & 0xff;
	IoReg_Write32(LG_M_PLUS_M_plus_reg064_reg, lg_m_plus_m_plus_reg64_REG.regValue);
	IoReg_Write32(LG_M_PLUS_M_plus_reg068_reg, lg_m_plus_m_plus_reg68_REG.regValue);
}
...
void drvif_DM_HDR_Vtop_set(unsigned char display, unsigned char dolbyMode, unsigned char en_422to444_1, unsigned char en_TC_422to444_1)
{
	...
	if (display == SLR_MAIN_DISPLAY) {
		...
		hdr_sub_hdr2_top_ctl_reg.hdr2_en_422to444_1 = en_422to444_1;
		hdr_sub_hdr2_top_ctl_reg.hdr2_en = dolbyMode;
...
void drvif_color_set_dma_memory(VIP_DMA_Memory_Addr mem_addr)
{
	...
	dmato3dtable_dmato3dtable_table2_addr_reg.regValue = IoReg_Read32(DMATO3DTABLE_DMAto3DTable_Table2_Addr_reg);
	IoReg_Write32(DMATO3DTABLE_DMAto3DTable_Table2_Addr_reg,mem_addr.dma_EOTF_startaddr);//set HDR EOTF dma address

	dmato3dtable_dmato3dtable_table3_addr_reg.regValue = IoReg_Read32(DMATO3DTABLE_DMAto3DTable_Table3_Addr_reg);
	IoReg_Write32(DMATO3DTABLE_DMAto3DTable_Table3_Addr_reg,mem_addr.dma_OETF_startaddr);//Set HDR OETF dma address

	dmato3dtable_dmato3dtable_table0_addr_reg.regValue = IoReg_Read32(DMATO3DTABLE_DMAto3DTable_Table0_Addr_reg);
	IoReg_Write32(DMATO3DTABLE_DMAto3DTable_Table0_Addr_reg,mem_addr.dma_HDR_3Dlut_startaddr);//Set HDR 3DLUT 24*24*24 dma address

	dmato3dlut_dmato3dlut_table0_addr_reg.regValue= IoReg_Read32(DMATO3DLUT_DMAto3DLUT_Table0_Addr_reg);
	IoReg_Write32(DMATO3DLUT_DMAto3DLUT_Table0_Addr_reg,mem_addr.dma_ICM_startaddr);//Set ICM dma address

	dmato3dlut_dmato3dlut_table1_addr_reg.regValue= IoReg_Read32(DMATO3DLUT_DMAto3DLUT_Table1_Addr_reg);
	IoReg_Write32(DMATO3DLUT_DMAto3DLUT_Table1_Addr_reg,mem_addr.dma_D_3DLut_startaddr);//Set D_3DLut dma address
...
char drvif_color_set_DeMura(DRV_DeMura_DMA_TBL* pDMA_TBL, DRV_DeMura_CTRL_TBL *ptr, unsigned char *pArray, unsigned int addr, unsigned int *vir_addr, unsigned int TBL_Line_size)
{
	...
	demura_demura_keep_h_control0_RBUS demura_demura_keep_h_control0_reg;
	demura_demura_keep_h_control1_RBUS demura_demura_keep_h_control1_reg;
	...
	if ((ptr == NULL) || (pArray == NULL) || (addr == 0) || (vir_addr == NULL)) {
		rtd_pr_vpq_info("drvif_color_set_DeMura tab;e NULL, ptr=%p,pArray=%p,NULL,addr=%x,vir_addr=%p\n", ptr, pArray, addr, vir_addr);
		return -1;
	}
	...
	*/
	...
	demura_demura_keep_h_control0_reg.regValue = IoReg_Read32(DEMURA_DEMURA_KEEP_H_CONTROL0_reg);
	demura_demura_keep_h_control1_reg.regValue = IoReg_Read32(DEMURA_DEMURA_KEEP_H_CONTROL1_reg);

	demura_demura_control_reg.demura_table_scale = ptr->demura_table_scale;
	demura_demura_control_reg.demura_table_scale_l = ptr->demura_table_scale_L;/*juwen, k5lp*/
	demura_demura_control_reg.demura_table_scale_m = ptr->demura_table_scale_M;/*juwen, k5lp*/
	demura_demura_control_reg.demura_table_scale_h = ptr->demura_table_scale_H;/*juwen, k5lp*/
	demura_demura_control_reg.demura_block_size = 0;//ptr->demura_block_size;
	...
	demura_demura_keep_h_control0_reg.demura_r_h_keep_level = ptr->demura_r_h_keep_level;
	demura_demura_keep_h_control0_reg.demura_g_h_keep_level = ptr->demura_g_h_keep_level;
	demura_demura_keep_h_control1_reg.demura_b_h_keep_level = ptr->demura_b_h_keep_level;
...
char drvif_color_Get_DeMura_CTRL(DRV_DeMura_CTRL_TBL *ptr)
{
	...
	ptr->demura_r_h_keep_level =  demura_demura_keep_h_control0_reg.demura_r_h_keep_level;
	ptr->demura_g_h_keep_level =  demura_demura_keep_h_control0_reg.demura_g_h_keep_level;
	ptr->demura_b_h_keep_level =  demura_demura_keep_h_control1_reg.demura_b_h_keep_level;
...
void drvif_color_set_DeMura_En(unsigned char enable)
{
	...
	demura_demura_control_reg.regValue = IoReg_Read32(DEMURA_DEMURA_CONTROL_reg);
#ifdef For_BringUp_Disable
		demura_demura_control_reg.demura_en = 0;
#else
...
char drvif_color_get_Peaking_Data_Access(unsigned int *index, unsigned int *YUV)
{
	...
	mpegnr_ich1_readdata_data_y2_pk_RBUS mpegnr_ich1_readdata_data_y2_pk_reg;
	mpegnr_ich1_readdata_data_c4_pk_RBUS mpegnr_ich1_readdata_data_c4_pk_reg;
	mpegnr_ich1_accessdata_posctrl_pk_reg.regValue = IoReg_Read32(MPEGNR_ICH1_AccessData_PosCtrl_PK_reg);
	mpegnr_ich1_accessdata_posctrl_pk_reg.startx = index[0];
	mpegnr_ich1_accessdata_posctrl_pk_reg.starty = index[1];
	...
	while((time_out!=0)&&(MPEGNR_ICH1_AccessData_CTRL_PK_get_read_en(IoReg_Read32(MPEGNR_ICH1_AccessData_CTRL_PK_reg))))
		time_out--;

	if(time_out==0)
		return -1;

	mpegnr_ich1_readdata_data_y2_pk_reg.regValue = IoReg_Read32(MPEGNR_ICH1_ReadData_DATA_Y2_PK_reg);
	mpegnr_ich1_readdata_data_c4_pk_reg.regValue = IoReg_Read32(MPEGNR_ICH1_ReadData_DATA_C4_PK_reg);

	YUV[0] = mpegnr_ich1_readdata_data_y2_pk_reg.y11;
	YUV[1] = mpegnr_ich1_readdata_data_c4_pk_reg.u11;
	YUV[2] = mpegnr_ich1_readdata_data_c4_pk_reg.v11;
...
char drvif_color_get_UZD_Data_Access(unsigned int *index, unsigned int *YUV)
{
	...
	scaledown_readdata_data_y2_uzd_RBUS scaledown_readdata_data_y2_uzd_reg;
	scaledown_readdata_data_c4_uzd_RBUS scaledown_readdata_data_c4_uzd_reg;

	scaledown_accessdata_posctrl_uzd_reg.regValue = IoReg_Read32(SCALEDOWN_AccessData_PosCtrl_UZD_reg);
	scaledown_accessdata_posctrl_uzd_reg.startx = index[0];
	scaledown_accessdata_posctrl_uzd_reg.starty = index[1];
	...
	while((time_out!=0)&&(SCALEDOWN_AccessData_CTRL_UZD_get_read_en(IoReg_Read32(SCALEDOWN_AccessData_CTRL_UZD_reg))))
		time_out--;

	if(time_out==0)
		return -1;

	scaledown_readdata_data_y2_uzd_reg.regValue = IoReg_Read32(SCALEDOWN_ReadData_DATA_Y2_UZD_reg);
	scaledown_readdata_data_c4_uzd_reg.regValue = IoReg_Read32(SCALEDOWN_ReadData_DATA_C4_UZD_reg);

	YUV[0] = scaledown_readdata_data_y2_uzd_reg.y11;
	YUV[1] = scaledown_readdata_data_c4_uzd_reg.u11;
	YUV[2] = scaledown_readdata_data_c4_uzd_reg.v11;
...
char drvif_color_get_UZU_Data_Access(unsigned int *index, unsigned int *YUV)
{
	...
	scaleup_readdata_data_y2_uzu_RBUS scaleup_readdata_data_y2_uzu_reg;
	scaleup_readdata_data_c4_uzu_RBUS scaleup_readdata_data_c4_uzu_reg;

	scaleup_accessdata_posctrl_uzu_reg.regValue = IoReg_Read32(SCALEUP_AccessData_PosCtrl_UZU_reg);
	scaleup_accessdata_posctrl_uzu_reg.startx = index[0];
	scaleup_accessdata_posctrl_uzu_reg.starty = index[1];
	...
	while((time_out!=0)&&(SCALEUP_AccessData_CTRL_UZU_get_read_en(IoReg_Read32(SCALEUP_AccessData_CTRL_UZU_reg))))
		time_out--;

	if(time_out==0)
		return -1;

	scaleup_readdata_data_y2_uzu_reg.regValue = IoReg_Read32(SCALEUP_ReadData_DATA_Y2_UZU_reg);
	scaleup_readdata_data_c4_uzu_reg.regValue = IoReg_Read32(SCALEUP_ReadData_DATA_C4_UZU_reg);

	YUV[0] = scaleup_readdata_data_y2_uzu_reg.y11;
	YUV[1] = scaleup_readdata_data_c4_uzu_reg.u11;
	YUV[2] = scaleup_readdata_data_c4_uzu_reg.v11;
...
char drvif_color_get_ICM_Data_Access(unsigned int *index, unsigned int *YUV)
{
	...
	color_icm_dm_icm_readdata_data_h2_RBUS color_icm_dm_icm_readdata_data_h2_reg;
	color_icm_dm_icm_readdata_data_s2_RBUS color_icm_dm_icm_readdata_data_s2_reg;
	color_icm_dm_icm_readdata_data_i2_RBUS color_icm_dm_icm_readdata_data_i2_reg;

	color_icm_dm_icm_accessdata_posctrl_reg.regValue = IoReg_Read32(COLOR_ICM_DM_ICM_AccessData_PosCtrl_reg);
	color_icm_dm_icm_accessdata_posctrl_reg.accessdata_startx = index[0];
	color_icm_dm_icm_accessdata_posctrl_reg.accessdata_starty = index[1];
	...
	while((time_out!=0)&&(COLOR_ICM_DM_ICM_AccessData_CTRL_get_accessdata_read_en(IoReg_Read32(COLOR_ICM_DM_ICM_AccessData_CTRL_reg))))
		time_out--;

	if(time_out==0)
		return -1;

	color_icm_dm_icm_readdata_data_h2_reg.regValue = IoReg_Read32(COLOR_ICM_DM_ICM_ReadData_DATA_H2_reg);
	color_icm_dm_icm_readdata_data_s2_reg.regValue = IoReg_Read32(COLOR_ICM_DM_ICM_ReadData_DATA_S2_reg);
	color_icm_dm_icm_readdata_data_i2_reg.regValue = IoReg_Read32(COLOR_ICM_DM_ICM_ReadData_DATA_I2_reg);

	YUV[0] = color_icm_dm_icm_readdata_data_h2_reg.readdata_h11;
	YUV[1] = color_icm_dm_icm_readdata_data_s2_reg.readdata_s11;
	YUV[2] = color_icm_dm_icm_readdata_data_i2_reg.readdata_i11;
...
char drvif_color_get_YUV2RGB_Data_Access(unsigned int *index, unsigned int *YUV)
{
	...
	yuv2rgb_accessdata_posctrl_reg.startx = index[0];
	yuv2rgb_accessdata_posctrl_reg.starty = index[1];
	...
	while((time_out!=0)&&(YUV2RGB_AccessData_CTRL_get_read_en(IoReg_Read32(YUV2RGB_AccessData_CTRL_reg))))
		time_out--;
	...
	YUV[0] = yuv2rgb_readdata_data_y2_reg.y11;
	YUV[1] = yuv2rgb_readdata_data_c4_reg.u11;
	YUV[2] = yuv2rgb_readdata_data_c4_reg.v11;
...
char drvif_color_get_Panel_Compensation_Data_Access(unsigned int *index, unsigned int *YUV)
{
	...
	od_readdata_data_channel1_2_pc_RBUS od_readdata_data_channel1_2_pc_reg;
	od_readdata_data_channel2_2_pc_RBUS od_readdata_data_channel2_2_pc_reg;
	od_readdata_data_channel3_2_pc_RBUS od_readdata_data_channel3_2_pc_reg;

	od_accessdata_posctrl_pc_reg.regValue = IoReg_Read32(OD_AccessData_PosCtrl_PC_reg);
	od_accessdata_posctrl_pc_reg.access_startx = index[0];
	od_accessdata_posctrl_pc_reg.access_starty = index[1];
	...
	while((time_out!=0)&&(OD_AccessData_CTRL_PC_get_access_read_en(IoReg_Read32(OD_AccessData_CTRL_PC_reg))))
		time_out--;

	if(time_out==0)
		return -1;

	od_readdata_data_channel1_2_pc_reg.regValue = IoReg_Read32(OD_ReadData_DATA_Channel1_2_PC_reg);
	od_readdata_data_channel2_2_pc_reg.regValue = IoReg_Read32(OD_ReadData_DATA_Channel2_2_PC_reg);
	od_readdata_data_channel3_2_pc_reg.regValue = IoReg_Read32(OD_ReadData_DATA_Channel3_2_PC_reg);

	YUV[0] = od_readdata_data_channel1_2_pc_reg.access_y11;
	YUV[1] = od_readdata_data_channel2_2_pc_reg.access_u11;
	YUV[2] = od_readdata_data_channel3_2_pc_reg.access_v11;
...
unsigned char drvif_color_VPQ_ByPass(unsigned char enable)
{
	if(enable){
		...
		/*D_domain*/
		IoReg_D_domain_ClearBits(COLOR_D_VC_Global_CTRL_reg, COLOR_D_VC_Global_CTRL_ms_vc_en_mask);
...
#ifdef CONFIG_HW_SUPPORT_MEMC
	if(enable){
		IoReg_Mask32(0xb80996b0,~(_BIT0|_BIT1|_BIT2),(_BIT2));
		IoReg_Write32(0xb809d5e4,0x0);//pql_patch_dummy_e4, disable auto API
		IoReg_SetBits(0xb809b200,_BIT29); //force random seed to initial value each frame

		IoReg_ClearBits(0xb809960c,_BIT1);//lvllpf_en

		IoReg_ClearBits(0xb8099610,_BIT0);//mvd_diff_lpf_en

		IoReg_ClearBits(0xb8099720,_BIT12);//logo_self_lpf_en

		IoReg_ClearBits(0xb8099750,_BIT0);//0:1 var_lpf_en
		IoReg_ClearBits(0xb8099750,_BIT1);//0:1 var_lpf_en

		IoReg_ClearBits(0xb8099750,_BIT11);//dbpt_lpf_en

		IoReg_ClearBits(0xb8099924,_BIT5);//lpf_2tap_on

		//local fb disable
		IoReg_SetBits(0xb8099628,_BIT14);//mc_fb_lvl_force_en
		IoReg_Write32(0xb8099628,(IoReg_Read32(0xb8099628) & (0xff807fff)));//15:22, mc_fb_lvl_force_value
		IoReg_ClearBits(0xb809960c,_BIT29);//logo_phase_fb_phase_en
		IoReg_ClearBits(0xb809960c,_BIT30);//pre_phase_fb_phase_en
		IoReg_ClearBits(0xb809960c,_BIT31);//pt_phase_fb_phase_en
		IoReg_ClearBits(0xb809d6b8,_BIT2);//pql_wr_fb_lvl_wr_en
		IoReg_ClearBits(0xb809d628,_BIT0);//pql_fb_ctrl_en
	}
#endif
	return TRUE;
}
...
/*juwen, Merlin3, newAlgo : UV offset by UV*/
	...
	d_yuv2rgb_control_1_reg.yuv2rgb_db_en = 0;
	...
	switch (WriteMode) {
	case VIP_CSMatrix_YUV2RGB_Base_Ctrl:
		d_yuv2rgb_control_REG.regValue = rtd_inl(YUV2RGB_D_YUV2RGB_Control_reg);
		yuv2rgb_d_yuv2rgb_tab1_data_clamp_REG.regValue = rtd_inl(YUV2RGB_D_YUV2RGB_Tab1_Data_Clamp_reg);
		yuv2rgb_d_yuv2rgb_tab2_data_clamp_REG.regValue = rtd_inl(YUV2RGB_D_YUV2RGB_Tab2_Data_Clamp_reg);
		if ((ch > SLR_SUB_DISPLAY) || (tbl > VIP_Table_Select_2)) {
			printf("~~drvif_color_setYUV2RGB_CSMatrix Error, CH or tbl select error, CH = %d, TBL = %d~~\n ", ch, tbl);
			return;
		}
		if (ch == SLR_MAIN_DISPLAY) {
		...
		printf(" yuv2rgb_main_en= %d, yuv2rgb_main_tab_sel = %d  ,yuv2rgb_main_out_shift =%d \n ", 
			d_yuv2rgb_control_REG.yuv2rgb_main_en, 
			d_yuv2rgb_control_REG.yuv2rgb_main_tab_sel,
			d_yuv2rgb_control_REG.yuv2rgb_main_out_shift);
		...
		rtd_outl(YUV2RGB_D_YUV2RGB_Tab1_Data_Clamp_reg, yuv2rgb_d_yuv2rgb_tab1_data_clamp_REG.regValue);
		rtd_outl(YUV2RGB_D_YUV2RGB_Control_reg, d_yuv2rgb_control_REG.regValue);
		rtd_outl(YUV2RGB_D_YUV2RGB_Tab2_Data_Clamp_reg, yuv2rgb_d_yuv2rgb_tab2_data_clamp_REG.regValue);
		break;
	...
	case VIP_CSMatrix_Coef_Y_Only:
		if (seg == VIP_YUV2RGB_Y_Seg_0) {
			...
			if (tbl == VIP_Table_Select_1) {
				...
				printf("~~drvif_color_setYUV2RGB_CSMatrix Error, Table2 can't set matrix by Y~~\n ");
				return;
			}
		} else if (seg == VIP_YUV2RGB_Y_Seg_Max) {
			if (tbl != VIP_Table_Select_1) {
				printf("~~drvif_color_setYUV2RGB_CSMatrix Error, TBL selec error~~\n ");
				return;
			}
			for (i = 0; i < VIP_YUV2RGB_Y_Seg_Max; i++) {
				yuv2rgb_d_yuv2rgb_tab1_data_0_REG.k11 = ptr->COEF_By_Y.K11[i];
	...
	case VIP_CSMatrix_Coef_C_Only:
		if (seg == VIP_YUV2RGB_Y_Seg_0) {
			...
			if (tbl == VIP_Table_Select_1) {
				...
				IoReg_WriteWord0(YUV2RGB_D_YUV2RGB_Tab2_Data_0_reg, yuv2rgb_d_yuv2rgb_tab1_data_0_REG.k12);
				rtd_outl(YUV2RGB_D_YUV2RGB_Tab2_Data_1_reg, yuv2rgb_d_yuv2rgb_tab1_data_1_REG.regValue);
				rtd_outl(YUV2RGB_D_YUV2RGB_Tab2_Data_2_reg, yuv2rgb_d_yuv2rgb_tab1_data_2_REG.regValue);
				rtd_outl(YUV2RGB_D_YUV2RGB_Tab2_Data_3_reg, yuv2rgb_d_yuv2rgb_tab1_data_3_REG.regValue);
			} else {
				printf("~~drvif_color_setYUV2RGB_CSMatrix Error, TBL selec error~~\n ");
				return;
			}
			...
			if (seg < VIP_YUV2RGB_Y_Seg_4) {
				IoReg_WriteWord0(YUV2RGB_D_YUV2RGBBYY_Tab_Data_1_0_reg+((seg-1)*4*4), yuv2rgb_d_yuv2rgb_tab1_data_0_REG.k12);
				rtd_outl(YUV2RGB_D_YUV2RGBBYY_Tab_Data_1_1_reg+((seg-1)*4*4), yuv2rgb_d_yuv2rgb_tab1_data_1_REG.regValue);
				rtd_outl(YUV2RGB_D_YUV2RGBBYY_Tab_Data_1_2_reg+((seg-1)*4*4), yuv2rgb_d_yuv2rgb_tab1_data_2_REG.regValue);
				rtd_outl(YUV2RGB_D_YUV2RGBBYY_Tab_Data_1_3_reg+((seg-1)*4*4), yuv2rgb_d_yuv2rgb_tab1_data_3_REG.regValue);
			} else if (seg == VIP_YUV2RGB_Y_Seg_4) {
				IoReg_WriteWord0(YUV2RGB_D_YUV2RGBBYY_Tab_Data_4_0_reg, yuv2rgb_d_yuv2rgb_tab1_data_0_REG.k12);
				rtd_outl(YUV2RGB_D_YUV2RGBBYY_Tab_Data_4_1_reg, yuv2rgb_d_yuv2rgb_tab1_data_1_REG.regValue);
				rtd_outl(YUV2RGB_D_YUV2RGBBYY_Tab_Data_4_2_reg, yuv2rgb_d_yuv2rgb_tab1_data_2_REG.regValue);
				...
				IoReg_WriteWord0(YUV2RGB_D_YUV2RGBBYY_Tab_Data_5_0_reg+((seg-5)*4*4), yuv2rgb_d_yuv2rgb_tab1_data_0_REG.k12);
				rtd_outl(YUV2RGB_D_YUV2RGBBYY_Tab_Data_5_1_reg+((seg-5)*4*4), yuv2rgb_d_yuv2rgb_tab1_data_1_REG.regValue);
				rtd_outl(YUV2RGB_D_YUV2RGBBYY_Tab_Data_5_2_reg+((seg-5)*4*4), yuv2rgb_d_yuv2rgb_tab1_data_2_REG.regValue);
				rtd_outl(YUV2RGB_D_YUV2RGBBYY_Tab_Data_5_3_reg+((seg-5)*4*4), yuv2rgb_d_yuv2rgb_tab1_data_3_REG.regValue);
			}
		}
		buffer_status_count = 0;
		break;
	...
	case VIP_CSMatrix_Offset_Only:
		...
		if (tbl == VIP_Table_Select_1) {
			...
			rtd_outl(YUV2RGB_D_YUV2RGB_Tab2_Data_4_reg, yuv2rgb_d_yuv2rgb_tab1_data_4_REG.regValue);
			rtd_outl(YUV2RGB_D_YUV2RGB_Tab2_Data_5_reg, yuv2rgb_d_yuv2rgb_tab1_data_5_REG.regValue);
			rtd_outl(YUV2RGB_D_YUV2RGB_Tab2_Data_6_reg, yuv2rgb_d_yuv2rgb_tab1_data_6_REG.regValue);
		} else {
			printf("~~drvif_color_setYUV2RGB_CSMatrix Error, TBL selec error~~\n ");
			return;
		}
	...
	case VIP_CSMatrix_Y_Clamp:
		...
		if (tbl == VIP_Table_Select_1)
			...
			rtd_outl(YUV2RGB_D_YUV2RGB_Tab2_Data_Clamp_reg, yuv2rgb_d_yuv2rgb_tab1_data_clamp_REG.regValue);
		else {
			printf("~~drvif_color_setYUV2RGB_CSMatrix Error, TBL selec error~~\n ");
			return;
		}
	...
	case VIP_CSMatrix_CoefByY_ctrl:
		d_yuv2rgbbyy_control_REG.regValue = rtd_inl(YUV2RGB_D_YUV2RGBBYY_CONTROL_reg);
		d_yuv2rgbbyy_control_REG.yuv2rgbbymode_main_en = ptr->CTRL_ITEM.CoefByY_En;
		/*d_yuv2rgbbyy_control_REG.yuv2rgbbyy_sub_en = ptr->CoefByY_En;*/
		...
		rtd_outl(YUV2RGB_D_YUV2RGBBYY_CONTROL_reg, d_yuv2rgbbyy_control_REG.regValue);
		buffer_status_count = 0;
		break;
	case VIP_CSMatrix_UVOffset_ctrl:
		d_uvoffsetbyy_control_REG.regValue = rtd_inl(YUV2RGB_D_UVOFFSETBYY_CONTROL_reg);
		d_uvoffsetbyy_control_REG.uvoffsetbyy_main_en = ptr->CTRL_ITEM.UVOffset_En;
		d_uvoffsetbyy_control_REG.uvoffsetbyy_mode = ptr->CTRL_ITEM.UVOffset_Mode_Ctrl;
		d_uvoffsetbyy_control_REG.uvoffset_mode = ptr->CTRL_ITEM.UVOffset_Mode_byUV_byY;/*juwen, Merlin3, newAlgo : UV offset by UV*/
		rtd_outl(YUV2RGB_D_UVOFFSETBYY_CONTROL_reg, d_uvoffsetbyy_control_REG.regValue);
		buffer_status_count = 0;
		break;
...
/*juwen, Merlin3, newAlgo : UV offset by UV*/
		...
		rtd_outl(YUV2RGB_D_UVOFFSETBYY_U_Tab_Data_1_reg, yuv2rgb_d_uvoffsetbyy_u_tab_data_1_REG.regValue);
		rtd_outl(YUV2RGB_D_UVOFFSETBYY_U_Tab_Data_2_reg, yuv2rgb_d_uvoffsetbyy_u_tab_data_2_REG.regValue);
		rtd_outl(YUV2RGB_D_UVOFFSETBYY_U_Tab_Data_3_reg, yuv2rgb_d_uvoffsetbyy_u_tab_data_3_REG.regValue);
		rtd_outl(YUV2RGB_D_UVOFFSETBYY_U_Tab_Data_4_reg, yuv2rgb_d_uvoffsetbyy_u_tab_data_4_REG.regValue);
		rtd_outl(YUV2RGB_D_UVOFFSETBYY_U_Tab_Data_5_reg, yuv2rgb_d_uvoffsetbyy_u_tab_data_5_REG.regValue);
		rtd_outl(YUV2RGB_D_UVOFFSETBYY_V_Tab_Data_1_reg, yuv2rgb_d_uvoffsetbyy_v_tab_data_1_REG.regValue);
		rtd_outl(YUV2RGB_D_UVOFFSETBYY_V_Tab_Data_2_reg, yuv2rgb_d_uvoffsetbyy_v_tab_data_2_REG.regValue);
		rtd_outl(YUV2RGB_D_UVOFFSETBYY_V_Tab_Data_3_reg, yuv2rgb_d_uvoffsetbyy_v_tab_data_3_REG.regValue);
		rtd_outl(YUV2RGB_D_UVOFFSETBYY_V_Tab_Data_4_reg, yuv2rgb_d_uvoffsetbyy_v_tab_data_4_REG.regValue);
		rtd_outl(YUV2RGB_D_UVOFFSETBYY_V_Tab_Data_5_reg, yuv2rgb_d_uvoffsetbyy_v_tab_data_5_REG.regValue);
		rtd_outl(YUV2RGB_D_UVOFFSETBYY_U_Tab_Step_1_reg, yuv2rgb_d_uvoffsetbyy_u_tab_step_1_REG.regValue);
		rtd_outl(YUV2RGB_D_UVOFFSETBYY_U_Tab_Step_2_reg, yuv2rgb_d_uvoffsetbyy_u_tab_step_2_REG.regValue);
		rtd_outl(YUV2RGB_D_UVOFFSETBYY_U_Tab_Step_3_reg, yuv2rgb_d_uvoffsetbyy_u_tab_step_3_REG.regValue);
		rtd_outl(YUV2RGB_D_UVOFFSETBYY_U_Tab_Step_4_reg, yuv2rgb_d_uvoffsetbyy_u_tab_step_4_REG.regValue);
		rtd_outl(YUV2RGB_D_UVOFFSETBYY_U_Tab_Step_5_reg, yuv2rgb_d_uvoffsetbyy_u_tab_step_5_REG.regValue);
		rtd_outl(YUV2RGB_D_UVOFFSETBYY_V_Tab_Step_1_reg, yuv2rgb_d_uvoffsetbyy_v_tab_step_1_REG.regValue);
		rtd_outl(YUV2RGB_D_UVOFFSETBYY_V_Tab_Step_2_reg, yuv2rgb_d_uvoffsetbyy_v_tab_step_2_REG.regValue);
		rtd_outl(YUV2RGB_D_UVOFFSETBYY_V_Tab_Step_3_reg, yuv2rgb_d_uvoffsetbyy_v_tab_step_3_REG.regValue);
		rtd_outl(YUV2RGB_D_UVOFFSETBYY_V_Tab_Step_4_reg, yuv2rgb_d_uvoffsetbyy_v_tab_step_4_REG.regValue);
		rtd_outl(YUV2RGB_D_UVOFFSETBYY_V_Tab_Step_5_reg, yuv2rgb_d_uvoffsetbyy_v_tab_step_5_REG.regValue);

/*juwen, Merlin3, newAlgo : UV offset by UV*/
		rtd_outl(YUV2RGB_D_OFFSETBYUV_NONLINEAR_1_reg, yuv2rgb_d_offsetbyuv_nonlinear_1_REG.regValue);
		rtd_outl(YUV2RGB_D_OFFSETBYUV_NONLINEAR_2_reg, yuv2rgb_d_offsetbyuv_nonlinear_2_REG.regValue);
		rtd_outl(YUV2RGB_D_OFFSETBYUV_NONLINEAR_3_reg, yuv2rgb_d_offsetbyuv_nonlinear_3_REG.regValue);
		rtd_outl(YUV2RGB_D_OFFSETBYUV_NONLINEAR_4_reg, yuv2rgb_d_offsetbyuv_nonlinear_4_REG.regValue);
		rtd_outl(YUV2RGB_D_OFFSETBYUV_NONLINEAR_5_reg, yuv2rgb_d_offsetbyuv_nonlinear_5_REG.regValue);
		rtd_outl(YUV2RGB_D_OFFSETBYUV_NONLINEAR_6_reg, yuv2rgb_d_offsetbyuv_nonlinear_6_REG.regValue);
		rtd_outl(YUV2RGB_D_OFFSETBYUV_NONLINEAR_7_reg, yuv2rgb_d_offsetbyuv_nonlinear_7_REG.regValue);
		rtd_outl(YUV2RGB_D_OFFSETBYUV_NONLINEAR_8_reg, yuv2rgb_d_offsetbyuv_nonlinear_8_REG.regValue);

		rtd_outl(YUV2RGB_D_OFFSETBYUV_Gain_Tab_1_reg, yuv2rgb_d_offsetbyuv_gain_tab_1_REG.regValue);
		rtd_outl(YUV2RGB_D_OFFSETBYUV_Gain_Tab_2_reg, yuv2rgb_d_offsetbyuv_gain_tab_2_REG.regValue);
		rtd_outl(YUV2RGB_D_OFFSETBYUV_Gain_Tab_3_reg, yuv2rgb_d_offsetbyuv_gain_tab_3_REG.regValue);
		rtd_outl(YUV2RGB_D_OFFSETBYUV_Gain_Tab_4_reg, yuv2rgb_d_offsetbyuv_gain_tab_4_REG.regValue);
		rtd_outl(YUV2RGB_D_OFFSETBYUV_Gain_Tab_5_reg, yuv2rgb_d_offsetbyuv_gain_tab_5_REG.regValue);
		rtd_outl(YUV2RGB_D_OFFSETBYUV_Gain_Tab_6_reg, yuv2rgb_d_offsetbyuv_gain_tab_6_REG.regValue);
		rtd_outl(YUV2RGB_D_OFFSETBYUV_Gain_Tab_7_reg, yuv2rgb_d_offsetbyuv_gain_tab_7_REG.regValue);
		rtd_outl(YUV2RGB_D_OFFSETBYUV_Gain_Tab_8_reg, yuv2rgb_d_offsetbyuv_gain_tab_8_REG.regValue);
		rtd_outl(YUV2RGB_D_OFFSETBYUV_Gain_Tab_9_reg, yuv2rgb_d_offsetbyuv_gain_tab_9_REG.regValue);
	...
	case VIP_CSMatrix_CoefByY_Index:		/* Mac3 add by chris @20140721*/
		...
		for (i = 0; i < VIP_YUV2RGB_Y_Seg_Max-1; i += 4) {
			...
			yuv2rgb_d_coefbyy_nonlinear_0_REG.index_3 = ptr->COEF_By_Y.Y_index[i+2];
			yuv2rgb_d_coefbyy_nonlinear_0_REG.index_4 = ptr->COEF_By_Y.Y_index[i+3];
			rtd_outl(YUV2RGB_D_COEFBYY_NONLINEAR_0_reg+i, yuv2rgb_d_coefbyy_nonlinear_0_REG.regValue);
		}
		buffer_status_count = 0;
		break;
	...
	case VIP_CSMatrix_UVOffset_Index:		/* Mac3 add by chris @20140721*/
		...
		for (i = 0; i < VIP_YUV2RGB_Y_Seg_Max-1; i += 4) {
			...
			yuv2rgb_d_offsetbyy_nonlinear_0_REG.index_3 = ptr->UV_Offset.UV_index[i+2];
			yuv2rgb_d_offsetbyy_nonlinear_0_REG.index_4 = ptr->UV_Offset.UV_index[i+3];
			rtd_outl(YUV2RGB_D_OFFSETBYY_NONLINEAR_0_reg+i, yuv2rgb_d_offsetbyy_nonlinear_0_REG.regValue);
		}
		buffer_status_count = 0;
		break;
	...
	case VIP_CSMatrix_Coef_BT2020_Only:
		if (tbl == VIP_Table_Select_1) {
			yuv2rgb_d_yuv2rgb_tab1_data_7_REG.regValue = rtd_inl(YUV2RGB_D_YUV2RGB_Tab1_Data_7_reg);
			yuv2rgb_d_yuv2rgb_tab1_data_7_REG.k132 = ptr->COEF_By_Y.bt2020_K13;
			yuv2rgb_d_yuv2rgb_tab1_data_7_REG.k322 = ptr->COEF_By_Y.bt2020_K32;
			rtd_outl(YUV2RGB_D_YUV2RGB_Tab1_Data_7_reg, yuv2rgb_d_yuv2rgb_tab1_data_7_REG.regValue);
		} else if (tbl == VIP_Table_Select_2) {
			yuv2rgb_d_yuv2rgb_tab2_data_7_REG.regValue = rtd_inl(YUV2RGB_D_YUV2RGB_Tab2_Data_7_reg);
			yuv2rgb_d_yuv2rgb_tab2_data_7_REG.k132 = ptr->COEF_By_Y.bt2020_K13;
			yuv2rgb_d_yuv2rgb_tab2_data_7_REG.k322 = ptr->COEF_By_Y.bt2020_K32;
			rtd_outl(YUV2RGB_D_YUV2RGB_Tab2_Data_7_reg, yuv2rgb_d_yuv2rgb_tab1_data_7_REG.regValue);
		} else {
			printf("~~drvif_color_setYUV2RGB_CSMatrix Error, Table select Error~~\n ");
		}
		buffer_status_count = 0;
		break;

	default:
		printf("~~drvif_color_setYUV2RGB_CSMatrix, WriteMode Error, WriteMode =%d~~\n ", WriteMode);
		return;
	}
	...
	printf("[vpq] Y2R WriteMode: %d finish  \n ",WriteMode );
...
void drvif_scalerdisplay_set_sharpness_line_mode_quick_show(unsigned char is_game_en)
{
	...
	if(is_game_en ==_ENABLE){
		display_timing_ctrl2_reg.shpnr_line_mode = 3;
	}
	else if(_DISP_WID < 1920){
		display_timing_ctrl2_reg.shpnr_line_mode = 0;
	}else{
		display_timing_ctrl2_reg.shpnr_line_mode = 2;
	}

	rtd_pr_vbe_debug(" display_timing_ctrl2_reg : %x \n", display_timing_ctrl2_reg.regValue);
