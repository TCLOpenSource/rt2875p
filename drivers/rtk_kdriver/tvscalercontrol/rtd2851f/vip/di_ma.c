...
void drvif_color_ma_init(void) /* when turning on auto MA (OSD)*/
{
...
void drvif_color_ma_auto_init_1(void)/* when turning off AutoMA1_Enable (OSD)*/
{

}

void drvif_color_ma_auto_init_2(void)/* when turning off AutoMA2_Enable (OSD)*/
{

}

void drvif_color_ma_auto_init_3(void)/* when turning off AutoMA3_Enable (OSD)*/
{

}

void drvif_color_ma_auto_init_4(void)/* when turning off AutoMA4_Enable (OSD)*/
{
...
void drvif_color_ma_set_DI_MA_Adjust_Table(DRV_di_ma_adjust_table *ptr)
{
	...
	di_control_reg.ma_stilllogoena = ptr->di_ma_control.ma_stilllogoena;
...
void drvif_color_ma_set_DI_MA_Init_Table(DRV_di_ma_init_table *ptr)
{
	...
	//di_control_reg.ma_preferintra = ptr->di_ma_control_init.ma_preferintra; //mac6p removed
...
#if 0
void drvif_color_Set_di_FRZ_CNT_ISR(unsigned char display, unsigned char FRZ_En)
{
	...
	if (FRZ_En == 1) {
		...
		im_di_weave_window_control_reg.freeze = 1;
		reg_input_di_ctrl_REG.auto_freeze = 0;
		...
		reg_input_di_ctrl_REG.regValue = IoReg_Read32(DI_IM_DI_DEBUG_MODE_reg);	
		reg_input_di_ctrl_REG.auto_freeze = 1;
		IoReg_Write32(DI_IM_DI_DEBUG_MODE_reg, reg_input_di_ctrl_REG.regValue);
	}
	
}
#endif
unsigned char drvif_color_Get_di_FRZ(void)
{
	return DI_IM_DI_WEAVE_WINDOW_CONTROL_get_freeze(IoReg_Read32(DI_IM_DI_WEAVE_WINDOW_CONTROL_reg));
}
...
void drvif_color_ma_ChromaError(DRV_MA_ChromaError *ptr)
{
	...
	//FrameSobel_statistic_Reg.chromaerror_en = ptr->chromaerror_en; //Mac7p chromaerror_en function removed, no more use
...
void drvif_color_ma_HMC(DRV_di_ma_hmc_table *ptr)
{
	...
	di_im_di_hmc_ma_blending_2_RBUS di_im_di_hmc_ma_blending_2_reg;
	di_im_di_hmc_ma_blending_3_RBUS di_im_di_hmc_ma_blending_3_reg;
	...
	di_im_di_hmc_ma_blending_2_reg.regValue = IoReg_Read32(DI_IM_DI_HMC_MA_BLENDING_2_reg);
	...
	di_im_di_hmc_ma_blending_2_reg.hmc_half_mv_energy_check_pre_th = ptr->di_ma_hmc_mv_energy_check.check_pre_th;
	di_im_di_hmc_ma_blending_2_reg.hmc_half_mv_energy_check_nxt_th = ptr->di_ma_hmc_mv_energy_check.check_nxt_th;
	di_im_di_hmc_ma_blending_2_reg.hmc_half_mv_energy_check_pre_gain = ptr->di_ma_hmc_mv_energy_check.check_pre_gain;
	di_im_di_hmc_ma_blending_2_reg.hmc_half_mv_energy_check_nxt_gain = ptr->di_ma_hmc_mv_energy_check.check_nxt_gain;

	/* di_ma_hmc_mv_teeth_check*/
	di_hmc_pan_control_reg.hmc_half_mv_all_teeth_check_en = ptr->di_ma_hmc_mv_teeth_check.allTeethCheck_en;
	di_im_di_hmc_ma_blending_3_reg.hmc_half_mv_all_teeth_check_th = ptr->di_ma_hmc_mv_teeth_check.all_teeth_th;
	di_hmc_pan_control_reg.hmc_half_mv_notteeth_recover_en = ptr->di_ma_hmc_mv_teeth_check.notTeethRecover_en;
	di_im_di_hmc_ma_blending_2_reg.hmc_half_mv_notteeth_recover_hline_th = ptr->di_ma_hmc_mv_teeth_check.notTeeth_Hline_th;
	di_im_di_hmc_ma_blending_3_reg.hmc_half_mv_notteeth_recover_dline_th = ptr->di_ma_hmc_mv_teeth_check.notTeeth_Dline_th;

	/* di_ma_hmc_blending_with_MA*/
	di_im_di_hmc_ma_blending_3_reg.hmc_blending_with_ma_en = ptr->di_ma_hmc_blending_with_MA.blendingMA_en;
	di_im_di_hmc_ma_blending_3_reg.hmc_blending_with_ma_gain_en = ptr->di_ma_hmc_blending_with_MA.gain_en;
	di_im_di_hmc_ma_blending_3_reg.hmc_blending_with_ma_gain_factor = ptr->di_ma_hmc_blending_with_MA.gain_factor;
	di_im_di_hmc_ma_blending_3_reg.hmc_blending_with_ma_gain = ptr->di_ma_hmc_blending_with_MA.gain;
	...
	IoReg_Write32(DI_IM_DI_HMC_MA_BLENDING_2_reg, di_im_di_hmc_ma_blending_2_reg.regValue);
	IoReg_Write32(DI_IM_DI_HMC_MA_BLENDING_3_reg, di_im_di_hmc_ma_blending_3_reg.regValue);
}
...
void drvif_color_ma_HME(DRV_di_ma_hme_table *ptr)
{
	...
	//di_im_di_hmc_me_refine_ctrl_1_RBUS di_hmc_me_refine_ctrl_1_reg; //mac6p removed
	...
	//di_hmc_pan_control_reg.hme_prefer_even_mv_en = ptr->di_ma_hme_prefer_even_mv.en; //mac6p removed
	...
	/* 		hme refine													*/
	//di_hmc_me_refine_ctrl_1_reg.regValue = IoReg_Read32(DI_IM_DI_HMC_ME_REFINE_CTRL_1_reg); //mac6p removed
	//IoReg_Write32(DI_IM_DI_HMC_ME_REFINE_CTRL_1_reg,ptr->DI_HMC_ME_REFINE_CTRL_1); //mac6p removed
...
//	di_im_di_si_film_final_result_RBUS di_im_di_si_film_final_result_reg;
	...
	di_rtnr_ediff_sobel_th_reg.regValue = IoReg_Read32(DI_IM_DI_RTNR_EDIFF_SOBEL_TH_reg);
	di_im_di_film_motion_sum_th_reg.regValue = IoReg_Read32(DI_IM_DI_FILM_MOTION_SUM_TH_reg);
	di_im_di_rtnr_hmcnr_statistic_6_reg.regValue = IoReg_Read32(DI_IM_DI_RTNR_HMCNR_STATISTIC_6_reg);
//	di_im_di_si_film_final_result_reg.regValue = IoReg_Read32(DI_IM_DI_SI_FILM_FINAL_RESULT_reg);
	od_ctrl_reg.regValue = IoReg_Read32(OD_OD_CTRL_reg);
	di_im_di_rtnr_refined_ctrl2_reg.regValue = IoReg_Read32(DI_IM_DI_RTNR_REFINED_CTRL2_reg);
	di_di_smd_dummy_reg.regValue = IoReg_Read32(DI_DI_SMD_dummy_reg);
#endif
	...
	di_rtnr_ediff_sobel_th_reg.dummy180241d0_31_22 = ptr->di_ma_pan_detection.diffMinThd;
	di_im_di_film_motion_sum_th_reg.dummy180240b4_23_16 = ptr->di_ma_pan_detection.restIdx;
//	di_im_di_si_film_final_result_reg.dummy180240c4_31_9 = di_im_di_si_film_final_result_reg.dummy180240c4_31_9 | (ptr->di_ma_pan_detection.restIdxThd << 4); // 16 bits [28:13]
	od_ctrl_reg.dummy1802ca00_31_2 = od_ctrl_reg.dummy1802ca00_31_2 | (ptr->di_ma_pan_detection.restIdxThd << 16); // 16 bits [31:16]
	di_im_di_rtnr_hmcnr_statistic_6_reg.dummy18024858_15_0 = ptr->di_ma_pan_detection.diffMaxMin;
	di_im_di_rtnr_refined_ctrl2_reg.dummy180242ac_31_17 = di_im_di_rtnr_refined_ctrl2_reg.dummy180242ac_31_17 | ptr->di_ma_pan_detection.panConti_str; // 8 bits [24:17]
	di_di_smd_dummy_reg.dummy18024540_31_2 = di_di_smd_dummy_reg.dummy18024540_31_2 | (ptr->di_ma_pan_detection.panConti << 8); // 8 bits [17:10];
	di_di_smd_dummy_reg.dummy18024540_31_2 = di_di_smd_dummy_reg.dummy18024540_31_2 | ptr->di_ma_pan_detection.panDeb_str; 		// 8 bits [9:2];
	di_di_smd_dummy_reg.dummy18024540_31_2 = di_di_smd_dummy_reg.dummy18024540_31_2 | (ptr->di_ma_pan_detection.panDeb << 16); 	// 8 bits [25:18];

	IoReg_Write32(DI_IM_DI_RTNR_EDIFF_SOBEL_TH_reg, di_rtnr_ediff_sobel_th_reg.regValue);
	IoReg_Write32(DI_IM_DI_FILM_MOTION_SUM_TH_reg, di_im_di_film_motion_sum_th_reg.regValue);
//	IoReg_Write32(DI_IM_DI_SI_FILM_FINAL_RESULT_reg, di_im_di_si_film_final_result_reg.regValue);
	IoReg_Write32(OD_OD_CTRL_reg, od_ctrl_reg.regValue);
	IoReg_Write32(DI_IM_DI_RTNR_HMCNR_STATISTIC_6_reg, di_im_di_rtnr_hmcnr_statistic_6_reg.regValue);
	IoReg_Write32(DI_IM_DI_RTNR_REFINED_CTRL2_reg, di_im_di_rtnr_refined_ctrl2_reg.regValue);
	IoReg_Write32(DI_DI_SMD_dummy_reg, di_di_smd_dummy_reg.regValue);
#endif
...
char drvif_color_Get_MCNR_HV_PAN_MV(unsigned char *MV_h, unsigned char *MV_v)
{
	...
	if ((MV_h == NULL) || (MV_v == NULL)) {
		rtd_pr_vpq_emerg("drvif_color_Get_MCNR_HV_PAN_MV NULL point!!\n");
		return -1;
	}
