		...
		if(curr_addr){
...
#endif
			{
				return (*(volatile unsigned int *)GET_MAPPED_RBUS_ADDR(addr));
					...
					bForcebg = (((*(volatile unsigned int *)GET_MAPPED_RBUS_ADDR(0xb8028300))&0x00000002)>>1);
...
void IoReg_Write32 (unsigned int addr, unsigned int value) {
	...
	if(Get_dump_function()
		...
		dump_register_info.vgip_line_cnt=(((*(volatile unsigned int *)GET_MAPPED_RBUS_ADDR(0xb8022234))&0x7FFF0000)>>16);
...
void register_dump_data_to_file(void)
{
	if(read_flag)
	{
		...
		if((rd_ptr->registeraddr != 0xb802508c)|| (rd_ptr->value != dumpreg_last_value)){
			if(rd_ptr->rw_flag == 2){
				if((rd_ptr->registeraddr == pre_reg_addr) && (rd_ptr->value == pre_reg_val) && (rd_ptr->rw_flag) == pre_reg_rw_flag){
					...
					rd_ptr->vgip_line_cnt=(((*(volatile unsigned int *)GET_MAPPED_RBUS_ADDR(0xb8022234))&0x7FFF0000)>>16);
					rd_ptr->uzudtg_line_cnt=(((*(volatile unsigned int *)GET_MAPPED_RBUS_ADDR(0xb8028258))&0x1FFF0000)>>16);
					rd_ptr->memcdtg_line_cnt=((*(volatile unsigned int *)GET_MAPPED_RBUS_ADDR(0xb8028258))&0x1FFF);
					snprintf(tmp_buf, buf_size, "[DUMP.S] [0x%08x] scnt=0x%08x,vline_cnt=0x%08x,uline_cnt=0x%08x,mline_cnt=0x%08x,addr=0x%08x,val=0x%08x,rw=0x%x, iteration=0x%x\n",
				...
				pre_reg_vgip_line_cnt = (((*(volatile unsigned int *)GET_MAPPED_RBUS_ADDR(0xb8022234))&0x7FFF0000)>>16);
	        ...
	        if(rd_ptr->registeraddr == 0xb802508c)
...
void register_dump_data_to_buffer(DUMP_REGISTER_INFO dump_register_info)
{
	...
	// timing monitor init 
	wrt_pnt1_reg_val = (*(volatile unsigned int *)GET_MAPPED_RBUS_ADDR(0xb8005680)); 
	wrt_pnt1_reg_val &= 0xFFFF00FF;
	wrt_pnt1_reg_val |= 0x0000f300;  //B[15:8]
	(*(volatile unsigned int *)GET_MAPPED_RBUS_ADDR(0xb8005680) = wrt_pnt1_reg_val);
	regValue5680 = (*(volatile unsigned int *)GET_MAPPED_RBUS_ADDR(0xb8005680)); 
	regValue5680 &= 0x6FFFFFFF;
	regValue5680 |= 0x90000000; //B[28] & [31]
	(*(volatile unsigned int *)GET_MAPPED_RBUS_ADDR(0xb8005680) = regValue5680);

#if 1 // dump log directory
    if((dump_register_info.registeraddr != 0xb802508c)|| (dump_register_info.value != dumpreg_last_value)){
		if(dump_register_info.rw_flag == 2){
			if((dump_register_info.registeraddr == pre_reg_addr) && (dump_register_info.value == pre_reg_val) && (dump_register_info.rw_flag) == pre_reg_rw_flag){
				...
				dump_register_info.pts = ((*(volatile unsigned int *)GET_MAPPED_RBUS_ADDR(TIMER_VCPU_CLK90K_LO_reg)));
				dump_register_info.vo_line_cnt = (((*(volatile unsigned int *)GET_MAPPED_RBUS_ADDR(0xB80050F4))&0x00000FFF)); 
				dump_register_info.vgip_line_cnt=(((*(volatile unsigned int *)GET_MAPPED_RBUS_ADDR(0xb8022234))&0x7FFF0000)>>16);
				dump_register_info.uzudtg_line_cnt=(((*(volatile unsigned int *)GET_MAPPED_RBUS_ADDR(0xb8028258))&0x1FFF0000)>>16);
				dump_register_info.memcdtg_line_cnt=((*(volatile unsigned int *)GET_MAPPED_RBUS_ADDR(0xb8028258))&0x1FFF);
				dump_register_info.timing_monitor = ((*(volatile unsigned int *)GET_MAPPED_RBUS_ADDR(0xb8005690))&0xFFFFFFFF);
				#ifdef CONFIG_DUMP_REGISTER_WHEN_ONLY_DISCONNECT
				rtd_pr_ioreg_info("[DUMP.S] [0x%08x] scnt=%4d,LCVO=%4d,LCV=%4d,LCU=0x%4d,LCM=%4d,MomSize=%8d,addr=0x%08x,val=0x%08x,rw=%d, rpt=%d\n",
			...
			pre_reg_vo_line_cnt = (((*(volatile unsigned int *)GET_MAPPED_RBUS_ADDR(0xB80050F4))&0x00000FFF)); 
			pre_reg_vgip_line_cnt = (((*(volatile unsigned int *)GET_MAPPED_RBUS_ADDR(0xb8022234))&0x7FFF0000)>>16);
			pre_reg_uzudtg_line_cnt = (((*(volatile unsigned int *)GET_MAPPED_RBUS_ADDR(0xb8028258))&0x1FFF0000)>>16);
			pre_reg_memcdtg_line_cnt = ((*(volatile unsigned int *)GET_MAPPED_RBUS_ADDR(0xb8028258))&0x1FFF);
			pre_timing_monitor = ((*(volatile unsigned int *)GET_MAPPED_RBUS_ADDR(0xb8005690))&0xFFFFFFFF);
