...
#define AV_OFFSETX_NTSC_NEW        		(4)
#define AV_OFFSETY_NTSC_NEW        		(0)
#define AV_OFFSETX_PAL_M_NEW       		(4)
#define AV_OFFSETY_PAL_M_NEW       		(0)
#define AV_OFFSETX_NTSC_50_NEW     		(4)
#define AV_OFFSETY_NTSC_50_NEW     		(4)
#define AV_OFFSETX_PAL_N_NEW       		(6)
#define AV_OFFSETY_PAL_N_NEW       		(4)
#define AV_OFFSETX_NTSC_443_NEW    		(4)
#define AV_OFFSETY_NTSC_443_NEW    		(0)
#define AV_OFFSETX_PAL_60_NEW      		(4)
#define AV_OFFSETY_PAL_60_NEW      		(0)
#define AV_OFFSETX_PAL_I_NEW       		(4)
#define AV_OFFSETY_PAL_I_NEW       		(4)
#define AV_OFFSETX_SECAM_NEW       		(-3)
#define AV_OFFSETY_SECAM_NEW       		(4)

#define AV_CKILL_OFFSETX_NTSC_NEW      	(5)
#define AV_CKILL_OFFSETY_NTSC_NEW      	(0)
#define AV_CKILL_OFFSETX_PAL_M_NEW     	(5)
#define AV_CKILL_OFFSETY_PAL_M_NEW     	(0)
#define AV_CKILL_OFFSETX_NTSC_50_NEW   	(5)
#define AV_CKILL_OFFSETY_NTSC_50_NEW   	(4)
#define AV_CKILL_OFFSETX_PAL_N_NEW     	(5)
#define AV_CKILL_OFFSETY_PAL_N_NEW     	(4)
#define AV_CKILL_OFFSETX_NTSC_443_NEW  	(5)
#define AV_CKILL_OFFSETY_NTSC_443_NEW  	(0)
#define AV_CKILL_OFFSETX_PAL_60_NEW    	(5)
#define AV_CKILL_OFFSETY_PAL_60_NEW    	(0)
#define AV_CKILL_OFFSETX_PAL_I_NEW     	(5)
#define AV_CKILL_OFFSETY_PAL_I_NEW     	(4)//30(force align)
#define AV_CKILL_OFFSETX_SECAM_NEW     	(-30)
#define AV_CKILL_OFFSETY_SECAM_NEW     	(5)//31(force align)
#endif//#ifdef AV_HSYNC_PULSE_START_REFINE

#define AV_OFFSETX_NTSC        		(18)
#define AV_OFFSETY_NTSC        		(0)
#define AV_OFFSETX_PAL_M       		(18)
#define AV_OFFSETY_PAL_M       		(0)
#define AV_OFFSETX_NTSC_50     		(18)
#define AV_OFFSETY_NTSC_50     		(4)
#define AV_OFFSETX_PAL_N       		(22)
#define AV_OFFSETY_PAL_N       		(4)
#define AV_OFFSETX_NTSC_443    		(18)
#define AV_OFFSETY_NTSC_443    		(0)
#define AV_OFFSETX_PAL_60      		(18)
#define AV_OFFSETY_PAL_60      		(0)
#define AV_OFFSETX_PAL_I       		(18)
#define AV_OFFSETY_PAL_I       		(4)
#define AV_OFFSETX_SECAM       		(-30)
#define AV_OFFSETY_SECAM       		(5)

#define AV_CKILL_OFFSETX_NTSC      	(18)
#define AV_CKILL_OFFSETY_NTSC      	(0)
#define AV_CKILL_OFFSETX_PAL_M     	(18)
#define AV_CKILL_OFFSETY_PAL_M     	(0)
#define AV_CKILL_OFFSETX_NTSC_50   	(18)
#define AV_CKILL_OFFSETY_NTSC_50   	(4)
#define AV_CKILL_OFFSETX_PAL_N     	(18)
#define AV_CKILL_OFFSETY_PAL_N     	(4)
#define AV_CKILL_OFFSETX_NTSC_443  	(18)
#define AV_CKILL_OFFSETY_NTSC_443  	(0)
#define AV_CKILL_OFFSETX_PAL_60    	(18)
#define AV_CKILL_OFFSETY_PAL_60    	(0)
#define AV_CKILL_OFFSETX_PAL_I     	(18)
#define AV_CKILL_OFFSETY_PAL_I     	(4)//30(force align)
#define AV_CKILL_OFFSETX_SECAM     	(-30)
#define AV_CKILL_OFFSETY_SECAM     	(5)//31(force align)
...
#define ATV_OFFSETX_NTSC        	(17)
#define ATV_OFFSETY_NTSC        	(2)
#define ATV_OFFSETX_PAL_M       	(3)
#define ATV_OFFSETY_PAL_M       	(0)
#define ATV_OFFSETX_NTSC_50     	(0)
#define ATV_OFFSETY_NTSC_50     	(0)
#define ATV_OFFSETX_PAL_N       	(14)
#define ATV_OFFSETY_PAL_N       	(4)
#define ATV_OFFSETX_NTSC_443    	(-21)
#define ATV_OFFSETY_NTSC_443    	(1)
#define ATV_OFFSETX_PAL_60      	(-15)
#define ATV_OFFSETY_PAL_60      	(0)
#define ATV_OFFSETX_PAL_I       	(0)
#define ATV_OFFSETY_PAL_I       	(5)
#define ATV_OFFSETX_SECAM       	(-77)
#define ATV_OFFSETY_SECAM       	(3)

#ifdef AVD_CKill_table
#define ATV_CKILL_OFFSETX_NTSC      (6)
#define ATV_CKILL_OFFSETY_NTSC      (2)
#define ATV_CKILL_OFFSETX_PAL_M     (3)
#define ATV_CKILL_OFFSETY_PAL_M     (0)
#define ATV_CKILL_OFFSETX_NTSC_50   (0)
#define ATV_CKILL_OFFSETY_NTSC_50   (0)
#define ATV_CKILL_OFFSETX_PAL_N     (14)
#define ATV_CKILL_OFFSETY_PAL_N     (4)
#define ATV_CKILL_OFFSETX_NTSC_443  (-21)
#define ATV_CKILL_OFFSETY_NTSC_443  (1)
#define ATV_CKILL_OFFSETX_PAL_60    (-15)
#define ATV_CKILL_OFFSETY_PAL_60    (0)
#define ATV_CKILL_OFFSETX_PAL_I     (-9)
#define ATV_CKILL_OFFSETY_PAL_I     (5)
#define ATV_CKILL_OFFSETX_SECAM     (-77)
#define ATV_CKILL_OFFSETY_SECAM     (3)
#endif

#define EXTD_ATV_OFFSETX_NTSC        	(18)
#define EXTD_ATV_OFFSETY_NTSC        	(0)
#define EXTD_ATV_OFFSETX_PAL_M       	(18)
#define EXTD_ATV_OFFSETY_PAL_M       	(0)
#define EXTD_ATV_OFFSETX_NTSC_50     	(18)
#define EXTD_ATV_OFFSETY_NTSC_50     	(0)
#define EXTD_ATV_OFFSETX_PAL_N       	(18)
#define EXTD_ATV_OFFSETY_PAL_N       	(4)
#define EXTD_ATV_OFFSETX_NTSC_443    	(18)
#define EXTD_ATV_OFFSETY_NTSC_443    	(-1)
#define EXTD_ATV_OFFSETX_PAL_60      	(18)
#define EXTD_ATV_OFFSETY_PAL_60      	(0)
#define EXTD_ATV_OFFSETX_PAL_I       	(18)
#define EXTD_ATV_OFFSETY_PAL_I       	(5)
#define EXTD_ATV_OFFSETX_SECAM       	(-27)
#define EXTD_ATV_OFFSETY_SECAM       	(6)

#ifdef AVD_CKill_table
#define EXTD_ATV_CKILL_OFFSETX_NTSC        	(2)
#define EXTD_ATV_CKILL_OFFSETY_NTSC        	(0)
#define EXTD_ATV_CKILL_OFFSETX_PAL_M       	(3)
#define EXTD_ATV_CKILL_OFFSETY_PAL_M       	(0)
#define EXTD_ATV_CKILL_OFFSETX_NTSC_50     	(0)
#define EXTD_ATV_CKILL_OFFSETY_NTSC_50     	(0)
#define EXTD_ATV_CKILL_OFFSETX_PAL_N       	(13)
#define EXTD_ATV_CKILL_OFFSETY_PAL_N       	(2)
#define EXTD_ATV_CKILL_OFFSETX_NTSC_443    	(-24)
#define EXTD_ATV_CKILL_OFFSETY_NTSC_443    	(-1)
#define EXTD_ATV_CKILL_OFFSETX_PAL_60      	(-15)
#define EXTD_ATV_CKILL_OFFSETY_PAL_60      	(0)
#define EXTD_ATV_CKILL_OFFSETX_PAL_I       	(-6)
#define EXTD_ATV_CKILL_OFFSETY_PAL_I       	(5)
#define EXTD_ATV_CKILL_OFFSETX_SECAM       	(-36)
#define EXTD_ATV_CKILL_OFFSETY_SECAM       	(4)
#endif

#ifdef AV_HSYNC_PULSE_START_REFINE
static INT8 g_av_offset_array_new[][2] = {
	{ AV_OFFSETX_NTSC_NEW, 		AV_OFFSETY_NTSC_NEW},
	{ AV_OFFSETX_PAL_M_NEW, 	AV_OFFSETY_PAL_M_NEW},
	{ AV_OFFSETX_NTSC_50_NEW, 	AV_OFFSETY_NTSC_50_NEW},
	{ AV_OFFSETX_PAL_N_NEW,		AV_OFFSETY_PAL_N_NEW},
	{ AV_OFFSETX_NTSC_443_NEW, 	AV_OFFSETY_NTSC_443_NEW},
	{ AV_OFFSETX_PAL_60_NEW, 	AV_OFFSETY_PAL_60_NEW},
	{ AV_OFFSETX_PAL_I_NEW, 	AV_OFFSETY_PAL_I_NEW},
	{ AV_OFFSETX_SECAM_NEW, 	AV_OFFSETY_SECAM_NEW}
};

static INT8 g_av_ckill_offset_array_new[][2] = {
	{ AV_CKILL_OFFSETX_NTSC_NEW, 		AV_CKILL_OFFSETY_NTSC_NEW},
	{ AV_CKILL_OFFSETX_PAL_M_NEW, 		AV_CKILL_OFFSETY_PAL_M_NEW},
	{ AV_CKILL_OFFSETX_NTSC_50_NEW, 	AV_CKILL_OFFSETY_NTSC_50_NEW},
	{ AV_CKILL_OFFSETX_PAL_N_NEW,		AV_CKILL_OFFSETY_PAL_N_NEW},
	{ AV_CKILL_OFFSETX_NTSC_443_NEW, 	AV_CKILL_OFFSETY_NTSC_443_NEW},
	{ AV_CKILL_OFFSETX_PAL_60_NEW, 		AV_CKILL_OFFSETY_PAL_60_NEW},
	{ AV_CKILL_OFFSETX_PAL_I_NEW, 		AV_CKILL_OFFSETY_PAL_I_NEW},
	{ AV_CKILL_OFFSETX_SECAM_NEW, 		AV_CKILL_OFFSETY_SECAM_NEW}
};
#endif//#ifdef AV_HSYNC_PULSE_START_REFINE
...
#ifdef AV_HSYNC_PULSE_START_REFINE//for CVBS
static UINT16 g_tAV_PRESET_TABLE_NEW[][9] =
{
	// VIDEO-60(NTSC)
	{
		858,				//IH_TOTAL
...
#endif//#ifdef AV_HSYNC_PULSE_START_REFINE//for CVBS
...
#ifdef AV_HSYNC_PULSE_START_REFINE
static unsigned short *tAV_PRESET_TABLE_NEW = &g_tAV_PRESET_TABLE_NEW[0][0];
#endif
...
#ifdef AV_HSYNC_PULSE_START_REFINE
static char *av_offset_array_new = &g_av_offset_array_new[0][0];
static char *av_ckill_offset_array_new = &g_av_ckill_offset_array_new[0][0];
#endif
...
//		Scaler_DispSetInputInfoByDisp((SCALER_DISP_CHANNEL)display,SLR_INPUT_IPH_ACT_STA_PRE,(*(tAV_PRESET_TABLE+modecnt*AV_PRESET_TABLE_COL_MAX+1)/2)*2+av_offset_array[vd_mode][0]);
	...
	if(_ENABLE == Scaler_Get_Zoom_In_Out_Enable())
	{
		...
		{
			//		rtd_pr_avd_debug("zoom in overscan tv & av source  PRE_V_LEN -8 , PRE_V_STA + 4\n");
		...
		{
			//	rtd_pr_avd_debug("zoom in overscan tv & av source  PRE_V_LEN -12 , PRE_V_STA + 6\n");
...
//	unsigned char vd_mode = 0;
	...
	bool ck_1 = !vdc_ChromaLockStatus;
		...
		if (a_ucSrc == _SRC_CVBS) {
			if(ckill_on) {
				...
				if(get_ic_version() == VERSION_A){
					vgip_offset_h = *(av_ckill_offset_array_new + vd_mode*AV_OFFSET_LEN);
					vgip_offset_v = *(av_ckill_offset_array_new + vd_mode*AV_OFFSET_LEN + 1);

					rtd_pr_avd_info("DEBUG AV ckill (%d) : modecnt %d, vd_mode %d, offset_h %d, offset_v %d\n",__LINE__, modecnt, vd_mode, vgip_offset_h, vgip_offset_v);
					a_ptDispInfo->IPH_ACT_STA_PRE = (unsigned short)((int)((*(tAV_PRESET_TABLE_NEW+modecnt*AV_PRESET_TABLE_COL_MAX+1)/2)*2)+(int)vgip_offset_h);
					a_ptDispInfo->IPV_ACT_STA_PRE = (unsigned short)((int)(*(tAV_PRESET_TABLE_NEW+modecnt*AV_PRESET_TABLE_COL_MAX+3))+(int)vgip_offset_v);
				}else
#endif
				{
...
#ifdef AV_HSYNC_PULSE_START_REFINE
				if(get_ic_version() == VERSION_A){
					vgip_offset_h = *(av_offset_array_new + vd_mode*AV_OFFSET_LEN);
					vgip_offset_v = *(av_offset_array_new + vd_mode*AV_OFFSET_LEN + 1);

					rtd_pr_avd_info("DEBUG AV (%d) : modecnt %d, vd_mode %d, offset_h %d, offset_v %d\n",__LINE__, modecnt, vd_mode, vgip_offset_h, vgip_offset_v);
					a_ptDispInfo->IPH_ACT_STA_PRE = (unsigned short)((int)((*(tAV_PRESET_TABLE_NEW+modecnt*AV_PRESET_TABLE_COL_MAX+1)/2)*2)+(int)vgip_offset_h);
					a_ptDispInfo->IPV_ACT_STA_PRE = (unsigned short)((int)(*(tAV_PRESET_TABLE_NEW+modecnt*AV_PRESET_TABLE_COL_MAX+3))+(int)vgip_offset_v);
				}else
#endif
			...
			if (KADP_AVD_EXTERNAL_DEMOD == Scaler_AVD_GetDemodType()) {
				...
				if(ckill_on) {
					...
					rtd_pr_avd_info("DEBUG EXT ATV ckill : modecnt %d, vd_mode %d, offset_h %d, offset_v %d\n", modecnt, vd_mode, vgip_offset_h, vgip_offset_v);
					a_ptDispInfo->IPH_ACT_STA_PRE = (unsigned short)((int)((*(tAV_PRESET_TABLE+modecnt*AV_PRESET_TABLE_COL_MAX+1)/2)*2)+(int)vgip_offset_h);
					a_ptDispInfo->IPV_ACT_STA_PRE = (unsigned short)((int)(*(tAV_PRESET_TABLE+modecnt*AV_PRESET_TABLE_COL_MAX+3))+(int)vgip_offset_v);
				} else
#endif
				{
					...
					rtd_pr_avd_info("DEBUG EXT ATV: modecnt %d, vd_mode %d, offset_h %d, offset_v %d\n", modecnt, vd_mode, vgip_offset_h, vgip_offset_v);
					a_ptDispInfo->IPH_ACT_STA_PRE = (unsigned short)((int)((*(tAV_PRESET_TABLE+modecnt*AV_PRESET_TABLE_COL_MAX+1)/2)*2)+(int)vgip_offset_h);
					a_ptDispInfo->IPV_ACT_STA_PRE = (unsigned short)((int)(*(tAV_PRESET_TABLE+modecnt*AV_PRESET_TABLE_COL_MAX+3))+(int)vgip_offset_v);
				}
			} else {
				...
				if(ckill_on) {
					...
					rtd_pr_avd_info("DEBUG ATV ckill : modecnt %d, vd_mode %d, offset_h %d, offset_v %d\n", modecnt, vd_mode, vgip_offset_h, vgip_offset_v);
					a_ptDispInfo->IPH_ACT_STA_PRE = (unsigned short)((int)((*(tAV_PRESET_TABLE+modecnt*AV_PRESET_TABLE_COL_MAX+1)/2)*2)+(int)vgip_offset_h);
					a_ptDispInfo->IPV_ACT_STA_PRE = (unsigned short)((int)(*(tAV_PRESET_TABLE+modecnt*AV_PRESET_TABLE_COL_MAX+3))+(int)vgip_offset_v);
				} else
#endif
				{
					...
					rtd_pr_avd_info("DEBUG ATV: modecnt %d, vd_mode %d, offset_h %d, offset_v %d\n", modecnt, vd_mode, vgip_offset_h, vgip_offset_v);
					a_ptDispInfo->IPH_ACT_STA_PRE = (unsigned short)((int)((*(tAV_PRESET_TABLE+modecnt*AV_PRESET_TABLE_COL_MAX+1)/2)*2)+(int)vgip_offset_h);
					a_ptDispInfo->IPV_ACT_STA_PRE = (unsigned short)((int)(*(tAV_PRESET_TABLE+modecnt*AV_PRESET_TABLE_COL_MAX+3))+(int)vgip_offset_v);
				}
			}
...
#ifdef AV_HSYNC_PULSE_START_REFINE
		if((get_ic_version() == VERSION_A)&&(a_ucSrc == _SRC_CVBS)){
			a_ptDispInfo->IHTotal = *(tAV_PRESET_TABLE_NEW+modecnt*AV_PRESET_TABLE_COL_MAX);
			a_ptDispInfo->IPH_ACT_WID_PRE = *(tAV_PRESET_TABLE_NEW+modecnt*AV_PRESET_TABLE_COL_MAX+2);
			a_ptDispInfo->IPV_ACT_LEN_PRE = *(tAV_PRESET_TABLE_NEW+modecnt*AV_PRESET_TABLE_COL_MAX+4);
		}else
#endif
		{
	...
	//rtd_pr_avd_debug("drvif_inprocvideo_config_capture, IPH_ACT_STA_PRE=%d\n", a_ptDispInfo->IPH_ACT_STA_PRE);

#ifdef CONFIG_ENABLE_VD_27MHZ_MODE
	//rtd_pr_avd_debug("Scaler_Get_VDC_27MHz_Mode_Enable=%d, a_ucSrc=%d\n", Scaler_Get_VDC_27MHz_Mode_Enable(), a_ucSrc);
	//if(VD_27M_OFF != fw_video_get_27mhz_mode((SCALER_DISP_CHANNEL)display))
	if (TRUE == Scaler_Get_VDC_27MHz_Mode_Enable() && (a_ucSrc == _SRC_CVBS || a_ucSrc == _SRC_TV))
	{
		...
		rtd_pr_avd_info("#####[%s(%d)]a_ptDispInfo->IPH_ACT_STA_PRE=0x%x\n",__func__,__LINE__,a_ptDispInfo->IPH_ACT_STA_PRE);
	}
#endif //#ifdef CONFIG_ENABLE_VD_27MHZ_MODE
...
unsigned char drvif_inprocvideo_setup(unsigned char a_ucSrc, StructDisplayInfo* a_ptDispInfo, ModeInformationType* a_ptTimingInfo)
{
	...
	rtd_pr_avd_debug("drvif_inprocvideo_setup\n");

	rtd_pr_avd_debug("ucVideoMode=%x\n", ucVideoMode);
...
//	vdc_mode_detect = ucVideoMode & 0xf;
	...
	if( (ucVideoMode == ZNTSC) ||
			...
			(ucVideoMode  ==  ZPAL_M))
	{
		rtd_pr_avd_debug( "480i\n");
		// 480i NTSC
		a_ptDispInfo->ucMode_Curr = _MODE_480I;
	}
	else
	{
		rtd_pr_avd_debug( "576i\n");
		// 576i PAL
	...
	if(drvif_mode_offlinemeasure(_OFFLINE_MS_SRC_VDC, ANALOG_MODE_MEASUREMENT, a_ptDispInfo, a_ptTimingInfo) == _MODE_SUCCESS)
	{
		...
		rtd_pr_avd_debug("VDC CHalfTotal=%d\n", VHalfTotal);

		rtd_pr_avd_debug("drvif_mode_offlinemeasure success\n");
	...
	{
		up(get_offline_semaphore());
		rtd_pr_avd_debug("drvif_mode_offlinemeasure fail\n");
		ucRet = FALSE;
	}
#endif
	return ucRet;
...
unsigned char drvif_inprocvideo_setup_NoSignal(unsigned char a_ucSrc, StructDisplayInfo* a_ptDispInfo, ModeInformationType* a_ptTimingInfo, unsigned char a_ucColorStd)
{
	...
	rtd_pr_avd_info("drvif_inprocvideo_setup_NoSignal\n");

	rtd_pr_avd_info("ucVideoMode=%x\n", ucVideoMode);
...
//	vdc_mode_detect = ucVideoMode & 0xf;
	...
	rtd_pr_avd_info("usVFreq=%d\n", usVFreq);

	// Check 20 times
	for (i = 0; i < VDC_RE_MEASURE_COUNTER; i++)
	{
		if(Scaler_AVD_GetIsChannelChange()){
			rtd_pr_avd_info("[%s](%d)IsChannelChange=%d\n",__FUNCTION__,__LINE__, Scaler_AVD_GetIsChannelChange());
			ucRet = FALSE;
			return ucRet;
		}
		if  (_MODE_480I == a_ptDispInfo->ucMode_Curr)
		{
			...
			else
			{
				...
				if(drvif_mode_offlinemeasure(_OFFLINE_MS_SRC_VDC, ANALOG_MODE_MEASUREMENT, a_ptDispInfo, a_ptTimingInfo) == _MODE_SUCCESS)
				{
					...
					rtd_pr_avd_debug("480i check count=%d, usVFreq=%d\n", i, usVFreq);
				}
				else
				{
					ucRet = FALSE;

					rtd_pr_avd_debug("480i  drvif_mode_offlinemeasure fail\n");
				}
		...
		else
		{
			...
			else
			{
				...
				if(drvif_mode_offlinemeasure(_OFFLINE_MS_SRC_VDC, ANALOG_MODE_MEASUREMENT, a_ptDispInfo, a_ptTimingInfo) == _MODE_SUCCESS)
				{
					...
					rtd_pr_avd_debug("576i check count=%d, usVFreq=%d\n", i, usVFreq);
				}
				else
				{
					ucRet = FALSE;

					rtd_pr_avd_debug("576i drvif_mode_offlinemeasure fail\n");
				}
	...
	if (TRUE == ucRet)
	{
		...
		a_ptDispInfo->color_depth = 1;//I3DDMA_COLOR_DEPTH_10B
...
void drvif_inprocvideo_offline_measure_check(SCALER_DISP_CHANNEL Display)
{
	...
	{
		rtd_pr_avd_debug("drvif_inprocvideo_offline_measure_check, HV no Lock\n");
		...
		if (counter >20)
		{
			if(_MODE_480I == CureentMode)
			{
				...
				rtd_pr_avd_debug("VDC offline measure %d times error, force Vfreq as 60Hz\n", VDC_RE_MEASURE_COUNTER);
			}
			else
			{
				Scaler_ModeSetModeInfo(SLR_MODE_IVFREQ, 500);
				rtd_pr_avd_debug("VDC offline measure %d times error, force Vfreq as 50Hz\n", VDC_RE_MEASURE_COUNTER);
			}
	...
	rtd_pr_avd_debug("CureentMode=%d, VdcMode=%d, SLR_MODE_IVFREQ=%d\n", CureentMode, VdcMode, Scaler_ModeGetModeInfo(SLR_MODE_IVFREQ));
	...
	case VDC_MODE_PALM:
		if(_MODE_480I == CureentMode)
		{
			...
			{
				rtd_pr_avd_debug("VDC Error Case1 : SLR_MODE_IVFREQ : %x, too small!\n", Scaler_ModeGetModeInfo(SLR_MODE_IVFREQ));
			}
			else
			{
				return;
		...
		{
			rtd_pr_avd_debug("VDC Error Case2 : CureentMode : %x, VdcMode : %x, is differ\n", CureentMode, VdcMode);
			return;
		}
		break;
	...
	default:
		if(_MODE_480I == CureentMode)
		{
			rtd_pr_avd_debug("VDC Error Case3 : CureentMode : %x, VdcMode : %x, is differ\n", CureentMode, VdcMode);
			return;
		}
		else// if(_MODE_576I == CureentMode)
		{
			...
			{
				rtd_pr_avd_debug("VDC Error Case4 : SLR_MODE_IVFREQ : %x, too large!\n", Scaler_ModeGetModeInfo(SLR_MODE_IVFREQ));
			}
			else
			{
				return;
	...
	while(counter--)
	{
		...
		{
			rtd_pr_avd_debug("VDC offline measure error : %x!", counter);
			continue;
		}
		*/
...
unsigned char drvif_inprocvideo_setup_ex(unsigned char a_ucSrc, StructDisplayInfo* a_ptDispInfo, ModeInformationType* a_ptTimingInfo, unsigned char ucVideoMode)
{
	...
	rtd_pr_avd_debug("drvif_inprocvideo_setup, ucVideoMode=%x\n", ucVideoMode);
...
extern unsigned short g_usIsVtotalNoGood;
extern unsigned short g_usCurVHaldTotal;
...
unsigned char drvif_inprocvideo_setup_NotMeasure(unsigned char a_ucSrc, StructDisplayInfo* a_ptDispInfo, ModeInformationType* a_ptTimingInfo, unsigned char ucModeCur, unsigned char supportColor)
{
...
#ifdef CONFIG_AVD_FHFV_BIAS
	unsigned short usVHalfTotal = 0;
	unsigned short usVLineOut = 0;
	unsigned int ulTimeout = 0;
#endif

	rtd_pr_avd_info("#####[%s(%d)] ucVideoMode=%x\n", __func__, __LINE__, ucVideoMode);
	...
	if( (ucVideoMode == ZNTSC) ||
			...
			(ucVideoMode	==	ZPAL_M))
	{
		rtd_pr_avd_info("[%s(line:%d)]480i\n", __FUNCTION__, __LINE__);
		// 480i NTSC
		a_ptDispInfo->ucMode_Curr = _MODE_480I;
	}
	else
	{
		rtd_pr_avd_info("[%s(line:%d)]576i\n", __FUNCTION__, __LINE__);
		// 576i PAL
		a_ptDispInfo->ucMode_Curr = _MODE_576I;
	}
#endif
	...
	// if(drvif_mode_offlinemeasure(_OFFLINE_MS_SRC_VDC, ANALOG_MODE_MEASUREMENT, a_ptDispInfo, a_ptTimingInfo) == _MODE_SUCCESS)
	{
		up(get_offline_semaphore());
#ifdef CONFIG_AVD_FHFV_BIAS
			if (g_usIsVtotalNoGood && g_ucSrcType == _SRC_TV)
			{
				do
				{
					drvif_module_vdc_GetVHalfTotalLen(&usVHalfTotal);
					usVLineOut = drvif_module_vdc_Read_Vline_out();
					if (0==ulTimeout) {
						rtd_pr_avd_emerg("#####[FHFV]** usVHalfTotal*2=%d, usVLineOut=%d, vstate=%d\n", usVHalfTotal*2, usVLineOut, drvif_module_vdc_Read_Vstate());
					}
					...
					if (ABS(usVLineOut, usVHalfTotal*2 ) <=2 && (usVLineOut!=526 && usVLineOut!=524 && usVLineOut!=624 && usVLineOut!=626) && ulTimeout<20) {
						if(19==ulTimeout){
							rtd_pr_avd_emerg("#####[FHFV]!! usVHalfTotal*2=%d, usVLineOut=%d, ulTimeout=%d, vstate=%d\n", usVHalfTotal*2, usVLineOut, ulTimeout, drvif_module_vdc_Read_Vstate());
						}
						usVLineOut=0; // vtotal non-standard, keep to check more long time
					}
					if(ulTimeout<10)
						usVLineOut=0; // vtotal non-standard, keep to check more long time

					msleep(1);
				}while(usVHalfTotal == 0 || ABS(usVLineOut, usVHalfTotal*2 ) > 2);
				g_usIsVtotalNoGood = 0;
				rtd_pr_avd_emerg("#####[FHFV]&& usVHalfTotal*2=%d, usVLineOut=%d, ulTimeout=%d, vstate=%d\n", usVHalfTotal*2, usVLineOut, ulTimeout, drvif_module_vdc_Read_Vstate());
			}
#endif
		if (_MODE_480I == a_ptDispInfo->ucMode_Curr)
		{
			//ucVideoMode = ZNTSC;
			a_ptDispInfo->IPH_ACT_WID=704;
			a_ptDispInfo->IPV_ACT_LEN=480;
			a_ptDispInfo->Polarity = a_ptTimingInfo->Polarity = 0;
#ifdef CONFIG_AVD_FHFV_BIAS
			// oliver+, 20170124
			if (0 != usVHalfTotal && (g_ucSrcType == _SRC_TV) && usVHalfTotal <= 313)
			{
				a_ptTimingInfo->IVTotal = a_ptTimingInfo->IVCount = usVHalfTotal;//262;
				a_ptDispInfo->IVTotal = a_ptTimingInfo->IVTotal = usVHalfTotal; //262;
				rtd_pr_avd_emerg("#####[FHFV]NTSC a_ptTimingInfo->IVTotal:%d,a_ptDispInfo->IVTotal=%d\n",a_ptTimingInfo->IVTotal,a_ptDispInfo->IVTotal);
			}
			else
#endif
			{
...
#ifdef CONFIG_AVD_FHFV_BIAS
			if (0 != usVHalfTotal && g_ucSrcType == _SRC_TV)
			{
				a_ptDispInfo->IPV_ACT_LEN_PRE = a_ptDispInfo->IVTotal - 22;
				if (usVHalfTotal > 22)
					g_usCurVHaldTotal = usVHalfTotal;
			}
			else
			{
				g_usCurVHaldTotal =  a_ptDispInfo->IVTotal;
			}

			rtd_pr_avd_info("#####[FHFV][%s(%d)] NTSC IVTotal:%d,IPV_ACT_LEN_PRE=%d,g_usCurVHaldTotal:%d\n",__func__,__LINE__,a_ptDispInfo->IVTotal, a_ptDispInfo->IPV_ACT_LEN_PRE,g_usCurVHaldTotal);
#endif
			Scaler_SetDispStatusFromSource(a_ptDispInfo, SLR_DISP_INTERLACE,TRUE);
			Scaler_SetDispStatusFromSource(a_ptDispInfo, SLR_DISP_422,FALSE);
			Scaler_SetDispStatusFromSource(a_ptDispInfo, SLR_DISP_10BIT,TRUE);
			...
			drvif_module_vdc_GetVHalfTotalLen(&VHalfTotal);
			rtd_pr_avd_info("VDC CHalfTotal=%d\n", VHalfTotal);
		...
		else
		{
		   	//ucVideoMode = ZPAL_I;
		   	a_ptDispInfo->IPH_ACT_WID=704;
			a_ptDispInfo->IPV_ACT_LEN=576;
			a_ptTimingInfo->Polarity = 0;
#ifdef CONFIG_AVD_FHFV_BIAS
			// oliver+, 20170124
			if (0 != usVHalfTotal  && (g_ucSrcType == _SRC_TV) && usVHalfTotal <= 313)
			{
				a_ptTimingInfo->IVTotal = a_ptTimingInfo->IVCount = usVHalfTotal;//302;
				a_ptDispInfo->IVTotal = a_ptTimingInfo->IVTotal = usVHalfTotal; //302;
			}
			else
			{
				a_ptTimingInfo->IVTotal = a_ptTimingInfo->IVCount = 313;
				a_ptDispInfo->IVTotal = a_ptTimingInfo->IVTotal = 313;
			}
			rtd_pr_avd_info("#####[FHFV][%s(%d)] a_ptTimingInfo->IVTotal=%d, usVHalfTotal=%d\n", __func__, __LINE__,a_ptTimingInfo->IVTotal, usVHalfTotal);
#else
			...
			if (0 != usVHalfTotal && g_ucSrcType == _SRC_TV)
			{
				a_ptDispInfo->IPV_ACT_LEN_PRE = a_ptDispInfo->IVTotal - 25;
				rtd_pr_avd_info("#####[FHFV]a_ptDispInfo->IPV_ACT_LEN_PRE=%d\n", a_ptDispInfo->IPV_ACT_LEN_PRE);
				if (usVHalfTotal > 25)
					g_usCurVHaldTotal = usVHalfTotal;
			}
			else
		...
		rtd_pr_avd_info("drvif_mode_offlinemeasure success\n");
