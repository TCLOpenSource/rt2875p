...
#define MAIN_2STEPUZU_START_REGISTER				TWO_STEP_UZU_DM_TWO_STEP_SR_Ctrl_reg
...
#define MAIN_2STEPUZU_DDR_range(addr)				(((addr>=TWO_STEP_UZU_DM_TWO_STEP_SR_Ctrl_reg) &&(addr <=TWO_STEP_UZU_DM_TWO_STEP_SR_Input_Size_reg)) ? 1: 0 )
...
#define MAIN_LC_DDR_range(addr)                                     ((((addr>=LC_LC_Global_Ctrl0_reg) &&(addr <=LC_LC_Global_Ctrl0_reg)) \
																		...
																		|| ((addr>=LC_LC_Inter_HCtrl1_reg) &&(addr <=LC_LC_Inter_VCtrl1_reg)) \
																		|| ((addr>=LC_LC_ToneMapping_Curve_sel_0_reg) &&(addr <=LC_LC_ToneMapping_Curve_sel_3_reg)) \
																		|| (addr==LC_LC_Local_Shpnr_1st_gain_8_reg) \
