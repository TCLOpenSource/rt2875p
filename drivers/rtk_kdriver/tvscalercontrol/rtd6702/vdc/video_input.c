...
#include "rbus/efuse_reg.h"             //Kenliu 2020/06/01
...
unsigned char VDADC_ADC_CTRL_LDO1V0_sel;    //VDADC_ADC_CTRL[5:3]  Kenliu 2020/06/01
...
void module_vdc_ADC_common_setting(void)
{
	...
	adc_vd_adc_clamp_ctl_1_RBUS vd_adc_clamp_ctl_1_reg;	// 0xb8020048
	adc_vd_adc_clamp_ctl_2_RBUS vd_adc_clamp_ctl_2_reg;	// 0xb802004c
	adc_vd_adc_updn_ctl_RBUS vd_adc_updn_ctl_reg; 		// 0xb8020050
	adc_vdadc_core_lpf_ctrl_RBUS vdadc_core_lpf_ctrl_rbus_reg; // 0xb8020054
	adc_vdadc_ck_ctl_RBUS vdadc_ck_ctl_reg; 			// 0xb8020058
	adc_vdadc_pow_ctl_RBUS vdadc_pow_ctl_reg;			// 0xb802005c
	...
	vd_adc_clamp_ctl_1_reg.vdadc_clamp_ctrl0_9 = 0;			/* 2_0048[25] = 00 */
	vd_adc_clamp_ctl_1_reg.vdadc_clamp_ctrl0_8 = 0;			/* 2_0048[24] = 00 */
	...
	vd_adc_clamp_ctl_1_reg.vdadc_clamp_ctrl1_14 = 0x0;		/* 2_0048[14] = 0x0, Reserved  */
	vd_adc_clamp_ctl_1_reg.vdadc_clamp_ctrl1_13 = 0x0;		/* 2_0048[13] = 0x0, dc restore enable */
	...
	vd_adc_clamp_ctl_1_reg.vdadc_clamp_ctrl1_6 = 0x0;		/* 2_0048[6] = 0x0, Reserved */
	vd_adc_clamp_ctl_1_reg.vdadc_clamp_ctrl1_5 = 0x0;		/* 2_0048[5] = 0x0, clamp en */
	...
	vd_adc_clamp_ctl_2_reg.vdadc_clamp_ctrl2_9 = 0x0;		/* 2_004c[9] VIN11PP select */
	vd_adc_clamp_ctl_2_reg.vdadc_clamp_ctrl2_8 = 0x0;		/* 2_004c[8] VIN11PP select */
	...
	vd_adc_clamp_ctl_2_reg.vdadc_clamp_ctrl2_1 = 0x0;		/* 2_004c[1] = 0, Reserved */
	vd_adc_clamp_ctl_2_reg.vdadc_clamp_ctrl2_0 = 0x0;		/* 2_004c[0] = 0, SF avout enable */
	...
	vd_adc_updn_ctl_reg.vdadc_updn_ctrl0_6_3 = 0x4;			/* 2_0050[6:3]=0100, clamp current */
	vd_adc_updn_ctl_reg.vdadc_updn_ctrl0_1 = 0x0;			/* 2_0050[1]=1, */
	vd_adc_updn_ctl_reg.vdadc_updn_ctrl0_0 = 0x1;			/* 2_0050[0]=01, AV clamp up/dn enable */
	...
	vdadc_pow_ctl_reg.vdadc_reserve_10 = 0x0;		/* 2_005c[26]=0, default */
	vdadc_pow_ctl_reg.vdadc_reserve_9 = 0x0; 	/* 2_005c[25]=0, default */
	vdadc_pow_ctl_reg.vdadc_reserve_8 = 0x0; 	/* 2_005c[24]=0, default */
	vdadc_pow_ctl_reg.vdadc_reserve_7 = 0x0; 	/* 2_005c[23]=0, default */
	vdadc_pow_ctl_reg.vdadc_reserve_6 = 0x0; 	/* 2_005c[22]=0, default */
	vdadc_pow_ctl_reg.vdadc_reserve_5 = 0x0; 	/* 2_005c[21]=0, default */
	vdadc_pow_ctl_reg.vdadc_reserve_4 = 0x0; 	/* 2_005c[20]=0, default */
	vdadc_pow_ctl_reg.vdadc_reserve_3 = 0x0; 	/* 2_005c[19]=0, default */
	vdadc_pow_ctl_reg.vdadc_reserve_2_1 = 0x2;		/* 2_005c[18:17]=2, default */
	vdadc_pow_ctl_reg.vdadc_reserve_0 = 0x0; 	/* 2_005c[16]=0, default */
	vdadc_pow_ctl_reg.ldo100ma_pow = 0x1; 	/* 2_005c[1]=1, LDO100MA_POW */
	vdadc_pow_ctl_reg.vdadc_pow = 0x1;		/* 2_005c[0]=1, power on */
	// VDC_DEBUG_MSG(VDC_MSG_INIT,"[1] 2_005c=%x\n", vdadc_pow_ctl_reg.regValue);
	rtdf_outl(ADC_VDADC_POW_CTL_reg, vdadc_pow_ctl_reg.regValue); // Clayton Note[1/2]: PGA power on first "vdadc_pow"
...
/*
	...
	vd_opt = ((rtdf_inl(EFUSE_DATAO_121_reg)&0x80000000)>>31);	//Add OTP address to set VDADC_ADC_CTRL_LDO1V0	2020/06/01
	if (vd_opt==1){											//vd_otp : otp done flag
		VDADC_ADC_CTRL_LDO1V0_sel = ((rtdf_inl(EFUSE_DATAO_121_reg)&0x70000000)>>28);
	}else {
		VDADC_ADC_CTRL_LDO1V0_sel = 0x5;					//default valure = 0x001(0.908V)
	}
*/
	//VD ADC OPT setting for LDO 1v
	...
	vd_opt = (vd_adc_ldo_data >> 3) & 0x1; //check Iotp done flag

	if (vd_opt==1){											//vd_otp : otp done flag
		VDADC_ADC_CTRL_LDO1V0_sel = (vd_adc_ldo_data & 0x7);
		VDC_DEBUG_MSG(VDC_MSG_INIT,"check to OTP value..... %x \n", vd_adc_ldo_data);
	}else {
		VDADC_ADC_CTRL_LDO1V0_sel = 0x5;					//default valure = 0x001(0.908V)
	}
	vdadc_core_lpf_ctrl_rbus_reg.vdadc_adc_ctrl_15_14 = 0x3;	/* 2_0054[31:30]=01 */ /*Mark2 modify, Reference Buffer Source Current Selection 0x3*/
	// vdadc_core_lpf_ctrl_rbus_reg.vdadc_adc_ctrl_13_12 = 0x0;	// mark2 reserved
	vdadc_core_lpf_ctrl_rbus_reg.vdadc_adc_ctrl_11_10 = 0x1;	// 2_0054[27:26]=1 mark2 modify SAR ADC sample time reduction
	vdadc_core_lpf_ctrl_rbus_reg.vdadc_adc_ctrl_9_8 = AD_vdadc_adc_ctrl_9_8;		/* 2_0054[25:24]=10 */
	vdadc_core_lpf_ctrl_rbus_reg.vdadc_adc_ctrl_7_6 = 0x2;		/* 2_0054[23:22]=01, 1.3V LDO Selection *//* Mark2 modify, DAC Shifting Selection 0x2*/
	vdadc_core_lpf_ctrl_rbus_reg.vdadc_adc_ctrl_5_3 = VDADC_ADC_CTRL_LDO1V0_sel;	/* 2_0054[21:19]=001, 1V LDO Selection(001:0.95V) */
	vdadc_core_lpf_ctrl_rbus_reg.vdadc_adc_ctrl_1 = 0x1;		/* 2_0054[17]=0 */ /*Mark2 modify, SAR ADC DAC Reset 0x1*/
	vdadc_core_lpf_ctrl_rbus_reg.vdadc_adc_ctrl_0 = 0x0;		/* 2_0054[16]=0, after m6/mac7 modify ADC S/H gain. (0:1X, 1:1.6X) */
	...
	vdadc_ck_ctl_reg.vdadc_ckout_sel_4 = 0x1;	/* 2_0058[4]=0 */ /*Mark2 modify ADADC 108M output clock drivider polarity 0x1*/
...
#else //fixed me. ADC resiter spec out
	...
	// tv_sb1_ana_vdadc_pow_ctl_reg.ldo100ma_pow = 0x1; 	/* 2_005c[1]=1, LDO100MA_POW */
	...
	VDADC_ADC_CTRL_LDO1V0_sel = 0x1;						//default valure = 0x001(0.95V)
	}
	tv_sb1_ana_vdadc_core_lpf_ctrl_reg.reg_vdadc_adc_ctrl_15_14 = 0x1;	/* 2_0054[31:30]=01 */
	tv_sb1_ana_vdadc_core_lpf_ctrl_reg.reg_vdadc_adc_ctrl_13 = 0x0; 	/* 2_0054[29]=0 */
	tv_sb1_ana_vdadc_core_lpf_ctrl_reg.reg_vdadc_adc_ctrl_12_10 = 0x0;	/* 2_0054[28:26]=0 */
	tv_sb1_ana_vdadc_core_lpf_ctrl_reg.reg_vdadc_adc_ctrl_9_8 = AD_vdadc_adc_ctrl_9_8;		/* 2_0054[25:24]=10 */
	tv_sb1_ana_vdadc_core_lpf_ctrl_reg.reg_vdadc_adc_ctrl_7 = 0x0;		/* 2_0054[23:22]=01, 1.3V LDO Selection */
	tv_sb1_ana_vdadc_core_lpf_ctrl_reg.reg_vdadc_adc_ctrl_6 = 0x1;		/*							  (01:1.30V) */
	tv_sb1_ana_vdadc_core_lpf_ctrl_reg.reg_vdadc_adc_ctrl_5_3 = VDADC_ADC_CTRL_LDO1V0_sel;	/* 2_0054[21:19]=001, 1V LDO Selection(001:0.95V) */
	tv_sb1_ana_vdadc_core_lpf_ctrl_reg.reg_vdadc_adc_ctrl_1 = 0x0;		/* 2_0054[17]=0 */
	tv_sb1_ana_vdadc_core_lpf_ctrl_reg.reg_vdadc_adc_ctrl_0 = 0x0;		/* 2_0054[16]=0, after m6/mac7 modify ADC S/H gain. (0:1X, 1:1.6X) */
	...
	tv_sb1_ana_vdadc_ck_ctl_reg.reg_vdadc_ckout_sel_4 = 0x0;	/* 2_0058[4]=0 */
...
_VIN_VD_i:
		...
		vd_adc_clamp_ctl_2_reg.vdadc_clamp_ctrl2_9 = 0x0;	/* 2_004c[9]=0, VIN1P/4P/7P */
		vd_adc_clamp_ctl_2_reg.vdadc_clamp_ctrl2_8 = 0x1;	/* 2_004c[8]=1, VIN1P/4P/7P */
		goto _V_Ch_Set;
	...
	case VIDEO_INPUT10:
		...
		vd_adc_clamp_ctl_2_reg.vdadc_clamp_ctrl2_9 = 0x1;	/* 2_004c[9]=1, VIN10P */
		vd_adc_clamp_ctl_2_reg.vdadc_clamp_ctrl2_8 = 0x0;	/* 2_004c[8]=0, VIN10P */
		goto _V_Ch_Set;
	/* Passive MUX : VIN11PP=12P, 13P */
	default:
	case VIDEO_INPUT12:
		vd_adc_clamp_ctl_2_reg.vdadc_clamp_ctrl2_9 = 0x0;	/* 2_004c[9]=0, VIN12P */
		vd_adc_clamp_ctl_2_reg.vdadc_clamp_ctrl2_8 = 0x0;	/* 2_004c[8]=0, VIN12P */
		goto _VIN11PP_set;
	case VIDEO_INPUT13:
		vd_adc_clamp_ctl_2_reg.vdadc_clamp_ctrl2_9 = 0x1;	/* 2_004c[9]=1, VIN13P */
		vd_adc_clamp_ctl_2_reg.vdadc_clamp_ctrl2_8 = 0x1;	/* 2_004c[8]=1, VIN13P */
		goto _VIN11PP_set;
...
_V_Ch_Set:		/* GND set */
		...
		switch (path_gnd) {
			...
			case VIDEO_GNDA1:	/* A1N from YPP */
				// adc_adc_vbias_reg.adc_vbias1_7_6 = 0x0;			// mark2 reserved
				adc_adc_vbias_reg.adc_vbias1_5_4 = 0x2;				/* 2_000c[13:12] = 10, VINN mux to D */
				// adc_adc_vbias_reg.adc_vbias1_3_1 = 0x0;			// mark2 reserved
			...
			case VIDEO_GN:
				...
				vd_adc_clamp_ctl_1_reg.vdadc_clamp_ctrl0_15_14 = 0x1;				/* 2_0048[31:30] = 01, A1N from YPP */
				vd_adc_updn_ctl_reg.vdadc_updn_ctrl0_10_8 = (ucNClampUpDn | _BIT1);	/* 2_0050[9]=1, A1N */
				break;
		}
...
_V_Ch_Set:		/* GND set */
		...
		switch (path_gnd) {
			...
			case VIDEO_Y0N:		/* Y0N */
			case VIDEO_GNDA1:	/* A1N from YPP */
				// adc_adc_vbias_reg.adc_vbias1_7_6 = 0x0;				/* 2_000c[15] = 0, 2_000c[14] = 0, */
				// adc_adc_vbias_reg.adc_vbias1_5_4 = 0x2;				/* 2_000c[13:12] = 10, VINN mux to D */
				// adc_adc_vbias_reg.adc_vbias1_3_1 = 0x0;				/* 2_000c[11:10] = 00, 2_000c[9] = 0,  */
				// adc_adc_vbias_reg.adc_vbias1_0 = 0x0;				/* 2_000c[8] = 0,  */
...
void module_vdc_SetInput_YC(unsigned char Y_path, unsigned char Y_Gnd_path, unsigned char C_path, unsigned char C_Gnd_path, unsigned char SV_Type)
{
	...
	module_vdc_SetADCPath(Y_path, Y_Gnd_path);
	...
	if (SV_Type == VIDEO_SV_SWAP) {
		...
		module_vdc_SetADCPath(C_path, C_Gnd_path);
		...
		vd_adc_updn_ctl_reg.regValue = rtdf_inl(ADC_VD_ADC_UPDN_CTL_reg);
		vd_adc_updn_ctl_reg.vdadc_updn_ctrl0_1 = 0x1;	/* 2_0050[1]=1, SV */
		vd_adc_updn_ctl_reg.vdadc_updn_ctrl0_0 = 0x1;	/* 2_0050[0]=1, SV */
		rtdf_outl(ADC_VD_ADC_UPDN_CTL_reg, vd_adc_updn_ctl_reg.regValue);
		...
		rtdf_outl(ADC_VDADC_CK_CTL_reg, vdadc_ck_ctl_reg.regValue);
#else //fixed me. ADC resiter spec out
		// merlin7 reserved this bit
		// tv_sb1_ana_vd_adc_clamp_ctl_2_reg.regValue = rtdf_inl(TV_SB1_ANA_VD_ADC_CLAMP_CTL_2_reg);
		// tv_sb1_ana_vd_adc_clamp_ctl_2_reg.reg_vdadc_clamp_ctrl2_5 = 0x1;	/* 2_004c[5] = 1, yc swap enable */
		// rtdf_outl(TV_SB1_ANA_VD_ADC_CLAMP_CTL_2_reg, tv_sb1_ana_vd_adc_clamp_ctl_2_reg.regValue);
		...
		module_vdc_SetRGBADCPath(C_path, C_Gnd_path);
...
#else //fixed me. ADC resiter spec out
	tv_sb1_ana_scart_ctrl1_reg.regValue = rtdf_inl(TV_SB1_ANA_SCART_CTRL1_reg);
	tv_sb1_ana_scart_ctrl1_reg.reg_vdadc_sct_ctrl_7_6= 0x1;
	tv_sb1_ana_scart_ctrl1_reg.reg_vdadc_sct_ctrl_5_4= 0x0;
	tv_sb1_ana_scart_ctrl1_reg.reg_vdadc_sct_ctrl_3 = 0x0;
	tv_sb1_ana_scart_ctrl1_reg.reg_vdadc_sct_ctrl_2 = 0x1;
	tv_sb1_ana_scart_ctrl1_reg.reg_vdadc_sct_ctrl_1 = 0x1;
	tv_sb1_ana_scart_ctrl1_reg.reg_vdadc_sct_ctrl_0 = 0x1;
	rtdf_outl(TV_SB1_ANA_SCART_CTRL1_reg, tv_sb1_ana_scart_ctrl1_reg.regValue);
#endif
}
#endif
...
void module_vdc_PathSelect(unsigned char ucSourceIndex, void* stPath)
{
	...
	//mark2 modify for TV source
	//reg_pll27x_vdadc_reg.regValue = rtdf_inl(PLL27X_REG_PLL27X_VDADC_reg);
	//reg_pll27x_vdadc_reg.pll27x_vdadc_duty = 0x0; //bit[1:0] VDADC clk duty select
	//rtdf_outl(PLL27X_REG_PLL27X_VDADC_reg, reg_pll27x_vdadc_reg.regValue);
	//vdadc_ck_ctl_reg.regValue = rtdf_inl(ADC_VDADC_CK_CTL_reg);
	//vdadc_ck_ctl_reg.vdadc_ckout_sel_4 = 0x1;	/* 2_0058[4]=1 */ /*Mark2 modify ADADC 108M output clock drivider polarity */
	//rtdf_outl(ADC_VDADC_CK_CTL_reg, vdadc_ck_ctl_reg.regValue);
	...
	scart_ctrl1_reg.vdadc_sct_ctrl_5_4= 0x0;
	scart_ctrl1_reg.vdadc_sct_ctrl_3 = 0x0;
	scart_ctrl1_reg.vdadc_sct_ctrl_2 = 0x0;
	scart_ctrl1_reg.vdadc_sct_ctrl_1 = 0x1;
	scart_ctrl1_reg.vdadc_sct_ctrl_0 = 0x0;
	rtdf_outl(ADC_SCART_CTRL1_reg, scart_ctrl1_reg.regValue);
#else //fixed me. ADC resiter spec out
	tv_sb1_ana_scart_ctrl1_reg.regValue = rtdf_inl(TV_SB1_ANA_SCART_CTRL1_reg);
	tv_sb1_ana_scart_ctrl1_reg.reg_vdadc_sct_ctrl_7_6= 0x1;
	tv_sb1_ana_scart_ctrl1_reg.reg_vdadc_sct_ctrl_5_4= 0x0;
	tv_sb1_ana_scart_ctrl1_reg.reg_vdadc_sct_ctrl_3 = 0x0;
	tv_sb1_ana_scart_ctrl1_reg.reg_vdadc_sct_ctrl_2 = 0x0;
	tv_sb1_ana_scart_ctrl1_reg.reg_vdadc_sct_ctrl_1 = 0x1;
	tv_sb1_ana_scart_ctrl1_reg.reg_vdadc_sct_ctrl_0 = 0x0;
	rtdf_outl(TV_SB1_ANA_SCART_CTRL1_reg, tv_sb1_ana_scart_ctrl1_reg.regValue);
#endif
	...
	module_vdc_Set_bgate_Setting(1); //[start]ryanliao 20190108 bgate_Setting
