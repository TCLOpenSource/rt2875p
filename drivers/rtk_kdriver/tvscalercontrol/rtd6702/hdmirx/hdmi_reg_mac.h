...
#include <rbus/hdmi20_p0_meas_reg.h>
#include <rbus/hdmi20_p1_meas_reg.h>
#include <rbus/hdmi20_p2_meas_reg.h>
#include <rbus/hdmi20_p3_meas_reg.h>
#ifndef uint32_t
...
#define  HDMI_HDMI_VPLLCR0_reg                 (mac[common_port].hdmi_vpllcr0)
#define  HDMI_HDMI_VPLLCR1_reg                 (mac[common_port].hdmi_vpllcr1)
#define  HDMI_HDMI_VPLLCR2_reg                 (mac[common_port].hdmi_vpllcr2)
#define  HDMI_MN_SCLKG_CTRL_reg                (mac[common_port].mn_sclkg_ctrl)
#define  HDMI_MN_SCLKG_DIVS_reg                (mac[common_port].mn_sclkg_divs)
#define  HDMI_MDD_CR_reg                       (mac[common_port].mdd_cr)
#define  HDMI_MDD_SR_reg                       (mac[common_port].mdd_sr)
#define  HDMI_FW_FUNC_reg                      (mac[0].fw_func)                      // Even has 2 set, but only one will be used
#define  HDMI_PORT_SWITCH_reg                  (mac[common_port].port_switch)
#define  HDMI_POWER_SAVING_reg                 (mac[common_port].power_saving)       // for HDMI PG CLK only
#define  HDMI_CRC_Ctrl_reg                     (mac[common_port].crc_ctrl)
#define  HDMI_CRC_Result_reg                   (mac[common_port].crc_result)
#define  HDMI_DES_CRC_reg                      (mac[common_port].des_crc)
#define  HDMI_CRC_ERR_CNT0_reg                 (mac[common_port].crc_err_cnt0)
#define  HDMI_hdmi_20_21_ctrl_reg              (mac[common_port].hdmi_20_21_ctrl)
#define  HDMI_YUV422_CD_reg                    (mac[common_port].yuv422_cd)
...
#define  HDMI_debug_port_ctrl_reg              (mac[0].debug_port_ctrl)
#define  HDMI_AUDIO_COMMON_PORT_SWITCH_reg     (mac[common_port].aud_common_port_switch)
...
#define  HDMI_HDMI_BCSR_bch_err2_shift                                   HDMI_P0_HDMI_BCSR_bch_err2_shift
#define  HDMI_HDMI_BCSR_bch_err2_mask                                    HDMI_P0_HDMI_BCSR_bch_err2_mask
#define  HDMI_HDMI_BCSR_gcp_bch_err2_shift                               HDMI_P0_HDMI_BCSR_gcp_bch_err2_shift
...
extern const struct hdmi20_meas_reg_st hd20_meas[HDMI20_MAC_NUM];

#define  HD20_MEAS_FRL_MEASURE_0_reg                                    (hd20_meas[nport].frl_measure_0)
#define  HD20_MEAS_FRL_MEASURE_1_reg                                    (hd20_meas[nport].frl_measure_1)
#define  HD20_MEAS_FRL_MEASURE_3_reg                                    (hd20_meas[nport].frl_measure_3)
#define  HD20_MEAS_FRL_MEASURE_4_reg                                    (hd20_meas[nport].frl_measure_4)
#define  HD20_MEAS_FRL_MEASURE_5_reg                                    (hd20_meas[nport].frl_measure_5)
#define  HD20_MEAS_FRL_MEASURE_7_reg                                    (hd20_meas[nport].frl_measure_7)
#define  HD20_MEAS_FRL_MEASURE_9_reg                                    (hd20_meas[nport].frl_measure_9)
#define  HD20_MEAS_FRL_MEASURE_A_reg                                    (hd20_meas[nport].frl_measure_a)
#define  HD20_MEAS_FRL_MEASURE_B_reg                                    (hd20_meas[nport].frl_measure_b)
#define  HD20_MEAS_FRL_MEASURE_D_reg                                    (hd20_meas[nport].frl_measure_d)
#define  HD20_MEAS_FRL_MEASURE_F_reg                                    (hd20_meas[nport].frl_measure_f)
#define  HD20_MEAS_FRL_MEASURE_11_reg                                   (hd20_meas[nport].frl_measure_11)
#define  HD20_MEAS_FRL_MEASURE_13_reg                                   (hd20_meas[nport].frl_measure_13)
#define  HD20_MEAS_FRL_MEASURE_14_reg                                   (hd20_meas[nport].frl_measure_14)
#define  HD20_MEAS_FRL_MEASURE_16_reg                                   (hd20_meas[nport].frl_measure_16)
#define  HD20_MEAS_FRL_MEASURE_18_reg                                   (hd20_meas[nport].frl_measure_18)

#define  HD20_MEAS_FRL_MEASURE_0_measure_en_mask               HDMI20_P0_MEAS_FRL_MEASURE_0_measure_en_mask
#define  HD20_MEAS_FRL_MEASURE_0_dummy_6_0_mask                HDMI20_P0_MEAS_FRL_MEASURE_0_dummy_6_0_mask
#define  HD20_MEAS_FRL_MEASURE_0_measure_en(data)              HDMI20_P0_MEAS_FRL_MEASURE_0_measure_en(data)
#define  HD20_MEAS_FRL_MEASURE_0_dummy_6_0(data)               HDMI20_P0_MEAS_FRL_MEASURE_0_dummy_6_0(data)
#define  HD20_MEAS_FRL_MEASURE_0_get_measure_en(data)          HDMI20_P0_MEAS_FRL_MEASURE_0_get_measure_en(data)
#define  HD20_MEAS_FRL_MEASURE_0_get_dummy_6_0(data)           HDMI20_P0_MEAS_FRL_MEASURE_0_get_dummy_6_0(data)


#define  HD20_MEAS_FRL_MEASURE_1_ht_clk_cnt_mask               HDMI20_P0_MEAS_FRL_MEASURE_1_ht_clk_cnt_mask
#define  HD20_MEAS_FRL_MEASURE_1_ht_clk_cnt(data)              HDMI20_P0_MEAS_FRL_MEASURE_1_ht_clk_cnt(data)
#define  HD20_MEAS_FRL_MEASURE_1_get_ht_clk_cnt(data)          HDMI20_P0_MEAS_FRL_MEASURE_1_get_ht_clk_cnt(data)

#define  HD20_MEAS_FRL_MEASURE_3_hs_sel_mask                   HDMI20_P0_MEAS_FRL_MEASURE_3_hs_sel_mask
#define  HD20_MEAS_FRL_MEASURE_3_ht_meas_sel_mask              HDMI20_P0_MEAS_FRL_MEASURE_3_ht_meas_sel_mask
#define  HD20_MEAS_FRL_MEASURE_3_meas_skip_line_mask           HDMI20_P0_MEAS_FRL_MEASURE_3_meas_skip_line_mask
#define  HD20_MEAS_FRL_MEASURE_3_avg_line_num_mask             HDMI20_P0_MEAS_FRL_MEASURE_3_avg_line_num_mask
#define  HD20_MEAS_FRL_MEASURE_3_dummy_0_mask                  HDMI20_P0_MEAS_FRL_MEASURE_3_dummy_0_mask
#define  HD20_MEAS_FRL_MEASURE_3_hs_sel(data)                  HDMI20_P0_MEAS_FRL_MEASURE_3_hs_sel(data)
#define  HD20_MEAS_FRL_MEASURE_3_ht_meas_sel(data)             HDMI20_P0_MEAS_FRL_MEASURE_3_ht_meas_sel(data)
#define  HD20_MEAS_FRL_MEASURE_3_meas_skip_line(data)          HDMI20_P0_MEAS_FRL_MEASURE_3_meas_skip_line(data)
#define  HD20_MEAS_FRL_MEASURE_3_avg_line_num(data)            HDMI20_P0_MEAS_FRL_MEASURE_3_avg_line_num(data)
#define  HD20_MEAS_FRL_MEASURE_3_dummy_0(data)                 HDMI20_P0_MEAS_FRL_MEASURE_3_dummy_0(data)
#define  HD20_MEAS_FRL_MEASURE_3_get_hs_sel(data)              HDMI20_P0_MEAS_FRL_MEASURE_3_get_hs_sel(data)
#define  HD20_MEAS_FRL_MEASURE_3_get_ht_meas_sel(data)         HDMI20_P0_MEAS_FRL_MEASURE_3_get_ht_meas_sel(data)
#define  HD20_MEAS_FRL_MEASURE_3_get_meas_skip_line(data)      HDMI20_P0_MEAS_FRL_MEASURE_3_get_meas_skip_line(data)
#define  HD20_MEAS_FRL_MEASURE_3_get_avg_line_num(data)        HDMI20_P0_MEAS_FRL_MEASURE_3_get_avg_line_num(data)
#define  HD20_MEAS_FRL_MEASURE_3_get_dummy_0(data)             HDMI20_P0_MEAS_FRL_MEASURE_3_get_dummy_0(data)


#define  HD20_MEAS_FRL_MEASURE_4_line_bd_sel_mask              HDMI20_P0_MEAS_FRL_MEASURE_4_line_bd_sel_mask
#define  HD20_MEAS_FRL_MEASURE_4_vt_meas_sel_mask              HDMI20_P0_MEAS_FRL_MEASURE_4_vt_meas_sel_mask
#define  HD20_MEAS_FRL_MEASURE_4_vact_meas_sel_mask            HDMI20_P0_MEAS_FRL_MEASURE_4_vact_meas_sel_mask
#define  HD20_MEAS_FRL_MEASURE_4_dummy_3_0_mask                HDMI20_P0_MEAS_FRL_MEASURE_4_dummy_3_0_mask
#define  HD20_MEAS_FRL_MEASURE_4_line_bd_sel(data)             HDMI20_P0_MEAS_FRL_MEASURE_4_line_bd_sel(data)
#define  HD20_MEAS_FRL_MEASURE_4_vt_meas_sel(data)             HDMI20_P0_MEAS_FRL_MEASURE_4_vt_meas_sel(data)
#define  HD20_MEAS_FRL_MEASURE_4_vact_meas_sel(data)           HDMI20_P0_MEAS_FRL_MEASURE_4_vact_meas_sel(data)
#define  HD20_MEAS_FRL_MEASURE_4_dummy_3_0(data)               HDMI20_P0_MEAS_FRL_MEASURE_4_dummy_3_0(data)
#define  HD20_MEAS_FRL_MEASURE_4_get_line_bd_sel(data)         HDMI20_P0_MEAS_FRL_MEASURE_4_get_line_bd_sel(data)
#define  HD20_MEAS_FRL_MEASURE_4_get_vt_meas_sel(data)         HDMI20_P0_MEAS_FRL_MEASURE_4_get_vt_meas_sel(data)
#define  HD20_MEAS_FRL_MEASURE_4_get_vact_meas_sel(data)       HDMI20_P0_MEAS_FRL_MEASURE_4_get_vact_meas_sel(data)
#define  HD20_MEAS_FRL_MEASURE_4_get_dummy_3_0(data)           HDMI20_P0_MEAS_FRL_MEASURE_4_get_dummy_3_0(data)


#define  HD20_MEAS_FRL_MEASURE_5_vt_line_cnt1_mask             HDMI20_P0_MEAS_FRL_MEASURE_5_vt_line_cnt1_mask
#define  HD20_MEAS_FRL_MEASURE_5_vt_line_cnt1(data)            HDMI20_P0_MEAS_FRL_MEASURE_5_vt_line_cnt1(data)
#define  HD20_MEAS_FRL_MEASURE_5_get_vt_line_cnt1(data)        HDMI20_P0_MEAS_FRL_MEASURE_5_get_vt_line_cnt1(data)


#define  HD20_MEAS_FRL_MEASURE_7_vt_line_cnt2_mask             HDMI20_P0_MEAS_FRL_MEASURE_7_vt_line_cnt2_mask
#define  HD20_MEAS_FRL_MEASURE_7_vt_line_cnt2(data)            HDMI20_P0_MEAS_FRL_MEASURE_7_vt_line_cnt2(data)
#define  HD20_MEAS_FRL_MEASURE_7_get_vt_line_cnt2(data)        HDMI20_P0_MEAS_FRL_MEASURE_7_get_vt_line_cnt2(data)


#define  HD20_MEAS_FRL_MEASURE_9_pol_det_mode_mask             HDMI20_P0_MEAS_FRL_MEASURE_9_pol_det_mode_mask
#define  HD20_MEAS_FRL_MEASURE_9_hs_polarity_mask              HDMI20_P0_MEAS_FRL_MEASURE_9_hs_polarity_mask
#define  HD20_MEAS_FRL_MEASURE_9_vs_polarity_mask              HDMI20_P0_MEAS_FRL_MEASURE_9_vs_polarity_mask
#define  HD20_MEAS_FRL_MEASURE_9_dummy_4_0_mask                HDMI20_P0_MEAS_FRL_MEASURE_9_dummy_4_0_mask
#define  HD20_MEAS_FRL_MEASURE_9_pol_det_mode(data)            HDMI20_P0_MEAS_FRL_MEASURE_9_pol_det_mode(data)
#define  HD20_MEAS_FRL_MEASURE_9_hs_polarity(data)             HDMI20_P0_MEAS_FRL_MEASURE_9_hs_polarity(data)
#define  HD20_MEAS_FRL_MEASURE_9_vs_polarity(data)             HDMI20_P0_MEAS_FRL_MEASURE_9_vs_polarity(data)
#define  HD20_MEAS_FRL_MEASURE_9_dummy_4_0(data)               HDMI20_P0_MEAS_FRL_MEASURE_9_dummy_4_0(data)
#define  HD20_MEAS_FRL_MEASURE_9_get_pol_det_mode(data)        HDMI20_P0_MEAS_FRL_MEASURE_9_get_pol_det_mode(data)
#define  HD20_MEAS_FRL_MEASURE_9_get_hs_polarity(data)         HDMI20_P0_MEAS_FRL_MEASURE_9_get_hs_polarity(data)
#define  HD20_MEAS_FRL_MEASURE_9_get_vs_polarity(data)         HDMI20_P0_MEAS_FRL_MEASURE_9_get_vs_polarity(data)
#define  HD20_MEAS_FRL_MEASURE_9_get_dummy_4_0(data)           HDMI20_P0_MEAS_FRL_MEASURE_9_get_dummy_4_0(data)


#define  HD20_MEAS_FRL_MEASURE_A_interlaced_vtotal_mask        HDMI20_P0_MEAS_FRL_MEASURE_A_interlaced_vtotal_mask
#define  HD20_MEAS_FRL_MEASURE_A_vtotal_diff_mask              HDMI20_P0_MEAS_FRL_MEASURE_A_vtotal_diff_mask
#define  HD20_MEAS_FRL_MEASURE_A_field_tog_mask                HDMI20_P0_MEAS_FRL_MEASURE_A_field_tog_mask
#define  HD20_MEAS_FRL_MEASURE_A_interlaced_field_mask         HDMI20_P0_MEAS_FRL_MEASURE_A_interlaced_field_mask
#define  HD20_MEAS_FRL_MEASURE_A_interlaced_err_mask           HDMI20_P0_MEAS_FRL_MEASURE_A_interlaced_err_mask
#define  HD20_MEAS_FRL_MEASURE_A_dummy_1_0_mask                HDMI20_P0_MEAS_FRL_MEASURE_A_dummy_1_0_mask
#define  HD20_MEAS_FRL_MEASURE_A_interlaced_vtotal(data)       HDMI20_P0_MEAS_FRL_MEASURE_A_interlaced_vtotal(data)
#define  HD20_MEAS_FRL_MEASURE_A_vtotal_diff(data)             HDMI20_P0_MEAS_FRL_MEASURE_A_vtotal_diff(data)
#define  HD20_MEAS_FRL_MEASURE_A_field_tog(data)               HDMI20_P0_MEAS_FRL_MEASURE_A_field_tog(data)
#define  HD20_MEAS_FRL_MEASURE_A_interlaced_field(data)        HDMI20_P0_MEAS_FRL_MEASURE_A_interlaced_field(data)
#define  HD20_MEAS_FRL_MEASURE_A_interlaced_err(data)          HDMI20_P0_MEAS_FRL_MEASURE_A_interlaced_err(data)
#define  HD20_MEAS_FRL_MEASURE_A_dummy_1_0(data)               HDMI20_P0_MEAS_FRL_MEASURE_A_dummy_1_0(data)
#define  HD20_MEAS_FRL_MEASURE_A_get_interlaced_vtotal(data)   HDMI20_P0_MEAS_FRL_MEASURE_A_get_interlaced_vtotal(data)
#define  HD20_MEAS_FRL_MEASURE_A_get_vtotal_diff(data)         HDMI20_P0_MEAS_FRL_MEASURE_A_get_vtotal_diff(data)
#define  HD20_MEAS_FRL_MEASURE_A_get_field_tog(data)           HDMI20_P0_MEAS_FRL_MEASURE_A_get_field_tog(data)
#define  HD20_MEAS_FRL_MEASURE_A_get_interlaced_field(data)    HDMI20_P0_MEAS_FRL_MEASURE_A_get_interlaced_field(data)
#define  HD20_MEAS_FRL_MEASURE_A_get_interlaced_err(data)      HDMI20_P0_MEAS_FRL_MEASURE_A_get_interlaced_err(data)
#define  HD20_MEAS_FRL_MEASURE_A_get_dummy_1_0(data)           HDMI20_P0_MEAS_FRL_MEASURE_A_get_dummy_1_0(data)


#define  HD20_MEAS_FRL_MEASURE_B_hs_width_mask                 HDMI20_P0_MEAS_FRL_MEASURE_B_hs_width_mask
#define  HD20_MEAS_FRL_MEASURE_B_hs_width(data)                HDMI20_P0_MEAS_FRL_MEASURE_B_hs_width(data)
#define  HD20_MEAS_FRL_MEASURE_B_get_hs_width(data)            HDMI20_P0_MEAS_FRL_MEASURE_B_get_hs_width(data)


#define  HD20_MEAS_FRL_MEASURE_D_hback_cnt_mask                HDMI20_P0_MEAS_FRL_MEASURE_D_hback_cnt_mask
#define  HD20_MEAS_FRL_MEASURE_D_hback_cnt(data)               HDMI20_P0_MEAS_FRL_MEASURE_D_hback_cnt(data)
#define  HD20_MEAS_FRL_MEASURE_D_get_hback_cnt(data)           HDMI20_P0_MEAS_FRL_MEASURE_D_get_hback_cnt(data)


#define  HD20_MEAS_FRL_MEASURE_F_hact_cnt_mask                 HDMI20_P0_MEAS_FRL_MEASURE_F_hact_cnt_mask
#define  HD20_MEAS_FRL_MEASURE_F_hact_cnt(data)                HDMI20_P0_MEAS_FRL_MEASURE_F_hact_cnt(data)
#define  HD20_MEAS_FRL_MEASURE_F_get_hact_cnt(data)            HDMI20_P0_MEAS_FRL_MEASURE_F_get_hact_cnt(data)


#define  HD20_MEAS_FRL_MEASURE_11_htotal_cnt_mask              HDMI20_P0_MEAS_FRL_MEASURE_11_htotal_cnt_mask
#define  HD20_MEAS_FRL_MEASURE_11_htotal_cnt(data)             HDMI20_P0_MEAS_FRL_MEASURE_11_htotal_cnt(data)
#define  HD20_MEAS_FRL_MEASURE_11_get_htotal_cnt(data)         HDMI20_P0_MEAS_FRL_MEASURE_11_get_htotal_cnt(data)


#define  HD20_MEAS_FRL_MEASURE_13_vs_width_mask                HDMI20_P0_MEAS_FRL_MEASURE_13_vs_width_mask
#define  HD20_MEAS_FRL_MEASURE_13_vs_width(data)               HDMI20_P0_MEAS_FRL_MEASURE_13_vs_width(data)
#define  HD20_MEAS_FRL_MEASURE_13_get_vs_width(data)           HDMI20_P0_MEAS_FRL_MEASURE_13_get_vs_width(data)


#define  HD20_MEAS_FRL_MEASURE_14_vback_cnt_mask               HDMI20_P0_MEAS_FRL_MEASURE_14_vback_cnt_mask
#define  HD20_MEAS_FRL_MEASURE_14_vback_cnt(data)              HDMI20_P0_MEAS_FRL_MEASURE_14_vback_cnt(data)
#define  HD20_MEAS_FRL_MEASURE_14_get_vback_cnt(data)          HDMI20_P0_MEAS_FRL_MEASURE_14_get_vback_cnt(data)


#define  HD20_MEAS_FRL_MEASURE_16_vs_hs_rp_align_mask          HDMI20_P0_MEAS_FRL_MEASURE_16_vs_hs_rp_align_mask
#define  HD20_MEAS_FRL_MEASURE_16_vs_hs_fp_align_mask          HDMI20_P0_MEAS_FRL_MEASURE_16_vs_hs_fp_align_mask
#define  HD20_MEAS_FRL_MEASURE_16_last_line_ov_thd_mask        HDMI20_P0_MEAS_FRL_MEASURE_16_last_line_ov_thd_mask
#define  HD20_MEAS_FRL_MEASURE_16_vact_cnt_mask                HDMI20_P0_MEAS_FRL_MEASURE_16_vact_cnt_mask
#define  HD20_MEAS_FRL_MEASURE_16_vs_hs_rp_align(data)         HDMI20_P0_MEAS_FRL_MEASURE_16_vs_hs_rp_align(data)
#define  HD20_MEAS_FRL_MEASURE_16_vs_hs_fp_align(data)         HDMI20_P0_MEAS_FRL_MEASURE_16_vs_hs_fp_align(data)
#define  HD20_MEAS_FRL_MEASURE_16_last_line_ov_thd(data)       HDMI20_P0_MEAS_FRL_MEASURE_16_last_line_ov_thd(data)
#define  HD20_MEAS_FRL_MEASURE_16_vact_cnt(data)               HDMI20_P0_MEAS_FRL_MEASURE_16_vact_cnt(data)
#define  HD20_MEAS_FRL_MEASURE_16_get_vs_hs_rp_align(data)     HDMI20_P0_MEAS_FRL_MEASURE_16_get_vs_hs_rp_align(data)
#define  HD20_MEAS_FRL_MEASURE_16_get_vs_hs_fp_align(data)     HDMI20_P0_MEAS_FRL_MEASURE_16_get_vs_hs_fp_align(data)
#define  HD20_MEAS_FRL_MEASURE_16_get_last_line_ov_thd(data)   HDMI20_P0_MEAS_FRL_MEASURE_16_get_last_line_ov_thd(data)
#define  HD20_MEAS_FRL_MEASURE_16_get_vact_cnt(data)           HDMI20_P0_MEAS_FRL_MEASURE_16_get_vact_cnt(data)

#define  HD20_MEAS_FRL_MEASURE_18_hs_period_mask               HDMI20_P0_MEAS_FRL_MEASURE_18_hs_period_mask
#define  HD20_MEAS_FRL_MEASURE_18_hs_period(data)              HDMI20_P0_MEAS_FRL_MEASURE_18_hs_period(data)
#define  HD20_MEAS_FRL_MEASURE_18_get_hs_period(data)          HDMI20_P0_MEAS_FRL_MEASURE_18_get_hs_period(data)
...
#define HDMI21_MAC1_BASE           (HDMI21_P1_HD21_CR_reg)
#define HDMI21_MAC2_BASE           (HDMI21_P2_HD21_CR_reg)
#define HDMI21_MAC3_BASE           (HDMI21_P3_HD21_CR_reg)
