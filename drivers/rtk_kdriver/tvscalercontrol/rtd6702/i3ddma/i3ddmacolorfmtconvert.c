...
char I3DDMA_4xxto4xx_Downsample(I3DDMA_COLOR_SPACE_T source, I3DDMA_COLOR_SPACE_T target) {
	...
	if(((source == I3DDMA_COLOR_YUV444) || (source == I3DDMA_COLOR_RGB)) && (drvif_I3DDMA_Get_Input_Info_Vaule(I3DDMA_INFO_TARGET_COLOR)==I3DDMA_COLOR_YUV422)){
		drvif_color_set_HDMI_444to422_Enable(1,1,0,0);//444to422=1;drop=1;delay=0;sel=rgb2yuv out
	}else {
		drvif_color_set_HDMI_444to422_Enable(0,1,0,0);//444to422=0;drop=1;delay=0;sel=rgb2yuv out
	}
