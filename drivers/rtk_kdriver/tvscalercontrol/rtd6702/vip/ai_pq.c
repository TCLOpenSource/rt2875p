...
void drvif_color_AI_obj_decont_init(unsigned char enable)//mk2
{
	...
	ipq_decontour_decont_ai_uv_1_reg.decont_ai_uv_en = enable;
	ipq_decontour_decont_ai_1_reg.decont_ai_ros_en = enable;
	ipq_decontour_decont_ai_4_reg.decont_ai_en = enable;
	ipq_decontour_decont_ai_5_reg.ai_region_0_en = enable;
	ipq_decontour_decont_ai_6_reg.ai_region_1_en = enable;
	ipq_decontour_decont_ai_7_reg.ai_region_2_en = enable;
	ipq_decontour_decont_ai_8_reg.ai_region_3_en = enable;
	ipq_decontour_decont_ai_9_reg.ai_region_4_en = enable;
	ipq_decontour_decont_ai_10_reg.ai_region_5_en = enable;
	ipq_decontour_bdecont_ai_0_reg.bdecont_ai_en = enable;
...
void drvif_color_AI_obj_icm_set(AI_ICM_apply face_icm_apply_f[6])
{
	...
	dcc_d_dcc_ai_10_reg.ai_region_end_j_2	= min(2159,face_icm_apply_f[2].pos_y_s+(face_icm_apply_f[2].h12>>2)+(face_icm_apply_f[2].h12>>3));
...
void drvif_color_AI_obj_dcc_set(AI_DCC_apply face_dcc_apply_f[6])
{
	...
	dcc_d_dcc_ai_10_reg.ai_region_end_j_2	= min(2159,face_dcc_apply_f[2].pos_y_s+(face_dcc_apply_f[2].h12>>2)+(face_dcc_apply_f[2].h12>>3));
...
// end yush 190815
	...
	if(z_face_weight>0)
	{
		...
		color_sharp_shp_cds_region0_5_RBUS reg_color_sharp_shp_cds_region0_5_reg;
...
// end yush 190815
		...
		reg_color_sharp_shp_cds_region0_5_reg.regValue=IoReg_Read32(COLOR_SHARP_SHP_CDS_REGION0_5_reg);
		...
		reg_color_sharp_shp_cds_region0_5_reg.cds_region_0_start_i=max(0,z_cds_AIInfo->cy12-(z_cds_AIInfo->h12>>1));
		reg_color_sharp_shp_cds_region0_5_reg.cds_region_0_end_i=min(2159,z_cds_AIInfo->cy12+(z_cds_AIInfo->h12>>1));
		...
		IoReg_Write32(COLOR_SHARP_SHP_CDS_REGION0_5_reg,reg_color_sharp_shp_cds_region0_5_reg.regValue);
	}
	else
	{
		color_sharp_shp_cds_region0_0_RBUS reg_color_sharp_shp_cds_region0_0_reg;
		...
		reg_color_sharp_shp_cds_region0_0_reg.cds_region_0_smooth=c_cds_region_smooth;
		reg_color_sharp_shp_cds_region0_5_reg.cds_region_0_start_i=2159;
		reg_color_sharp_shp_cds_region0_5_reg.cds_region_0_end_i=0;
...
// end yush 190815
	...
	if(z_face_weight>0)
	{
		...
		color_sharp_shp_cds_region1_5_RBUS reg_color_sharp_shp_cds_region1_5_reg;
		if(y_face_max<z_face_weight){y_face_max=z_face_weight;}
// yush 190815
...
// end yush 190815
		...
		reg_color_sharp_shp_cds_region1_5_reg.regValue=IoReg_Read32(COLOR_SHARP_SHP_CDS_REGION1_5_reg);
		reg_color_sharp_shp_cds_region_enable_reg.cds_region_0_enable_1=1;
		reg_color_sharp_shp_cds_region1_0_reg.cds_region_1_smooth=c_cds_region_smooth;
		reg_color_sharp_shp_cds_region1_5_reg.cds_region_1_start_i=max(0,z_cds_AIInfo->cy12-(z_cds_AIInfo->h12>>1));
		reg_color_sharp_shp_cds_region1_5_reg.cds_region_1_end_i=min(2159,z_cds_AIInfo->cy12+(z_cds_AIInfo->h12>>1));
		...
		IoReg_Write32(COLOR_SHARP_SHP_CDS_REGION1_5_reg,reg_color_sharp_shp_cds_region1_5_reg.regValue);
	}
	else
	{
		color_sharp_shp_cds_region1_1_RBUS reg_color_sharp_shp_cds_region1_1_reg;
		...
		reg_color_sharp_shp_cds_region1_5_reg.cds_region_1_start_i=2159;
		reg_color_sharp_shp_cds_region1_5_reg.cds_region_1_end_i=0;
...
// end yush 190815
	...
	if(z_face_weight>0)
	{
		...
		color_sharp_shp_cds_region2_5_RBUS reg_color_sharp_shp_cds_region2_5_reg;
		if(y_face_max<z_face_weight){y_face_max=z_face_weight;}
// yush 190815
...
// end yush 190815
		...
		reg_color_sharp_shp_cds_region2_5_reg.regValue=IoReg_Read32(COLOR_SHARP_SHP_CDS_REGION2_5_reg);
		reg_color_sharp_shp_cds_region_enable_reg.cds_region_0_enable_2=1;
		reg_color_sharp_shp_cds_region2_0_reg.cds_region_2_smooth=c_cds_region_smooth;
		reg_color_sharp_shp_cds_region2_5_reg.cds_region_2_start_i=max(0,z_cds_AIInfo->cy12-(z_cds_AIInfo->h12>>1));
		reg_color_sharp_shp_cds_region2_5_reg.cds_region_2_end_i=min(2159,z_cds_AIInfo->cy12+(z_cds_AIInfo->h12>>1));
		...
		IoReg_Write32(COLOR_SHARP_SHP_CDS_REGION2_5_reg,reg_color_sharp_shp_cds_region2_5_reg.regValue);
	}
	else
	{
		color_sharp_shp_cds_region2_1_RBUS reg_color_sharp_shp_cds_region2_1_reg;
		...
		reg_color_sharp_shp_cds_region2_5_reg.cds_region_2_start_i=2159;
		reg_color_sharp_shp_cds_region2_5_reg.cds_region_2_end_i=0;
...
// end yush 190815
	...
	if(z_face_weight>0)
	{
		...
		color_sharp_shp_cds_region3_5_RBUS reg_color_sharp_shp_cds_region3_5_reg;
		if(y_face_max<z_face_weight){y_face_max=z_face_weight;}
// yush 190815
...
// end yush 190815
		...
		reg_color_sharp_shp_cds_region3_5_reg.regValue=IoReg_Read32(COLOR_SHARP_SHP_CDS_REGION3_5_reg);
		reg_color_sharp_shp_cds_region_enable_reg.cds_region_0_enable_3=1;
		reg_color_sharp_shp_cds_region3_0_reg.cds_region_3_smooth=c_cds_region_smooth;
		reg_color_sharp_shp_cds_region3_5_reg.cds_region_3_start_i=max(0,z_cds_AIInfo->cy12-(z_cds_AIInfo->h12>>1));
		reg_color_sharp_shp_cds_region3_5_reg.cds_region_3_end_i=min(2159,z_cds_AIInfo->cy12+(z_cds_AIInfo->h12>>1));
		...
		IoReg_Write32(COLOR_SHARP_SHP_CDS_REGION3_5_reg,reg_color_sharp_shp_cds_region3_5_reg.regValue);
	}
	else
	{
		color_sharp_shp_cds_region3_1_RBUS reg_color_sharp_shp_cds_region3_1_reg;
		...
		reg_color_sharp_shp_cds_region3_5_reg.cds_region_3_start_i=2159;
		reg_color_sharp_shp_cds_region3_5_reg.cds_region_3_end_i=0;
...
//(1) global setting ///////////////
	...
	ai_ctrl.ai_global.db_bypass = ptr->ai_global.db_bypass;// k8 ai_face
...
//(13) shp tuning
	...
	ai_ctrl.ai_global3.AI_decont_en = ptr->ai_global3.AI_decont_en;
    ai_ctrl.ai_global.decont_uv_blend_ratio0 = ptr->ai_global.decont_uv_blend_ratio0;
    ai_ctrl.ai_global.decont_uv_blend_ratio1 = ptr->ai_global.decont_uv_blend_ratio1;
    ai_ctrl.ai_global.decont_uv_blend_ratio2 = ptr->ai_global.decont_uv_blend_ratio2;
    ai_ctrl.ai_global.decont_uv_blend_ratio3 = ptr->ai_global.decont_uv_blend_ratio3;
    ai_ctrl.ai_global.decont_uv_blend_ratio4 = ptr->ai_global.decont_uv_blend_ratio4;
    ai_ctrl.ai_global.decont_uv_blend_ratio5 = ptr->ai_global.decont_uv_blend_ratio5;
    ai_ctrl.ai_global.decont_uv_blend_ratio6 = ptr->ai_global.decont_uv_blend_ratio6;
    ai_ctrl.ai_global.decont_uv_blend_ratio7 = ptr->ai_global.decont_uv_blend_ratio7;
    ai_ctrl.ai_global.decont_inside_ratio = ptr->ai_global.decont_inside_ratio;
	...
	//(15) decont_blending_setting ///////////

	ai_ctrl.ai_decont_blend.d_change_speed_default = ptr->ai_decont_blend.d_change_speed_default;
	ai_ctrl.ai_decont_blend.change_speed_default = ptr->ai_decont_blend.change_speed_default;

	// disappear //////
	ai_ctrl.ai_decont_blend.val_diff_loth = ptr->ai_decont_blend.val_diff_loth;
	ai_ctrl.ai_decont_blend.d_change_speed_val_loth = ptr->ai_decont_blend.d_change_speed_val_loth;
	ai_ctrl.ai_decont_blend.d_change_speed_val_hith = ptr->ai_decont_blend.d_change_speed_val_hith;
	ai_ctrl.ai_decont_blend.d_change_speed_val_slope = ptr->ai_decont_blend.d_change_speed_val_slope;
	ai_ctrl.ai_decont_blend.IOU_diff_loth = ptr->ai_decont_blend.IOU_diff_loth;
	ai_ctrl.ai_decont_blend.d_change_speed_IOU_loth = ptr->ai_decont_blend.d_change_speed_IOU_loth;
	ai_ctrl.ai_decont_blend.d_change_speed_IOU_hith = ptr->ai_decont_blend.d_change_speed_IOU_hith;
	ai_ctrl.ai_decont_blend.d_change_speed_IOU_slope = ptr->ai_decont_blend.d_change_speed_IOU_slope;
	ai_ctrl.ai_decont_blend.size_diff_loth = ptr->ai_decont_blend.size_diff_loth;
	ai_ctrl.ai_decont_blend.d_change_speed_size_loth = ptr->ai_decont_blend.d_change_speed_size_loth;
	ai_ctrl.ai_decont_blend.d_change_speed_size_hith = ptr->ai_decont_blend.d_change_speed_size_hith;
	ai_ctrl.ai_decont_blend.d_change_speed_size_slope = ptr->ai_decont_blend.d_change_speed_size_slope;

	// appear //////

	ai_ctrl.ai_decont_blend.val_diff_loth_a = ptr->ai_decont_blend.val_diff_loth_a;
	ai_ctrl.ai_decont_blend.d_change_speed_val_loth_a = ptr->ai_decont_blend.d_change_speed_val_loth_a;
	ai_ctrl.ai_decont_blend.d_change_speed_val_hith_a = ptr->ai_decont_blend.d_change_speed_val_hith_a;
	ai_ctrl.ai_decont_blend.d_change_speed_val_slope_a = ptr->ai_decont_blend.d_change_speed_val_slope_a;
	ai_ctrl.ai_decont_blend.IOU_diff_loth_a = ptr->ai_decont_blend.IOU_diff_loth_a;
	ai_ctrl.ai_decont_blend.d_change_speed_IOU_loth_a = ptr->ai_decont_blend.d_change_speed_IOU_loth_a;
	ai_ctrl.ai_decont_blend.d_change_speed_IOU_hith_a = ptr->ai_decont_blend.d_change_speed_IOU_hith_a;
	ai_ctrl.ai_decont_blend.d_change_speed_IOU_slope_a = ptr->ai_decont_blend.d_change_speed_IOU_slope_a;
	ai_ctrl.ai_decont_blend.size_diff_loth_a = ptr->ai_decont_blend.size_diff_loth_a;
	ai_ctrl.ai_decont_blend.d_change_speed_size_loth_a = ptr->ai_decont_blend.d_change_speed_size_loth_a;
	ai_ctrl.ai_decont_blend.d_change_speed_size_hith_a = ptr->ai_decont_blend.d_change_speed_size_hith_a;
	ai_ctrl.ai_decont_blend.d_change_speed_size_slope_a = ptr->ai_decont_blend.d_change_speed_size_slope_a;
	ai_ctrl.ai_decont_blend.blend_hith = ptr->ai_decont_blend.blend_hith;
...
//(1) global setting ///////////////
		...
		ptr->ai_global.db_bypass = ai_ctrl.ai_global.db_bypass;// k8 ai_face
...
// (14) global3 setting
		...
		ptr->ai_global3.AI_decont_en = ai_ctrl.ai_global3.AI_decont_en;
	    ptr->ai_global.decont_uv_blend_ratio0 = ai_ctrl.ai_global.decont_uv_blend_ratio0;
	    ptr->ai_global.decont_uv_blend_ratio1 = ai_ctrl.ai_global.decont_uv_blend_ratio1;
	    ptr->ai_global.decont_uv_blend_ratio2 = ai_ctrl.ai_global.decont_uv_blend_ratio2;
	    ptr->ai_global.decont_uv_blend_ratio3 = ai_ctrl.ai_global.decont_uv_blend_ratio3;
	    ptr->ai_global.decont_uv_blend_ratio4 = ai_ctrl.ai_global.decont_uv_blend_ratio4;
	    ptr->ai_global.decont_uv_blend_ratio5 = ai_ctrl.ai_global.decont_uv_blend_ratio5;
	    ptr->ai_global.decont_uv_blend_ratio6 = ai_ctrl.ai_global.decont_uv_blend_ratio6;
	    ptr->ai_global.decont_uv_blend_ratio7 = ai_ctrl.ai_global.decont_uv_blend_ratio7;
	    ptr->ai_global.decont_inside_ratio = ai_ctrl.ai_global.decont_inside_ratio;
...
//(15) decont_blending_setting ///////////
        ...
        ptr->ai_decont_blend.d_change_speed_default = ai_ctrl.ai_decont_blend.d_change_speed_default;
        ptr->ai_decont_blend.change_speed_default = ai_ctrl.ai_decont_blend.change_speed_default;

	// disappear //////
        ptr->ai_decont_blend.val_diff_loth = ai_ctrl.ai_decont_blend.val_diff_loth;
        ptr->ai_decont_blend.d_change_speed_val_loth = ai_ctrl.ai_decont_blend.d_change_speed_val_loth;
        ptr->ai_decont_blend.d_change_speed_val_hith = ai_ctrl.ai_decont_blend.d_change_speed_val_hith;
        ptr->ai_decont_blend.d_change_speed_val_slope = ai_ctrl.ai_decont_blend.d_change_speed_val_slope;
        ptr->ai_decont_blend.IOU_diff_loth = ai_ctrl.ai_decont_blend.IOU_diff_loth;
        ptr->ai_decont_blend.d_change_speed_IOU_loth = ai_ctrl.ai_decont_blend.d_change_speed_IOU_loth;
        ptr->ai_decont_blend.d_change_speed_IOU_hith = ai_ctrl.ai_decont_blend.d_change_speed_IOU_hith;
        ptr->ai_decont_blend.d_change_speed_IOU_slope = ai_ctrl.ai_decont_blend.d_change_speed_IOU_slope;
        ptr->ai_decont_blend.size_diff_loth = ai_ctrl.ai_decont_blend.size_diff_loth;
        ptr->ai_decont_blend.d_change_speed_size_loth = ai_ctrl.ai_decont_blend.d_change_speed_size_loth;
        ptr->ai_decont_blend.d_change_speed_size_hith = ai_ctrl.ai_decont_blend.d_change_speed_size_hith;
        ptr->ai_decont_blend.d_change_speed_size_slope = ai_ctrl.ai_decont_blend.d_change_speed_size_slope;



	// appear //////

        ptr->ai_decont_blend.val_diff_loth_a = ai_ctrl.ai_decont_blend.val_diff_loth_a;
        ptr->ai_decont_blend.d_change_speed_val_loth_a = ai_ctrl.ai_decont_blend.d_change_speed_val_loth_a;
        ptr->ai_decont_blend.d_change_speed_val_hith_a = ai_ctrl.ai_decont_blend.d_change_speed_val_hith_a;
        ptr->ai_decont_blend.d_change_speed_val_slope_a = ai_ctrl.ai_decont_blend.d_change_speed_val_slope_a;
        ptr->ai_decont_blend.IOU_diff_loth_a = ai_ctrl.ai_decont_blend.IOU_diff_loth_a;
        ptr->ai_decont_blend.d_change_speed_IOU_loth_a = ai_ctrl.ai_decont_blend.d_change_speed_IOU_loth_a;
        ptr->ai_decont_blend.d_change_speed_IOU_hith_a = ai_ctrl.ai_decont_blend.d_change_speed_IOU_hith_a;
        ptr->ai_decont_blend.d_change_speed_IOU_slope_a = ai_ctrl.ai_decont_blend.d_change_speed_IOU_slope_a;
        ptr->ai_decont_blend.size_diff_loth_a = ai_ctrl.ai_decont_blend.size_diff_loth_a;
        ptr->ai_decont_blend.d_change_speed_size_loth_a = ai_ctrl.ai_decont_blend.d_change_speed_size_loth_a;
        ptr->ai_decont_blend.d_change_speed_size_hith_a = ai_ctrl.ai_decont_blend.d_change_speed_size_hith_a;
        ptr->ai_decont_blend.d_change_speed_size_slope_a = ai_ctrl.ai_decont_blend.d_change_speed_size_slope_a;
        ptr->ai_decont_blend.blend_hith = ai_ctrl.ai_decont_blend.blend_hith;
...
void drvif_color_AI_decont_table_set(AI_Decont_Ctrl_table *tbl) // mk2
{
	ipq_decontour_decont_ai_uv_1_RBUS ipq_decontour_decont_ai_uv_1_reg;
...
void drvif_color_AI_PQ_set_mnr(int basic_pq_val[PQ_IP_TYPE_NUM][PQ_TUNING_NUM], int pq_offset[PQ_IP_TYPE_NUM][PQ_TUNING_NUM])
{
	...
	nr_mosquito_nr_level_ctrl_RBUS_reg.mosquitonr_nlevel_positive_offset = clip( 0, 255, basic_pq_val[PQ_IP_NR][0]+pq_offset[PQ_IP_NR][0]);
	nr_mosquito_nr_level_ctrl_RBUS_reg.mosquitonr_nlevel_positive_shift = clip( 0, 255, basic_pq_val[PQ_IP_NR][1]+pq_offset[PQ_IP_NR][1]);
	nr_mosquito_nr_level_ctrl_RBUS_reg.mosquitonr_nlevel_negative_offset = clip( 0, 255, basic_pq_val[PQ_IP_NR][2]+pq_offset[PQ_IP_NR][2]);
	nr_mosquito_nr_level_ctrl_RBUS_reg.mosquitonr_nlevel_negative_shift = clip( 0, 255, basic_pq_val[PQ_IP_NR][3]+pq_offset[PQ_IP_NR][3]);
...
void drvif_color_AI_PQ_set_decontour(int basic_pq_val[PQ_IP_TYPE_NUM][PQ_TUNING_NUM], int pq_offset[PQ_IP_TYPE_NUM][PQ_TUNING_NUM])
{
	...
	bdecont_alpha_ydiff4_reg.bdecont_alpha_by_ydiff0	= clip( 0, 63, basic_pq_val[PQ_IP_NR][5]+pq_offset[PQ_IP_NR][5]);
	bdecont_alpha_ydiff3_reg.bdecont_alpha_by_ydiff1	= clip( 0, 63, basic_pq_val[PQ_IP_NR][6]+pq_offset[PQ_IP_NR][6]);
	bdecont_alpha_ydiff3_reg.bdecont_alpha_by_ydiff2	= clip( 0, 63, basic_pq_val[PQ_IP_NR][7]+pq_offset[PQ_IP_NR][7]);
	bdecont_alpha_ydiff3_reg.bdecont_alpha_by_ydiff3	= clip( 0, 63, basic_pq_val[PQ_IP_NR][8]+pq_offset[PQ_IP_NR][8]);
	bdecont_alpha_ydiff3_reg.bdecont_alpha_by_ydiff4	= clip( 0, 63, basic_pq_val[PQ_IP_NR][9]+pq_offset[PQ_IP_NR][9]);
	bdecont_alpha_ydiff2_reg.bdecont_alpha_by_ydiff5	= clip( 0, 63, basic_pq_val[PQ_IP_NR][10]+pq_offset[PQ_IP_NR][10]);
	bdecont_alpha_ydiff2_reg.bdecont_alpha_by_ydiff6	= clip( 0, 63, basic_pq_val[PQ_IP_NR][11]+pq_offset[PQ_IP_NR][11]);
	bdecont_alpha_ydiff2_reg.bdecont_alpha_by_ydiff7	= clip( 0, 63, basic_pq_val[PQ_IP_NR][12]+pq_offset[PQ_IP_NR][12]);
	bdecont_alpha_ydiff2_reg.bdecont_alpha_by_ydiff8	= clip( 0, 63, basic_pq_val[PQ_IP_NR][13]+pq_offset[PQ_IP_NR][13]);
	bdecont_alpha_ydiff1_reg.bdecont_alpha_by_ydiff9	= clip( 0, 63, basic_pq_val[PQ_IP_NR][14]+pq_offset[PQ_IP_NR][14]);
	bdecont_alpha_ydiff1_reg.bdecont_alpha_by_ydiff10	= clip( 0, 63, basic_pq_val[PQ_IP_NR][15]+pq_offset[PQ_IP_NR][15]);
	bdecont_alpha_ydiff1_reg.bdecont_alpha_by_ydiff11	= clip( 0, 63, basic_pq_val[PQ_IP_NR][16]+pq_offset[PQ_IP_NR][16]);
	bdecont_alpha_ydiff1_reg.bdecont_alpha_by_ydiff12	= clip( 0, 63, basic_pq_val[PQ_IP_NR][17]+pq_offset[PQ_IP_NR][17]);
	bdecont_alpha_ydiff0_reg.bdecont_alpha_by_ydiff13	= clip( 0, 63, basic_pq_val[PQ_IP_NR][18]+pq_offset[PQ_IP_NR][18]);
	bdecont_alpha_ydiff0_reg.bdecont_alpha_by_ydiff14	= clip( 0, 63, basic_pq_val[PQ_IP_NR][19]+pq_offset[PQ_IP_NR][19]);
	//bdecont_alpha_ydiff0_reg.bdecont_alpha_by_ydiff15	= ptr->bdecont_alpha_by_ydiff[15];


	IoReg_Write32(IPQ_DECONTOUR_BLK_De_Contour_Alpha_Ydiff0_reg, bdecont_alpha_ydiff0_reg.regValue);
	IoReg_Write32(IPQ_DECONTOUR_BLK_De_Contour_Alpha_Ydiff1_reg, bdecont_alpha_ydiff1_reg.regValue);
        IoReg_Write32(IPQ_DECONTOUR_BLK_De_Contour_Alpha_Ydiff2_reg, bdecont_alpha_ydiff2_reg.regValue);
        IoReg_Write32(IPQ_DECONTOUR_BLK_De_Contour_Alpha_Ydiff3_reg, bdecont_alpha_ydiff3_reg.regValue);
        IoReg_Write32(IPQ_DECONTOUR_BLK_De_Contour_Alpha_Ydiff4_reg, bdecont_alpha_ydiff4_reg.regValue);



/*
	aa[0] = clip( 0, 63, basic_pq_val[PQ_IP_NR][0]+pq_offset[PQ_IP_NR][0]);
	aa[1] = clip( 0, 63, basic_pq_val[PQ_IP_NR][1]+pq_offset[PQ_IP_NR][1]);
	aa[2] = clip( 0, 63, basic_pq_val[PQ_IP_NR][2]+pq_offset[PQ_IP_NR][2]);
	aa[3] = clip( 0, 63, basic_pq_val[PQ_IP_NR][3]+pq_offset[PQ_IP_NR][3]);
	aa[4] = clip( 0, 63, basic_pq_val[PQ_IP_NR][4]+pq_offset[PQ_IP_NR][4]);
	aa[5] = clip( 0, 63, basic_pq_val[PQ_IP_NR][5]+pq_offset[PQ_IP_NR][5]);
	aa[6] = clip( 0, 63, basic_pq_val[PQ_IP_NR][6]+pq_offset[PQ_IP_NR][6]);
	aa[7] = clip( 0, 63, basic_pq_val[PQ_IP_NR][7]+pq_offset[PQ_IP_NR][7]);
	aa[8] = clip( 0, 63, basic_pq_val[PQ_IP_NR][8]+pq_offset[PQ_IP_NR][8]);
	aa[9] = clip( 0, 63, basic_pq_val[PQ_IP_NR][9]+pq_offset[PQ_IP_NR][9]);
	aa[10] = clip( 0, 63, basic_pq_val[PQ_IP_NR][10]+pq_offset[PQ_IP_NR][10]);
	aa[11] = clip( 0, 63, basic_pq_val[PQ_IP_NR][11]+pq_offset[PQ_IP_NR][11]);
	aa[12] = clip( 0, 63, basic_pq_val[PQ_IP_NR][12]+pq_offset[PQ_IP_NR][12]);
	aa[13] = clip( 0, 63, basic_pq_val[PQ_IP_NR][13]+pq_offset[PQ_IP_NR][13]);
	aa[14] = clip( 0, 63, basic_pq_val[PQ_IP_NR][14]+pq_offset[PQ_IP_NR][14]);
	aa[15] = clip( 0, 63, basic_pq_val[PQ_IP_NR][15]+pq_offset[PQ_IP_NR][15]);
	aa[16] = clip( 0, 63, basic_pq_val[PQ_IP_NR][16]+pq_offset[PQ_IP_NR][16]);
	aa[17] = clip( 0, 63, basic_pq_val[PQ_IP_NR][17]+pq_offset[PQ_IP_NR][17]);

	for(i=0;i<18;i++){

	rtd_printk(KERN_EMERG, TAG_NAME, "rord aa[%d] %d , idx9 %d , offset[%d] \n",i,aa[i],basic_pq_val[PQ_IP_NR][i],pq_offset[PQ_IP_NR][i]);
...
{
	int tmp;
	tmp = *value + scalerAI_PQ_offset_get(PQ_IP_NR, 4);	
