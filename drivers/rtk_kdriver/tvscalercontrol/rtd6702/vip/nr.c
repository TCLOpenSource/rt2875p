...
void drvif_color_nr_curvemapping_weight1_set(unsigned short w1[9])
{
	...
	curve_mapping_w1_1_reg.curvemapping_w1_0 = w1[0];
	curve_mapping_w1_1_reg.curvemapping_w1_1 = w1[1];
	curve_mapping_w1_1_reg.curvemapping_w1_2 = w1[2];
	curve_mapping_w1_1_reg.curvemapping_w1_3 = w1[3];
	curve_mapping_w1_2_reg.curvemapping_w1_4 = w1[4];
	curve_mapping_w1_2_reg.curvemapping_w1_5 = w1[5];
	curve_mapping_w1_2_reg.curvemapping_w1_6 = w1[6];
	curve_mapping_w1_2_reg.curvemapping_w1_7 = w1[7];
	curve_mapping_w1_3_reg.curvemapping_w1_8 = w1[8];
...
void drvif_color_iEdgeSmooth_en(unsigned char enable)
{
	...
	if(get_vsc_run_pc_mode() && (get_scaler_connect_source(SLR_MAIN_DISPLAY) == _SRC_HDMI))	//RGB444
...
/* end ylchen 150617 */
	...
	di_im_new_mcnr_control3.n_mcnr_only_h_c_en								= DI_IM_DI_RTNR_NEW_CONTROL_get_rtnr_8k_en(IoReg_Read32(DI_IM_DI_RTNR_NEW_CONTROL_reg)); //ptr->MCNR_Control2.n_mcnr_only_h_c_en;
...
void drvif_color_DRV_SNR_Modified_LPF(DRV_SNR_Modified_LPF *ptr)
{
	...
	nr_new_lpf_type_thd_RBUS nr_new_lpf_type_thd_reg;
	dch1_cp_ctrl_reg.regValue = IoReg_Read32(NR_DCH1_CP_Ctrl_reg);
	new_lpf_nearby_ctrl_reg.regValue = IoReg_Read32(NR_NEW_LPF_NEARBY_CTRL_reg);
	...
	nr_new_lpf_type_thd_reg.regValue = IoReg_Read32(NR_NEW_LPF_TYPE_THD_reg); // Merlin6 add
	...
	nr_new_lpf_type_thd_reg.modified_lpf_type_mode = ptr->SNR_modified_lpf_type_mode; // Merlin6 add
	nr_new_lpf_type_thd_reg.modified_lpf_type_th = ptr->SNR_modified_lpf_type_th; // Merlin6 add
	...
	IoReg_Write32(NR_NEW_LPF_TYPE_THD_reg, nr_new_lpf_type_thd_reg.regValue);// Merlin6 add
	IoReg_SetBits(NR_SNR_DB_CTRL_reg, NR_SNR_DB_CTRL_snr_db_apply_mask); /* DB apply */
}
...
void drvif_color_DRV_SNR_NR_Mask(DRV_SNR_NR_Mask *ptr)/* mk2 */
{
	...
	dch1_MASK1_CTRL2_Reg.cp_mask1_maplimit = (ptr->SNR_Mask1_Limit);
	...
	dch1_MASK2_CTRL2_Reg.cp_mask2_maplimit = (ptr->SNR_Mask2_Limit);
	...
	dch1_MASK3_CTRL2_Reg.cp_mask3_maplimit = (ptr->SNR_Mask3_Limit);
...
void drvif_color_DRV_SNR_NR_Mask_W1W2(DRV_SNR_NR_Mask_W1W2 *ptr)  /*Mac3, leonard wu@20140722*//* mk2 */
{
...
void drvif_color_DRV_SNR_Veritcal_NR(DRV_SNR_Veritcal_NR *ptr)
{
	...
	if(get_vsc_run_pc_mode() && (get_scaler_connect_source(SLR_MAIN_DISPLAY) == _SRC_HDMI))
	...
	IoReg_SetBits(IEDGE_SMOOTH_EDSM_DB_CTRL_reg, IEDGE_SMOOTH_EDSM_DB_CTRL_edsm_db_apply_mask); /* DB apply */ // mk2
}
...
void drvif_color_DRV_SNR_Mosquito_NR(DRV_SNR_Mosquito_NR *ptr)
{
	...
	nr_mosquito_ctrl_RBUS_reg.mnr_edge78_smooth_en = ptr->MNR_edge78_en;//merlin6 add
	nr_mosquito_ctrl_RBUS_reg.mnr_line_protect_en = ptr->MNR_line_protect_en;//merlin6 add
...
char drvif_color_MA_SNR_check(void)//mk2
{
	char status = 0;
	...
	status = getMotion_main_reg.rtnr_isnr_getmotion_en || nr_motion_weight_ctrl_reg.nr_motion_en || eng_clamp_reg.iedsm_motion_en || vfilter_6_reg.egsm_avlpf_motion_en;

	return status;
}

void drvif_color_DRV_SNR_Mosquito_NR_blk(DRV_SNR_Mosquito_NR_blk *ptr)//mk2
{
	nr_mosquito_ctrl_RBUS nr_mosquito_ctrl_RBUS_reg;
	nr_mosquito_nr_blk_ctrl_1_RBUS nr_mosquito_nr_blk_ctrl_1_reg;
	nr_mosquito_nr_blk_ctrl_2_RBUS nr_mosquito_nr_blk_ctrl_2_reg;
	nr_mosquito_nr_blk_ctrl_3_RBUS nr_mosquito_nr_blk_ctrl_3_reg;
	nr_mosquito_nr_blk_ctrl_4_RBUS nr_mosquito_nr_blk_ctrl_4_reg;
	nr_spnr_act_width_RBUS nr_spnr_act_width_reg;
	nr_spnr_act_length_RBUS nr_spnr_act_length_reg;

	nr_mosquito_ctrl_RBUS_reg.regValue = IoReg_Read32(NR_MOSQUITO_CTRL_reg);
	nr_mosquito_nr_blk_ctrl_1_reg.regValue = IoReg_Read32(NR_MOSQUITO_NR_BLK_CTRL_1_reg);
	nr_mosquito_nr_blk_ctrl_2_reg.regValue = IoReg_Read32(NR_MOSQUITO_NR_BLK_CTRL_2_reg);
	nr_mosquito_nr_blk_ctrl_3_reg.regValue = IoReg_Read32(NR_MOSQUITO_NR_BLK_CTRL_3_reg);
	nr_mosquito_nr_blk_ctrl_4_reg.regValue = IoReg_Read32(NR_MOSQUITO_NR_BLK_CTRL_4_reg);
	...
	nr_mosquito_ctrl_RBUS_reg.mnr_blk_en				= (drvif_color_MA_SNR_check())?(0):(ptr->SNR_mnr_blk_en);
	nr_mosquito_ctrl_RBUS_reg.mnr_blk_mode				= ptr->SNR_mnr_blk_mode;
	nr_mosquito_nr_blk_ctrl_1_reg.mnr_ccl_maxmin_th 	= ptr->SNR_mnr_ccl_maxmin_th;
	nr_mosquito_nr_blk_ctrl_1_reg.mnr_ccl_edge			= ptr->SNR_mnr_ccl_edge;
	nr_mosquito_nr_blk_ctrl_1_reg.mnr_ccl_edge_rate		= ptr->SNR_mnr_ccl_edge_rate;
	nr_mosquito_nr_blk_ctrl_1_reg.mnr_ccl_edge_var_rate	= ptr->SNR_mnr_ccl_edge_var_rate;
	nr_mosquito_nr_blk_ctrl_1_reg.mnr_ccl_flat_rate		= ptr->SNR_mnr_ccl_flat_rate;
	nr_mosquito_nr_blk_ctrl_1_reg.mnr_ccl_rgn_cnt		= ptr->SNR_mnr_ccl_rgn_cnt;
	nr_mosquito_nr_blk_ctrl_2_reg.mnr_ccl_rgn_cnt_rate	= ptr->SNR_mnr_ccl_rgn_cnt_rate;
	nr_mosquito_nr_blk_ctrl_2_reg.mnr_ccl_diff_flat		= ptr->SNR_mnr_ccl_diff_flat;
	nr_mosquito_nr_blk_ctrl_2_reg.mnr_ccl_diff_var		= ptr->SNR_mnr_ccl_diff_var;
	nr_mosquito_nr_blk_ctrl_2_reg.mnr_ccl_adj1_th		= ptr->SNR_mnr_ccl_adj1_th;
	nr_mosquito_nr_blk_ctrl_2_reg.mnr_ccl_adj3_th		= ptr->SNR_mnr_ccl_adj3_th;
	nr_mosquito_nr_blk_ctrl_3_reg.mnr_ccl_adj_maxmin_th	= ptr->SNR_mnr_ccl_adj_maxmin_th;
	nr_mosquito_nr_blk_ctrl_3_reg.mnr_ccl_adj_wt_th		= ptr->SNR_mnr_ccl_adj_wt_th;
	nr_mosquito_nr_blk_ctrl_3_reg.mnr_ccl_adj_wt_gain	= ptr->SNR_mnr_ccl_adj_wt_gain;
	nr_mosquito_nr_blk_ctrl_3_reg.mnr_ccl_fw_wt			= ptr->SNR_mnr_ccl_fw_wt;
	nr_mosquito_nr_blk_ctrl_4_reg.ccl_modified_lpf_thd_upbnd = ptr->SNR_mnr_ccl_modified_lpf_thd_upbnd;

	nr_spnr_act_length_reg.spnr_image_height = Scaler_DispGetInputInfo(SLR_INPUT_IPV_ACT_LEN);
	nr_spnr_act_width_reg.spnr_image_width = Scaler_DispGetInputInfo(SLR_INPUT_IPH_ACT_WID);
	...
	IoReg_Write32(NR_MOSQUITO_CTRL_reg, nr_mosquito_ctrl_RBUS_reg.regValue);
	IoReg_Write32(NR_MOSQUITO_NR_BLK_CTRL_1_reg, nr_mosquito_nr_blk_ctrl_1_reg.regValue);
	IoReg_Write32(NR_MOSQUITO_NR_BLK_CTRL_2_reg, nr_mosquito_nr_blk_ctrl_2_reg.regValue);
	IoReg_Write32(NR_MOSQUITO_NR_BLK_CTRL_3_reg, nr_mosquito_nr_blk_ctrl_3_reg.regValue);
	IoReg_Write32(NR_MOSQUITO_NR_BLK_CTRL_4_reg, nr_mosquito_nr_blk_ctrl_4_reg.regValue);
...
void drvif_color_DRV_SNR_PQ_Mask(DRV_SNR_PQ_Mask *ptr)//mk2, ml7
{
	nr_snr_pq_mask_ctrl_RBUS snr_pq_mask_ctrl_reg;
	nr_snr_curve_mapping_weight3_1_RBUS snr_curve_mapping_weight3_1_reg;
	nr_snr_curve_mapping_weight3_2_RBUS snr_curve_mapping_weight3_2_reg;

	snr_pq_mask_ctrl_reg.regValue = IoReg_Read32(NR_SNR_PQ_MASK_ctrl_reg);
	snr_curve_mapping_weight3_1_reg.regValue = IoReg_Read32(NR_SNR_CURVE_MAPPING_WEIGHT3_1_reg);
	snr_curve_mapping_weight3_2_reg.regValue = IoReg_Read32(NR_SNR_CURVE_MAPPING_WEIGHT3_2_reg);

	snr_pq_mask_ctrl_reg.nr_semantic_en = ptr->SNR_semantic_en;
	snr_pq_mask_ctrl_reg.nr_semantic_mode = ptr->SNR_semantic_mode;
	snr_pq_mask_ctrl_reg.nr_fixedweight3y = ptr->SNR_fixedweight3y;
	snr_pq_mask_ctrl_reg.nr_weight3y = ptr->SNR_weight13y;
	snr_pq_mask_ctrl_reg.nr_curve_mapping_w3_0 = ptr->SNR_curvemapping_w3_0;
	
	snr_curve_mapping_weight3_1_reg.nr_curve_mapping_w3_1 = ptr->SNR_curvemapping_w3_1;
	snr_curve_mapping_weight3_1_reg.nr_curve_mapping_w3_2 = ptr->SNR_curvemapping_w3_2;
	snr_curve_mapping_weight3_1_reg.nr_curve_mapping_w3_3 = ptr->SNR_curvemapping_w3_3;
	snr_curve_mapping_weight3_1_reg.nr_curve_mapping_w3_4 = ptr->SNR_curvemapping_w3_4;
	snr_curve_mapping_weight3_2_reg.nr_curve_mapping_w3_5 = ptr->SNR_curvemapping_w3_5;
	snr_curve_mapping_weight3_2_reg.nr_curve_mapping_w3_6 = ptr->SNR_curvemapping_w3_6;
	snr_curve_mapping_weight3_2_reg.nr_curve_mapping_w3_7 = ptr->SNR_curvemapping_w3_7;
	snr_curve_mapping_weight3_2_reg.nr_curve_mapping_w3_8 = ptr->SNR_curvemapping_w3_8;
	

	IoReg_Write32(NR_SNR_PQ_MASK_ctrl_reg, snr_pq_mask_ctrl_reg.regValue);
	IoReg_Write32(NR_SNR_CURVE_MAPPING_WEIGHT3_1_reg, snr_curve_mapping_weight3_1_reg.regValue);
	IoReg_Write32(NR_SNR_CURVE_MAPPING_WEIGHT3_2_reg, snr_curve_mapping_weight3_2_reg.regValue);
	IoReg_SetBits(NR_SNR_DB_CTRL_reg, NR_SNR_DB_CTRL_snr_db_apply_mask); /* DB apply */
}
...
void drvif_color_DRV_SNR_PQ_Mask_Enable(unsigned char bEnable)
{
	...
	snr_pq_mask_ctrl_reg.nr_semantic_en = (bEnable == 0)? 0 : 1;
...
void drvif_IESM_format_convert(unsigned short display)// Merlin4 add
{
	...
	if (display == SLR_MAIN_DISPLAY) {
		...
		else if(get_vsc_run_pc_mode() && (get_scaler_connect_source(SLR_MAIN_DISPLAY) == _SRC_HDMI))
		{
			edsm_format_convert_reg.main_444_to_422_en = 0;
			edsm_format_convert_reg.main_422_to_444_en = 0;
		}
	...
	rtd_pr_vpq_info("iesm_format:main(imode=%d, rtnr=%d, %d->%d) sub(imode=%d, rtnr=%d, %d),display=%d,2Pixel=%d,hdmi_in=%d,colorFMT=%d,\n ",
...
void drvif_IESM_frontporch_set(void)
{
	...
	int fmt_422to444, is_game_mode=0;
	iedge_smooth_format_convert_RBUS edsm_format_convert_reg;
        iedge_smooth_edsm_db_ctrl_RBUS edsm_db_ctrl_reg;
	iedge_smooth_edgesmooth_ex_ctrl_RBUS edgesmooth_ex_ctrl_reg;
	extern unsigned char drv_memory_get_low_delay_game_mode_dynamic(void);
	...
	is_game_mode = drv_memory_get_low_delay_game_mode_dynamic();
	...
	printk(KERN_EMERG "[minchay][%s]front_porch_num = %d I_width=%d\n",__FUNCTION__,front_porch_num, I_width);*/
	 ...
	 if(is_game_mode)
	  linemode_limit = 1; // 5 line mode
	 else if(front_porch_num >= front_porch_num_17line && I_width <= 2048 && I_height>8)
	  linemode_limit = 3; // 17 line mode
...
// Merlin3 change
	...
	iedge_smooth_dejagging_smallword0_RBUS iedge_smooth_dejagging_smallword0;
	iedge_smooth_dejagging_smallword1_RBUS iedge_smooth_dejagging_smallword1;
	...
	iedge_smooth_dejagging_smallword0.regValue = IoReg_Read32(IEDGE_SMOOTH_dejagging_smallword0_reg);
	iedge_smooth_dejagging_smallword1.regValue = IoReg_Read32(IEDGE_SMOOTH_dejagging_smallword1_reg);
	...
	iedge_smooth_dejagging_motion_support.i_dejag_delta_tex_seg= ptr->i_dejag_delta_tex_seg;
	iedge_smooth_dejagging_motion_support.i_dejag_nondir_tex_seg= ptr->i_dejag_nondir_tex_seg;
	//scalerVIP_color_noise_dejag_detect__z_dummy[2]=ptr->IESM_smallword_weak*10+2;
	iedge_smooth_dejagging_smallword0.i_dejag_smallword_5_0 = ptr->i_dejag_smallword_5_0;
	iedge_smooth_dejagging_smallword0.i_dejag_smallword_5_1 = ptr->i_dejag_smallword_5_1;
	iedge_smooth_dejagging_smallword0.i_dejag_smallword_7_0 = ptr->i_dejag_smallword_7_0;
	iedge_smooth_dejagging_smallword0.i_dejag_smallword_7_1 = ptr->i_dejag_smallword_7_1;
	iedge_smooth_dejagging_smallword0.i_dejag_smallword_7_2 = ptr->i_dejag_smallword_7_2;
	iedge_smooth_dejagging_smallword1.i_dejag_smallword_9_0 = ptr->i_dejag_smallword_9_0;
	iedge_smooth_dejagging_smallword1.i_dejag_smallword_9_1 = ptr->i_dejag_smallword_9_1;
	iedge_smooth_dejagging_smallword1.i_dejag_smallword_9_2 = ptr->i_dejag_smallword_9_2;
	iedge_smooth_dejagging_smallword1.i_dejag_smallword_9_3 = ptr->i_dejag_smallword_9_3;
	...
	IoReg_Write32(IEDGE_SMOOTH_dejagging_smallword0_reg, iedge_smooth_dejagging_smallword0.regValue);
	IoReg_Write32(IEDGE_SMOOTH_dejagging_smallword1_reg, iedge_smooth_dejagging_smallword1.regValue);
}
void drvif_color_DRV_MA_ISNR_GetMotion(DRV_MA_ISNR_GetMotion *ptr)
{
	...
	if (ptr->MA_isnr_Get_Motion_EdgeTh_2 != ptr->MA_isnr_Get_Motion_EdgeTh_1) {
		slope1_lm = (((unsigned int)ptr->MA_isnr_Get_Motion_MotionTh_M_1 - ptr->MA_isnr_Get_Motion_MotionTh_L_1)*32/(ptr->MA_isnr_Get_Motion_EdgeTh_2 - ptr->MA_isnr_Get_Motion_EdgeTh_1)+1) >>1;
		slope2_lm = (((unsigned int)ptr->MA_isnr_Get_Motion_MotionTh_M_2 - ptr->MA_isnr_Get_Motion_MotionTh_L_2)*32/(ptr->MA_isnr_Get_Motion_EdgeTh_2 - ptr->MA_isnr_Get_Motion_EdgeTh_1)+1) >>1;
		slope3_lm = (((unsigned int)ptr->MA_isnr_Get_Motion_MotionTh_M_3 - ptr->MA_isnr_Get_Motion_MotionTh_L_3)*32/(ptr->MA_isnr_Get_Motion_EdgeTh_2 - ptr->MA_isnr_Get_Motion_EdgeTh_1)+1) >>1;
	}
	if (ptr->MA_isnr_Get_Motion_EdgeTh_3 != ptr->MA_isnr_Get_Motion_EdgeTh_2) {
		slope1_mn = (((unsigned int)ptr->MA_isnr_Get_Motion_MotionTh_N_1 - ptr->MA_isnr_Get_Motion_MotionTh_M_1)*32/(ptr->MA_isnr_Get_Motion_EdgeTh_3 - ptr->MA_isnr_Get_Motion_EdgeTh_2)+1) >>1;
		slope2_mn = (((unsigned int)ptr->MA_isnr_Get_Motion_MotionTh_N_2 - ptr->MA_isnr_Get_Motion_MotionTh_M_2)*32/(ptr->MA_isnr_Get_Motion_EdgeTh_3 - ptr->MA_isnr_Get_Motion_EdgeTh_2)+1) >>1;
		slope3_mn = (((unsigned int)ptr->MA_isnr_Get_Motion_MotionTh_N_3 - ptr->MA_isnr_Get_Motion_MotionTh_M_3)*32/(ptr->MA_isnr_Get_Motion_EdgeTh_3 - ptr->MA_isnr_Get_Motion_EdgeTh_2)+1) >>1;
	}
	if (ptr->MA_isnr_Get_Motion_EdgeTh_4 != ptr->MA_isnr_Get_Motion_EdgeTh_3) {
		slope1_nh = (((unsigned int)ptr->MA_isnr_Get_Motion_MotionTh_H_1 - ptr->MA_isnr_Get_Motion_MotionTh_N_1)*32/(ptr->MA_isnr_Get_Motion_EdgeTh_4 - ptr->MA_isnr_Get_Motion_EdgeTh_3)+1) >>1;
		slope2_nh = (((unsigned int)ptr->MA_isnr_Get_Motion_MotionTh_H_2 - ptr->MA_isnr_Get_Motion_MotionTh_N_2)*32/(ptr->MA_isnr_Get_Motion_EdgeTh_4 - ptr->MA_isnr_Get_Motion_EdgeTh_3)+1) >>1;
		slope3_nh = (((unsigned int)ptr->MA_isnr_Get_Motion_MotionTh_H_3 - ptr->MA_isnr_Get_Motion_MotionTh_N_3)*32/(ptr->MA_isnr_Get_Motion_EdgeTh_4 - ptr->MA_isnr_Get_Motion_EdgeTh_3)+1) >>1;
	}
...
unsigned char  drvif_color_Set_I_De_Contour(VIP_I_De_Contour_TBL *ptr)
{
	...
	ipq_decontour_de_contour_ctrl_reg.decont_blend_semantic_en = ptr->decont_blend_semantic_en;//mk2
...
void drvif_color_Set_I_De_Contour_PQ_Mask_Enable(unsigned int bEnable) {
	...
	ipq_decontour_de_contour_ctrl_reg.decont_blend_semantic_en = (bEnable == 0)? 0 : 1;
...
void drvif_color_Set_Block_DeContour_Ctrl(DRV_Block_DeContour_Ctrl *ptr)
{
	...
	blk_de_contour_ctrl_reg.bdecont_dither_temporal_enable = ptr->bdecont_dither_temporal_enable;	// mk2
	blk_de_contour_ctrl_reg.bdecont_dither_value_sign 		= ptr->bdecont_dither_value_sign;		// mk2
	blk_de_contour_ctrl_reg.bdecont_diff_clamp_en 			= ptr->bdecont_diff_clamp_en;			// mk2
	blk_de_contour_ctrl_reg.bdecont_blend_semantic_en = ptr->bdecont_blend_semantic_en;				// mk2
...
unsigned char  drvif_color_Get_Block_DeContour_Ctrl(DRV_Block_DeContour_Ctrl *ptr)
{
	...
	ptr->bdecont_en = blk_de_contour_ctrl_reg.bdecont_en;
	ptr->bdecont_en_c = blk_de_contour_ctrl_reg.bdecont_en_c;
	ptr->bdecont_tenable = blk_de_contour_ctrl_reg.bdecont_tenable;
	ptr->bdecont_dither_en = blk_de_contour_ctrl_reg.bdecont_dither_en;
	ptr->bdecont_profile_diff_gain_en = blk_de_contour_ctrl_reg.bdecont_profile_diff_gain_en;
	ptr->bdecont_diff_clamp_en = blk_de_contour_ctrl_reg.bdecont_diff_clamp_en;
	ptr->bdecont_blend_semantic_en = blk_de_contour_ctrl_reg.bdecont_blend_semantic_en;
...
void drvif_color_Set_Block_DeContour_PQ_Mask_Enable(unsigned char bEnable) {
	...
	blk_de_contour_ctrl_reg.bdecont_blend_semantic_en = (bEnable == 0)? 0 : 1;
...
void drvif_color_Set_Block_DeContour_Dither(DRV_Block_DeContour_Dither *ptr)
{
	...
	ipq_decontour_bdecont_dither_seq_y_00_15_RBUS bdecont_dither_seq_y_00_15_reg;
	ipq_decontour_bdecont_dither_seq_y_16_31_RBUS bdecont_dither_seq_y_16_31_reg;
	ipq_decontour_bdecont_dither_seq_u_00_15_RBUS bdecont_dither_seq_u_00_15_reg;
	ipq_decontour_bdecont_dither_seq_u_16_31_RBUS bdecont_dither_seq_u_16_31_reg;
	ipq_decontour_bdecont_dither_seq_v_00_15_RBUS bdecont_dither_seq_v_00_15_reg;
	ipq_decontour_bdecont_dither_seq_v_16_31_RBUS bdecont_dither_seq_v_16_31_reg;
	...
	ipq_decontour_bdecont_dither_temp_tb_RBUS bdecont_dither_temp_tb_reg;	

	bdecont_dither_seq_y_00_15_reg.regValue = IoReg_Read32(IPQ_DECONTOUR_BDecont_dither_SEQ_Y_00_15_reg);
	bdecont_dither_seq_y_16_31_reg.regValue = IoReg_Read32(IPQ_DECONTOUR_BDecont_dither_SEQ_Y_16_31_reg);
	bdecont_dither_seq_u_00_15_reg.regValue = IoReg_Read32(IPQ_DECONTOUR_BDecont_dither_SEQ_U_00_15_reg);
	bdecont_dither_seq_u_16_31_reg.regValue = IoReg_Read32(IPQ_DECONTOUR_BDecont_dither_SEQ_U_16_31_reg);
	bdecont_dither_seq_v_00_15_reg.regValue = IoReg_Read32(IPQ_DECONTOUR_BDecont_dither_SEQ_V_00_15_reg);
	bdecont_dither_seq_v_16_31_reg.regValue = IoReg_Read32(IPQ_DECONTOUR_BDecont_dither_SEQ_V_16_31_reg);	
	...
	bdecont_dither_temp_tb_reg.regValue = IoReg_Read32(IPQ_DECONTOUR_BDecont_dither_Temp_TB_reg);

	bdecont_dither_seq_y_00_15_reg.bdecont_dither_seq_y_0  = ptr->s_bdecont_dither_sequence[0][0];
	bdecont_dither_seq_y_00_15_reg.bdecont_dither_seq_y_1  = ptr->s_bdecont_dither_sequence[0][1];
	bdecont_dither_seq_y_00_15_reg.bdecont_dither_seq_y_2  = ptr->s_bdecont_dither_sequence[0][2];
	bdecont_dither_seq_y_00_15_reg.bdecont_dither_seq_y_3  = ptr->s_bdecont_dither_sequence[0][3];
	bdecont_dither_seq_y_00_15_reg.bdecont_dither_seq_y_4  = ptr->s_bdecont_dither_sequence[0][4];
	bdecont_dither_seq_y_00_15_reg.bdecont_dither_seq_y_5  = ptr->s_bdecont_dither_sequence[0][5];
	bdecont_dither_seq_y_00_15_reg.bdecont_dither_seq_y_6  = ptr->s_bdecont_dither_sequence[0][6];
	bdecont_dither_seq_y_00_15_reg.bdecont_dither_seq_y_7  = ptr->s_bdecont_dither_sequence[0][7];
	bdecont_dither_seq_y_00_15_reg.bdecont_dither_seq_y_8  = ptr->s_bdecont_dither_sequence[0][8];
	bdecont_dither_seq_y_00_15_reg.bdecont_dither_seq_y_9  = ptr->s_bdecont_dither_sequence[0][9];
	bdecont_dither_seq_y_00_15_reg.bdecont_dither_seq_y_10 = ptr->s_bdecont_dither_sequence[0][10];
	bdecont_dither_seq_y_00_15_reg.bdecont_dither_seq_y_11 = ptr->s_bdecont_dither_sequence[0][11];
	bdecont_dither_seq_y_00_15_reg.bdecont_dither_seq_y_12 = ptr->s_bdecont_dither_sequence[0][12];
	bdecont_dither_seq_y_00_15_reg.bdecont_dither_seq_y_13 = ptr->s_bdecont_dither_sequence[0][13];
	bdecont_dither_seq_y_00_15_reg.bdecont_dither_seq_y_14 = ptr->s_bdecont_dither_sequence[0][14];
	bdecont_dither_seq_y_00_15_reg.bdecont_dither_seq_y_15 = ptr->s_bdecont_dither_sequence[0][15];
	bdecont_dither_seq_y_16_31_reg.bdecont_dither_seq_y_16 = ptr->s_bdecont_dither_sequence[0][16];
	bdecont_dither_seq_y_16_31_reg.bdecont_dither_seq_y_17 = ptr->s_bdecont_dither_sequence[0][17];
	bdecont_dither_seq_y_16_31_reg.bdecont_dither_seq_y_18 = ptr->s_bdecont_dither_sequence[0][18];
	bdecont_dither_seq_y_16_31_reg.bdecont_dither_seq_y_19 = ptr->s_bdecont_dither_sequence[0][19];
	bdecont_dither_seq_y_16_31_reg.bdecont_dither_seq_y_20 = ptr->s_bdecont_dither_sequence[0][20];
	bdecont_dither_seq_y_16_31_reg.bdecont_dither_seq_y_21 = ptr->s_bdecont_dither_sequence[0][21];
	bdecont_dither_seq_y_16_31_reg.bdecont_dither_seq_y_22 = ptr->s_bdecont_dither_sequence[0][22];
	bdecont_dither_seq_y_16_31_reg.bdecont_dither_seq_y_23 = ptr->s_bdecont_dither_sequence[0][23];
	bdecont_dither_seq_y_16_31_reg.bdecont_dither_seq_y_24 = ptr->s_bdecont_dither_sequence[0][24];
	bdecont_dither_seq_y_16_31_reg.bdecont_dither_seq_y_25 = ptr->s_bdecont_dither_sequence[0][25];
	bdecont_dither_seq_y_16_31_reg.bdecont_dither_seq_y_26 = ptr->s_bdecont_dither_sequence[0][26];
	bdecont_dither_seq_y_16_31_reg.bdecont_dither_seq_y_27 = ptr->s_bdecont_dither_sequence[0][27];
	bdecont_dither_seq_y_16_31_reg.bdecont_dither_seq_y_28 = ptr->s_bdecont_dither_sequence[0][28];
	bdecont_dither_seq_y_16_31_reg.bdecont_dither_seq_y_29 = ptr->s_bdecont_dither_sequence[0][29];
	bdecont_dither_seq_y_16_31_reg.bdecont_dither_seq_y_30 = ptr->s_bdecont_dither_sequence[0][30];
	bdecont_dither_seq_y_16_31_reg.bdecont_dither_seq_y_31 = ptr->s_bdecont_dither_sequence[0][31];
	bdecont_dither_seq_u_00_15_reg.bdecont_dither_seq_u_0  = ptr->s_bdecont_dither_sequence[1][0];
	bdecont_dither_seq_u_00_15_reg.bdecont_dither_seq_u_1  = ptr->s_bdecont_dither_sequence[1][1];
	bdecont_dither_seq_u_00_15_reg.bdecont_dither_seq_u_2  = ptr->s_bdecont_dither_sequence[1][2];
	bdecont_dither_seq_u_00_15_reg.bdecont_dither_seq_u_3  = ptr->s_bdecont_dither_sequence[1][3];
	bdecont_dither_seq_u_00_15_reg.bdecont_dither_seq_u_4  = ptr->s_bdecont_dither_sequence[1][4];
	bdecont_dither_seq_u_00_15_reg.bdecont_dither_seq_u_5  = ptr->s_bdecont_dither_sequence[1][5];
	bdecont_dither_seq_u_00_15_reg.bdecont_dither_seq_u_6  = ptr->s_bdecont_dither_sequence[1][6];
	bdecont_dither_seq_u_00_15_reg.bdecont_dither_seq_u_7  = ptr->s_bdecont_dither_sequence[1][7];
	bdecont_dither_seq_u_00_15_reg.bdecont_dither_seq_u_8  = ptr->s_bdecont_dither_sequence[1][8];
	bdecont_dither_seq_u_00_15_reg.bdecont_dither_seq_u_9  = ptr->s_bdecont_dither_sequence[1][9];
	bdecont_dither_seq_u_00_15_reg.bdecont_dither_seq_u_10 = ptr->s_bdecont_dither_sequence[1][10];
	bdecont_dither_seq_u_00_15_reg.bdecont_dither_seq_u_11 = ptr->s_bdecont_dither_sequence[1][11];
	bdecont_dither_seq_u_00_15_reg.bdecont_dither_seq_u_12 = ptr->s_bdecont_dither_sequence[1][12];
	bdecont_dither_seq_u_00_15_reg.bdecont_dither_seq_u_13 = ptr->s_bdecont_dither_sequence[1][13];
	bdecont_dither_seq_u_00_15_reg.bdecont_dither_seq_u_14 = ptr->s_bdecont_dither_sequence[1][14];
	bdecont_dither_seq_u_00_15_reg.bdecont_dither_seq_u_15 = ptr->s_bdecont_dither_sequence[1][15];
	bdecont_dither_seq_u_16_31_reg.bdecont_dither_seq_u_16 = ptr->s_bdecont_dither_sequence[1][16];
	bdecont_dither_seq_u_16_31_reg.bdecont_dither_seq_u_17 = ptr->s_bdecont_dither_sequence[1][17];
	bdecont_dither_seq_u_16_31_reg.bdecont_dither_seq_u_18 = ptr->s_bdecont_dither_sequence[1][18];
	bdecont_dither_seq_u_16_31_reg.bdecont_dither_seq_u_19 = ptr->s_bdecont_dither_sequence[1][19];
	bdecont_dither_seq_u_16_31_reg.bdecont_dither_seq_u_20 = ptr->s_bdecont_dither_sequence[1][20];
	bdecont_dither_seq_u_16_31_reg.bdecont_dither_seq_u_21 = ptr->s_bdecont_dither_sequence[1][21];
	bdecont_dither_seq_u_16_31_reg.bdecont_dither_seq_u_22 = ptr->s_bdecont_dither_sequence[1][22];
	bdecont_dither_seq_u_16_31_reg.bdecont_dither_seq_u_23 = ptr->s_bdecont_dither_sequence[1][23];
	bdecont_dither_seq_u_16_31_reg.bdecont_dither_seq_u_24 = ptr->s_bdecont_dither_sequence[1][24];
	bdecont_dither_seq_u_16_31_reg.bdecont_dither_seq_u_25 = ptr->s_bdecont_dither_sequence[1][25];
	bdecont_dither_seq_u_16_31_reg.bdecont_dither_seq_u_26 = ptr->s_bdecont_dither_sequence[1][26];
	bdecont_dither_seq_u_16_31_reg.bdecont_dither_seq_u_27 = ptr->s_bdecont_dither_sequence[1][27];
	bdecont_dither_seq_u_16_31_reg.bdecont_dither_seq_u_28 = ptr->s_bdecont_dither_sequence[1][28];
	bdecont_dither_seq_u_16_31_reg.bdecont_dither_seq_u_29 = ptr->s_bdecont_dither_sequence[1][29];
	bdecont_dither_seq_u_16_31_reg.bdecont_dither_seq_u_30 = ptr->s_bdecont_dither_sequence[1][30];
	bdecont_dither_seq_u_16_31_reg.bdecont_dither_seq_u_31 = ptr->s_bdecont_dither_sequence[1][31];	
	bdecont_dither_seq_v_00_15_reg.bdecont_dither_seq_v_0  = ptr->s_bdecont_dither_sequence[2][0];
	bdecont_dither_seq_v_00_15_reg.bdecont_dither_seq_v_1  = ptr->s_bdecont_dither_sequence[2][1];
	bdecont_dither_seq_v_00_15_reg.bdecont_dither_seq_v_2  = ptr->s_bdecont_dither_sequence[2][2];
	bdecont_dither_seq_v_00_15_reg.bdecont_dither_seq_v_3  = ptr->s_bdecont_dither_sequence[2][3];
	bdecont_dither_seq_v_00_15_reg.bdecont_dither_seq_v_4  = ptr->s_bdecont_dither_sequence[2][4];
	bdecont_dither_seq_v_00_15_reg.bdecont_dither_seq_v_5  = ptr->s_bdecont_dither_sequence[2][5];
	bdecont_dither_seq_v_00_15_reg.bdecont_dither_seq_v_6  = ptr->s_bdecont_dither_sequence[2][6];
	bdecont_dither_seq_v_00_15_reg.bdecont_dither_seq_v_7  = ptr->s_bdecont_dither_sequence[2][7];
	bdecont_dither_seq_v_00_15_reg.bdecont_dither_seq_v_8  = ptr->s_bdecont_dither_sequence[2][8];
	bdecont_dither_seq_v_00_15_reg.bdecont_dither_seq_v_9  = ptr->s_bdecont_dither_sequence[2][9];
	bdecont_dither_seq_v_00_15_reg.bdecont_dither_seq_v_10 = ptr->s_bdecont_dither_sequence[2][10];
	bdecont_dither_seq_v_00_15_reg.bdecont_dither_seq_v_11 = ptr->s_bdecont_dither_sequence[2][11];
	bdecont_dither_seq_v_00_15_reg.bdecont_dither_seq_v_12 = ptr->s_bdecont_dither_sequence[2][12];
	bdecont_dither_seq_v_00_15_reg.bdecont_dither_seq_v_13 = ptr->s_bdecont_dither_sequence[2][13];
	bdecont_dither_seq_v_00_15_reg.bdecont_dither_seq_v_14 = ptr->s_bdecont_dither_sequence[2][14];
	bdecont_dither_seq_v_00_15_reg.bdecont_dither_seq_v_15 = ptr->s_bdecont_dither_sequence[2][15];
	bdecont_dither_seq_v_16_31_reg.bdecont_dither_seq_v_16 = ptr->s_bdecont_dither_sequence[2][16];
	bdecont_dither_seq_v_16_31_reg.bdecont_dither_seq_v_17 = ptr->s_bdecont_dither_sequence[2][17];
	bdecont_dither_seq_v_16_31_reg.bdecont_dither_seq_v_18 = ptr->s_bdecont_dither_sequence[2][18];
	bdecont_dither_seq_v_16_31_reg.bdecont_dither_seq_v_19 = ptr->s_bdecont_dither_sequence[2][19];
	bdecont_dither_seq_v_16_31_reg.bdecont_dither_seq_v_20 = ptr->s_bdecont_dither_sequence[2][20];
	bdecont_dither_seq_v_16_31_reg.bdecont_dither_seq_v_21 = ptr->s_bdecont_dither_sequence[2][21];
	bdecont_dither_seq_v_16_31_reg.bdecont_dither_seq_v_22 = ptr->s_bdecont_dither_sequence[2][22];
	bdecont_dither_seq_v_16_31_reg.bdecont_dither_seq_v_23 = ptr->s_bdecont_dither_sequence[2][23];
	bdecont_dither_seq_v_16_31_reg.bdecont_dither_seq_v_24 = ptr->s_bdecont_dither_sequence[2][24];
	bdecont_dither_seq_v_16_31_reg.bdecont_dither_seq_v_25 = ptr->s_bdecont_dither_sequence[2][25];
	bdecont_dither_seq_v_16_31_reg.bdecont_dither_seq_v_26 = ptr->s_bdecont_dither_sequence[2][26];
	bdecont_dither_seq_v_16_31_reg.bdecont_dither_seq_v_27 = ptr->s_bdecont_dither_sequence[2][27];
	bdecont_dither_seq_v_16_31_reg.bdecont_dither_seq_v_28 = ptr->s_bdecont_dither_sequence[2][28];
	bdecont_dither_seq_v_16_31_reg.bdecont_dither_seq_v_29 = ptr->s_bdecont_dither_sequence[2][29];
	bdecont_dither_seq_v_16_31_reg.bdecont_dither_seq_v_30 = ptr->s_bdecont_dither_sequence[2][30];
	bdecont_dither_seq_v_16_31_reg.bdecont_dither_seq_v_31 = ptr->s_bdecont_dither_sequence[2][31];	

	blk_de_contour_dither_y_reg.bdecont_dither_table_y00	= ptr->s_bdecont_dither_table[0][0][0];
	blk_de_contour_dither_y_reg.bdecont_dither_table_y01	= ptr->s_bdecont_dither_table[0][0][1];
	blk_de_contour_dither_y_reg.bdecont_dither_table_y02	= ptr->s_bdecont_dither_table[0][0][2];
	blk_de_contour_dither_y_reg.bdecont_dither_table_y03	= ptr->s_bdecont_dither_table[0][0][3];
	blk_de_contour_dither_y_reg.bdecont_dither_table_y10	= ptr->s_bdecont_dither_table[0][1][0];
	blk_de_contour_dither_y_reg.bdecont_dither_table_y11	= ptr->s_bdecont_dither_table[0][1][1];
	blk_de_contour_dither_y_reg.bdecont_dither_table_y12	= ptr->s_bdecont_dither_table[0][1][2];
	blk_de_contour_dither_y_reg.bdecont_dither_table_y13	= ptr->s_bdecont_dither_table[0][1][3];
	blk_de_contour_dither_y_reg.bdecont_dither_table_y20	= ptr->s_bdecont_dither_table[0][2][0];
	blk_de_contour_dither_y_reg.bdecont_dither_table_y21	= ptr->s_bdecont_dither_table[0][2][1];
	blk_de_contour_dither_y_reg.bdecont_dither_table_y22	= ptr->s_bdecont_dither_table[0][2][2];
	blk_de_contour_dither_y_reg.bdecont_dither_table_y23	= ptr->s_bdecont_dither_table[0][2][3];
	blk_de_contour_dither_y_reg.bdecont_dither_table_y30	= ptr->s_bdecont_dither_table[0][3][0];
	blk_de_contour_dither_y_reg.bdecont_dither_table_y31	= ptr->s_bdecont_dither_table[0][3][1];
	blk_de_contour_dither_y_reg.bdecont_dither_table_y32	= ptr->s_bdecont_dither_table[0][3][2];
	blk_de_contour_dither_y_reg.bdecont_dither_table_y33	= ptr->s_bdecont_dither_table[0][3][3];
	blk_de_contour_dither_u_reg.bdecont_dither_table_u00	= ptr->s_bdecont_dither_table[1][0][0];
	blk_de_contour_dither_u_reg.bdecont_dither_table_u01	= ptr->s_bdecont_dither_table[1][0][1];
	blk_de_contour_dither_u_reg.bdecont_dither_table_u02	= ptr->s_bdecont_dither_table[1][0][2];
	blk_de_contour_dither_u_reg.bdecont_dither_table_u03	= ptr->s_bdecont_dither_table[1][0][3];
	blk_de_contour_dither_u_reg.bdecont_dither_table_u10	= ptr->s_bdecont_dither_table[1][1][0];
	blk_de_contour_dither_u_reg.bdecont_dither_table_u11	= ptr->s_bdecont_dither_table[1][1][1];
	blk_de_contour_dither_u_reg.bdecont_dither_table_u12	= ptr->s_bdecont_dither_table[1][1][2];
	blk_de_contour_dither_u_reg.bdecont_dither_table_u13	= ptr->s_bdecont_dither_table[1][1][3];
	blk_de_contour_dither_u_reg.bdecont_dither_table_u20	= ptr->s_bdecont_dither_table[1][2][0];
	blk_de_contour_dither_u_reg.bdecont_dither_table_u21	= ptr->s_bdecont_dither_table[1][2][1];
	blk_de_contour_dither_u_reg.bdecont_dither_table_u22	= ptr->s_bdecont_dither_table[1][2][2];
	blk_de_contour_dither_u_reg.bdecont_dither_table_u23	= ptr->s_bdecont_dither_table[1][2][3];
	blk_de_contour_dither_u_reg.bdecont_dither_table_u30	= ptr->s_bdecont_dither_table[1][3][0];
	blk_de_contour_dither_u_reg.bdecont_dither_table_u31	= ptr->s_bdecont_dither_table[1][3][1];
	blk_de_contour_dither_u_reg.bdecont_dither_table_u32	= ptr->s_bdecont_dither_table[1][3][2];
	blk_de_contour_dither_u_reg.bdecont_dither_table_u33	= ptr->s_bdecont_dither_table[1][3][3];
	blk_de_contour_dither_v_reg.bdecont_dither_table_v00	= ptr->s_bdecont_dither_table[2][0][0];
	blk_de_contour_dither_v_reg.bdecont_dither_table_v01	= ptr->s_bdecont_dither_table[2][0][1];
	blk_de_contour_dither_v_reg.bdecont_dither_table_v02	= ptr->s_bdecont_dither_table[2][0][2];
	blk_de_contour_dither_v_reg.bdecont_dither_table_v03	= ptr->s_bdecont_dither_table[2][0][3];
	blk_de_contour_dither_v_reg.bdecont_dither_table_v10	= ptr->s_bdecont_dither_table[2][1][0];
	blk_de_contour_dither_v_reg.bdecont_dither_table_v11	= ptr->s_bdecont_dither_table[2][1][1];
	blk_de_contour_dither_v_reg.bdecont_dither_table_v12	= ptr->s_bdecont_dither_table[2][1][2];
	blk_de_contour_dither_v_reg.bdecont_dither_table_v13	= ptr->s_bdecont_dither_table[2][1][3];
	blk_de_contour_dither_v_reg.bdecont_dither_table_v20	= ptr->s_bdecont_dither_table[2][2][0];
	blk_de_contour_dither_v_reg.bdecont_dither_table_v21	= ptr->s_bdecont_dither_table[2][2][1];
	blk_de_contour_dither_v_reg.bdecont_dither_table_v22	= ptr->s_bdecont_dither_table[2][2][2];
	blk_de_contour_dither_v_reg.bdecont_dither_table_v23	= ptr->s_bdecont_dither_table[2][2][3];
	blk_de_contour_dither_v_reg.bdecont_dither_table_v30	= ptr->s_bdecont_dither_table[2][3][0];
	blk_de_contour_dither_v_reg.bdecont_dither_table_v31	= ptr->s_bdecont_dither_table[2][3][1];
	blk_de_contour_dither_v_reg.bdecont_dither_table_v32	= ptr->s_bdecont_dither_table[2][3][2];
	blk_de_contour_dither_v_reg.bdecont_dither_table_v33	= ptr->s_bdecont_dither_table[2][3][3];

	bdecont_dither_temp_tb_reg.bdecont_dither_tab_temp_offset_0  = ptr->s_bdecont_dither_temporal[0];
	bdecont_dither_temp_tb_reg.bdecont_dither_tab_temp_offset_1  = ptr->s_bdecont_dither_temporal[1];
	bdecont_dither_temp_tb_reg.bdecont_dither_tab_temp_offset_2  = ptr->s_bdecont_dither_temporal[2];
	bdecont_dither_temp_tb_reg.bdecont_dither_tab_temp_offset_3  = ptr->s_bdecont_dither_temporal[3];
	bdecont_dither_temp_tb_reg.bdecont_dither_tab_temp_offset_4  = ptr->s_bdecont_dither_temporal[4];
	bdecont_dither_temp_tb_reg.bdecont_dither_tab_temp_offset_5  = ptr->s_bdecont_dither_temporal[5];
	bdecont_dither_temp_tb_reg.bdecont_dither_tab_temp_offset_6  = ptr->s_bdecont_dither_temporal[6];
	bdecont_dither_temp_tb_reg.bdecont_dither_tab_temp_offset_7  = ptr->s_bdecont_dither_temporal[7];
	bdecont_dither_temp_tb_reg.bdecont_dither_tab_temp_offset_8  = ptr->s_bdecont_dither_temporal[8];
	bdecont_dither_temp_tb_reg.bdecont_dither_tab_temp_offset_9  = ptr->s_bdecont_dither_temporal[9];
	bdecont_dither_temp_tb_reg.bdecont_dither_tab_temp_offset_10 = ptr->s_bdecont_dither_temporal[10];
	bdecont_dither_temp_tb_reg.bdecont_dither_tab_temp_offset_11 = ptr->s_bdecont_dither_temporal[11];
	bdecont_dither_temp_tb_reg.bdecont_dither_tab_temp_offset_12 = ptr->s_bdecont_dither_temporal[12];
	bdecont_dither_temp_tb_reg.bdecont_dither_tab_temp_offset_13 = ptr->s_bdecont_dither_temporal[13];
	bdecont_dither_temp_tb_reg.bdecont_dither_tab_temp_offset_14 = ptr->s_bdecont_dither_temporal[14];
	bdecont_dither_temp_tb_reg.bdecont_dither_tab_temp_offset_15 = ptr->s_bdecont_dither_temporal[15];
	
	IoReg_Write32(IPQ_DECONTOUR_BDecont_dither_SEQ_Y_00_15_reg, bdecont_dither_seq_y_00_15_reg.regValue);
	IoReg_Write32(IPQ_DECONTOUR_BDecont_dither_SEQ_Y_16_31_reg, bdecont_dither_seq_y_16_31_reg.regValue);
	IoReg_Write32(IPQ_DECONTOUR_BDecont_dither_SEQ_U_00_15_reg, bdecont_dither_seq_u_00_15_reg.regValue);
	IoReg_Write32(IPQ_DECONTOUR_BDecont_dither_SEQ_U_16_31_reg, bdecont_dither_seq_u_16_31_reg.regValue);
	IoReg_Write32(IPQ_DECONTOUR_BDecont_dither_SEQ_V_00_15_reg, bdecont_dither_seq_v_00_15_reg.regValue);
	IoReg_Write32(IPQ_DECONTOUR_BDecont_dither_SEQ_V_16_31_reg, bdecont_dither_seq_v_16_31_reg.regValue);
	...
	IoReg_Write32(IPQ_DECONTOUR_BDecont_dither_Temp_TB_reg, bdecont_dither_temp_tb_reg.regValue);
...
{
	ipq_decontour_bdecont_ai_0_RBUS bdecont_ai_0_reg;

	bdecont_ai_0_reg.regValue = IoReg_Read32(IPQ_DECONTOUR_BDECONT_AI_0_reg);

	bdecont_ai_0_reg.bdecont_diff_clamp_y = ptr->bdecont_diff_clamp_y;
	bdecont_ai_0_reg.bdecont_diff_clamp_c = ptr->bdecont_diff_clamp_c;

	IoReg_Write32(IPQ_DECONTOUR_BDECONT_AI_0_reg, bdecont_ai_0_reg.regValue);
}
...
{
	ipq_decontour_bdecont_ai_0_RBUS bdecont_ai_0_reg;
	ipq_decontour_blk_de_alpha_diff_semantic0_RBUS blk_de_alpha_diff_semantic0_reg;
	ipq_decontour_blk_de_alpha_diff_semantic1_RBUS blk_de_alpha_diff_semantic1_reg;
	ipq_decontour_blk_de_alpha_diff_semantic2_RBUS blk_de_alpha_diff_semantic2_reg;
	ipq_decontour_blk_de_alpha_diff_semantic3_RBUS blk_de_alpha_diff_semantic3_reg;
	ipq_decontour_blk_de_alpha_diff_semantic4_RBUS blk_de_alpha_diff_semantic4_reg;
	ipq_decontour_blk_de_alpha_diff_semantic5_RBUS blk_de_alpha_diff_semantic5_reg;
	ipq_decontour_blk_de_alpha_diff_semantic6_RBUS blk_de_alpha_diff_semantic6_reg;
	ipq_decontour_blk_de_alpha_diff_semantic7_RBUS blk_de_alpha_diff_semantic7_reg;
	ipq_decontour_blk_de_alpha_diff_semantic8_RBUS blk_de_alpha_diff_semantic8_reg;
	ipq_decontour_blk_de_alpha_diff_semantic9_RBUS blk_de_alpha_diff_semantic9_reg;
	ipq_decontour_blk_de_alpha_diff_semantic10_RBUS blk_de_alpha_diff_semantic10_reg;
	ipq_decontour_blk_de_contour_alpha_ydiff4_RBUS blk_de_alpha_ydiff4_reg;	
	ipq_decontour_blk_de_contour_alpha_cdiff4_RBUS blk_de_alpha_cdiff4_reg;	

	bdecont_ai_0_reg.regValue = IoReg_Read32(IPQ_DECONTOUR_BDECONT_AI_0_reg);
	blk_de_alpha_diff_semantic0_reg.regValue = IoReg_Read32(IPQ_DECONTOUR_BLK_De_Alpha_Diff_Semantic0_reg);
	blk_de_alpha_diff_semantic1_reg.regValue = IoReg_Read32(IPQ_DECONTOUR_BLK_De_Alpha_Diff_Semantic1_reg);
	blk_de_alpha_diff_semantic2_reg.regValue = IoReg_Read32(IPQ_DECONTOUR_BLK_De_Alpha_Diff_Semantic2_reg);
	blk_de_alpha_diff_semantic3_reg.regValue = IoReg_Read32(IPQ_DECONTOUR_BLK_De_Alpha_Diff_Semantic3_reg);
	blk_de_alpha_diff_semantic4_reg.regValue = IoReg_Read32(IPQ_DECONTOUR_BLK_De_Alpha_Diff_Semantic4_reg);
	blk_de_alpha_diff_semantic5_reg.regValue = IoReg_Read32(IPQ_DECONTOUR_BLK_De_Alpha_Diff_Semantic5_reg);
	blk_de_alpha_diff_semantic6_reg.regValue = IoReg_Read32(IPQ_DECONTOUR_BLK_De_Alpha_Diff_Semantic6_reg);
	blk_de_alpha_diff_semantic7_reg.regValue = IoReg_Read32(IPQ_DECONTOUR_BLK_De_Alpha_Diff_Semantic7_reg);
	blk_de_alpha_diff_semantic8_reg.regValue = IoReg_Read32(IPQ_DECONTOUR_BLK_De_Alpha_Diff_Semantic8_reg);
	blk_de_alpha_diff_semantic9_reg.regValue = IoReg_Read32(IPQ_DECONTOUR_BLK_De_Alpha_Diff_Semantic9_reg);
	blk_de_alpha_diff_semantic10_reg.regValue = IoReg_Read32(IPQ_DECONTOUR_BLK_De_Alpha_Diff_Semantic10_reg);
	blk_de_alpha_ydiff4_reg.regValue = IoReg_Read32(IPQ_DECONTOUR_BLK_De_Contour_Alpha_Ydiff4_reg);
	blk_de_alpha_cdiff4_reg.regValue = IoReg_Read32(IPQ_DECONTOUR_BLK_De_Contour_Alpha_Cdiff4_reg);
	
	blk_de_alpha_ydiff4_reg.bdecont_alpha_by_ydiff_semantic_hi_0 = ptr->bdecont_alpha_by_ydiff_semantic_hi[0];
	blk_de_alpha_ydiff4_reg.bdecont_alpha_by_ydiff_semantic_hi_1 = ptr->bdecont_alpha_by_ydiff_semantic_hi[1];
	blk_de_alpha_ydiff4_reg.bdecont_alpha_by_ydiff_semantic_hi_2 = ptr->bdecont_alpha_by_ydiff_semantic_hi[2];
	blk_de_alpha_ydiff4_reg.bdecont_alpha_by_ydiff_semantic_hi_3 = ptr->bdecont_alpha_by_ydiff_semantic_hi[3];	
	blk_de_alpha_diff_semantic0_reg.bdecont_alpha_by_ydiff_semantic_hi_4 = ptr->bdecont_alpha_by_ydiff_semantic_hi[4];
	blk_de_alpha_diff_semantic0_reg.bdecont_alpha_by_ydiff_semantic_hi_5 = ptr->bdecont_alpha_by_ydiff_semantic_hi[5];
	blk_de_alpha_diff_semantic0_reg.bdecont_alpha_by_ydiff_semantic_hi_6 = ptr->bdecont_alpha_by_ydiff_semantic_hi[6];
	blk_de_alpha_diff_semantic0_reg.bdecont_alpha_by_ydiff_semantic_hi_7 = ptr->bdecont_alpha_by_ydiff_semantic_hi[7];
	blk_de_alpha_diff_semantic0_reg.bdecont_alpha_by_ydiff_semantic_hi_8 = ptr->bdecont_alpha_by_ydiff_semantic_hi[8];
	blk_de_alpha_diff_semantic1_reg.bdecont_alpha_by_ydiff_semantic_hi_9 = ptr->bdecont_alpha_by_ydiff_semantic_hi[9];
	blk_de_alpha_diff_semantic1_reg.bdecont_alpha_by_ydiff_semantic_hi_10 = ptr->bdecont_alpha_by_ydiff_semantic_hi[10];
	blk_de_alpha_diff_semantic1_reg.bdecont_alpha_by_ydiff_semantic_hi_11 = ptr->bdecont_alpha_by_ydiff_semantic_hi[11];
	blk_de_alpha_diff_semantic1_reg.bdecont_alpha_by_ydiff_semantic_hi_12 = ptr->bdecont_alpha_by_ydiff_semantic_hi[12];
	blk_de_alpha_diff_semantic1_reg.bdecont_alpha_by_ydiff_semantic_hi_13 = ptr->bdecont_alpha_by_ydiff_semantic_hi[13];
	blk_de_alpha_diff_semantic2_reg.bdecont_alpha_by_ydiff_semantic_hi_14 = ptr->bdecont_alpha_by_ydiff_semantic_hi[14];
	blk_de_alpha_diff_semantic2_reg.bdecont_alpha_by_ydiff_semantic_hi_15 = ptr->bdecont_alpha_by_ydiff_semantic_hi[15];

	blk_de_alpha_diff_semantic2_reg.bdecont_alpha_by_ydiff_semantic_lo_0 = ptr->bdecont_alpha_by_ydiff_semantic_lo[0];
	blk_de_alpha_diff_semantic2_reg.bdecont_alpha_by_ydiff_semantic_lo_1 = ptr->bdecont_alpha_by_ydiff_semantic_lo[1];
	blk_de_alpha_diff_semantic2_reg.bdecont_alpha_by_ydiff_semantic_lo_2 = ptr->bdecont_alpha_by_ydiff_semantic_lo[2];
	blk_de_alpha_diff_semantic3_reg.bdecont_alpha_by_ydiff_semantic_lo_3 = ptr->bdecont_alpha_by_ydiff_semantic_lo[3];
	blk_de_alpha_diff_semantic3_reg.bdecont_alpha_by_ydiff_semantic_lo_4 = ptr->bdecont_alpha_by_ydiff_semantic_lo[4];
	blk_de_alpha_diff_semantic3_reg.bdecont_alpha_by_ydiff_semantic_lo_5 = ptr->bdecont_alpha_by_ydiff_semantic_lo[5];
	blk_de_alpha_diff_semantic3_reg.bdecont_alpha_by_ydiff_semantic_lo_6 = ptr->bdecont_alpha_by_ydiff_semantic_lo[6];
	blk_de_alpha_diff_semantic3_reg.bdecont_alpha_by_ydiff_semantic_lo_7 = ptr->bdecont_alpha_by_ydiff_semantic_lo[7];
	blk_de_alpha_diff_semantic4_reg.bdecont_alpha_by_ydiff_semantic_lo_8 = ptr->bdecont_alpha_by_ydiff_semantic_lo[8];
	blk_de_alpha_diff_semantic4_reg.bdecont_alpha_by_ydiff_semantic_lo_9 = ptr->bdecont_alpha_by_ydiff_semantic_lo[9];
	blk_de_alpha_diff_semantic4_reg.bdecont_alpha_by_ydiff_semantic_lo_10 = ptr->bdecont_alpha_by_ydiff_semantic_lo[10];
	blk_de_alpha_diff_semantic4_reg.bdecont_alpha_by_ydiff_semantic_lo_11 = ptr->bdecont_alpha_by_ydiff_semantic_lo[11];
	blk_de_alpha_diff_semantic4_reg.bdecont_alpha_by_ydiff_semantic_lo_12 = ptr->bdecont_alpha_by_ydiff_semantic_lo[12];
	blk_de_alpha_diff_semantic5_reg.bdecont_alpha_by_ydiff_semantic_lo_13 = ptr->bdecont_alpha_by_ydiff_semantic_lo[13];
	blk_de_alpha_diff_semantic5_reg.bdecont_alpha_by_ydiff_semantic_lo_14 = ptr->bdecont_alpha_by_ydiff_semantic_lo[14];
	blk_de_alpha_diff_semantic5_reg.bdecont_alpha_by_ydiff_semantic_lo_15 = ptr->bdecont_alpha_by_ydiff_semantic_lo[15];

	blk_de_alpha_diff_semantic5_reg.bdecont_alpha_by_cdiff_semantic_hi_0 = ptr->bdecont_alpha_by_cdiff_semantic_hi[0];
	blk_de_alpha_diff_semantic5_reg.bdecont_alpha_by_cdiff_semantic_hi_1 = ptr->bdecont_alpha_by_cdiff_semantic_hi[1];
	blk_de_alpha_cdiff4_reg.bdecont_alpha_by_cdiff_semantic_hi_2 = ptr->bdecont_alpha_by_cdiff_semantic_hi[2];
	blk_de_alpha_cdiff4_reg.bdecont_alpha_by_cdiff_semantic_hi_3 = ptr->bdecont_alpha_by_cdiff_semantic_hi[3];
	blk_de_alpha_cdiff4_reg.bdecont_alpha_by_cdiff_semantic_hi_4 = ptr->bdecont_alpha_by_cdiff_semantic_hi[4];
	blk_de_alpha_cdiff4_reg.bdecont_alpha_by_cdiff_semantic_hi_5 = ptr->bdecont_alpha_by_cdiff_semantic_hi[5];
	blk_de_alpha_diff_semantic6_reg.bdecont_alpha_by_cdiff_semantic_hi_6= ptr->bdecont_alpha_by_cdiff_semantic_hi[6];
	blk_de_alpha_diff_semantic6_reg.bdecont_alpha_by_cdiff_semantic_hi_7= ptr->bdecont_alpha_by_cdiff_semantic_hi[7];
	blk_de_alpha_diff_semantic6_reg.bdecont_alpha_by_cdiff_semantic_hi_8= ptr->bdecont_alpha_by_cdiff_semantic_hi[8];
	blk_de_alpha_diff_semantic6_reg.bdecont_alpha_by_cdiff_semantic_hi_9= ptr->bdecont_alpha_by_cdiff_semantic_hi[9];
	blk_de_alpha_diff_semantic6_reg.bdecont_alpha_by_cdiff_semantic_hi_10= ptr->bdecont_alpha_by_cdiff_semantic_hi[10];
	blk_de_alpha_diff_semantic7_reg.bdecont_alpha_by_cdiff_semantic_hi_11= ptr->bdecont_alpha_by_cdiff_semantic_hi[11];
	blk_de_alpha_diff_semantic7_reg.bdecont_alpha_by_cdiff_semantic_hi_12= ptr->bdecont_alpha_by_cdiff_semantic_hi[12];
	blk_de_alpha_diff_semantic7_reg.bdecont_alpha_by_cdiff_semantic_hi_13= ptr->bdecont_alpha_by_cdiff_semantic_hi[13];
	blk_de_alpha_diff_semantic7_reg.bdecont_alpha_by_cdiff_semantic_hi_14= ptr->bdecont_alpha_by_cdiff_semantic_hi[14];
	blk_de_alpha_diff_semantic7_reg.bdecont_alpha_by_cdiff_semantic_hi_15= ptr->bdecont_alpha_by_cdiff_semantic_hi[15];

	blk_de_alpha_diff_semantic8_reg.bdecont_alpha_by_cdiff_semantic_lo_0 = ptr->bdecont_alpha_by_cdiff_semantic_lo[0];
	blk_de_alpha_diff_semantic8_reg.bdecont_alpha_by_cdiff_semantic_lo_1 = ptr->bdecont_alpha_by_cdiff_semantic_lo[1];
	blk_de_alpha_diff_semantic8_reg.bdecont_alpha_by_cdiff_semantic_lo_2 = ptr->bdecont_alpha_by_cdiff_semantic_lo[2];
	blk_de_alpha_diff_semantic8_reg.bdecont_alpha_by_cdiff_semantic_lo_3 = ptr->bdecont_alpha_by_cdiff_semantic_lo[3];
	blk_de_alpha_diff_semantic8_reg.bdecont_alpha_by_cdiff_semantic_lo_4 = ptr->bdecont_alpha_by_cdiff_semantic_lo[4];	
	blk_de_alpha_diff_semantic9_reg.bdecont_alpha_by_cdiff_semantic_lo_5= ptr->bdecont_alpha_by_cdiff_semantic_lo[5];
	blk_de_alpha_diff_semantic9_reg.bdecont_alpha_by_cdiff_semantic_lo_6= ptr->bdecont_alpha_by_cdiff_semantic_lo[6];
	blk_de_alpha_diff_semantic9_reg.bdecont_alpha_by_cdiff_semantic_lo_7= ptr->bdecont_alpha_by_cdiff_semantic_lo[7];
	blk_de_alpha_diff_semantic9_reg.bdecont_alpha_by_cdiff_semantic_lo_8= ptr->bdecont_alpha_by_cdiff_semantic_lo[8];
	blk_de_alpha_diff_semantic9_reg.bdecont_alpha_by_cdiff_semantic_lo_9= ptr->bdecont_alpha_by_cdiff_semantic_lo[9];
	blk_de_alpha_diff_semantic10_reg.bdecont_alpha_by_cdiff_semantic_lo_10= ptr->bdecont_alpha_by_cdiff_semantic_lo[10];
	blk_de_alpha_diff_semantic10_reg.bdecont_alpha_by_cdiff_semantic_lo_11= ptr->bdecont_alpha_by_cdiff_semantic_lo[11];
	blk_de_alpha_diff_semantic10_reg.bdecont_alpha_by_cdiff_semantic_lo_12= ptr->bdecont_alpha_by_cdiff_semantic_lo[12];
	blk_de_alpha_diff_semantic10_reg.bdecont_alpha_by_cdiff_semantic_lo_13= ptr->bdecont_alpha_by_cdiff_semantic_lo[13];
	blk_de_alpha_diff_semantic10_reg.bdecont_alpha_by_cdiff_semantic_lo_14= ptr->bdecont_alpha_by_cdiff_semantic_lo[14];
	bdecont_ai_0_reg.bdecont_alpha_by_cdiff_semantic_lo_15= ptr->bdecont_alpha_by_cdiff_semantic_lo[15];

	IoReg_Write32(IPQ_DECONTOUR_BDECONT_AI_0_reg, bdecont_ai_0_reg.regValue);
	IoReg_Write32(IPQ_DECONTOUR_BLK_De_Alpha_Diff_Semantic0_reg, blk_de_alpha_diff_semantic0_reg.regValue);
	IoReg_Write32(IPQ_DECONTOUR_BLK_De_Alpha_Diff_Semantic1_reg, blk_de_alpha_diff_semantic1_reg.regValue);
	IoReg_Write32(IPQ_DECONTOUR_BLK_De_Alpha_Diff_Semantic2_reg, blk_de_alpha_diff_semantic2_reg.regValue);
	IoReg_Write32(IPQ_DECONTOUR_BLK_De_Alpha_Diff_Semantic3_reg, blk_de_alpha_diff_semantic3_reg.regValue);
	IoReg_Write32(IPQ_DECONTOUR_BLK_De_Alpha_Diff_Semantic4_reg, blk_de_alpha_diff_semantic4_reg.regValue);
	IoReg_Write32(IPQ_DECONTOUR_BLK_De_Alpha_Diff_Semantic5_reg, blk_de_alpha_diff_semantic5_reg.regValue);
	IoReg_Write32(IPQ_DECONTOUR_BLK_De_Alpha_Diff_Semantic6_reg, blk_de_alpha_diff_semantic6_reg.regValue);
	IoReg_Write32(IPQ_DECONTOUR_BLK_De_Alpha_Diff_Semantic7_reg, blk_de_alpha_diff_semantic7_reg.regValue);
	IoReg_Write32(IPQ_DECONTOUR_BLK_De_Alpha_Diff_Semantic8_reg, blk_de_alpha_diff_semantic8_reg.regValue);
	IoReg_Write32(IPQ_DECONTOUR_BLK_De_Alpha_Diff_Semantic9_reg, blk_de_alpha_diff_semantic9_reg.regValue);
	IoReg_Write32(IPQ_DECONTOUR_BLK_De_Alpha_Diff_Semantic10_reg, blk_de_alpha_diff_semantic10_reg.regValue);
	IoReg_Write32(IPQ_DECONTOUR_BLK_De_Contour_Alpha_Ydiff4_reg, blk_de_alpha_ydiff4_reg.regValue);
	IoReg_Write32(IPQ_DECONTOUR_BLK_De_Contour_Alpha_Cdiff4_reg, blk_de_alpha_cdiff4_reg.regValue);
...
{
	if (DI_IM_DI_ACTIVE_WINDOW_CONTROL_get_singlefieldintra(IoReg_Read32(DI_IM_DI_ACTIVE_WINDOW_CONTROL_reg)) == 0)
		return 2;
	else
		return DI_IM_DI_DEBUG_MODE_get_field_confuse(IoReg_Read32(DI_IM_DI_DEBUG_MODE_reg));
}

unsigned char drvif_color_Get_RTNR_progressive_input(void)
{
	return DI_IM_DI_RTNR_CONTROL_get_cp_rtnr_progressive(IoReg_Read32(DI_IM_DI_RTNR_CONTROL_reg));
}
