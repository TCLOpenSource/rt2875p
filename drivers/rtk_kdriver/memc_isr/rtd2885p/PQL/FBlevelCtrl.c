...

{
		...
		unsigned int repeat_cnt1 = 0, repeat_cnt2 = 0, repeat_cnt3 = 0, i = 0, repeat_en = 0, repeat_gain = 0, test_en = 0, log_repeat = 0;
		...
		ReadRegister(SOFTWARE3_SOFTWARE3_57_reg, 0, 0, &test_en);
...
//		u8_flbk_lvl_OSDPictureModeChg = _MIN_(_FB_LEVEL_MAX_, (_FB_LEVEL_MAX_/5)*s_pContext->_output_frc_sceneAnalysis.u8_OSDPictureModeChg_prt_apply);
	...
	//k23
	pOutput->u8_FBSystem =  _MAX_(_MAX_(_MAX_(_MAX_(_MAX_(_MAX_(_MAX_(_MAX_(u8_flbk_lvl_FrameRepeatMode
	...
	if(log_en){
		rtd_pr_memc_emerg("[%s] u8_FBSystem,%d, val,%d,%d,%d,%d,%d,%d,%d,%d,%d\n",__FUNCTION__, pOutput->u8_FBSystem,
			...
			u8_flbk_lvl_EPG, u8_flbk_lvl_OSDPictureModeChg, u8_flbk_lvl_CMR_pattern );
...
if(ES_Test_4==1)	 //YE Test to control ES Enable/Disable
	...
	#if 0   //mark it all to avoid L_G doesn't accept judder //YE Test temp mark
					...
					||(ES_Flag_208==1)||(ES_Flag_219==1)||(ES_Flag_316==1)||(ES_Flag_319==1)||(ES_Flag_009_1==1)||(ES_Flag_358==1)||(ES_Flag_109==1))//||(ES_Test_26==1)
				{
					...
					if(ES_Test_1==1)
						{  // new condition
							...
							#if 0 //mark it all to avoid L_G doesn't accept judder
