...
const unsigned char g_FRCCADEN_60HZOUT_T[_PQL_IN_96HZ][_FRC_CADENCE_NUM_] =
{
	...
	{_VIDEO_T, _22_N, _32_N, _32322_N, _334_N, _22224_N, _2224_N, _3223_N, _55_N, _66_N, _44_N, _1112_N, _11112_N, _122_N, _11i23_N,_321_N, _1225_N, _1225_P2_N, _12214_N},
	//_PQL_IN_50HZ,
	{_VIDEO_T, _22_T, _32_N, _32322_N, _334_F, _22224_N, _2224_N, _3223_N, _55_F, _66_F, _44_F, _1112_N, _11112_N, _122_T, _11i23_N,_321_N, _1225_N, _1225_P2_N, _12214_N},
	//_PQL_IN_60HZ,
	{_VIDEO_T, _22_T, _32_T, _32322_T, _334_F, _22224_T, _2224_T, _3223_T, _55_T, _66_T, _44_T, _1112_F, _11112_T, _122_N, _11i23_N,_321_T, _1225_N, _1225_P2_N, _12214_N},
};
#else
...
VOID Debug_Msg_Print(_PQLPARAMETER* g_pParam, _PQLCONTEXT* pContext)
{
	...
	if((log_en==1) || (display_timing_ctrl1_reg.disp_en == 1 && ((Scaler_DispGetInputInfoByDisp(SLR_MAIN_DISPLAY, SLR_INPUT_STATE) == _MODE_STATE_ACTIVE) || MEMC_error_status_print_flag) && MEMC_MuxEn)){
		...
		if(ippre_mute_hact != GS_image_hsize/2){
		...
		if(ippre_mute_vact != GS_image_vsize){
...
VOID PQL_ContextInit(VOID)
{
	...
	Periodic_Init(&(s_Context._output_periodic_manage));
	PRD_Init(&(s_Context._output_prd_manage));
#endif
...
VOID PQL_ContextProc_outputInterrupt(int iSliceIdx)
{
...
#if CONFIG_REPEAT_NEW_ALOG
		//o------ new periodic algo ------o
		Periodic_Proc(&(s_pParam->_param_periodic_manage), &(s_Context._output_periodic_manage));
		PRD_Proc(&(s_pParam->_param_prd_manage), &(s_Context._output_prd_manage), &(s_Context._output_periodic_manage));
#endif
		//o------ Merlin5 new add ------o
	...
	if(0){
		rtd_pr_memc_notice("[%s][%d][APL,%d,][SAD,%d,][SAD_diff_th,%d,][TC,%d,][motion,%d,]\n\r", __FUNCTION__, __LINE__,
			...
			rtd_inl(KME_ME1_TOP6_KME_ME1_TOP6_E0_reg), rtd_inl(KME_IPME_KME_IPME_A8_reg));
		rtd_pr_memc_notice("[%s][%d][APL,%d,][SAD,%d,][SAD_diff_th,%d,][TC,%d,][motion,%d,]\n\r", __FUNCTION__, __LINE__,
	...
	if(log_en){
		...
		unsigned int mc_sc_mode = 0, mc_sc_on = 0, mc_sc_fb = 0, mc_bld_bypass = 0, izpz_bld = 0, izpz_mode = 0;
		...
		rtd_pr_memc_notice("[%s][%d][,%d,%d,%d,%d,%d,][,%d,%d,%d,%d,%d,][,%d,%d,%d,][,%d,%d,%d,]\n\r", __FUNCTION__, __LINE__,
			...
			mc_sc_mode, mc_sc_on, mc_sc_fb, mc_bld_bypass, izpz_bld, izpz_mode);
	}
}
