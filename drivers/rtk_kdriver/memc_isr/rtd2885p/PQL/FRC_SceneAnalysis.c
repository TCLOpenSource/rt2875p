...
#endif
	// M8_repeat_condition
	unsigned int repeat_cnt1 = 0, repeat_cnt2 = 0, repeat_cnt3 = 0, i = 0, repeat_en = 0, repeat_gain = 0, test_en = 0;
	unsigned int repeat_cnt1_tmp = 0, repeat_cnt2_tmp = 0, repeat_cnt3_tmp = 0, max_cnt = 0, force_en = 0, force_val = 0;
...
//	ReadRegister(SOFTWARE3_SOFTWARE3_01_reg, 24, 24, &log_en);
	...
	for(i = 0; i < 32; i++){
		ReadRegister(KME_ALGO_me1_freq_statistic_00_reg + 4*i, 0, 9, &repeat_cnt1_tmp);
		ReadRegister(KME_ALGO_me1_freq_statistic_00_reg + 4*i, 10, 19, &repeat_cnt2_tmp);
		ReadRegister(KME_ALGO_me1_freq_statistic_00_reg + 4*i, 20, 29, &repeat_cnt3_tmp);
		repeat_cnt1 += repeat_cnt1_tmp;
		repeat_cnt2 += repeat_cnt2_tmp;
		repeat_cnt3 += repeat_cnt3_tmp;
		repeat_cnt1_tmp = 0;
		repeat_cnt2_tmp = 0;
		repeat_cnt3_tmp = 0;
	}
	repeat_cnt1 = repeat_cnt1 *1000 / repeat_total_num;
	repeat_cnt2 = repeat_cnt2 *1000 / repeat_total_num;
	repeat_cnt3 = repeat_cnt3 *1000 / repeat_total_num;
	max_cnt = _MAX_(repeat_cnt1, _MAX_(repeat_cnt2, repeat_cnt3));

	if(log_en){
		pr_notice("[%s][%d][cnt1,%d,][cnt2,%d,][cnt3,%d,]\n\r", __FUNCTION__, __LINE__,
...
VOID MEMC_me1_bgmask_newalgo_Proc(const _PARAM_FRC_SceneAnalysis *pParam, _OUTPUT_FRC_SceneAnalysis *pOutput)
{
  ...
  //  int rgnmvx_fg[32]={0};
    ...
    int readval12,readval13,readval14,readval15;
 ...
 //   }
...
#else
	if((ABS(gmv_bgx,gmv_fgx)>=65)&&(gmv_bgcnt<=27000)&&(bgrgncnt>9))
#endif
    {
   ...
   //+++++++++++++++++++163 dog  vertical  moving fast+++++++//
    ...
    cond_013_2=(gmv_bgcnt>27000 &&  gmv_bgx==0 && _ABS_(gmv_bgy)<=1 && 
        ...
        && rgn_apli[1]>30000 && rgn_apli[1]<50000 &&  (rgn_apli[7]>20000 &&rgn_apli[7]<40000) && cond_013_rmv); //L_G 120hz
...
if(fg_apl_sum>0 && bg_apl_sum>0){
    ...
    if(u8_dh_condition_dhbypass_en)
    {
		...
		if(((avg_bg_diff_cond == 1)||(glb_bgcnt_large==1) || (dark_flash_big_fg == 1) || (bad_light_off == 1) || (tiny_bgcnt_flag == 1) || (smallcnt_y_big_flag == 1) || 
            ...
            ||(pOutput->u8_dh_condition_393_scgarbage == 1)||(pOutput->u8_dh_condition_182_bypass == 1)||(pOutput->u8_dh_condition_343_bypass == 1)||(pOutput->u8_dh_condition_416_bypass == 1)||(	pOutput->u8_dh_condition_lager_dtlcomparison_bypass == 1)||(pOutput->u8_dh_condition_smallbgcnt_slant_bypass == 1))  && (pOutput->u8_me1_condition_halobefore_flag ==0)&&
            (fwcontrol_13 == 0) && (fwcontrol_214 == 0) && (fwcontrol_185 == 0) && (fwcontrol_299 == 0) &&(fwcontrol_192 == 0) &&(fwcontrol_189 == 0) && (pOutput->u8_dh_condition_229 == 0) && (fwcontrol_156 == 0) && (fwcontrol_306 == 0) && (fwcontrol_227 == 0)&&(fwcontrol_153 == 0)&&(fwcontrol_298 == 0 )&&(pOutput->u8_dh_condition_214==0)&&(pOutput->u8_me1_condition_fixgmv_2k_flag == 0))
		/*if(((avg_bg_diff_cond == 1)||(glb_bgcnt_large==1) || (dark_flash_big_fg == 1) || (bad_light_off == 1) || (tiny_bgcnt_flag == 1) || (smallcnt_y_big_flag == 1) || 
            (pOutput->u8_dh_condition_mixed_mv == 1)|| (pOutput->u8_dh_condition_123_broken == 1) || (pOutput->u8_dh_condition_vertical_broken == 1) || 
            (pOutput->u8_dh_condition_slant_mv == 1) || pOutput->u8_me1_condition_virtical_case3==1 || (pOutput->u8_dh_condition_flashing == 1) ||
            (pOutput->u8_dh_condition_ver_sea == 1)||(pOutput->u8_dh_condition_ver_hor_fast == 1) || pOutput->u8_dh_condition_bad_fg || (pOutput->u8_dh_condition_024_bypass == 1)||(pOutput->u8_dh_condition_030_bypass == 1 )||(pOutput->u8_dh_condition_051_bypass == 1 )
            ...
            ||(pOutput->u8_dh_condition_412_bypass == 1)||(pOutput->u8_dh_condition_35_bypass == 1)||(pOutput->u8_dh_condition_215_bypass==1)||(pOutput->u8_dh_condition_2271_bypass==1)||(pOutput->u8_dh_condition_410_scgarbage == 1)||( pOutput->u8_me1_condition_bgmidstable_fgmotion_2k_flag ==1)||( pOutput->u8_me1_condition_random_bgmid_2k_flag ==1)
            ||(pOutput->u8_dh_condition_393_scgarbage == 1)||(pOutput->u8_dh_condition_182_bypass == 1)||(pOutput->u8_dh_condition_343_bypass == 1)||(pOutput->u8_dh_condition_416_bypass == 1)||(	pOutput->u8_dh_condition_lager_dtlcomparison_bypass == 1)||(pOutput->u8_dh_condition_smallbgcnt_slant_bypass == 1))  && (pOutput->u8_me1_condition_halobefore_flag ==0)&&
            (fwcontrol_13 == 0) && (fwcontrol_214 == 0) && (fwcontrol_185 == 0) && (fwcontrol_299 == 0) &&(fwcontrol_192 == 0) &&(fwcontrol_189 == 0) && (pOutput->u8_dh_condition_229 == 0) && (fwcontrol_156 == 0) && (fwcontrol_306 == 0) && (fwcontrol_227 == 0)&&(fwcontrol_153 == 0)&&(fwcontrol_298 == 0 )&&(pOutput->u8_dh_condition_214==0))*/
#endif
        {
...
VOID MEMC_dehalo_newalgo_bgmaskBase_Proc_DHBYPASS(const _PARAM_FRC_SceneAnalysis *pParam, _OUTPUT_FRC_SceneAnalysis *pOutput)
{
  ...
  // if((!SCFlag_holdflag) && _ABS_(u11_gmv_mvx)<=50  && _ABS_(u10_gmv_mvy)<10 && _ABS_(gmv_bgx)<=50 && _ABS_(gmv_bgy)<10 && apl_change_cnt>=2 && apl_change_jumpcnt>=1 && apl_change_jumpcnt<=7 &&apl_sum2_avr<15000 && (fg_apl_seg6_cnt+fg_apl_seg7_cnt*100)/fg_apl_sum<15)
    ...
    if(flag_light_cond)
   {
	...
	if(((lightflag == 1) ||(lightflag_cond == 1) ||(rotateflag == 1)||(fgmvmutationflag == 1)||(light_left == 1) ||(flag_sencehange == 1)||(flag_tinydtl == 1)||(aplsumchange == 1))&&(fwcontrol_leftfast == 0))
    {
...
VOID SAD_Peak_Skip_GFB(const _PARAM_FRC_SceneAnalysis *pParam, _OUTPUT_FRC_SceneAnalysis *pOutput)
{
	...
	ReadRegister(SOFTWARE3_SOFTWARE3_06_reg, 6, 6, &log_en);
		...
		{
	        		rtd_pr_memc_debug(" [MEMC SADP] , FBResult=%d, SAD =%d,SAD_current=%d,SAD_pre=%d,SAD_pre_temp=%d,SAD_diff=%d, SAD_overshot_cnt=%d,sad_overshot_flag=%d, sc_status=%d, HW_sc=%d, \n"
