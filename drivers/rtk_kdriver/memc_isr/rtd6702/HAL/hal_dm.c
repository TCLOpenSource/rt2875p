...
VOID HAL_DM_SetKmcHVsize(unsigned int u32Hsize,unsigned int u32Vsize)
{
	#if (IC_K5LP || IC_K6LP || IC_K7LP || IC_K8LP)
	//reg_kmc_hv_size
	mc_dma_mc_lf_wdma_ctrl1_RBUS memc_mc_dma_mc_wdma_ctrl1_reg;
	memc_mc_dma_mc_wdma_ctrl1_reg.regValue= rtd_inl(MC_DMA_MC_LF_WDMA_CTRL1_reg);
	memc_mc_dma_mc_wdma_ctrl1_reg.width=u32Hsize;
	memc_mc_dma_mc_wdma_ctrl1_reg.height=u32Vsize;
	rtd_outl(MC_DMA_MC_LF_WDMA_CTRL1_reg,memc_mc_dma_mc_wdma_ctrl1_reg.regValue);
	#endif
}
...
VOID HAL_DM_SetKmc04ReadEnable(BOOL bEnable)
{
	...
	#if (IC_K5LP || IC_K6LP || IC_K7LP || IC_K8LP)
	mc_dma_mc_lf_i_dma_rd_ctrl_RBUS memc_mc_dma_mc_lf_i_dma_rd_ctrl_reg;
	memc_mc_dma_mc_lf_i_dma_rd_ctrl_reg.regValue= rtd_inl(MC_DMA_MC_LF_I_DMA_RD_Ctrl_reg);
	memc_mc_dma_mc_lf_i_dma_rd_ctrl_reg.dma_enable=(unsigned int)bEnable;
	rtd_outl(MC_DMA_MC_LF_I_DMA_RD_Ctrl_reg,memc_mc_dma_mc_lf_i_dma_rd_ctrl_reg.regValue);
	#else
...
VOID HAL_DM_Set_KMC_LFH_WriteEnable(BOOL bEnable)
{
	...
	mc_dma_mc_lfh_dma_wr_ctrl_reg.dma_enable=(unsigned int)bEnable;
...
VOID HAL_DM_Set_KMC_LFH_I_ReadEnable(BOOL bEnable)
{
	...
	mc_dma_mc_lfh_i_dma_rd_ctrl_reg.dma_enable=(unsigned int)bEnable;
...
VOID HAL_DM_Set_KMC_LFH_P_ReadEnable(BOOL bEnable)
{
	...
	mc_dma_mc_lfh_p_dma_rd_ctrl_reg.dma_enable=(unsigned int)bEnable;
