...
VOID Mid_Mode_DisableMCDMA(VOID)
{
	...
	HAL_DM_Set_KMC_LFH_WriteEnable(FALSE);
	HAL_DM_Set_KMC_LFH_I_ReadEnable(FALSE);
	HAL_DM_Set_KMC_LFH_P_ReadEnable(FALSE);	
}
...
VOID Mid_Mode_EnableMCDMA(VOID)
{
	...
	HAL_DM_Set_KMC_LFH_WriteEnable(TRUE);
	HAL_DM_Set_KMC_LFH_I_ReadEnable(TRUE);
	HAL_DM_Set_KMC_LFH_P_ReadEnable(TRUE);	
}
...
//		u32MC_Hact = GS_image_hsize/2;
//		u32MC_Vact = GS_image_vsize/2;
//	}else{
