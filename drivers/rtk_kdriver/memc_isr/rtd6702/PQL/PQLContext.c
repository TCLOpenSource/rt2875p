...
const unsigned char g_FRCCADEN_120HZOUT_T[_PQL_IN_96HZ][_FRC_CADENCE_NUM_] =
{
	...
	{_VIDEO_T, _22_N, _32_N, _32322_N, _334_N, _22224_N, _2224_N, _3223_N, _55_N, _66_N, _44_N, _1112_N, _11112_N, _122_N, _11i23_N,_321_N, _1225_N, _1225_P2_N, _12214_N},
	//_PQL_IN_50HZ,
	{_VIDEO_T, _22_T, _32_N, _32322_N, _334_F, _22224_N, _2224_N, _3223_N, _55_F, _66_F, _44_F, _1112_N, _11112_N, _122_T, _11i23_F,_321_N, _1225_T, _1225_P2_T, _12214_T},
	//_PQL_IN_60HZ,
	{_VIDEO_T, _22_T, _32_T, _32322_T, _334_F, _22224_T, _2224_T, _3223_T, _55_F, _66_F, _44_F, _1112_F, _11112_T, _122_N, _11i23_N,_321_T, _1225_N, _1225_P2_N, _12214_N},
};
...
const unsigned char g_FRCCADEN_60HZOUT_T[_PQL_IN_96HZ][_FRC_CADENCE_NUM_] =
{
	...
	{_VIDEO_T, _22_N, _32_N, _32322_N, _334_N, _22224_N, _2224_N, _3223_N, _55_N, _66_N, _44_N, _1112_N, _11112_N, _122_N, _11i23_N,_321_N, _1225_N, _1225_P2_N, _12214_N},
	//_PQL_IN_50HZ,
	{_VIDEO_T, _22_T, _32_N, _32322_N, _334_F, _22224_N, _2224_N, _3223_N, _55_F, _66_F, _44_F, _1112_N, _11112_N, _122_T, _11i23_F,_321_N, _1225_N, _1225_P2_N, _12214_N},
	//_PQL_IN_60HZ,
	{_VIDEO_T, _22_T, _32_T, _32322_T, _334_F, _22224_T, _2224_T, _3223_T, _55_T, _66_F, _44_F, _1112_F, _11112_T, _122_N, _11i23_N,_321_T, _1225_N, _1225_P2_N, _12214_N},
};
#else
const unsigned char g_FRCCADEN_60HZOUT_T[_PQL_IN_96HZ][_FRC_CADENCE_NUM_] =
{
	...
	if((log_en==1) || (display_timing_ctrl1_reg.disp_en == 1 && ((Scaler_DispGetInputInfoByDisp(0/*SLR_MAIN_DISPLAY*/, 41/*SLR_INPUT_STATE*/) == 2/*_MODE_STATE_ACTIVE*/) || MEMC_error_status_print_flag) && MEMC_MuxEn)){
		...
		if(lbmc_lbmc_24_reg.lbmcpc_mode == 0){
			...
			if(sys_reg_sys_clken3_reg.clken_memc_me && (((kme_bist_kme_buff_st_reg.regValue)>>0)&0xffffffff) != 0){
				if(cnt_2 < 20 && repeat_mode_chg_cnt == 0){
					rtd_pr_memc_notice("[DMA Check] lbme_underflorw_status (b809b1f4 = %x) !!!(BG=%d/%d)(MEMC_Mux=%d)(90K = %d)\n\r", kme_bist_kme_buff_st_reg.regValue, bBGEn, MEMC_BGEn, MEMC_MuxEn, rtd_inl(TIMER_SCPU_CLK90K_LO_reg));
				}
				rtd_outl(KME_BIST_KME_BUFF_ST_reg, kme_bist_kme_buff_st_reg.regValue);
				cnt_1++;
			}

			if(sys_reg_sys_clken3_reg.clken_memc_me && (((mc_dma_mc_dma_index_reg.regValue)>>12)&0x3) != 0){
				if(cnt_2 < 20 && repeat_mode_chg_cnt == 0){
			...
			if(MEMC_LibGetMEMCLowDelayModeEnable() == FALSE || MEMC_LibGetMEMC_PCModeEnable() == FALSE){
				if(lbmc_lbmc_24_reg.lbmcpc_mode_sel_p){ // PZ
					if(lbmc_lbmc_e8_reg.hf_p_not_enough || lbmc_lbmc_e8_reg.hf_p_underflow || lbmc_lbmc_e8_reg.lfh_p_not_enough || lbmc_lbmc_e8_reg.lfh_p_underflow || lbmc_lbmc_e8_reg.lfl_p_not_enough || lbmc_lbmc_e8_reg.lfl_p_underflow){
						if(cnt_2 < 20 && repeat_mode_chg_cnt == 0){
							rtd_pr_memc_notice("[DMA Check][PZ] mc_read_dma_error_flag (b809c290 = %x) !!!(BG=%d/%d)(MEMC_Mux=%d)(90K = %d)\n\r", lbmc_lbmc_e8_reg.regValue, bBGEn, MEMC_BGEn, MEMC_MuxEn, rtd_inl(TIMER_SCPU_CLK90K_LO_reg));
						}
						rtd_outl(LBMC_LBMC_E8_reg, lbmc_lbmc_e8_reg.regValue);
						cnt_1++;
					}
					...
					if(lbmc_lbmc_e8_reg.hf_i_not_enough || lbmc_lbmc_e8_reg.hf_i_underflow || lbmc_lbmc_e8_reg.lfh_i_not_enough || lbmc_lbmc_e8_reg.lfh_i_underflow || lbmc_lbmc_e8_reg.lfl_i_not_enough || lbmc_lbmc_e8_reg.lfl_i_underflow){
						if(cnt_2 < 20 && repeat_mode_chg_cnt == 0){
							rtd_pr_memc_notice("[DMA Check][IZ] mc_read_dma_error_flag (b809c290 = %x) !!!(BG=%d/%d)(MEMC_Mux=%d)(90K = %d)\n\r", lbmc_lbmc_e8_reg.regValue, bBGEn, MEMC_BGEn, MEMC_MuxEn, rtd_inl(TIMER_SCPU_CLK90K_LO_reg));
						}
						rtd_outl(LBMC_LBMC_E8_reg, lbmc_lbmc_e8_reg.regValue);
						cnt_1++;
					}
...
VOID PQL_Debug_MVInfo(const _PQLCONTEXT* s_pContext)
{
	signed short u11_gmv_1st_mvx = s_pContext->_output_read_comreg.s11_me_GMV_1st_vx_rb;
	signed short u10_gmv_1st_mvy = s_pContext->_output_read_comreg.s10_me_GMV_1st_vy_rb;
	...
	signed short u11_gmv_2nd_mvx = s_pContext->_output_read_comreg.s11_me_GMV_2nd_vx_rb;
	signed short u10_gmv_2nd_mvy = s_pContext->_output_read_comreg.s10_me_GMV_2nd_vy_rb;
	...
	unsigned int u30_aSAD_rb = s_pContext->_output_read_comreg.u30_me_aSAD_rb;
	unsigned int log_en;
	ReadRegister(SOFTWARE3_SOFTWARE3_00_reg, 30, 30, &log_en);

	if(log_en){ //d900[30]
		rtd_pr_memc_emerg("[1st]gmv,%d,%d,cnt,%u,unconf,%u [2nd]gmv,%d,%d,cnt,%u,unconf,%u [APL],%u,%u, [sf],%d, [DTL],%u, [SAD],%u,\n", 
		u11_gmv_1st_mvx, u10_gmv_1st_mvy, u17_gmv_1st_cnt, u12_gmv_1st_unconf,
		u11_gmv_2nd_mvx, u10_gmv_2nd_mvy, u17_gmv_2nd_cnt, u12_gmv_2nd_unconf,
		u26_aAPLi_rb, u26_aAPLp_rb,	u1_still_frame, u25_me_aDTL, u30_aSAD_rb);
	}
}

#define PTG_PARAM_NUM	(7)
#define PTG_param_bypass (255)
static _PTG_Param PTG_table[PTG_PARAM_NUM] = {
    //size(w,h)		color(r,g,b)  speed(h,v)	motion			pattern(rect/circle)  bg_type
	{ 38, 50,		0,1023,1023,	 9,18,		4,0xF/*1111*/,		0,					0},//default
	{265,350,		0,1023,1023,	 1, 1,		4,0xF/*1111*/,		PTG_param_bypass,	3},//final check. this setting will raise the sc flag
	{150,200,		0,1023,1023,	 1, 1,		4,0xF/*1111*/,		PTG_param_bypass,	3},//final check. this setting won't raise the sc flag
	{330,245,		0,1023,1023,	 1, 0,		4,0xF/*1111*/,		0,					PTG_param_bypass},//final check. this setting will raise the sc flag
	{380,245,		0,1023,1023,	 1, 0,		4,0xF/*1111*/,		0,					PTG_param_bypass},//final check. this setting won't raise the sc flag
	{300,400,		0,1023,1023,	 6, 6,		4,0xF/*1111*/,		0,					0},//check for sc table lv2 threshold	
	{300,400,		0,1023,1023,	12,12,		4,0xA/*1010*/,		0,					0},//check for sc table lv3 threshold
};

VOID PQL_Set_PTG(unsigned char u8_id)
{
	PQL_OUTPUT_RESOLUTION output_Resolution = s_Context._external_data._output_resolution;
	...
	if(u8_id >= PTG_PARAM_NUM){
		u8_id = 0;
	}

	// set PTG rectangle size
	ippre1_ippre1_54.bar_width = PTG_table[u8_id].u13_bar_width*s_pRimParam->u8_scale_H;
	ippre1_ippre1_54.bar_hight = PTG_table[u8_id].u13_bar_height*s_pRimParam->u8_scale_V;
	...
	if(PTG_table[u8_id].u1_pattern_mode != PTG_param_bypass) {
		ippre_ippre_50.scroll_bar_mode = PTG_table[u8_id].u1_pattern_mode;
	}

	// set PTG background
	if(PTG_table[u8_id].u2_bg_type != PTG_param_bypass) {
...
VOID PQL_BringUp_SceneChange(void)
{
	...
	if(u3_mode==1 || u3_mode==2){ //d904[0:2]
	...
	else if(u3_mode==3 || u3_mode==4){ //d904[0:2]
...
VOID PQL_Debug_SceneChange(_PQLPARAMETER* s_pParam,const _PQLCONTEXT* s_pContext)
{
	//Scene Change threshold tuning: https://wiki.realtek.com/x/E9KBDw
	unsigned char u8_last_id = 0;
	unsigned int log_en = 0, log_en2 = 0;
	static unsigned long long u64_sad_sum = 0, u64_sad_diff_sum = 0, u64_sad_diff_new_sum = 0;
	static unsigned char u8_id = 0;
	static unsigned int u32_sad[128]={0}, u32_sad_diff[128]={0}, u32_sad_diff_new[128]={0};
	
	ReadRegister(SOFTWARE3_SOFTWARE3_01_reg, 29, 29, &log_en);
	ReadRegister(SOFTWARE3_SOFTWARE3_01_reg, 28, 28, &log_en2);

	u8_id = (u8_id<127) ? u8_id+1 : 0;
	u8_last_id =(u8_id<127) ? u8_id+1 : 0;

	u32_sad[u8_id] = rtd_inl(KME_ME1_TOP6_KME_ME1_TOP6_D4_reg);
	u32_sad_diff[u8_id] = rtd_inl(KME_ME1_TOP1_ME1_SCENE1_07_reg);
	u32_sad_diff_new[u8_id] = s_pContext->_output_frc_sceneAnalysis.u32_new_saddiff_th;
	u64_sad_sum += u32_sad[u8_id];
	u64_sad_diff_sum += u32_sad_diff[u8_id];
	u64_sad_diff_new_sum += u32_sad_diff_new[u8_id];
	u64_sad_sum -= u32_sad[u8_last_id];
	u64_sad_diff_sum -= u32_sad_diff[u8_last_id];
	u64_sad_diff_new_sum -= u32_sad_diff_new[u8_last_id];

	if(log_en){ //d900[29]
		rtd_pr_memc_emerg("SAD,%u,SAD_diff,%u,%u,lvl,%d	Diff_Gain,%d,param,%u,%u,	gmv_ratio,%d,param,%d,	rmv,%d,%d,	dtl,%u\n",
				rtd_inl(KME_ME1_TOP6_KME_ME1_TOP6_D4_reg),		//c9d4 regr_me1_statis_glb_sad
				rtd_inl(KME_ME1_TOP1_ME1_SCENE1_07_reg),		//c5dc me1_sc_saddiff_th
				s_pContext->_output_frc_sceneAnalysis.u32_new_saddiff_th,
				s_pContext->_output_wrt_comreg.u4_sc_table_lvl,
				s_pContext->_output_frc_sceneAnalysis.u8_dynSAD_Diff_Gain,
				s_pParam->_param_frc_sceneAnalysis.u28_dyn_SAD_Diff_sadAll_th_l,
				s_pParam->_param_frc_sceneAnalysis.u28_dyn_SAD_Diff_sadAll_th_h,
				s_pContext->_output_frc_sceneAnalysis.u6_gmv_ratio,
				s_pParam->_param_frc_sceneAnalysis.u6_dyn_SAD_Diff_gmv_ratio_th,
				s_pParam->_param_frc_sceneAnalysis.u4_dyn_SAD_Diff_rmv_ratio_th_l,
				s_pParam->_param_frc_sceneAnalysis.u4_dyn_SAD_Diff_rmv_ratio_th_h,
				s_pContext->_output_read_comreg.u25_me_aDTL_rb);
	}

	if(log_en2){ //d900[28]
		rtd_pr_memc_emerg("SAD_avg,%u,SAD_diff_avg,%u,%u\n",
				(u64_sad_sum>>7), (u64_sad_diff_sum>>7), (u64_sad_diff_new_sum>>7));
	}
...
VOID PQL_ContextProc_outputInterrupt(int iSliceIdx)
{
	...
	// re-init when chang the dehalo mode
	...
	//*************************//
	PQL_Debug_MVInfo(&s_Context);
	PQL_BringUp_SceneChange();
	PQL_Debug_SceneChange(s_pParam, &s_Context);
...
fD				WriteRegister(_CMDREG_2,0,31,uiData);
				//LogPrintf(DBG_MSG, "status address: \n",uiAddr);
				//LogPrintf(DBG_MSG, "status val: \n",uiData);
#endif //FIX_ME_INCORRECT_MEMORY_ADDRESS_USE
			}
