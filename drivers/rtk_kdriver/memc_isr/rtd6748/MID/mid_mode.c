...
*/
extern unsigned char u8_pulldown_mode_for_Repeat;
...
VOID Mid_Mode_SetMEMCFrameRepeatEnable(BOOL bEnable)
{
	...
	if(bEnable)
	{
		...
		if(MC_8_buffer_en == 0 && (u8_pulldown_mode_for_Repeat == _PQL_IN24HZ_TRUMOTOFF_CINEMAOFF ||
			((u8_cadence_id == _CAD_32 || u8_cadence_id == _CAD_2224) && u8_pulldown_mode_for_Repeat == _PQL_IN60HZ_TRUMOTOFF_CINEMAOFF))){
...
static _str_MEMC_buffer_size_table  MEMC_buffer_size_table[9]={
	...
	{3840, 1080, 960, 540, 240, 135, 960, 540, 480, 270, 480, 270, 480, 270, 960, 540, 240, 135},	/*3._PQL_OUT_3840x1080*/
