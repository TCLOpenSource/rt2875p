 ...
 * @retval VOID
*/
VOID HAL_POST_SetOutINTSource(unsigned int u32Sor)//b809D008, bit[0]
{
...
BOOL HAL_POST_GetOutINTEnable(unsigned int u32IntType)//b809D008, bit[5:8]
{
	unsigned int v = 0;
...
*/
extern unsigned char MEMC_instanboot_resume_check[10];
VOID HAL_KPOST_TOP_SetOutINTWclr(INT_TYPE eIntType, BOOL bWclr)//b809D008, bit 1:4
{
