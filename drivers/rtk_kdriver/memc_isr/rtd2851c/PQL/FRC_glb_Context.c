...
FRC_CADENCE  frc_cadTable[_FRC_CADENCE_NUM_]=
{
	...
	//{ 0x12AAAAA, 0x1FFFFFF, 12, 25, 0, 0x1ffffff,  25,  0, _CAD_11i23, 0},

	//0xF: 321
	{ 0x25, 0x3F, 3, 6, 0, 0x3f,  6,  0, _CAD_321, 0},

	//0x10: 1225
	//{ 0x15554CC, 0x1FFFFFF, 12, 25, 0, 0x1ffffff,  25,  0, _CAD_1225_T1, 0},
	{ 0x1332AAA, 0x1FFFFFF, 12, 25, 0, 0x1ffffff,  25,  0, _CAD_1225_T1, 0},

	//0x11: 1225_P2
	{ 0x11A9695, 0x1FFFFFF, 12, 25, 0, 0x1ffffff,  25,  0, _CAD_1225_T2, 0},

	//0x12: 12214
	{ 0x358, 0x3FF, 5, 10, 0, 0x3FF,  10,  0, _CAD_12214, 0},
};
...
{
	unsigned char ret_usableFlag = 0;
	if (cadInfo.cad_isLRin == 0)
	{
