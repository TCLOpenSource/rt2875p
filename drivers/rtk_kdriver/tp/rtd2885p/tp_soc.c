...
INT32 TP_Get_MCM_ATSC3_Exist(void)
{
        ...
        efuse_val = rtd_inl(EFUSE_DATAO_97_reg);
        if( efuse_val & 0x00020000 ) {
                TP_WARNING("TP_Get_MCM_ATSC3_Exist ATSC3.0 MCM Exist\n");
                return 1;
        } else {
                TP_WARNING("TP_Get_MCM_ATSC3_Exist ATSC3.0 MCM Not Exist\n");
                return 0;
        }
}
