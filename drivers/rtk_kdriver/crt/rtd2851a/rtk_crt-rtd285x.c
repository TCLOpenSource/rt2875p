...
{	
	hw_semaphore_try_lock();
	if (clken == CLK_ON) {
		rtd_outl(SYS_REG_SYS_SRST0_reg, SYS_REG_SYS_SRST0_rstn_dtv_frontend(1) | SYS_REG_SYS_SRST0_rstn_rtk_demod(1) | SYS_REG_SYS_SRST0_write_data(1));
		rtd_outl(SYS_REG_SYS_SRST2_reg, SYS_REG_SYS_SRST2_rstn_dtv_demod(1) | SYS_REG_SYS_SRST2_write_data(1));
		udelay(50);
		rtd_outl(SYS_REG_SYS_CLKEN0_reg, SYS_REG_SYS_CLKEN0_clken_dtv_frontend(1) | SYS_REG_SYS_CLKEN0_clken_rtk_demod(1) |SYS_REG_SYS_CLKEN0_write_data(1));
		rtd_outl(SYS_REG_SYS_CLKEN2_reg, SYS_REG_SYS_CLKEN2_clken_dtv_demod(1) | SYS_REG_SYS_CLKEN0_write_data(1));
		udelay(50);
	} else {
		rtd_outl(SYS_REG_SYS_CLKEN0_reg, SYS_REG_SYS_CLKEN0_clken_dtv_frontend(1) | SYS_REG_SYS_CLKEN0_clken_rtk_demod(1) |SYS_REG_SYS_CLKEN0_write_data(0));
		rtd_outl(SYS_REG_SYS_CLKEN2_reg, SYS_REG_SYS_CLKEN2_clken_dtv_demod(1) | SYS_REG_SYS_CLKEN0_write_data(0));
		udelay(50);
		rtd_outl(SYS_REG_SYS_SRST0_reg, SYS_REG_SYS_SRST0_rstn_dtv_frontend(1) | SYS_REG_SYS_SRST0_rstn_rtk_demod(1) | SYS_REG_SYS_SRST0_write_data(0));
...
char * CRT_CLK_ModuleName(enum CRT_MODULE module_ip)
{
	...
	case ANADEMOD:
		strncpy(moduleName, "ANADEMOD", 9);
		break;

	case DIGDEMOD:
		strncpy(moduleName, "DIGDEMOD", 9);
		break;
