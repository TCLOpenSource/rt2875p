		...
		*---------------------------------------------------*/
		...
		case 2:
			...
			rtd_outl(SYS_REG_INT_CTRL_SCPU_reg,
						SYS_REG_INT_CTRL_SCPU_usb_ex_int_scpu_routing_en_mask |
		...
		case 3:
			// disable interrupt
			rtd_outl(SYS_REG_INT_CTRL_SCPU_reg,
							SYS_REG_INT_CTRL_SCPU_usb_int_scpu_routing_en_mask |
							SYS_REG_INT_CTRL_SCPU_write_data(0));
			udelay(USB_PHY_DELAY);
...
{	
	hw_semaphore_try_lock();
	if (clken == CLK_ON) {
		rtd_outl(SYS_REG_SYS_SRST0_reg, SYS_REG_SYS_SRST0_rstn_img_demod_wrap(1) | SYS_REG_SYS_SRST0_rstn_dtv_frontend(1) | SYS_REG_SYS_SRST0_write_data(1));
		rtd_outl(SYS_REG_SYS_SRST2_reg, SYS_REG_SYS_SRST2_rstn_dtv_demod(1) | SYS_REG_SYS_SRST2_write_data(1));
		udelay(50);
		rtd_outl(SYS_REG_SYS_CLKEN0_reg, SYS_REG_SYS_CLKEN0_clken_img_demod_wrap(1) | SYS_REG_SYS_CLKEN0_clken_dtv_frontend(1) | SYS_REG_SYS_CLKEN0_write_data(1));
		rtd_outl(SYS_REG_SYS_CLKEN2_reg, SYS_REG_SYS_CLKEN2_clken_dtv_demod(1) | SYS_REG_SYS_CLKEN2_write_data(1));
		udelay(50);
	} else {
		rtd_outl(SYS_REG_SYS_CLKEN0_reg, SYS_REG_SYS_CLKEN0_clken_img_demod(1) | SYS_REG_SYS_CLKEN0_clken_img_demod_wrap(1) | SYS_REG_SYS_CLKEN0_clken_hdic(1) | SYS_REG_SYS_CLKEN0_clken_dtv_frontend(1) | SYS_REG_SYS_CLKEN0_write_data(0));
		rtd_outl(SYS_REG_SYS_CLKEN2_reg, SYS_REG_SYS_CLKEN2_clken_dtv_demod(1) | SYS_REG_SYS_CLKEN2_clken_rtk_demod(1) |SYS_REG_SYS_CLKEN2_write_data(0));
		rtd_outl(SYS_REG_SYS_SRST0_reg, SYS_REG_SYS_SRST0_rstn_img_demod(1) | SYS_REG_SYS_SRST0_rstn_img_demod_wrap(1) | SYS_REG_SYS_SRST0_rstn_hdic_apb(1) | SYS_REG_SYS_SRST0_rstn_hdic_axi(1) | SYS_REG_SYS_SRST0_rstn_hdic(1) | SYS_REG_SYS_SRST0_rstn_dtv_frontend(1) | SYS_REG_SYS_SRST0_write_data(0));
		rtd_outl(SYS_REG_SYS_SRST2_reg, SYS_REG_SYS_SRST2_rstn_dtv_demod(1) | SYS_REG_SYS_SRST2_rstn_rtk_demod(1) |SYS_REG_SYS_SRST2_write_data(0));
		udelay(10);
	}
	hw_semaphore_unlock();
...
int DDEMOD_RTK_EN_CriticalRegister(enum CRT_CLK clken)
{
	hw_semaphore_try_lock();
	if (clken == CLK_ON) {
		rtd_outl(SYS_REG_SYS_SRST2_reg, SYS_REG_SYS_SRST2_rstn_rtk_demod(1) | SYS_REG_SYS_SRST2_write_data(1));
		mdelay(5);
		rtd_outl(SYS_REG_SYS_CLKEN2_reg, SYS_REG_SYS_CLKEN2_clken_rtk_demod(1) | SYS_REG_SYS_CLKEN2_write_data(1));
		mdelay(5);
	} else {
...
char * CRT_CLK_ModuleName(enum CRT_MODULE module_ip)
{
    ...
    case CEC:
            strncpy(moduleName, "CEC", 3);
            break;  
		
        case LSADC:
            strncpy(moduleName, "LSADC", 5);
            break;  
