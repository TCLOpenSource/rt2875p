...
#define USB_PHY_DELAY	100
	...
	if (CLK_ON == clken) {
		...
		*---------------------------------------------------*/
		...
		switch (usb_version) {
#if defined(CONFIG_RTK_KDRV_EHCI_HCD_PLATFORM) || defined(RTK_KDRV_OHCI_HCD_PLATFORM)
		case 2:
			// disable interrupt
			...
			rtd_outl(SYS_REG_SYS_CLKEN2_reg,
						...
						SYS_REG_SYS_CLKEN2_clken_usb2_ex_wrapper_mask |
			...
			rtd_outl(SYS_REG_SYS_SRST2_reg,
						...
						SYS_REG_SYS_SRST2_rstn_usb2_ex_wrapper_mask |
			...
			break;
#endif // defined(CONFIG_RTK_KDRV_EHCI_HCD_PLATFORM) || defined(RTK_KDRV_OHCI_HCD_PLATFORM)
		...
		case 3:
			...
			// disable interrupt
			rtd_outl(SYS_REG_INT_CTRL_SCPU_2_reg,
						SYS_REG_INT_CTRL_SCPU_2_usb3_ex_int_scpu_routing_en_mask |
			...
			// clock off : USB3_EX MAC
			rtd_outl(SYS_REG_SYS_CLKEN5_reg,
						SYS_REG_SYS_CLKEN5_clken_usb3_ex_mask |
			...
			rtd_outl(SYS_REG_SYS_SRST5_reg,
						SYS_REG_SYS_SRST5_rstn_usb3_ex_mask |
						SYS_REG_SYS_SRST5_write_data(0));

			rtd_outl(SYS_REG_SYS_SRST3_reg,
						SYS_REG_SYS_SRST3_rstn_pcie_mask |
						SYS_REG_SYS_SRST3_write_data(0));
			udelay(USB_PHY_DELAY);
			...
			// Reset USB3_EX PHY
			rtd_outl(SYS_REG_SYS_SRST5_reg,
						SYS_REG_SYS_SRST5_rstn_usb3_phy_p1_mask |
						SYS_REG_SYS_SRST5_rstn_usb3_mdio_p1_mask |
						SYS_REG_SYS_SRST5_write_data(0));
			udelay(USB_PHY_DELAY);
			...
			// enable USB3 interrupt
			rtd_outl(SYS_REG_INT_CTRL_SCPU_reg,
							SYS_REG_INT_CTRL_SCPU_usb3_int_scpu_routing_en_mask |
							SYS_REG_INT_CTRL_SCPU_write_data(1));

			// enable USB3_EX interrupt
			rtd_outl(SYS_REG_INT_CTRL_SCPU_2_reg,
						SYS_REG_INT_CTRL_SCPU_2_usb3_ex_int_scpu_routing_en_mask |
						SYS_REG_INT_CTRL_SCPU_2_write_data(1));
			udelay(USB_PHY_DELAY);
			break;
#endif // CONFIG_RTK_KDRV_XHCI_HCD_PLATFORM
		default:
			return CRT_FAIL;
		}
	} else {
		...
		*---------------------------------------------------*/
		...
		case 3:
			...
			// disable interrupt
			rtd_outl(SYS_REG_INT_CTRL_SCPU_2_reg,
						SYS_REG_INT_CTRL_SCPU_2_usb3_ex_int_scpu_routing_en_shift |
						SYS_REG_INT_CTRL_SCPU_write_data(0));
			udelay(USB_PHY_DELAY);
...
int UART_CriticalRegister(enum CRT_CLK clken, void *private_data)
{
	...
	case 1:
		...
		break;
	case 2:
		rtd_outl(SYS_REG_SYS_CLKEN2_reg, BIT(SYS_REG_SYS_CLKEN2_clken_uart2_nouse_shift) | SYS_REG_SYS_CLKEN2_write_data_mask);
		break;
	case 3:
...
int PCMCIA_CriticalRegister(enum CRT_CLK clken)
{
	...
	if (clken == CLK_ON) {
		...
		/* PCMCIA mio clock */
		rtd_outl(SYS_REG_SYS_CLKEN_reg, BIT(SYS_REG_SYS_CLKEN_clken_pcmcia_wrapper_shift));	/* disable clock */
		udelay(10);
		rtd_outl(SYS_REG_SYS_SRST_reg, BIT(SYS_REG_SYS_SRST_rstn_pcmcia_wrapper_shift));	/* assert pcmcia */
		udelay(10);
		rtd_outl(SYS_REG_SYS_SRST_reg, BIT(SYS_REG_SYS_SRST_rstn_pcmcia_wrapper_shift) | BIT(SYS_REG_SYS_SRST_write_data_shift)); 	/* deassert pcmcia */
		udelay(10);
		rtd_outl(SYS_REG_SYS_CLKEN_reg, BIT(SYS_REG_SYS_CLKEN_clken_pcmcia_wrapper_shift) | BIT(SYS_REG_SYS_CLKEN_write_data_shift));
	} else {
		/*pcmcia rbus wrapper clock */
		rtd_outl(SYS_REG_SYS_CLKEN2_reg, BIT(SYS_REG_SYS_CLKEN2_clken_pcmcia_shift));	/* disable clock  */
		/* PCMCIA mio clock */
...
int SDIO_CriticalRegister(enum CRT_CLK clken, void *private_data)
{
	...
	if (clken == CLK_ON) {
		...
		rtd_outl(SYS_REG_SYS_CLKEN3_reg, BIT(SYS_REG_SYS_CLKEN3_clken_sd_nouse_shift));
		rtd_outl(SYS_REG_SYS_SRST3_reg, BIT(SYS_REG_SYS_SRST3_rstn_sd_nouse_shift));
		udelay(10);
		rtd_outl(SYS_REG_SYS_SRST3_reg, BIT(SYS_REG_SYS_SRST3_rstn_sd_nouse_shift) | SYS_REG_SYS_SRST3_write_data_mask);
		rtd_outl(SYS_REG_SYS_CLKEN3_reg, BIT(SYS_REG_SYS_CLKEN3_clken_sd_nouse_shift) | SYS_REG_SYS_CLKEN3_write_data_mask);

		/* enable interrupt */
		rtd_setbits(SYS_REG_INT_CTRL_SCPU_reg, BIT(SYS_REG_INT_CTRL_SCPU_sd_int_scpu_routing_en_nouse_shift));
		udelay(10);
		...
		/* disable interrupt */
		rtd_clearbits(SYS_REG_INT_CTRL_SCPU_reg, BIT(SYS_REG_INT_CTRL_SCPU_sd_int_scpu_routing_en_nouse_shift));
		rtd_clearbits(SYS_REG_INT_CTRL_KCPU_reg, BIT(SYS_REG_INT_CTRL_KCPU_sd_int_kcpu_routing_en_nouse_shift));
		udelay(10);
	}
	hw_semaphore_unlock();
	return CRT_SUCCESS;
...
int SMC_MIO_CriticalRegister(enum CRT_CLK clken)
{
	...
	hw_semaphore_try_lock();
	if (clken == CLK_ON) {
		rtd_outl(SYS_REG_SYS_CLKEN_reg, SYS_REG_SYS_CLKEN_clken_sc_top_mask);   /* Disable Clock */
		udelay(100);
		rtd_outl(SYS_REG_SYS_SRST_reg, SYS_REG_SYS_SRST_rstn_sc_top_mask);   /*HW Reset*/
		udelay(100);
		rtd_outl(SYS_REG_SYS_SRST_reg, SYS_REG_SYS_SRST_rstn_sc_top_mask | SYS_REG_SYS_SRST_write_data_mask);     /* HW Reset*/
		udelay(100);
		rtd_outl(SYS_REG_SYS_CLKEN_reg, SYS_REG_SYS_CLKEN_clken_sc_top_mask | SYS_REG_SYS_CLKEN_write_data_mask);     /* Enable Clock*/
	} else {
		rtd_outl(SYS_REG_SYS_CLKEN_reg, SYS_REG_SYS_CLKEN_clken_sc_top_mask);   /* Disable Clock */
	}
	hw_semaphore_unlock();
...
int TP_MIO_CriticalRegister(enum CRT_CLK clken)
{
	...
	if (clken == CLK_ON) {
		rtd_outl(SYS_REG_SYS_CLKEN_reg, SYS_REG_SYS_CLKEN_clken_tp_mask);   /* Disable Clock */
		udelay(100);
		/*  External Reset TP MIO (0: reset ; 1: normal) */
		rtd_outl(SYS_REG_SYS_SRST_reg, SYS_REG_SYS_SRST_rstn_tp_mask);
		udelay(100);
		/* enable TP MIO clock */
		rtd_outl(SYS_REG_SYS_CLKEN_reg, SYS_REG_SYS_CLKEN_clken_tp_mask | SYS_REG_SYS_CLKEN_write_data_mask);
		udelay(100);
		/*  External Reset TP MIO */
		rtd_outl(SYS_REG_SYS_SRST_reg, SYS_REG_SYS_SRST_rstn_tp_mask | SYS_REG_SYS_SRST_write_data_mask);
		udelay(100);
	...
	if (clken == CLK_ON) {
		...
		rtd_outl(SYS_REG_SYS_SRST1_reg,
				  (SYS_REG_SYS_SRST1_rstn_hdmi_mask |
				   SYS_REG_SYS_SRST1_rstn_vodma1_mask |
...
int HDMI_CriticalRegister(enum CRT_CLK clken)
{
	...
	if (clken == CLK_ON) {
		...
		rtd_outl(SYS_REG_SYS_SRST1_reg,
					...
					SYS_REG_SYS_SRST1_rstn_cbus_nouse_mask |
					SYS_REG_SYS_SRST1_write_data_mask));
		...
		rtd_outl(SYS_REG_SYS_CLKEN1_reg,
					...
					SYS_REG_SYS_CLKEN1_clken_cbus_nouse_mask |
					SYS_REG_SYS_CLKEN1_write_data_mask));
		/* DDC */
		rtd_outl(SYS_REG_SYS_SRST3_reg, SYS_REG_SYS_SRST3_rstn_ddc_nouse_mask | SYS_REG_SYS_SRST3_write_data_mask);
		rtd_outl(SYS_REG_SYS_CLKEN3_reg, SYS_REG_SYS_CLKEN3_clken_ddc_nouse_mask | SYS_REG_SYS_CLKEN3_write_data_mask);
	} else {
		/* HDMI & APLL &cbus & off measure */
		rtd_outl(SYS_REG_SYS_SRST1_reg,
					(SYS_REG_SYS_SRST1_rstn_hdmi_mask |
		...
		rtd_outl(SYS_REG_SYS_CLKEN1_reg,
					...
					SYS_REG_SYS_CLKEN1_clken_cbus_nouse_mask));
		/* DDC */
		rtd_outl(SYS_REG_SYS_SRST3_reg, SYS_REG_SYS_SRST3_rstn_ddc_nouse_mask);
		rtd_outl(SYS_REG_SYS_CLKEN3_reg, SYS_REG_SYS_CLKEN3_clken_ddc_nouse_mask);
	}
...
int SVAD_CriticalRegister(enum CRT_CLK clken)
{
	hw_semaphore_try_lock();

	if (clken == CLK_ON) {
		/* HW mode */
		rtd_outl(SYS_REG_SYS_CLKEN_reg+0x80, BIT(SYS_REG_SYS_CLKEN_clken_sv_shift));
		udelay(10);
		rtd_outl(SYS_REG_SYS_SRST_reg+0x80, BIT(SYS_REG_SYS_SRST_rstn_sv_shift));
		udelay(10);
		rtd_outl(SYS_REG_SYS_SRST_reg+0x80, BIT(SYS_REG_SYS_SRST_rstn_sv_shift) | BIT(SYS_REG_SYS_SRST_write_data_shift));
		udelay(10);
		rtd_outl(SYS_REG_SYS_CLKEN_reg+0x80, BIT(SYS_REG_SYS_CLKEN_clken_sv_shift) | BIT(SYS_REG_SYS_CLKEN_write_data_shift));
	} else {
		rtd_outl(SYS_REG_SYS_CLKEN_reg+0x80, BIT(SYS_REG_SYS_CLKEN_clken_sv_shift));
		rtd_outl(SYS_REG_SYS_SRST_reg+0x80, BIT(SYS_REG_SYS_SRST_rstn_sv_shift));
	}
...
int TV_AllISDBT_CriticalRegister(enum CRT_CLK clken)
{
	...
	*/
	...
	hw_semaphore_try_lock();        //DTV Demod turn off(CLK/RESET), Demod IP off frist then wrapper 
    if (clken == CLK_OFF) {
		rtd_maskl(TVSB5_TV_SB5_DCU1_ARB_CR1_reg, ~(0x00000002 | 0x00000001), 0x0);//TVSB5 don't process command from cliend(demod/demoddbg)
		mdelay(1);
        //ATV_IFD RESET and CLK OFF
        rtd_outl(SYS_REG_SYS_SRST1_reg, SYS_REG_SYS_SRST1_rstn_if_demod(1)|SYS_REG_SYS_SRST1_write_data(0));
        rtd_outl(SYS_REG_SYS_SRST2_reg, SYS_REG_SYS_SRST2_rstn_if_demod_logic(1)|SYS_REG_SYS_SRST1_write_data(0));
...
int TVE1_CriticalRegister(enum CRT_CLK clken)
{
	...
	if (clken == CLK_ON) {
		...
		//tve reset
		rtd_outl(SYS_REG_SYS_SRST1_reg, SYS_REG_SYS_SRST1_rstn_tve_nouse_mask | SYS_REG_SYS_SRST1_write_data_mask); //[26]RSTN_TVE
		//tve clock enable - digital
		rtd_outl(SYS_REG_SYS_CLKEN1_reg, SYS_REG_SYS_CLKEN1_clken_tve_nouse_mask | SYS_REG_SYS_CLKEN1_write_data_mask); //[26]CLKEN_TVE
	} else {
...
int TVE2_CriticalRegister(enum CRT_CLK clken)
{
	...
	hw_semaphore_try_lock();
	if (clken == CLK_ON) {
		rtd_outl(SYS_REG_SYS_CLKEN1_reg, SYS_REG_SYS_CLKEN1_clken_tve_nouse_mask | SYS_REG_SYS_CLKEN1_write_data_mask);
	} else {
		rtd_outl(SYS_REG_SYS_CLKEN1_reg, SYS_REG_SYS_CLKEN1_clken_tve_nouse_mask);
	}
	hw_semaphore_unlock();
...
int TVE3_CriticalRegister(enum CRT_CLK clken)
{
	...
	if (clken == CLK_ON) {
		...
		rtd_outl(SYS_REG_SYS_CLKEN1_reg, SYS_REG_SYS_CLKEN1_clken_tve_nouse_mask); //[26]CLKEN_TVE
	} else {
...
int TVE4_CriticalRegister(enum CRT_CLK clken)
{
	...
	hw_semaphore_try_lock();
	if (clken == CLK_ON) {
		rtd_outl(SYS_REG_SYS_SRST1_reg, SYS_REG_SYS_SRST1_rstn_tve_nouse_mask | SYS_REG_SYS_SRST1_write_data_mask);
	} else {
...
#if 0 // FIXME: undefined in rtd6702
...
void CRT_CLK_OnOff(enum CRT_MODULE module_ip, enum CRT_CLK clken, void *private_data)
{
	...
	case WOV:
		...
		break;
	case SVAD:
		if (SVAD_CriticalRegister(clken) == CRT_FAIL) {
			rtd_pr_crt_warn("SVAD CRT setting fail\n");
		}
		break;
	case GPIO:
