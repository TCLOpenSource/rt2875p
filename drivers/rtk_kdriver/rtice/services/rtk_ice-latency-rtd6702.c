...
static int latencyThread(void *data)
{
	...
	while(gStop == 0){
		...
		/*sb1_ssb1*/
		sbx_ssbx_pc_ctrl_RBUS ssbx_pc_ctrl;
		sbx_ssbx_pc_sys_prog_ctrl_RBUS ssbx_pc_sys_prog_ctrl;
		sbx_ssbx_pc_sys_prog_0_max_lat_RBUS ssbx_pc_sys_prog_0_max_lat;
		sbx_ssbx_pc_sys_prog_0_req_num_RBUS ssbx_pc_sys_prog_0_req_num;
		sbx_ssbx_pc_sys_prog_1_max_lat_RBUS ssbx_pc_sys_prog_1_max_lat;
		sbx_ssbx_pc_sys_prog_1_req_num_RBUS ssbx_pc_sys_prog_1_req_num;
		sbx_ssbx_pc_sys_prog_2_max_lat_RBUS ssbx_pc_sys_prog_2_max_lat;
		sbx_ssbx_pc_sys_prog_2_req_num_RBUS ssbx_pc_sys_prog_2_req_num;
		/*sb2*/
		...
		sbx_pc_ctrl.pc_go = 1;
		sbx_pc_sys_prog_ctrl.pc_sys_prog0_sel = clientId % 16;
		sbx_pc_sys_prog_ctrl.pc_sys_prog1_sel = (clientId + 1) % 16;
		sbx_pc_sys_prog_ctrl.pc_sys_prog2_sel = (clientId + 2) % 16;
		rtd_outl(SBX_SBX_PC_SYS_prog_ctrl_reg,sbx_pc_sys_prog_ctrl.regValue);
		rtd_outl(SBX_SBX_PC_CTRL_reg,sbx_pc_ctrl.regValue);
		/*start pc--sb1_ssb1*/
		ssbx_pc_ctrl.pc_rcmd_only = gReadOnly ? 1 : 0;
		ssbx_pc_ctrl.pc_go = 1;
		ssbx_pc_sys_prog_ctrl.pc_sys_prog0_sel = clientId % 16;
		ssbx_pc_sys_prog_ctrl.pc_sys_prog1_sel = (clientId + 1) % 16;
		ssbx_pc_sys_prog_ctrl.pc_sys_prog2_sel = (clientId + 2) % 16;
		rtd_outl(SBX_SSBX_PC_SYS_prog_ctrl_reg,ssbx_pc_sys_prog_ctrl.regValue);
		rtd_outl(SBX_SSBX_PC_CTRL_reg,ssbx_pc_ctrl.regValue);
		/*start pc--sb2*/
		...
		if(sbx_pc_sys_prog_0_req_num.sys_prog0_req_num)
			addLatency(2,clientId % 16,0,sbx_pc_sys_prog_0_max_lat.sys_prog0_max_lat );
		...
		if(sbx_pc_sys_prog_1_req_num.sys_prog1_req_num)
			addLatency(2,(clientId + 1) % 16,0,sbx_pc_sys_prog_1_max_lat.sys_prog1_max_lat);
		...
		if(sbx_pc_sys_prog_2_req_num.sys_prog2_req_num)
			addLatency(2,(clientId + 2) % 16,0,sbx_pc_sys_prog_2_max_lat.sys_prog2_max_lat);
		/*read latency--sb1_ssb1*/
		ssbx_pc_sys_prog_0_req_num.regValue = rtd_inl(SBX_SSBX_PC_SYS_prog_0_REQ_NUM_reg);
		ssbx_pc_sys_prog_0_max_lat.regValue = rtd_inl(SBX_SSBX_PC_SYS_prog_0_MAX_LAT_reg);
		if(ssbx_pc_sys_prog_0_req_num.sys_prog0_req_num)
			addLatency(4,clientId % 16,0,ssbx_pc_sys_prog_0_max_lat.sys_prog0_max_lat );
		ssbx_pc_sys_prog_1_req_num.regValue = rtd_inl(SBX_SSBX_PC_SYS_prog_1_REQ_NUM_reg);
		ssbx_pc_sys_prog_1_max_lat.regValue = rtd_inl(SBX_SSBX_PC_SYS_prog_1_MAX_LAT_reg);
		if(ssbx_pc_sys_prog_1_req_num.sys_prog1_req_num)
			addLatency(4,(clientId + 1) % 16,0,ssbx_pc_sys_prog_1_max_lat.sys_prog1_max_lat);
		ssbx_pc_sys_prog_2_req_num.regValue = rtd_inl(SBX_SSBX_PC_SYS_prog_2_REQ_NUM_reg);
		ssbx_pc_sys_prog_2_max_lat.regValue = rtd_inl(SBX_SSBX_PC_SYS_prog_2_MAX_LAT_reg);
		if(ssbx_pc_sys_prog_2_req_num.sys_prog2_req_num)
			addLatency(4,(clientId + 2) % 16,0,ssbx_pc_sys_prog_2_max_lat.sys_prog2_max_lat);
		/*read latency--sb2*/
