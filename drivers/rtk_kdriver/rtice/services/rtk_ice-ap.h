...
#define RTICE_AP_CMD_READ_DATA \
	RTICE_OP_CODE(RTICE_CMD_GROUP_ID_AP, 6)
...
#define RTICE_AP_CMD_WRITE_DATA	\
	RTICE_OP_CODE(RTICE_CMD_GROUP_ID_AP, 7)
...
#define RTICE_AP_ERR_UNIMPLEMENT                 	RTICE_FUNC_ERR(6)

#ifdef DEBUG_RTICE_AP
#define RTICE_AP_DEBUG(fmt, args...)   rtd_pr_rtice_debug(fmt, ##args)
#else
