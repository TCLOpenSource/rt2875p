...
static int latencyThread(void *data)
{
	...
	while(gStop == 0){
		...
		/*tvsb2_2*/
		tvsb2_2_tv_sb2_2_dcu1_pc_ctrl_RBUS tvsb2_2_tv_sb2_2_dcu1_pc_ctrl;
		tvsb2_2_tv_sb2_2_dcu1_pc_prog_ctrl1_RBUS tvsb2_2_tv_sb2_2_dcu1_pc_prog_ctrl1;
		tvsb2_2_tv_sb2_2_dcu1_pc_prog_0_channel_sel_RBUS tvsb2_2_tv_sb2_2_dcu1_pc_prog_0_channel_sel;
		tvsb2_2_tv_sb2_2_dcu1_pc_prog_0_max_lat_RBUS tvsb2_2_tv_sb2_2_dcu1_pc_prog_0_max_lat;
		tvsb2_2_tv_sb2_2_dcu1_pc_prog_0_req_num_RBUS tvsb2_2_tv_sb2_2_dcu1_pc_prog_0_req_num;
		/*tvsb3*/
		...
		/*sb1*/
		sbx_sb1_dcu1_pc_ctrl_RBUS sbx_pc_ctrl;
		sbx_sb1_dcu1_pc_prog_0_max_lat_RBUS sbx_pc_sys_prog_0_max_lat;
		sbx_sb1_dcu1_pc_prog_0_req_num_RBUS sbx_pc_sys_prog_0_req_num;
		/*sb2*/
		...
		/*start pc--tvsb2_2*/
		tvsb2_2_tv_sb2_2_dcu1_pc_ctrl.pc_rd_only = gReadOnly ? 1 : 0;
		tvsb2_2_tv_sb2_2_dcu1_pc_ctrl.pc_go = 1;
		tvsb2_2_tv_sb2_2_dcu1_pc_prog_ctrl1.pc_prog0_sel = clientId % 16;
		tvsb2_2_tv_sb2_2_dcu1_pc_prog_ctrl1.pc_prog1_sel = (clientId + 1) % 16;
		tvsb2_2_tv_sb2_2_dcu1_pc_prog_ctrl1.pc_prog2_sel = (clientId + 2) % 16;
		rtd_outl(TVSB2_2_TV_SB2_2_DCU1_PC_prog_ctrl1_reg,tvsb2_2_tv_sb2_2_dcu1_pc_prog_ctrl1.regValue);
		rtd_outl(TVSB2_2_TV_SB2_2_DCU1_PC_CTRL_reg,tvsb2_2_tv_sb2_2_dcu1_pc_ctrl.regValue);
		/*start pc--tvsb3*/
		...
		/*start pc--sb1*/
		sbx_pc_ctrl.pc_rd_only = gReadOnly ? 1 : 0;
		sbx_pc_ctrl.pc_go = 1;
		sbx_pc_ctrl.pc_prog0_sel = clientId2 % 16;
		rtd_outl(SBX_SB1_DCU1_PC_CTRL_reg,sbx_pc_ctrl.regValue);
		/*start pc--sb2*/
		...
		rtd_outl(TVSB2_TV_SB2_DCU1_PC_CTRL_reg,tvsb2_tv_sb2_dcu1_pc_ctrl.regValue);
		/*stop pc-- tvsb2_2*/
		tvsb2_2_tv_sb2_2_dcu1_pc_ctrl.pc_go = 0;
		rtd_outl(TVSB2_2_TV_SB2_2_DCU1_PC_CTRL_reg,tvsb2_2_tv_sb2_2_dcu1_pc_ctrl.regValue);
		/*stop pc-- tvsb3*/
		...
		/*read latency--tvsb2_2*/
		tvsb2_2_tv_sb2_2_dcu1_pc_prog_0_channel_sel.prog_channel_sel = 0;
		rtd_outl(TVSB2_2_TV_SB2_2_DCU1_PC_prog_0_channel_sel_reg,tvsb2_2_tv_sb2_2_dcu1_pc_prog_0_channel_sel.regValue);
		tvsb2_2_tv_sb2_2_dcu1_pc_prog_0_req_num.regValue = rtd_inl(TVSB2_2_TV_SB2_2_DCU1_PC_prog_0_req_num_reg);
		tvsb2_2_tv_sb2_2_dcu1_pc_prog_0_max_lat.regValue = rtd_inl(TVSB2_2_TV_SB2_2_DCU1_PC_prog_0_max_lat_reg);
		if(tvsb2_2_tv_sb2_2_dcu1_pc_prog_0_req_num.prog_req_num)
			addLatency(0xe,clientId % 16,0,tvsb2_2_tv_sb2_2_dcu1_pc_prog_0_max_lat.prog_max_lat);
		tvsb2_2_tv_sb2_2_dcu1_pc_prog_0_channel_sel.prog_channel_sel = 1;
		rtd_outl(TVSB2_2_TV_SB2_2_DCU1_PC_prog_0_channel_sel_reg,tvsb2_2_tv_sb2_2_dcu1_pc_prog_0_channel_sel.regValue);
		tvsb2_2_tv_sb2_2_dcu1_pc_prog_0_req_num.regValue = rtd_inl(TVSB2_2_TV_SB2_2_DCU1_PC_prog_0_req_num_reg);
		tvsb2_2_tv_sb2_2_dcu1_pc_prog_0_max_lat.regValue = rtd_inl(TVSB2_2_TV_SB2_2_DCU1_PC_prog_0_max_lat_reg);
		if(tvsb2_2_tv_sb2_2_dcu1_pc_prog_0_req_num.prog_req_num)
			addLatency(0xe,(clientId + 1) % 16,0,tvsb2_2_tv_sb2_2_dcu1_pc_prog_0_max_lat.prog_max_lat);
		tvsb2_2_tv_sb2_2_dcu1_pc_prog_0_channel_sel.prog_channel_sel = 2;
		rtd_outl(TVSB2_2_TV_SB2_2_DCU1_PC_prog_0_channel_sel_reg,tvsb2_2_tv_sb2_2_dcu1_pc_prog_0_channel_sel.regValue);
		tvsb2_2_tv_sb2_2_dcu1_pc_prog_0_req_num.regValue = rtd_inl(TVSB2_2_TV_SB2_2_DCU1_PC_prog_0_req_num_reg);
		tvsb2_2_tv_sb2_2_dcu1_pc_prog_0_max_lat.regValue = rtd_inl(TVSB2_2_TV_SB2_2_DCU1_PC_prog_0_max_lat_reg);
		if(tvsb2_2_tv_sb2_2_dcu1_pc_prog_0_req_num.prog_req_num)
			addLatency(0xe,(clientId + 2) % 16,0,tvsb2_2_tv_sb2_2_dcu1_pc_prog_0_max_lat.prog_max_lat);
		/*read latency--tvsb3*/
		...
		/*read latency--sb1*/
		sbx_pc_sys_prog_0_req_num.regValue = rtd_inl(SBX_SB1_DCU1_PC_prog_0_req_num_reg);
		sbx_pc_sys_prog_0_max_lat.regValue = rtd_inl(SBX_SB1_DCU1_PC_prog_0_max_lat_reg);
		if(sbx_pc_sys_prog_0_req_num.prog_req_num)
			addLatency(2,clientId2 % 16,0,sbx_pc_sys_prog_0_max_lat.prog_max_lat );
		/*read latency--sb2*/
