...
#endif
volatile unsigned char fDebugModeEnable = 0x00;
...
{
#if IS_ENABLED(CONFIG_RTK_KDRV_SERIAL_8250)
    rtk_serial8250_uart_regedist_rtice_callback(_rtice_input);
#endif
	...
	#ifdef DEBUG_RTICE
	rtd_pr_rtice_notice("Enable RTICE DEBUG msg to uart1.\n");
	uart1_enable();
	#endif
	return 1;
}
