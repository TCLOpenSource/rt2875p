...
#define EMCU_POWER_PIN_NAME1    "PIN_POWER_EN0"
#define EMCU_POWER_PIN_NAME2    "PIN_POWER_EN1"
#define EMCU_POWER_PIN_NAME3    "PIN_POWER_EN2"
#define EMCU_POWER_PIN_NAME4    "PIN_POWER_EN3"
#define EMCU_DDR_POWER_NAME1	"PIN_DDR_POWER_EN"
#define EMCU_DDR_POWER_NAME2    "PIN_DDR_POWER_EN2"
#define EMCU_WOL_POWER_NAME     "PIN_WOL_EN"
#define EMCU_WOV_POWER_NAME     "PIN_WOV_CTL_EN"
...
#define EMCU_POWER_PIN_NAME1    "PIN_POWER_EN0"
#define EMCU_POWER_PIN_NAME2    "PIN_POWER_EN1"
#define EMCU_POWER_PIN_NAME3    "PIN_POWER_EN4"
#define EMCU_POWER_PIN_NAME4    "PIN_POWER_EN5"
#define EMCU_DDR_POWER_NAME1	"PIN_DDR_POWER_EN"
#define EMCU_DDR_POWER_NAME2    "PIN_DDR_POWER_EN2"
#define EMCU_WOL_POWER_NAME     "PIN_WOL_EN"
#define EMCU_WOV_POWER_NAME     "PIN_WOV_CTL"
...
#endif
//#define POWER_PIN_TLB  "EMCU_DDR_POWER_NAME1,EMCU_DDR_POWER_NAME2,EMCU_POWER_PIN_NAME1,EMCU_POWER_PIN_NAME2,EMCU_POWER_PIN_NAME3,EMCU_POWER_PIN_NAME4,EMCU_WOL_POWER_NAME,EMCU_WOV_POWER_NAME"
#define POWER_PIN_TLB  \
    EMCU_DDR_POWER_NAME1,\
    EMCU_DDR_POWER_NAME2,\
    EMCU_POWER_PIN_NAME1,\
    EMCU_POWER_PIN_NAME2,\
    EMCU_POWER_PIN_NAME3,\
    EMCU_POWER_PIN_NAME4,\
    EMCU_WOL_POWER_NAME,\
    EMCU_WOV_POWER_NAME

#define NEW_POWER_PIN_LIB

#define IDX_SHIFT           (56)
#define IDX_WOW_PIN         (0x58ULL)	//GPI for wakeup on wide lan
#define IDX_REKEY           (0x57ULL)	//GPI for rekey

/* idx of power GPIO pin */
#define IDX_POWER_PIN       (0x60ULL)	//GPO for normal power pin 0~3 or more
#define IDX_DDR_POWER       (0x70ULL)	//GPO for DDR power pin 0~1 or more
#define IDX_WOL_POWER       (0x80ULL)	//GPO for WOL module power pin
#define IDX_WOV_POWER       (0x90ULL)	//GPO for WOV module power pin
#define IDX_LED_FLASH_POWER (0xC0ULL)	//GPO for led flash pin

#define IO_WOW_PIN         (IDX_WOW_PIN << IDX_SHIFT)
#define IO_TPYE_REKEY      (IDX_REKEY << IDX_SHIFT)

#define IO_POWER_PIN       (IDX_POWER_PIN << IDX_SHIFT)
#define IO_DDR_POWER       (IDX_DDR_POWER << IDX_SHIFT)
#define IO_WOL_POWER       (IDX_WOL_POWER << IDX_SHIFT)
#define IO_WOV_POWER       (IDX_WOV_POWER << IDX_SHIFT)


#define SCPU_TEXT_START	0x00200000
#define SCPU_TEXT_END	0x00d00000
#define ACPU_TEXT_START	0x1b200000
#define ACPU_TEXT_END	0x1b700000
#define VCPU_TEXT_STRT	0x1a700000
#define VCPU_TEXT_END	0x1aa00000
