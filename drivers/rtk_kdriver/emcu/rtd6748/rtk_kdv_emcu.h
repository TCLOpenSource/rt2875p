...
#define EMCU_LED_FLASH_POWER_NAME "PIN_LEDS_0"
...
#define IO_WOL_POWER       (IDX_POWER_PIN << IDX_SHIFT)
#define IO_WOV_POWER       (IDX_POWER_PIN << IDX_SHIFT)
