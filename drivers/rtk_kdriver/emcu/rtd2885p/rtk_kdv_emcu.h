...
#define EMCU_POWER_PIN_NAME1     "PIN_POWER_EN1"
#define EMCU_POWER_PIN_NAME2    "PIN_POWER_EN2"
#define EMCU_POWER_PIN_NAME3    "PIN_POWER_EN3"
#define EMCU_POWER_PIN_NAME4     "PIN_POWER_EN4"
...
#define EMCU_WIFI_POWER_NAME1    "PIN_WLAN_RESET"
#define EMCU_WIFI_POWER_NAME2    "PIN_WLAN_POWER_ON"
#define EMCU_AMP_POWER_NAME      "PIN_AMP_PWR_EN"
#define EMCU_WOV_POWER_NAME      "PIN_WOV_CTL_EN"
#define EMCU_A0V9_POWER_NAME1     "PIN_A0V9_EN1" //TV:control HDRX0V9/USB0V9/PIF OV9; Dias: control HDRX0V9/USB0V9/PIFOV9
#define EMCU_A0V9_POWER_NAME2     "PIN_A0V9_EN2" //TV:no the power pin; Dias: control USB0V9/PIFOV9
...
#define POWER_PIN_TLB  \
	...
	EMCU_WOL_POWER_NAME,\
	EMCU_WIFI_POWER_NAME1,\
	EMCU_WIFI_POWER_NAME2,\
	EMCU_WOV_POWER_NAME,\
	EMCU_A0V9_POWER_NAME1,\
	EMCU_A0V9_POWER_NAME2
...
#define ACPU_TEXT_END	0x1b800000
#define VCPU_TEXT_STRT	0x1a900000
#define VCPU_TEXT_END	0x1ac00000
...
#define PARAM_LEN_PWEN          13	//max pin count of power pin(new protocol can use 13)
...
extern int emcu_set_RTC(int value);
