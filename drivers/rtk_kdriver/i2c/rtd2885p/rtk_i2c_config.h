...
static const rtk_i2c_port RTK_I2C_i2c0_port[] =
{
	{
		.gpio_mapped       = 1,
		.g2c_scl           = rtk_gpio_id(ISO_GPIO, 2),
		.g2c_sda           = rtk_gpio_id(ISO_GPIO, 16),
		.input_mux[0]      = {0x0, (0x0), (0x0)},//SCL
		.input_mux[1]      = {0x0, (0x0), (0x0)},//SDA
		.pin_mux[0]        = {0xb8060200, (0xF<<20), (0xB<<20), (0xF<<20)},
		.pin_mux[1]        = {0xb8060208, (0xF<<12), (0xB<<12), (0xF<<12)},
	},
};
...
static const rtk_i2c_port RTK_I2C_i2c1_port[] =
{
	{
		.gpio_mapped       = 1,
		.g2c_scl           = rtk_gpio_id(MIS_GPIO, 50),
		.g2c_sda           = rtk_gpio_id(MIS_GPIO, 49),
		.input_mux[0]      = {0x0, (0), (0)},//table not match register
		.input_mux[1]      = {0x0, (0), (0)},
		.pin_mux[0]        = {0xb8000818,(0xF<<12), (0xB<<12), (0xF<<12)},
		.pin_mux[1]        = {0xb8000818,(0xF<<20), (0xB<<20), (0xF<<20)},
	},
};
...
{
	{
		...
		.g2c_sda           = rtk_gpio_id(MIS_GPIO, 17),
		.input_mux[0]      = {0x0, (0x0), (0x0)},
		.input_mux[1]      = {0x0, (0x0),  (0x0)},
		.pin_mux[0]        = {0xb8000814, (0xF<<20), (0xB<<20), (0xF<<20)},
		.pin_mux[1]        = {0xb800080C, (0xF<<12), (0xB<<12), (0xF<<12)},
	},
};
...
static const rtk_i2c_port RTK_I2C_i2c3_port[] =
{
	{
		.gpio_mapped       = 1,
		.g2c_scl           = rtk_gpio_id(MIS_GPIO, 65),
		.g2c_sda           = rtk_gpio_id(MIS_GPIO, 98),
		.input_mux[0]      = {0xb80008C8, (0x3<<28), (0x0<<28)},
		.input_mux[1]      = {0xb80008C8, (0x3<<24), (0x0<<24)},
		.pin_mux[0]        = {0xb800088C, (0xF<<4),  (0xB<<4),  (0xF<<4)},
		.pin_mux[1]        = {0xb8000898, (0xF<<12), (0xB<<12), (0xF<<12)},
	},
	{
		.gpio_mapped       = 1,
		.g2c_scl           = rtk_gpio_id(MIS_GPIO, 70),
		.g2c_sda           = rtk_gpio_id(MIS_GPIO, 69),
		.input_mux[0]      = {0xb80008C8, (0x3<<28), (0x1<<28)},
		.input_mux[1]      = {0xb80008C8, (0x3<<24), (0x1<<24)},
		.pin_mux[0]        = {0xb8000890, (0xF<<4),  (0xB<<4),  (0xF<<4)},
		.pin_mux[1]        = {0xb8000890, (0xF<<12), (0xB<<12), (0xF<<12)},
	},
};
...
static const rtk_i2c_port RTK_I2C_i2c4_port[] =
{
	{
		.gpio_mapped       = 1,
		.g2c_scl           = rtk_gpio_id(MIS_GPIO, 18),
		.g2c_sda           = rtk_gpio_id(MIS_GPIO, 72),
		.input_mux[0]      = {0xb80008C8, (0x3<<20), (0x0<<20)},
		.input_mux[1]      = {0xb80008C8, (0x3<<16), (0x0<<16)},
		.pin_mux[0]        = {0xb800080C, (0xF<<4),  (0xB<<4), (0xF<<4)},
		.pin_mux[1]        = {0xb800081C, (0xF<<12), (0xB<<12), (0xF<<12)},
	},
	{
		.gpio_mapped       = 1,
		.g2c_scl           = rtk_gpio_id(MIS_GPIO, 106),
		.g2c_sda           = rtk_gpio_id(MIS_GPIO, 105),
		.input_mux[0]      = {0xb80008C8, (0x3<<20), (0x1<<20)},
		.input_mux[1]      = {0xb80008C8, (0x3<<16), (0x1<<16)},
		.pin_mux[0]        = {0xb80008A0, (0xF<<12), (0xB<<12), (0xF<<12)},
		.pin_mux[1]        = {0xb80008A0, (0xF<<20), (0xB<<20), (0xF<<20)},
	},
};
...
static const rtk_i2c_port RTK_I2C_i2c5_port[] =
{
	{
		.gpio_mapped       = 1,
		.g2c_scl           = rtk_gpio_id(ISO_GPIO, 37),
		.g2c_sda           = rtk_gpio_id(ISO_GPIO, 21),
		.input_mux[0]      = {0xb8060258, (0x3<<20), (0x0<<20)},
		.input_mux[1]      = {0xb8060258, (0x3<<16), (0x0<<16)},
		.pin_mux[0]        = {0xb8060214, (0xF<<28), (0xB<<28), (0xF<<28)},
	...
	},
	{
		...
		.input_mux[0]      = {0xb8060258, (0x3<<20), (0x1<<20)},
		.input_mux[1]      = {0xb8060258, (0x3<<16), (0x1<<16)},
		.pin_mux[0]        = {0xb806022C, (0xF<<12), (0xB<<12), (0xF<<12)},
		.pin_mux[1]        = {0xb8060228, (0xF<<20), (0xB<<20), (0xF<<20)},
	},
};
