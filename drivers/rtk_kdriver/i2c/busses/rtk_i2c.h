...
#define SCPU_SYNC_REG   (0xB8060578)
#define MICOM_SYNC_REG   (0xB806057C)
#define SCPU_SYNC_MAGIC   (0x2379)
#define MICOM_SYNC_MAGIC   (0xbeef)

// FIXME: Should use PCB enum instead.
/* Slave address */
#define LG_DVBS_TUNER_ADDRESS       (0x60)
#define LG_DVBS_TUNER_I2C_CHANNEL   (0x1)
