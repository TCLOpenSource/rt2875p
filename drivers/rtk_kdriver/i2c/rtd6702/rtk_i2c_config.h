...
static const rtk_i2c_port RTK_I2C_i2c0_port[] =
{
	{
		.gpio_mapped       = 1,
		.g2c_scl           = rtk_gpio_id(ISO_GPIO, 45),
		.g2c_sda           = rtk_gpio_id(ISO_GPIO, 46),
		.input_mux[0]      = {0xB8060268, (0x7<<20), (0x0<<20)},//SCL
		.input_mux[1]      = {0xB8060268, (0x7<<16), (0x0<<16)},//SDA
		.pin_mux[0]        = {0xb806022C, (0xF<<20), (0xB<<20), (0xF<<20)},
		.pin_mux[1]        = {0xb806022C, (0xF<<12), (0xB<<12), (0xF<<12)},
	},
	{
		.gpio_mapped       = 1,
		.g2c_scl           = rtk_gpio_id(ISO_GPIO, 61),
		.g2c_sda           = rtk_gpio_id(ISO_GPIO, 59),
		.input_mux[0]      = {0xB8060268, (0x7<<20), (0x1<<20)},
		.input_mux[1]      = {0xB8060268, (0x7<<16), (0x1<<16)},
		.pin_mux[0]        = {0xB8060230, (0xF<<12), (0xB<<12), (0xF<<12)},
		.pin_mux[1]        = {0xB8060230, (0xF<<28), (0xB<<28), (0xF<<28)},
	},

	{
		.gpio_mapped       = 1,
		.g2c_scl           = rtk_gpio_id(ISO_GPIO, 22),
		.g2c_sda           = rtk_gpio_id(ISO_GPIO, 19),
		.input_mux[0]      = {0xB8060268, (0x7<<20), (0x2<<20)},
		.input_mux[1]      = {0xB8060268, (0x7<<16), (0x2<<16)},
		.pin_mux[0]        = {0xB8060214, (0xF<<12), (0xB<<12), (0xF<<12)},
		.pin_mux[1]        = {0xB8060210, (0xF<<4),  (0xB<<4),  (0xF<<4)},
	},
	{
		.gpio_mapped       = 1,
		.g2c_scl           = rtk_gpio_id(ISO_GPIO, 34),
		.g2c_sda           = rtk_gpio_id(ISO_GPIO, 33),
		.input_mux[0]      = {0xB8060268, (0x7<<20), (0x3<<20)},
		.input_mux[1]      = {0xB8060268, (0x7<<16), (0x3<<16)},
		.pin_mux[0]        = {0xB8060220, (0xF<<12), (0xB<<12), (0xF<<12)},
		.pin_mux[1]        = {0xB8060220, (0xF<<20), (0xB<<20), (0xF<<20)},
	},
	{
		.gpio_mapped       = 1,
		.g2c_scl           = rtk_gpio_id(ISO_GPIO, 44),
		.g2c_sda           = rtk_gpio_id(ISO_GPIO, 43),
		.input_mux[0]      = {0xB8060268, (0x7<<20), (0x4<<20)},
		.input_mux[1]      = {0xB8060268, (0x7<<16), (0x4<<16)},
		.pin_mux[0]        = {0xB806022C, (0xF<<28), (0xB<<28), (0xF<<28)},
		.pin_mux[1]        = {0xB8060228, (0xF<<4), (0xB<<4), (0xF<<4)},
	},
	{
		.gpio_mapped       = 1,
		.g2c_scl           = rtk_gpio_id(ISO_GPIO, 38),
		.g2c_sda           = rtk_gpio_id(ISO_GPIO, 37),
		.input_mux[0]      = {0xB8060268, (0x7<<20), (0x5<<20)},
		.input_mux[1]      = {0xB8060268, (0x7<<16), (0x5<<16)},
		.pin_mux[0]        = {0xB8060224, (0xF<<12), (0xB<<12), (0xF<<12)},
		.pin_mux[1]        = {0xB8060224, (0xF<<20), (0xB<<20), (0xF<<20)},
	},
};
...
static const rtk_i2c_port RTK_I2C_i2c1_port[] =
{
	{
		.gpio_mapped       = 1,
		.g2c_scl           = rtk_gpio_id(ISO_GPIO, 87),
		.g2c_sda           = rtk_gpio_id(ISO_GPIO, 88),
		.input_mux[0]      = {0x0, (0), (0)},//table not match register
		.input_mux[1]      = {0x0, (0), (0)},
		.pin_mux[0]        = {0xb806024C,(0xF<<28), (0xB<<28), (0xF<<28)},
		.pin_mux[1]        = {0xb806024C,(0xF<<20), (0xB<<20), (0xF<<20)},
	},
};
...
static rtk_i2c_init_reg RTK_I2C_i2c1_init_reg[] =
{
    ...
    {MISC_SYSTEM_reg, MISC_SYSTEM_i2c1_int_en_mask, MISC_SYSTEM_i2c1_int_en(1)},                 //INT enable
};
...
static const rtk_i2c_port RTK_I2C_i2c2_port[] =
{
	{
		.gpio_mapped       = 1,
		.g2c_scl           = rtk_gpio_id(MIS_GPIO, 68),
		.g2c_sda           = rtk_gpio_id(MIS_GPIO, 65),
		.input_mux[0]      = {(0x0), (0x0), (0x0)},
		.input_mux[1]      = {(0x0), (0x0),  (0x0)},
		.pin_mux[0]        = {0xb800082c, (0xF<<12), (0xB<<12), (0xF<<12)},
		.pin_mux[1]        = {0xb8000828, (0xF<<4), (0xB<<4), (0xF<<4)},
	},
};
...
static rtk_i2c_init_reg RTK_I2C_i2c2_init_reg[] =
{
    ...
    {MISC_SYSTEM_reg, MISC_SYSTEM_i2c2_int_en_mask, MISC_SYSTEM_i2c2_int_en(1)},                 //INT enable
};
...
static const rtk_i2c_port RTK_I2C_i2c3_port[] =
{
	{
		.gpio_mapped       = 1,
		.g2c_scl           = rtk_gpio_id(MIS_GPIO, 56),
		.g2c_sda           = rtk_gpio_id(MIS_GPIO, 52),
		.input_mux[0]      = {0xb80008D0, (0x3<<16),  (0x0<<16)},
		.input_mux[1]      = {0xb80008D0, (0x3<<12),  (0x0<<12)},
		.pin_mux[0]        = {0xb8000820, (0xF<<12), (0xB<<12), (0xF<<12)},
		.pin_mux[1]        = {0xb800081C, (0xF<<12), (0xB<<12), (0xF<<12)},
	},
	{
		.gpio_mapped       = 1,
		.g2c_scl           = rtk_gpio_id(MIS_GPIO, 15),
		.g2c_sda           = rtk_gpio_id(MIS_GPIO, 11),
		.input_mux[0]      = {0xb80008D0, (0x3<<16), (0x1<16)},
		.input_mux[1]      = {0xb80008D0, (0x3<<12), (0x1<<12)},
		.pin_mux[0]        = {0xb8000860, (0xF<<24),(0xB<<24), (0xF<<24)},
		.pin_mux[1]        = {0xb8000860, (0xF<<8), (0xB<<8),  (0xF<<8)},
	},
};
...
static rtk_i2c_init_reg RTK_I2C_i2c3_init_reg[] =
{
    ...
    {MISC_SYSTEM_reg, MISC_SYSTEM_i2c3_int_en_mask, MISC_SYSTEM_i2c3_int_en(1)},                 //INT enable
};
...
static const rtk_i2c_port RTK_I2C_i2c4_port[] =
{
	{
		.gpio_mapped       = 1,
		.g2c_scl           = rtk_gpio_id(MIS_GPIO, 3),
		.g2c_sda           = rtk_gpio_id(MIS_GPIO, 2),
		.input_mux[0]      = {0xb80008D0, (0x3<<8), (0x0<<8)},
		.input_mux[1]      = {0xb80008D0, (0x3<<4), (0x0<<4)},
		.pin_mux[0]        = {0xb8000850, (0xF<<12), (0xB<<12), (0xF<<12)},
		.pin_mux[1]        = {0xb8000850, (0xF<<8),  (0xB<<8),  (0xF<<8)},
	},
	{
		.gpio_mapped       = 1,
		.g2c_scl           = rtk_gpio_id(MIS_GPIO, 38),
		.g2c_sda           = rtk_gpio_id(MIS_GPIO, 50),
		.input_mux[0]      = {0xb80008D0, (0x3<<8),  (0x1<<8)},
		.input_mux[1]      = {0xb80008D0, (0x3<<4),  (0x1<<4)},
		.pin_mux[0]        = {0xb8000810, (0xF<<28), (0xB<<28), (0xF<<28)},
		.pin_mux[1]        = {0xb800081C, (0xF<<28), (0xB<<28), (0xF<<28)},
	},
	{
		.gpio_mapped       = 1,
		.g2c_scl           = rtk_gpio_id(MIS_GPIO, 27),
		.g2c_sda           = rtk_gpio_id(MIS_GPIO, 28),
		.input_mux[0]      = {0xb80008D0, (0x3<<8),  (0x2<<8)},
		.input_mux[1]      = {0xb80008D0, (0x3<<4),  (0x2<<4)},
		.pin_mux[0]        = {0xb8000804, (0xF<<20), (0xB<<20), (0xF<<20)},
		.pin_mux[1]        = {0xb8000804, (0xF<<12), (0xB<<12), (0xF<<12)},
	},
	{
		.gpio_mapped       = 1,
		.g2c_scl           = rtk_gpio_id(MIS_GPIO, 82),
		.g2c_sda           = rtk_gpio_id(MIS_GPIO, 83),
		.input_mux[0]      = {0xb80008D0, (0x3<<8),  (0x3<<8)},
		.input_mux[1]      = {0xb80008D0, (0x3<<4),  (0x3<<4)},
		.pin_mux[0]        = {0xb8000868, (0xF<<28), (0xB<<28), (0xF<<28)},
		.pin_mux[1]        = {0xb8000868, (0xF<<20), (0xB<<20), (0xF<<20)},
	},
};
...
static rtk_i2c_init_reg RTK_I2C_i2c4_init_reg[] =
{
    ...
    {MISC_SYSTEM_reg, MISC_SYSTEM_i2c4_int_en_mask, MISC_SYSTEM_i2c4_int_en(1)},                 //INT enable
};
...
static const rtk_i2c_port RTK_I2C_i2c5_port[] =
{
	{
		.gpio_mapped       = 1,
		.g2c_scl           = rtk_gpio_id(ISO_GPIO, 1),
		.g2c_sda           = rtk_gpio_id(ISO_GPIO, 0),
		.input_mux[0]      = {0xb8060268, (0x7<<12), (0x0<<12)},
		.input_mux[1]      = {0xb8060268, (0x7<<8),  (0x0<<8)},
		.pin_mux[0]        = {0xb8060200, (0xF<<20), (0xB<<20), (0xF<<20)},
		.pin_mux[1]        = {0xb8060200, (0xF<<28), (0xB<<28), (0xF<<28)},
	},
	{
		.gpio_mapped       = 1,
		.g2c_scl           = rtk_gpio_id(ISO_GPIO, 10),
		.g2c_sda           = rtk_gpio_id(ISO_GPIO, 17),
		.input_mux[0]      = {0xb8060268, (0x7<<12), (0x1<<12)},
		.input_mux[1]      = {0xb8060268, (0x7<<8),  (0x1<<8)},
		.pin_mux[0]        = {0xb8060208, (0xF<<12), (0xB<<12), (0xF<<12)},
		.pin_mux[1]        = {0xb8060210, (0xF<<20), (0xB<<20), (0xF<<20)},
	},
	{
		.gpio_mapped       = 1,
		.g2c_scl           = rtk_gpio_id(ISO_GPIO, 18),
		.g2c_sda           = rtk_gpio_id(ISO_GPIO, 26),
		.input_mux[0]      = {0xb8060268, (0x7<<12), (0x2<<12)},
		.input_mux[1]      = {0xb8060268, (0x7<<8),  (0x2<<8)},
		.pin_mux[0]        = {0xb8060210, (0xF<<12), (0xB<<12), (0xF<<12)},
		.pin_mux[1]        = {0xb8060218, (0xF<<12), (0xB<<12), (0xF<<12)},
	},
	{
		.gpio_mapped       = 1,
		.g2c_scl           = rtk_gpio_id(ISO_GPIO, 31),
		.g2c_sda           = rtk_gpio_id(ISO_GPIO, 32),
		.input_mux[0]      = {0xb8060268, (0x7<<12), (0x3<<12)},
		.input_mux[1]      = {0xb8060268, (0x7<<8),  (0x3<<8)},
		.pin_mux[0]        = {0xb806021C, (0xF<<4),  (0xB<<4),  (0xF<<4)},
		.pin_mux[1]        = {0xb8060220, (0xF<<28), (0xB<<28), (0xF<<28)},
	},
	{
		.gpio_mapped       = 1,
		.g2c_scl           = rtk_gpio_id(ISO_GPIO, 7),
		.g2c_sda           = rtk_gpio_id(ISO_GPIO, 6),
		.input_mux[0]      = {0xb8060268, (0x7<<12), (0x4<<12)},
		.input_mux[1]      = {0xb8060268, (0x7<<8),  (0x4<<8)},
		.pin_mux[0]        = {0xb8060204, (0xF<<4),  (0xB<<4),  (0xF<<4)},
		.pin_mux[1]        = {0xb8060204, (0xF<<12), (0xB<<12), (0xF<<12)},
	},
	{
		.gpio_mapped       = 1,
		.g2c_scl           = rtk_gpio_id(ISO_GPIO, 40),
		.g2c_sda           = rtk_gpio_id(ISO_GPIO, 42),
		.input_mux[0]      = {0xb8060268, (0x7<<12), (0x5<<12)},
		.input_mux[1]      = {0xb8060268, (0x7<<8),  (0x5<<8)},
		.pin_mux[0]        = {0xb8060228, (0xF<<28), (0xB<<28), (0xF<<28)},
		.pin_mux[1]        = {0xb8060228, (0xF<<12), (0xB<<12), (0xF<<12)},
	},
	{
		.gpio_mapped       = 1,
		.g2c_scl           = rtk_gpio_id(ISO_GPIO, 35),
		.g2c_sda           = rtk_gpio_id(ISO_GPIO, 36),
		.input_mux[0]      = {0xb8060268, (0x7<<12), (0x6<<12)},
		.input_mux[1]      = {0xb8060268, (0x7<<8),  (0x6<<8)},
		.pin_mux[0]        = {0xb8060220, (0xF<<4),  (0xB<<4),  (0xF<<4)},
		.pin_mux[1]        = {0xb8060224, (0xF<<28), (0xB<<28), (0xF<<28)},
	},
};
