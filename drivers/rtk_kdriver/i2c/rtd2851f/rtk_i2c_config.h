...
{
        {
                ...
                .g2c_sda           = rtk_gpio_id(ISO_GPIO, 3),
                .input_mux[0]      = {0xb8060230, (0x3<<24), (0x0<<24)},//SCL
                .input_mux[1]      = {0xb8060230, (0x3<<20), (0x0<<20)},//SDA
                .pin_mux[0]        = {0xb8060208, (0xF<<28), (0x6<<28), (0xF<<28)},
                .pin_mux[1]        = {0xb8060204, (0xF<<4), (0x6<<4), (0xF<<4)},
        },
        {
                .gpio_mapped       = 1,
                .g2c_scl           = rtk_gpio_id(MIS_GPIO, 21),
                .g2c_sda           = rtk_gpio_id(MIS_GPIO, 20),
                .input_mux[0]      = {0xB8060230, (0x3<<24), (0x1<<24)},
                .input_mux[1]      = {0xB8060230, (0x3<<20), (0x1<<20)},
                .pin_mux[0]        = {0xb800084C, (0xF<<4), (0x6<<4), (0xF<<4)},
                .pin_mux[1]        = {0xb806084C, (0xF<<12), (0x6<<12), (0xF<<12)},
        },
        {
                .gpio_mapped       = 1,
                .g2c_scl           = rtk_gpio_id(ISO_GPIO, 12),
                .g2c_sda           = rtk_gpio_id(ISO_GPIO, 11),
                .input_mux[0]      = {0xB8060230, (0x3<<24), (0x2<<24)},
                .input_mux[1]      = {0xB8060230, (0x3<<20), (0x2<<20)},
                .pin_mux[0]        = {0xb8060210, (0xF<<28), (0x7<<28), (0xF<<28)},
                .pin_mux[1]        = {0xb806020C, (0xF<<4),  (0x7<<4),  (0xF<<4)},
        },
};
...
static const rtk_i2c_port RTK_I2C_i2c1_port[] =
{
        {
                .gpio_mapped       = 1,
                .g2c_scl           = rtk_gpio_id(MIS_GPIO, 10),
                .g2c_sda           = rtk_gpio_id(MIS_GPIO, 9),
                .input_mux[0]      = {0xb80008C4, (0x3<<8), (0x0<<8)},
                .input_mux[1]      = {0xb80008C4, (0x3<<4), (0x0<<4)},
                .pin_mux[0]        = {0xb8000844,(0xF<<28),(0x6<<28), (0xF<<28)},
                .pin_mux[1]        = {0xb8000840,(0xF<<4),(0x6<<4), (0xF<<4)},
        },
        {
                .gpio_mapped       = 1,
                .g2c_scl           = rtk_gpio_id(ISO_GPIO, 8),
                .g2c_sda           = rtk_gpio_id(ISO_GPIO, 7),
                .input_mux[0]      = {0xb80008C4, (0x3<<8), (0x1<<8)},
                .input_mux[1]      = {0xb80008C4, (0x3<<4), (0x1<<4)},
                .pin_mux[0]        = {0xb806020C, (0xF<<28), (0x7<<28), (0xF<<28)},
                .pin_mux[1]        = {0xb8060208, (0xF<<4),  (0x7<<4),  (0xF<<4)},
        },
};
...
static const rtk_i2c_port RTK_I2C_i2c2_port[] =
{
        {
                .gpio_mapped       = 1,
                .g2c_scl           = rtk_gpio_id(MIS_GPIO, 84),
                .g2c_sda           = rtk_gpio_id(MIS_GPIO, 83),
                .input_mux[0]      = {0xb80008C4, (0x3<<0), (0x0<<0)},
                .input_mux[1]      = {0xb80008C8, (0x3<<28), (0x0<<28)},
                .pin_mux[0]        = {0xb800080C, (0xF<<4), (0x6<<4), (0xF<<4)},
                .pin_mux[1]        = {0xb800080C, (0xF<<12), (0x6<<12), (0xF<<12)},
        },
        {
                .gpio_mapped       = 1,
                .g2c_scl           = rtk_gpio_id(MIS_GPIO, 86),
                .g2c_sda           = rtk_gpio_id(MIS_GPIO, 85),
                .input_mux[0]      = {0xb80008C4, (0x3<<0), (0x1<<0)},
                .input_mux[1]      = {0xb80008C8, (0x3<<28), (0x1<<28)},
                .pin_mux[0]        = {0xb8000810, (0xF<<20), (0x6<<20), (0xF<<20)},
                .pin_mux[1]        = {0xb8000810, (0xF<<28), (0x6<<28), (0xF<<28)},
        },
        {
                .gpio_mapped       = 1,
                .g2c_scl           = rtk_gpio_id(ISO_GPIO, 10),
                .g2c_sda           = rtk_gpio_id(ISO_GPIO, 9),
                .input_mux[0]      = {0xb80008C4, (0x3<<0),  (0x2<<0)},
                .input_mux[1]      = {0xb80008C8, (0x3<<28), (0x2<<28)},
                .pin_mux[0]        = {0xb806020C, (0xF<<12), (0x7<<12), (0xF<<12)},
                .pin_mux[1]        = {0xb806020C, (0xF<<20), (0x7<<20), (0xF<<20)},
        },
};
