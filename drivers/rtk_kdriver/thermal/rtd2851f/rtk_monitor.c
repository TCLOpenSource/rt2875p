...
static void Kernal_ZqCalibration(void)
{
    ...
    if((test_mode & 0x2) == 0x2)   //[1]Main Enable
    {
            ...
            if((test_mode & 0x20) == 0x20)   // [5]:ZQ msg
            {
                    pr_emerg("[ZqCalDebugInfo]: value(0x%08x,0x%08x): 0x%08x, 0x%08x", DC1_OCDP_SET0, DC1_OCDN_SET0, rtd_ZQ_inl(DC1_OCDP_SET0), rtd_ZQ_inl(DC1_OCDN_SET0));
                    pr_emerg("[ZqCalDebugInfo]: value(0x%08x,0x%08x): 0x%08x, 0x%08x", DC1_OCDP_SET0 + 0x4, DC1_OCDN_SET0 + 0x4, rtd_ZQ_inl(DC1_OCDP_SET0 + 0x4), rtd_ZQ_inl(DC1_OCDN_SET0 + 0x4));
            }

            if((test_mode & 0x20) == 0x20)   // [5]:ZQ msg
            {
                    pr_emerg("[ZqCalDebugInfo]: value(0x%08x,0x%08x): 0x%08x, 0x%08x", DC1_OCDP_SET1, DC1_OCDN_SET1, rtd_ZQ_inl(DC1_OCDP_SET1), rtd_ZQ_inl(DC1_OCDN_SET1));
                    pr_emerg("[ZqCalDebugInfo]: value(0x%08x,0x%08x): 0x%08x, 0x%08x", DC1_OCDP_SET1 + 0x4, DC1_OCDN_SET1 + 0x4, rtd_ZQ_inl(DC1_OCDP_SET1 + 0x4), rtd_ZQ_inl(DC1_OCDN_SET1 + 0x4));
            }
            ...
            if(counter == print_flag)
            {
                    ...
                    if((ZQ_Config & 0x20) == 0x20)   //[5]=1, max and min for each set
                    {
                            ...
                            {
                                    pr_emerg("[ZqCompare]: DC1_PMOS_SET%d_max=%d\n", i, DC1_SET_max[i]);
                                    pr_emerg("[ZqCompare]: DC1_PMOS_SET%d_min=%d\n", i, DC1_SET_min[i]);
                            }
