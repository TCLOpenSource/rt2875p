...
//Enable it when bringup stage (will disable thermal protect/shutdown)
#if 0
#ifdef CONFIG_ARCH_XXX
#define RTK_THERMAL_BRINGUP_VERIFY
#endif
#endif
...
//[RL6702-3737] support two extra thermal meter, use config to select
#define  CONFIG_RTK_KDRV_THERMAL_USING_THERMAL_NUM	0
...
#define THERMAL_SENSOR_1                SCPU_CORE_TEMP_SENSOR_1_reg
#define THERMAL_SENSOR_2                SCPU_CORE_TEMP_SENSOR_2_reg
#define THERMAL_SENSOR_3                SCPU_CORE_TEMP_SENSOR_3_reg
#define THERMAL_SENSOR_4                SCPU_CORE_TEMP_SENSOR_4_reg
#define THERMAL_SENSOR_5                SCPU_CORE_TEMP_SENSOR_5_reg
#define THERMAL_SENSOR_6                SCPU_CORE_TEMP_SENSOR_6_reg
#define THERMAL_SENSOR_7                SCPU_CORE_TEMP_SENSOR_7_reg
#define THERMAL_SENSOR_8                SCPU_CORE_TEMP_SENSOR_8_reg
#define THERMAL_RESULT_1                 SCPU_CORE_THERMAL_RESULT_1_reg
#define THERMAL_RESULT_2                 SCPU_CORE_THERMAL_RESULT_2_reg
#define THERMAL_IRQ_Threshold_1      SCPU_CORE_THERMAL_IRQ_Threshold_1_reg
#define THERMAL_IRQ_Threshold_2      SCPU_CORE_THERMAL_IRQ_Threshold_2_reg
#else
#define THERMAL_SENSOR_1                SCPU_CORE_TEMP_SENSOR_1_2_reg
#define THERMAL_SENSOR_2                SCPU_CORE_TEMP_SENSOR_2_2_reg
#define THERMAL_SENSOR_3                SCPU_CORE_TEMP_SENSOR_3_2_reg
#define THERMAL_SENSOR_4                SCPU_CORE_TEMP_SENSOR_4_2_reg
#define THERMAL_SENSOR_5                SCPU_CORE_TEMP_SENSOR_5_2_reg
#define THERMAL_SENSOR_6                SCPU_CORE_TEMP_SENSOR_6_2_reg
#define THERMAL_SENSOR_7                SCPU_CORE_TEMP_SENSOR_7_2_reg
#define THERMAL_SENSOR_8                SCPU_CORE_TEMP_SENSOR_8_2_reg
#define THERMAL_RESULT_1                 SCPU_CORE_THERMAL_RESULT_1_2_reg
#define THERMAL_RESULT_2                 SCPU_CORE_THERMAL_RESULT_2_2_reg
#define THERMAL_IRQ_Threshold_1      SCPU_CORE_THERMAL_IRQ_Threshold_1_2_reg
#define THERMAL_IRQ_Threshold_2      SCPU_CORE_THERMAL_IRQ_Threshold_2_2_reg
#endif
#else //CONFIG_ARCH_RTK6748
#define THERMAL_SENSOR_1                PLL_REG_TEMP_SENSOR_1_reg
#define THERMAL_SENSOR_2                PLL_REG_TEMP_SENSOR_2_reg
#define THERMAL_SENSOR_3                PLL_REG_TEMP_SENSOR_3_reg
#define THERMAL_SENSOR_4                PLL_REG_TEMP_SENSOR_4_reg
