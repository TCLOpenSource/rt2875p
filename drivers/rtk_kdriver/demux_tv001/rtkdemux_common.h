...
#define MTP_BUFFER_SIZE (8*1024*1024)
...
typedef enum {
	...
	/* sending to MPEG4 decoder to indicate it's QWER or not (VIDEOQWER4) 33*/
	PRIVATEINFO_VIDEO_MPEG4_QWER4,
	...
	/* send qwerplus certify flag to video to enable TPT track resolution scale 65*/
	PRIVATEINFO_QWERPLUS_CERTIFY,
...
typedef enum {
	...
	/*QweR3 resolution In-band Command*/
	VIDEO_QWER3_INBAND_CMD_TYPE_RESOLUTION = 18,

	/*MPEG4 QweR4 detected In-band command*/
	VIDEO_MPEG4_INBAND_CMD_TYPE_QWER4 = 19,
	...
	/*QWER In-band Command*/
	VIDEO_INBAND_CMD_TYPE_QWER_CERTIFY = 36,
