...
/*	Mark2 has a new formula for PLL : PLL Frequency = 27*(NCODE +4 + FCODE/2048)
*	Frequency set to 432 and the PCR local clock will become 90k.
*	Input : (NCODE=12, FCODE=0, PLLDDS_N=0(input divider is 1)), Output value: 432 , 432/1=432
*	Input : (NCODE=60, FCODE=0, PLLDDS_N=3(input divider is 4)), Output value : 1728 , 1728/4=432
*/
/*	The max adjustment of PCR clock :
*
*	max clock rate     (60+4+ (160*16)/2048) - (60 + 4 + 0/2048)      160 * 16
*	--------------- = ------------------------------------------- =  ------------ = 0.01953125
*		90K                   (60 + 4 + 0/2048)                      2048 * 64
*/
/*	not Mark2 :PLL Frequency = 27*(NCODE +3 + FCODE/2048)
*	Frequency set to 432 and the PCR local clock will become 90k.
...
*/
#if defined (CONFIG_ARCH_RTK6748) || defined (CONFIG_ARCH_RTK2851A)
#define PCRTRACK_PREDEFINED_DEFAULT_NCODE              61
#else
#define PCRTRACK_PREDEFINED_DEFAULT_NCODE              60
#endif

#define PCRTRACK_PREDEFINED_DEFAULT_FCODE              0

#define PCRTRACK_PREDEFINED_DEFAULT_IDX                0
#define PCRTRACK_PREDEFINED_FULL_SPAN                  160 // 256
