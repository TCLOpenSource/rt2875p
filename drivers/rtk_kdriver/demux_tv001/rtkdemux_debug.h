...
#define dmx_emerg(fmt, ...)			{rtd_pr_demux_emerg(fmt, ##__VA_ARGS__); }
#define dmx_alert(fmt, ...)			{rtd_pr_demux_alert(fmt, ##__VA_ARGS__); }
#define dmx_crit(fmt, ...)			{rtd_pr_demux_crit(fmt, ##__VA_ARGS__); }
#define dmx_err(fmt, ...)			{rtd_pr_demux_err(fmt, ##__VA_ARGS__); }
#define dmx_warn(fmt, ...)			{rtd_pr_demux_warn(fmt, ##__VA_ARGS__); }
#define dmx_notice(fmt, ...)		{rtd_pr_demux_notice(fmt, ##__VA_ARGS__); }
#define dmx_info(fmt, ...)    		{rtd_pr_demux_info(fmt, ##__VA_ARGS__); }
#define dmx_dbg(fmt, ...)     		{rtd_pr_demux_debug(fmt, ##__VA_ARGS__); }

#define dmx_mask_print_emerg(BIT,fmt, ...)	{if ((BIT) & rtkdemux_dbg_log_mask) {dmx_emerg(fmt, ##__VA_ARGS__);}}
#define dmx_mask_print_alert(BIT,fmt, ...)	{if ((BIT) & rtkdemux_dbg_log_mask) {dmx_alert(fmt, ##__VA_ARGS__);}}
#define dmx_mask_print_crit(BIT,fmt, ...)	{if ((BIT) & rtkdemux_dbg_log_mask) {dmx_crit(fmt, ##__VA_ARGS__);}}
#define dmx_mask_print_err(BIT,fmt, ...)	{if ((BIT) & rtkdemux_dbg_log_mask) {dmx_err(fmt, ##__VA_ARGS__);}}
#define dmx_mask_print_warn(BIT,fmt, ...)	{if ((BIT) & rtkdemux_dbg_log_mask) {dmx_warn(fmt, ##__VA_ARGS__);}}
#define dmx_mask_print_notice(BIT,fmt, ...)	{if ((BIT) & rtkdemux_dbg_log_mask) {dmx_notice(fmt, ##__VA_ARGS__);}}
#define dmx_mask_print_info(BIT,fmt, ...)	{if ((BIT) & rtkdemux_dbg_log_mask) {dmx_info(fmt, ##__VA_ARGS__);}}
#define dmx_mask_print_dbg(BIT,fmt, ...)	{if ((BIT) & rtkdemux_dbg_log_mask) {dmx_dbg(fmt, ##__VA_ARGS__);}}

#define dmx_check_log_mask(BIT)         ((BIT) & rtkdemux_dbg_log_mask)


//#define dmx_info(fmt, ...)     		{if (rtkdemux_dbg_log_mask > DMX_LOGLEVEL_INFO) rtd_pr_demux_emerg(fmt, ##__VA_ARGS__); }
//#define dmx_dbg(fmt, ...)     		{if (rtkdemux_dbg_log_mask > DMX_LOGLEVEL_DEBUG) rtd_pr_demux_emerg(fmt, ##__VA_ARGS__); }
...
extern unsigned char rtkdemux_dbg_check_inband_en;
extern unsigned char rtkdemux_dbg_esbufmonitor_en;
