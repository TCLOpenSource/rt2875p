...
{
#if (ENTER_FREE_RUN_THRESHOLD_LEVEL == 0)
	RCD_UNSTABLE_LEVEL_S = 160,
	RCD_UNSTABLE_LEVEL_A = 120,
	RCD_UNSTABLE_LEVEL_B = 80,
	RCD_UNSTABLE_LEVEL_C = 40,
	RCD_UNSTABLE_AUDIO_LEVEL_S = 160,
	RCD_UNSTABLE_AUDIO_LEVEL_A = 120,
	RCD_UNSTABLE_AUDIO_LEVEL_B = 80,
	RCD_UNSTABLE_AUDIO_LEVEL_C = 40,
#elif (ENTER_FREE_RUN_THRESHOLD_LEVEL == 1)
	...
	RCD_UNSTABLE_AUDIO_LEVEL_B = 80,
	RCD_UNSTABLE_AUDIO_LEVEL_C = 40,
#elif (ENTER_FREE_RUN_THRESHOLD_LEVEL == 2)
	RCD_UNSTABLE_LEVEL_S = 160,
	RCD_UNSTABLE_LEVEL_A = 120,
	RCD_UNSTABLE_LEVEL_B = 80,
	RCD_UNSTABLE_LEVEL_C = 40,
	RCD_UNSTABLE_AUDIO_LEVEL_S = 1600,
	RCD_UNSTABLE_AUDIO_LEVEL_A = 1200,
	RCD_UNSTABLE_AUDIO_LEVEL_B = 800,
	RCD_UNSTABLE_AUDIO_LEVEL_C = 400,
#else
	RCD_UNSTABLE_LEVEL_S = 1600,
	RCD_UNSTABLE_LEVEL_A = 1200,
	RCD_UNSTABLE_LEVEL_B = 800,
...
typedef struct DEMUX_RCD_STABILITY_MONITOR_T_ {
	...
	int audio_array[RCD_STABILITY_SAMPLE_NUM];
	int index;
	int rcdUnstableTotal;           /* total rcd statble value in an array */
	int audio_rcdUnstableTotal;           /* total rcd statble value in an array */
...
typedef struct DEMUX_PCRSYNC_T_ {
	...
	bool isUnderFreeRunMode_audio; //Enter this mode due to unstable RCD
	...
	int64_t streamFirstDemuxAudioPTS;  /*the stream first  pts*/
	int64_t streamFirstDemuxVideoPTS;  /*the stream first  pts*/
	...
	int64_t audio_pts_gap;
	int64_t video_pts_gap;
	...
	/* Dynamic adjust pcrOffset*/
	bool compensateFlag;
	int64_t compensatePcrOffset;
} DEMUX_PCRSYNC_T;
