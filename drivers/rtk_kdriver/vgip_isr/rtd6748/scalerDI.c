...
void scalerVIP_DI_MiddleWare_PAN_Apply()
{
	...
	if(gmv_y_cnt>di_im_di_mpeg_sequence_app_reg.dummy1802404c_6_3)
	{
	...
	VIP_DEBUG_PRINTF("[DI][PAN] gmv_y_cur=%d, gmv_y_pre=%d, gmv_y_cnt=%d, gmv_v_th=%d\n",
						...
						gmv_y_pre, gmv_y_cnt, di_im_di_mpeg_sequence_app_reg.dummy1802404c_6_3);
