...
// apply in 20 IRE
#define Dynamic_Black_Equalize_bin_sta 8	
#define Dynamic_Black_Equalize_bin_end 32 
void scalerVIP_Dynamic_Black_Equalize_byLevel(int *Gz, unsigned int Lv, _system_setting_info *_system_info)
{	
	int offset_tmp = 0;
	int i;
	int max_offset;
...
//=========== define for TV002 ADV API (gain multiply by 1024) =======================
	...
	if (Scaler_APDEM_Arg_Access(DEM_ARG_Dynamic_Black_Equalize_Gain, 0, 0) != 0xFF) {
		...
		scalerVIP_Dynamic_Black_Equalize_byLevel(Gz, APDEM_Dynamic_Equalize, system_info_structure_table);
	}
#endif
//========================================
