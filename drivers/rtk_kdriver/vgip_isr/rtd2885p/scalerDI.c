...
//end chen 190514
	...
	if(((RPC_system_info_structure_table->VIP_source == VIP_QUALITY_HDR_HDMI_4k2k)||
		(RPC_system_info_structure_table->VIP_source == VIP_QUALITY_HDR_DTV_4k2k) ||
	    (RPC_system_info_structure_table->VIP_source == VIP_QUALITY_HDMI_4k2k)) &&
