...
extern unsigned char Sony_test_pattern[100];
...
void scalerVIP_DI_MiddleWare_StatusInit(VIP_SOURCE_TIMING cur_vip_source)
{
    ...
    di_im_di_active_window_msb_control_RBUS di_im_di_active_window_msb_control_reg;
    ...
    di_im_di_active_window_msb_control_reg.regValue = IoReg_Read32(DI_IM_DI_ACTIVE_WINDOW_MSB_CONTROL_reg); 
	...
	di_tnrxc_mkii_ctrl_reg.regValue = rtd_inl(DI_IM_DI_RTNR_REFINED_CTRL_reg);
	Smart_Integration_Status.DI_HEIGHT = ((di_im_di_active_window_msb_control_reg.vsize_msb<<10)+di_active_window_control_reg.vsize);
	Smart_Integration_Status.DI_WIDTH = ((di_im_di_active_window_msb_control_reg.hsize_msb<<11)+di_active_window_control_reg.hsize);
	...
	if (Smart_Integration_Status.DI_HEIGHT == 0) {
		...
		if (Smart_Integration_Status.SCREEN_HMCNR_STATUS.Show_Debug_MSG)
			ROSPrintf_DILv1("[SIS HMCNR] Error : DI_HEIGHT is zero!!\n");
	}
	if (Smart_Integration_Status.DI_WIDTH == 0) {
		if (Smart_Integration_Status.SCREEN_HMCNR_STATUS.Show_Debug_MSG)
			ROSPrintf_DILv1("[SIS HMCNR] Error : DI_WIDTH is zero!!\n");
	...
	if (Smart_Integration_Status.Vip_Source_Timing != cur_vip_source || SIS_INIT == 0) // only initial on vip change source
	{
		...
		switch(Smart_Integration_Status.Vip_Source_Timing)
		{
			...
			case VIP_QUALITY_HDMI_576I:
				...
				//di_di_pq_pq_cmp_pair_reg.dummy18024c04_14_7 = 0x8f; // SD disalbe all
				di_im_di_rtnr_refined_ctrl_reg.dummy180242a8_7 = 0; // mv_modify_en
				di_tnrxc_mkii_ctrl_reg.dummy180242a0_7_2 = 15; // mv_avg_count = 15
				break;
			...
			case VIP_QUALITY_HDMI_1080I:
				...
				//di_di_pq_pq_cmp_pair_reg.dummy18024c04_14_7 = 0x8f;
				di_im_di_rtnr_refined_ctrl_reg.dummy180242a8_7 = 0; // mv_modify_en
				di_tnrxc_mkii_ctrl_reg.dummy180242a0_7_2 = 15; // mv_avg_count = 15
				break;
			...
			default:
				...
				di_im_di_rtnr_refined_ctrl_reg.dummy180242a8_7 = 0; // mv_modify_en
				di_tnrxc_mkii_ctrl_reg.dummy180242a0_7_2 = 0; // mv_avg_count = 0
				break;
		}
...
void scalerVIP_DI_MiddleWare_HMC_Apply()
{
	...
	di_im_new_mcnr_control_RBUS di_im_new_mcnr_control_reg;
	unsigned char cur_source=0;
       // static signed char mcnr_pan_cnt=0;
/*
...
*/
	...
	di_im_new_mcnr_control_reg.regValue = rtd_inl(DI_IM_NEW_MCNR_CONTROL_reg);
	cur_source=(RPC_system_info_structure_table->VIP_source);
#if 1
	if(cur_source == VIP_QUALITY_DTV_576I) // for 576i need more time to enter pan
        {

                if (Smart_Integration_Status.SCREEN_HMC_STATUS.Pass_Result_Total < 3 || Smart_Integration_Status.SCREEN_ACTION_STATUS.FILM_detect == 1)
                {
                        di_hmc_me_refine_ctrl2_reg.hmc_fw_ctrl_bypass = 1;
                        hmc_statistic1_reg.ma_hmc_lineratio = 0;
                }
                else if (Smart_Integration_Status.SCREEN_HMC_STATUS.Pass_Result_Total >= 3 && Smart_Integration_Status.SCREEN_HMC_STATUS.Pass_Result_Total < 10)
                {
                        di_hmc_me_refine_ctrl2_reg.hmc_fw_ctrl_bypass = 0;
                        hmc_statistic1_reg.ma_hmc_lineratio = 6;//1;
                }
                else if (Smart_Integration_Status.SCREEN_HMC_STATUS.Pass_Result_Total >= 10 && Smart_Integration_Status.SCREEN_HMC_STATUS.Pass_Result_Total < 20)
                {
                        di_hmc_me_refine_ctrl2_reg.hmc_fw_ctrl_bypass = 0;
                        hmc_statistic1_reg.ma_hmc_lineratio = 7;//6;
                }
                else if (Smart_Integration_Status.SCREEN_HMC_STATUS.Pass_Result_Total >= 20 && Smart_Integration_Status.SCREEN_HMC_STATUS.Pass_Result_Total < 30)
                {
                        di_hmc_me_refine_ctrl2_reg.hmc_fw_ctrl_bypass = 0;
                        hmc_statistic1_reg.ma_hmc_lineratio = 8;//6;
                }
                else if (Smart_Integration_Status.SCREEN_HMC_STATUS.Pass_Result_Total >= 30 && Smart_Integration_Status.SCREEN_HMC_STATUS.Pass_Result_Total < 40)
                {
                        di_hmc_me_refine_ctrl2_reg.hmc_fw_ctrl_bypass = 0;
                        hmc_statistic1_reg.ma_hmc_lineratio = 10;//6;
                }
                ...
                {
                        di_hmc_me_refine_ctrl2_reg.hmc_fw_ctrl_bypass = 0;
                        hmc_statistic1_reg.ma_hmc_lineratio = 12;//6;
                }
                ...
                {
                        di_hmc_me_refine_ctrl2_reg.hmc_fw_ctrl_bypass = 0;
                        hmc_statistic1_reg.ma_hmc_lineratio = 14;//6;
                }
                ...
                {
                        di_hmc_me_refine_ctrl2_reg.hmc_fw_ctrl_bypass = 0;
                        hmc_statistic1_reg.ma_hmc_lineratio = 16;//8;
                }
                ...
                {
                        di_hmc_me_refine_ctrl2_reg.hmc_fw_ctrl_bypass = 0;
                        hmc_statistic1_reg.ma_hmc_lineratio = 20;//10;
                }
                else if (Smart_Integration_Status.SCREEN_HMC_STATUS.Pass_Result_Total > 100)
                {
                        di_hmc_me_refine_ctrl2_reg.hmc_fw_ctrl_bypass = 0;
                        hmc_statistic1_reg.ma_hmc_lineratio = 24;//12;
                }
	...
	else
        {
                ...
                {
                        di_hmc_me_refine_ctrl2_reg.hmc_fw_ctrl_bypass = 0;
                        hmc_statistic1_reg.ma_hmc_lineratio = 2;//1;
                }
  ...
  // henry 180307
	...
	{
		di_hmc_me_refine_ctrl2_reg.hmc_fw_ctrl_bypass = 0;
		hmc_statistic1_reg.ma_hmc_lineratio = 36;//36;
	}
       // printk("gmv =%d \n",scalerVIP_DI_MiddleWare_MCNR_Get_GMV_Ratio());
...
//		rtd_clearbits(DI_IM_DI_HMC_ADJUSTABLE_reg, _BIT17);
	...
	// === diagonal motion setting, henry
	if(di_im_new_mcnr_control4.n_mcnr_v_pan_mv != 6)
		di_hmc_me_refine_ctrl2_reg.hmc_fw_ctrl_bypass = 1;
	else
		di_hmc_me_refine_ctrl2_reg.hmc_fw_ctrl_bypass = 0;
	rtd_outl(DI_IM_DI_HMC_ME_REFINE_CTRL_2_reg, di_hmc_me_refine_ctrl2_reg.regValue);
	...
	// 181016 henry - Pan case of interlaced mix mode in DTV SD (tv006)
	//if((RPC_system_info_structure_table->VIP_source==VIP_QUALITY_DTV_480I || RPC_system_info_structure_table->VIP_source==VIP_QUALITY_DTV_576I)
	//	&& di_im_new_mcnr_control_reg.n_h_pan_flag)
	//	di_hmc_me_refine_ctrl2_reg.hmc_fw_ctrl_bypass = 1;
...
void scalerVIP_DI_MiddleWare_PAN_Apply()
{
	...
	di_im_new_mcnr_control4.regValue = rtd_inl(DI_IM_NEW_MCNR_CONTROL4_reg);
	di_im_di_mpeg_sequence_app_reg.regValue = rtd_inl(DI_IM_DI_MPEG_SEQUENCE_APP_reg);
	...
	if((cur_source >= VIP_QUALITY_CVBS_NTSC && cur_source <=VIP_QUALITY_YPbPr_576P)||
		...
		(cur_source >= VIP_QUALITY_DTV_480P && cur_source <=VIP_QUALITY_DTV_576P)||
	...
	{
		di_im_di_pan_detection_control_2_reg.pan_mc_edge_v = 1;
		di_im_di_hmc_pan_control_reg.pan_mc_adaptive_compensation_en = 0;
		di_im_di_pan_detection_control_2_reg.pan_mc_teeth_check_en = 0;
	}
	// === end teeth and jaggy process
	...
	if(gmv_y_cnt>di_im_di_mpeg_sequence_app_reg.dummy1802404c_6_5)
	{
	...
	// henry debug print
	VIP_DEBUG_PRINTF("[DI][PAN] pan_en=%d, pan_det=%d, pan_mv=%d\n",
						di_pan_detection_control_1_reg.pan_en,
						di_im_di_hmc_pan_control_reg.pan_me_fw_control_motion_vector_det,
						di_im_di_hmc_pan_control_reg.pan_me_fw_control_motion_vector);
	VIP_DEBUG_PRINTF("[DI][PAN] mv_now=%d, mv_avg_count=%d, mv_modify_en=%d\n",
						fw_mv[0], mv_avg_count, mv_modify_en);
	VIP_DEBUG_PRINTF("[DI][PAN] gmv_y_cur=%d, gmv_y_pre=%d, gmv_y_cnt=%d, gmv_v_th=%d\n",
						di_im_new_mcnr_control4.n_mcnr_v_pan_mv,
						gmv_y_pre, gmv_y_cnt, di_im_di_mpeg_sequence_app_reg.dummy1802404c_6_5);
...
//	else
	...
	if (Smart_Integration_Status.SCREEN_HMCNR_STATUS.Show_Debug_MSG && pre_hmcnr_detect_status != Smart_Integration_Status.SCREEN_ACTION_STATUS.HMCNR_detect)
		ROSPrintf_DILv1("[SIS HMCNR] HMCNR status change!! - current is: %d\n", Smart_Integration_Status.SCREEN_ACTION_STATUS.HMCNR_detect);
...
void scalerVIP_DI_MiddleWare_MCNR_Ctrl(unsigned char weight)
{
	...
	unsigned char cur_source=0,sd_input=0;
	cur_source=(system_info_structure_table->VIP_source);
...
//==============================================================================================================
	...
	{
		if(rtd_inl(SUB_DITHER_I_Sub_Dither_SEQ_G_00_07_reg)==0) //b802267C
		{
			ROSPrintf_DILv1("MC Hpan =%d ,Vpan=%d ,diff_th_h=%d \n",Hpan_value,Vpan_value,diff_th_h);
			ROSPrintf_DILv1("GMVx1_ctr_acc =%d ,GMVx1_acc=%d \n",GMVx1_ctr_acc,GMVx1_acc);
			ROSPrintf_DILv1("GMV_ratio_h =%d ,GMV_ratio_v=%d \n",GMV_ratio_h,GMV_ratio_v);
			ROSPrintf_DILv1("Hpan_flag =%d ,Vpan_flag=%d \n",Hpan_flag_n,Vpan_flag_n);
		}
		else if(rtd_inl(SUB_DITHER_I_Sub_Dither_SEQ_G_00_07_reg)==1) //b802267C
		{
			ROSPrintf_DILv1("MC Hpan =%d ,Vpan=%d ,diff_th_v=%d \n",Hpan_value,Vpan_value,diff_th_v);
			ROSPrintf_DILv1("GMVy1_ctr_acc =%d ,GMVy1_acc=%d \n",GMVy1_ctr_acc,GMVy1_acc);
			ROSPrintf_DILv1("GMV_ratio_h =%d ,GMV_ratio_v=%d \n",GMV_ratio_h,GMV_ratio_v);
			ROSPrintf_DILv1("Hpan_flag =%d ,Vpan_flag=%d \n",Hpan_flag_n,Vpan_flag_n);
		}
	}
...
//		Hpan_value=10;
	...
	if((MA_print_count%debug_print_delay_time==0)&&(Start_Print.ID_Pattern_47==TRUE))
	{
		...
		if(rtd_inl(SUB_DITHER_I_Sub_Dither_SEQ_G_00_07_reg)==2) //b802267c
		{
			ROSPrintf_DILv1("Hpan_value =%d ,Vpan=%d \n",Hpan_value,Vpan_value);
...
#if 0
	ROSPrintf_DILv1("gx =%d ,gy=%d ,gmx =%d , gmy =%d \n",init_di_smd_gmvcoeff3_reg.smd_gmv1_x,
...
// chen 180308
	...
	di_di_smd_waterflow_teeth_count_RBUS	di_di_smd_waterflow_teeth_count;
	di_di_smd_hardwarepan_modify1_RBUS di_smd_hardwarepan_modify1; //fw_gmvx
	di_di_smd_waterflag_ctr3_RBUS	di_di_smd_waterflag_ctr3; //fw_gmvy

	int ratio_static_TH=40;
	static bool static_flag_c=0, static_flag_p1=0, static_flag_p2=0, static_flag_p3=0, static_flag_p4=0;
	static int ratio_static_c=0;
	static int ratio_static_p=0;
	static int ratio_static_p2=0;
	static int ratio_static_p3=0;

// chen 190514
	static bool pan_flag_pre;
	static int gmvx_pre, gmvy_pre;

	int film_mode_others=0;
	int mov_th2=20;
	// end chen 190514

	int pan_detect_en=1;
	int film_mode_flag=0;//0;
	static unsigned char isFilm_22 = 40;
	...
	bool MCNR_TMV_value0_en=0;
	bool mcnr_mad_hist_all_en=0;

	int mvx_hist_sum_p12_15=0;
 	int mvx_hist_sum_n12_15=0;

 	//int di_teeth_count_cur=0;
	//static int di_teeth_count_acc=0;
	//int gmv_x_tmp,gmv_y_tmp;
	bool reg_vc_nr_MCNR_TMV_no_reset=0;
        //int di_pan_mvx=0;
...
// end chen 180308
	...
	int mcnr_static_sum=1;//4a0c[15:0]
	int sum_h=0;
	int sum_v=0;
	int h_gmv_ratio=0;
	int v_gmv_ratio=0;
	...
	//int mvx_15_ratio=0,mvx_16_ratio=0,mvx_17_ratio=0;
	//int mvy_3_ratio=0,mvy_4_ratio=0;
	...
	int GMV_ratio_v_lr=0;
	int GMV_ratio_h_lr=0;
	...
	di_im_new_mcnr_tmv_penalty_th.regValue = rtd_inl(DI_IM_NEW_MCNR_TMV_Penalty_TH_reg);

// chen 180308
	di_di_smd_teeth_processing.regValue = rtd_inl(DI_DI_SMD_Teeth_Processing_reg);
	di_di_smd_waterflow_teeth_count.regValue = rtd_inl(DI_DI_SMD_WaterFlow_Teeth_Count_reg);
	di_smd_hardwarepan_modify1.regValue = rtd_inl(DI_DI_SMD_HardwarePan_Modify1_reg);
	...
	mcnr_static_sum=di_im_di_rtnr_mcnr_statistic_15.mcnr_static_sum;
	for(i=0; i<31; i++)
	{
		vc_nr_MCNR_mvx_hist[i]=(vc_nr_MCNR_mvx_hist[i]>>4);
		sum_h=sum_h+vc_nr_MCNR_mvx_hist[i];
	...
	for(i=0; i<31; i++)
	{
	    ...
	    // chen 180308
	    if(i>=27)
	    	mvx_hist_sum_p12_15=mvx_hist_sum_p12_15+mvx_hist_adj_add;

    	if(i<=3)
	    	mvx_hist_sum_n12_15=mvx_hist_sum_n12_15+mvx_hist_adj_add;
	    // end chen 180308
...
// chen 180308
	if(max_hist_h_MV>=4 && max_hist_h_MV<=26)
	{
		if(mvx_hist_sum_p12_15>mvx_hist_sum_n12_15 &&
		mvx_hist_sum_p12_15>max_hist_h)
		{
			max_hist_h=mvx_hist_sum_p12_15;
			max_hist_h_MV=27;
		}
		else if(mvx_hist_sum_n12_15>mvx_hist_sum_p12_15 &&
		mvx_hist_sum_n12_15>max_hist_h)
		{
			max_hist_h=mvx_hist_sum_n12_15;
			max_hist_h_MV=3;
		}
	}
	// end chen 180308
...
// end chen 171005
	...
	{
		if(max_hist_h_MV==15)
		g_gmv_ratio=vc_nr_MCNR_mvx_hist[14]+vc_nr_MCNR_mvx_hist[15]+vc_nr_MCNR_mvx_hist[16]+(mcnr_static_sum>>4);
		if(max_hist_h_MV==14)
		g_gmv_ratio=vc_nr_MCNR_mvx_hist[13]+vc_nr_MCNR_mvx_hist[14]+vc_nr_MCNR_mvx_hist[15]+(mcnr_static_sum>>4);
		if(max_hist_h_MV==16)
		g_gmv_ratio=vc_nr_MCNR_mvx_hist[15]+vc_nr_MCNR_mvx_hist[16]+vc_nr_MCNR_mvx_hist[17]+(mcnr_static_sum>>4);

		g_gmv_ratio_y=vc_nr_MCNR_mvy_hist[6]+vc_nr_MCNR_mvy_hist[5]+vc_nr_MCNR_mvy_hist[7]+(mcnr_static_sum>>4);
	...
	if((g_gmv_ratio>50 && g_gmv_ratio_y>50 && max_hist_v_MV==6 && max_hist_h_MV>=14 && max_hist_h_MV<=16)&&sd_input==0)
	{
	...
	if(((g_gmv_ratio>50&&g_gmv_ratio<95) && (g_gmv_ratio_y>50&&g_gmv_ratio_y<95) && max_hist_v_MV==6 && max_hist_h_MV>=14 && max_hist_h_MV<=16)&&sd_input==0)
	{
		soft_move =1;
	}
	else
	...
	if(((g_gmv_ratio>80) && (g_gmv_ratio_y>80) && max_hist_v_MV==6 && max_hist_h_MV==15)&&
		((SmartPic_clue->HMC_bin_hist_Ratio[16]>900)&&(sd_input==0)))
	{
		static_move =1;
	}
	else
	...
	/*mvx_15_ratio =vc_nr_MCNR_mvx_hist[15]*100/sum_h;
	mvx_16_ratio =vc_nr_MCNR_mvx_hist[16]*100/sum_h;
	mvx_17_ratio =vc_nr_MCNR_mvx_hist[17]*100/sum_h;

	mvy_3_ratio =vc_nr_MCNR_mvy_hist[3]*100/sum_v;
	mvy_4_ratio =vc_nr_MCNR_mvy_hist[4]*100/sum_v;*/
	...
	GMVx=max_hist_h_MV-reg_vc_nr_HMCNR_search_range_full;
	GMVy=max_hist_v_MV-reg_vc_nr_MCNR_V_search_range_full;

	GMV_ratio_v=max_hist_v*100/sum_v;
	GMV_ratio_h=max_hist_h*100/sum_h;

	GMV_ratio_v_lr=max_hist_v_lr*100/sum_v;
	GMV_ratio_h_lr=max_hist_h_lr*100/sum_h;
	...
	if(cur_source ==VIP_QUALITY_HDMI_1080I)
	{
		if(scalerVIP_DI_MiddleWare_MCNR_Get_Pan_Flag()==1)
		{
			...
			{
				coring_diff_v=coring_diff*3/4; 
				coring_diff_h=coring_diff*1/4;
			}
			else if((abs(GMVx)-abs(GMVy))<=-2)
			{
				coring_diff_v=coring_diff*1/4;	
				coring_diff_h=coring_diff*3/4;
			}
...
/*
	// chen 170905
	static_flag_p4=static_flag_p3;
	static_flag_p3=static_flag_p2;
	static_flag_p2=static_flag_p1;
	static_flag_p1=static_flag_c;

	ratio_static_p=ratio_static_c;
	ratio_static_c=ratio_static;


  static_th1=75;
  static_th2=50;

	non_static_22_flag=(ratio_static_p<=20 || ratio_static_c<=20);
	if(static_flag==1 && ratio_static>=static_th1)
		static_flag_c=1;
	else
		static_flag_c=0;
*/
// end chen 180308 remove
	...
	if( FilmInfo == NULL )
	{
		ROSPrintf_DILv1("[%s] Film information ptr from MEMC error\n", __func__);
	}

	// Debounce
	if( FilmInfo[_FILM_MEMC_OUT_ALL] != 1 && isFilm_22 > 0 )
		isFilm_22--;
	else if( FilmInfo[_FILM_MEMC_OUT_ALL] == 1 )
		isFilm_22 = 40;
...
// chen 180308
	if((isFilm_22>0)&&(Smart_Integration_Status.Mode_Progressive==1))
{
	film_mode_22p=1;
	}
	else{
...
// chen 190514 only for test
	/*if(rtd_inl(0xb802e4f0)==1)
		film_mode_22p=1;
	else if(rtd_inl(0xb802e4f0)==2)
		film_mode_32p=1;
	else if(rtd_inl(0xb802e4f0)==4)
		film_mode_32i=1;
	else if(rtd_inl(0xb802e4f0)==8)
		film_mode_others=1;
	*/
//end 190514
...
//if(film_mode_22p==1 || film_mode_32p==1 || film_mode_32i==1)
// chen 190514
	if(film_mode_22p==1 || film_mode_32p==1 || film_mode_32i==1 || film_mode_others==1)
//end chen 190514
		film_mode_flag=1;

	ratio_static_p3=ratio_static_p2;
	ratio_static_p2=ratio_static_p;
	ratio_static_p=ratio_static_c;
	ratio_static_c=ratio_static;

	if(abs(ratio_static_c-ratio_static_p)<=10 && abs(ratio_static_c-ratio_static_p2)<=10)
	{
		static_th=97;
		mov_th=5;
	}
	else if(abs(ratio_static_c-ratio_static_p)<=15  && abs(ratio_static_c-ratio_static_p2)<=15)
	{
		static_th=93;
		mov_th=10;
	}
...
//	if((GMVy!=0 || GMVx!=0) && ((DynamicOptimizeSystem[177]==1)))
...
if(DynamicOptimizeSystem[177]==1)
{
...
else if((GMVy!=0 || GMVx!=0) && ((ratio_static<=ratio_static_TH) ||(DynamicOptimizeSystem[177]==1)))
		static_flag=0;
else
		static_flag=1;
	...
	if(static_flag==1 && ratio_static>=static_th)
		static_flag_c=1;
	else
		static_flag_c=0;

	//22P
	if(film_mode_22p==1 && film_mode_flag==1)
	{
		if(static_flag_c==1 && (100-ratio_static_p)>=mov_th)
			reg_vc_nr_MCNR_TMV_no_reset=0;
		else
			reg_vc_nr_MCNR_TMV_no_reset=1;
	}
	// 32P
	else if(film_mode_32p==1 && film_mode_flag==1)
	{
		if((static_flag_c==1 && (100-ratio_static_p)>=mov_th && static_flag_p2==1 && static_flag_p3==1) ||
			(static_flag_c==1 && static_flag_p1==1 && (100-ratio_static_p2)>=mov_th))
			reg_vc_nr_MCNR_TMV_no_reset=0;
		else
			reg_vc_nr_MCNR_TMV_no_reset=1;
	}
// 32i
	else if(film_mode_32i==1 && film_mode_flag==1)
	{
		if((100-ratio_static)>=mov_th &&
			 (100-ratio_static_p)>=mov_th &&
			 (100-ratio_static_p2)>=mov_th &&
			 (100-ratio_static_p3)>=mov_th &&
			 static_flag_p4==1
			 )
			reg_vc_nr_MCNR_TMV_no_reset=1;
		else
	...
	// chen 190514
	else if (film_mode_others==1 && film_mode_flag==1)
	{
		reg_vc_nr_MCNR_TMV_no_reset=1;
	}
	//end chen 190514
...
//if((film_mode_22flag==0 || (static_flag_c==0 && ratio_static_p>=static_th1)) && pan_detect_en==1)
// chen 180308
if((film_mode_flag==0 || (static_flag_c==0)) && pan_detect_en==1)
// end chen 180308
{
...
// end chen 180308 remove
	...
	pan_flag=(Vpan_flag_n==1 && Hpan_flag_n==1 && (GMVx1_acc!=0 || GMVy1_acc!=0) && (GMVx!=0 || GMVy!=0));
...
else
{
	...
	di_im_new_mcnr_gmv_hist_ctrl.n_mcnr_hmv_th2=30;
...
//chen 180308
	// chen 190514
	if(static_flag_c==0 || film_mode_flag==0 )
//end chen 190514
	{
		pan_flag_pre=reg_h_pan_flag;
		gmvx_pre=GMVx+reg_vc_nr_HMCNR_search_range_full;
		gmvy_pre=GMVy+reg_vc_nr_MCNR_V_search_range_full;
	}
	else
	{
		/*
		pan_flag_pre=pan_flag_pre;
		gmvx_pre=gmvx_pre;
		gmvy_pre=gmvy_pre;
	*/
	// chen 190514
		if(film_mode_others==0 && ((100-ratio_static_p)>=mov_th2 || (100-ratio_static_p2)>=mov_th2))
		{
			//pan_flag_pre=pan_flag_pre;
			//gmvx_pre=gmvx_pre;
			//gmvy_pre=gmvy_pre;
		...
		{
			pan_flag_pre=0;
			gmvx_pre=reg_vc_nr_HMCNR_search_range_full;
			gmvy_pre=reg_vc_nr_MCNR_V_search_range_full;
		}
	//end chen 190514

	}

	if(reg_vc_nr_MCNR_TMV_no_reset==1)
	{
		reg_h_pan_flag=0;
		MCNR_TMV_value0_en=1;
	}
	else
	{
		reg_h_pan_flag=pan_flag_pre;
		MCNR_TMV_value0_en=0;
	}
	...
	if(film_mode_flag==1)
	{
		mv_h_pan=gmvx_pre;
		mv_v_pan=gmvy_pre;
		mcnr_mad_hist_all_en=1;
	}
	else
	{
		mv_h_pan=GMVx+reg_vc_nr_HMCNR_search_range_full;
		mv_v_pan=GMVy+reg_vc_nr_MCNR_V_search_range_full;
		mcnr_mad_hist_all_en=0;
	}


	di_im_new_mcnr_control3.n_mcnr_tmv_value0_en=MCNR_TMV_value0_en;
	di_im_new_mcnr_control3.n_mcnr_mad_hist_all_en=mcnr_mad_hist_all_en;

	//rtd_outl(DI_IM_NEW_MCNR_CONTROL3_reg,di_im_new_mcnr_control3.regValue);
// end chen 180308

// chen 190514
	if (film_mode_others==1 && film_mode_flag==1)
	{
		if(scalerVIP_Get_Noise_Level()<=6)
		{
			di_im_new_mcnr_tmv_penalty_th.n_mcnr_tmv_penalty1=2;
			di_im_new_mcnr_tmv_penalty_th.n_mcnr_tmv_penalty2=2;
			di_im_new_mcnr_tmv_penalty_th.n_mcnr_tmv_penalty3=1;
			di_im_new_mcnr_tmv_penalty_th.n_mcnr_tmv_penalty4=1;
			di_im_new_mcnr_tmv_penalty_th.n_mcnr_tmv_penalty5=1;
			di_im_new_mcnr_tmv_penalty_th.n_mcnr_tmv_penalty6=0;
			di_im_new_mcnr_tmv_penalty_th.n_mcnr_tmv_penalty7=0;
		}
		else if(scalerVIP_Get_Noise_Level()<=7)
		{
			di_im_new_mcnr_tmv_penalty_th.n_mcnr_tmv_penalty1=3;
			di_im_new_mcnr_tmv_penalty_th.n_mcnr_tmv_penalty2=2;
			di_im_new_mcnr_tmv_penalty_th.n_mcnr_tmv_penalty3=2;
			di_im_new_mcnr_tmv_penalty_th.n_mcnr_tmv_penalty4=1;
			di_im_new_mcnr_tmv_penalty_th.n_mcnr_tmv_penalty5=1;
			di_im_new_mcnr_tmv_penalty_th.n_mcnr_tmv_penalty6=1;
			di_im_new_mcnr_tmv_penalty_th.n_mcnr_tmv_penalty7=0;
		}
		else
		{
			di_im_new_mcnr_tmv_penalty_th.n_mcnr_tmv_penalty1=4;
			di_im_new_mcnr_tmv_penalty_th.n_mcnr_tmv_penalty2=3;
			di_im_new_mcnr_tmv_penalty_th.n_mcnr_tmv_penalty3=3;
			di_im_new_mcnr_tmv_penalty_th.n_mcnr_tmv_penalty4=2;
			di_im_new_mcnr_tmv_penalty_th.n_mcnr_tmv_penalty5=2;
			di_im_new_mcnr_tmv_penalty_th.n_mcnr_tmv_penalty6=1;
			di_im_new_mcnr_tmv_penalty_th.n_mcnr_tmv_penalty7=0;
		}
		rtd_outl(DI_IM_NEW_MCNR_TMV_Penalty_TH_reg,di_im_new_mcnr_tmv_penalty_th.regValue);

	}
//end chen 190514


       // if(Smart_Integration_Status.Mode_Progressive==0&&reg_h_pan_flag==1 && abs(max_hist_v_MV-6)==0 && abs(di_pan_mvx-max_hist_h_MV)>=2 && abs(max_hist_h_MV-15)==1 && abs(di_pan_mvx-15)>1)
        //                      mv_h_pan=di_pan_mvx;

	if(RPC_system_info_structure_table->VIP_source==VIP_QUALITY_TV_SECAN)
		reg_h_pan_flag=0;

	if(((RPC_system_info_structure_table->VIP_source == VIP_QUALITY_HDR_HDMI_4k2kP_30)||
		(RPC_system_info_structure_table->VIP_source == VIP_QUALITY_HDR_HDMI_4k2kP_60)||
		(RPC_system_info_structure_table->VIP_source == VIP_QUALITY_HDR_DTV_4k2kP_30) ||
		(RPC_system_info_structure_table->VIP_source == VIP_QUALITY_HDR_DTV_4k2kP_60) ||
		(RPC_system_info_structure_table->VIP_source == VIP_QUALITY_HDMI_4k2kI_30) ||
		(RPC_system_info_structure_table->VIP_source == VIP_QUALITY_HDMI_4k2kP_30) ||
		(RPC_system_info_structure_table->VIP_source == VIP_QUALITY_HDMI_4k2kP_60)) &&
		(SmartPic_clue->Hist_Y_Mean_Value < 13))
	{
		reg_h_pan_flag = 0;
	}
	...
	di_im_new_mcnr_control.n_h_pan_flag=reg_h_pan_flag;
        if(DynamicOptimizeSystem[177]==1){  //fixed me
                if(mv_h_pan ==19)
                mv_h_pan =18;
               //di_pan_mvx= -(Smart_Integration_Status.SCREEN_HMC_STATUS.BIN_Rank[0]+1-17)+15;


       di_im_new_mcnr_control3.n_mcnr_messlevel_th =200;
        }
        else
        {
                di_im_new_mcnr_control3.n_mcnr_messlevel_th =100;
	...
	/*if(( ((mv_h_pan==15 || mv_h_pan==16|| mv_h_pan==17) &&	mv_v_pan==4) ||
		(mv_v_pan==3 && vc_nr_MCNR_mvy_hist[3]<=vc_nr_MCNR_mvy_hist[4]*4)) && reg_h_pan_flag==1&&
	...
	//scalerVIP_DI_MiddleWare_MCNR_Set_Pan_Flag(reg_h_pan_flag);
        ...
        if((reg_h_pan_flag==1)&&(mv_h_pan==15))
        {
                scalerVIP_DI_MiddleWare_MCNR_Set_V_Pan_Flag(1);
                scalerVIP_DI_MiddleWare_MCNR_Set_Pan_Flag(0);
        }
        else if(reg_h_pan_flag==1)
        {
                scalerVIP_DI_MiddleWare_MCNR_Set_Pan_Flag(1);
                scalerVIP_DI_MiddleWare_MCNR_Set_V_Pan_Flag(0);
        }
        else
        {
	...
	// chen 180308 for DI_smd
	#if 0

	gmv_x_tmp = -(mv_h_pan-15)/2+3;
	gmv_y_tmp = -(mv_v_pan-6)+3;
	...
	di_smd_hardwarepan_modify1.smd_fw_gmvx = gmv_x_tmp;
	di_di_smd_waterflag_ctr3.smd_fw_gmvy = gmv_y_tmp;

	di_teeth_count_cur=di_di_smd_waterflow_teeth_count.smd_sawtooth_count_wf;

	if(di_teeth_count_cur>4000)
		di_teeth_count_acc=di_teeth_count_acc+2;
	else if(di_teeth_count_cur>3000)
		di_teeth_count_acc=di_teeth_count_acc+1;
	else if(di_teeth_count_cur>2000)
		di_teeth_count_acc=di_teeth_count_acc+0;
	else
 	 	di_teeth_count_acc=di_teeth_count_acc-1;


	if(di_teeth_count_acc>10)
		di_teeth_count_acc=10;

	if(di_teeth_count_acc<0)
		di_teeth_count_acc=0;

	if(di_teeth_count_acc>6)
		di_di_smd_teeth_processing.smd_acc_teeth_count_en=0;
	else
		di_di_smd_teeth_processing.smd_acc_teeth_count_en=1;

	rtd_outl(DI_DI_SMD_Teeth_Processing_reg,di_di_smd_teeth_processing.regValue);
//	rtd_outl(DI_DI_SMD_WaterFlow_Teeth_Count_reg,di_di_smd_waterflow_teeth_count.regValue);
	rtd_outl(DI_DI_SMD_HardwarePan_Modify1_reg,di_smd_hardwarepan_modify1.regValue);
	...
	// chen 170811
#if 1
	rt_max=vc_nr_MCNR_mvx_hist[max_hist_h_MV]*100/sum_h;
	hist_l=max_hist_h_MV-1;
	if (hist_l<0) hist_l=0;
	hist_r=max_hist_h_MV+1;
	if (hist_r>30) hist_r=30;

	rt_max_v=vc_nr_MCNR_mvy_hist[max_hist_v_MV]*100/sum_v;
	hist_d=max_hist_v_MV-1;
	if (hist_d<0) hist_d=0;
	hist_u=max_hist_v_MV+1;
	if (hist_u>12) hist_u=12;

	rt_D=vc_nr_MCNR_mvy_hist[hist_d]*100/sum_v;
	rt_U=vc_nr_MCNR_mvy_hist[hist_u]*100/sum_v;


	rt_L=vc_nr_MCNR_mvx_hist[hist_l]*100/sum_h;
	rt_R=vc_nr_MCNR_mvx_hist[hist_r]*100/sum_h;


	if(reg_h_pan_flag==1 &&
 	rt_max>70 && (rt_max+max(rt_L,rt_R)>85) &&
    rt_max_v>80 && (rt_max_v+max(rt_D,rt_U)>85) &&
    ((mv_v_pan)==8 || (mv_v_pan)==4)
    )
 		pattern_gen_flag=1;
	else
		pattern_gen_flag=0;
	 ...
	 if(
	   (mv_v_pan==7 ||mv_v_pan==8||mv_v_pan==9) &&
	   (mv_h_pan==15) &&
	   ((vc_nr_MCNR_mvy_hist[8]*2)>vc_nr_MCNR_mvy_hist[7]) &&
	   ((vc_nr_MCNR_mvy_hist[8]*2)>vc_nr_MCNR_mvy_hist[9])
	  )
	  tower_flag=1;
	 else
	  tower_flag=0;
...
void scalerVIP_DI_MiddleWare_MCNR_Set_GMV_X(int GMV_x)
{
	GMV_X = GMV_x;
}
void scalerVIP_DI_MiddleWare_MCNR_Set_GMV_Y(int GMV_y)
{
	GMV_Y = GMV_y;
}


unsigned char scalerVIP_DI_MiddleWare_MCNR_Get_GMV_x(void)
{
	return GMV_X;
}
unsigned char scalerVIP_DI_MiddleWare_MCNR_Get_GMV_y(void)
{
	return GMV_Y;
}
...
void scalerVIP_DI_MiddleWare_FILM_Apply()
{
	...
	motion_ratio = im_di_si_film_final_result_reg.dummy180240c4_31_9 & 0xf;
...
unsigned char scalerVIP_DI_HMC_Continue()
{
	...
	if (Smart_Integration_Status.SCREEN_HMC_STATUS.Show_Debug_MSG)
	{
		ROSPrintf_DILv1("[SIS HMC] Top5 (%d, %d, %d, %d, %d)c: %d, p: %d, p2:%d, p3:%d, pass: %d\n",
...
unsigned char scalerVIP_DI_HMC_Rank_Check(unsigned char fromRank, unsigned char inRank, unsigned char fixRank, unsigned char vsync_time)
{
	...
	for (k=0; k<vsync_time; k++)
	{
		...
		if (Smart_Integration_Status.SCREEN_HMC_STATUS.Show_Debug_MSG)
			ROSPrintf_DILv1("[SIS HMC]HMC Rank Check (vsync:%d): inRank:%d, fromRank:%d, counter:%d, Rank pass:%d\n", k, inRank, fromRank, counter, pass);
	}
...
unsigned char scalerVIP_DI_HMC_LR_Check()
{
	...
	if (Smart_Integration_Status.SCREEN_HMC_STATUS.Show_Debug_MSG)
		ROSPrintf_DILv1("[SIS HMC]HMC LR Check: R_bin: %d, L_bin: %d, L_count: %d, R_count: %d, pass: %d\n", R_bin_count, L_bin_count, L_count, R_count, pass);
	return pass;
}
...
void scalerVIP_DI_MOTION_StatusUpdate()
{
	...
	{
		ROSPrintf_DILv1("[SIS MOTION] LV: %d/48 [large: %d[eg: %d], small: %d, zero: %d]/1000\n", Smart_Integration_Status.SCREEN_MOTION_STATUS.MOTION_LEVEL,
...
void scalerVIP_DI_PAN_HistSwitch()
{
	...
	extern unsigned char g_panConti;
...
void scalerVIP_DI_PAN_StatusUpdate()
{
	...
	unsigned int diffMinThd=0,restIdxThd=0;
	int diffMaxMin=0;
	unsigned char reg_pan_debounce_str=10,reg_pan_debounce=20;

	int sort_array[HMC_BIN_COUNT] = {0};
...
#else
	extern unsigned short g_diffMinThd;
	extern unsigned char g_restIdx;
	extern unsigned short g_restIdxThd;
	extern int g_diffMaxMin;
	extern unsigned char g_panConti_str;
	extern unsigned char g_panConti;
	extern unsigned char g_panDeb_str;
	extern unsigned char g_panDeb;
#endif
...
//	restIdxThd = (di_im_di_si_film_final_result_reg.dummy180240c4_31_9 & 0xFFF0) >> 4; // 16 bits [28:13]
...
#else
	diffMinThd = g_diffMinThd;
	restIdx = g_restIdx;
	restIdxThd = g_restIdxThd;
	diffMaxMin = g_diffMaxMin;
	Pan_counter_th_str = g_panConti_str;
	Pan_counter_th = g_panConti;
	reg_pan_debounce_str = g_panDeb_str;
	reg_pan_debounce = g_panDeb;
#endif
	...
	*/
	...
	else
	{
		...
		if( RPC_VIP_system_info_structure_table == NULL )
		{
			if( MA_print_count%360 == 0 )
				ROSPrintf_DILv1(" share Memory PQ data ERROR, RPC_system_info = %p\n", RPC_VIP_system_info_structure_table);
			return;
		}
...
#else
		g_diffMinThd = ((diffMinThd>1023)? 1023 : diffMinThd);
		g_diffMaxMin = diffMaxMin;
#endif
	...
	if (Smart_Integration_Status.SCREEN_HPAN_STATUS.Show_Debug_MSG)
	{
		if (Smart_Integration_Status.SCREEN_HMC_STATUS.BIN_Histogram_flag == 0)
		{
			ROSPrintf_DILv1("[SIS PAN 1] max: %d:%d, second: %d:%d, ratio: %d, pass : %d\n", MaxValue_Pan, MAX_Pan_index, SecondMaxValue_Pan, SecondMax_Pan_index, Pan_Count_Ratio, pass);
		}
		else
		{
			ROSPrintf_DILv1("[SIS PAN 2] min:%d %d,rest:%d %d, diff:%d %d, pass : %d\n", sort_array[0],diffMinThd,sort_array[restIdx],restIdxThd,abs_value(sort_array[0]-sort_array[32]),diffMaxMin, pass);
		}
		ROSPrintf_DILv1("[SIS PAN] mv:%d HstFlg:%d, Pan det:%d %d Deb:%d %d\n",
...
void scalerVIP_DI_VPAN_StatusUpdate()
{
	...
	if (di_smd_hardwarepan_modify1.smd_fw_gmvx== 3 && di_di_smd_waterflag_ctr3.smd_fw_gmvy < 3)
		pass = 2; // move up
	else if (di_smd_hardwarepan_modify1.smd_fw_gmvx == 3 && di_di_smd_waterflag_ctr3.smd_fw_gmvy > 3)
		pass = 1; // move down
	else
		pass = 0;
...
void scalerVIP_DI_SPAN_StatusUpdate()
{
	...
	if (smd_gmvcoeff3_reg.smd_firmwaremv_x > 3 && smd_gmvcoeff3_reg.smd_firmwaremv_y > 3)
		pass = 4; // right-down
	else if (smd_gmvcoeff3_reg.smd_firmwaremv_x > 3 && smd_gmvcoeff3_reg.smd_firmwaremv_y < 3)
		pass = 3; // right-up
	else if (smd_gmvcoeff3_reg.smd_firmwaremv_x < 3 && smd_gmvcoeff3_reg.smd_firmwaremv_y > 3)
		pass = 2; // left-down
	else if (smd_gmvcoeff3_reg.smd_firmwaremv_x < 3 && smd_gmvcoeff3_reg.smd_firmwaremv_y < 3)
...
void scalerVIP_DI_SLOWMOTION_StatusUpdate()
{
	...
	{
		ROSPrintf_DILv1("[SIS SLOWMOTION] slow_pass_total: %d\n", slow_pass_total);
	}
...
void scalerVIP_DI_SCENECHANGE_StatusUpdate()
{
		...
		abs(Smart_Integration_Status.SCREEN_SCENECHANGE_STATUS.Result_Sequence[0]-Smart_Integration_Status.SCREEN_SCENECHANGE_STATUS.Result_Sequence[4]) > 3500)
	{
		...
		{
			ROSPrintf_DILv1("[SIS SCENECHANGE] near: %d, far: %d, %d, %d, %d, Y diff: %d\n", near_compare_diff, far_compare_diff,
				abs_value(Smart_Integration_Status.SCREEN_MOTION_STATUS.Large_FM_SUM_Sequence[1]-Smart_Integration_Status.SCREEN_MOTION_STATUS.Large_FM_SUM_Sequence[2]),
				abs_value(Smart_Integration_Status.SCREEN_MOTION_STATUS.Large_FM_SUM_Sequence[2]-Smart_Integration_Status.SCREEN_MOTION_STATUS.Large_FM_SUM_Sequence[3]),
				abs_value(Smart_Integration_Status.SCREEN_MOTION_STATUS.Large_FM_SUM_Sequence[3]-Smart_Integration_Status.SCREEN_MOTION_STATUS.Large_FM_SUM_Sequence[4]),
				abs_value(Smart_Integration_Status.SCREEN_SCENECHANGE_STATUS.Result_Sequence[0]-Smart_Integration_Status.SCREEN_SCENECHANGE_STATUS.Result_Sequence[4]));
		}
	}
	else
...
void scalerVIP_SPATIAL_NOISE_LEVEL_StatusUpdate()
{
	...
	{
		ROSPrintf_DILv1("Cur NM NoiseLevel : %d , Reliable: %d \n",
		...
		ROSPrintf_DILv1("Result NM NoiseLevel : %d , Reliable: %d \n",
...
void scalerVIP_DI_TEMPORAL_NOISE_LEVEL_StatusUpdate()
{
	...
	{
		ROSPrintf_DILv1("[SIS NR_TMP_R: %d, %d, %d, %d, %d, NR_TMP_LEVEL: %d, %d, %d, %d, %d => %d\n",
...
void scalerVIP_DI_SMD_StautsUpdate()
{
	...
	{
		ROSPrintf_DILv1("GMV_global_ctr: %d \n",smd_gmvcoeff1_reg.smd_gmv_ctr);
	}
}
*/
// end chen 180308 remove
 	...
 	switch (Level)
	{
		...
		case 9:
			...
			*/
			...
			//ROSPrintf_DILv1("[Young]scalerVIP_colorMAQuickSetTh88888888\n");
		...
		default:
			...
			//di_control_reg.ma_stilllogoena=1; // melrin4 remove
			...
			//teeth_detect_th_b_reg.ma_stilllogovdth=0xf; // merlin4 remove
...
void scalerVIP_colorMABeanDrop(unsigned char mode, unsigned int en_test)
{
	...
	di_im_di_si_film_motion_pre_h_b_RBUS pre_h_b;
 	ROSPrintf_DILv1( "enter scalerVIP_colorMABeanDrop\n" );
...
//========Bean drop problem========
	...
	if ( ((SmartPic_clue->Y_Main_Hist)[16]) > bean_th && ((SmartPic_clue->Y_Main_Hist)[17]) > bean_th &&
			...
			pre_h_b.regValue<th_BeanBot ) )
 	{
		...
		if (1)
		{
				...
				//di_control_reg.ma_preferintra = 1; // merlin4 remove
	...
	if ( BeanCount == 0 )
	{
		//di_control_reg.ma_preferintra = 0; // merlin4 remove
...
//	di_im_di_rtnr_control_RBUS_reg.regValue = rtd_inl(DI_IM_DI_RTNR_CONTROL_reg);
	...
	ROSPrintf_DILv1( "enter scalerVIP_colorMABeerProblem\n" );
...
//			rtd_outl(DI_IM_DI_RTNR_CONTROL_reg, di_im_di_rtnr_control_RBUS_reg.regValue);//rtnr
	...
	if (BeerCount > 50)
	{
		if (BeerFlag == 0)
		{
			CaveCount =0;
			if(AutoMADebugMsg==1)
				ROSPrintf_DILv1("============== INTO BEER : %d (tm: %d, lp : %d, lm : %d, fmc : %d)=============\n", film_still, total_motion, large_pixel, large_motion, film_motion_c);
		}
		BeerCount  = 50;
		BeerFlag = 1;
	}
...
static FILM_FWMode DETECTION_scalerVIP_film_FWmode(void)
{
	...
	if (TV_05_style_ON == 1)
	{
		enchance22_en = 1;//(im_di_film_motion_sum_th_reg.dummy180240b4_23_16 & 0x01);
	...
	hw_RTNR_Interlace_Force2D_En =0; //if bring up is ok , pleaes remove it.
	...
	scalerVIP_film_FWmode_detection22_isr(StatusNextStaticPattern_film22, 0,
...
#else
	fw_Status32Detected1 =	Status32Detected1;
	fw_Statusus32Detected2 =  Status32Detected2;
	fw_Stat22Detected  =  Status22Detected;
...
void scalerVIP_film_test(void)
{
	//DETECTION_scalerVIP_film_FWmode_vip();
...
void APPLY_scalerVIP_film_FWmode_isr(FILM_FWMode DetInformation)
{
	...
	if((FilmInfo!=NULL)||((film_index == FILM22)/*||(film_index == FILM32)*/))	// only film 22 need to check MEMC film, WOSQRTK-11890
		im_di_film_new_function_main_reg.fw_film_filmdetected = (DetInformation.Fw_StatusFilmDetected&&(FilmInfo[_FILM_MEMC_OUT_ALL]!=0));
	else
	...
	*/
	if((rtd_inl(DI_IM_DI_CONTROL_reg)&_BIT14)>>14) {
	...
	*Violate = 0;
	...
	if(*p32Detected1) // check FrameStaticPattern and decide pSeq
	{
		if(*film_index==FILM32)
		{
			...
			{
				case 0x84210:
					if(	(!*p32Detected1 && (FramePairPattern&0x3fffffff)==0x6619866 && (!LeaveQuick_en || (NextStaticPattern&0x31)!=0x30) ) ||
					...
					break;
				case 0x8421:
					if(	(!*p32Detected1 && (FramePairPattern&0x3fffffff)==0x19866198) ||
					...
					break;
				case 0x10842:
					if(	(!*p32Detected1 && (FramePairPattern&0x3fffffff)==0x26198661 && (!LeaveQuick_en || (PrevStaticPattern&0x2b)!=0x2a) ) ||
					...
					break;
				case 0x21084:
					if(	(!*p32Detected1 && (FramePairPattern&0x3fffffff)==0x18661986 && (!LeaveQuick_en || (NextStaticPattern&0x2d)!=0x2c) ) ||
					...
					break;
				case 0x42108:
					if(	(!*p32Detected1 && (FramePairPattern&0x3fffffff)==0x21986619 && (!LeaveQuick_en || (PrevStaticPattern&0x29)!=0x28) ) ||
		...
		else if(*film_index==FILM3223)
		{
			...
			{
				case 0x40902:
					if(	(!*p32Detected1 && (FramePairPattern&0x3fffffff)==0x26186661 && (!LeaveQuick_en || (PrevStaticPattern&0x2b)==0x2a	) ) ||
						( *p32Detected1 && (!Pair_en || (FramePairPattern&2)==0) && (!LeaveQuick_en || (PrevStaticPattern&0x2b)==0x2a		) )
					)
					{
						*p32Detected1 = 1;
					...
					break;
				case 0x81204:
					if(	(!*p32Detected1 && (FramePairPattern&0x3fffffff)==0x18619986 && (!LeaveQuick_en || (NextStaticPattern&0x2d)!=0x2c	) ) ||
						( *p32Detected1 && (!Pair_en || (FramePairPattern&1)==0) && (!LeaveQuick_en || (NextStaticPattern&0x2d)!=0x2c		) )
					)
					{
						*p32Detected1 = 1;
					...
					break;
				case 0x2409:
					if(	(!*p32Detected1 && (FramePairPattern&0x3fffffff)==0x21866618) ||
						( *p32Detected1 && (!Pair_en || (FramePairPattern&3)==0) )
					  )
					{
						*p32Detected1 = 1;
					...
					break;
				case 0x4812:
					if(	(!*p32Detected1 && (FramePairPattern&0x3fffffff)==0x6199861 && (!LeaveQuick_en || (PrevStaticPattern&0x1b)==0x1a	) ) ||
					...
					break;
				case 0x9024:
					if(	(!*p32Detected1 && (FramePairPattern&0x3fffffff)==0x18666186 && (!LeaveQuick_en || (NextStaticPattern&0x2d)!=0x2c	) ) ||
						( *p32Detected1 && (!Pair_en || (FramePairPattern&1)==0) && (!LeaveQuick_en || (NextStaticPattern&0x2d)!=0x2c		) )
					  )
					{
						*p32Detected1 = 1;
					...
					break;
				case 0x12048:
					if(	(!*p32Detected1 && (FramePairPattern&0x3fffffff)==0x21998619 && (!LeaveQuick_en || (PrevStaticPattern&0x2d)==0x2c	) ) ||
					...
					break;
				case 0x24090:
					if(	(!*p32Detected1 && (FramePairPattern&0x3fffffff)==0x6661866 && (!LeaveQuick_en || (NextStaticPattern&0x35)!=0x34	) ) ||
					...
					break;
				case 0x48120:
					if(	(!*p32Detected1 && (FramePairPattern&0x3fffffff)==0x19986199 && (!LeaveQuick_en || (PrevStaticPattern&0x35)==0x34	) ) ||
					...
					break;
				case 0x90240:
					if(	(!*p32Detected1 && (FramePairPattern&0x3fffffff)==0x26618666 && (!LeaveQuick_en || (NextStaticPattern&0x15)!=0x14	) ) ||
					...
					break;
				case 0x20481:
					if(	(!*p32Detected1 && (FramePairPattern&0x3fffffff)==0x19861998) ||
						( *p32Detected1 && (!Pair_en || (FramePairPattern&3)==0) )
					  )
					{
						*p32Detected1 = 1;
		...
		else if(*film_index==FILM64)
		{
			switch(FrameStaticPattern&0xfffff)
			{
				...
				case 0x799e6:
					if(	(!*p32Detected1 && (FramePairPattern&0x3fffffff)==0x18180181 && (!LeaveQuick_en || (PrevStaticPattern&0x37)!=0x36) ) ||
					...
					break;
				case 0xf33cc:
					if(	(!*p32Detected1 && (FramePairPattern&0x3fffffff)==0x20600606 && (!LeaveQuick_en || (NextStaticPattern&0x1d)!=0x1c	) ) ||
					...
					break;
				case 0xe6799:
					if(	(!*p32Detected1 && (FramePairPattern&0x3fffffff)==0x1801818) ||
						( *p32Detected1 && (!Pair_en || (FramePairPattern&3)==0) )
					  )
					{
						*p32Detected1 = 1;
					...
					break;
				case 0xccf33:
					if(	(!*p32Detected1 && (FramePairPattern&0x3fffffff)==0x6006060) ||
						( *p32Detected1 && (!Pair_en || (FramePairPattern&3)==0) )
					  )
					{
						*p32Detected1 = 1;
					...
					break;
				case 0x99e67:
					if(	(!*p32Detected1 && (FramePairPattern&0x3fffffff)==0x18018180) ||
						( *p32Detected1 && (!Pair_en || (FramePairPattern&3)==0) )
					  )
					{
						*p32Detected1 = 1;
					...
					break;
				case 0x33ccf:
					if(	(!*p32Detected1 && (FramePairPattern&0x3fffffff)==0x20060600) ||
						( *p32Detected1 && (!Pair_en || (FramePairPattern&3)==0) )
					  )
					{
						*p32Detected1 = 1;
					...
					break;
				case 0x6799e:
					if(	(!*p32Detected1 && (FramePairPattern&0x3fffffff)==0x181801 && (!LeaveQuick_en || (PrevStaticPattern&0x1f)==0x1e) ) ||
					...
					break;
				case 0xcf33c:
					if(	(!*p32Detected1 && (FramePairPattern&0x3fffffff)==0x606006 && (!LeaveQuick_en || (NextStaticPattern&0x3d)!=0x3c) ) ||
					...
					break;
				case 0x9e679:
					if(	(!*p32Detected1 && (FramePairPattern&0x3fffffff)==0x1818018) ||
						( *p32Detected1 && (!Pair_en || (FramePairPattern&3)==0) )
					  )
					{
						*p32Detected1 = 1;
					...
					break;
				case 0x3ccf3:
					if(	(!*p32Detected1 && (FramePairPattern&0x3fffffff)==0x6060060) ||
						( *p32Detected1 && (!Pair_en || (FramePairPattern&3)==0) )
					  )
					{
						*p32Detected1 = 1;
		...
		else if(*film_index==FILM55)
		{
			...
			{
				case 0x739ce:
					if(	(!*p32Detected1 && (FramePairPattern&0x3fffffff)==0x20180601 && (!LeaveQuick_en || (PrevStaticPattern&0x2f)==0x2e) ) ||
					...
					break;
				case 0xe739c:
					if(	(!*p32Detected1 && (FramePairPattern&0x3fffffff)==0x601806 && (!LeaveQuick_en || (NextStaticPattern&0x3d)!=0x3c) ) ||
						( *p32Detected1 && (!Pair_en || (FramePairPattern&1)==0) && (!LeaveQuick_en || (NextStaticPattern&0x3d)!=0x3c) )
					  )
					{
						*p32Detected1 = 1;
					...
					break;
				case 0xce739:
					if(	(!*p32Detected1 && (FramePairPattern&0x3fffffff)==0x1806018) ||
						( *p32Detected1 && (!Pair_en || (FramePairPattern&3)==0) )
					  )
					{
						*p32Detected1 = 1;
					...
					break;
				case 0x9ce73:
					if(	(!*p32Detected1 && (FramePairPattern&0x3fffffff)==0x6018060) ||
						( *p32Detected1 && (!Pair_en || (FramePairPattern&3)==0) )
					  )
					{
						*p32Detected1 = 1;
					...
					break;
				case 0x39ce7:
					if(	(!*p32Detected1 && (FramePairPattern&0x3fffffff)==0x18060180) ||
						( *p32Detected1 && (!Pair_en || (FramePairPattern&3)==0) )
					  )
					{
						*p32Detected1 = 1;
		...
		else if(*film_index==FILM2224)
		{
			...
			{
				case 0x1806:
					if(	(!*p32Detected1 && (FramePairPattern&0x3fffffff)==0x18199981 && (!LeaveQuick_en || (PrevStaticPattern&0x17)!=0x16) ) ||
					...
					break;
				case 0x300c:
					if(	(!*p32Detected1 && (FramePairPattern&0x3fffffff)==0x20666606 && (!LeaveQuick_en || (NextStaticPattern&0x1d)==0x1c) ) ||
						( *p32Detected1 && (!Pair_en || (FramePairPattern&1)==0) && (!LeaveQuick_en || (NextStaticPattern&0x1d)==0x1c) )
					  )
					{
						*p32Detected1 = 1;
					...
					break;
				case 0x6018:
					if(	(!*p32Detected1 && (FramePairPattern&0x3fffffff)==0x1999819 && (!LeaveQuick_en || (PrevStaticPattern&0x1d)==0x1c) ) ||
					...
					break;
				case 0xc030:
					if(	(!*p32Detected1 && (FramePairPattern&0x3fffffff)==0x6666066 && (!LeaveQuick_en || (NextStaticPattern&0x35)==0x34) ) ||
						( *p32Detected1 && (!Pair_en || (FramePairPattern&1)==0) && (!LeaveQuick_en || (NextStaticPattern&0x35)==0x34) )
					  )
					{
						*p32Detected1 = 1;
					...
					break;
				case 0x18060:
					if(	(!*p32Detected1 && (FramePairPattern&0x3fffffff)==0x19998199 && (!LeaveQuick_en || (PrevStaticPattern&0x35)==0x34) ) ||
						( *p32Detected1 && (!Pair_en || (FramePairPattern&2)==0) && (!LeaveQuick_en || (PrevStaticPattern&0x35)==0x34) )
					  )
					{
						*p32Detected1 = 1;
					...
					break;
				case 0x300c0:
					if(	(!*p32Detected1 && (FramePairPattern&0x3fffffff)==0x26660666 && (!LeaveQuick_en || (NextStaticPattern&0x15)!=0x14) ) ||
						( *p32Detected1 && (!Pair_en || (FramePairPattern&1)==0) && (!LeaveQuick_en || (NextStaticPattern&0x15)!=0x14) )
					  )
					{
						*p32Detected1 = 1;
					...
					break;
				case 0x60180:
					if(	(!*p32Detected1 && (FramePairPattern&0x3fffffff)==0x19981999 && (!LeaveQuick_en || (PrevStaticPattern&0x15)==0x14) ) ||
					...
					break;
				case 0xc0300:
					if(	(!*p32Detected1 && (FramePairPattern&0x3fffffff)==0x26606666 && (!LeaveQuick_en || (NextStaticPattern&0x15)!=0x14) ) ||
						( *p32Detected1 && (!Pair_en || (FramePairPattern&1)==0) && (!LeaveQuick_en || (NextStaticPattern&0x15)!=0x14) )
					  )
					{
						*p32Detected1 = 1;
					...
					break;
				case 0x80601:
					if(	(!*p32Detected1 && (FramePairPattern&0x3fffffff)==0x19819998) ||
						( *p32Detected1 && (!Pair_en || (FramePairPattern&3)==0) )
					  )
					{
						*p32Detected1 = 1;
					...
					break;
				case 0xc03:
					if(	(!*p32Detected1 && (FramePairPattern&0x3fffffff)==0x26066660) ||
						( *p32Detected1 && (!Pair_en || (FramePairPattern&3)==0) )
					  )
					{
						*p32Detected1 = 1;
		...
		else if(*film_index==FILM32322)
		{
			...
			{
				case 0x20420:
					if(	(!*p32Detected1 && (FramePairPattern&0x3fffffff)==0x19866199 && (!LeaveQuick_en || (PrevStaticPattern&0x35)==0x34	) ) ||
						( *p32Detected1 && (!Pair_en || (FramePairPattern&2)==0) && (!LeaveQuick_en || (PrevStaticPattern&0x35)==0x34		) )
					  )
					{
						*p32Detected1 = 1;
					...
					break;
				case 0x40840:
					if(	(!*p32Detected1 && (FramePairPattern&0x3fffffff)==0x26198666 && (!LeaveQuick_en || (NextStaticPattern&0x15)!=0x14) ) ||
						( *p32Detected1 && (!Pair_en || (FramePairPattern&1)==0) && (!LeaveQuick_en || (NextStaticPattern&0x15)!=0x14) )
					  )
					{
						*p32Detected1 = 1;
					...
					break;
				case 0x81081:
					if(	(!*p32Detected1 && (FramePairPattern&0x3fffffff)==0x18661998) ||
						( *p32Detected1 && (!Pair_en || (FramePairPattern&3)==0) )
					  )
					{
						*p32Detected1 = 1;
					...
					break;
				case 0x2102:
					if(	(!*p32Detected1 && (FramePairPattern&0x3fffffff)==0x21986661 && (!LeaveQuick_en || (PrevStaticPattern&0x2b)==0x2a) ) ||
						( *p32Detected1 && (!Pair_en || (FramePairPattern&2)==0) && (!LeaveQuick_en || (PrevStaticPattern&0x2b)==0x2a) )
					  )
					{
						*p32Detected1 = 1;
					...
					break;
				case 0x4204:
					if(	(!*p32Detected1 && (FramePairPattern&0x3fffffff)==0x6619986 && (!LeaveQuick_en || (NextStaticPattern&0x2d)!=0x2c) ) ||
						( *p32Detected1 && (!Pair_en || (FramePairPattern&1)==0) && (!LeaveQuick_en || (NextStaticPattern&0x2d)!=0x2c) )
					  )
					{
						*p32Detected1 = 1;
					...
					break;
				case 0x8408:
					if(	(!*p32Detected1 && (FramePairPattern&0x3fffffff)==0x19866619 && (!LeaveQuick_en || (PrevStaticPattern&0x2d)==0x2c) ) ||
						( *p32Detected1 && (!Pair_en || (FramePairPattern&2)==0) && (!LeaveQuick_en || (PrevStaticPattern&0x2d)==0x2c) )
					  )
					{
						*p32Detected1 = 1;
					...
					break;
				case 0x10810:
					if(	(!*p32Detected1 && (FramePairPattern&0x3fffffff)==0x26199866 && (!LeaveQuick_en || (NextStaticPattern&0x35)!=0x34) ) ||
						( *p32Detected1 && (!Pair_en || (FramePairPattern&1)==0) && (!LeaveQuick_en || (NextStaticPattern&0x35)!=0x34) )
					  )
					{
						*p32Detected1 = 1;
					...
					break;
				case 0x21021:
					if(	(!*p32Detected1 && (FramePairPattern&0x3fffffff)==0x18666198) ||
						( *p32Detected1 && (!Pair_en || (FramePairPattern&3)==0) )
					  )
					{
						*p32Detected1 = 1;
					...
					break;
				case 0x42042:
					if(	(!*p32Detected1 && (FramePairPattern&0x3fffffff)==0x21998661 && (!LeaveQuick_en || (PrevStaticPattern&0x2b)==0x2a) ) ||
						( *p32Detected1 && (!Pair_en || (FramePairPattern&2)==0) && (!LeaveQuick_en || (PrevStaticPattern&0x2b)==0x2a) )
					  )
					{
						*p32Detected1 = 1;
					...
					break;
				case 0x84084:
					if(	(!*p32Detected1 && (FramePairPattern&0x3fffffff)==0x6661986 && (!LeaveQuick_en || (NextStaticPattern&0x2d)!=0x2c) ) ||
						( *p32Detected1 && (!Pair_en || (FramePairPattern&1)==0) && (!LeaveQuick_en || (NextStaticPattern&0x2d)!=0x2c) )
					  )
					{
						*p32Detected1 = 1;
					...
					break;
				case 0x8108:
					if(	(!*p32Detected1 && (FramePairPattern&0x3fffffff)==0x19986619 && (!LeaveQuick_en || (PrevStaticPattern&0x2d)==0x2c) ) ||
						( *p32Detected1 && (!Pair_en || (FramePairPattern&2)==0) && (!LeaveQuick_en || (PrevStaticPattern&0x2d)==0x2c) )
					  )
					{
						*p32Detected1 = 1;
					...
					break;
				case 0x10210:
					if(	(!*p32Detected1 && (FramePairPattern&0x3fffffff)==0x26619866 && (!LeaveQuick_en || (NextStaticPattern&0x35)!=0x34) ) ||
						( *p32Detected1 && (!Pair_en || (FramePairPattern&1)==0) && (!LeaveQuick_en || (NextStaticPattern&0x35)!=0x34) )
					  )
					{
						*p32Detected1 = 1;
		...
		else if(*film_index==FILM87)
		{
			...
			{
				case 0xf3f3e:
					if(	(!*p32Detected1 && (FramePairPattern&0x3fffffff)==0x20006001 && (!LeaveQuick_en || (PrevStaticPattern&0x3f)==0x3e) ) ||
					...
					break;
				case 0xe7e7c:
					if(	(!*p32Detected1 && (FramePairPattern&0x3fffffff)==0x18006 && (!LeaveQuick_en || (NextStaticPattern&0x3d)==0x3c) ) ||
						( *p32Detected1 && (!Pair_en || (FramePairPattern&1)==0) && (!LeaveQuick_en || (NextStaticPattern&0x3d)==0x3c) )
					  )
					{
						*p32Detected1 = 1;
					...
					break;
				case 0xcfcf9:
					if(	(!*p32Detected1 && (FramePairPattern&0x3fffffff)==0x60018) ||
						( *p32Detected1 && (!Pair_en || (FramePairPattern&3)==0) )
					  )
					{
						*p32Detected1 = 1;
					...
					break;
				case 0x9f9f3:
					if(	(!*p32Detected1 && (FramePairPattern&0x3fffffff)==0x180060) ||
						( *p32Detected1 && (!Pair_en || (FramePairPattern&3)==0) )
					  )
					{
						*p32Detected1 = 1;
					...
					break;
				case 0x3f3e7:
					if(	(!*p32Detected1 && (FramePairPattern&0x3fffffff)==0x600180) ||
						( *p32Detected1 && (!Pair_en || (FramePairPattern&3)==0) )
					  )
					{
						*p32Detected1 = 1;
					...
					break;
				case 0x7e7cf:
					if(	(!*p32Detected1 && (FramePairPattern&0x3fffffff)==0x1800600) ||
						( *p32Detected1 && (!Pair_en || (FramePairPattern&3)==0) )
					  )
					{
						*p32Detected1 = 1;
					...
					break;
				case 0xfcf9f:
					if(	(!*p32Detected1 && (FramePairPattern&0x3fffffff)==0x6001800) ||
						( *p32Detected1 && (!Pair_en || (FramePairPattern&3)==0) )
					  )
					{
						*p32Detected1 = 1;
					...
					break;
				case 0xf9f3f:
					if(	(!*p32Detected1 && (FramePairPattern&0x3fffffff)==0x18006000) ||
						( *p32Detected1 && (!Pair_en || (FramePairPattern&3)==0) )
					  )
					{
						*p32Detected1 = 1;
					...
					break;
				case 0xf3e7e:
					if(	(!*p32Detected1 && (FramePairPattern&0x3fffffff)==0x20018001 && (!LeaveQuick_en || (PrevStaticPattern&0x3f)!=0x3e) ) ||
						( *p32Detected1 && (!Pair_en || (FramePairPattern&2)==0) && (!LeaveQuick_en || (PrevStaticPattern&0x3f)!=0x3e) )
					  )
					{
						*p32Detected1 = 1;
					...
					break;
				case 0xe7cfc:
					if(	(!*p32Detected1 && (FramePairPattern&0x3fffffff)==0x60006 && (!LeaveQuick_en || (NextStaticPattern&0x3d)!=0x3c) ) ||
						( *p32Detected1 && (!Pair_en || (FramePairPattern&1)==0) && (!LeaveQuick_en || (NextStaticPattern&0x3d)!=0x3c) )
					  )
					{
						*p32Detected1 = 1;
					...
					break;
				case 0xcf9f9:
					if(	(!*p32Detected1 && (FramePairPattern&0x3fffffff)==0x180018) ||
						( *p32Detected1 && (!Pair_en || (FramePairPattern&3)==0) )
					  )
					{
						*p32Detected1 = 1;
					...
					break;
				case 0x9f3f3:
					if(	(!*p32Detected1 && (FramePairPattern&0x3fffffff)==0x600060) ||
						( *p32Detected1 && (!Pair_en || (FramePairPattern&3)==0) )
					  )
					{
						*p32Detected1 = 1;
					...
					break;
				case 0x3e7e7:
					if(	(!*p32Detected1 && (FramePairPattern&0x3fffffff)==0x1800180) ||
						( *p32Detected1 && (!Pair_en || (FramePairPattern&3)==0) )
					  )
					{
						*p32Detected1 = 1;
					...
					break;
				case 0x7cfcf:
					if(	(!*p32Detected1 && (FramePairPattern&0x3fffffff)==0x6000600) ||
						( *p32Detected1 && (!Pair_en || (FramePairPattern&3)==0) )
					  )
					{
						*p32Detected1 = 1;
					...
					break;
				case 0xf9f9f:
					if(	(!*p32Detected1 && (FramePairPattern&0x3fffffff)==0x18001800) ||
						( *p32Detected1 && (!Pair_en || (FramePairPattern&3)==0) )
					  )
					{
						*p32Detected1 = 1;
...
void scalerVIP_DI_MCNR_RTNR_bottom_fresh_line_patch(unsigned char enable)
{
	...
	if (enable && Scaler_DispGetStatus(SLR_MAIN_DISPLAY, SLR_DISP_INTERLACE) && (SmartPic_clue->RTNR_MAD_count_Y_avg_ratio > 950|| motionl_level<=2)&& s_count > 5) {
		...
		im_di_weave_window_5_start_reg.xstart_83_70 = 1;
		im_di_weave_window_5_start_reg.ystart_77_65 = Smart_Integration_Status.DI_HEIGHT;

		im_di_weave_window_5_end_reg.xend_83_70 = Smart_Integration_Status.DI_WIDTH;
