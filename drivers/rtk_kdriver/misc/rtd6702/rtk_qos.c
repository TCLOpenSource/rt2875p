...
int g_vdec_codec_type = VDEC_CODEC_TYPE_NOSET;
...
static int rtk_qos_load_mc_decoder_4k_bad_edit_setting(void)
{
	...
	// william_qos_3(submit).tbl
	rtd_outl(0xb80c3a00,0x00000443);
	rtd_outl(0xb80c3a10,0x00000000);
	rtd_outl(0xb80c3a14,0x00000000);
	rtd_outl(0xb80c3a18,0x40000000);
	rtd_outl(0xb80c3a1c,0x012c0000);
	rtd_outl(0xb80c3a20,0x00fa00fa);
	rtd_outl(0xb80c3a24,0x00180630);
	//rtd_outl(0xb80c3a28,0x0000000f);
	rtd_outl(0xb80c3a2c,0x00ff0077);
	rtd_outl(0xb80c3a30,0x000f0001);
	rtd_outl(0xb80c3a34,0x03ff0000);
	rtd_outl(0xb80c3a3c,0x00ffffff);

	rtd_outl(0xb80c3a60,0x09840806);
	rtd_outl(0xb80c3a64,0x00003f00);
	rtd_outl(0xb80c3a68,0x80030004);
	rtd_outl(0xb80c3a6c,0x41010021);

	rtd_outl(0xb80c3a80,0x09840806);
	rtd_outl(0xb80c3a84,0x00007f00);
	rtd_outl(0xb80c3a88,0x80002008);
	rtd_outl(0xb80c3a8c,0x41010041);

	rtd_outl(0xb80c3aa0,0x09840806);
	rtd_outl(0xb80c3aa4,0x40007f00);
	rtd_outl(0xb80c3aa8,0x12c0400c);
	rtd_outl(0xb80c3aac,0x63018071);

	rtd_outl(0xb80c3ac0,0x09840806);
	rtd_outl(0xb80c3ac4,0x20007f00);
	rtd_outl(0xb80c3ac8,0x12c0800c);
	rtd_outl(0xb80c3acc,0x63018071);

	rtd_outl(0xb80c3ae0,0x09840806);
	rtd_outl(0xb80c3ae4,0x00005000);
	rtd_outl(0xb80c3ae8,0x8000a00a);
	rtd_outl(0xb80c3aec,0x63018021);

	rtd_outl(0xb80c3b00,0x09840806);
	rtd_outl(0xb80c3b04,0x00001f00);
	rtd_outl(0xb80c3b08,0x8000c80a);
	rtd_outl(0xb80c3b0c,0x63018021);

	rtd_outl(0xb80c3b20,0x09840806);
	rtd_outl(0xb80c3b24,0x00003f00);
	rtd_outl(0xb80c3b28,0x80030004);
	rtd_outl(0xb80c3b2c,0x41010021);
...
static int rtk_qos_load_mc_decoder_4k_bad_edit_ddr4_setting(void)
{
	...
	rtd_outl(0xb80c2b40,0x09840806); // DIC suggests same as ch0
	rtd_outl(0xb80c2b44,0x00003f00);
	rtd_outl(0xb80c2b48,0x80030004);
	rtd_outl(0xb80c2b4c,0x41010021);

	rtd_outl(0xb80c2b60,0x09840806); // DIC suggests same as ch6
	rtd_outl(0xb80c2b64,0x00003f00);
	rtd_outl(0xb80c2b68,0x80030004);
	rtd_outl(0xb80c2b6c,0x41010021);
	...
	rtd_outl(0xb80c3a24,0x00180630);
	//rtd_outl(0xb80c3a28,0x0000000f);
	rtd_outl(0xb80c3a2c,0x00ff0074);
	rtd_outl(0xb80c3a30,0x000f0007);
	rtd_outl(0xb80c3a34,0x03ff0000);
	rtd_outl(0xb80c3a3c,0x00ffffff);
	...
	rtd_outl(0xb80c3b40,0x09840806); // DIC suggests same as ch0
	rtd_outl(0xb80c3b44,0x00003f00);
	rtd_outl(0xb80c3b48,0x80030004);
	rtd_outl(0xb80c3b4c,0x41010021);

	rtd_outl(0xb80c3b60,0x09840806); // DIC suggests same as ch6
	rtd_outl(0xb80c3b64,0x00003f00);
	rtd_outl(0xb80c3b68,0x80030004);
	rtd_outl(0xb80c3b6c,0x41010021);
	...
	rtd_outl(0xb80c4b40,0x09840806); // DIC suggests same as ch0
	rtd_outl(0xb80c4b44,0x00003f00);
	rtd_outl(0xb80c4b48,0x80030004);
	rtd_outl(0xb80c4b4c,0x41010021);

	rtd_outl(0xb80c4b60,0x09840806); // DIC suggests same as ch6
	rtd_outl(0xb80c4b64,0x00003f00);
	rtd_outl(0xb80c4b68,0x80030004);
	rtd_outl(0xb80c4b6c,0x41010021);


	// william_qos_3(submit).tbl
	rtd_outl(0xb80c5a00,0x00000443);
	rtd_outl(0xb80c5a10,0x00000000);
	rtd_outl(0xb80c5a14,0x00000000);
	rtd_outl(0xb80c5a18,0x40000000);
	rtd_outl(0xb80c5a1c,0x012c0000);
	rtd_outl(0xb80c5a20,0x00fa00fa);
	rtd_outl(0xb80c5a24,0x00180630);
	//rtd_outl(0xb80c5a28,0x0000000f);
	rtd_outl(0xb80c5a2c,0x00ff0074);
	rtd_outl(0xb80c5a30,0x000f0007);
	rtd_outl(0xb80c5a34,0x03ff0000);
	rtd_outl(0xb80c5a3c,0x00ffffff);

	rtd_outl(0xb80c5a60,0x09840806);
	rtd_outl(0xb80c5a64,0x00003f00);
	rtd_outl(0xb80c5a68,0x80030004);
	rtd_outl(0xb80c5a6c,0x41010021);

	rtd_outl(0xb80c5a80,0x09840806);
	rtd_outl(0xb80c5a84,0x00007f00);
	rtd_outl(0xb80c5a88,0x80002008);
	rtd_outl(0xb80c5a8c,0x41010041);

	rtd_outl(0xb80c5aa0,0x09840806);
	rtd_outl(0xb80c5aa4,0x40007f00);
	rtd_outl(0xb80c5aa8,0x12c0400c);
	rtd_outl(0xb80c5aac,0x63018071);

	rtd_outl(0xb80c5ac0,0x09840806);
	rtd_outl(0xb80c5ac4,0x20007f00);
	rtd_outl(0xb80c5ac8,0x12c0800c);
	rtd_outl(0xb80c5acc,0x63018071);

	rtd_outl(0xb80c5ae0,0x09840806);
	rtd_outl(0xb80c5ae4,0x00005000);
	rtd_outl(0xb80c5ae8,0x8000a00a);
	rtd_outl(0xb80c5aec,0x63018021);

	rtd_outl(0xb80c5b00,0x09840806);
	rtd_outl(0xb80c5b04,0x00001f00);
	rtd_outl(0xb80c5b08,0x8000c80a);
	rtd_outl(0xb80c5b0c,0x63018021);

	rtd_outl(0xb80c5b20,0x09840806);
	rtd_outl(0xb80c5b24,0x00003f00);
	rtd_outl(0xb80c5b28,0x80030004);
	rtd_outl(0xb80c5b2c,0x41010021);

	rtd_outl(0xb80c5b40,0x09840806); // DIC suggests same as ch0
	rtd_outl(0xb80c5b44,0x00003f00);
	rtd_outl(0xb80c5b48,0x80030004);
	rtd_outl(0xb80c5b4c,0x41010021);

	rtd_outl(0xb80c5b60,0x09840806); // DIC suggests same as ch6
	rtd_outl(0xb80c5b64,0x00003f00);
	rtd_outl(0xb80c5b68,0x80030004);
	rtd_outl(0xb80c5b6c,0x41010021);


	// william_qos_3(submit).tbl
	rtd_outl(0xb80c6a00,0x00000443);
	rtd_outl(0xb80c6a10,0x00000000);
	rtd_outl(0xb80c6a14,0x00000000);
	rtd_outl(0xb80c6a18,0x40000000);
	rtd_outl(0xb80c6a1c,0x012c0000);
	rtd_outl(0xb80c6a20,0x00fa00fa);
	rtd_outl(0xb80c6a24,0x00180630);
	//rtd_outl(0xb80c6a28,0x0000000f);
	rtd_outl(0xb80c6a2c,0x00ff0074);
	rtd_outl(0xb80c6a30,0x000f0007);
	rtd_outl(0xb80c6a34,0x03ff0000);
	rtd_outl(0xb80c6a3c,0x00ffffff);

	rtd_outl(0xb80c6a60,0x09840806);
	rtd_outl(0xb80c6a64,0x00003f00);
	rtd_outl(0xb80c6a68,0x80030004);
	rtd_outl(0xb80c6a6c,0x41010021);

	rtd_outl(0xb80c6a80,0x09840806);
	rtd_outl(0xb80c6a84,0x00007f00);
	rtd_outl(0xb80c6a88,0x80002008);
	rtd_outl(0xb80c6a8c,0x41010041);

	rtd_outl(0xb80c6aa0,0x09840806);
	rtd_outl(0xb80c6aa4,0x40007f00);
	rtd_outl(0xb80c6aa8,0x12c0400c);
	rtd_outl(0xb80c6aac,0x63018071);

	rtd_outl(0xb80c6ac0,0x09840806);
	rtd_outl(0xb80c6ac4,0x20007f00);
	rtd_outl(0xb80c6ac8,0x12c0800c);
	rtd_outl(0xb80c6acc,0x63018071);

	rtd_outl(0xb80c6ae0,0x09840806);
	rtd_outl(0xb80c6ae4,0x00005000);
	rtd_outl(0xb80c6ae8,0x8000a00a);
	rtd_outl(0xb80c6aec,0x63018021);

	rtd_outl(0xb80c6b00,0x09840806);
	rtd_outl(0xb80c6b04,0x00001f00);
	rtd_outl(0xb80c6b08,0x8000c80a);
	rtd_outl(0xb80c6b0c,0x63018021);

	rtd_outl(0xb80c6b20,0x09840806);
	rtd_outl(0xb80c6b24,0x00003f00);
	rtd_outl(0xb80c6b28,0x80030004);
	rtd_outl(0xb80c6b2c,0x41010021);

	rtd_outl(0xb80c6b40,0x09840806); // DIC suggests same as ch0
	rtd_outl(0xb80c6b44,0x00003f00);
	rtd_outl(0xb80c6b48,0x80030004);
	rtd_outl(0xb80c6b4c,0x41010021);

	rtd_outl(0xb80c6b60,0x09840806); // DIC suggests same as ch6
	rtd_outl(0xb80c6b64,0x00003f00);
	rtd_outl(0xb80c6b68,0x80030004);
	rtd_outl(0xb80c6b6c,0x41010021);


	// william_qos_3(submit).tbl
	rtd_outl(0xb80c7a00,0x00000443);
	rtd_outl(0xb80c7a10,0x00000000);
	rtd_outl(0xb80c7a14,0x00000000);
	rtd_outl(0xb80c7a18,0x40000000);
	rtd_outl(0xb80c7a1c,0x012c0000);
	rtd_outl(0xb80c7a20,0x00fa00fa);
	rtd_outl(0xb80c7a24,0x00180630);
	//rtd_outl(0xb80c7a28,0x0000000f);
	rtd_outl(0xb80c7a2c,0x00ff0074);
	rtd_outl(0xb80c7a30,0x000f0007);
	rtd_outl(0xb80c7a34,0x03ff0000);
	rtd_outl(0xb80c7a3c,0x00ffffff);

	rtd_outl(0xb80c7a60,0x09840806);
	rtd_outl(0xb80c7a64,0x00003f00);
	rtd_outl(0xb80c7a68,0x80030004);
	rtd_outl(0xb80c7a6c,0x41010021);

	rtd_outl(0xb80c7a80,0x09840806);
	rtd_outl(0xb80c7a84,0x00007f00);
	rtd_outl(0xb80c7a88,0x80002008);
	rtd_outl(0xb80c7a8c,0x41010041);

	rtd_outl(0xb80c7aa0,0x09840806);
	rtd_outl(0xb80c7aa4,0x40007f00);
	rtd_outl(0xb80c7aa8,0x12c0400c);
	rtd_outl(0xb80c7aac,0x63018071);

	rtd_outl(0xb80c7ac0,0x09840806);
	rtd_outl(0xb80c7ac4,0x20007f00);
	rtd_outl(0xb80c7ac8,0x12c0800c);
	rtd_outl(0xb80c7acc,0x63018071);

	rtd_outl(0xb80c7ae0,0x09840806);
	rtd_outl(0xb80c7ae4,0x00005000);
	rtd_outl(0xb80c7ae8,0x8000a00a);
	rtd_outl(0xb80c7aec,0x63018021);

	rtd_outl(0xb80c7b00,0x09840806);
	rtd_outl(0xb80c7b04,0x00001f00);
	rtd_outl(0xb80c7b08,0x8000c80a);
	rtd_outl(0xb80c7b0c,0x63018021);

	rtd_outl(0xb80c7b20,0x09840806);
	rtd_outl(0xb80c7b24,0x00003f00);
	rtd_outl(0xb80c7b28,0x80030004);
	rtd_outl(0xb80c7b2c,0x41010021);

	rtd_outl(0xb80c7b40,0x09840806); // DIC suggests same as ch0
	rtd_outl(0xb80c7b44,0x00003f00);
	rtd_outl(0xb80c7b48,0x80030004);
	rtd_outl(0xb80c7b4c,0x41010021);

	rtd_outl(0xb80c7b60,0x09840806); // DIC suggests same as ch6
	rtd_outl(0xb80c7b64,0x00003f00);
	rtd_outl(0xb80c7b68,0x80030004);
	rtd_outl(0xb80c7b6c,0x41010021);
...
//	rtd_maskl(0xb800483c,0xFFFFFF7F,0x00000080);
	...
	rtd_outl(0xb80c3a00,0x000f0ec3);
	rtd_outl(0xb80c3a10,0x222d2af0);
	rtd_outl(0xb80c3a14,0x00000000);
	rtd_outl(0xb80c3a18,0x40000000);
	rtd_outl(0xb80c3a1c,0x012c0000);
	rtd_outl(0xb80c3a20,0x00fa00fa);
	rtd_outl(0xb80c3a24,0x00180630);
	rtd_outl(0xb80c3a28,0x00000030);
	rtd_outl(0xb80c3a2c,0x001f0066);
	rtd_outl(0xb80c3a30,0x000f0001);
	rtd_outl(0xb80c3a34,0x03ff0000);
	rtd_outl(0xb80c3a3c,0x00ffffff);

	rtd_outl(0xb80c3a60,0x09840806);
	rtd_outl(0xb80c3a64,0x00006400);
	rtd_outl(0xb80c3a68,0x80004008);
	rtd_outl(0xb80c3a6c,0x83010061);

	rtd_outl(0xb80c3a80,0x0984080e);
	rtd_outl(0xb80c3a84,0xff00ff00);
	rtd_outl(0xb80c3a88,0x05002008);
	rtd_outl(0xb80c3a8c,0x43010071);

	rtd_outl(0xb80c3aa0,0x09840806);
	rtd_outl(0xb80c3aa4,0x60007f00);
	rtd_outl(0xb80c3aa8,0x80008c08);
	rtd_outl(0xb80c3aac,0x43018031);

	rtd_outl(0xb80c3ac0,0x09840806);
	rtd_outl(0xb80c3ac4,0x60007f00);
	rtd_outl(0xb80c3ac8,0x8000b408);
	rtd_outl(0xb80c3acc,0x43018031);

	rtd_outl(0xb80c3ae0,0x09840806);
	rtd_outl(0xb80c3ae4,0x00005000);
	rtd_outl(0xb80c3ae8,0x8000b408);
	rtd_outl(0xb80c3aec,0x43018041);

	rtd_outl(0xb80c3b00,0x09840806);
	rtd_outl(0xb80c3b04,0x00001f00);
	rtd_outl(0xb80c3b08,0x8000c808);
	rtd_outl(0xb80c3b0c,0x43018041);

	rtd_outl(0xb80c3b20,0x09840806);
	rtd_outl(0xb80c3b24,0x00006400);
	rtd_outl(0xb80c3b28,0x80004008);
	rtd_outl(0xb80c3b2c,0x83010061);
...
static int rtk_qos_load_mc_decoder_8k_av1_setting(void)
{
	rtd_pr_qos_debug("[QOS] DECODER 8K AV1\n");
	...
	rtd_outl(0xb80c2a6c,0x83010051);

	rtd_outl(0xb80c2a80,0x09840800);
	rtd_outl(0xb80c2a84,0x00007f00);
	rtd_outl(0xb80c2a88,0x80008008);
	rtd_outl(0xb80c2a8c,0x41010061);

	rtd_outl(0xb80c2aa0,0x0984080e);
	rtd_outl(0xb80c2aa4,0x40007f00);
	rtd_outl(0xb80c2aa8,0x12c04008);
	rtd_outl(0xb80c2aac,0x23018061);

	rtd_outl(0xb80c2ac0,0x0984080e);
	rtd_outl(0xb80c2ac4,0x40007f00);
	rtd_outl(0xb80c2ac8,0x15e04008);
	rtd_outl(0xb80c2acc,0x23018061);

	rtd_outl(0xb80c2ae0,0x09840800);
	rtd_outl(0xb80c2ae4,0x00005000);
	rtd_outl(0xb80c2ae8,0x8000a008);
	rtd_outl(0xb80c2aec,0x43018051);

	rtd_outl(0xb80c2b00,0x09840800);
	rtd_outl(0xb80c2b04,0x00001f00);
	rtd_outl(0xb80c2b08,0x8000c808);
	rtd_outl(0xb80c2b0c,0x43018051);

	rtd_outl(0xb80c2b20,0x09840800);
	rtd_outl(0xb80c2b24,0x64007f00);
	rtd_outl(0xb80c2b28,0x10008004);
	rtd_outl(0xb80c2b2c,0x83010051);

	rtd_outl(0xb80c2b40,0x09840800);
	rtd_outl(0xb80c2b44,0x64007f00);
	rtd_outl(0xb80c2b48,0x10008004);
	rtd_outl(0xb80c2b4c,0x83010051);

	rtd_outl(0xb80c2b60,0x09840800);
	rtd_outl(0xb80c2b64,0x64007f00);
	rtd_outl(0xb80c2b68,0x10008004);
	rtd_outl(0xb80c2b6c,0x83010051);


	rtd_outl(0xb80c3a00,0x00000c43);
	rtd_outl(0xb80c3a10,0x00000000);
	rtd_outl(0xb80c3a14,0x00000000);
	rtd_outl(0xb80c3a18,0x40000000);
	rtd_outl(0xb80c3a1c,0x012c0000);
	rtd_outl(0xb80c3a20,0x00fa00fa);
	rtd_outl(0xb80c3a24,0x00180630);
	rtd_outl(0xb80c3a28,0x00002100);
	rtd_outl(0xb80c3a2c,0x001f0077);
	rtd_outl(0xb80c3a30,0x000f0001);
	rtd_outl(0xb80c3a34,0x03ff0000);
	rtd_outl(0xb80c3a3c,0x00ffffff);

	rtd_outl(0xb80c3a60,0x09840800);
	rtd_outl(0xb80c3a64,0x64007f00);
	rtd_outl(0xb80c3a68,0x10008004);
	rtd_outl(0xb80c3a6c,0x83010051);

	rtd_outl(0xb80c3a80,0x09840800);
	rtd_outl(0xb80c3a84,0x00007f00);
	rtd_outl(0xb80c3a88,0x80008008);
	rtd_outl(0xb80c3a8c,0x41010061);

	rtd_outl(0xb80c3aa0,0x0984080e);
	rtd_outl(0xb80c3aa4,0x40007f00);
	rtd_outl(0xb80c3aa8,0x12c04008);
	rtd_outl(0xb80c3aac,0x23018061);

	rtd_outl(0xb80c3ac0,0x0984080e);
	rtd_outl(0xb80c3ac4,0x40007f00);
	rtd_outl(0xb80c3ac8,0x15e04008);
	rtd_outl(0xb80c3acc,0x23018061);

	rtd_outl(0xb80c3ae0,0x09840800);
	rtd_outl(0xb80c3ae4,0x00005000);
	rtd_outl(0xb80c3ae8,0x8000a008);
	rtd_outl(0xb80c3aec,0x43018051);

	rtd_outl(0xb80c3b00,0x09840800);
	rtd_outl(0xb80c3b04,0x00001f00);
	rtd_outl(0xb80c3b08,0x8000c808);
	rtd_outl(0xb80c3b0c,0x43018051);

	rtd_outl(0xb80c3b20,0x09840800);
	rtd_outl(0xb80c3b24,0x64007f00);
	rtd_outl(0xb80c3b28,0x10008004);
	rtd_outl(0xb80c3b2c,0x83010051);

	rtd_outl(0xb80c3b40,0x09840800);
	rtd_outl(0xb80c3b44,0x64007f00);
	rtd_outl(0xb80c3b48,0x10008004);
	rtd_outl(0xb80c3b4c,0x83010051);

	rtd_outl(0xb80c3b60,0x09840800);
	rtd_outl(0xb80c3b64,0x64007f00);
	rtd_outl(0xb80c3b68,0x10008004);
	rtd_outl(0xb80c3b6c,0x83010051);
	...
	rtd_outl(0xb80c4a6c,0x83010051);

	rtd_outl(0xb80c4a80,0x09840800);
	rtd_outl(0xb80c4a84,0x00007f00);
	rtd_outl(0xb80c4a88,0x80008008);
	rtd_outl(0xb80c4a8c,0x41010061);

	rtd_outl(0xb80c4aa0,0x0984080e);
	rtd_outl(0xb80c4aa4,0x40007f00);
	rtd_outl(0xb80c4aa8,0x12c04008);
	rtd_outl(0xb80c4aac,0x23018061);

	rtd_outl(0xb80c4ac0,0x0984080e);
	rtd_outl(0xb80c4ac4,0x40007f00);
	rtd_outl(0xb80c4ac8,0x15e04008);
	rtd_outl(0xb80c4acc,0x23018061);

	rtd_outl(0xb80c4ae0,0x09840800);
	rtd_outl(0xb80c4ae4,0x00005000);
	rtd_outl(0xb80c4ae8,0x8000a008);
	rtd_outl(0xb80c4aec,0x43018051);

	rtd_outl(0xb80c4b00,0x09840800);
	rtd_outl(0xb80c4b04,0x00001f00);
	rtd_outl(0xb80c4b08,0x8000c808);
	rtd_outl(0xb80c4b0c,0x43018051);

	rtd_outl(0xb80c4b20,0x09840800);
	rtd_outl(0xb80c4b24,0x64007f00);
	rtd_outl(0xb80c4b28,0x10008004);
	rtd_outl(0xb80c4b2c,0x83010051);

	rtd_outl(0xb80c4b40,0x09840800);
	rtd_outl(0xb80c4b44,0x64007f00);
	rtd_outl(0xb80c4b48,0x10008004);
	rtd_outl(0xb80c4b4c,0x83010051);

	rtd_outl(0xb80c4b60,0x09840800);
	rtd_outl(0xb80c4b64,0x64007f00);
	rtd_outl(0xb80c4b68,0x10008004);
	rtd_outl(0xb80c4b6c,0x83010051);


	rtd_outl(0xb80c5a00,0x00000c43);
	rtd_outl(0xb80c5a10,0x00000000);
	rtd_outl(0xb80c5a14,0x00000000);
	rtd_outl(0xb80c5a18,0x40000000);
	rtd_outl(0xb80c5a1c,0x012c0000);
	rtd_outl(0xb80c5a20,0x00fa00fa);
	rtd_outl(0xb80c5a24,0x00180630);
	rtd_outl(0xb80c5a28,0x00002100);
	rtd_outl(0xb80c5a2c,0x001f0077);
	rtd_outl(0xb80c5a30,0x000f0001);
	rtd_outl(0xb80c5a34,0x03ff0000);
	rtd_outl(0xb80c5a3c,0x00ffffff);

	rtd_outl(0xb80c5a60,0x09840800);
	rtd_outl(0xb80c5a64,0x64007f00);
	rtd_outl(0xb80c5a68,0x10008004);
	rtd_outl(0xb80c5a6c,0x83010051);

	rtd_outl(0xb80c5a80,0x09840800);
	rtd_outl(0xb80c5a84,0x00007f00);
	rtd_outl(0xb80c5a88,0x80008008);
	rtd_outl(0xb80c5a8c,0x41010061);

	rtd_outl(0xb80c5aa0,0x0984080e);
	rtd_outl(0xb80c5aa4,0x40007f00);
	rtd_outl(0xb80c5aa8,0x12c04008);
	rtd_outl(0xb80c5aac,0x23018061);

	rtd_outl(0xb80c5ac0,0x0984080e);
	rtd_outl(0xb80c5ac4,0x40007f00);
	rtd_outl(0xb80c5ac8,0x15e04008);
	rtd_outl(0xb80c5acc,0x23018061);

	rtd_outl(0xb80c5ae0,0x09840800);
	rtd_outl(0xb80c5ae4,0x00005000);
	rtd_outl(0xb80c5ae8,0x8000a008);
	rtd_outl(0xb80c5aec,0x43018051);

	rtd_outl(0xb80c5b00,0x09840800);
	rtd_outl(0xb80c5b04,0x00001f00);
	rtd_outl(0xb80c5b08,0x8000c808);
	rtd_outl(0xb80c5b0c,0x43018051);

	rtd_outl(0xb80c5b20,0x09840800);
	rtd_outl(0xb80c5b24,0x64007f00);
	rtd_outl(0xb80c5b28,0x10008004);
	rtd_outl(0xb80c5b2c,0x83010051);

	rtd_outl(0xb80c5b40,0x09840800);
	rtd_outl(0xb80c5b44,0x64007f00);
	rtd_outl(0xb80c5b48,0x10008004);
	rtd_outl(0xb80c5b4c,0x83010051);

	rtd_outl(0xb80c5b60,0x09840800);
	rtd_outl(0xb80c5b64,0x64007f00);
	rtd_outl(0xb80c5b68,0x10008004);
	rtd_outl(0xb80c5b6c,0x83010051);


	rtd_outl(0xb80c6a00,0x00000c43);
	rtd_outl(0xb80c6a10,0x00000000);
	rtd_outl(0xb80c6a14,0x00000000);
	rtd_outl(0xb80c6a18,0x40000000);
	rtd_outl(0xb80c6a1c,0x012c0000);
	rtd_outl(0xb80c6a20,0x00fa00fa);
	rtd_outl(0xb80c6a24,0x00180630);
	rtd_outl(0xb80c6a28,0x00002100);
	rtd_outl(0xb80c6a2c,0x001f0077);
	rtd_outl(0xb80c6a30,0x000f0001);
	rtd_outl(0xb80c6a34,0x03ff0000);
	rtd_outl(0xb80c6a3c,0x00ffffff);

	rtd_outl(0xb80c6a60,0x09840800);
	rtd_outl(0xb80c6a64,0x64007f00);
	rtd_outl(0xb80c6a68,0x10008004);
	rtd_outl(0xb80c6a6c,0x83010051);

	rtd_outl(0xb80c6a80,0x09840800);
	rtd_outl(0xb80c6a84,0x00007f00);
	rtd_outl(0xb80c6a88,0x80008008);
	rtd_outl(0xb80c6a8c,0x41010061);

	rtd_outl(0xb80c6aa0,0x0984080e);
	rtd_outl(0xb80c6aa4,0x40007f00);
	rtd_outl(0xb80c6aa8,0x12c04008);
	rtd_outl(0xb80c6aac,0x23018061);

	rtd_outl(0xb80c6ac0,0x0984080e);
	rtd_outl(0xb80c6ac4,0x40007f00);
	rtd_outl(0xb80c6ac8,0x15e04008);
	rtd_outl(0xb80c6acc,0x23018061);

	rtd_outl(0xb80c6ae0,0x09840800);
	rtd_outl(0xb80c6ae4,0x00005000);
	rtd_outl(0xb80c6ae8,0x8000a008);
	rtd_outl(0xb80c6aec,0x43018051);

	rtd_outl(0xb80c6b00,0x09840800);
	rtd_outl(0xb80c6b04,0x00001f00);
	rtd_outl(0xb80c6b08,0x8000c808);
	rtd_outl(0xb80c6b0c,0x43018051);

	rtd_outl(0xb80c6b20,0x09840800);
	rtd_outl(0xb80c6b24,0x64007f00);
	rtd_outl(0xb80c6b28,0x10008004);
	rtd_outl(0xb80c6b2c,0x83010051);

	rtd_outl(0xb80c6b40,0x09840800);
	rtd_outl(0xb80c6b44,0x64007f00);
	rtd_outl(0xb80c6b48,0x10008004);
	rtd_outl(0xb80c6b4c,0x83010051);

	rtd_outl(0xb80c6b60,0x09840800);
	rtd_outl(0xb80c6b64,0x64007f00);
	rtd_outl(0xb80c6b68,0x10008004);
	rtd_outl(0xb80c6b6c,0x83010051);


	rtd_outl(0xb80c7a00,0x00000c43);
	rtd_outl(0xb80c7a10,0x00000000);
	rtd_outl(0xb80c7a14,0x00000000);
	rtd_outl(0xb80c7a18,0x40000000);
	rtd_outl(0xb80c7a1c,0x012c0000);
	rtd_outl(0xb80c7a20,0x00fa00fa);
	rtd_outl(0xb80c7a24,0x00180630);
	rtd_outl(0xb80c7a28,0x00002100);
	rtd_outl(0xb80c7a2c,0x001f0077);
	rtd_outl(0xb80c7a30,0x000f0001);
	rtd_outl(0xb80c7a34,0x03ff0000);
	rtd_outl(0xb80c7a3c,0x00ffffff);

	rtd_outl(0xb80c7a60,0x09840800);
	rtd_outl(0xb80c7a64,0x64007f00);
	rtd_outl(0xb80c7a68,0x10008004);
	rtd_outl(0xb80c7a6c,0x83010051);

	rtd_outl(0xb80c7a80,0x09840800);
	rtd_outl(0xb80c7a84,0x00007f00);
	rtd_outl(0xb80c7a88,0x80008008);
	rtd_outl(0xb80c7a8c,0x41010061);

	rtd_outl(0xb80c7aa0,0x0984080e);
	rtd_outl(0xb80c7aa4,0x40007f00);
	rtd_outl(0xb80c7aa8,0x12c04008);
	rtd_outl(0xb80c7aac,0x23018061);

	rtd_outl(0xb80c7ac0,0x0984080e);
	rtd_outl(0xb80c7ac4,0x40007f00);
	rtd_outl(0xb80c7ac8,0x15e04008);
	rtd_outl(0xb80c7acc,0x23018061);

	rtd_outl(0xb80c7ae0,0x09840800);
	rtd_outl(0xb80c7ae4,0x00005000);
	rtd_outl(0xb80c7ae8,0x8000a008);
	rtd_outl(0xb80c7aec,0x43018051);

	rtd_outl(0xb80c7b00,0x09840800);
	rtd_outl(0xb80c7b04,0x00001f00);
	rtd_outl(0xb80c7b08,0x8000c808);
	rtd_outl(0xb80c7b0c,0x43018051);

	rtd_outl(0xb80c7b20,0x09840800);
	rtd_outl(0xb80c7b24,0x64007f00);
	rtd_outl(0xb80c7b28,0x10008004);
	rtd_outl(0xb80c7b2c,0x83010051);

	rtd_outl(0xb80c7b40,0x09840800);
	rtd_outl(0xb80c7b44,0x64007f00);
	rtd_outl(0xb80c7b48,0x10008004);
	rtd_outl(0xb80c7b4c,0x83010051);

	rtd_outl(0xb80c7b60,0x09840800);
	rtd_outl(0xb80c7b64,0x64007f00);
	rtd_outl(0xb80c7b68,0x10008004);
	rtd_outl(0xb80c7b6c,0x83010051);
...
static int rtk_qos_load_mc_decoder_4k_setting(void)
{
	...
	rtd_outl(0xb80c2b40,0x09840800); // DIC suggests same as ch0
	rtd_outl(0xb80c2b44,0x64007f00);
	rtd_outl(0xb80c2b48,0x10008004);
	rtd_outl(0xb80c2b4c,0x83010081);

	rtd_outl(0xb80c2b60,0x09840800); // DIC suggests same as ch6
	rtd_outl(0xb80c2b64,0x64007f00);
	rtd_outl(0xb80c2b68,0x10008004);
	rtd_outl(0xb80c2b6c,0x83010081);
	...
	rtd_outl(0xb80c3a20,0x00fa00fa);
	rtd_outl(0xb80c3a24,0x00180630);
	rtd_outl(0xb80c3a28,0x0000210e);
	rtd_outl(0xb80c3a2c,0x001f0077);
	rtd_outl(0xb80c3a30,0x000f0001);
	rtd_outl(0xb80c3a34,0x03ff0000);
	rtd_outl(0xb80c3a3c,0x00ffffff);
	...
	rtd_outl(0xb80c3a64,0x64007f00);
	rtd_outl(0xb80c3a68,0x10008004);
	rtd_outl(0xb80c3a6c,0x83010081);

	rtd_outl(0xb80c3a80,0x09840800);
	rtd_outl(0xb80c3a84,0x00007f00);
	rtd_outl(0xb80c3a88,0x80002008);
	rtd_outl(0xb80c3a8c,0x41010081);

	rtd_outl(0xb80c3aa0,0x0984080e);
	rtd_outl(0xb80c3aa4,0x40007f00);
	rtd_outl(0xb80c3aa8,0x12c02008);
	rtd_outl(0xb80c3aac,0x23018081);

	rtd_outl(0xb80c3ac0,0x0984080e);
	rtd_outl(0xb80c3ac4,0x40007f00);
	rtd_outl(0xb80c3ac8,0x15e02008);
	rtd_outl(0xb80c3acc,0x23018081);

	rtd_outl(0xb80c3ae0,0x09840800);
	rtd_outl(0xb80c3ae4,0x00005000);
	rtd_outl(0xb80c3ae8,0x8000a008);
	rtd_outl(0xb80c3aec,0x23018031);

	rtd_outl(0xb80c3b00,0x09840800);
	rtd_outl(0xb80c3b04,0x00001f00);
	rtd_outl(0xb80c3b08,0x8000c808);
	rtd_outl(0xb80c3b0c,0x23018031);

	rtd_outl(0xb80c3b20,0x09840800);
	rtd_outl(0xb80c3b24,0x64007f00);
	rtd_outl(0xb80c3b28,0x10008004);
	rtd_outl(0xb80c3b2c,0x83010081);

	rtd_outl(0xb80c3b40,0x09840800); // DIC suggests same as ch0
	rtd_outl(0xb80c3b44,0x64007f00);
	rtd_outl(0xb80c3b48,0x10008004);
	rtd_outl(0xb80c3b4c,0x83010081);

	rtd_outl(0xb80c3b60,0x09840800); // DIC suggests same as ch6
	rtd_outl(0xb80c3b64,0x64007f00);
	rtd_outl(0xb80c3b68,0x10008004);
	rtd_outl(0xb80c3b6c,0x83010081);
	...
	rtd_outl(0xb80c4b40,0x09840800); // DIC suggests same as ch0
	rtd_outl(0xb80c4b44,0x64007f00);
	rtd_outl(0xb80c4b48,0x10008004);
	rtd_outl(0xb80c4b4c,0x83010081);

	rtd_outl(0xb80c4b60,0x09840800); // DIC suggests same as ch6
	rtd_outl(0xb80c4b64,0x64007f00);
	rtd_outl(0xb80c4b68,0x10008004);
	rtd_outl(0xb80c4b6c,0x83010081);
	...
	rtd_outl(0xb80c5a20,0x00fa00fa);
	rtd_outl(0xb80c5a24,0x00180630);
	rtd_outl(0xb80c5a28,0x0000210e);
	rtd_outl(0xb80c5a2c,0x001f0077);
	rtd_outl(0xb80c5a30,0x000f0001);
	rtd_outl(0xb80c5a34,0x03ff0000);
	rtd_outl(0xb80c5a3c,0x00ffffff);
	...
	rtd_outl(0xb80c5a64,0x64007f00);
	rtd_outl(0xb80c5a68,0x10008004);
	rtd_outl(0xb80c5a6c,0x83010081);

	rtd_outl(0xb80c5a80,0x09840800);
	rtd_outl(0xb80c5a84,0x00007f00);
	rtd_outl(0xb80c5a88,0x80002008);
	rtd_outl(0xb80c5a8c,0x41010081);

	rtd_outl(0xb80c5aa0,0x0984080e);
	rtd_outl(0xb80c5aa4,0x40007f00);
	rtd_outl(0xb80c5aa8,0x12c02008);
	rtd_outl(0xb80c5aac,0x23018081);

	rtd_outl(0xb80c5ac0,0x0984080e);
	rtd_outl(0xb80c5ac4,0x40007f00);
	rtd_outl(0xb80c5ac8,0x15e02008);
	rtd_outl(0xb80c5acc,0x23018081);

	rtd_outl(0xb80c5ae0,0x09840800);
	rtd_outl(0xb80c5ae4,0x00005000);
	rtd_outl(0xb80c5ae8,0x8000a008);
	rtd_outl(0xb80c5aec,0x23018031);

	rtd_outl(0xb80c5b00,0x09840800);
	rtd_outl(0xb80c5b04,0x00001f00);
	rtd_outl(0xb80c5b08,0x8000c808);
	rtd_outl(0xb80c5b0c,0x23018031);

	rtd_outl(0xb80c5b20,0x09840800);
	rtd_outl(0xb80c5b24,0x64007f00);
	rtd_outl(0xb80c5b28,0x10008004);
	rtd_outl(0xb80c5b2c,0x83010081);

	rtd_outl(0xb80c5b40,0x09840800); // DIC suggests same as ch0
	rtd_outl(0xb80c5b44,0x64007f00);
	rtd_outl(0xb80c5b48,0x10008004);
	rtd_outl(0xb80c5b4c,0x83010081);

	rtd_outl(0xb80c5b60,0x09840800); // DIC suggests same as ch6
	rtd_outl(0xb80c5b64,0x64007f00);
	rtd_outl(0xb80c5b68,0x10008004);
	rtd_outl(0xb80c5b6c,0x83010081);
	...
	rtd_outl(0xb80c6a20,0x00fa00fa);
	rtd_outl(0xb80c6a24,0x00180630);
	rtd_outl(0xb80c6a28,0x0000210e);
	rtd_outl(0xb80c6a2c,0x001f0077);
	rtd_outl(0xb80c6a30,0x000f0001);
	rtd_outl(0xb80c6a34,0x03ff0000);
	rtd_outl(0xb80c6a3c,0x00ffffff);
	...
	rtd_outl(0xb80c6a64,0x64007f00);
	rtd_outl(0xb80c6a68,0x10008004);
	rtd_outl(0xb80c6a6c,0x83010081);

	rtd_outl(0xb80c6a80,0x09840800);
	rtd_outl(0xb80c6a84,0x00007f00);
	rtd_outl(0xb80c6a88,0x80002008);
	rtd_outl(0xb80c6a8c,0x41010081);

	rtd_outl(0xb80c6aa0,0x0984080e);
	rtd_outl(0xb80c6aa4,0x40007f00);
	rtd_outl(0xb80c6aa8,0x12c02008);
	rtd_outl(0xb80c6aac,0x23018081);

	rtd_outl(0xb80c6ac0,0x0984080e);
	rtd_outl(0xb80c6ac4,0x40007f00);
	rtd_outl(0xb80c6ac8,0x15e02008);
	rtd_outl(0xb80c6acc,0x23018081);

	rtd_outl(0xb80c6ae0,0x09840800);
	rtd_outl(0xb80c6ae4,0x00005000);
	rtd_outl(0xb80c6ae8,0x8000a008);
	rtd_outl(0xb80c6aec,0x23018031);

	rtd_outl(0xb80c6b00,0x09840800);
	rtd_outl(0xb80c6b04,0x00001f00);
	rtd_outl(0xb80c6b08,0x8000c808);
	rtd_outl(0xb80c6b0c,0x23018031);

	rtd_outl(0xb80c6b20,0x09840800);
	rtd_outl(0xb80c6b24,0x64007f00);
	rtd_outl(0xb80c6b28,0x10008004);
	rtd_outl(0xb80c6b2c,0x83010081);

	rtd_outl(0xb80c6b40,0x09840800); // DIC suggests same as ch0
	rtd_outl(0xb80c6b44,0x64007f00);
	rtd_outl(0xb80c6b48,0x10008004);
	rtd_outl(0xb80c6b4c,0x83010081);

	rtd_outl(0xb80c6b60,0x09840800); // DIC suggests same as ch6
	rtd_outl(0xb80c6b64,0x64007f00);
	rtd_outl(0xb80c6b68,0x10008004);
	rtd_outl(0xb80c6b6c,0x83010081);
	...
	rtd_outl(0xb80c7a20,0x00fa00fa);
	rtd_outl(0xb80c7a24,0x00180630);
	rtd_outl(0xb80c7a28,0x0000210e);
	rtd_outl(0xb80c7a2c,0x001f0077);
	rtd_outl(0xb80c7a30,0x000f0001);
	rtd_outl(0xb80c7a34,0x03ff0000);
	rtd_outl(0xb80c7a3c,0x00ffffff);
	...
	rtd_outl(0xb80c7a64,0x64007f00);
	rtd_outl(0xb80c7a68,0x10008004);
	rtd_outl(0xb80c7a6c,0x83010081);

	rtd_outl(0xb80c7a80,0x09840800);
	rtd_outl(0xb80c7a84,0x00007f00);
	rtd_outl(0xb80c7a88,0x80002008);
	rtd_outl(0xb80c7a8c,0x41010081);

	rtd_outl(0xb80c7aa0,0x0984080e);
	rtd_outl(0xb80c7aa4,0x40007f00);
	rtd_outl(0xb80c7aa8,0x12c02008);
	rtd_outl(0xb80c7aac,0x23018081);

	rtd_outl(0xb80c7ac0,0x0984080e);
	rtd_outl(0xb80c7ac4,0x40007f00);
	rtd_outl(0xb80c7ac8,0x15e02008);
	rtd_outl(0xb80c7acc,0x23018081);

	rtd_outl(0xb80c7ae0,0x09840800);
	rtd_outl(0xb80c7ae4,0x00005000);
	rtd_outl(0xb80c7ae8,0x8000a008);
	rtd_outl(0xb80c7aec,0x23018031);

	rtd_outl(0xb80c7b00,0x09840800);
	rtd_outl(0xb80c7b04,0x00001f00);
	rtd_outl(0xb80c7b08,0x8000c808);
	rtd_outl(0xb80c7b0c,0x23018031);

	rtd_outl(0xb80c7b20,0x09840800);
	rtd_outl(0xb80c7b24,0x64007f00);
	rtd_outl(0xb80c7b28,0x10008004);
	rtd_outl(0xb80c7b2c,0x83010081);

	rtd_outl(0xb80c7b40,0x09840800); // DIC suggests same as ch0
	rtd_outl(0xb80c7b44,0x64007f00);
	rtd_outl(0xb80c7b48,0x10008004);
	rtd_outl(0xb80c7b4c,0x83010081);

	rtd_outl(0xb80c7b60,0x09840800); // DIC suggests same as ch6
	rtd_outl(0xb80c7b64,0x64007f00);
	rtd_outl(0xb80c7b68,0x10008004);
	rtd_outl(0xb80c7b6c,0x83010081);
...
static int rtk_qos_load_mc_decoder_4k_ddr4_setting(void)
{
	...
	rtd_outl(0xb80c2b44,0x64007f00);
	rtd_outl(0xb80c2b48,0x10008004);
	rtd_outl(0xb80c2b4c,0x43010041);

	rtd_outl(0xb80c2b60,0x09840800); // DIC suggests same as ch6
	rtd_outl(0xb80c2b64,0x64007f00);
	rtd_outl(0xb80c2b68,0x10008004);
	rtd_outl(0xb80c2b6c,0x43010041);


	rtd_outl(0xb80c3a00,0x00000e43);
	rtd_outl(0xb80c3a10,0x00000000);
	rtd_outl(0xb80c3a14,0x00000000);
	rtd_outl(0xb80c3a18,0x40000000);
	rtd_outl(0xb80c3a1c,0x012c0000);
	...
	rtd_outl(0xb80c3a24,0x00180630);
	rtd_outl(0xb80c3a28,0x0000210e);
	rtd_outl(0xb80c3a2c,0x001f0096);
	rtd_outl(0xb80c3a30,0x000f0007);
	rtd_outl(0xb80c3a34,0x03ff0000);
	rtd_outl(0xb80c3a3c,0x00ffffff);
	...
	rtd_outl(0xb80c3a64,0x64007f00);
	rtd_outl(0xb80c3a68,0x10008004);
	rtd_outl(0xb80c3a6c,0x43010041);
	...
	rtd_outl(0xb80c3aa0,0x0984080e);
	rtd_outl(0xb80c3aa4,0x40007f00);
	rtd_outl(0xb80c3aa8,0x0fa02008);
	rtd_outl(0xb80c3aac,0x43018081);

	rtd_outl(0xb80c3ac0,0x0984080e);
	rtd_outl(0xb80c3ac4,0x40007f00);
	rtd_outl(0xb80c3ac8,0x0fa02008);
	rtd_outl(0xb80c3acc,0x43018081);

	rtd_outl(0xb80c3ae0,0x09840800);
	rtd_outl(0xb80c3ae4,0x00005000);
	rtd_outl(0xb80c3ae8,0x4000c808);
	rtd_outl(0xb80c3aec,0x23018031);

	rtd_outl(0xb80c3b00,0x09840800);
	rtd_outl(0xb80c3b04,0x00001f00);
	rtd_outl(0xb80c3b08,0x5dc10408);
	rtd_outl(0xb80c3b0c,0x23018031);

	rtd_outl(0xb80c3b20,0x09840800);
	rtd_outl(0xb80c3b24,0x64007f00);
	rtd_outl(0xb80c3b28,0x10008004);
	rtd_outl(0xb80c3b2c,0x43010041);

	rtd_outl(0xb80c3b40,0x09840800); // DIC suggests same as ch0
	rtd_outl(0xb80c3b44,0x64007f00);
	rtd_outl(0xb80c3b48,0x10008004);
	rtd_outl(0xb80c3b4c,0x43010041);

	rtd_outl(0xb80c3b60,0x09840800); // DIC suggests same as ch6
	rtd_outl(0xb80c3b64,0x64007f00);
	rtd_outl(0xb80c3b68,0x10008004);
	rtd_outl(0xb80c3b6c,0x43010041);
	...
	rtd_outl(0xb80c4b44,0x64007f00);
	rtd_outl(0xb80c4b48,0x10008004);
	rtd_outl(0xb80c4b4c,0x43010041);

	rtd_outl(0xb80c4b60,0x09840800); // DIC suggests same as ch6
	rtd_outl(0xb80c4b64,0x64007f00);
	rtd_outl(0xb80c4b68,0x10008004);
	rtd_outl(0xb80c4b6c,0x43010041);


	rtd_outl(0xb80c5a00,0x00000e43);
	rtd_outl(0xb80c5a10,0x00000000);
	rtd_outl(0xb80c5a14,0x00000000);
	rtd_outl(0xb80c5a18,0x40000000);
	rtd_outl(0xb80c5a1c,0x012c0000);
	...
	rtd_outl(0xb80c5a24,0x00180630);
	rtd_outl(0xb80c5a28,0x0000210e);
	rtd_outl(0xb80c5a2c,0x001f0096);
	rtd_outl(0xb80c5a30,0x000f0007);
	rtd_outl(0xb80c5a34,0x03ff0000);
	rtd_outl(0xb80c5a3c,0x00ffffff);
	...
	rtd_outl(0xb80c5a64,0x64007f00);
	rtd_outl(0xb80c5a68,0x10008004);
	rtd_outl(0xb80c5a6c,0x43010041);
	...
	rtd_outl(0xb80c5aa0,0x0984080e);
	rtd_outl(0xb80c5aa4,0x40007f00);
	rtd_outl(0xb80c5aa8,0x0fa02008);
	rtd_outl(0xb80c5aac,0x43018081);

	rtd_outl(0xb80c5ac0,0x0984080e);
	rtd_outl(0xb80c5ac4,0x40007f00);
	rtd_outl(0xb80c5ac8,0x0fa02008);
	rtd_outl(0xb80c5acc,0x43018081);

	rtd_outl(0xb80c5ae0,0x09840800);
	rtd_outl(0xb80c5ae4,0x00005000);
	rtd_outl(0xb80c5ae8,0x4000c808);
	rtd_outl(0xb80c5aec,0x23018031);

	rtd_outl(0xb80c5b00,0x09840800);
	rtd_outl(0xb80c5b04,0x00001f00);
	rtd_outl(0xb80c5b08,0x5dc10408);
	rtd_outl(0xb80c5b0c,0x23018031);

	rtd_outl(0xb80c5b20,0x09840800);
	rtd_outl(0xb80c5b24,0x64007f00);
	rtd_outl(0xb80c5b28,0x10008004);
	rtd_outl(0xb80c5b2c,0x43010041);

	rtd_outl(0xb80c5b40,0x09840800); // DIC suggests same as ch0
	rtd_outl(0xb80c5b44,0x64007f00);
	rtd_outl(0xb80c5b48,0x10008004);
	rtd_outl(0xb80c5b4c,0x43010041);

	rtd_outl(0xb80c5b60,0x09840800); // DIC suggests same as ch6
	rtd_outl(0xb80c5b64,0x64007f00);
	rtd_outl(0xb80c5b68,0x10008004);
	rtd_outl(0xb80c5b6c,0x43010041);


	rtd_outl(0xb80c6a00,0x00000e43);
	rtd_outl(0xb80c6a10,0x00000000);
	rtd_outl(0xb80c6a14,0x00000000);
	rtd_outl(0xb80c6a18,0x40000000);
	rtd_outl(0xb80c6a1c,0x012c0000);
	...
	rtd_outl(0xb80c6a24,0x00180630);
	rtd_outl(0xb80c6a28,0x0000210e);
	rtd_outl(0xb80c6a2c,0x001f0096);
	rtd_outl(0xb80c6a30,0x000f0007);
	rtd_outl(0xb80c6a34,0x03ff0000);
	rtd_outl(0xb80c6a3c,0x00ffffff);
	...
	rtd_outl(0xb80c6a64,0x64007f00);
	rtd_outl(0xb80c6a68,0x10008004);
	rtd_outl(0xb80c6a6c,0x43010041);
	...
	rtd_outl(0xb80c6aa0,0x0984080e);
	rtd_outl(0xb80c6aa4,0x40007f00);
	rtd_outl(0xb80c6aa8,0x0fa02008);
	rtd_outl(0xb80c6aac,0x43018081);

	rtd_outl(0xb80c6ac0,0x0984080e);
	rtd_outl(0xb80c6ac4,0x40007f00);
	rtd_outl(0xb80c6ac8,0x0fa02008);
	rtd_outl(0xb80c6acc,0x43018081);

	rtd_outl(0xb80c6ae0,0x09840800);
	rtd_outl(0xb80c6ae4,0x00005000);
	rtd_outl(0xb80c6ae8,0x4000c808);
	rtd_outl(0xb80c6aec,0x23018031);

	rtd_outl(0xb80c6b00,0x09840800);
	rtd_outl(0xb80c6b04,0x00001f00);
	rtd_outl(0xb80c6b08,0x5dc10408);
	rtd_outl(0xb80c6b0c,0x23018031);

	rtd_outl(0xb80c6b20,0x09840800);
	rtd_outl(0xb80c6b24,0x64007f00);
	rtd_outl(0xb80c6b28,0x10008004);
	rtd_outl(0xb80c6b2c,0x43010041);

	rtd_outl(0xb80c6b40,0x09840800); // DIC suggests same as ch0
	rtd_outl(0xb80c6b44,0x64007f00);
	rtd_outl(0xb80c6b48,0x10008004);
	rtd_outl(0xb80c6b4c,0x43010041);

	rtd_outl(0xb80c6b60,0x09840800); // DIC suggests same as ch6
	rtd_outl(0xb80c6b64,0x64007f00);
	rtd_outl(0xb80c6b68,0x10008004);
	rtd_outl(0xb80c6b6c,0x43010041);


	rtd_outl(0xb80c7a00,0x00000e43);
	rtd_outl(0xb80c7a10,0x00000000);
	rtd_outl(0xb80c7a14,0x00000000);
	rtd_outl(0xb80c7a18,0x40000000);
	rtd_outl(0xb80c7a1c,0x012c0000);
	...
	rtd_outl(0xb80c7a24,0x00180630);
	rtd_outl(0xb80c7a28,0x0000210e);
	rtd_outl(0xb80c7a2c,0x001f0096);
	rtd_outl(0xb80c7a30,0x000f0007);
	rtd_outl(0xb80c7a34,0x03ff0000);
	rtd_outl(0xb80c7a3c,0x00ffffff);
	...
	rtd_outl(0xb80c7a64,0x64007f00);
	rtd_outl(0xb80c7a68,0x10008004);
	rtd_outl(0xb80c7a6c,0x43010041);
	...
	rtd_outl(0xb80c7aa0,0x0984080e);
	rtd_outl(0xb80c7aa4,0x40007f00);
	rtd_outl(0xb80c7aa8,0x0fa02008);
	rtd_outl(0xb80c7aac,0x43018081);

	rtd_outl(0xb80c7ac0,0x0984080e);
	rtd_outl(0xb80c7ac4,0x40007f00);
	rtd_outl(0xb80c7ac8,0x0fa02008);
	rtd_outl(0xb80c7acc,0x43018081);

	rtd_outl(0xb80c7ae0,0x09840800);
	rtd_outl(0xb80c7ae4,0x00005000);
	rtd_outl(0xb80c7ae8,0x4000c808);
	rtd_outl(0xb80c7aec,0x23018031);

	rtd_outl(0xb80c7b00,0x09840800);
	rtd_outl(0xb80c7b04,0x00001f00);
	rtd_outl(0xb80c7b08,0x5dc10408);
	rtd_outl(0xb80c7b0c,0x23018031);

	rtd_outl(0xb80c7b20,0x09840800);
	rtd_outl(0xb80c7b24,0x64007f00);
	rtd_outl(0xb80c7b28,0x10008004);
	rtd_outl(0xb80c7b2c,0x43010041);

	rtd_outl(0xb80c7b40,0x09840800); // DIC suggests same as ch0
	rtd_outl(0xb80c7b44,0x64007f00);
	rtd_outl(0xb80c7b48,0x10008004);
	rtd_outl(0xb80c7b4c,0x43010041);

	rtd_outl(0xb80c7b60,0x09840800); // DIC suggests same as ch6
	rtd_outl(0xb80c7b64,0x64007f00);
	rtd_outl(0xb80c7b68,0x10008004);
	rtd_outl(0xb80c7b6c,0x43010041);
...
static int rtk_qos_load_mc_decoder_2k_ddr4_setting(void)
{
	...
	rtd_outl(0xb80c3a20,0x00fa00fa);
	rtd_outl(0xb80c3a24,0x00180630);
	rtd_outl(0xb80c3a28,0x0000290e);
	rtd_outl(0xb80c3a2c,0x001f0064);
	rtd_outl(0xb80c3a30,0x000f0007);
	rtd_outl(0xb80c3a34,0x00200000);
	rtd_outl(0xb80c3a3c,0x00ffffff);

	rtd_outl(0xb80c3a60,0x0984080c);
	rtd_outl(0xb80c3a64,0x5a005a00);
	rtd_outl(0xb80c3a68,0x7ff7ff08);
	rtd_outl(0xb80c3a6c,0x00002041);

	rtd_outl(0xb80c3a80,0x0984088c);
	rtd_outl(0xb80c3a84,0x46004600);
	rtd_outl(0xb80c3a88,0x7ff20008);
	rtd_outl(0xb80c3a8c,0x00020041);

	rtd_outl(0xb80c3aa0,0x0984088e);
	rtd_outl(0xb80c3aa4,0x82008200);
	rtd_outl(0xb80c3aa8,0x08006008);
	rtd_outl(0xb80c3aac,0x4003ff81);

	rtd_outl(0xb80c3ac0,0x09840806);
	rtd_outl(0xb80c3ac4,0x78007800);
	rtd_outl(0xb80c3ac8,0x08008008);
	rtd_outl(0xb80c3acc,0x4003ff81);

	rtd_outl(0xb80c3ae0,0x09840800);
	rtd_outl(0xb80c3ae4,0x6e006e00);
	rtd_outl(0xb80c3ae8,0x7ff7ff08);
	rtd_outl(0xb80c3aec,0x00008031);

	rtd_outl(0xb80c3b00,0x09840802);
	rtd_outl(0xb80c3b04,0x64006400);
	rtd_outl(0xb80c3b08,0x7ff7ff08);
	rtd_outl(0xb80c3b0c,0x00008031);

	rtd_outl(0xb80c3b20,0x09840806);
	rtd_outl(0xb80c3b24,0x50005000);
	rtd_outl(0xb80c3b28,0x7ff7ff08);
	rtd_outl(0xb80c3b2c,0x00002041);
...
static int rtk_qos_load_mc_hdmi_4k_setting(void)
{
	...
	rtd_outl(0xb80c2b40,0x09840806); // DIC suggests same as ch0
	rtd_outl(0xb80c2b44,0x00003f00);
	rtd_outl(0xb80c2b48,0x80080008);
	rtd_outl(0xb80c2b4c,0x43010031);

	rtd_outl(0xb80c2b60,0x09840806); // DIC suggests same as ch6
	rtd_outl(0xb80c2b64,0x00003f00);
	rtd_outl(0xb80c2b68,0x80080008);
	rtd_outl(0xb80c2b6c,0x43010031);
	...
	rtd_outl(0xb80c3a20,0x00fa00fa);
	rtd_outl(0xb80c3a24,0x00180630);
	rtd_outl(0xb80c3a28,0x0000000e);
	rtd_outl(0xb80c3a2c,0x00ff0077);
	rtd_outl(0xb80c3a30,0x000f0001);
	rtd_outl(0xb80c3a34,0x03ff0000);
	rtd_outl(0xb80c3a3c,0x00ffffff);
	...
	rtd_outl(0xb80c3a60,0x09840806);
	rtd_outl(0xb80c3a64,0x00003f00);
	rtd_outl(0xb80c3a68,0x80080008);
	rtd_outl(0xb80c3a6c,0x43010031);

	rtd_outl(0xb80c3a80,0x09840806);
	rtd_outl(0xb80c3a84,0x00003f00);
	rtd_outl(0xb80c3a88,0x80040008);
	rtd_outl(0xb80c3a8c,0x43010031);

	rtd_outl(0xb80c3aa0,0x0984080e);
	rtd_outl(0xb80c3aa4,0x40007f00);
	rtd_outl(0xb80c3aa8,0x0fa00808);
	rtd_outl(0xb80c3aac,0x43018081);

	rtd_outl(0xb80c3ac0,0x0984080e);
	rtd_outl(0xb80c3ac4,0x40007f00);
	rtd_outl(0xb80c3ac8,0x0c800808);
	rtd_outl(0xb80c3acc,0x43018081);

	rtd_outl(0xb80c3ae0,0x09840802);
	rtd_outl(0xb80c3ae4,0x00003f00);
	rtd_outl(0xb80c3ae8,0x80018008);
	rtd_outl(0xb80c3aec,0x43018021);

	rtd_outl(0xb80c3b00,0x09840802);
	rtd_outl(0xb80c3b04,0x00001f00);
	rtd_outl(0xb80c3b08,0x80018008);
	rtd_outl(0xb80c3b0c,0x43018011);

	rtd_outl(0xb80c3b20,0x09840806);
	rtd_outl(0xb80c3b24,0x00003f00);
	rtd_outl(0xb80c3b28,0x80080008);
	rtd_outl(0xb80c3b2c,0x43010031);

	rtd_outl(0xb80c3b40,0x09840806); // DIC suggests same as ch0
	rtd_outl(0xb80c3b44,0x00003f00);
	rtd_outl(0xb80c3b48,0x80080008);
	rtd_outl(0xb80c3b4c,0x43010031);

	rtd_outl(0xb80c3b60,0x09840806); // DIC suggests same as ch6
	rtd_outl(0xb80c3b64,0x00003f00);
	rtd_outl(0xb80c3b68,0x80080008);
	rtd_outl(0xb80c3b6c,0x43010031);
	...
	rtd_outl(0xb80c4b40,0x09840806); // DIC suggests same as ch0
	rtd_outl(0xb80c4b44,0x00003f00);
	rtd_outl(0xb80c4b48,0x80080008);
	rtd_outl(0xb80c4b4c,0x43010031);

	rtd_outl(0xb80c4b60,0x09840806); // DIC suggests same as ch6
	rtd_outl(0xb80c4b64,0x00003f00);
	rtd_outl(0xb80c4b68,0x80080008);
	rtd_outl(0xb80c4b6c,0x43010031);
	...
	rtd_outl(0xb80c5a20,0x00fa00fa);
	rtd_outl(0xb80c5a24,0x00180630);
	rtd_outl(0xb80c5a28,0x0000000e);
	rtd_outl(0xb80c5a2c,0x00ff0077);
	rtd_outl(0xb80c5a30,0x000f0001);
	rtd_outl(0xb80c5a34,0x03ff0000);
	rtd_outl(0xb80c5a3c,0x00ffffff);
	...
	rtd_outl(0xb80c5a60,0x09840806);
	rtd_outl(0xb80c5a64,0x00003f00);
	rtd_outl(0xb80c5a68,0x80080008);
	rtd_outl(0xb80c5a6c,0x43010031);

	rtd_outl(0xb80c5a80,0x09840806);
	rtd_outl(0xb80c5a84,0x00003f00);
	rtd_outl(0xb80c5a88,0x80040008);
	rtd_outl(0xb80c5a8c,0x43010031);

	rtd_outl(0xb80c5aa0,0x0984080e);
	rtd_outl(0xb80c5aa4,0x40007f00);
	rtd_outl(0xb80c5aa8,0x0fa00808);
	rtd_outl(0xb80c5aac,0x43018081);

	rtd_outl(0xb80c5ac0,0x0984080e);
	rtd_outl(0xb80c5ac4,0x40007f00);
	rtd_outl(0xb80c5ac8,0x0c800808);
	rtd_outl(0xb80c5acc,0x43018081);

	rtd_outl(0xb80c5ae0,0x09840802);
	rtd_outl(0xb80c5ae4,0x00003f00);
	rtd_outl(0xb80c5ae8,0x80018008);
	rtd_outl(0xb80c5aec,0x43018021);

	rtd_outl(0xb80c5b00,0x09840802);
	rtd_outl(0xb80c5b04,0x00001f00);
	rtd_outl(0xb80c5b08,0x80018008);
	rtd_outl(0xb80c5b0c,0x43018011);

	rtd_outl(0xb80c5b20,0x09840806);
	rtd_outl(0xb80c5b24,0x00003f00);
	rtd_outl(0xb80c5b28,0x80080008);
	rtd_outl(0xb80c5b2c,0x43010031);

	rtd_outl(0xb80c5b40,0x09840806); // DIC suggests same as ch0
	rtd_outl(0xb80c5b44,0x00003f00);
	rtd_outl(0xb80c5b48,0x80080008);
	rtd_outl(0xb80c5b4c,0x43010031);

	rtd_outl(0xb80c5b60,0x09840806); // DIC suggests same as ch6
	rtd_outl(0xb80c5b64,0x00003f00);
	rtd_outl(0xb80c5b68,0x80080008);
	rtd_outl(0xb80c5b6c,0x43010031);
	...
	rtd_outl(0xb80c6a20,0x00fa00fa);
	rtd_outl(0xb80c6a24,0x00180630);
	rtd_outl(0xb80c6a28,0x0000000e);
	rtd_outl(0xb80c6a2c,0x00ff0077);
	rtd_outl(0xb80c6a30,0x000f0001);
	rtd_outl(0xb80c6a34,0x03ff0000);
	rtd_outl(0xb80c6a3c,0x00ffffff);
	...
	rtd_outl(0xb80c6a60,0x09840806);
	rtd_outl(0xb80c6a64,0x00003f00);
	rtd_outl(0xb80c6a68,0x80080008);
	rtd_outl(0xb80c6a6c,0x43010031);

	rtd_outl(0xb80c6a80,0x09840806);
	rtd_outl(0xb80c6a84,0x00003f00);
	rtd_outl(0xb80c6a88,0x80040008);
	rtd_outl(0xb80c6a8c,0x43010031);

	rtd_outl(0xb80c6aa0,0x0984080e);
	rtd_outl(0xb80c6aa4,0x40007f00);
	rtd_outl(0xb80c6aa8,0x0fa00808);
	rtd_outl(0xb80c6aac,0x43018081);

	rtd_outl(0xb80c6ac0,0x0984080e);
	rtd_outl(0xb80c6ac4,0x40007f00);
	rtd_outl(0xb80c6ac8,0x0c800808);
	rtd_outl(0xb80c6acc,0x43018081);

	rtd_outl(0xb80c6ae0,0x09840802);
	rtd_outl(0xb80c6ae4,0x00003f00);
	rtd_outl(0xb80c6ae8,0x80018008);
	rtd_outl(0xb80c6aec,0x43018021);

	rtd_outl(0xb80c6b00,0x09840802);
	rtd_outl(0xb80c6b04,0x00001f00);
	rtd_outl(0xb80c6b08,0x80018008);
	rtd_outl(0xb80c6b0c,0x43018011);

	rtd_outl(0xb80c6b20,0x09840806);
	rtd_outl(0xb80c6b24,0x00003f00);
	rtd_outl(0xb80c6b28,0x80080008);
	rtd_outl(0xb80c6b2c,0x43010031);

	rtd_outl(0xb80c6b40,0x09840806); // DIC suggests same as ch0
	rtd_outl(0xb80c6b44,0x00003f00);
	rtd_outl(0xb80c6b48,0x80080008);
	rtd_outl(0xb80c6b4c,0x43010031);

	rtd_outl(0xb80c6b60,0x09840806); // DIC suggests same as ch6
	rtd_outl(0xb80c6b64,0x00003f00);
	rtd_outl(0xb80c6b68,0x80080008);
	rtd_outl(0xb80c6b6c,0x43010031);
	...
	rtd_outl(0xb80c7a20,0x00fa00fa);
	rtd_outl(0xb80c7a24,0x00180630);
	rtd_outl(0xb80c7a28,0x0000000e);
	rtd_outl(0xb80c7a2c,0x00ff0077);
	rtd_outl(0xb80c7a30,0x000f0001);
	rtd_outl(0xb80c7a34,0x03ff0000);
	rtd_outl(0xb80c7a3c,0x00ffffff);
	...
	rtd_outl(0xb80c7a60,0x09840806);
	rtd_outl(0xb80c7a64,0x00003f00);
	rtd_outl(0xb80c7a68,0x80080008);
	rtd_outl(0xb80c7a6c,0x43010031);

	rtd_outl(0xb80c7a80,0x09840806);
	rtd_outl(0xb80c7a84,0x00003f00);
	rtd_outl(0xb80c7a88,0x80040008);
	rtd_outl(0xb80c7a8c,0x43010031);

	rtd_outl(0xb80c7aa0,0x0984080e);
	rtd_outl(0xb80c7aa4,0x40007f00);
	rtd_outl(0xb80c7aa8,0x0fa00808);
	rtd_outl(0xb80c7aac,0x43018081);

	rtd_outl(0xb80c7ac0,0x0984080e);
	rtd_outl(0xb80c7ac4,0x40007f00);
	rtd_outl(0xb80c7ac8,0x0c800808);
	rtd_outl(0xb80c7acc,0x43018081);

	rtd_outl(0xb80c7ae0,0x09840802);
	rtd_outl(0xb80c7ae4,0x00003f00);
	rtd_outl(0xb80c7ae8,0x80018008);
	rtd_outl(0xb80c7aec,0x43018021);

	rtd_outl(0xb80c7b00,0x09840802);
	rtd_outl(0xb80c7b04,0x00001f00);
	rtd_outl(0xb80c7b08,0x80018008);
	rtd_outl(0xb80c7b0c,0x43018011);

	rtd_outl(0xb80c7b20,0x09840806);
	rtd_outl(0xb80c7b24,0x00003f00);
	rtd_outl(0xb80c7b28,0x80080008);
	rtd_outl(0xb80c7b2c,0x43010031);

	rtd_outl(0xb80c7b40,0x09840806); // DIC suggests same as ch0
	rtd_outl(0xb80c7b44,0x00003f00);
	rtd_outl(0xb80c7b48,0x80080008);
	rtd_outl(0xb80c7b4c,0x43010031);

	rtd_outl(0xb80c7b60,0x09840806); // DIC suggests same as ch6
	rtd_outl(0xb80c7b64,0x00003f00);
	rtd_outl(0xb80c7b68,0x80080008);
	rtd_outl(0xb80c7b6c,0x43010031);
...
static int rtk_qos_load_mc_hdmi_4k_ddr4_setting(void)
{
	...
	rtd_outl(0xb80c2b40,0x09840806); // DIC suggests same as ch0
	rtd_outl(0xb80c2b44,0x5a007f00);
	rtd_outl(0xb80c2b48,0x0fa03008);
	rtd_outl(0xb80c2b4c,0x43010061);

	rtd_outl(0xb80c2b60,0x09840806); // DIC suggests same as ch6
	rtd_outl(0xb80c2b64,0x6e007f00);
	rtd_outl(0xb80c2b68,0x0fa03008);
	rtd_outl(0xb80c2b6c,0x43010061);
	...
	rtd_outl(0xb80c3a20,0x00fa00fa);
	rtd_outl(0xb80c3a24,0x00180630);
	rtd_outl(0xb80c3a28,0x00000c0e);
	rtd_outl(0xb80c3a2c,0x001f0064);
	rtd_outl(0xb80c3a30,0x000f0007);
	rtd_outl(0xb80c3a34,0x03ff0000);
	rtd_outl(0xb80c3a3c,0x00ffffff);
	...
	rtd_outl(0xb80c3a60,0x09840806);
	rtd_outl(0xb80c3a64,0x5a007f00);
	rtd_outl(0xb80c3a68,0x0fa03008);
	rtd_outl(0xb80c3a6c,0x43010061);

	rtd_outl(0xb80c3a80,0x09840806);
	rtd_outl(0xb80c3a84,0x00003f00);
	rtd_outl(0xb80c3a88,0x80040008);
	rtd_outl(0xb80c3a8c,0x23010031);

	rtd_outl(0xb80c3aa0,0x0984080e);
	rtd_outl(0xb80c3aa4,0x60007f00);
	rtd_outl(0xb80c3aa8,0x12c01008);
	rtd_outl(0xb80c3aac,0x43018081);

	rtd_outl(0xb80c3ac0,0x0984080e);
	rtd_outl(0xb80c3ac4,0x40007f00);
	rtd_outl(0xb80c3ac8,0x19001008);
	rtd_outl(0xb80c3acc,0x43018071);

	rtd_outl(0xb80c3ae0,0x09840802);
	rtd_outl(0xb80c3ae4,0x00003f00);
	rtd_outl(0xb80c3ae8,0x80018008);
	rtd_outl(0xb80c3aec,0x23018021);

	rtd_outl(0xb80c3b00,0x09840802);
	rtd_outl(0xb80c3b04,0x00001f00);
	rtd_outl(0xb80c3b08,0x80018008);
	rtd_outl(0xb80c3b0c,0x33018011);

	rtd_outl(0xb80c3b20,0x09840806);
	rtd_outl(0xb80c3b24,0x6e007f00);
	rtd_outl(0xb80c3b28,0x0fa03008);
	rtd_outl(0xb80c3b2c,0x43010061);

	rtd_outl(0xb80c3b40,0x09840806); // DIC suggests same as ch0
	rtd_outl(0xb80c3b44,0x5a007f00);
	rtd_outl(0xb80c3b48,0x0fa03008);
	rtd_outl(0xb80c3b4c,0x43010061);

	rtd_outl(0xb80c3b60,0x09840806); // DIC suggests same as ch6
	rtd_outl(0xb80c3b64,0x6e007f00);
	rtd_outl(0xb80c3b68,0x0fa03008);
	rtd_outl(0xb80c3b6c,0x43010061);
	...
	rtd_outl(0xb80c4b40,0x09840806); // DIC suggests same as ch0
	rtd_outl(0xb80c4b44,0x5a007f00);
	rtd_outl(0xb80c4b48,0x0fa03008);
	rtd_outl(0xb80c4b4c,0x43010061);

	rtd_outl(0xb80c4b60,0x09840806); // DIC suggests same as ch6
	rtd_outl(0xb80c4b64,0x6e007f00);
	rtd_outl(0xb80c4b68,0x0fa03008);
	rtd_outl(0xb80c4b6c,0x43010061);
	...
	rtd_outl(0xb80c5a20,0x00fa00fa);
	rtd_outl(0xb80c5a24,0x00180630);
	rtd_outl(0xb80c5a28,0x00000c0e);
	rtd_outl(0xb80c5a2c,0x001f0064);
	rtd_outl(0xb80c5a30,0x000f0007);
	rtd_outl(0xb80c5a34,0x03ff0000);
	rtd_outl(0xb80c5a3c,0x00ffffff);

	rtd_outl(0xb80c5a60,0x09840806);
	rtd_outl(0xb80c5a64,0x5a007f00);
	rtd_outl(0xb80c5a68,0x0fa03008);
	rtd_outl(0xb80c5a6c,0x43010061);

	rtd_outl(0xb80c5a80,0x09840806);
	rtd_outl(0xb80c5a84,0x00003f00);
	rtd_outl(0xb80c5a88,0x80040008);
	rtd_outl(0xb80c5a8c,0x23010031);

	rtd_outl(0xb80c5aa0,0x0984080e);
	rtd_outl(0xb80c5aa4,0x60007f00);
	rtd_outl(0xb80c5aa8,0x12c01008);
	rtd_outl(0xb80c5aac,0x43018081);

	rtd_outl(0xb80c5ac0,0x0984080e);
	rtd_outl(0xb80c5ac4,0x40007f00);
	rtd_outl(0xb80c5ac8,0x19001008);
	rtd_outl(0xb80c5acc,0x43018071);

	rtd_outl(0xb80c5ae0,0x09840802);
	rtd_outl(0xb80c5ae4,0x00003f00);
	rtd_outl(0xb80c5ae8,0x80018008);
	rtd_outl(0xb80c5aec,0x23018021);

	rtd_outl(0xb80c5b00,0x09840802);
	rtd_outl(0xb80c5b04,0x00001f00);
	rtd_outl(0xb80c5b08,0x80018008);
	rtd_outl(0xb80c5b0c,0x33018011);

	rtd_outl(0xb80c5b20,0x09840806);
	rtd_outl(0xb80c5b24,0x6e007f00);
	rtd_outl(0xb80c5b28,0x0fa03008);
	rtd_outl(0xb80c5b2c,0x43010061);

	rtd_outl(0xb80c5b40,0x09840806); // DIC suggests same as ch0
	rtd_outl(0xb80c5b44,0x5a007f00);
	rtd_outl(0xb80c5b48,0x0fa03008);
	rtd_outl(0xb80c5b4c,0x43010061);

	rtd_outl(0xb80c5b60,0x09840806); // DIC suggests same as ch6
	rtd_outl(0xb80c5b64,0x6e007f00);
	rtd_outl(0xb80c5b68,0x0fa03008);
	rtd_outl(0xb80c5b6c,0x43010061);
	...
	rtd_outl(0xb80c6a20,0x00fa00fa);
	rtd_outl(0xb80c6a24,0x00180630);
	rtd_outl(0xb80c6a28,0x00000c0e);
	rtd_outl(0xb80c6a2c,0x001f0064);
	rtd_outl(0xb80c6a30,0x000f0007);
	rtd_outl(0xb80c6a34,0x03ff0000);
	rtd_outl(0xb80c6a3c,0x00ffffff);

	rtd_outl(0xb80c6a60,0x09840806);
	rtd_outl(0xb80c6a64,0x5a007f00);
	rtd_outl(0xb80c6a68,0x0fa03008);
	rtd_outl(0xb80c6a6c,0x43010061);

	rtd_outl(0xb80c6a80,0x09840806);
	rtd_outl(0xb80c6a84,0x00003f00);
	rtd_outl(0xb80c6a88,0x80040008);
	rtd_outl(0xb80c6a8c,0x23010031);

	rtd_outl(0xb80c6aa0,0x0984080e);
	rtd_outl(0xb80c6aa4,0x60007f00);
	rtd_outl(0xb80c6aa8,0x12c01008);
	rtd_outl(0xb80c6aac,0x43018081);

	rtd_outl(0xb80c6ac0,0x0984080e);
	rtd_outl(0xb80c6ac4,0x40007f00);
	rtd_outl(0xb80c6ac8,0x19001008);
	rtd_outl(0xb80c6acc,0x43018071);

	rtd_outl(0xb80c6ae0,0x09840802);
	rtd_outl(0xb80c6ae4,0x00003f00);
	rtd_outl(0xb80c6ae8,0x80018008);
	rtd_outl(0xb80c6aec,0x23018021);

	rtd_outl(0xb80c6b00,0x09840802);
	rtd_outl(0xb80c6b04,0x00001f00);
	rtd_outl(0xb80c6b08,0x80018008);
	rtd_outl(0xb80c6b0c,0x33018011);

	rtd_outl(0xb80c6b20,0x09840806);
	rtd_outl(0xb80c6b24,0x6e007f00);
	rtd_outl(0xb80c6b28,0x0fa03008);
	rtd_outl(0xb80c6b2c,0x43010061);

	rtd_outl(0xb80c6b40,0x09840806); // DIC suggests same as ch0
	rtd_outl(0xb80c6b44,0x5a007f00);
	rtd_outl(0xb80c6b48,0x0fa03008);
	rtd_outl(0xb80c6b4c,0x43010061);

	rtd_outl(0xb80c6b60,0x09840806); // DIC suggests same as ch6
	rtd_outl(0xb80c6b64,0x6e007f00);
	rtd_outl(0xb80c6b68,0x0fa03008);
	rtd_outl(0xb80c6b6c,0x43010061);
	...
	rtd_outl(0xb80c7a20,0x00fa00fa);
	rtd_outl(0xb80c7a24,0x00180630);
	rtd_outl(0xb80c7a28,0x00000c0e);
	rtd_outl(0xb80c7a2c,0x001f0064);
	rtd_outl(0xb80c7a30,0x000f0007);
	rtd_outl(0xb80c7a34,0x03ff0000);
	rtd_outl(0xb80c7a3c,0x00ffffff);

	rtd_outl(0xb80c7a60,0x09840806);
	rtd_outl(0xb80c7a64,0x5a007f00);
	rtd_outl(0xb80c7a68,0x0fa03008);
	rtd_outl(0xb80c7a6c,0x43010061);

	rtd_outl(0xb80c7a80,0x09840806);
	rtd_outl(0xb80c7a84,0x00003f00);
	rtd_outl(0xb80c7a88,0x80040008);
	rtd_outl(0xb80c7a8c,0x23010031);

	rtd_outl(0xb80c7aa0,0x0984080e);
	rtd_outl(0xb80c7aa4,0x60007f00);
	rtd_outl(0xb80c7aa8,0x12c01008);
	rtd_outl(0xb80c7aac,0x43018081);

	rtd_outl(0xb80c7ac0,0x0984080e);
	rtd_outl(0xb80c7ac4,0x40007f00);
	rtd_outl(0xb80c7ac8,0x19001008);
	rtd_outl(0xb80c7acc,0x43018071);

	rtd_outl(0xb80c7ae0,0x09840802);
	rtd_outl(0xb80c7ae4,0x00003f00);
	rtd_outl(0xb80c7ae8,0x80018008);
	rtd_outl(0xb80c7aec,0x23018021);

	rtd_outl(0xb80c7b00,0x09840802);
	rtd_outl(0xb80c7b04,0x00001f00);
	rtd_outl(0xb80c7b08,0x80018008);
	rtd_outl(0xb80c7b0c,0x33018011);

	rtd_outl(0xb80c7b20,0x09840806);
	rtd_outl(0xb80c7b24,0x6e007f00);
	rtd_outl(0xb80c7b28,0x0fa03008);
	rtd_outl(0xb80c7b2c,0x43010061);

	rtd_outl(0xb80c7b40,0x09840806); // DIC suggests same as ch0
	rtd_outl(0xb80c7b44,0x5a007f00);
	rtd_outl(0xb80c7b48,0x0fa03008);
	rtd_outl(0xb80c7b4c,0x43010061);

	rtd_outl(0xb80c7b60,0x09840806); // DIC suggests same as ch6
	rtd_outl(0xb80c7b64,0x6e007f00);
	rtd_outl(0xb80c7b68,0x0fa03008);
	rtd_outl(0xb80c7b6c,0x43010061);
...
static int rtk_qos_load_mc_hdmi_2k_ddr4_setting(void)
{
	...
	rtd_outl(0xb80c3aa0,0x09840806);
	rtd_outl(0xb80c3aa4,0x60007f00);
	rtd_outl(0xb80c3aa8,0x12c00808);
	rtd_outl(0xb80c3aac,0x53018071);

	rtd_outl(0xb80c3ac0,0x0984080e);
	rtd_outl(0xb80c3ac4,0x40007f00);
	rtd_outl(0xb80c3ac8,0x0c800808);
	rtd_outl(0xb80c3acc,0x53018071);

	rtd_outl(0xb80c3ae0,0x09840802);
	rtd_outl(0xb80c3ae4,0x00003f00);
	rtd_outl(0xb80c3ae8,0x80018008);
	rtd_outl(0xb80c3aec,0x33018021);
...
static unsigned int rtk_bw_limit_HW_get_request_threshold(RTK_BRIG_T brig)
{
	...
	return rtd_inl(reg_request) & 0x00FFFFFF;
}
...
void rtk_qos_set_vdec_codec_type(int rtkvdec_codec_type)
{
	g_vdec_codec_type = rtkvdec_codec_type;
}
EXPORT_SYMBOL(rtk_qos_set_vdec_codec_type);

int rtk_qos_get_vdec_codec_type(void)
{
	return g_vdec_codec_type;
}
EXPORT_SYMBOL(rtk_qos_get_vdec_codec_type);
...
int rtk_qos_set_mode(RTK_QOS_MODE_T qos_mode)
{
	...
	switch(qos_mode){
		...
		case RTK_QOS_DECODER_8K_AV1_MODE:
			if (is_DDR4()) {
				// TODO: 8K AV1 QoS for DDR4
				rtk_qos_load_mc_decoder_4k_ddr4_setting();
			} else {
				rtk_qos_load_mc_decoder_8k_av1_setting();
			}
			break;
...
//			}
	...
	if (tmp_value)
	{
		if (qos_mode == RTK_QOS_DECODER_8K_AV1_MODE) {
			if (rtk_bw_limit_HW_get_request_threshold(RTK_BRIG_GPU) > tmp_value)
...
int rtk_qos_resume(void)
{
	...
	rtk_bw_limit_HW_set_threshold(RTK_BRIG_NNIP, 0x80, 0x10);
...
ssize_t rtk_qos_show(struct kobject *kobj, struct kobj_attribute *attr, char *buf)
{
	...
	else
	{
		...
		else if(g_rtk_qos_force_setting == RTK_QOS_DECODER_8K_AV1_MODE)
			return sprintf(buf, "current is force decode 8k av1 mode\n");
...
#define MC_MES_TOTAL_NUM 3
//#define MC_NUM_PER_MC_MES 2
...
static void rtk_qos_enable_client_measure(int mc_mes_idx)
{
	...
	// Force to set 1 (2MC only) on Mark2
...
int rtk_qos_bw_start_measure(unsigned int n_sec)
{
	...
	// Temp assume 3 mc measures are all used, but we can get mc measure number by below API
#ifdef RTK_SUPPORT_MULTIPLE_MC_MEASURES
	MC_MES_NUM = rtk_qos_get_mc_mes_number();
	if (MC_MES_NUM != MC_MES_TOTAL_NUM)
	{
		pr_warning("[MC_MES] MC_MES_NUM(%d) != MC_MES_TOTAL_NUM(%d)\n", MC_MES_NUM, MC_MES_TOTAL_NUM);
		rtk_qos_dump_dc_ib_region_mode(3); // dump IB_0 / IB_1 / IB_2 region mode
	}
#endif

	// check if need to release resource first
	if ((qos_bw_measure_p[0] != NULL)/* || (qos_bw_measure_p[1] != NULL) || (qos_bw_measure_p[2] != NULL)*/)
	{
	...
	if (buf != NULL)
	{
		...
		else if (strncmp(buf, "set", 3) == 0)
		{
			...
			if (mode != NULL)
			{
				...
				else if (strncmp(mode, "decode_5", 8) == 0)
				{
					return RTK_QOS_DECODER_8K_AV1_MODE; // decode mode
				}
