...
static int rtk_qos_save_mc_normal_setting(void)
{
	...
	// MC2
	g_rtk_qos_parameter[idx++] = rtd_inl(DC_MC2_MC_Qos_ctl_0_reg);
	g_rtk_qos_parameter[idx++] = rtd_inl(DC_MC2_MC_Qos_ctl_1_reg);
	g_rtk_qos_parameter[idx++] = rtd_inl(DC_MC2_MC_Qos_ctl_2_reg);
	g_rtk_qos_parameter[idx++] = rtd_inl(DC_MC2_MC_Qos_ctl_3_reg);
	g_rtk_qos_parameter[idx++] = rtd_inl(DC_MC2_MC_Qos_ctl_4_reg);
	g_rtk_qos_parameter[idx++] = rtd_inl(DC_MC2_MC_Qos_ctl_5_reg);
	g_rtk_qos_parameter[idx++] = rtd_inl(DC_MC2_MC_Qos_ctl_6_reg);
	g_rtk_qos_parameter[idx++] = rtd_inl(DC_MC2_MC_Qos_ctl_7_reg);
	g_rtk_qos_parameter[idx++] = rtd_inl(DC_MC2_MC_Qos_ctl_8_reg);
	g_rtk_qos_parameter[idx++] = rtd_inl(DC_MC2_MC_Qos_ctl_9_reg);
	g_rtk_qos_parameter[idx++] = rtd_inl(DC_MC2_MC_Qos_ctl_11_reg);
	g_rtk_qos_parameter[idx++] = rtd_inl(DC_MC2_MC_Qos_ctl_12_reg);

	for (ch_idx = 0; ch_idx < CHANNEL_NUM; ch_idx++)
	{
		for (ctl_idx = 0; ctl_idx < CTL_PER_CHANNEL; ctl_idx++)
		{
			g_rtk_qos_parameter[idx++] = rtd_inl(DC_MC2_MC_Qos_ch0_ctl_0_reg + ch_idx*CHANNEL_REGISTER_OFFSET + ctl_idx*CTL_REGISTER_OFFSET);
		}
	}
...
static int rtk_qos_load_mc_normal_setting(void)
{
	...
	// MC2
	rtd_outl(DC_MC2_MC_Qos_ctl_0_reg, g_rtk_qos_parameter[idx++]);
	rtd_outl(DC_MC2_MC_Qos_ctl_1_reg, g_rtk_qos_parameter[idx++]);
	rtd_outl(DC_MC2_MC_Qos_ctl_2_reg, g_rtk_qos_parameter[idx++]);
	rtd_outl(DC_MC2_MC_Qos_ctl_3_reg, g_rtk_qos_parameter[idx++]);
	rtd_outl(DC_MC2_MC_Qos_ctl_4_reg, g_rtk_qos_parameter[idx++]);
	rtd_outl(DC_MC2_MC_Qos_ctl_5_reg, g_rtk_qos_parameter[idx++]);
	rtd_outl(DC_MC2_MC_Qos_ctl_6_reg, g_rtk_qos_parameter[idx++]);
	rtd_outl(DC_MC2_MC_Qos_ctl_7_reg, g_rtk_qos_parameter[idx++]);
	rtd_outl(DC_MC2_MC_Qos_ctl_8_reg, g_rtk_qos_parameter[idx++]);
	rtd_outl(DC_MC2_MC_Qos_ctl_9_reg, g_rtk_qos_parameter[idx++]);
	rtd_outl(DC_MC2_MC_Qos_ctl_11_reg, g_rtk_qos_parameter[idx++]);
	rtd_outl(DC_MC2_MC_Qos_ctl_12_reg, g_rtk_qos_parameter[idx++]);

	for (ch_idx = 0; ch_idx < CHANNEL_NUM; ch_idx++)
	{
		for (ctl_idx = 0; ctl_idx < CTL_PER_CHANNEL; ctl_idx++)
		{
			rtd_outl(DC_MC2_MC_Qos_ch0_ctl_0_reg + ch_idx*CHANNEL_REGISTER_OFFSET + ctl_idx*CTL_REGISTER_OFFSET, g_rtk_qos_parameter[idx++]);
		}
	}
#endif
...
static int rtk_qos_load_mc_decoder_non_compress_setting(void)
{
	...
	rtd_outl(0xb80c3ae0,0x09840808);
	rtd_outl(0xb80c3ae4,0x00005000);
	rtd_outl(0xb80c3ae8,0x0800c808);
	rtd_outl(0xb80c3aec,0x23018061);

	rtd_outl(0xb80c3b00,0x09840808);
	rtd_outl(0xb80c3b04,0x00001f00);
	rtd_outl(0xb80c3b08,0x08010408);
	rtd_outl(0xb80c3b0c,0x23018061);
