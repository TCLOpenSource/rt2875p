...
#endif
	printk(KERN_EMERG"[rtk][gpu] ### alloc Memory %p size:0x%x (page_num:%d)...\n", fbi->video_info.videomemory, fbi->video_info.videomemorysize, fbi->video_info.videomemorysizeorder);
#ifdef NON_USE_DRV_MALLOC
...
static int venusfb_pan_display(struct fb_var_screeninfo *var, struct fb_info *info)
{
	...
	//printk(KERN_EMERG"[rtk][gpu] /#@# Pan Display Area...var x %d var y %d \n", var->xoffset, var->yoffset);
