 ...
 * Internal Used API
 */
static void __inline _rtk_gpio_disable_misc_irq(void)
{
    int i;
...
static void __inline _rtk_gpio_clear_misc_isr(void)
{
    int i;
