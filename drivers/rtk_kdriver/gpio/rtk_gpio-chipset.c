...
static struct gpio_chip g_rtk_gpio_chipsets[] =
{
...
#if defined(CONFIG_ARCH_RTK2885P)
    {
        ...
        .set              = gpio_ops_set,
        .dbg_show         = gpio_ops_dbg_show,
        .base             = ISO_GPIO_MIO_OFST,
        .ngpio            = ISO_GPIO_MIO_CNT,
        .can_sleep        = false,
    },
#endif
};
    ...
    )
{
    ...
    case MIO_GPIO: *gpio_num = MIO_GPIO_OFST; break;
#endif
#if defined(CONFIG_ARCH_RTK2885P)
    case ISO_GPIO_MIO: *gpio_num = ISO_GPIO_MIO_OFST; break;
#endif
    default:
        return -1;
    }
...
struct gpio_chip* get_gpio_chipset(RTK_GPIO_ID gid)
{
    RTK_GPIO_GROUP group = gpio_group(gid);
    unsigned int   gpio_base = MIS_GPIO_OFST;
    int i = 0;
...
#ifdef CONFIG_RTK_KDRV_MIO
    case MIO_GPIO: gpio_base = MIO_GPIO_OFST; break;
#endif
#if defined(CONFIG_ARCH_RTK2885P)
    case ISO_GPIO_MIO: gpio_base = ISO_GPIO_MIO_OFST; break;
#endif
    default:
        return NULL;
    }
...
#ifdef CONFIG_RTK_KDRV_MIO
    case MIO_GPIO_OFST: group = MIO_GPIO; break;
#endif
#if defined(CONFIG_ARCH_RTK2885P)
    case ISO_GPIO_MIO: group = ISO_GPIO_MIO_OFST; break;
#endif
    default:
        return -1;
    }
...
int __init rtk_gpio_register_gpio_chipset(void)
{
    ...
    for (i=0; i<RTK_GPIO_CHIPSET_CNT; i++){
        if(g_rtk_gpio_chipsets[i].ngpio > 0){
