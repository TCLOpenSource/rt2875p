...
int Comm_SendReadCommand(COMM* pCOMMKernel, unsigned char DeviceAddr, unsigned char* pRegisterAddr, unsigned char RegisterAddrSize, unsigned char* pReadingBytes,	unsigned char ByteNum, U32BITS Flags);
int Comm_SendWriteCommand(COMM* pCOMMKernel, unsigned char DeviceAddr, unsigned char* pWritingBytes, unsigned int ByteNum, U32BITS Flags);
