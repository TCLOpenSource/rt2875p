...
int REALTEK_H_DTMB_ScanSignal(DEMOD* pDemodKernel, S32BITS* offset, SCAN_RANGE range);
...
#define REALTEK_H_DTMB_DBG(fmt, args...)         rtd_demod_print(KERN_DEBUG,"Dtmb Debug, " fmt, ##args);
#define REALTEK_H_DTMB_INFO(fmt, args...)        rtd_demod_print(KERN_INFO,"Dtmb Info, " fmt, ##args);
#define REALTEK_H_DTMB_WARNING(fmt, args...)     rtd_demod_print(KERN_WARNING,"Dtmb Warning, " fmt, ##args);
