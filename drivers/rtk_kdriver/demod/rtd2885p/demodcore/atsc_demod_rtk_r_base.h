...
int main(void)
{
	...
	U32BITS ByteErrorRateNum, ByteErrorRateDen, PacketErrorRateNum, PacketErrorRateDen;
...
enum ATSC_REG_BIT_NAME {
	...
	ATSC_CR_LPF_SHIFT,
	ATSC_CR_PMU_COMP1,
	ATSC_CR_FMU_UPD_CNT_TH,
	ATSC_CR_CR2_CARB,
	ATSC_CR_CR2_CARB_WB,
	ATSC_CR_CR2_SWBW_COND_SEL,
	ATSC_CR_CR2_SWBW,
	...
	//dummy register
	Dummy_FAKE_PER_EN,
	Dummy_8051_PATCH_IND,
	Dummy_8051_STAY_CARB_NB_IND,
	Dummy_8051_CR_GL_DIFF_IND,
	Dummy_CHANGE_CHANNEL_IND,
	Dummy_8051_CR_SW_MODE_IND,
...
int atsc_rtd_4bytes_i2c_wr(ATSC_DEMOD_MODULE *pDemod, unsigned int addr, unsigned int data);
int atsc_rtd_4bytes_i2c_rd(ATSC_DEMOD_MODULE *pDemod, unsigned int addr, unsigned int* data);
int atsc_rtd_4bytes_i2c_mask(ATSC_DEMOD_MODULE *pDemod, unsigned int addr, unsigned int mask, unsigned int data);
...
#define REALTEK_R_ATSC_BASE_DBG(fmt, args...)          rtd_pr_demod_debug("ATSC_BASE_DEBUG, " fmt, ##args);
#define REALTEK_R_ATSC_BASE_INFO(fmt, args...)       rtd_pr_demod_info("ATSC_BASE_INFO, " fmt, ##args);
#define REALTEK_R_ATSC_BASE_WARNING(fmt, args...)    rtd_pr_demod_warn("ATSC_BASE_WARNING, " fmt, ##args);
