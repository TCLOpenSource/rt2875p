...
void drv_ifd_loop2_agcin_kpki_settings(UINT8 agc_in_kp, UINT8 agc_in_ki, UINT8 agc_in_kp_shift, UINT8 agc_in_ki_shift)
{
	...
	agc_in_kp_ki_rbus_data.agc_in_kp_sshift = agc_in_kp_shift;
	agc_in_kp_ki_rbus_data.agc_in_ki_sshift = agc_in_ki_shift;
...
UINT8 drv_ifd_agc_loop2_kishift_settings_get_info(void)
{
	...
	agc_in_kp_ki_rbus_data.regValue = rtd_inl(IFD_108_agc_in_kp_ki_reg);
	return (agc_in_kp_ki_rbus_data.agc_in_ki_sshift);
}
/*=============================================================*/
/**
...
UINT8 drv_ifd_agc_loop2_kpshift_settings_get_info(void)
{
	...
	agc_in_kp_ki_rbus_data.regValue = rtd_inl(IFD_108_agc_in_kp_ki_reg);
	return (agc_in_kp_ki_rbus_data.agc_in_kp_sshift);
}
/*=============================================================*/
/**
...
void drv_ifd_agc_set_peak_slowcharge_val(UINT8 value)
{
	ifd_108_agc_max_countforcoarsemode_agc_cntl1_RBUS agc_max_countforcoarsemode_agc_cntl1_rbus_data;

	agc_max_countforcoarsemode_agc_cntl1_rbus_data.regValue = rtd_inl(IFD_108_agc_max_countforcoarsemode_agc_cntl1_reg);
	agc_max_countforcoarsemode_agc_cntl1_rbus_data.agc_peak_slow_charge_value = value;
	rtd_outl(IFD_108_agc_max_countforcoarsemode_agc_cntl1_reg, agc_max_countforcoarsemode_agc_cntl1_rbus_data.regValue);
}

void drv_ifd_agc_loop1_peak_cnt(UINT16 agc_peak_cnt)
{
	ifd_108_agc_peak_detect_RBUS agc_peak_detect_rbus_data;

	agc_peak_detect_rbus_data.regValue = rtd_inl(IFD_108_agc_peak_detect_reg);
	agc_peak_detect_rbus_data.agc_peak_cnt = agc_peak_cnt;
	rtd_outl(IFD_108_agc_peak_detect_reg, agc_peak_detect_rbus_data.regValue);
}
