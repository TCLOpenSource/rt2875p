...
enum ISDBT_REG_BIT_NAME {
	...
	// Private
	//ISDBT_PRIVATE_0,//rm 0xe74d = 18159D34~9d40
...
typedef struct RTK_R_ISDBT_MPEG_TS_MODE_STRUCT {
...
} RTK_R_ISDBT_MPEGTSMode;

typedef struct RTK_R_ISDBT_TUNER_CONFIG_STRUCT {
...
} RTK_R_ISDBT_TUNER_INPUT_T;

/*******************Tuner's AGC polarity inverted or normal**************/
#define   RTK_A_ISDBT_IF_AGC_POLARITY_INVERTED      1
#define   RTK_A_ISDBT_IF_AGC_POLARITY_NORMAL        0

typedef struct RTK_R_ISDBT_CONFIG_STRUCT {
	/**************Common setting*******************************************/
	RTK_R_ISDBT_MPEGTSMode stMPEGTSMode;      /*TS interface configuration	*/
	...
	RTK_R_ISDBT_TUNER_INPUT_T IsdbtTunerInput; /*DVB-T and DVB-T2 only*/
} stRtkrIsdbtConfig;
...
struct ISDBT_DEMOD_MODULE_TAG {
	...
	ISDBT_DEMOD_FP_SET_AGC_POL                  SetAgcPol;
...
unsigned int RTK_R_ISDBT_Log10ConvertdBx10(unsigned int i32InValue);
...
#define RTK_DEMOD_ISDBT_CALLER(fmt, args...)     rtd_demod_print(KERN_DEBUG,"CALLER, " fmt, ##args);
#define RTK_DEMOD_ISDBT_DBG(fmt, args...)        rtd_demod_print(KERN_DEBUG,"Debug, " fmt, ##args);
#define RTK_DEMOD_ISDBT_INFO(fmt, args...)       rtd_demod_print(KERN_INFO,"Info, " fmt, ##args);
#define RTK_DEMOD_ISDBT_WARNING(fmt, args...)    rtd_demod_print(KERN_WARNING,"Warning, " fmt, ##args);
