...
#include "demodcomm/kadp_audio_atv.h"
#else
...
#define IFD_GROUPDELAY_TABLE_BG_ATBM253  \
{  \
              0x00B, 0x7E5, 0x038, 0x7A7,   \
              0x082, 0x756, 0x0C7, 0x738,   \
              0x0B3, 0x785, 0x032, 0x014,   \
              0x7B2, 0x05F, 0x77F, 0x7C1,   \
              0x030, 0x205, 0x285, 0x75C,   \
              0x7DF, 0x0F7, 0x76B, 0x01C,   \
              0x055, 0x79D, 0x03C, 0x7FF,   \
              0x7D5, 0x02F, 0x7E5, 0x7FF,   \
              0x014,   \
}
...
#define IFD_GROUPDELAY_TABLE_BG_R840 \
{	\
	0x001, 0x7F6, 0x021, 0x7E1,   \
	0x063, 0x734, 0x0D7, 0x77C,   \
	0x35A, 0x167, 0x717, 0x044,   \
	0x03E, 0x7C4, 0x7F8, 0x009,   \
	0x7FD, 0x7FF, 0x000, 0x001,   \
	0x000, 0x7FF, 0x000, 0x000,   \
	0x000, 0x000, 0x000, 0x000,   \
	0x000, 0x000, 0x000, 0x000,   \
	0x000,   \
...
#define IFD_GROUPDELAY_TABLE_I_ATBM253 \
{  \
	0x00F, 0x7DF, 0x042, 0x797,   \
	0x096, 0x747, 0x0CE, 0x739,   \
	0x0A2, 0x79D, 0x016, 0x032,   \
	0x798, 0x071, 0x7A1, 0x019,   \
	0x7D8, 0x791, 0x2AE, 0x222,   \
	0x772, 0x032, 0x052, 0x7BB,   \
	0x02C, 0x002, 0x7EC, 0x018,   \
	0x7F3, 0x002, 0x007, 0x7F7,   \
	0x006,   \
}
...
#define IFD_GROUPDELAY_TABLE_DK_R840  \
{  \
	0x012, 0x7E8, 0x03D, 0x7A5,   \
	0x09A, 0x735, 0x13B, 0x6DF,   \
	0x1EC, 0x2DB, 0x7F1, 0x798,   \
	0x009, 0x7F1, 0x000, 0x7FD,   \
	0x7F9, 0x7FD, 0x7FB, 0x7FF,   \
...
#define IFD_GROUPDELAY_TABLE_DK_ATBM253  \
       {  \
              0x006, 0x7EF, 0x022, 0x7C2,   \
              0x064, 0x776, 0x0B0, 0x73D,   \
              0x0C5, 0x75B, 0x073, 0x7CD,   \
              0x7EB, 0x054, 0x780, 0x062,   \
              0x724, 0x053, 0x339, 0x0FE,   \
              0x7AA, 0x08C, 0x7F8, 0x7F4,   \
              0x024, 0x7E7, 0x010, 0x000,   \
              0x7F4, 0x00B, 0x7F8, 0x7FF,   \
              0x003,   \
       }
...
#define IFD_GROUPDELAY_TABLE_I_R840  \
{  \
	0x00D, 0x7EC, 0x035, 0x7B0,   \
	0x091, 0x740, 0x133, 0x6C5,   \
	0x207, 0x2CA, 0x7F6, 0x7AB,   \
	0x007, 0x7EE, 0x7FE, 0x7FD,   \
	0x7FA, 0x7FF, 0x7FD, 0x7FF,   \
	0x001, 0x000, 0x000, 0x000,   \
	0x000, 0x000, 0x000, 0x000,   \
	0x000, 0x000, 0x000, 0x000,   \
	0x000,   \
...
#define IFD_GROUPDELAY_TABLE_MN_ATBM253                           \
		   {  \
              0x025, 0x7B2, 0x08F, 0x737,   \
              0x0F5, 0x713, 0x0BB, 0x7A8,   \
              0x7F9, 0x059, 0x78C, 0x060,   \
              0x7F0, 0x7BC, 0x061, 0x7C5,   \
              0x7D7, 0x7F5, 0x0AB, 0x2B9,   \
              0x16B, 0x706, 0x033, 0x094,   \
              0x774, 0x019, 0x04D, 0x7AB,   \
              0x00F, 0x025, 0x7D2, 0x00A,   \
              0x00B,   \
           }
...
#define IFD_GROUPDELAY_TABLE_M_R840  \
{  \
	0x006, 0x7DA, 0x03F, 0x7E9,   \
	0x05F, 0x776, 0x112, 0x6AE,   \
	0x29F, 0x25D, 0x7CA, 0x7D3,   \
	0x7EB, 0x000, 0x7EA, 0x7DB,   \
	0x00C, 0x00E, 0x7FE, 0x7FF,   \
	0x001, 0x002, 0x7FF, 0x7FF,   \
	0x000, 0x000, 0x000, 0x000,   \
	0x000, 0x000, 0x000, 0x000,   \
	0x000,   \
}
...
#define IFD_EQ_TABLE_NTSC_ATBM253 \
       {  \
              0x000, 0x000, 0x000, 0x000,   \
              0x000, 0x000, 0x001, 0x001,   \
              0x000, 0x000, 0x002, 0x000,   \
              0x000, 0x001, 0x001, 0x3ff,   \
              0x001, 0x002, 0x3ff, 0x3ff,   \
              0x003, 0x000, 0x3fc, 0x005,   \
              0x007, 0x3f2, 0x3ff, 0x017,   \
              0x3ef, 0x3d9, 0x088, 0x12a,   \
       }
...
#define IFD_EQ_TABLE_PALBG_R840 \
{  \
	0x001, 0x3fe, 0x001, 0x000,   \
	0x3ff, 0x3ff, 0x002, 0x000,   \
	0x000, 0x000, 0x001, 0x3ff,   \
	0x001, 0x3ff, 0x000, 0x000,   \
	0x001, 0x3fd, 0x003, 0x001,   \
	0x3fe, 0x3fd, 0x006, 0x3f9,   \
	0x002, 0x001, 0x006, 0x3f5,   \
	0x031, 0x39d, 0x03a, 0x1fd,   \
}
...
#define IFD_EQ_TABLE_PALI_R840 \
{  \
	0x000, 0x3ff, 0x001, 0x000,   \
	0x000, 0x000, 0x000, 0x3ff,   \
	0x000, 0x001, 0x000, 0x3ff,   \
	0x001, 0x000, 0x001, 0x001,   \
	0x000, 0x3fe, 0x000, 0x000,   \
	0x000, 0x001, 0x002, 0x3fd,   \
	0x000, 0x001, 0x003, 0x3ff,   \
	0x00d, 0x3df, 0x010, 0x1fe,   \
}
...
#define IFD_EQ_TABLE_PALDKL_R840 \
{  \
	0x001, 0x3ff, 0x001, 0x001,   \
	0x3ff, 0x3ff, 0x001, 0x000,   \
	0x000, 0x000, 0x000, 0x000,   \
	0x000, 0x3ff, 0x001, 0x001,   \
	0x000, 0x3fe, 0x001, 0x001,   \
	0x000, 0x3ff, 0x001, 0x3fd,   \
	0x000, 0x002, 0x007, 0x002,   \
	0x00c, 0x3e1, 0x009, 0x1ff,   \
}
...
#define IFD_EQ_TABLE_NTSC_R840 \
{  \
	0x000, 0x000, 0x000, 0x000,   \
	0x000, 0x000, 0x000, 0x001,   \
	0x000, 0x000, 0x001, 0x001,   \
	0x000, 0x3ff, 0x3ff, 0x002,   \
	0x000, 0x3fd, 0x001, 0x000,   \
	0x3ff, 0x001, 0x3ff, 0x003,   \
	0x006, 0x3f4, 0x007, 0x025,   \
	0x3d2, 0x3b2, 0x0a4, 0x164,   \
}
...
#define IFD_EQ_TABLE_PALBG_ATBM253 \
       {  \
       0x002, 0x3fe, 0x001, 0x001,   \
       0x3fd, 0x002, 0x000, 0x3fd,   \
       0x003, 0x3fe, 0x3fe, 0x004,   \
       0x3fc, 0x000, 0x004, 0x3fa,   \
       0x003, 0x002, 0x3f9, 0x007,   \
       0x3fe, 0x3fa, 0x00d, 0x3f6,   \
       0x000, 0x012, 0x3eb, 0x008,   \
       0x01b, 0x3c0, 0x071, 0x163,   \
        }
...
#define IFD_EQ_TABLE_PALI_ATBM253 \
	{  \
              0x001, 0x000, 0x000, 0x001,   \
              0x000, 0x000, 0x001, 0x3ff,   \
              0x001, 0x000, 0x3ff, 0x001,   \
              0x000, 0x3ff, 0x002, 0x3fe,   \
              0x001, 0x001, 0x3fe, 0x002,   \
              0x002, 0x3fb, 0x007, 0x3fe,   \
              0x3fe, 0x005, 0x004, 0x3ef,   \
              0x024, 0x3cf, 0x04b, 0x18c,   \
        }
...
#define IFD_EQ_TABLE_PALDK_ATBM253 \
	{  \
			0x001, 0x3ff, 0x001, 0x000,   \
			0x3ff, 0x001, 0x3ff, 0x3ff,   \
			0x002, 0x3fe, 0x000, 0x001,   \
			0x3fe, 0x001, 0x001, 0x3fe,   \
			0x003, 0x3ff, 0x3ff, 0x003,   \
			0x3ff, 0x3fe, 0x007, 0x3fa,   \
			0x002, 0x007, 0x3fe, 0x3fd,   \
			0x01d, 0x3cd, 0x058, 0x170,   \
        }
...
{									\
	...
	{								\
			rtd_pr_demod_info("[IFD_DEBUG][INFO], " string, ##args);				\
	}\
		if(ifd_level==IFD_MSG_TUNER)	\
		{								\
			rtd_pr_demod_info("[IFD_DEBUG][TUNER]" string, ##args);				\
		}								\
		if(ifd_level==IFD_MSG_SCANCH)	\
		{								\
			rtd_pr_demod_info("[IFD_DEBUG][SCAN_CH]" string, ##args);				\
		}								\
		if(ifd_level==IFD_MSG_SETCH)	\
		{								\
			rtd_pr_demod_info("[IFD_DEBUG][SET_CH]" string, ##args);				\
		}								\
		...
		{								\
			rtd_pr_demod_info("[IFD_DEBUG][AFC]" string, ##args);				\
		}								\
		if(ifd_level==IFD_MSG_ADAPTIVE_TARGET)	\
		{								\
			rtd_pr_demod_info("[IFD_DEBUG][ADAPTIVE_TARGET]" string, ##args);				\
		}								\
		if(ifd_level==IFD_MSG_CR_STATE)	\
		{								\
			rtd_pr_demod_info("[IFD_DEBUG][CR_STATE]" string, ##args);				\
		}								\
		if(ifd_level==IFD_MSG_STRONG_SIGNAL)	\
		{								\
			rtd_pr_demod_info("[IFD_DEBUG][STRONG_SIGNAL]" string, ##args);				\
		}								\
		if(ifd_level==IFD_MSG_DUMP_REG)	\
		{								\
			rtd_pr_demod_info("[IFD_DEBUG][DUMP_REG]" string, ##args);				\
		}								\
		if(ifd_level==IFD_MSG_AGC_VAR)	\
		{								\
			rtd_pr_demod_info("[IFD_DEBUG][AGC_VAR]" string, ##args);				\
		}								\
		if(ifd_level==IFD_MSG_INIT)	\
		{								\
			rtd_pr_demod_info("[IFD_DEBUG][INIT]" string, ##args);				\
		}								\
		if(ifd_level==IFD_MSG_OTHERS)	\
		{								\
			rtd_pr_demod_info("[IFD_DEBUG][OTHERS]" string, ##args);				\
		}								\
}
