...
#define IFD_DOWN_SAMPLE_FILTER_TABLE_SIZE 18
...
// SI2178B extra module
typedef struct SI2178B_EXTRA_MODULE_TAG SI2178B_EXTRA_MODULE;

// SI2178B bandwidth mode setting function pointer
typedef UINT8
(*SI2178B_FP_SET_STANDARD_MODE)(
	ATV_TUNER_MODULE *pTuner,
	TUNER_ATV_VIDEO_MODE video_mode, 
	TUNER_ATV_AUDIO_MODE audio_mode
	);

// SI2178B bandwidth mode getting function pointer
typedef int
(*SI2178B_FP_GET_STANDARD_BANDWIDTH_MODE)(
	ATV_TUNER_MODULE *pTuner,
	int *pStandardBandwidthMode
	);

typedef void
(*SI2178B_FP_SET_STANDARD_BANDWIDTH_MODE)(
	UINT8 set_bandwidth
	);

// SI2178B power mode setting function pointer
typedef int
(*SI2178B_FP_SET_POWER_MODE)(
	ATV_TUNER_MODULE *pTuner,
	int PowerMode
	);

// SI2178B power mode getting function pointer
typedef int
(*SI2178B_FP_GET_POWER_MODE)(
	ATV_TUNER_MODULE *pTuner,
	int *pPowerMode
	);

// SI2178B IF frequency getting function pointer
typedef int
(*SI2178B_FP_GET_IF_FREQ_HZ)(
	ATV_TUNER_MODULE *pTuner,
	U32BITS *pIfFreqHz
	);

typedef void 
(*SI2178B_FP_GET_RF_STREGTH)(
	int *TuneComplete, 
	int *InputLevel, 
	int *AtvTunerLockStatus, 
	int *AtvOffset);
...
typedef void 
(*SI2178B_FP_SET_LNA_ONOFF)(
	bool enable);

typedef int
(*SI2178B_FP_GET_ATV_AGC_SPEED)(
	ATV_TUNER_MODULE *pTuner, 
	int *pStandardAGCSPEED);

typedef void 
(*SI2178B_FP_SET_ATV_AGC_SPEED)(
	UINT8 agc_speed_mode);

typedef void 
(*SI2178B_FP_SET_ATV_RF_AGC_TOP)(
	UINT8 rf_agc_top_mode);

typedef  int 
(*SI2178B_FP_GET_ATV_RF_AGC_TOP)(
	ATV_TUNER_MODULE *pTuner, int *pStandardRFTOP);

typedef void 
(*SI2178B_FP_SET_ATV_IF_PORT_AUXIF_AGC)(
	UINT8 if_port_auxif_agc_mode);

typedef int  
(*SI2178B_FP_GET_ATV_IF_PORT_AUXIF_AGC)(
ATV_TUNER_MODULE *pTuner, int *pStandardAUXIFAGC);

typedef void 
(*SI2178B_FP_SET_ATV_IF_OUTPUT_AMP)(
	UINT8 if_output_amp_value);

typedef int  
(*SI2178B_FP_GET_ATV_IF_OUTPUT_AMP)(
ATV_TUNER_MODULE *pTuner, int *pStandardAmpValue);

typedef void 
(*SI2178B_FP_SET_ATV_AFC_ENABLE)(
	bool enable);

typedef int  
(*SI2178B_FP_GET_ATV_AFC_ENABLE)(
bool *enable);

typedef int
(*SI2178B_FP_GET_ATV_TUNER_INIT_RESULT)(
	ATV_TUNER_MODULE *pTuner, 
	int *pTuner_Init_Result);

// SI2178B extra module
struct SI2178B_EXTRA_MODULE_TAG
{
	// SI2178B extra variables
	U32BITS CrystalFreqHz;
	int UnitNo;
	int IfOutputVppMode;
	int StandardBandwidthMode;
	...
	UINT8 if_output_amp_value;
	int pStandardAmpValue;
	// SI2178B extra function pointers
	SI2178B_FP_SET_STANDARD_MODE   SetStandardMode;
	SI2178B_FP_GET_STANDARD_BANDWIDTH_MODE   GetStandardBandwidthMode;
	SI2178B_FP_SET_STANDARD_BANDWIDTH_MODE   SetStandardBandwidthMode;
	SI2178B_FP_SET_POWER_MODE                SetPowerMode;
	SI2178B_FP_GET_POWER_MODE                GetPowerMode;
	SI2178B_FP_GET_RF_STREGTH		  GetRfStregth;
	SI2178B_FP_SET_LNA_ONOFF				SetLNAOnOff;
	SI2178B_FP_SET_ATV_AGC_SPEED	SetATVAgcSpeed;
	SI2178B_FP_GET_ATV_AGC_SPEED	GetATVAgcSpeed;
	SI2178B_FP_SET_ATV_RF_AGC_TOP       SetATVRFAgcTop;
	SI2178B_FP_GET_ATV_RF_AGC_TOP       GetATVRFAgcTop;
	SI2178B_FP_SET_ATV_IF_PORT_AUXIF_AGC	 SetATVIFPAUXIFAGC;
	SI2178B_FP_GET_ATV_IF_PORT_AUXIF_AGC GetATVIFPAUXIFAGC;
	SI2178B_FP_SET_ATV_IF_OUTPUT_AMP		SetATVIFPOUTPUTAMP;
	SI2178B_FP_GET_ATV_IF_OUTPUT_AMP 	GetATVIFPOUTPUTAMP;
	SI2178B_FP_SET_ATV_AFC_ENABLE		SetATVAfcEnable;
	SI2178B_FP_GET_ATV_AFC_ENABLE 		GetATVAfcEnable;
	SI2178B_FP_GET_ATV_TUNER_INIT_RESULT GetATVTunerInitResult;
};
