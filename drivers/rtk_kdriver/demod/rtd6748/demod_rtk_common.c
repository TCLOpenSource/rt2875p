...
void DemodAdcSetting(RTK_DEMOD_MODE mode)
{
	...
	rtd_maskl(0xb8033120, 0xfffffffe, 0x00000001);		//IF ADC GAIN FIX EN <bit0>= 1(Internal Demod IQ mode)
	rtd_maskl(0xb803312c, 0xffeecc00, 0x00000000);		//<bit20>Q single_end=0x0, <bit16>I single_end=0, <bit13:12>Q_CKIN_Sel=00(from PLL27x_IFADC), <bit9:8>I_CKIN_Sel=00: From PLL27X_IFADC, <bit7:4>reg_qpga_d=0x0(0dB), <bit3:0>reg_ipga_d=0x0(0dB)
	rtd_outl(0xb803311c, 0x0a000a00);					//QADC_CAPCAL<11:9>=101 / IADC_CAPCAL<11:9>=101 for IDNL measurement
...
int IQAdcLdoSetting(void)
{
    ...
    if(Iotp==1){
	    ...
	    rtd_maskl(TV_SB1_ANA_IQADC_CTRL7_reg, ~TV_SB1_ANA_IQADC_CTRL7_reg_iadc_ldo_sel_mask, TV_SB1_ANA_IQADC_CTRL7_reg_iadc_ldo_sel(1));   //IADC_LDO_set default
    }
    ...
    if(Qotp==1){
	    ...
	    rtd_maskl(TV_SB1_ANA_IQADC_CTRL7_reg, ~TV_SB1_ANA_IQADC_CTRL7_reg_qadc_ldo_sel_mask, TV_SB1_ANA_IQADC_CTRL7_reg_qadc_ldo_sel(1));   //QADC_LDO_set default
    }
