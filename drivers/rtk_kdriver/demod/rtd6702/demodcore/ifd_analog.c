...
{
#if 0
	//Video DAC default setting 
	rtd_outl(TV_SB1_ANA_APLL_ADC_VADC_IDACO_CTRL0_reg, 0x00000302);
	//Video DAC power on
	rtd_maskl(TV_SB1_ANA_APLL_ADC_VADC_IDACO_CTRL0_reg , 0xFFFEFFEF, 0x00010010);
#endif	
	return;
}
