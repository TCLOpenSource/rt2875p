...
static const REG_VALUE_ENTRY R84x_OPT_VALUE_ATSC[] = {
	// RegBitName,				Value
	{ATSC_IF_AGC_MAX,				0x38		},// IFAGC Max=2.4V
	{ATSC_IF_AGC_MIN,				0x9e		},// IFAGC Min=0.4V
	{ATSC_AAGC_TARGET,				0x2b		},// default 0x2d
};
