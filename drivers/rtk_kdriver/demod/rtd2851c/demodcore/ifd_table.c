...
void drv_ifd_eq_init(unsigned short  tuner_id)
{
    ...
    */
	...
	case TV_TUNER_MAXLINEAR_MXL661:
     {
		StructEQNotch stEqNotchNtsc[] = {
			{IFD_ENABLE, IFD_EQ_TABLE_NTSC_MXL661},
		};
		StructEQNotch stEqNotchPalBG[] = {
			{IFD_ENABLE, IFD_EQ_TABLE_PALBG_MXL661},
		};
		StructEQNotch stEqNotchPalI[] = {
			{IFD_ENABLE, IFD_EQ_TABLE_PALI_MXL661},
		};
		StructEQNotch stEqNotchPalDK[] = {
			{IFD_ENABLE, IFD_EQ_TABLE_PALDK_MXL661},
		};
		StructEQNotch stEqNotchSecamL[] = {
			{IFD_ENABLE, IFD_EQ_TABLE_PALDK_MXL661},
		};
	...
	case TV_TUNER_ALTOBEAM_ATBM253: {
		...
		StructEQNotch stEqNotchNtsc[] = {
			{IFD_ENABLE, IFD_EQ_TABLE_NTSC_ATBM253},
		};
		StructEQNotch stEqNotchPalBG[] = {
			{IFD_ENABLE, IFD_EQ_TABLE_PALBG_ATBM253},
		};
		StructEQNotch stEqNotchPalI[] = {
			{IFD_ENABLE, IFD_EQ_TABLE_PALI_ATBM253},
		};
		StructEQNotch stEqNotchPalDK[] = {
			{IFD_ENABLE, IFD_EQ_TABLE_PALDK_ATBM253},
		};
		StructEQNotch stEqNotchSecamL[] = {
			{IFD_ENABLE, IFD_EQ_TABLE_PALDK_ATBM253},
		};
	...
	{
		StructEQNotch stEqNotchNtsc[] = {
			{IFD_ENABLE, IFD_EQ_TABLE_NTSC_SUTRX243},
		};
		StructEQNotch stEqNotchPalBG[] = {
			{IFD_ENABLE, IFD_EQ_TABLE_PAL_BG_SUTRX243},
		};
		StructEQNotch stEqNotchPalI[] = {
			{IFD_ENABLE, IFD_EQ_TABLE_PAL_I_SUTRX243},
		};
		StructEQNotch stEqNotchPalDK[] = {
			{IFD_ENABLE, IFD_EQ_TABLE_PAL_DK_SUTRX243},
		};
		StructEQNotch stEqNotchSecamL[] = {
			{IFD_ENABLE, IFD_EQ_TABLE_PAL_DK_SUTRX243},
		};
	...
	{
		StructEQNotch stEqNotchNtsc[] = {
			{IFD_ENABLE, IFD_EQ_TABLE_NTSC_SUTRX243_RA},
		};
		StructEQNotch stEqNotchPalBG[] = {
			{IFD_ENABLE, IFD_EQ_TABLE_PAL_BG_SUTRX243_RA},
		};
		StructEQNotch stEqNotchPalI[] = {
			{IFD_ENABLE, IFD_EQ_TABLE_PAL_I_SUTRX243_RA},
		};
		StructEQNotch stEqNotchPalDK[] = {
			{IFD_ENABLE, IFD_EQ_TABLE_PAL_DK_SUTRX243_RA},
		};
		StructEQNotch stEqNotchSecamL[] = {
			{IFD_ENABLE, IFD_EQ_TABLE_PAL_DK_SUTRX243},
		};
	...
	case TV_TUNER_RAFAEL_R842: {
		...
		StructEQNotch stEqNotchNtsc[] = {
			{IFD_ENABLE, IFD_EQ_TABLE_NTSC_R840},
		};
		StructEQNotch stEqNotchPalBG[] = {
			{IFD_ENABLE, IFD_EQ_TABLE_PALBG_R840},
		};
		StructEQNotch stEqNotchPalI[] = {
			{IFD_ENABLE, IFD_EQ_TABLE_PALI_R840},
		};
		StructEQNotch stEqNotchPalDK[] = {
			{IFD_ENABLE, IFD_EQ_TABLE_PALDKL_R840},
		};
		StructEQNotch stEqNotchSecamL[] = {
			{IFD_ENABLE, IFD_EQ_TABLE_PALDKL_R840},
		};
...
*/
	...
	case TV_TUNER_MAXLINEAR_MXL661:
     {
		StructGroupDelay stStructGroupDelayM[] = {
			{IFD_ENABLE, IFD_GROUPDELAY_TABLE_MN_MXL661},
		};
		StructGroupDelay stStructGroupDelayN[] = {
			{IFD_ENABLE, IFD_GROUPDELAY_TABLE_MN_MXL661},
		};
		StructGroupDelay stStructGroupDelayBG[] = {
			{IFD_ENABLE, IFD_GROUPDELAY_TABLE_BG_MXL661},
		};
		StructGroupDelay stStructGroupDelayI[] = {
			{IFD_ENABLE, IFD_GROUPDELAY_TABLE_I_MXL661},
		};
		StructGroupDelay stStructGroupDelayDK[] = {
			{IFD_ENABLE, IFD_GROUPDELAY_TABLE_DK_MXL661},
		};
		StructGroupDelay stStructGroupDelayL[] = {
			{IFD_ENABLE, IFD_GROUPDELAY_TABLE_DK_MXL661},
		};
	...
	case TV_TUNER_ALTOBEAM_ATBM253: 
     {		
		StructGroupDelay stStructGroupDelayM[] = {
			{IFD_ENABLE, IFD_GROUPDELAY_TABLE_MN_ATBM253},
		};
		StructGroupDelay stStructGroupDelayN[] = {
			{IFD_ENABLE, IFD_GROUPDELAY_TABLE_MN_ATBM253},
		};
		StructGroupDelay stStructGroupDelayBG[] = {
			{IFD_ENABLE, IFD_GROUPDELAY_TABLE_BG_ATBM253},
		};
		StructGroupDelay stStructGroupDelayI[] = {
			{IFD_ENABLE, IFD_GROUPDELAY_TABLE_I_ATBM253},
		};
		StructGroupDelay stStructGroupDelayDK[] = {
			{IFD_ENABLE, IFD_GROUPDELAY_TABLE_DK_ATBM253},
		};
		StructGroupDelay stStructGroupDelayL[] = {
			{IFD_ENABLE, IFD_GROUPDELAY_TABLE_DK_ATBM253},
		};
	...
	{
		StructGroupDelay stStructGroupDelayM[] = {
			{IFD_ENABLE, IFD_GROUPDELAY_TABLE_M_SUTRX243},
		};
		StructGroupDelay stStructGroupDelayN[] = {
			{IFD_ENABLE, IFD_GROUPDELAY_TABLE_N},
		};
		StructGroupDelay stStructGroupDelayBG[] = {
			{IFD_ENABLE, IFD_GROUPDELAY_TABLE_BG_SUTRX243},
		};
		StructGroupDelay stStructGroupDelayI[] = {
			{IFD_ENABLE, IFD_GROUPDELAY_TABLE_I_SUTRX243},
		};
		StructGroupDelay stStructGroupDelayDK[] = {
			{IFD_ENABLE, IFD_GROUPDELAY_TABLE_DK_SUTRX243},
		};
		StructGroupDelay stStructGroupDelayL[] = {
			{IFD_ENABLE, IFD_GROUPDELAY_TABLE_DK_RE232TN},
		};
		StructGroupDelay stStructGroupDelayLA[] = {
			{IFD_ENABLE, IFD_GROUPDELAY_TABLE_DK_RE232TN},
		};
	...
	{
		StructGroupDelay stStructGroupDelayM[] = {
			{IFD_ENABLE, IFD_GROUPDELAY_TABLE_M_SUTRX243_RA},
		};
		StructGroupDelay stStructGroupDelayN[] = {
			{IFD_ENABLE, IFD_GROUPDELAY_TABLE_N},
		};
		StructGroupDelay stStructGroupDelayBG[] = {
			{IFD_ENABLE, IFD_GROUPDELAY_TABLE_BG_SUTRX243_RA},
		};
		StructGroupDelay stStructGroupDelayI[] = {
			{IFD_ENABLE, IFD_GROUPDELAY_TABLE_I_SUTRX243_RA},
		};
		StructGroupDelay stStructGroupDelayDK[] = {
			{IFD_ENABLE, IFD_GROUPDELAY_TABLE_DK_SUTRX243_RA},
		};
		StructGroupDelay stStructGroupDelayL[] = {
			{IFD_ENABLE, IFD_GROUPDELAY_TABLE_DK_RE232TN},
		};
	...
	case TV_TUNER_RAFAEL_R842: {
		...
		StructGroupDelay stStructGroupDelayM[] = {
			{IFD_ENABLE, IFD_GROUPDELAY_TABLE_M_R840},
		};
		StructGroupDelay stStructGroupDelayN[] = {
			{IFD_ENABLE, IFD_GROUPDELAY_TABLE_N},
		};
		StructGroupDelay stStructGroupDelayBG[] = {
			{IFD_ENABLE, IFD_GROUPDELAY_TABLE_BG_R840},
		};
		StructGroupDelay stStructGroupDelayI[] = {
			{IFD_ENABLE, IFD_GROUPDELAY_TABLE_I_R840},
		};
		StructGroupDelay stStructGroupDelayDK[] = {
			{IFD_ENABLE, IFD_GROUPDELAY_TABLE_DK_R840},
		};
		StructGroupDelay stStructGroupDelayL[] = {
			{IFD_ENABLE, IFD_GROUPDELAY_TABLE_DK_R840},
		};
...
*/
	...
	{	
		StructInputFltCoef stStructInputBpfMNB[] = {
			{IFD_DISABLE, IFD_INPUTFILTER_TABLE_MNB,},
		};
		StructInputFltCoef stStructInputBpfDKL[] = {
			{IFD_DISABLE, IFD_INPUTFILTER_TABLE_DKL,},
		};
...
void drv_ifd_user_data_init(unsigned short  tuner_id)
{
	...
	/*case TV_TUNER_NXP_TDA18273 : {
		...
		stIFDUserData.AGCloop1_dnsample = 0xf;//TODO: need to confirm with DIC.//0x00;
		stIFDUserData.AGCloop1_finednsample = 0x000;
		stIFDUserData.AGCloop1_peakcnt = 0xdb0;
		...
		stIFDUserData.AGCloop2_peakcnt = 0xdb0;
		stIFDUserData.AGC_peak_slowcharge_val = 0x2;
...
*/
	...
	case TV_TUNER_NO_TUNER: {
		...
		stIFDUserData.AFClockthd = 3;
		stIFDUserData.AFC_STAGE_MAX_COUNT = 15;
		stIFDUserData.SCANdelay = 0;  //100
		stIFDUserData.SETCHANNELdelay = 0;  //100
		stIFDUserData.CRPhaseInverseThr = 0;
		stIFDUserData.CRinverse_debounce = 16;
		stIFDUserData.CRSt3pgain = 0x1;
		stIFDUserData.CRSt3igain = 0x6;
		...
		stIFDUserData.AGCloop1_maxtargetPAL = 0x300;  //0x300
		stIFDUserData.AGCloop1_maxtargetSECAM = 0x280;
		stIFDUserData.AGCloop1_difftarget = 0x90;
		stIFDUserData.AGCloop1_peaktarget = 0x6a0;  //ori 0x700
		stIFDUserData.AGCloop1_peakforce_en = IFD_ENABLE;
		stIFDUserData.AGCloop1_kpgain = 0x12;
		stIFDUserData.AGCloop1_kigain = 0x7;
		stIFDUserData.AGCloop1_kpkishift = 0xb;   //0x9
		stIFDUserData.AGCloop1_dnsample = 0xf;//TODO: need to confirm with DIC.//0x00;
		stIFDUserData.AGCloop1_finednsample = 0x000;
		stIFDUserData.AGCloop1_peakcnt = 0xdb0;
		stIFDUserData.AGCloop2_kpgain = 0x1;
		...
		stIFDUserData.AGCloop2_kpshift = 0x3;
		stIFDUserData.AGCloop2_kishift = 0x7;
		stIFDUserData.AGCloop2_dnsample = 0x0F;  //0xF
		stIFDUserData.AGCloop2_finednsample = 0x0FFF;
		stIFDUserData.AGCloop2_peakcnt = 0xdb0;
		stIFDUserData.AGC_peak_slowcharge_val = 0x2;
		stIFDUserData.AGC_RfHasten_en = IFD_DISABLE;
		...
		stIFDUserData.AGCadapt_diffcoarsestep = 0x8;
		stIFDUserData.AGCSigmaDeltaDnSel = 0x4;
		stIFDUserData.AGCDataTarg = 0x400;  //0x400
		stIFDUserData.DataGainSel = IFD_VIDEOPATH_OUTPUT_GAIN_ADAPTIVE;
		stIFDUserData.CLAMPscale_scanch = IFD_CLAMP_SCALE_1D4;
		stIFDUserData.CLAMPscale_setch = IFD_CLAMP_SCALE_1D64;
		stIFDUserData.SHAPEfilter_bw = IFD_SHAPING_BW_SEL_0P86M;
	...
	case TV_TUNER_ALTOBEAM_ATBM253: {
		...
		stIFDUserData.AGCloop2_dnsample = 0x0F;
		stIFDUserData.AGCloop2_finednsample = 0x0FFF;
		stIFDUserData.AGCloop2_peakcnt = 0x38c;
		stIFDUserData.AGC_peak_slowcharge_val = 0x2;
		stIFDUserData.AGC_RfHasten_en = IFD_DISABLE;
		stIFDUserData.AGC_RfHasten_ki = 0x6;
		stIFDUserData.AGC_RfHasten_cntl = 0x1;
		...
		stIFDUserData.AGCadapt_interval = 0xf;
		stIFDUserData.AGCadapt_en = IFD_ENABLE;
		stIFDUserData.AGCadapt_incthr = 0x100;
		stIFDUserData.AGCadapt_mindifftarget = 0x10;
		stIFDUserData.AGCadapt_minmaxtarget = 0x40;
		stIFDUserData.AGCadapt_finetargetthr = 0x70;
		stIFDUserData.AGCadapt_diffcoarsestep = 0x8;
	...
	case TV_TUNER_SONY_SUTRX243_RA:
	{
		...
		stIFDUserData.CRpgain = 0x2;
		stIFDUserData.CRigain = 0x7;
		stIFDUserData.CRlock_err_thd = 3;
		stIFDUserData.CRweight_speed = 0;
		stIFDUserData.CRphasebad_en = IFD_DISABLE;
		stIFDUserData.CRphasebad_en_st4 = IFD_DISABLE;
		stIFDUserData.CRphasebad_en_st2 = IFD_ENABLE;
		stIFDUserData.CRphasebad_en_st0 = IFD_DISABLE;
		stIFDUserData.CR_phase_var_st0_thr = 0x1c;
		stIFDUserData.CR_freq_var_st0_thr = 0x1a;
		stIFDUserData.CR_phase_var_st2_thr = 0x20;
		stIFDUserData.CR_freq_var_vcheck_thr = 0x30;
		stIFDUserData.CR_freq_var_st2_up_thr = 0x50;
		...
		stIFDUserData.CRPower_Lock = IFD_ENABLE;
		stIFDUserData.CRPower_Lock_Thr = 0x2710; //10000 in decimal
		stIFDUserData.AGC_if_max = 0x1fff; //IF_AGC = 1.5V
		stIFDUserData.AGC_if_min = 0x0; //0x70;//IF_AGC=0.65V
		stIFDUserData.AGCloop1_maxtargetNTSC = 0x300; //To match IF_AGC=0.65~1.5V Curve
		stIFDUserData.AGCloop1_maxtargetPAL = 0x300;  //0x300
		stIFDUserData.AGCloop1_maxtargetSECAM = 0x300;
		stIFDUserData.AGCloop1_difftarget = 0xd5;
		stIFDUserData.AGCloop1_peaktarget = 0x770;  //0x700
		stIFDUserData.AGCloop1_peakforce_en = IFD_DISABLE;  //IFD_ENABLE
		stIFDUserData.AGCloop1_kpgain = 0x12;
		stIFDUserData.AGCloop1_kigain = 0x5;
		stIFDUserData.AGCloop1_kpkishift = 0x9;   //0xc
		stIFDUserData.AGCloop1_dnsample = 0xf;//TODO: need to confirm with DIC.//0x00;
		stIFDUserData.AGCloop1_finednsample = 0x000;
		stIFDUserData.AGCloop1_peakcnt = 0x5;
		stIFDUserData.AGCloop2_kpgain = 0x1;
		stIFDUserData.AGCloop2_kigain = 0x0;
		stIFDUserData.AGCloop2_kpshift = 0x3;
		stIFDUserData.AGCloop2_kishift = 0x7;
		stIFDUserData.AGCloop2_dnsample = 0x0F;
		stIFDUserData.AGCloop2_finednsample = 0x0FFF;
		stIFDUserData.AGCloop2_peakcnt = 0x5;
		stIFDUserData.AGC_peak_slowcharge_val = 0x1;
		stIFDUserData.AGC_RfHasten_en = IFD_DISABLE;
		stIFDUserData.AGC_RfHasten_ki = 0x6;
		stIFDUserData.AGC_RfHasten_cntl = 0x1;
		stIFDUserData.AGC_RfHasten_thr = 0x5c0;
		...
		stIFDUserData.AGCadapt_fineinterval = 0x7f;
		stIFDUserData.AGCadapt_interval = 0xf;
		stIFDUserData.AGCadapt_en = IFD_DISABLE;
		stIFDUserData.AGCadapt_incthr = 0x8f; //To match IF_AGC=0.65~1.5V Curve
		stIFDUserData.AGCadapt_mindifftarget = 0x10;
		stIFDUserData.AGCadapt_minmaxtarget = 0x40;
		stIFDUserData.AGCadapt_finetargetthr = 0x70;
		stIFDUserData.AGCadapt_diffcoarsestep = 0x8;
		stIFDUserData.AGCSigmaDeltaDnSel = 0x4;
		stIFDUserData.AGCDataTarg = 0x400;  //0x500
		stIFDUserData.DataGainSel = IFD_VIDEOPATH_OUTPUT_GAIN_ADAPTIVE;
		stIFDUserData.CLAMPscale_scanch = IFD_CLAMP_SCALE_1D4;
		stIFDUserData.CLAMPscale_setch = IFD_CLAMP_SCALE_1D64;
		stIFDUserData.SHAPEfilter_bw = IFD_SHAPING_BW_SEL_0P86M;
		stIFDUserData.VideoUpsampleLPF_NTSC = IFD_UPSAMPLE_LP_SEL_PAL;
		stIFDUserData.VideoUpsampleLPF_PAL = IFD_UPSAMPLE_LP_SEL_PAL;
		stIFDUserData.ADCInput_ShaGain = IFD_ADC_SHAGAIN_0P6X;
		stIFDUserData.ADCInput_FullScale = IFD_ADC_FULLSCALE_1P40V;
		stIFDUserData.ADCInput_clock = IFD_CLK_RATE_162M;
		...
		stIFDUserData.tunerPara.tunerI2C_ADD = 0xc0; // tuner i2c device address
		stIFDUserData.tunerPara.tunerMinFreq = 470000;
		stIFDUserData.tunerPara.tunerVHF_LowFreq = 3680000;
		stIFDUserData.tunerPara.tunerVHF_HighFreq = 8660000;
		stIFDUserData.tunerPara.tunerMaxFreq = 8660000;
		stIFDUserData.tunerPara.tunerPIF = 77500;
		stIFDUserData.tunerPara.tunerPIF_MN = IFD_IF_FREQ_5P75M;
		stIFDUserData.tunerPara.tunerPIF_B = IFD_IF_FREQ_7P3M;
		stIFDUserData.tunerPara.tunerPIF_GH = IFD_IF_FREQ_7P3M;
		stIFDUserData.tunerPara.tunerPIF_I = IFD_IF_FREQ_7P85M;
		stIFDUserData.tunerPara.tunerPIF_DK = IFD_IF_FREQ_7P85M;
		stIFDUserData.tunerPara.tunerPIF_L = IFD_IF_FREQ_7P85M;
		stIFDUserData.tunerPara.tunerPIF_LA = IFD_IF_FREQ_2P2M;
		stIFDUserData.tunerPara.tunerPIF_SCAN = IFD_IF_FREQ_7P85M;
		stIFDUserData.tunerPara.tunerIFType = TUNER_IF_TYPE_NEG;
		stIFDUserData.tunerPara.tunerRATIOStepSize = 10;
		...
		stIFDUserData.tunerPara.tunerUsedTag = _FALSE;
		stIFDUserData.tunerPara.tunerAGCtype = TUNER_RFAGC_IC_IFAGC;
		stIFDUserData.tunerPara.tunerAGCpolarity = TUNER_RF_NONE_IF_NEG;
		stIFDUserData.tunerPara.tunerType = TUNER_LOW_IF;
		stIFDUserData.tunerPara.tunerSpecificTag = 0;
		stIFDUserData.tunerPara.tunerID = TUNER_SONY_SUTRX243;
	}
	break;
	...
	case TV_TUNER_RAFAEL_R842: {
		...
		stIFDUserData.CRShift_Target_Freq = IFD_IF_FREQ_16M;
		stIFDUserData.CRPower_Lock = IFD_ENABLE;
		stIFDUserData.CRPower_Lock_Thr = 0x32c8;
		stIFDUserData.AGC_if_max = 0x1700; //2.4V
		stIFDUserData.AGC_if_min = 0x3c0; //0.4V
		stIFDUserData.AGCloop1_maxtargetNTSC = 0x300;
		stIFDUserData.AGCloop1_maxtargetPAL = 0x300;
		stIFDUserData.AGCloop1_maxtargetSECAM = 0x300;
		stIFDUserData.AGCloop1_difftarget = 0x110;
		stIFDUserData.AGCloop1_peaktarget = 0x6d0; //0x790;
		stIFDUserData.AGCloop1_peakforce_en = IFD_ENABLE;
		stIFDUserData.AGCloop1_kpgain = 0x15;
		stIFDUserData.AGCloop1_kigain = 0x5;
		stIFDUserData.AGCloop1_kpkishift = 0xb;
		stIFDUserData.AGCloop1_dnsample = 0x3;
		stIFDUserData.AGCloop1_finednsample = 0x000;
		stIFDUserData.AGCloop1_peakcnt = 0xdb0;
		stIFDUserData.AGCloop2_kpgain = 0x1;
		stIFDUserData.AGCloop2_kigain = 0x0;
		...
		stIFDUserData.tunerPara.tunerI2C_ADD = 0x74;
		stIFDUserData.tunerPara.tunerMinFreq = 452500;
		stIFDUserData.tunerPara.tunerMaxFreq = 8660000;
		stIFDUserData.tunerPara.tunerPIF = IFD_IF_FREQ_5P1M;
		stIFDUserData.tunerPara.tunerPIF_MN = IFD_IF_FREQ_5P1M;
		stIFDUserData.tunerPara.tunerPIF_B = IFD_IF_FREQ_6P6M;
		stIFDUserData.tunerPara.tunerPIF_GH = IFD_IF_FREQ_6P6M;
		stIFDUserData.tunerPara.tunerPIF_I = IFD_IF_FREQ_7P3M;
		stIFDUserData.tunerPara.tunerPIF_DK = IFD_IF_FREQ_7P3M;
		stIFDUserData.tunerPara.tunerPIF_L = IFD_IF_FREQ_7P3M;
		stIFDUserData.tunerPara.tunerPIF_LA = IFD_IF_FREQ_1P32M;
		stIFDUserData.tunerPara.tunerPIF_SCAN = IFD_IF_FREQ_7P3M;
		stIFDUserData.tunerPara.tunerIFType = TUNER_IF_TYPE_NEG;
		stIFDUserData.tunerPara.tunerRATIOStepSize = 500;
		stIFDUserData.tunerPara.tunerUsedTag = _FALSE;
		stIFDUserData.tunerPara.tunerAGCtype = TUNER_RFAGC_IC_IFAGC;
		...
		stIFDUserData.tunerPara.tunerType = TUNER_LOW_IF;
		stIFDUserData.tunerPara.tunerSpecificTag = 0;
		stIFDUserData.tunerPara.tunerID = TUNER_RAFAEL_R842;
	}
	break;
