...
#define IFD_INPUT_FILTER_TABLE_SIZE 72
	...
	UINT16    AGCloop2_peakcnt;
	UINT8      AGC_peak_slowcharge_val;
...
#define GET_ATV_IFD_AGCLOOP1_PEAKCNT()                               stIFDUserData.AGCloop1_peakcnt
...
#define GET_ATV_IFD_AGCLOOP2_PEAKCNT()                               stIFDUserData.AGCloop2_peakcnt
#define GET_ATV_IFD_AGC_PEAK_SLOWCHARGE_VAL()                               stIFDUserData.AGC_peak_slowcharge_val
