...
RTK_A_DVBSX_STATUS RTK_A_DVBSX_SetDvbSxVeryLowSrAdc(DVBSX_DEMOD_MODULE *pDemod, unsigned char VeryLowSrEn)
{
	...
	if(VeryLowSrEn)
		rtd_maskl(PLL27X_REG_SYS_PLL_DIF2_reg, ~(PLL27X_REG_SYS_PLL_DIF2_plldif_divadc_sel_mask), PLL27X_REG_SYS_PLL_DIF2_plldif_divadc_sel(0xc)); //ADC CLK 60M div12
	else
		rtd_maskl(PLL27X_REG_SYS_PLL_DIF2_reg, ~(PLL27X_REG_SYS_PLL_DIF2_plldif_divadc_sel_mask), PLL27X_REG_SYS_PLL_DIF2_plldif_divadc_sel(0x9)); //ADC CLK 120M div6
