...
typedef enum _E_IRDA_KEYMAP_TYPE{
    ...
    IRDA_KEYMAP_TYPE_TV030_JP,
    IRDA_KEYMAP_TYPE_TV030_NEC,
    IRDA_KEYMAP_TYPE_TV030_KT1752,
...
#define MAX_IRDA_BOOT_PARAMETER_NUM 2

#define MAX_POWERUP_KEYLIST_NUM 13
typedef struct {
	char keylist_remoter[32];
	unsigned int keylist_proto_id;
	unsigned int keylist_len;
	unsigned int powerup_keylist[MAX_POWERUP_KEYLIST_NUM];
}IRDA_BOOT_PARAMETER;
...
extern unsigned int ir_poll_settings[MAX_HW_RTK_KDRV_PROTOCOLS_NUM][2];
#endif
