...
#include <rbus/vdtop_reg.h> //HKTTANDP-12, RL
...
int g_CurrentHWDetectStd = 0;
int g_RealHWDetectStd = 0;
static int g_CurrentHWDetectUpdate = 0;
int g_NoSIFFlag = 0;
int g_NoSignalCount = 0;
...
int g_StartFromSIFResume = 0;	// inform SIF thread that start from SIF Resume
...
static int g_NicamSignalStable2 = 1;

static int g_KR_A2_TH_CHG = 0;
#ifndef TV001_BOARD
static int g_weak_pilot = 0;
static int g_dual_stereo_pilot_diff_level = 0x3000;
...
static uint32_t g_TVBGDKIVolumeCompensate_Ultra = 0;	/* compensate BGDKI Ultra deviation */
...
static uint32_t g_TVNICAM_MonoVolumeCompensate_Ultra = 0;
...
static int32_t g_wait_tunner_delay_mute = 0;
...
//static uint32_t g_AudioDuringChangeStatus = FALSE;	//[Fix me]

//static FP_AUDIOSTATUSCHANGE audioStatusChanageCallBack = NULL;	//[Fix me]

/* speed up the time when weak NICAM switch to MONO */
static uint32_t g_NicamErrorRateThresholdHigh = 0x100;		/* original 0x100 //0F */ /*Merlin2 0x70*/
static uint32_t g_NicamErrorRateThresholdNormal = 0x70;		/*Merlin2 0x20*/
static uint32_t g_NicamErrorRateThresholdLow = 0x40;		/* original 0x70 //03 */ /*Merlin2 0x10*/
...
static int32_t g_sif_offset = 0;			// For other compensation exclusive hw mode amplitude difference
static int32_t g_sif_highdev_offset = 0;	//g_sif_highdev_offset=7(+0.875dB,), For FM modulation High Dev, exclude NICAM, AM, it needs to compensate +0.875dB, for normal dev, comp=0dB
static int32_t g_sif_AMcomp_offset = 0;	// g_sif_AMcomp_offset = -40 (-5dB) due to EQ LPF ON
static int32_t g_sif_BTSC_FMradio_comp = 0;	//g_sif_BTSC_FMradio_comp=48 (+6dB)FM_radio=1 & SoundMode=MONO
static int32_t g_sif_gain_finetuning = 0;
...
static ATV_A2_TH_TAB A2_Th_MN_Table[101] = {														/* ATV_MODE_MAX_TH_0 */
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x50000,	0x170000,	20},	//0
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x50000,	0x170000,	20},	//1
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x50000,	0x170000,	20},	//2
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x50000,	0x170000,	20},	//3
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x50000,	0x170000,	20},	//4
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x50000,	0x170000,	20},	//5
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x50000,	0x170000,	20},	//6
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x50000,	0x170000,	20},	//7
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x50000,	0x170000,	20},	//8
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x50000,	0x170000,	20},	//9
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x50000,	0x170000,	20},	//10
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x090000,	20},	//11 //Clayton: New TH for K6
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x0e2000,	20},	//12
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x0e4000,	20},	//13
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x0e6000,	20},	//14
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x0e8000,	20},	//15
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x0ea000,	20},	//16
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x0ec000,	20},	//17
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x0ee000,	20},	//18
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x0f0000,	20},	//19
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x0f2000,	20},	//20
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x0f4000,	20},	//21
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x0f6000,	20},	//22
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x0f8000,	20},	//23
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x0fa000,	20},	//24
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x0fc000,	20},	//25
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x0fe000,	20},	//26
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x100000,	20},	//27
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x102000,	20},	//28
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x104000,	20},	//29
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x106000,	20},	//30
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x108000,	20},	//31
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x10a000,	20},	//32
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x10c000,	20},	//33
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x10e000,	20},	//34
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x110000,	20},	//35
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x112000,	20},	//36
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x114000,	20},	//37
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x116000,	20},	//38
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x118000,	20},	//39
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x11a000,	20},	//40
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x11c000,	20},	//41
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x11e000,	20},	//42
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x120000,	20},	//43
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x122000,	20},	//44
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x124000,	20},	//45
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x126000,	20},	//46
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x128000,	20},	//47
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x12a000,	20},	//48
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x12c000,	20},	//49
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x12e000,	20},	//50
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x130000,	20},	//51
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x132000,	20},	//52
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x134000,	20},	//53
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x136000,	20},	//54
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x138000,	20},	//55
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x13a000,	20},	//56
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x13c000,	20},	//57
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x13e000,	20},	//58
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x140000,	20},	//59
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x142000,	20},	//60
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x144000,	20},	//61
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x146000,	20},	//62
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x148000,	20},	//63
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x14a000,	20},	//64
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x14c000,	20},	//65
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x14e000,	20},	//66
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x150000,	20},	//67
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x152000,	20},	//68
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x154000,	20},	//69
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x156000,	20},	//70
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x158000,	20},	//71
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x15a000,	20},	//72
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x15c000,	20},	//73
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x15e000,	20},	//74
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x160000,	20},	//75
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x162000,	20},	//76
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x164000,	20},	//77
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x166000,	20},	//78
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x168000,	20},	//79
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x16a000,	20},	//80
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x16c000,	20},	//81
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x16e000,	20},	//82
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x170000,	20},	//83
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x172000,	20},	//84
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x174000,	20},	//85
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x176000,	20},	//86
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x178000,	20},	//87
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x17a000,	20},	//88
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x17c000,	20},	//89
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x17e000,	20},	//90
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x180000,	20},	//91
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x182000,	20},	//92
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x184000,	20},	//93
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x186000,	20},	//94
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x188000,	20},	//95
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x18a000,	20},	//96
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x18c000,	20},	//97
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x18e000,	20},	//98
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x190000,	20},	//99
	{ATV_LPF_COEF_SEL_14, ATV_LPF_COEF_SEL_14, ATV_MODE_HI_TH_2P00T, ATV_MODE_LO_TH_1P50T, ATV_A2_DEBOUNCE_0P1S, 0x60000,	0x270000,	20},	//100  //Clayton: New TH for K6
};
...
static ATV_MODE_TAB atv_mode_tab[16] = {
	...
	#else
	{	ATV_A2_DEBOUNCE_0P2S,	ATV_MODE_HI_TH_2P50T,	ATV_MODE_LO_TH_1P00T,	ATV_MODE_ACCU_32}, // AUDIO_SOUND_STD_A2_BG
	#endif
...
/* 
 * {band_enable, {LP_a1, 0, LP_h0}, {BP1_a1, BP1_a2, BP1_h0}, {BP2_a1, BP2_a2, BP2_h0}}
 */
...
static void AtvSetFwCarrierFreq(bool paa, bool manual);
...
//static void AtvSetMute(int32_t para);//nio_liao 20191015
...
static void AtvBTSCoverModulationMode(uint32_t Enable);
...
//static int32_t AtvCheckVideoTiming_LG(ATV_SOUND_STD_MAIN_SYSTEM main_sys);
...
void AtvCheckA2DK3rdTone(void);
static void AtvResetMSD(void);
static void HwpSetVolume_SIF(int32_t vol);
static void Audio_HwpSetVolume_SIF(void);
static void AudioSifBtscLpfSel(uint32_t SoundMode);
...
{
	alog_err("Audio_AtvMuteDecoder %d \n", isMute);
	#if 0
	...
	#else
	if (g_instanceID != 0)
		rtk_snd_set_decoder_mute(isMute, ENUM_AI_PB_PATH);
        else if (g_SetMode_Mute == 1) //NULL & SetMode
		g_InternalDecoder_0_FAIL = 1;

	if (g_sub_instanceID != 0)
		rtk_snd_set_decoder_mute(isMute, ENUM_AI_TS_PATH);
        else if (g_SetMode_Mute == 1) //NULL & SetMode
		g_InternalDecoder_1_FAIL = 1;
	#endif
}
...
EXPORT_SYMBOL(Audio_AtvEnableAutoChangeStdFlag);
...
#define AUDIO_SIF_SEL_TYPE	(ATV_AUDIO_SIF_BTSC_SELECT | \
		...
		if ((g_CurSifType & AUDIO_SIF_SEL_TYPE) == 0) 
		{
			...
			while (1)
			{
				...
				//alog_info("check HW STD stable..... %x %d \n", msd_result.hw_detected_std,  Timeout);

				if (msd_result.hw_detected_std != ATV_SOUND_STD_UNKNOWN)
				{
					++ SoundStdDebounce;
				}
				else
				...
				if (SoundStdDebounce >= 2 || Timeout > 20)
				{
			...
			//alog_info("start set mode Delay %x %x \n", g_CurSifType, AUDIO_SIF_SEL_TYPE);
			//audio_hw_usleep(210000);	// 210ms
			g_wait_tunner_delay = 0;
			g_wait_tunner_delay_mute = 1;
		}
	...
	AtvSetFwCarrierFreq(ATV_ENABLE, 0);
	...
	// HW function "Down_6dB" only be affect on FM except BTSC
	// Only FM modulation SIF needs to down 6dB excep BTSC, A2M, MN_MONO due to HW demod result
	// So, when A2M or MN_MONO, disable down_6dB, others: enable down_6dB
	a2_eiaj_demod.regValue = AIO_ReadRegister(AUDIO_a2_eiaj_demod_reg);
	if ((sound_std == ATV_SOUND_STD_A2_M) || (sound_std == ATV_SOUND_STD_MN_MONO)) 
	{
		a2_eiaj_demod.down_6db = 0;
	}
	else
	{
		a2_eiaj_demod.down_6db = 1;
	}
	// [End]
	alog_info("[%s]down_6db.......=%d\n", __FUNCTION__, a2_eiaj_demod.down_6db);
	AIO_WriteRegister(AUDIO_a2_eiaj_demod_reg, a2_eiaj_demod.regValue);

	//reset sif volume to 0dB
	//[start]
	g_sif_offset = 0;
	//g_sif_highdev_offset = 0;		//it needs to depends on HDEV setting then change it.
	g_sif_AMcomp_offset = 0;
	g_sif_BTSC_FMradio_comp = 0;
	g_sif_gain_finetuning = 0;
	Audio_HwpSetVolume_SIF();
	//[end]
	...
	if (sifsource == SIF_FROM_SIF_ADC) {
		if ((sound_std == ATV_SOUND_STD_NICAM_L) || (sound_std == ATV_SOUND_STD_AM_MONO)) {
			...
			// RyanLan, for France field stream, sif input from 200mV to 600mV
	...
	//else if ((sound_std == ATV_SOUND_STD_DK_MONO) || (sound_std == ATV_SOUND_STD_A2_DK1) || (sound_std == ATV_SOUND_STD_A2_DK2) || (sound_std == ATV_SOUND_STD_A2_DK3) || (sound_std == ATV_SOUND_STD_NICAM_DK))
	else
	...
	if ((sound_std == ATV_SOUND_STD_A2_M && g_CurSifType != ATV_AUDIO_SIF_KOREA_A2_SELECT) ||
		...
		if(g_sif_highdev_offset != 0)
		{
			g_sif_highdev_offset = 0;
			alog_info("[%s]global_ctrl_1.hdv_mode_sel= %d, g_sif_highdev_offset= %d\n", __FUNCTION__, global_ctrl_1.hdv_mode_sel, g_sif_highdev_offset);
			Audio_HwpSetVolume_SIF();
		}
	}
...
EXPORT_SYMBOL(Audio_AtvSetSoundStd);
...
EXPORT_SYMBOL(Audio_AtvSetMtsPriority);
...
EXPORT_SYMBOL(Audio_AtvGetSoundStd);
...
EXPORT_SYMBOL(Audio_HwpAADSIFInit);
...
int32_t Audio_AtvInit(ATV_CFG *p_cfg)
{
	...
	// Enable SIF EQ, fixed it after RTD284x.
	eq_tvd_bp_control.regValue = AIO_ReadRegister(AUDIO_EQ_tvd_bp_Control_reg);
	eq_tvd_bp_control.eq_tvd_deq_enable = AIO_ENABLE;
	...
	FW_CARRIER_CTRL_REG.tone_det_en = 1;
	FW_CARRIER_CTRL_REG.nicam_play_ana_sel = 1;
	alog_err("[Clayton-0709]Force mute if Ni true_det=0\n");
	...
	// enable normalize & Add down_6dB for FM demod compensate
	a2_eiaj_demod.regValue = AIO_ReadRegister(AUDIO_a2_eiaj_demod_reg);
	// Clayton 2013/11/28
...
#ifdef USE_PACFIC_STYLE
#ifdef CONFIG_PM
	if ((!IS_ERR_OR_NULL(audio_atv_thread)) && (AtvThreadState==true)) {
#else
	if (!IS_ERR(audio_atv_thread)) {
#endif
...
EXPORT_SYMBOL(Audio_HwpAADSIFFinalize);
...
static void AtvSetPrescaleDeemphasis(uint32_t sound_std)
{
	...
	//alog_info("AtvSetPrescaleDeemphasis.....%x\n", sound_std);
...
/*
// Clayton: 2019/9/12, No need to compensate anything due to down 6dB remove
...
#ifdef DRV_NO_12DBBOOST
                              
				//g_sif_offset = -16; // SIF gain -1.125dB
				//g_sif_offset = -14; // SIF gain -0.85dB
				g_sif_offset = -12; // SIF gain -0.625dB
				alog_info("[%s]g_sif_offset = %d %d\n", __FUNCTION__,  g_sif_offset , __LINE__);
				Audio_HwpSetVolume_SIF();
#endif					
...
*/
	...
	switch (sound_std) {// Audio sif Compensate
	case ATV_SOUND_STD_BG_MONO:
	case ATV_SOUND_STD_DK_MONO:
	case ATV_SOUND_STD_FM_MONO_NO_I:
		if(g_sif_gain_finetuning != 3)
		{ // #22580
			g_sif_gain_finetuning = 3; //x /8 db
			alog_info("[%s]g_sif_gain_finetuning= %d %d\n", __FUNCTION__, g_sif_gain_finetuning, __LINE__);
			Audio_HwpSetVolume_SIF();
		}
		break;
	...
	case ATV_SOUND_STD_NICAM_BG:
	case ATV_SOUND_STD_NICAM_I:
		if(g_sif_gain_finetuning != -2)
		{
			g_sif_gain_finetuning = -2; //x /8 db
			alog_info("[%s]g_sif_gain_finetuning= %d %d\n", __FUNCTION__, g_sif_gain_finetuning, __LINE__);
			Audio_HwpSetVolume_SIF();
		}
		break;
	...
	case ATV_SOUND_STD_A2_BG:
		if(g_sif_gain_finetuning != 6)
		{
			g_sif_gain_finetuning = 6; //x /8 db
			alog_info("[%s]g_sif_gain_finetuning= %d %d\n", __FUNCTION__, g_sif_gain_finetuning, __LINE__);
			Audio_HwpSetVolume_SIF();
		}
		break;
	...
	default:
		if(g_sif_gain_finetuning != 0)
		{
			g_sif_gain_finetuning = 0; //x /8 db
			//alog_info("[%s]g_sif_gain_finetuning= %d %d\n", __FUNCTION__, g_sif_gain_finetuning, __LINE__);
			Audio_HwpSetVolume_SIF();
		}
		//alog_info("[%s] no Gain Compensate\n", __FUNCTION__);
	}
}
...
static void AtvSetA2Parameter(void)
{
...
#if 0 //K2L
	audio_md_ctrl_RBUS  MD_CTRL;
	audio_md_status_2_RBUS			md_status_2;
	audio_md_status_3_RBUS			md_status_3;
	int  max_stereo_dual =0;
	MD_CTRL.regValue = AIO_ReadRegister(AUDIO_md_ctrl_reg);
	md_status_2.regValue = AIO_ReadRegister(AUDIO_md_status_2_reg);
	md_status_3.regValue = AIO_ReadRegister(AUDIO_md_status_3_reg);

	md_status_2.lpf_coef_sel       = A2_Th_Table[g_A2_TH_sel].lpf_coef_sel;
	md_status_2.lpf_coef_sel_lock  = A2_Th_Table[g_A2_TH_sel].lpf_coef_sel_lock;
	MD_CTRL.high_threshold     = A2_Th_Table[g_A2_TH_sel].hi_threshold;
	MD_CTRL.low_threshold      = A2_Th_Table[g_A2_TH_sel].lo_threshold;
	md_status_3.debounce_time      = A2_Th_Table[g_A2_TH_sel].debounce_time;
	MD_CTRL.max_threshold      = A2_Th_Table[g_A2_TH_sel].max_threshold;
	//if(g_A2_TH_sel == 1 || g_A2_TH_sel == 0 )
	//{
	//  MD_CTRL.bpf_sel = 1;
	//}
	//else
	...
	switch((ATV_SOUND_MODE)g_A2_soundmode){
		default:
		case ATV_SOUND_MODE_MONO  :
		if( g_KR_A2_TH_CHG > KR_A2_TH_CNT){
			MD_CTRL.max_threshold = A2_Th_Table[0].max_threshold;
			md_status_2.lpf_coef_sel       = A2_Th_Table[0].lpf_coef_sel;
			md_status_2.lpf_coef_sel_lock  = A2_Th_Table[0].lpf_coef_sel_lock;
		} else { // I
			MD_CTRL.max_threshold = A2_Th_Table[g_A2_TH_sel].max_threshold;
		}
		...
		case ATV_SOUND_MODE_STEREO   :
		if( g_CurrentStd == ATV_SOUND_STD_A2_M && g_CurSifType == ATV_AUDIO_SIF_KOREA_A2_SELECT){
			g_dual_stereo_pilot_diff_level = 0x1500;
		} else {
			g_dual_stereo_pilot_diff_level = 0x3000;
		}
		if( g_KR_A2_TH_CHG > KR_A2_TH_CNT){
			max_stereo_dual= A2_Th_Table[0].max_threshold- g_dual_stereo_pilot_diff_level; //ATV_MODE_MAX_TH_4500; // Hysteresis for change back MONO
			md_status_2.lpf_coef_sel       = A2_Th_Table[g_A2_TH_sel].lpf_coef_sel;
			md_status_2.lpf_coef_sel_lock  = A2_Th_Table[g_A2_TH_sel].lpf_coef_sel_lock;
		} else { //525
			max_stereo_dual= A2_Th_Table[g_A2_TH_sel].max_threshold- g_dual_stereo_pilot_diff_level; //ATV_MODE_MAX_TH_4500; // Hysteresis for change back MONO
		}
		if(max_stereo_dual < 0) max_stereo_dual = 0;
		if(g_weak_pilot == 1 && g_CurrentStd == ATV_SOUND_STD_A2_M && g_CurSifType == ATV_AUDIO_SIF_KOREA_A2_SELECT){
			MD_CTRL.max_threshold = 0x1500;
		} else {
			MD_CTRL.max_threshold  = max_stereo_dual;
		}



		//max_stereo_dual= A2_Th_Table[g_A2_TH_sel].max_threshold;
		//if(max_stereo_dual < 0) max_stereo_dual = 0;
		//MD_CTRL.max_threshold  = max_stereo_dual;
		break;
		case ATV_SOUND_MODE_DUAL  :
	...
	AIO_WriteRegister(AUDIO_md_ctrl_reg, MD_CTRL.regValue);
	AIO_WriteRegister(AUDIO_md_status_2_reg, md_status_2.regValue);
	AIO_WriteRegister(AUDIO_md_status_3_reg, md_status_3.regValue);
#else //K3L
	audio_md_ctrl_RBUS			MD_CTRL_REG;
...
static void AtvSetFwCarrierFreq(bool para, bool manual)
{
	audio_carrier_freq_deviation_ctrl_RBUS	FW_CARRIER_CTRL_REG;

		FW_CARRIER_CTRL_REG.regValue = AIO_ReadRegister(AUDIO_carrier_freq_deviation_ctrl_reg);

	FW_CARRIER_CTRL_REG.tone_det_en = para;
	FW_CARRIER_CTRL_REG.freq_manual_en = manual;
...
static void AtvSetMuteSW(int32_t para)
{
	if (para) {
		...
		if (g_instanceID != 0 || g_sub_instanceID != 0)
			Audio_AtvMuteDecoder(TRUE);
		else alog_info("sw mute fail\n");
...
static void AtvSetMuteHW(int32_t para)
{
	...
	alog_info("tv Mute HW = %d %x \n", AtvGetCurrState(), g_numTVMute);

	if ((AtvGetCurrState() == ATV_TASK_STOP) && (g_numTVMute > 0)) { /* 585 */
		para = ATV_DISABLE;
		g_numTVMute = 0;
	}
...
#ifdef USE_ATV_SW_MUTE
	if(g_user_config == AUDIO_USER_CONFIG_TV001 ||g_user_config == AUDIO_USER_CONFIG_TV003){
		AtvSetMuteSW(para); // only sif mute
	}
	else{ //#else
		AtvSetMuteHW(para); // sif mute + AQ process mute
	}
#endif
	...
	for (i = 0; i < 10; i++) {
		...
		if (main_std == ATV_SOUND_MN_SYSTEM) {
			...
			if(g_user_config == AUDIO_USER_CONFIG_TV003 ||g_user_config == AUDIO_USER_CONFIG_TV002){
				...
				{
					std = ATV_SOUND_STD_UNKNOWN;
					alog_info("[Scan]Fake BG, android, change to UNKNOWN\n");
				}
			}else{

				if ((g_Std_energy_55 < g_Std_energy_6) || (g_Std_energy_55 < g_Std_energy_65) || (g_Std_energy_55 < g_Std_energy_45)) 
				{
					std = ATV_SOUND_STD_UNKNOWN;
		...
		if (std != ATV_SOUND_STD_UNKNOWN) {
			alog_info("[HW auto  %x ] %x %d\n", id,  std, i);
			break; //

		} else {
			alog_info("[HW auto %x %d] unknow \n", id, i);
		}
	}
...
uint32_t  AtvCheckAGCFlag(void)
{
	...
	if (analog_pg.afe_pga_vol == 0xF)	//only 4bits, fix
		return 0;
	else
		return 1;
}
...
uint32_t AtvGetHWStd(void)
{
	...
	uint32_t nicam_main_tone, nicam_sub_tone, sub_thresh,noise_thresh;
	static int true_detect_false_cnt = 0;
	ATV_SOUND_MODE sound_mode = ATV_SOUND_MODE_MONO;
	audio_carrier_freq_deviation_ctrl_RBUS force_a2_DK123;
	...
	{
			if ((g_Std_energy_6 < g_Std_energy_55) ||
				(g_Std_energy_6 < g_Std_energy_65) ||
		...
		if(g_user_config == AUDIO_USER_CONFIG_TV003 || g_user_config == AUDIO_USER_CONFIG_TV002)
		{
					...
					&& g_Std_energy_55 > g_Std_energy_45)
			{
				...
				alog_info("audio_debug, android, change to A2_BG\n");
			}
		}
...
// [Fix me] Customization => change to general patch
// Start
		sound_mode = ATV_SOUND_MODE_MONO;

	if(g_CurSifType == ATV_AUDIO_SIF_DVB_AJJA_SELECT) //for Vietnam field stream
	{
		//check A2DK sound mode by 3rd tone detection
		if(g_CurrentStd == ATV_SOUND_STD_NICAM_DK || g_CurrentStd == ATV_SOUND_STD_DK_MONO)
		{
			AtvCheckA2DK3rdTone();
		}
		else if(g_CurrentStd == ATV_SOUND_STD_A2_DK1 || g_CurrentStd == ATV_SOUND_STD_A2_DK2 || g_CurrentStd == ATV_SOUND_STD_A2_DK3)
		{
			AtvGetA2HwSoundMode(&sound_mode, FALSE);
			if(sound_mode == ATV_SOUND_MODE_MONO)
			{
				if(g_Std_msd_result.hw_detected_std != ATV_SOUND_STD_DK_MONO)
				{
					g_Std_msd_result.hw_detected_std = ATV_SOUND_STD_DK_MONO;
					alog_info("Fake 0x%x, change to DK MONO\n", g_CurrentStd);
				}
			}
			else
			{
				...
				{
					g_Std_msd_result.hw_detected_std = g_CurrentStd;
					alog_info("Fake DK MONO, change to 0x%x\n", g_CurrentStd);
				}
			}
		}
	}
// End
//nio 20191120
//NicamBG error handler
//I Mono should be no 55, 574,525 signal
if(g_Std_msd_result.hw_detected_std==ATV_SOUND_STD_FM_MONO_NO_I)
{
	//for BG system
	//noise floor detect
	noise_thresh=(g_Std_energy_65+g_Std_energy_6552+g_Std_energy_674)/3;

	if(g_Std_energy_55>g_Std_energy_574)
	{
        	if(((g_Std_energy_55-g_Std_energy_574)>0x300) && (g_Std_energy_55>(noise_thresh+0x300)))
        	{
			g_Std_msd_result.hw_detected_std=ATV_SOUND_STD_BG_MONO;
			alog_debug("Fake I Mono, change to BG Mono\n");	
        	}
	}else
	{
        	if(((g_Std_energy_574-g_Std_energy_55)>0x300) && (g_Std_energy_574>(noise_thresh+0x300)))
        	{
			g_Std_msd_result.hw_detected_std=ATV_SOUND_STD_BG_MONO;
			alog_debug("Fake I Mono, change to BG Mono\n");	
        	}
	}
	if(g_Std_energy_55>g_Std_energy_525)
	{
        	if(((g_Std_energy_55-g_Std_energy_525)>0x300) && (g_Std_energy_55>(noise_thresh+0x300)))
        	{
			g_Std_msd_result.hw_detected_std=ATV_SOUND_STD_BG_MONO;
			alog_debug("Fake I Mono, change to BG Mono\n");	
        	}
	...
	{
        	if(((g_Std_energy_525-g_Std_energy_55)>0x300) && (g_Std_energy_525>(noise_thresh+0x300)))
        	{
			g_Std_msd_result.hw_detected_std=ATV_SOUND_STD_BG_MONO;
			alog_debug("Fake I Mono, change to BG Mono\n");	
        	}
	...
	//for DK system
	//noise floor detect
	noise_thresh=(g_Std_energy_525+g_Std_energy_55)/2;
	
	if(g_Std_energy_65>g_Std_energy_6552)
	{
        	if(((g_Std_energy_65-g_Std_energy_6552)>0x300) && (g_Std_energy_65>(noise_thresh+0x300)))
        	{
			g_Std_msd_result.hw_detected_std=ATV_SOUND_STD_DK_MONO;
			alog_debug("Fake I Mono, change to DK Mono\n");	
        	}
	}else
	{
        	if(((g_Std_energy_6552-g_Std_energy_65)>0x300) && (g_Std_energy_6552>(noise_thresh+0x300)))
        	{
			g_Std_msd_result.hw_detected_std=ATV_SOUND_STD_DK_MONO;
			alog_debug("Fake I Mono, change to DK Mono\n");	
        	}
	}
//	if(g_Std_energy_65>g_Std_energy_625)
//	{
//        	if((g_Std_energy_65-g_Std_energy_625)>(noise_thresh+0x300))
//        	{
//			g_Std_msd_result.hw_detected_std=ATV_SOUND_STD_DK_MONO;
//			alog_debug("Fake I Mono, change to DK Mono\n");	
//        	}
//	}else
//	{
//        	if((g_Std_energy_625-g_Std_energy_65)>(noise_thresh+0x300))
//        	{
//			g_Std_msd_result.hw_detected_std=ATV_SOUND_STD_DK_MONO;
//			alog_debug("Fake I Mono, change to DK Mono\n");	
 //       	}
//	}
		...
		{
			if(true_detect_false_cnt < 255)
			{
				++true_detect_false_cnt;
			}
			...
			else if(true_detect_false_cnt >= fakeNICAM_TH)
			{
				//KTASKWBS-9293
				if (g_Std_msd_result.hw_detected_std == ATV_SOUND_STD_NICAM_DK)
				{
					g_Std_msd_result.hw_detected_std = ATV_SOUND_STD_DK_MONO;
					alog_info("Fake DK-NICAM, change to DK-Mono %x\n", g_Std_msd_result.hw_detected_std);
				}
			}
		}
		else if(nicam_decode_status.true_detect)
		{ //nio 20191120
			true_detect_false_cnt = 0;
				if (g_Std_msd_result.hw_detected_std == ATV_SOUND_STD_BG_MONO) {
					g_Std_msd_result.hw_detected_std =ATV_SOUND_STD_NICAM_BG;
				} else if (g_Std_msd_result.hw_detected_std ==ATV_SOUND_STD_DK_MONO) {
					g_Std_msd_result.hw_detected_std = ATV_SOUND_STD_NICAM_DK;
				} else if (g_Std_msd_result.hw_detected_std == ATV_SOUND_STD_FM_MONO_NO_I){
					g_Std_msd_result.hw_detected_std =ATV_SOUND_STD_NICAM_I;
				} else if (g_Std_msd_result.hw_detected_std ==ATV_SOUND_STD_AM_MONO) {
					g_Std_msd_result.hw_detected_std = ATV_SOUND_STD_NICAM_L;
				}
				//alog_info("nicam true detect==1\n");

		}

	}
      //alog_debug("nicam true detect==%x\n",nicam_decode_status.true_detect);
	...
	if (AtvIsA2System((ATV_SOUND_STD)g_Std_msd_result.hw_detected_std)) {
		sub_thresh = AtvGetSubThresh((ATV_SUB_TONE_RATIO)ratio, g_Std_energy_65);
		force_a2_DK123.regValue = AIO_ReadRegister(AUDIO_carrier_freq_deviation_ctrl_reg);
		force_a2_DK123.tone_det_en=1;
		Audio_HwpWriteRegister(AUDIO_carrier_freq_deviation_ctrl_reg, force_a2_DK123.regValue);
		...
		if ((g_AudioTVControlFlag&ENABLE_NEW_A2_DETECTED_MASK) == ENABLE_NEW_CHECK_A2) {
			if (g_Std_msd_result.hw_detected_std == ATV_SOUND_STD_A2_DK1) {
				//case1: A2KD1 is fake, but ATV_SOUND_STD_A2_DK2 is true
				if (((g_Std_energy_674 >> 1) > g_Std_energy_625) && (g_Std_energy_674>=sub_thresh)) {
					alog_info("Error A2DK1 and go to A2DK2, %x %x \n", g_Std_energy_674, g_Std_energy_625);
					g_Std_msd_result.hw_detected_std = ATV_SOUND_STD_A2_DK2;
				}
				//case2: A2KD1 is fake, but ATV_SOUND_STD_A2_DK3 is true
				else if (((g_Std_energy_574 >> 1) > g_Std_energy_625) && (g_Std_energy_574>=sub_thresh)) {
					alog_info("Error A2DK1 and go to A2DK3, %x %x \n", g_Std_energy_574, g_Std_energy_625);
					g_Std_msd_result.hw_detected_std = ATV_SOUND_STD_A2_DK3;
				}
				//case3: A2KD1 is fake, but ATV_SOUND_STD_NICAM_DK is true
				else if (g_Std_energy_585 > 0x100) {
					if ((g_Std_energy_574 >= sub_thresh) &&
							(g_Std_energy_585 >= sub_thresh) &&
							(g_Std_energy_595 >= sub_thresh)) {
						alog_info("Error A2DK1 and go to NicamDK, %x %x \n", g_Std_energy_585, g_Std_energy_625);
						g_Std_msd_result.hw_detected_std = ATV_SOUND_STD_NICAM_DK;
					}
				}
				//case4: A2DK1 is fake, but ATV_SOUND_STD_DK_MONO is true
				else if (((g_Std_energy_625 >> 1) < g_Std_energy_674)&& (g_Std_energy_625<sub_thresh)) {
					alog_info("Error A2DK1 %x %x \n", g_Std_energy_674, g_Std_energy_625);
					g_Std_msd_result.hw_detected_std = ATV_SOUND_STD_DK_MONO;
				}else{
					force_a2_DK123.regValue = AIO_ReadRegister(AUDIO_carrier_freq_deviation_ctrl_reg);
					force_a2_DK123.force_a2_dk_sel = ATV_FORCE_A2_DK1;
					Audio_HwpWriteRegister(AUDIO_carrier_freq_deviation_ctrl_reg, force_a2_DK123.regValue);
                    			audio_hw_usleep(10*1000); //wait 10ms
					AtvGetA2HwSoundMode(&sound_mode, FALSE);
					if(sound_mode == ATV_SOUND_MODE_MONO){
						//alog_info("Fake detect 0x%x, change to DK MONO\n", g_Std_msd_result.hw_detected_std);
						g_Std_msd_result.hw_detected_std = ATV_SOUND_STD_DK_MONO;
					}
				}
			} else if (g_Std_msd_result.hw_detected_std == ATV_SOUND_STD_A2_DK2) {
				//case1: A2KD2 is fake, but ATV_SOUND_STD_A2_DK1 is true //2019/10/1 nio added
				if (((g_Std_energy_625 >> 1) > g_Std_energy_674) && (g_Std_energy_625>=sub_thresh)) {
					alog_info("Error A2DK2 and go to A2DK1, %x %x \n", g_Std_energy_625, g_Std_energy_674);
					g_Std_msd_result.hw_detected_std = ATV_SOUND_STD_A2_DK1;
				}
				//case2: A2KD2 is fake, but ATV_SOUND_STD_A2_DK3 is true //2019/10/1 nio added
				else if (((g_Std_energy_574 >> 1) > g_Std_energy_674) && (g_Std_energy_574>=sub_thresh)) {
					alog_info("Error A2DK2 and go to A2DK3, %x %x \n", g_Std_energy_574, g_Std_energy_674);
					g_Std_msd_result.hw_detected_std = ATV_SOUND_STD_A2_DK3;
				}
				//case3: A2KD2 is fake, but ATV_SOUND_STD_NICAM_DK is true //2019/10/1 nio added
				else if (g_Std_energy_585 > 0x100) {
					if ((g_Std_energy_574 >= sub_thresh) &&
							(g_Std_energy_585 >= sub_thresh) &&
							(g_Std_energy_595 >= sub_thresh)) {
						alog_info("Error A2DK2 and go to NicamDK, %x %x \n", g_Std_energy_585, g_Std_energy_674);
						g_Std_msd_result.hw_detected_std = ATV_SOUND_STD_NICAM_DK;
					}
				}
				//case4: A2DK2 is fake, but ATV_SOUND_STD_DK_MONO is true
				else if (((g_Std_energy_674 >> 1) < g_Std_energy_625) && (g_Std_energy_674<sub_thresh)) {
					alog_info("Error A2DK2 %x %x \n", g_Std_energy_625, g_Std_energy_674);
					g_Std_msd_result.hw_detected_std = ATV_SOUND_STD_DK_MONO;
				}else{
					force_a2_DK123.regValue = AIO_ReadRegister(AUDIO_carrier_freq_deviation_ctrl_reg);
					force_a2_DK123.force_a2_dk_sel = ATV_FORCE_A2_DK2;
					Audio_HwpWriteRegister(AUDIO_carrier_freq_deviation_ctrl_reg, force_a2_DK123.regValue);
                    			audio_hw_usleep(10*1000); //wait 10ms
					AtvGetA2HwSoundMode(&sound_mode, FALSE);
					if(sound_mode == ATV_SOUND_MODE_MONO){
			...
			} else if (g_Std_msd_result.hw_detected_std == ATV_SOUND_STD_A2_DK3) {
				//case1: A2KD3 is fake, but ATV_SOUND_STD_A2_DK1 is true
				if (((g_Std_energy_674 >> 1) > g_Std_energy_574) && (g_Std_energy_674>=sub_thresh)) {
					alog_info("Error A2DK3 and go to A2DK1, %x %x \n", g_Std_energy_625, g_Std_energy_574);
					g_Std_msd_result.hw_detected_std = ATV_SOUND_STD_A2_DK1;
				}
				//case2: A2KD1 is fake, but ATV_SOUND_STD_A2_DK3 is true
				else if (((g_Std_energy_625 >> 1) > g_Std_energy_574) && (g_Std_energy_625>=sub_thresh)) {
					alog_info("Error A2DK3 and go to A2DK2, %x %x \n", g_Std_energy_674, g_Std_energy_574);
					g_Std_msd_result.hw_detected_std = ATV_SOUND_STD_A2_DK2;
				}
				//case3: A2KD3 is fake, but ATV_SOUND_STD_NICAM_DK is true
				else if (g_Std_energy_585 > 0x100) {
					if ((g_Std_energy_574 >= sub_thresh) &&
							(g_Std_energy_585 >= sub_thresh) &&
							(g_Std_energy_595 >= sub_thresh)) {
						alog_info("Error A2DK3 and go to NicamDK, %x %x \n", g_Std_energy_585, g_Std_energy_574);
						g_Std_msd_result.hw_detected_std = ATV_SOUND_STD_NICAM_DK;
					}
				}
				//case4: A2DK3 is fake, but ATV_SOUND_STD_DK_MONO is true
				else if (((g_Std_energy_574 >> 1) < g_Std_energy_674)&& (g_Std_energy_574<sub_thresh)) {
					alog_info("Error A2DK3 %x %x \n", g_Std_energy_674, g_Std_energy_574);
					g_Std_msd_result.hw_detected_std = ATV_SOUND_STD_DK_MONO;
				}else{
					force_a2_DK123.regValue = AIO_ReadRegister(AUDIO_carrier_freq_deviation_ctrl_reg);
					force_a2_DK123.force_a2_dk_sel = ATV_FORCE_A2_DK3;
					Audio_HwpWriteRegister(AUDIO_carrier_freq_deviation_ctrl_reg, force_a2_DK123.regValue);
					audio_hw_usleep(10*1000); //wait 10ms
					AtvGetA2HwSoundMode(&sound_mode, FALSE);
					if(sound_mode == ATV_SOUND_MODE_MONO){
		...
		//AtvCheckA2DK3rdTone();
		//Double Check sound mode, if sound mode= mono, change to mono
		if(g_CurrentStd == ATV_SOUND_STD_A2_DK1 || g_CurrentStd == ATV_SOUND_STD_A2_DK2 || g_CurrentStd == ATV_SOUND_STD_A2_DK3)
		{
			AtvGetA2HwSoundMode(&sound_mode, FALSE);
			if(sound_mode == ATV_SOUND_MODE_MONO)
			{
				...
				{
					g_Std_msd_result.hw_detected_std = ATV_SOUND_STD_DK_MONO;
					alog_info("Fake current:0x%x, change to DK MONO\n", g_CurrentStd);
				}
			}
			else
			{
	...
	//to avoid BG mono/A2 change frequently when g_user_config is not AUDIO_USER_CONFIG_TV001  there is a probility that the thread doesn't do into this patch
	 if (g_user_config == AUDIO_USER_CONFIG_TV001){
//to avoid BG mono/A2 change frequently
		AtvGetA2HwSoundMode(&sound_mode, FALSE);
		if(sound_mode == ATV_SOUND_MODE_MONO){		
			g_Std_msd_result.hw_detected_std = ATV_SOUND_STD_BG_MONO;	//g_CurrentStd			
			alog_info("Fake detect BG A2, change to BG MONO\n");
		}
           }
	}
	}
...
static void AtvSetDeviation(uint32_t sound_std, uint32_t bwid)
{
	...
	//alog_info("dev..........g_DevBySoundStd %x\n", g_DevBySoundStd);
	...
	case ATV_SOUND_STD_NICAM_L:
		...
		if (bwid == FM_BW_SUPER) {                //+- 370kHz Old...+/-300kHz
			...
			if(g_sif_highdev_offset != 7)
			{
				g_sif_highdev_offset = 7;
				alog_info("[%s]global_ctr.hdv_mode_sel= %d, g_sif_highdev_offset= %d\n", __FUNCTION__, global_ctr.hdv_mode_sel, g_sif_highdev_offset);
				Audio_HwpSetVolume_SIF();
			}
...
void AtvSwitch2NicamAnalog(void)
{
	...
	*/
	...
	if (global_ctrl_1.hdv_mode_sel == 1)
		g_sif_highdev_offset = 7;
	else
		g_sif_highdev_offset = 0;
...
void AtvSwitch2NicamDigial(void)
{
	...
	*/
	...
	{
		g_sif_highdev_offset = 0;
		alog_info("[%s] g_sif_highdev_offset= %d\n", __FUNCTION__, g_sif_highdev_offset);
		Audio_HwpSetVolume_SIF();
	}
...
#define NORMALDECTEDTHD_super (10)	// NICAM/A2 STD change to MONO case
...
//	unsigned int First_SoundStdDebounce = 0, First_Timeout = 0;
//	static unsigned int HWunstable_check_1st= 0;
...
#else
// [Fix me] Refine patch again and add customized API to change debounce cnt
				...
				if (g_TVAudioReady == 1 && g_CurrentHWDetectStd != ATV_SOUND_STD_UNKNOWN) {
					if ((g_CurrentHWDetectStd == ATV_SOUND_STD_NICAM_BG && detectStd_normal == ATV_SOUND_STD_BG_MONO) ||
              				...
              				(g_CurrentHWDetectStd == ATV_SOUND_STD_A2_DK1 && detectStd_normal == ATV_SOUND_STD_DK_MONO && g_CurSifType == ATV_AUDIO_SIF_DVB_AJJA_SELECT) ||
              				(g_CurrentHWDetectStd == ATV_SOUND_STD_A2_DK2 && detectStd_normal == ATV_SOUND_STD_DK_MONO && g_CurSifType == ATV_AUDIO_SIF_DVB_AJJA_SELECT) ||
              				(g_CurrentHWDetectStd == ATV_SOUND_STD_A2_DK3 && detectStd_normal == ATV_SOUND_STD_DK_MONO && g_CurSifType == ATV_AUDIO_SIF_DVB_AJJA_SELECT) ||
              				(g_CurrentHWDetectStd == ATV_SOUND_STD_DK_MONO && detectStd_normal == ATV_SOUND_STD_A2_DK1 && g_CurSifType == ATV_AUDIO_SIF_DVB_AJJA_SELECT) ||
              				(g_CurrentHWDetectStd == ATV_SOUND_STD_DK_MONO && detectStd_normal == ATV_SOUND_STD_A2_DK2 && g_CurSifType == ATV_AUDIO_SIF_DVB_AJJA_SELECT) ||
              				(g_CurrentHWDetectStd == ATV_SOUND_STD_DK_MONO && detectStd_normal == ATV_SOUND_STD_A2_DK3 && g_CurSifType == ATV_AUDIO_SIF_DVB_AJJA_SELECT))
              			{
						detectStd_countTH = NORMALDECTEDTHD_super;
					} else {
						detectStd_countTH = NORMALDECTEDTHD;
		...
		if ((g_CurrentStd == (int32_t)newStd) ||  (g_isAutoDetect != ATV_SOUND_STD_AUTO))
			{
				//alog_info("std change return...... %x %x %x %x \n", g_CurrentStd, newStd, g_isAutoDetect, AIO_ReadRegister(AUDIO_msd_result_reg));
			return;
			}
	...
	if (g_StdchangeNoMuteFlag == 0)      // if g_StdchangeNoMuteFlag=0,need to mute but if g_StdchangeNoMuteFlag=1 is special case, doesn't mute
		AtvSetMute(ATV_ENABLE);
//Move this patch to Audio_HwSIFRetrunSoundStandard 
#if 0
	// first time inter ATV, audio HW check detection stable and auto set correct soud std if AP set sound std incorrect parameter
	if (HWunstable_check_1st == 0 && g_user_config != AUDIO_USER_CONFIG_TV001){
		while(1)
		{
			...
			if (msd_result.hw_detected_std != ATV_SOUND_STD_UNKNOWN)
			{
				++ First_SoundStdDebounce;
			}
			else
			{
				First_SoundStdDebounce = 0;
			}

			if (First_SoundStdDebounce >= First_DEBOUNCE_TIME)
			{
				alog_info("HW_unstable_check %x %x %x %x %d \n", g_CurrentStd, newStd, g_isAutoDetect, AIO_ReadRegister(AUDIO_msd_result_reg), First_Timeout);
				if (g_CurrentStd != msd_result.hw_detected_std){
					ATV_SOUND_STD_MAIN_SYSTEM mainStd = 0;
					newStd = msd_result.hw_detected_std;
					...
					//alog_info("std change to HW detection %x %x %x %x %d \n", g_CurrentStd, newStd, g_isAutoDetect, AIO_ReadRegister(AUDIO_msd_result_reg), First_Timeout);
				}else{
					//alog_info("set mode std equal to HW detection %x %x %x %x %d \n", g_CurrentStd, newStd, g_isAutoDetect, AIO_ReadRegister(AUDIO_msd_result_reg), First_Timeout);
					newStd = g_UserStd;
				}

				break;
			}else if (First_Timeout > 45){
					alog_info("First_Timeout...!!! %d \n", First_Timeout);
					break;
			}
	...
	if (setStdFlag == 1) {
		...
		ATV_SOUND_STD_MAIN_SYSTEM mainStd = 0;
			//alog_info("[%s] Auto std change, newStd=0x%x\n", __FUNCTION__, newStd);
			//AtvChangeStdCleanData(); //Clayton: No need to clean data
		mainStd = (ATV_SOUND_STD_MAIN_SYSTEM)AtvGetMainSystem(newStd);
		Audio_AtvSetSoundStd(mainStd, (ATV_SOUND_STD)newStd); // replace AtvSetNewSoundStd()
	}
...
void  Audio_HwCheckNoSignal(void)
{
	int32_t Tone45, Tone55, Tone60, Tone65;
	int32_t NoSignalTH = 0x500;

	Tone45 = AIO_ReadRegister(AUDIO_msd_mag_4_5_reg);
	Tone55 = AIO_ReadRegister(AUDIO_msd_mag_5_5_reg);
	Tone60 = AIO_ReadRegister(AUDIO_msd_mag_6_reg);
	Tone65 = AIO_ReadRegister(AUDIO_msd_carrier_6_5_reg);

	if ((Tone45 < NoSignalTH) && (Tone55 < NoSignalTH)&& (Tone60 < NoSignalTH) && (Tone65 < NoSignalTH))
	{
		g_NoSignalCount ++;
		//alog_info("g_NoSignalFlag_0=%x %x %x %x %x\n", Tone45, Tone55, Tone60, Tone65, AIO_ReadRegister(AUDIO_msd_result_reg));
	}
	else
	{
		//alog_info("g_NoSignalFlag_1=%x %x %x %x %x\n", Tone45, Tone55, Tone60, Tone65, AIO_ReadRegister(AUDIO_msd_result_reg));
		g_NoSIFFlag = 0;
		g_NoSignalCount = 0;
	}

	if(g_NoSignalCount >8)
	{
		g_NoSIFFlag = 1;
		//alog_info("g_NoSignalFlag=%d %d %x \n", g_NoSIFFlag, g_NoSignalCount, Tone65);
	}
}
...
#define LOWPSTHRESHOLD (0xC) // 0x30 -> 0xC, only 4bit in TV001_k5
...
{
	//alog_info("AtvChangeDeviation(%x), %x\n", newStd, bwid);
...
#if 0
#define  MONODELAY_CNT (15)  // 19 ->15
#else
#define  MONODELAY_CNT (1)  // 19 ->15
#endif
	...
	if (CHANGESTDSTATUS_FIRST_TIME == g_ChangeStdStatus) {
		...
		if (g_ContinueMonoNum == FIRSTTIMEMONOCHECKTIME) {
			...
			
			{
				...
				if(g_CurrentStd == ATV_SOUND_STD_MN_MONO && g_CurSifType == ATV_AUDIO_SIF_DVB_CN_SELECT)
				{// #23130 CN model modify outpt gain, DVB/CN/NTSC_A2
					if(g_sif_gain_finetuning != -12)
					{
						g_sif_gain_finetuning = -12; //x /8 db
						alog_info("[%s]g_sif_gain_finetuning= %d %d\n", __FUNCTION__, g_sif_gain_finetuning, __LINE__);
						Audio_HwpSetVolume_SIF();
					}
				}

				if(g_CurrentStd == ATV_SOUND_STD_MN_MONO && g_CurSifType == ATV_AUDIO_SIF_DVB_AJJA_SELECT)
				{// #22424 AJJA model modify outpt gain
					if(g_sif_gain_finetuning != -12)
					{
						g_sif_gain_finetuning = -12; //x /8 db
						alog_info("[%s]g_sif_gain_finetuning= %d %d\n", __FUNCTION__, g_sif_gain_finetuning, __LINE__);
				...
				alog_info("m r p s %d %x\n", g_ContinueMonoNum, g_CurrentStd);
...
void AtvGetA2HwSoundMode(ATV_SOUND_MODE *p_sound_info, bool check_pilot)
{
	...
	// get analog sound_mode
	md_status_1.regValue = AIO_ReadRegister(AUDIO_md_status_1_reg);
	md_status_2.regValue = AIO_ReadRegister(AUDIO_md_status_2_reg);
	md_status_3.regValue = AIO_ReadRegister(AUDIO_md_status_3_reg);
	//alog_info("[%s]Mode result %d, Max_other=0x%x, Max_dual=0x%x, Max_stereo=0x%x\n",__FUNCTION__, md_status_2.mode_result, md_status_1.max_other, md_status_2.max_dual, md_status_3.max_stereo);

	if (p_sound_info) {
		*p_sound_info = (ATV_SOUND_MODE)md_status_2.mode_result;
		//if (md_status_2.mode_result == 3 || g_A2_TH_sel == 100) {	// not for g_A2_TH_sel=100
		if (md_status_2.mode_result == 3) {
...
void AtvChageA2SoundMode(ATV_SOUND_MODE sound_mode)
{
	...
	//alog_info("AtvChageA2SoundMode......%d\n",  sound_mode);
	...
	//Compensate A2 Dual Main only for Korea model
	if(g_CurSifType == ATV_AUDIO_SIF_KOREA_A2_SELECT){
		alog_info("Soundmode = %x, Language = %x %d\n",g_A2_soundmode, g_UserTVA2Language, g_sif_offset);

		//modify output gain of SIF function for A2M, Tune the ATV Signal mono/stereo by sw bypass(standard signal: -14dB)
             //Check the bypass level(input gain: 7F00, SPDIF Output gain: 7F00), RL 200602, KTASKWBS-16876, KTASKWBS-17156
		if(g_A2_soundmode ==  ATV_SOUND_MODE_STEREO && g_UserTVA2Language == 0){
			if(g_sif_gain_finetuning != 32)
			{ //#21547, modify KR gain setting
				g_sif_gain_finetuning = 32; //x /8 db
				alog_info("[%s]g_sif_gain_finetuning= %d %d\n", __FUNCTION__, g_sif_gain_finetuning, __LINE__);
				Audio_HwpSetVolume_SIF();
			}
		}else if(g_A2_soundmode ==  ATV_SOUND_MODE_DUAL && g_UserTVA2Language == 0){//main sound
			if(g_sif_gain_finetuning != 34)
			{
				g_sif_gain_finetuning = 34; //x /8 db
				alog_info("[%s]g_sif_gain_finetuning= %d %d\n", __FUNCTION__, g_sif_gain_finetuning, __LINE__);
				Audio_HwpSetVolume_SIF();
			}
		}else if(g_A2_soundmode ==  ATV_SOUND_MODE_DUAL && g_UserTVA2Language == 1){//sub sound
			if(g_sif_gain_finetuning != 34)
			{
				g_sif_gain_finetuning = 34; //x /8 db
				alog_info("[%s]g_sif_gain_finetuning= %d %d\n", __FUNCTION__, g_sif_gain_finetuning, __LINE__);
			...
			if(g_sif_gain_finetuning != 29)
			{
				g_sif_gain_finetuning = 29; //x /8 db
				alog_info("[%s]g_sif_gain_finetuning= %d %d\n", __FUNCTION__, g_sif_gain_finetuning, __LINE__);
				Audio_HwpSetVolume_SIF();
			}
		}
	...
	case 	ATV_SOUND_MODE_MONO  :
		...
		MD_CTRL_REG.max_threshold = A2_Th_Table[g_A2_TH_sel].max_threshold;
		alog_info("[%s]MONO %x %x %x\n",__FUNCTION__,MD_CTRL_REG.max_threshold, A2_Th_Table[g_A2_TH_sel].max_threshold, A2_Th_Table[g_A2_TH_sel].schmitt_window);
	...
	if (p_sound_info) {
		...
		case 2:
			*p_sound_info = 	ATV_SOUND_MODE_DUAL;
			break;
		case 6:
			*p_sound_info = 	ATV_SOUND_MODE_DATA;
			break;
		default :
		case 4:
			*p_sound_info = 	ATV_SOUND_MODE_MONO;
...
void NicamSignalProcess(void)
{
	...
	audio_nicam_decode_status_RBUS nicam_decode_status;
	audio_msd_crtl_word_RBUS	MSD_CTRL_REG; //Clayton, 2018/7/9
	audio_msd_result_RBUS MSD_RESULT_REG; //Clayton, 2018/7/9
	audio_nicam_auto_switch_RBUS nicam_auto_switch; //Clayton, 2018/7/9
...
#if 0
#define  FIRSTTIMECHECKTIME (10)  //8->6 // keep std change sequence for normal case
#else
#define  FIRSTTIMECHECKTIME (5)  //8->6 //for g_user_config == AUDIO_USER_CONFIG_TV001 used
#endif
...
#define NICAMSOUNDCHANGEMAX  (3) //10 -> 1
	...
	if (CHANGESTDSTATUS_FIRST_TIME == g_ChangeStdStatus) {
		...
		if (g_ContinueNicamNum <= NicamFirstTimeCheckloop) { // no signal now
			...
			case ATV_SOUND_MODE_DUAL: // no this case
				g_FirstTimeSoundMode[2] = g_FirstTimeSoundMode[2] + 1;
				break;
			case ATV_SOUND_MODE_DATA: // no this case
...
#define NICAM_SOUNDMODE_OUT_CNT 3
			...
			if (maxindex == 0)
				...
				g_nicam_soundmode = ATV_SOUND_MODE_DATA;
			else
			...
			if (g_NicamSignalStable == 1) { // unstable , can detected
				...
				if (AtvIsPlayDigitalState()) {
					alog_info("4 to ana\n");
					alog_err("[Clayton-0709]Nicam unstable but keep play Nicam\n");
					//AtvSwitch2NicamAnalog();
				}

				alog_err("[Clayton-0711-1]Nicam unstable but keep play Nicam, no need auto recovery\n");
				/*
			...
			nicam_decode_status.regValue = AIO_ReadRegister(AUDIO_nicam_decode_status_reg);
			nicam_auto_switch.regValue = AIO_ReadRegister(AUDIO_nicam_auto_switch_reg);
			...
			else if (maxerrorrate == 0 && g_Std_energy_6552== 0 && ((g_Std_energy_6552 + 0x500/*0x1000*/) < g_Std_energy_65) && g_CurrentStd == ATV_SOUND_STD_NICAM_I)
			{
				g_nicam_carrier_shift++;
				if (g_nicam_carrier_shift > NICAM_CARRIER_SHIFT_TH) {
					g_nicam_carrier_shift = NICAM_CARRIER_SHIFT_TH + 1;
			...
			nicam_decode_status.regValue = AIO_ReadRegister(AUDIO_nicam_decode_status_reg);
			if (maxerrorrate >= g_NicamErrorRateThresholdNormal && nicam_decode_status.true_detect == 0) {
				g_errorRateDebunce--;
			...
			if (g_NicamSignalStable == 1) { // singal stable
				...
				if (AtvIsPlayDigitalState()) {
					//alog_info("4 to ana\n");
					alog_info("[Clayton2-0709]Nicam unstable but keep play Nicam\n");
					//AtvSetMute(ATV_ENABLE);  //Clayton 0709
					//	drv_audio_set_backendplay(AUD_DISABLE);
					//	ScalerTimer_DelayXms(200);
					//audio_hw_usleep(70000); // 50 ms
					//AtvSwitch2NicamAnalog();  // Clayton0709
					//	drv_audio_set_backendplay(AUD_ENABLE);
					//audio_hw_usleep(250000); // 50 ms
					//AtvSetMute(ATV_DISABLE);  //Clayton 0709

					nicam_decode_status.regValue = AIO_ReadRegister(AUDIO_nicam_decode_status_reg);
					if(nicam_decode_status.true_detect == 0){
					AtvResetNicamOverflow(); // reset nicam precale  //Clayton0709
					alog_info("[Clayton-0711-1]clean Nicam overflow when true_det=0\n");
						}
				}
...
void AtvChageBTSCSoundMode(ATV_SOUND_MODE sound_mode)
{
	...
	case ATV_SOUND_MODE_MONO  :
		...
		if(g_sif_gain_finetuning != -12)
		{ //#22424 BR/TW/US modify output gain
			g_sif_gain_finetuning = -12; //x /8 db
			alog_info("[%s]g_sif_gain_finetuning= %d %d\n", __FUNCTION__, g_sif_gain_finetuning, __LINE__);
			Audio_HwpSetVolume_SIF();
		}
	...
	case ATV_SOUND_MODE_STEREO   :
		...
		if (g_UserTVBTSCISStereo == 0) {  // A
			...
			AtvBTSCoverModulationMode(0);
			if(g_sif_gain_finetuning != -8)
			{
				g_sif_gain_finetuning = -8; //x /8 db
				alog_info("[%s]g_sif_gain_finetuning= %d %d\n", __FUNCTION__, g_sif_gain_finetuning, __LINE__);
				Audio_HwpSetVolume_SIF();
			}
	...
	case 	ATV_SOUND_MODE_SAP_MONO   :
		...
		if (g_UserTVBTSCSAP == 0) {    // Clayton ; Date: 2012/6/25
			...
			if(g_sif_gain_finetuning != -76)
			{
				g_sif_gain_finetuning = -76; //x /8 db
				alog_info("[%s]g_sif_gain_finetuning= %d %d\n", __FUNCTION__, g_sif_gain_finetuning, __LINE__);
				Audio_HwpSetVolume_SIF();
			}
...
/*
	if (sifsource == SIF_FROM_SIF_ADC) {
		audio_sif_adc_release_flow();
		alog_info("SIFpath Released\n");
	}
*/
	AtvSetMute(ATV_DISABLE);
...
EXPORT_SYMBOL(Audio_AtvCleanTVSourceData);
...
{
#if 0
	#ifdef NO_USE_HW_AQ	//RTD289X SIF-EQ has distortion issue, keep using HW-EQ to compensate BTSC & AM freq response
	if(g_user_config == AUDIO_USER_CONFIG_TV001){
...
void AtvBTSCoverModulationMode(uint32_t Enable)
{
	//ML4SONYAND-1027 ryanliao 20190306
	audio_msd_result_RBUS MSD_RESULT_REG;
	MSD_RESULT_REG.regValue = AIO_ReadRegister(AUDIO_msd_result_reg);
	if (Enable == TRUE){
		MSD_RESULT_REG.reg_std =0x0;
		alog_info("BTSCoverModulationMode_Force_MN\n");
	}else{
		MSD_RESULT_REG.reg_std =0x1;
	}
	AIO_WriteRegister(AUDIO_msd_result_reg, MSD_RESULT_REG.regValue);
}
#ifndef TV001_BOARD
...
void AtvEnableAMFreqCompensate(uint32_t Enable)
{
	...
	if (Enable == TRUE)
	{
		if (g_sif_AMcomp_offset != -40)
		{
			g_sif_AMcomp_offset = -40;
			Audio_HwpSetVolume_SIF();
...
#define  FIRSTTIMEBTSCCHECKTIME (8)
	...
	//audio_btsc_sap_noise_RBUS btsc_sap_noise; //mark un-used code by ryanlan
	//uint32_t sap_noise_dis = 0; //mark un-used code by ryanlan
//#define SAP_NOISE_DIST (0x10)//mark un-used code by ryanlan
//#define SAP_SPEED_UP_DEBOUNCE (g_BTSCSOUNDCHANGEMAX) //mark un-used code by ryanlan
...
#define BTSC_SOUNDMODE_OUT_CNT 4
			...
			if (g_ContinueBTSCNum == (BtscFirstTimeCheckloop)) {
				...
				{
					audio_msd_status_RBUS msd_status;
					audio_btsc_pilot_thres_RBUS btsc_pilot_thres;

					msd_status.regValue = AIO_ReadRegister(AUDIO_msd_status_reg);
					btsc_pilot_thres.regValue = AIO_ReadRegister(AUDIO_btsc_pilot_thres_reg);
					if (btsc_pilot_thres.fm_radio_en == 0 && g_btsc_soundmode == ATV_SOUND_MODE_MONO)
					{
						alog_err("fm_radio_en = 1\n");
						btsc_pilot_thres.fm_radio_en = 1;
						AIO_WriteRegister(AUDIO_btsc_pilot_thres_reg, btsc_pilot_thres.regValue);
						g_sif_BTSC_FMradio_comp = 48; // SIF gain 6dB
						Audio_HwpSetVolume_SIF();
						//HwpSetVolume_SIF(g_sif_offset);
					}
					else if (g_btsc_soundmode != ATV_SOUND_MODE_MONO && btsc_pilot_thres.fm_radio_en == 1)
					{
						alog_err("fm_radio_en = 0\n");
						btsc_pilot_thres.fm_radio_en = 0;
						AIO_WriteRegister(AUDIO_btsc_pilot_thres_reg, btsc_pilot_thres.regValue);
						g_sif_BTSC_FMradio_comp = 0; // SIF gain 0dB
						Audio_HwpSetVolume_SIF();
						//HwpSetVolume_SIF(g_sif_offset);
					}
				}
	...
	//btsc_pilot_phase_delta.regValue = AIO_ReadRegister(AUDIO_btsc_pilot_phase_delta_reg); //remove, keep setting 0xA7D44F3
	phase_error_pi_gain.regValue = AIO_ReadRegister(AUDIO_phase_error_pi_gain_reg);
	if (phase_error_count > (FIRSTTIMEBTSCCHECKTIME / 2 - 1)) { //phase_error_count >4
		//if (btsc_pilot_phase_delta.pilot_phase_delta == ATV_PILOT_PHASE_DELTA_Others) { //0xA7D44F3
		//	phase_error_pi_gain.unlock_i_gain = 0x8;
		//	phase_error_pi_gain.unlock_p_gain = 0x8;
		//	AIO_WriteRegister(AUDIO_phase_error_pi_gain_reg, phase_error_pi_gain.regValue);
		//	Audio_AtvChangebtscpilotphasedelta(ATV_PILOT_PHASE_DELTA_PAL_MN); //0xA6AAAAA
		//	alog_info("It's PAL N BTSC, shift stereo pilot\n");
		//	phase_error_count = 0;
		//} else {
			phase_error_pi_gain.unlock_i_gain = 0xa;
			phase_error_pi_gain.unlock_p_gain = 0xa;
			AIO_WriteRegister(AUDIO_phase_error_pi_gain_reg, phase_error_pi_gain.regValue);
			Audio_AtvChangebtscpilotphasedelta(ATV_PILOT_PHASE_DELTA_Others); //0xA7D44F3
			alog_info("It's PAL M or NTSC BTSC, shift stereo pilot\n");
			phase_error_count = 0;
		//}
	}
	...
	if ((noSap_check_flag == 0) && (g_btsc_soundmode_debounce != 0) && (g_btsc_soundmode == ATV_SOUND_MODE_SAP_STEREO || g_btsc_soundmode ==ATV_SOUND_MODE_SAP_MONO) && (sound_mode != g_btsc_soundmode_prev)) {
		g_btsc_soundmode = sound_mode;
		g_changeSoundMode = 1;
		firsttimedetect = 1;
		g_btsc_soundmode_debounce = g_BTSCSOUNDCHANGEMAX;
		noSap_check_flag = 1;
	}
	...
	*/
	...
	if (noSap_check_flag ||changeSelectFlag || ((g_changeSoundMode) && (g_Start2NormalProcess == 1)))    //changeSelectFlag is indenpendent on g_Start2NormalProcess.
											  //if( (changeSelectFlag || g_changeSoundMode) && (g_Start2NormalProcess == 1) )	//Clayton, no need to change FIFO source select
	{
		...
		//	}
// refine the noSap_check_flag =0, it should be all cases.
		if ( noSap_check_flag == 1) {
			AtvSetMute(ATV_DISABLE);
			noSap_check_flag = 0;
		}
...
void AtvCheckTask(void)
{
	...
	if ((sifsource == SIF_FROM_SIF_ADC) && (g_StartFromSIFResume == 1)){
		audio_sif_adc_initial_flow();
		g_StartFromSIFResume = 0;
	}

	//alog_info("[Audio][Clayton]Start entering AtvCheckTask\n");			//Clayton 2012/7/3
	AtvStdChangeProcess();
	
	Audio_HwCheckNoSignal();
	...
	{
                alog_info("[Audio][FM_RADIO]Start signal process task\n");		
                AtvBTSCSignalProcess();
	}
...
#endif
	AIO_WriteRegister(AUDIO_msd_crtl_word_reg, msd_ctrl_word.regValue);
	AtvSetHwDetecteMode(ATV_HW_CARRIER_SHIFT_BANDWIDTH_MONO_ONLY);
// [Fix me] Which one is better for auto scan?
/*
...
{
	//	alog_info( "[audio ] exit set channel \n");
	AtvUpdateState(ATV_TASK_RUN);
}
...
EXPORT_SYMBOL(Audio_AtvEnterAtvSource);
...
EXPORT_SYMBOL(Audio_AtvSetBTSCSoundSelect);
...
EXPORT_SYMBOL(Audio_AtvSetNICAMSoundSelect);
...
EXPORT_SYMBOL(Audio_AtvSetA2SoundSelect);
...
EXPORT_SYMBOL(Audio_AtvPauseTVStdDetection);
...
EXPORT_SYMBOL(Audio_AtvSetAudioInHandle);
...
EXPORT_SYMBOL(Audio_AtvSetSubAudioInHandle);
...
EXPORT_SYMBOL(Audio_AtvForceFirstTimeMonoSoundFlag);
...
EXPORT_SYMBOL(Audio_AtvSetNicamErrorRateThreshold);

void Audio_AtvSetNicamErrorRateDebounce(int MaxDebounce)
{
	g_NicamMaxErrorDebounce	= MaxDebounce;
}
EXPORT_SYMBOL(Audio_AtvSetNicamErrorRateDebounce);
...
EXPORT_SYMBOL(Audio_AtvSetDeviationMethod);
...
EXPORT_SYMBOL(Audio_AtvSetDevBandWidth);
...
//0: no down
// Clayton 2019/9/11
// Forbidden to use, because there is no need to down 6dB
// Normal dev: 0dB ; High dev: -0.9dB
// Need to use SIF_Vol for High dev => SIF_Vol=0dB for Normal deviation ; +0.875dB for High deviation
void Audio_AtvSetFMoutDownGain(int para)
{
	alog_info("Forbidden to use down 6dB\n");
/*
	audio_a2_eiaj_demod_RBUS a2_eiaj_demod;
...
EXPORT_SYMBOL(Audio_AtvSetFMoutDownGain);
...
{
	return g_NicamSignalStable2;
}
EXPORT_SYMBOL(Audio_AtvGetNicamSignalStable);

void  Audio_AtvConfigNoSignalNeed2Mute(uint32_t isNeed2Mute)
{
	g_NoSignalNeedToMuteFlag = isNeed2Mute;
}
EXPORT_SYMBOL(Audio_AtvConfigNoSignalNeed2Mute);
...
EXPORT_SYMBOL(Audio_HwpSetSIFDataSource);
...
EXPORT_SYMBOL(Audio_HwpSIFSetA2StereoDualTH);

void  Audio_HwpSIFGetA2StereoDualTH(uint32_t *a2_th)
{
	*a2_th = g_A2_TH_sel;
}
EXPORT_SYMBOL(Audio_HwpSIFGetA2StereoDualTH);
...
EXPORT_SYMBOL(Audio_HwpSIFSetNicamTH);
...
EXPORT_SYMBOL(Audio_HwpSIFGetNicamTH);
...
else
{
	...
	msd_result.regValue = AIO_ReadRegister(AUDIO_msd_result_reg);
	alog_info("HW detect STD= %x, real_main_sys = %x, real_sound_std = %x, main_sys = %d %x\n", msd_result.hw_detected_std, real_main_sys, real_sound_std, main_sys, p_sound_std);
	if (main_sys == ATV_SOUND_AUTO_SYSTEM) {  // unstable signal
		...
		} else if ((real_main_sys == ATV_SOUND_I_SYSTEM) || ((real_main_sys == ATV_SOUND_UNKNOWN_SYSTEM) && (SIF_Tone.SIF_6p0 > SIF_Tone.SIF_4p5) && (SIF_Tone.SIF_6p0 > ATV_STD_THRESHOLD_HIGH))) {//HKTTANDP-12, RL
			Audio_HwpSIFGetMainToneMag(real_main_sys, &ToneMag);
			noise_tone[0] = SIF_Tone.SIF_4p5;
	...
	//It will cover the chroma of next NTSC channel in band, and make MN system detect to I system.
			//if(abs(SIF_Tone.SIF_4p5 - SIF_Tone.SIF_5p25) > ATV_LOW_TH_THRESHOLD_HIGH) //check MN system existed or not
	{
		...
		ATV_SOUND_STD_MAIN_SYSTEM	recheck_main_sys = ATV_SOUND_UNKNOWN_SYSTEM;
			...
			alog_info("recheck_main_sys %d\n", recheck_main_sys);
				...
				// ryanliao 20190114 [M6p353]
				if(recheck_main_sys == ATV_SOUND_MN_SYSTEM && AtvCheckVideoTiming(ATV_SOUND_MN_SYSTEM) == 1)
			{
					alog_info("%s, %d", __FUNCTION__, __LINE__);
				real_sound_std = recheck_sound_std;
					real_main_sys = ATV_SOUND_MN_SYSTEM;
	...
	if (main_sys == real_main_sys || main_sys == ATV_SOUND_AUTO_SYSTEM) {
		...
		*pToneSNR = ToneMag;    // Return SIF magnitude
		...
		if (real_main_sys == ATV_SOUND_UNKNOWN_SYSTEM) {
			*pToneSNR = 0;
		}
	} else
		{
		*pToneSNR = 0;  //main_sys != real_main_sys, real_main_sys is true main_sys
		}
...
EXPORT_SYMBOL(Audio_HwpSIFGetMainToneSNR);
...
EXPORT_SYMBOL(Audio_HwpSIFGetA2DKSubToneMag);
...
void  Audio_HwpSIFCheckNicamDigital(int *exist_flag)
{
	...
	if (g_CurSifType == ATV_AUDIO_SIF_DVB_IN_SELECT) {
		if (sound_std == ATV_SOUND_STD_NICAM_BG || sound_std == ATV_SOUND_STD_A2_BG) {    // Clayton 2013/1/3
...
EXPORT_SYMBOL(Audio_HwpSIFCheckNicamDigital);
...
void  Audio_HwpSIFDetectedSoundStandard(ATV_SOUND_STD *detected_sound_std)
{
	...
	*detected_sound_std = Audio_HwSIFRetrunSoundStandard(g_CurrentHWDetectStd);
	...
	//For India, it is only mono.
	if (g_CurSifType == ATV_AUDIO_SIF_DVB_IN_SELECT) {
		if (*detected_sound_std == ATV_SOUND_STD_NICAM_BG || *detected_sound_std == ATV_SOUND_STD_A2_BG) {  // mono
...
EXPORT_SYMBOL(Audio_HwpSIFDetectedSoundStandard);
...
EXPORT_SYMBOL(Audio_HwpSetAtvAudioBand);
...
void Audio_HwSetAPVREnable_Flag(uint8_t en) //for external demod apvr enable flag
{
#ifdef RTD289X
	Audio_sb2_arch_reg_RBUS     sb2_arch_reg;
	...
	sb2_arch_reg.regValue = AIO_ReadRegister(AUDIO_sb2_arch_reg_reg);
	if (en) {
		sb2_arch_reg.regValue =  sb2_arch_reg.regValue|AUDIO_SET_START_APVR_FLAG;
	} else {
		sb2_arch_reg.regValue =  sb2_arch_reg.regValue&(!AUDIO_SET_START_APVR_FLAG);
	}

	AIO_WriteRegister(AUDIO_sb2_arch_reg_reg, sb2_arch_reg.regValue);
	alog_info("[%s]AVD ASET_SWITCH_CH_FLAG 0x%x\n", __FUNCTION__, sb2_arch_reg.regValue);
#endif
}
...
EXPORT_SYMBOL(Audio_HwpSetChannelChange);
...
void Audio_HwpSetBandDelay(void)
{
	...
	//reset sif volume to 0dB
	// Put this reset in Audio_AtvSetSoundStd()
	// Because there is two ways to change std: (1) Switch ch (with SetBandDelay) (2) Auto STD change(without SetBandDelay) 
/*
	//[start]
	g_sif_offset = 0;
	g_sif_highdev_offset = 0;
...
EXPORT_SYMBOL(Audio_HwpSetBandDelay);
...
EXPORT_SYMBOL(Audio_HwpCurSifType);
...
EXPORT_SYMBOL(Audio_AtvSetDevOnOff);
...
static int set_sif_mute(unsigned int para)
{
	...
	#if 0
	while (1) {
// [Fix me] Please check this function correct or Merlin4 correct?
		audio_hw_usleep(1*1000);
		tvdemod_digital_volume_control.regValue = AIO_ReadRegister(AUDIO_TVdemod_Digital_Volume_Control_reg);
		if (para == 1 && tvdemod_digital_volume_control.switch_status_tvd == ATV_HW_IDLE_STATE)
		{
			break;
		}
		else if (para == 0 && tvdemod_digital_volume_control.switch_status_tvd == ATV_HW_FADE_OUT_DONE_STATE)
		{
			break;
		}
	...
	//APP_LOG("[AUDIO][DRV] %s() try_cntr(0x%08x)\n",__FUNCTION__,time_out);
	...
	while (1) {
		...
		if (1 == g_wait_tunner_delay_mute){
			g_wait_tunner_delay_mute = 0;
			break;
		}

		time_out++;
		if (time_out > 500) { // for Sts check, sif dvc mute no signal, mute/unmute count check fail (600 to 500)
			alog_info("%s() TimeOut(0x%x)!!!\n", __FUNCTION__, time_out);
			return AIO_ERROR;
		}
	}
	#endif
	alog_info("%s() END--set_sif_mute Apply %d \n", __FUNCTION__, g_wait_tunner_delay_mute);

	return AIO_OK;
}

/**
 * Top Set SIF  Digital Volume, trigger SIF vol update
 * Update content include
 * (1) g_sif_offset: External customization
 * (2) g_sif_highdev_offset: HW only for high deviation (+0.9dB)
 * (3) g_sif_AMcomp_offset: HW only for AM case EQ LPF ON (+5dB)
 * (4) g_sif_BTSC_FMradio_comp: HW only for BTSC MONO use FM_radio (+6dB)
 */
static void Audio_HwpSetVolume_SIF(void)
{
	int32_t sif_vol=0;
	sif_vol = g_sif_offset+g_sif_highdev_offset+g_sif_AMcomp_offset+g_sif_BTSC_FMradio_comp+g_sif_gain_finetuning;
	HwpSetVolume_SIF(sif_vol);
	alog_info("[%s] g_sif_offset= %d, g_sif_highdev_offset= %d, g_sif_AMcomp_offset= %d, g_sif_BTSC_FMradio_comp= %d, g_sif_gain_finetuning= %d\n", __FUNCTION__, g_sif_offset, g_sif_highdev_offset,g_sif_AMcomp_offset,g_sif_BTSC_FMradio_comp,g_sif_gain_finetuning);
}
...
void CleanSIFEQOverflow(void)
{
	...
	// Clayton add-- Step3: Clear overflow flag, Max clear 10 times
	do {
		eq_tvd_bp_control.regValue = AIO_ReadRegister(AUDIO_EQ_tvd_bp_Control_reg);
		eq_tvd_bp_control.regValue =eq_tvd_bp_control.regValue | 0x10;	//bit4: sif_eq_ovf wclr_out bit
		AIO_WriteRegister(AUDIO_EQ_tvd_bp_Control_reg, eq_tvd_bp_control.regValue);
	...
	eq_tvd_bp_control.regValue = AIO_ReadRegister(AUDIO_EQ_tvd_bp_Control_reg);
	eq_tvd_bp_control.eq_tvd_lp_enable = eq_tvd_bp_control_bk.eq_tvd_lp_enable;
	eq_tvd_bp_control.eq_tvd_band1_enable = eq_tvd_bp_control_bk.eq_tvd_band1_enable;
	eq_tvd_bp_control.eq_tvd_band2_enable = eq_tvd_bp_control_bk.eq_tvd_band1_enable;
	Audio_HwpWriteRegister(AUDIO_EQ_tvd_bp_Control_reg, eq_tvd_bp_control.regValue);
	...
	eq_tvd_bp_control.regValue = AIO_ReadRegister(AUDIO_EQ_tvd_bp_Control_reg);
	eq_tvd_bp_control.eq_tvd_deq_enable = eq_tvd_bp_control_bk.eq_tvd_deq_enable;
	Audio_HwpWriteRegister(AUDIO_EQ_tvd_bp_Control_reg, eq_tvd_bp_control.regValue);
	alog_info("CleanSIFEQLoudnessOverflow step8 : Enable Main power of SIF_EQ %x\n", eq_tvd_bp_control_bk.regValue);
}
...
int32_t AtvCheckVideoTiming(ATV_SOUND_STD_MAIN_SYSTEM main_sys)
{
	...
	uint32_t vd_sep_burst_ro_2, sep_443_burst, sep_358_burst, line_625_flag, sep_443_burst_hsync, sep_358_burst_hsync;
	int timing_match_flag = 0;

	int sep_358_burst_hsync_count = 10;
	int sep_358_burst_hsync_check = 0;
	int i = 0;
	int sep_443_burst_hsync_count = 10;
	int sep_443_burst_hsync_check = 0;
	...
	alog_info("vd_decision_mode_status, main_sys %d %d\n", vd_decision_mode_status, main_sys);
	alog_info("vd_sep_burst_ro_2 = %x\n", vd_sep_burst_ro_2);
	alog_info("line_625_flag = %x\n", line_625_flag);

	if (main_sys == ATV_SOUND_UNKNOWN_SYSTEM)
	{
		alog_info("...........CheckVideoTiming error, return SNR 0\n");
		return timing_match_flag =0;
	}

#if 1
	//HKTTANDP-12, RL
	if (line_625_flag == 1)//625 line
	{
		if (sep_443_burst > sep_358_burst){ //443
			if ((sep_443_burst > BURST_TH) && (main_sys == ATV_SOUND_BG_SYSTEM ||main_sys == ATV_SOUND_I_SYSTEM ||main_sys == ATV_SOUND_DK_SYSTEM ||main_sys == ATV_SOUND_L_SYSTEM)){
				timing_match_flag = 1;
				alog_info("video timing is BG/DK/I/L system, PAL system, return SNR 1 %d\n", __LINE__);
			}
	}

		if (sep_358_burst > sep_443_burst){ //358
			if ((sep_358_burst > BURST_TH) && main_sys == ATV_SOUND_MN_SYSTEM){
				timing_match_flag = 1;
				alog_info("video timing is MN system, MN system, return SNR 1 %d\n", __LINE__);
			}
	}
	
		if (timing_match_flag ==0 && (sep_443_burst == 0xff ||sep_358_burst == 0xff)){

	burst_location_hsync_reg.regValue = IoReg_Read32(VDTOP_BURST_LOCATION_HSYNC_reg);
	burst_location_hsync_reg.sep_hsync_start = 0x1;
	burst_location_hsync_reg.sep_hsync_end = 0x5a;
	IoReg_Write32(VDTOP_BURST_LOCATION_HSYNC_reg, burst_location_hsync_reg.regValue);
	
			for (i=0; i<10; i++){
				audio_hw_usleep(10000); //10ms
				sep_358_burst_hsync = (AIO_ReadRegister(VD_SEP_BURST_RO_2_VADDR) & 0x00FF0000) >> 16;

				if (sep_358_burst_hsync > BURST_TH){
					sep_358_burst_hsync_count++;
					//alog_info("sep_358_burst_hsync > BURST_TH count = %d %x\n", sep_358_burst_hsync_count, AIO_ReadRegister(VD_SEP_BURST_RO_2_VADDR));
					 if (sep_358_burst_hsync_count > 15)
					 {
						sep_358_burst_hsync_check = 1;
						alog_info("sep_358_burst_hsync_check >5 %d\n", sep_358_burst_hsync_count);
						break;
					 }
				}else if(sep_358_burst_hsync < BURST_TH){
					sep_358_burst_hsync_count--;
					//alog_info("sep_358_burst_hsync < BURST_TH count = %d %x\n", sep_358_burst_hsync_count, AIO_ReadRegister(VD_SEP_BURST_RO_2_VADDR));
					if (sep_358_burst_hsync_count < 5)
					 {
						sep_358_burst_hsync_check = 0;
						alog_info("sep_358_burst_hsync_check UNKNOWN %d\n", sep_358_burst_hsync_count);
						break;
					 }
				}else{
					alog_info("need recheck sep_358_burst_hsync %d\n", sep_358_burst_hsync_count);
					break;
			...
			for (i=0; i<10; i++){
				audio_hw_usleep(10000); //10ms
				//sep_358_burst_hsync = (AIO_ReadRegister(VD_SEP_BURST_RO_2_VADDR) & 0x00FF0000) >> 16;
	sep_443_burst_hsync = (AIO_ReadRegister(VD_SEP_BURST_RO_2_VADDR) & 0xFF000000) >> 24;

				if (sep_443_burst_hsync > BURST_TH){
					sep_443_burst_hsync_count++;
					//alog_info("sep_443_burst_hsync > BURST_TH count = %d %x\n", sep_443_burst_hsync_count, AIO_ReadRegister(VD_SEP_BURST_RO_2_VADDR));
					 if (sep_443_burst_hsync_count > 15)
					 {
						sep_443_burst_hsync_check = 1;
						alog_info("sep_443_burst_hsync_check >5 %d\n", sep_443_burst_hsync_count);
						break;
					 }
				}else if(sep_443_burst_hsync < BURST_TH){
					sep_443_burst_hsync_count--;
					//alog_info("sep_443_burst_hsync < BURST_TH count = %d %x\n", sep_443_burst_hsync_count, AIO_ReadRegister(VD_SEP_BURST_RO_2_VADDR));
					if (sep_443_burst_hsync_count < 5)
					 {
						sep_443_burst_hsync_check = 0;
						alog_info("sep_443_burst_hsync_check UNKNOWN %d\n", sep_443_burst_hsync_count);
						break;
					 }
				}else{
					alog_info("need recheck sep_443_burst_hsync %d\n", sep_443_burst_hsync_count);
					break;
	...
	IoReg_Write32(VDTOP_BURST_LOCATION_HSYNC_reg, burst_location_hsync_reg.regValue);
			...
			alog_info("443/358 0xff recheck = %x %x %x %x \n", sep_443_burst_hsync, sep_358_burst_hsync, sep_443_burst_hsync_check, sep_358_burst_hsync_check);


			if (sep_358_burst_hsync_check == 1 && main_sys == ATV_SOUND_MN_SYSTEM){
				if(sep_358_burst_hsync == 0xff){
					timing_match_flag = 0;
					alog_info("video timing is no signal, 625flag=0, return SNR 0, %d\n", __LINE__);
				}else if(sep_358_burst_hsync !=0xff && sep_443_burst_hsync !=0xff && (sep_358_burst_hsync < sep_443_burst_hsync)){ // 358>443 -->MN ok
					timing_match_flag = 0;
					alog_info("Fake MN system recheck, return SNR 0, %d\n", __LINE__);
				}else{
					timing_match_flag = 1;
					alog_info("video timing is MN system recheck, return SNR 1, %d\n", __LINE__);
				}
			}else if (sep_443_burst_hsync_check == 1 && (main_sys == ATV_SOUND_BG_SYSTEM ||main_sys == ATV_SOUND_I_SYSTEM ||main_sys == ATV_SOUND_DK_SYSTEM ||main_sys == ATV_SOUND_L_SYSTEM)){
				if(sep_443_burst_hsync == 0xff){
					timing_match_flag = 0;
					alog_info("video timing is no signal, 625flag=0, return SNR 0, %d\n", __LINE__);
				}else if(sep_358_burst_hsync !=0xff && sep_443_burst_hsync !=0xff && (sep_443_burst_hsync < sep_358_burst_hsync)){ // 443>358 -->BG/DK/I/L ok
					timing_match_flag = 0;
					alog_info("Fake DK, BG, I, L system recheck, return SNR 0, %d\n", __LINE__);
				}else{
					timing_match_flag = 1;
					alog_info("video timing is DK, BG system recheck, return SNR 1, %d\n", __LINE__);
				}
			}else{

					if (sep_443_burst_hsync > sep_358_burst_hsync){ //443
						if ((sep_443_burst_hsync > BURST_TH_LOW) && (main_sys == ATV_SOUND_BG_SYSTEM ||main_sys == ATV_SOUND_I_SYSTEM ||main_sys == ATV_SOUND_DK_SYSTEM ||main_sys == ATV_SOUND_L_SYSTEM)){
					timing_match_flag = 1;
							alog_info("video timing is BG/DK/I/L system, PAL system, return SNR 1, %d\n", __LINE__);
						}else{
					timing_match_flag = 0;
							alog_info("Fake system, return SNR 0, %d\n", __LINE__);
				}			
					}else if (sep_358_burst == 0xff && sep_358_burst_hsync == 0xff && sep_443_burst_hsync != 0xff){
						//if ((sep_443_burst_hsync > BURST_TH_LOW) && (main_sys == ATV_SOUND_BG_SYSTEM ||main_sys == ATV_SOUND_I_SYSTEM ||main_sys == ATV_SOUND_DK_SYSTEM ||main_sys == ATV_SOUND_L_SYSTEM) 
						//	&& ((vd_decision_mode_status == 1) || (vd_decision_mode_status == 3) || (vd_decision_mode_status == 5) || (vd_decision_mode_status == 6) || (vd_decision_mode_status == 7)))
						if ((sep_443_burst_hsync > BURST_TH_LOW) && (main_sys == ATV_SOUND_BG_SYSTEM ||main_sys == ATV_SOUND_I_SYSTEM ||main_sys == ATV_SOUND_DK_SYSTEM ||main_sys == ATV_SOUND_L_SYSTEM))
						{
							timing_match_flag = 1;
							alog_info("video timing is PAL/SECAM system, PAL system, return SNR 1, %d\n", __LINE__);
				}else{
							timing_match_flag = 0;
							alog_info("Fake system, return SNR 0, %d\n", __LINE__);
						}
					...
					if (sep_358_burst_hsync > sep_443_burst_hsync){ //358
						if ((sep_358_burst_hsync > BURST_TH_LOW) && main_sys == ATV_SOUND_MN_SYSTEM){
							timing_match_flag = 1;
							alog_info("video timing is MN system, MN system, return SNR 1, %d\n", __LINE__);
						}else{
							timing_match_flag = 0;
					...
					}else if (sep_443_burst == 0xff && sep_443_burst_hsync == 0xff && sep_358_burst_hsync != 0xff){
						//if ((sep_358_burst_hsync > BURST_TH_LOW) && (main_sys == ATV_SOUND_MN_SYSTEM) && ((vd_decision_mode_status == 0) || (vd_decision_mode_status == 2) || (vd_decision_mode_status == 4)))
						if ((sep_358_burst_hsync > BURST_TH_LOW) && (main_sys == ATV_SOUND_MN_SYSTEM))
						{// vd_decision_mode_status = 0 2 4 -->NTSC system
							timing_match_flag = 1;
							alog_info("video timing is NTSC system, MN system, return SNR 1, %d\n", __LINE__);
				}else{
							timing_match_flag = 0;
							alog_info("Fake system, return SNR 0, %d\n", __LINE__);
						}
				...
				//timing_match_flag = 1;
				//alog_info("VD recheckagian_2, return SNR 1\n"); // VD recheck from burst_sync, it always can't get correct status, but this channel have siganl, so return SNR=1

		}


	} else if (line_625_flag == 0){ //525 line
		...
		//	timing_match_flag = 1;
		//alog_info("video timing return normal, no check, return SNR 1\n");
	//}

#endif
	

	alog_info("Return_SNR_Result = %d\n", timing_match_flag);

	return timing_match_flag;
		}
		
int32_t AtvCheckVideoTiming_LG(ATV_SOUND_STD_MAIN_SYSTEM main_sys)
{
	uint32_t vd_decision_mode_status, video_status_reg3;
	...
	alog_info("Return_SNR_Result_LG = %d\n", timing_match_flag);
...
ATV_SOUND_STD Audio_HwSIFRetrunSoundStandard(int debounce_sound_std)
{
	...
	ATV_SOUND_STD FwReturnStd;
       audio_msd_result_RBUS msd_result;
	static int HWSIFRETURN_HWunstable_check=0;
	int HWSIFRETURN_First_Timeout=0;
	int HWSIFRETURN_First_SoundStdDebounce=0;
	int First_DEBOUNCE_TIME_HWSIFRETURN=2;

	#if 1
	// the g_UserStd is setted by Audio_AtvSetSoundStd before  so that  the RHAL_AUDIO_SIF_CheckAvailableSystem will always return signal present when first enter atv
	// first time inter ATV, audio HW check detection stable and auto set correct soud std if AP set sound std incorrect parameter
	if (HWSIFRETURN_HWunstable_check == 0 && g_user_config != AUDIO_USER_CONFIG_TV001){
		while(1)
		{
			...
			if (msd_result.hw_detected_std!= ATV_SOUND_STD_UNKNOWN)
			{
				++ HWSIFRETURN_First_SoundStdDebounce;
			}
			else
			{
				HWSIFRETURN_First_SoundStdDebounce = 0;
			}

			if (HWSIFRETURN_First_SoundStdDebounce >= First_DEBOUNCE_TIME_HWSIFRETURN)
			{
				alog_info("HWSIFRETURN_HW_unstable_check =%x HWSIFRETURN_First_Timeout = %d  \n", AIO_ReadRegister(AUDIO_msd_result_reg),HWSIFRETURN_First_Timeout);
					break;
			}else if (HWSIFRETURN_First_Timeout > 45){
				alog_info("First_Timeout...!!! %d \n", HWSIFRETURN_First_Timeout );
					break;
			}
		...
		HWSIFRETURN_HWunstable_check = 1;
	}

#endif
       HwDetectStd = (ATV_SOUND_STD)AtvGetHWStd();
	g_RealHWDetectStd = HwDetectStd;
...
uint32_t AtvGetSubThresh(ATV_SUB_TONE_RATIO ratio, uint32_t main_tone)
{
	...
	case ATV_SUB_4_64:
		...
		break;
	case ATV_SUB_5_64:
		subThresh = (main_tone >> 5) + (main_tone >> 6);
		break;
	default :
...
int32_t AUDIO_SIF_SetBandSetup(ATV_AUDIO_SIF_TYPE_T eSifType, ATV_SOUND_STD_MAIN_SYSTEM sifBand)
{
	...
	Audio_HwpSetBandDelay();
       if (sifBand<ATV_SOUND_DK_SYSTEM || sifBand> ATV_SOUND_AUTO_SYSTEM) {
...
EXPORT_SYMBOL(Audio_AtvGetCurrentDetectUpdate);
...
EXPORT_SYMBOL(Audio_SetAudioHWConfig);
...
void audio_sif_adc_initial_flow(void)
{
	...
	// Clayton 2018/11/12, no need to toggle IFADC_CLKEN
	alog_err("[AudioHW]IFADC init start\n");
	
	ifadc_ctrl2.reg_adc2x_difpow = 1; //[24]REG_ADC2X_DIFPOW
	alog_debug("SIF ADC 33104 %x\n",ifadc_ctrl2.regValue);
...
{
	AIO_WriteRegister(TV_SB1_ANA_IFADC_CTRL1_reg, 0x00010202);//IFADC_CTRL1
	AIO_WriteRegister(TV_SB1_ANA_IFADC_CTRL2_reg, 0x00000240);//IFADC_CTRL2

	AIO_WriteRegister(TV_SB1_ANA_IQADC_CTRL0_reg, 0x30200010);//IQADC_CTRL0

	AIO_WriteRegister(TV_SB1_ANA_IQADC_CTRL2_reg, 0x00440001);//IQADC_CTRL2
	AIO_WriteRegister(TV_SB1_ANA_IQADC_CTRL3_reg, 0x00001111);//IQADC_CTRL3
	AIO_WriteRegister(TV_SB1_ANA_IQADC_CTRL4_reg, 0x10210022);//IQADC_CTRL4
	AIO_WriteRegister(TV_SB1_ANA_IQADC_CTRL5_reg, 0x00000000);//IQADC_CTRL5

	AIO_WriteRegister(TV_SB1_ANA_IQADC_CTRL7_reg, 0x22000022);//IQADC_CTRL7
	alog_debug("SIF ADC Release to IQ-ADC Done\n");
}
...
EXPORT_SYMBOL(Audio_Hw_SetFmRadioMode);
...
void WriteMaskRegister(unsigned int addr, unsigned int mask, unsigned int value)
{
	unsigned int temp;
	temp = IoReg_Read32(addr);
	temp = (temp & mask) | value;
	IoReg_Write32(addr, temp);
}

void Audio_Auto_Verify_Set_Path(void)
{
	alog_err("[audio_hw] Audio_DDTS_BringUp 1\n");
	
	if (g_user_config == AUDIO_USER_CONFIG_BRING_UP)
	{
		//pll_audio init
		alog_err("[audio_hw] Audio_DDTS_BringUp 2\n");
		AIO_WriteRegister(SYS_REG_SYS_SRST1_reg,0x000F8000);
		AIO_WriteRegister(SYS_REG_SYS_SRST1_reg, VERIFY_BIT19|VERIFY_BIT18|VERIFY_BIT17|VERIFY_BIT16|VERIFY_BIT15|VERIFY_BIT0);

		AIO_WriteRegister(SYS_REG_SYS_CLKEN3_reg,0x000003FE);
		AIO_WriteRegister(SYS_REG_SYS_CLKEN3_reg, VERIFY_BIT9|VERIFY_BIT8|VERIFY_BIT7|VERIFY_BIT6|VERIFY_BIT5|VERIFY_BIT4
			|VERIFY_BIT3|VERIFY_BIT2|VERIFY_BIT1|VERIFY_BIT0);

	  	AIO_WriteRegister(SYS_REG_SYS_CLKEN1_reg,0x00038000);
	  	AIO_WriteRegister(SYS_REG_SYS_CLKEN1_reg, VERIFY_BIT17|VERIFY_BIT16|VERIFY_BIT15|VERIFY_BIT0);
	 
	  	AIO_WriteRegister(SYS_REG_SYS_CLKEN2_reg,0x00009000);
	  	AIO_WriteRegister(SYS_REG_SYS_CLKEN2_reg, VERIFY_BIT15|VERIFY_BIT12|VERIFY_BIT0);

		AIO_WriteRegister(PLL27X_REG_SYS_PLL_27X2_reg,0x88085501);//Enable Audio PLL related LDO, PLL_POW_LDO11V & PLL_POW_LDO
		AIO_WriteRegister(PLL27X_REG_SYS_PLL_AUD3_reg,0x00000019);//Enable PLLAUD_CK196M/CK295M output
		AIO_WriteRegister(PLL27X_REG_SYS_PLL_512FS_2_reg,0x00000003);//Enable PLL512Fs output*/
		AIO_WriteRegister(PLL27X_REG_SYS_PLL_PSAUD1_reg,0x0000000C);//PSAUD_EN, PSAUD_PSEN 0 --> 1

		//audio path init
		audio_hw_usleep(1000); //ideal 80us, wait 1ms.
		
		WriteMaskRegister(AUDIO_global_ctrl_1_reg, ~(VERIFY_BIT31|VERIFY_BIT30|VERIFY_BIT29|VERIFY_BIT28), 
			VERIFY_BIT31|VERIFY_BIT30|VERIFY_BIT29|VERIFY_BIT28);//SDRAM on
		WriteMaskRegister(AUDIO_global_ctrl_1_reg, ~(VERIFY_BIT20), VERIFY_BIT20);//SIF ADC CLOCK on
		WriteMaskRegister(AUDIO_global_ctrl_1_reg, ~(VERIFY_BIT13|VERIFY_BIT12|VERIFY_BIT5|VERIFY_BIT4), 
			VERIFY_BIT13|VERIFY_BIT5);//PLL AUDIO

		WriteMaskRegister(AUDIO_analog_depop2_reg, ~(VERIFY_BIT3|VERIFY_BIT2), VERIFY_BIT3|VERIFY_BIT2);//enable output normal mode FOR HP/AIO Frank

		WriteMaskRegister(AUDIO_analog_depop1_reg, ~(VERIFY_BIT10|VERIFY_BIT9|VERIFY_BIT8|VERIFY_BIT2|VERIFY_BIT1), 
			VERIFY_BIT10|VERIFY_BIT2|VERIFY_BIT1);//enable HPO/AIO enable depop
		
		WriteMaskRegister(0xb8033000, ~(VERIFY_BIT24),VERIFY_BIT24);// turn on "REG_VDAC_POWMBIAS" for BB audio
		/*
		WriteMaskRegister(AUDIO_global_ctrl_1_reg, 0x0FFFFFFF, _BIT31|_BIT30|_BIT29|_BIT28);//SDRAM on
		WriteMaskRegister(AUDIO_global_ctrl_1_reg, 0xFFEFFFFF, _BIT20);//SIF ADC CLOCK on
		WriteMaskRegister(AUDIO_global_ctrl_1_reg, 0xFFFFCFCF, _BIT13|_BIT5);//PLL AUDIO

		WriteMaskRegister(AUDIO_analog_depop2_reg, 0xFFFFFFF3, _BIT3|_BIT2);//enable output normal mode FOR HP/AIO Frank

		WriteMaskRegister(AUDIO_analog_depop1_reg, 0xFFFFF8F9, _BIT10|_BIT2|_BIT1);//enable HPO/AIO enable depop
		
		WriteMaskRegister(0xb8033000, ~(_BIT24),_BIT24);// turn on "REG_VDAC_POWMBIAS" for BB audio
		*/
		//ryanliao turn on audio power
		WriteMaskRegister(AUDIO_analog_power_reg, ~(VERIFY_BIT11|VERIFY_BIT10|VERIFY_BIT9|VERIFY_BIT8|VERIFY_BIT7|
		VERIFY_BIT6|VERIFY_BIT5|VERIFY_BIT4|VERIFY_BIT3|VERIFY_BIT2), VERIFY_BIT11|VERIFY_BIT10|
		VERIFY_BIT9|VERIFY_BIT8|VERIFY_BIT7|VERIFY_BIT6|VERIFY_BIT5|VERIFY_BIT4|VERIFY_BIT3|VERIFY_BIT2);

		WriteMaskRegister(AUDIO_global_ctrl_2_reg, ~(VERIFY_BIT8|VERIFY_BIT7|VERIFY_BIT6|VERIFY_BIT5|VERIFY_BIT4), 
			VERIFY_BIT8|VERIFY_BIT7|VERIFY_BIT6|VERIFY_BIT5|VERIFY_BIT4);// enable tv_demod, i2s_out, spdif_out functions

		AIO_WriteRegister(AUDIO_HW_Process_Control_reg, 0x00000000);

		AIO_WriteRegister(AUDIO_analog_pga_reg, 0x00023000);// HPO mode
		AIO_WriteRegister(AUDIO_analog_CI01_reg, 0xD5D517D5);// HPO bias control (11: 20u)
		AIO_WriteRegister(AUDIO_adfilter_src_4_reg_reg, 0x000C0003);//DAC_0_1 setting PB(modify)
		AIO_WriteRegister(AUDIO_analog_aio_Hpout_Lineout_L_reg, 0x80180005);//DAC0_HPO DAC1_AIO1 unmute L channel
		AIO_WriteRegister(AUDIO_analog_aio_Hpout_Lineout_R_reg, 0x00180005);//DAC0_HPO DAC1_AIO1 unmute R channel
		#if 0
		//K4L
		alog_err("\n[SIF_ADC]IFD_SIF_ADC_Initial_Flow\n");
		tv_sb1_ana_ifadc_ctrl1_RBUS ifadc_ctrl1;
		...
		alog_err("SIF ADC 33100 %x\n",ifadc_ctrl1.regValue);
		WriteRegister(TV_SB1_ANA_IFADC_CTRL1_reg, ifadc_ctrl1.regValue);

		ifadc_ctrl2.reg_adc2x_difpow = 1; //[24]REG_ADC2X_DIFPOW
		alog_err("SIF ADC 33104 %x\n",ifadc_ctrl2.regValue);
		WriteRegister(TV_SB1_ANA_IFADC_CTRL2_reg, ifadc_ctrl2.regValue);
		...
		alog_err("SIF ADC 33134 %x\n",iqadc_ctrl7.regValue);
		WriteRegister(TV_SB1_ANA_IQADC_CTRL7_reg, iqadc_ctrl7.regValue);

		iqadc_ctrl3.reg_pow_q_pga = 1; //[12]REG_POW_Q_PGA, [8]REG_POW_I_PGA, [4]REG_POW_Q_ADC, [0]REG_POW_I_ADC
		iqadc_ctrl3.reg_pow_q_adc = 1;
		iqadc_ctrl3.reg_pow_i_pga = 1;
		iqadc_ctrl3.reg_pow_i_adc = 1;
		alog_err("SIF ADC 33124 %x\n",iqadc_ctrl3.regValue);
		WriteRegister(TV_SB1_ANA_IQADC_CTRL3_reg, iqadc_ctrl3.regValue);

		//Fix IFPGA 2dB
		iqadc_ctrl2.reg_if_fix_en= 1;
		alog_err("SIF ADC 33120 %x\n",iqadc_ctrl2.regValue);
		WriteRegister(TV_SB1_ANA_IQADC_CTRL2_reg, iqadc_ctrl2.regValue);

		iqadc_ctrl5.reg_ipga_d = 2; //[3:0]REG_IPGA_D, IPGA gain adjust 0x2: 2dB
		alog_err("SIF ADC 3312c %x\n",iqadc_ctrl5.regValue);
		WriteRegister(TV_SB1_ANA_IQADC_CTRL5_reg, iqadc_ctrl5.regValue);

		// SIF Audio related setting

		iqadc_ctrl0.reg_ckout_sel_q = 0; //REG_CKOUT_SEL_Q--> 0:Q_CKOUT
		alog_err("SIF ADC 33118 %x\n",iqadc_ctrl0.regValue);
		WriteRegister(TV_SB1_ANA_IQADC_CTRL0_reg, iqadc_ctrl0.regValue);

		iqadc_ctrl4.reg_ipga_fix_gain = 0; //[14:12]REG_IPGA_FIX_GAIN, Fix IFPGA 2dB, [0]REG_IF_FIX_EN
		iqadc_ctrl4.reg_qpga_input_sel = 0x4; //REG_QPGA_INPUT_SEL  100: SIF input
		alog_err("SIF ADC 33128 %x\n",iqadc_ctrl4.regValue);
		WriteRegister(TV_SB1_ANA_IQADC_CTRL4_reg, iqadc_ctrl4.regValue);
		...
		//SIF ADC init
		//register default
		WriteRegister(TV_SB1_ANA_IFADC_CTRL1_reg,0x00010202);//PGA IB20U select <bit7:0> = 0x02(10u),IFD MBIAS power on(bit16=1), ADC2X_BG_SEL= 10(1.221V)
		WriteRegister(TV_SB1_ANA_IFADC_CTRL2_reg,0x00000040);//IFADC Comparator bias select, <bit6:4>= 100(50uF), IQADC input cm power off <bit24> = 0  
		WriteRegister(TV_SB1_ANA_IQADC_CTRL0_reg,0x30200010);//IQ ADC calibration input swing <bit30:28> = 0x11, REG_IQ_CAL_DIV<bit21:20> = 0x10, REG_CKOUT_SEL_Q: the default is "1:I_CKOUT" on AIF spec
		WriteRegister(TV_SB1_ANA_IQADC_CTRL2_reg,0x00440000);//REG_IQCMP_ISEL <bit22:20> = 0x100(50uA), REG_IQCAL_ISEL <bit18:16> = 0x100(50uA), IF ADC GAIN FIX EN <bit0> = 0(SIF mode)
		WriteRegister(TV_SB1_ANA_IQADC_CTRL3_reg,0x00000000);//PGA/ADC Power Off
		WriteRegister(TV_SB1_ANA_IQADC_CTRL3_reg,0x00000101);//I_ADC PGA/ADC Power on
		WriteRegister(TV_SB1_ANA_IQADC_CTRL4_reg,0x00000022);//Default setting(10=20uA), IQ PGA CURRENT  select(same with Mac5P)
			
		//IFADC+IFPGA power on
		WriteMaskRegister(TV_SB1_ANA_IFADC_CTRL1_reg, 0xFEEEFFFF, 0x00010000);	//turn on MBIAS
		WriteMaskRegister(TV_SB1_ANA_IFADC_CTRL2_reg, 0xFEFFFFFF, 0x01000000);	//REG_ADC2X_DIFPOW, IFADC input cm power on
		WriteMaskRegister(TV_SB1_ANA_IQADC_CTRL4_reg, 0x8fc8fccc, 0x00020022);	//I PGA input select = IFD input, Q PGA input select = No input, REG_IB20U_IPGA_SEL = 10(20uA)

		//IQADC+IQPGA power on
		WriteRegister(TV_SB1_ANA_IQADC_CTRL5_reg,0x00000000);//default setting
		WriteRegister(TV_SB1_ANA_IQADC_CTRL6_reg,0x00000000);//default setting
		WriteRegister(TV_SB1_ANA_IQADC_CTRL7_reg,0x22000022);//REG_IADC_LDO_SEL = 010, REG_QADC_LDO_SEL = 010, IADC, QADC_META_POW = turn off, REG_IADC_VREF_SEL = 10, REG_QADC_VREF_SEL = 10

		//Set IFPGA GAIN = 2dB
		WriteMaskRegister(TV_SB1_ANA_IQADC_CTRL2_reg, 0xfffffffe, 0x00000001);//IF ADC GAIN FIX EN <bit0>= 1(Internal Dedmo IQ mode)
		WriteMaskRegister(TV_SB1_ANA_IQADC_CTRL5_reg, 0xffffcc00, 0x00000022);//Q_CKIN_Sel = 00, I_CKIN_Sel = 00: From PLL27X_IFADC, REG_IPGA_Q and REG_IPGA_D GAIN set to 0010(2dB)

		// SIF Audio related setting
		WriteRegister(TV_SB1_ANA_IQADC_CTRL0_reg,0x30200000); // REG_CKOUT_SEL_Q--> 0:Q_CKOUT
		WriteRegister(TV_SB1_ANA_IQADC_CTRL4_reg,0x40000022); // REG_QPGA_INPUT_SEL  100: SIF input
		WriteRegister(TV_SB1_ANA_IQADC_CTRL7_reg,0x00001000); // QADC META control -->1
		WriteRegister(TV_SB1_ANA_IQADC_CTRL2_reg,0x40000001); 

		WriteRegister(TV_SB1_ANA_IQADC_CTRL5_reg, 0x00002022); // REG_Q_CKIN_SEL 10: CK_24M From Digital
		WriteRegister(TV_SB1_ANA_IQADC_CTRL3_reg, 0x00001010); // REG_POW_Q -->Q channel ADC power on, Q channel PGA power on
		
		//sif path init
		WriteRegister(AUDIO_sif_agc_eval_cnt_reg, 0x000b0180); //SIF HW AGC enable
		WriteRegister(AUDIO_carrier_freq_deviation_ctrl_reg, 0x80000000); //from SIF_ADC

		//Audio MSD setting
		WriteRegister(AUDIO_msd_crtl_word_reg, 0x30C80617); //HW msd_en all hw scan
		WriteRegister(AUDIO_mode_detect_reg, 0x00000004); //HW md_en
		WriteRegister(AUDIO_down_sample_fifo_source_sel_reg, 0x00007650);
		#else
		audio_sif_adc_initial_flow();
		#endif
		WriteMaskRegister(AUDIO_TVdemod_Digital_Volume_Control_reg, 0xF7FFFFFF, 0); //disable SIF DVC
		WriteMaskRegister(AUDIO_LR_Digital_Volume_Control_reg, ~(VERIFY_BIT31|VERIFY_BIT15), 0);
	}
	else
	{
		alog_err("[audio_hw] Audio_DDTS_BringUp 3\n");
		AIO_WriteRegister(AUDIO_global_ctrl_1_reg, 0xF0102222);//PLL audio, turn on ADC/DAC SDRAM
		AIO_WriteRegister(AUDIO_adfilter_src_4_reg_reg, 0x000C0003);//DAC_0_1 setting PB(modify)
		AIO_WriteRegister(AUDIO_HW_Process_Control_reg, 0x00000014);
	}
}
EXPORT_SYMBOL(Audio_Auto_Verify_Set_Path);

static void AudioSifBtscLpfSel(uint32_t SoundMode)
{
	audio_phase_err_threshold_RBUS phase_err_threshold;
					
	phase_err_threshold.regValue = AIO_ReadRegister(AUDIO_phase_err_threshold_reg);
	if (SoundMode == ATV_SOUND_MODE_MONO && phase_err_threshold.mono_lpf_sel == 0)
	{
		phase_err_threshold.mono_lpf_sel = 1;
	}
	else if (SoundMode != ATV_SOUND_MODE_MONO && phase_err_threshold.mono_lpf_sel == 1)
	{
		phase_err_threshold.mono_lpf_sel = 0;
	}

	AIO_WriteRegister(AUDIO_phase_err_threshold_reg, phase_err_threshold.regValue);
}
...
void AtvCheckA2DK3rdTone(void)
{
	audio_carrier_freq_deviation_ctrl_RBUS force_a2_DK123;
	ATV_SOUND_MODE sound_mode = ATV_SOUND_MODE_MONO;
	int force_a2_dk_sel = 0;
	audio_md_status_3_RBUS md_status_3;
	md_status_3.regValue = AIO_ReadRegister(AUDIO_md_status_3_reg);
	Audio_HwpWriteRegister(AUDIO_md_status_3_reg, 0);//debounce off for merlin4, speech up to detect sound mode
	...
	if(g_Std_msd_result.hw_detected_std == ATV_SOUND_STD_DK_MONO ||
	   ...
	   g_Std_msd_result.hw_detected_std == ATV_SOUND_STD_A2_DK3)
	{
		for(force_a2_dk_sel = ATV_FORCE_A2_DK1; force_a2_dk_sel <= ATV_FORCE_A2_DK3; force_a2_dk_sel++)
		{
			force_a2_DK123.regValue = AIO_ReadRegister(AUDIO_carrier_freq_deviation_ctrl_reg);
			force_a2_DK123.force_a2_dk_sel = force_a2_dk_sel;
			Audio_HwpWriteRegister(AUDIO_carrier_freq_deviation_ctrl_reg, force_a2_DK123.regValue);
			audio_hw_usleep(10*1000); //wait 10ms
			AtvGetA2HwSoundMode(&sound_mode, FALSE);
			...
			if(sound_mode != ATV_SOUND_MODE_MONO)
			{
				//ATV_LOG("A2DK 0x%x has sound mode\n", force_a2_dk_sel);
				break;
			}
		}
		...
		if(sound_mode == ATV_SOUND_MODE_MONO)
		{
			...
			{
				g_Std_msd_result.hw_detected_std = ATV_SOUND_STD_DK_MONO;
				alog_info("Fake A2DK, change to DK MONO\n");
			}
		}
		else
		{
			if(g_Std_msd_result.hw_detected_std == ATV_SOUND_STD_DK_MONO)
			{
				if(force_a2_dk_sel == ATV_FORCE_A2_DK1)
				{
					g_Std_msd_result.hw_detected_std = ATV_SOUND_STD_A2_DK1;
					alog_info("Fake DK MONO, change to A2DK1,soundmode=%x \n",sound_mode);
				}
				else if(force_a2_dk_sel == ATV_FORCE_A2_DK2)
				{
					g_Std_msd_result.hw_detected_std = ATV_SOUND_STD_A2_DK2;
					alog_info("Fake DK MONO, change to A2DK2,soundmode=%x \n",sound_mode);
				}
				else
				{
					g_Std_msd_result.hw_detected_std = ATV_SOUND_STD_A2_DK3;
					alog_info("Fake DK MONO, change to A2DK3,soundmode=%x \n",sound_mode);
				}
			}
		}
	}
	Audio_HwpWriteRegister(AUDIO_md_status_3_reg, md_status_3.regValue);	//restore debounce value
}

int Audio_GetHWDectectStd(void)
{
	return g_RealHWDetectStd;
}
...
EXPORT_SYMBOL(Audio_Hw_Set_Scan_Std_Flag);
...
EXPORT_SYMBOL(Audio_AtvSetFwPriority);
...
EXPORT_SYMBOL_GPL(m_atv_cfg_default);
