...
void Audio_HW_Earc_SetAPHY(void)
{
	...
	EARC_ANA_1.regValue = AIO_ReadRegister(EARCMISC_earc_ana_1_reg);
	EARC_ANA_1.r300_sel = 0x3;//0x1;
	EARC_ANA_1.r60_sel = 0x7;//0xa;
	...
	EARC_ANA_2.cmrx_ref_sel=0; //eco: CMRx ref, 0: from RC, 1: from OP
	EARC_ANA_2.cmrx_hys_sel=1;//eco: hysteresis window, 0:78mV, 1: 55mV
	AIO_WriteRegister(EARCMISC_earc_ana_2_reg, EARC_ANA_2.regValue);
