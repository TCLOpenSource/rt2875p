...
#include <sed_types.h>
#endif
#include <../IPC/generate/include/audio/AudioRPCBaseDS_data.h>

#define VERIFY_BIT0 (0x1)
#define VERIFY_BIT1 (0x2)
#define VERIFY_BIT2 (0x4)
#define VERIFY_BIT3 (0x8)
#define VERIFY_BIT4 (0x10)
#define VERIFY_BIT5 (0x20)
#define VERIFY_BIT6 (0x40)
#define VERIFY_BIT7 (0x80)
#define VERIFY_BIT8 (0x100)
#define VERIFY_BIT9 (0x200)

#define VERIFY_BIT10 (0x400)
#define VERIFY_BIT11 (0x800)
#define VERIFY_BIT12 (0x1000)
#define VERIFY_BIT13 (0x2000)
#define VERIFY_BIT14 (0x4000)
#define VERIFY_BIT15 (0x8000)
#define VERIFY_BIT16 (0x10000)
#define VERIFY_BIT17 (0x20000)
#define VERIFY_BIT18 (0x40000)
#define VERIFY_BIT19 (0x80000)

#define VERIFY_BIT20 (0x100000)
#define VERIFY_BIT21 (0x200000)
#define VERIFY_BIT22 (0x400000)
#define VERIFY_BIT23 (0x800000)
#define VERIFY_BIT24 (0x1000000)
#define VERIFY_BIT25 (0x2000000)
#define VERIFY_BIT26 (0x4000000)
#define VERIFY_BIT27 (0x8000000)
#define VERIFY_BIT28 (0x10000000)
#define VERIFY_BIT29 (0x20000000)

#define VERIFY_BIT30 (0x40000000)
#define VERIFY_BIT31 (0x80000000)
...
typedef enum {
	...
	ATV_A2_DEBOUNCE_2P0S		= 0x04,
	ATV_A2_DEBOUNCE_0P05S	= 0x05,
	ATV_A2_DEBOUNCE_0P1S		= 0x06,
	ATV_A2_DEBOUNCE_0P2S		= 0x07,
 ...
 * @ingroup lib_audio
 */
void Audio_AtvPauseTVStdDetection(int is_pause);
...
void Audio_AtvForceSoundSel(int flag);
...
void  Audio_AtvStartfromSIFResume(void);
...
void Audio_HwSetAPVREnable_Flag(uint8_t en);	/* for external demo apvr */
...
void Audio_AtvSetDevOnOff(int bOnOff);
...
void audio_sif_adc_release_flow(void);

void Audio_Auto_Verify_Set_Path(void);

int Audio_GetHWDectectStd(void);
...
void AtvSetMute(int32_t para);//nio_liao 20191015
#endif
