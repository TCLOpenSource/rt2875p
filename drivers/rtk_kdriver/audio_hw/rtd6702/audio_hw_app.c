...
int32_t Audio_AppInit(void)
{
	...
	audio_analog_refgen_RBUS AUDIO_ANALOG_REFGEN_REG;
	...
	// [end]
//Mark2 s: new method: internal charge pump
	alog("[AUDIO][APP] REFVDD Setting-internal charge pump s\n");
	AUDIO_ANALOG_REFGEN_REG.regValue = AIO_ReadRegister(AUDIO_analog_refgen_reg);
	AUDIO_ANALOG_REFGEN_REG.reg_bb_refgen_pow= 1; // internal charge pump turn on
	AIO_WriteRegister(AUDIO_analog_refgen_reg, AUDIO_ANALOG_REFGEN_REG.regValue);

	audio_hw_usleep(300*1000);
	AUDIO_ANALOG_REFGEN_REG.regValue = AIO_ReadRegister(AUDIO_analog_refgen_reg);
	AUDIO_ANALOG_REFGEN_REG.reg_bb_refgen_en_ad= 1;
	AUDIO_ANALOG_REFGEN_REG.reg_bb_refgen_en_da= 1;
	AUDIO_ANALOG_REFGEN_REG.reg_bb_refgen_rst= 1;	
	AIO_WriteRegister(AUDIO_analog_refgen_reg, AUDIO_ANALOG_REFGEN_REG.regValue);
	alog("[AUDIO][APP] REFVDD Setting-internal charge pump e\n");	
//Mark2 e: delay 300ms for external 10uF cap	
