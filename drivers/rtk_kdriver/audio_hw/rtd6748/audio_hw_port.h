...
/************************* Audio HW Config *************************/ 
/* IC Version */
#undef	RTD284X											/* Support AIO1, HP */
#undef	RTD289X											/* Support AIO1, AIO2, HP */
#undef	RTD287X											/* Support AIO1, AIO2, HP */
#undef	RTD285X											/* Support AIO1, HP */
#undef	RTD2842										/* Support AIO1, HP */
#define	RTD2874

/* Audio Function */
#define	SUPPORT_HP_OUT_SWAP					/* only support on Merlin series IC */
#define	SUPPORT_ADC_DVC							/* For controling analog_in independently */
#undef	SUPPORT_2_SET_ADC						/* For 2 pairs AMIC in */
#undef	SUPPORT_TWO_BAND_DRC						/* For 2band DRC */
#define	SUPPORT_6_CHANNEL_PRESCALE	/* only support on Merlin series IC */
#define	SUPPORT_6_CHANNEL_LOUDNESS	/* only support on Merlin series IC */
#define	SUPPORT_8_CHANNEL_I2S_OUT		/* only support on Merlin series IC) */

/* AQ relevant */
#define	NO_USE_HW_AQ								/* HW AQ switch */
#define	USE_ATV_SW_MUTE							/* ATV SW/HW Mute */
#undef	USE_SW_SOUND_SURROUND				/* SW sound surround*/
#define	MAX_EQ_BAND_NUM 13						/* 1LPF + 11BPF + 1HPF */
...
#define	AUDIO_USER_CONFIG_BRING_UP 0x3
