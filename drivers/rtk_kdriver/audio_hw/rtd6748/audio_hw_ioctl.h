...
#define AUDIO_IOC_APP_HWP_SET_LIMIT_OUTPUT_DAC0		_IOW(AUDIO_IOC_APP_MAGIC, 47, APP_HWP_SET_LIMIT_OUTPUT_T)
...
#define AUDIO_IOC_APP_HWP_SET_LIMIT_OUTPUT_DAC1		_IOW(AUDIO_IOC_APP_MAGIC, 65, APP_HWP_SET_LIMIT_OUTPUT_T)
#define AUDIO_IOC_APP_HWP_SET_LIMIT_OUTPUT_I2S0		_IOW(AUDIO_IOC_APP_MAGIC, 66, APP_HWP_SET_LIMIT_OUTPUT_T)
#define AUDIO_IOC_APP_HWP_SET_DRC				_IOW(AUDIO_IOC_APP_MAGIC, 67, APP_HWP_SET_BALANCE_T)
#define AUDIO_IOC_APP_HWP_SET_EQ_DIRECT_PARAMETER			_IOW(AUDIO_IOC_APP_MAGIC, 68, APP_HWP_SET_EQ_PARAMETER_T)
#define AUDIO_IOC_APP_HWP_SET_LOUD_DIRECT_PARAMETER			_IOW(AUDIO_IOC_APP_MAGIC, 69, APP_HWP_SET_LOUD_PARAMETER_T)
