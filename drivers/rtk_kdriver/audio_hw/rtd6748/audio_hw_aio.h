...
#define AIO_EARC_NORMAL_PERIOD_US	(10*1000)	// 20ms
...
#ifdef SUPPORT_EARC
#define AIO_EARC_CAP_DEVICE_ID 			0xA0
#define AIO_EARC_CAP_OFFSET 				0x00
#define AIO_EARC_LATENCY_DEVICE_ID 		0x74
#define AIO_EARC_ERX_LATENCY_OFFSET 		0xD2 //read transaction
#define AIO_EARC_ERX_LATENCY_REQ_OFFSET 	0xD3 //write transaction

#define AIO_EARC_HPD_IRQ 				0x00000001
#define AIO_EARC_CAP_CHNG_IRQ 		(AIO_EARC_HPD_IRQ << 1)
#define AIO_EARC_START_CHNG_IRQ 		(AIO_EARC_HPD_IRQ << 2)
#define AIO_EARC_UNEXP_RESPONSE_IRQ	(AIO_EARC_HPD_IRQ << 3)
#define AIO_EARC_NO_RESPONSE_IRQ 	(AIO_EARC_HPD_IRQ << 4)
#define AIO_EARC_ERR_UECC_IRQ 		(AIO_EARC_HPD_IRQ << 5)
#define AIO_EARC_LOST_HEARTBEAT_IRQ 	(AIO_EARC_HPD_IRQ << 6)
#define AIO_EARC_HEARTBEAT_ACK_IRQ 	(AIO_EARC_HPD_IRQ << 7)
#define AIO_EARC_COMMA_TIMEOUT_IRQ 	(AIO_EARC_HPD_IRQ << 8)
#define AIO_EARC_RDATA_VALID_IRQ 		(AIO_EARC_HPD_IRQ << 9)
#define AIO_EARC_REQUEST_FIN_IRQ 		(AIO_EARC_HPD_IRQ << 10)
#define AIO_EARC_READ_UECC_IRQ 		(AIO_EARC_HPD_IRQ << 11)
#define AIO_EARC_READ_NACK_IRQ 		(AIO_EARC_HPD_IRQ << 12)
#define AIO_EARC_WRITE_NACK_IRQ 		(AIO_EARC_HPD_IRQ << 13)

#define AIO_EARC_OTP_REG 			0xb8038188
#define AIO_EARC_OTP_Z0_REG 			0xb80381e8

#if 0
#define AIO_EARC_IRQ_EN (AIO_EARC_HEARTBEAT_ACK_IRQ | AIO_EARC_HPD_IRQ \
		| AIO_EARC_START_CHNG_IRQ | AIO_EARC_CAP_CHNG_IRQ | AIO_EARC_LOST_HEARTBEAT_IRQ)
#else
#define AIO_EARC_IRQ_EN (AIO_EARC_HPD_IRQ | AIO_EARC_START_CHNG_IRQ \
		| AIO_EARC_CAP_CHNG_IRQ | AIO_EARC_LOST_HEARTBEAT_IRQ)
#endif
#define AIO_EARC_ERR_READ_TRANS_IRQ (AIO_EARC_READ_NACK_IRQ | AIO_EARC_READ_UECC_IRQ \
		| AIO_EARC_NO_RESPONSE_IRQ	| AIO_EARC_UNEXP_RESPONSE_IRQ | AIO_EARC_LOST_HEARTBEAT_IRQ)
#define AIO_EARC_ERR_WRITE_TRANS_IRQ (AIO_EARC_WRITE_NACK_IRQ | AIO_EARC_LOST_HEARTBEAT_IRQ\
		| AIO_EARC_NO_RESPONSE_IRQ	| AIO_EARC_UNEXP_RESPONSE_IRQ | AIO_EARC_WRITE_NACK_IRQ)
#endif
...
#if 1//def SUPPORT_EARC

typedef enum {
	AIO_EARC_CHNG_HB= 0,
	AIO_EARC_CHNG_NEXT_HB= 1,
	AIO_EARC_CHNG_NEXT_2HB= 2,
	AIO_EARC_CHNG_NEXT_3HB= 3,	
} AIO_AUDIO_EARC_STAT_CAP_INTERVAL_T;

typedef enum {
	AIO_EARC_IDLE1				=	0x0,
	AIO_EARC_EARC_HANKSHAKE	=	0x1,
	AIO_EARC_EARC				=	0x2,
	AIO_EARC_EARC_FAIL		=	0xF,
} AIO_EARC_STATE_T;

typedef enum {
	AIO_EARC_STATE_IDLE1	=	0x0,
	AIO_EARC_STATE_IDLE2	=	0x1,
	AIO_EARC_STATE_DISC1	=	0x2,
	AIO_EARC_STATE_DISC2	=	0x4,
	AIO_EARC_STATE_EARC	=	0x8,
} AIO_EARC_STATE_MACHINE_T;

typedef enum {
	AIO_AUDIO_EARC_RX_STATUS_NONE			= 0,
	AIO_AUDIO_EARC_RX_STATUS_CAP_CHNG,
	AIO_AUDIO_EARC_RX_STATUS_STAT_CHNG,
} AIO_AUDIO_EARC_RX_STATUS_T;

typedef enum {
	AIO_AUDIO_EARC_READ_CAP	= 0,
	AIO_AUDIO_EARC_READ_LATENCY,
} AIO_AUDIO_EARC_READ_T;

typedef enum {
	AIO_AUDIO_EARC_IDLE			= 	0x00,
	AIO_AUDIO_EARC_ABORT			=	0x01,
	AIO_AUDIO_EARC_EARC_CMD		=	0x02,
	AIO_AUDIO_EARC_DEVICE_ID		=	0x03,
	AIO_AUDIO_EARC_OFFSET		=	0x04,
	AIO_AUDIO_EARC_CONT1			=	0x05,
	AIO_AUDIO_EARC_CONT2			=	0x06,
	AIO_AUDIO_EARC_RETRY			=	0x07,
	AIO_AUDIO_EARC_DATA1			=	0x08,
	AIO_AUDIO_EARC_DATA2			=	0x09,
	AIO_AUDIO_EARC_STOP			=	0x0A,
} AIO_AUDIO_EARC_TRANS_STATE_T;

typedef enum {
	AIO_AUDIO_EARC_TRAN_IDLE						=	0x000,
	/* Read State */
	AIO_AUDIO_EARC_TRAN_READ_CAP_PROCESS		=	0x001,
	AIO_AUDIO_EARC_TRAN_READ_CAP_RETRY		=	0x002,
	AIO_AUDIO_EARC_TRAN_READ_CAP_FINISH		=	0x003,
	AIO_AUDIO_EARC_TRAN_READ_CAP_FALSE			=	0x004,
	
	AIO_AUDIO_EARC_TRAN_READ_LATENCY_PROCESS	=	0x011,
	AIO_AUDIO_EARC_TRAN_READ_LATENCY_RETRY	=	0x012,
	AIO_AUDIO_EARC_TRAN_READ_LATENCY_FINISH	=	0x013,
	AIO_AUDIO_EARC_TRAN_READ_LATENCY_FALSE	=	0x014,
	
	/* Write State */
	AIO_AUDIO_EARC_TRAN_WRITE_LATENCY_PROCESS=	0x111,
	AIO_AUDIO_EARC_TRAN_WRITE_LATENCY_RETRY	=	0x112,
	AIO_AUDIO_EARC_TRAN_WRITE_LATENCY_FINISH	=	0x113,
	AIO_AUDIO_EARC_TRAN_WRITE_LATENCY_FALSE	=	0x114,
} AIO_AUDIO_EARC_TRAN_STATE_T;

typedef struct {
	AIO_EARC_STATE_MACHINE_T ConnectState;
	AIO_AUDIO_EARC_RX_STATUS_T RxState;
	bool ReadCapReady;
	bool ReadLatencyReady;
	AIO_AUDIO_EARC_TRAN_STATE_T TransactionState;
	bool CommaTimeout;
} EARC_STATE_T;

typedef struct {
	AIO_AUDIO_EARC_READ_T Type;
	unsigned char *ReadData;
} AIO_AUDIO_EARC_CMDC_READ_T;

typedef enum {
	AIO_AUDIO_ARC	= 0,
	AIO_AUDIO_EARC,
} AIO_AUDIO_EARC_ARC_SWITCH_T;


typedef union{
	RBus_UInt32 regValue;
	struct {
		unsigned int Hy_Wd_Done:1;
		unsigned int Hy_Wd_Sel:2;			
		unsigned int Cm_Ib_Done:1;
		unsigned int Cm_Ib_Sel:3;			
		unsigned int Df_Ib_Done:1;
		unsigned int Df_Ib_Sel:3;	
		unsigned int Arc_Ib_Done:1;	
		unsigned int Arc_Ib_Sel:3;			
		unsigned int R60_Done:1;
		unsigned int R60_Sel:4;		
		unsigned int R300_Done:1;		
		unsigned int R300_Sel:3;
...
typedef union{
	RBus_UInt8 regValue;
	struct {
		unsigned int DMAC_Slf_Test_En:1;			
		unsigned int CMRx_KOFF_Offset_Code:3;		
		unsigned int CMRx_Vref_Sel:1;
		unsigned int CMRx_Hy_Wd_Sel:2;
		unsigned int CMRx_KOFF_En:1;		
	} ;
}Aphy_reserved_extra_T;
...
typedef struct {
	int32_t RDMA_PB_ADDR_L;
	int32_t RDMA_PB_ADDR_R;	
	int32_t WDMA_PB_ADDR_L;
	int32_t WDMA_PB_ADDR_R;	
	int32_t RDMA_Lens;
	int32_t WDMA_Lens;	
} AIO_HWP_SET_DMA_T;
...
typedef enum{    
	HDMI_PCB_EARC_UNKNOW = -3,   
	HDMI_PCB_EARC_MULTI = -2,    
	HDMI_PCB_EARC_NONE = -1,    
	HDMI_PCB_EARC_PORT0 = 0,    
	HDMI_PCB_EARC_PORT1 = 1,    
	HDMI_PCB_EARC_PORT2 = 2,    
	HDMI_PCB_EARC_PORT3 = 3,
}HDMI_PCB_EARC_T;

typedef enum {
	AIO_EARC_DUTY_FIX60FINETUNE40=0x1,
	AIO_EARC_DUTY_FIX40FINETUNE60=0x2,
	AIO_EARC_DUTY_FIX4060=0x7,	
} df_duty_sel;

typedef enum {			
	AIO_EARC_DUTY_DOWN_05P=0xE0,
	AIO_EARC_DUTY_DOWN_1P=0xA0,
	AIO_EARC_DUTY_DOWN_15P=0x60,
	AIO_EARC_DUTY_DOWN_2P=0x20,	
	AIO_EARC_DUTY_UP_05P=0x00,
	AIO_EARC_DUTY_UP_1P=0x40,
	AIO_EARC_DUTY_UP_15P=0x80,
	AIO_EARC_DUTY_UP_2P=0xC0
} df_duty_finetune;
...
typedef union
{
    uint32_t regValue;
    struct{
        uint32_t  earc_hpd_irq:1;
        uint32_t  cap_chng_irq:1;
        uint32_t  start_chng_irq:1;
        uint32_t  unexp_response_irq:1;
        uint32_t  no_response_irq:1;
        uint32_t  err_uecc_irq:1;
        uint32_t  lost_heartbeat_irq:1;
        uint32_t  heartbeat_ack_irq:1;
        uint32_t  comma_timeout_irq:1;
        uint32_t  rdata_valid_irq:1;
        uint32_t  request_fin_irq:1;
        uint32_t  read_uecc_irq:1;
        uint32_t  read_nack_irq:1;
        uint32_t  write_nack_irq:1;
        uint32_t  rcmd_valid_irq:1;
        uint32_t  res2:1;
        uint32_t  dmac_frequency_irq:1;		
        uint32_t  res1:7;	
       uint32_t  sw_data:8;
       
    };
}earc_sw_cmdc_irq_event;
...
//int32_t AudioEarcRead(unsigned char *Data);
