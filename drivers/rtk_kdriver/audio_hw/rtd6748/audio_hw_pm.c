...
void audio_atv_suspend(struct audio_hw_pm *pm)
{
	audio_analog_power_RBUS   		  AUDIO_ANALOG_PWR_REG;
	...
	AUDIO_ANALOG_PWR_REG.regValue = AIO_ReadRegister(AUDIO_analog_power_reg);
	pm->ADC_Vref = AUDIO_ANALOG_PWR_REG.reg_bb_adcref_pow;
...
void audio_atv_resume(struct audio_hw_pm *pm)
{
	...
	AUDIO_ANALOG_PWR_REG.regValue = AIO_ReadRegister(AUDIO_analog_power_reg);
	AUDIO_ANALOG_PWR_REG.reg_bb_adcref_pow = pm->ADC_Vref;
	AIO_WriteRegister(AUDIO_analog_power_reg, AUDIO_ANALOG_PWR_REG.regValue);
