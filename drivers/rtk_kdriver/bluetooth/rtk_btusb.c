...
{ 0x043E, 0x3111, 0x8822, 0, 0, "mp_rtl8822c_fw", "rtl8822c_fw", "rtl8822c_config", NULL, 0,CONFIG_MAC_OFFSET_GEN_4PLUS, MAX_PATCH_SIZE_40K},
...
static int btusb_open(struct hci_dev *hdev)
{
    ...
    reset_and_clean_hw_buffer(data->fw_info);
