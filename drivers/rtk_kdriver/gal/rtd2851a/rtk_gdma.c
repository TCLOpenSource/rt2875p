...
#if defined(CONFIG_ARCH_RTK288O) || defined(CONFIG_ARCH_RTK2851A)
#else
...
int GAL_Runtime_Suspend(void)
{
  ...
  rtd_pr_gdma_notice("[GDMA][%d][reg %x] GAL_Runtime_Suspend_status=%d \n",__LINE__,GAL_Runtime_Suspend_status);
...
int GAL_Runtime_Resume(void)
{
  ...
  rtd_pr_gdma_emerg("[GDMA][%d][reg %x] GAL_Runtime_Suspend_status=%d \n",__LINE__,GAL_Runtime_Suspend_status);
 ...
 *  @return None
 */
void GDMA_Clk_Select(int src_type, unsigned char enable)
{
