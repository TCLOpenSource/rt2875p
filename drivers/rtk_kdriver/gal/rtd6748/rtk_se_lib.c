...
//#ifdef SUPPORT_SE_LIMIT
#if defined(CONFIG_ARCH_RTK6748) 
#define SEINFO_REG_SWAP_FBDC_1 0xfff//0xfff
#define SEINFO_REG_SWAP_FBDC_2 0xff0//0xff0
#define SEINFO_REG_SWAP_FBDC_3 0x00f//0x00f
	...
	void*			pExtraParam)
{
	...
	if (pEx->result_format == SEINFO_EXT_COLOR_FORMAT_ARGB8888
		...
		se_ext_stch.Word1.rslt_argb_order = ARGBENDIAN;//ARGBENDIAN; //FPGA-->BGRA
	}
	...
	if (pEx->src1_format == SEINFO_EXT_COLOR_FORMAT_FBDC_U8U8U8U8) {
		se_ext_stch.Word6.src1_tfbdc_lossy = 0;
	}
...
//-------------------------------------------------------------
	...
	if (pEx->result_format == SEINFO_EXT_COLOR_FORMAT_ARGB8888
		&& (pEx->src1_format == SEINFO_EXT_COLOR_FORMAT_FBDC_U8U8U8U8
		|| pEx->src2_format == SEINFO_EXT_COLOR_FORMAT_FBDC_U8U8U8U8)) {
		se_ext_rop.Word1.rslt_argb_order = ARGBENDIAN;//5; //ABGR
	} else {
	...
	if (pEx->result_format == SEINFO_EXT_COLOR_FORMAT_FBDC_U8U8U8U8
		&& (pEx->src1_format == SEINFO_EXT_COLOR_FORMAT_ARGB8888
        || pEx->src2_format == SEINFO_EXT_COLOR_FORMAT_ARGB8888)) {
	...
	if (pEx->src1_format == SEINFO_EXT_COLOR_FORMAT_FBDC_U8U8U8U8) {
		se_ext_rop.Word6.src1_tfbdc_lossy = 0;
	}
...
//-------------------------------------------------------------
	...
	if (pEx->result_format == SEINFO_EXT_COLOR_FORMAT_ARGB8888
		&& (pEx->src1_format == SEINFO_EXT_COLOR_FORMAT_FBDC_U8U8U8U8
		|| pEx->src2_format == SEINFO_EXT_COLOR_FORMAT_FBDC_U8U8U8U8)) {
		se_ext_conv.Word1.rslt_argb_order = ARGBENDIAN; //ABGR
	} else {
	...
	if (pEx->src1_format == SEINFO_EXT_COLOR_FORMAT_FBDC_U8U8U8U8) {
		se_ext_conv.Word6.src1_tfbdc_lossy = 0;
	}
...
//-------------------------------------------------------------
	...
	if (pEx->result_format == SEINFO_EXT_COLOR_FORMAT_ARGB8888
		&& (pEx->src1_format == SEINFO_EXT_COLOR_FORMAT_FBDC_U8U8U8U8
		|| pEx->src2_format == SEINFO_EXT_COLOR_FORMAT_FBDC_U8U8U8U8)) {
		se_ext_conv.Word1.rslt_argb_order = ARGBENDIAN;//5; //ABGR
	} else {
		se_ext_conv.Word1.rslt_argb_order = ARGBENDIAN; //FPGA-->BGRA
	}
...
)
{
	...
	se_ext_stch.WordReg4.RegisterAddress = (SEINFO_WRITEREG)SE20INFO_REG_STRETCH;
	se_ext_stch.WordReg4_1.RegisterValue = dwScalingSetting;
	// printk("[%s] dwScalingSetting = 0x%08x\n", "DEBUG", dwScalingSetting);
...

	{
		...
		for(i=0; i<(sizeof(SECMD_PQMASK_EXT_STCH_BLIT)/8); i++) {
			...
			if (((temp&0xf) == SEINFO_OPCODE_NOP) && (i<20))
				continue;
			if (i < 12)
				printk("SE_Reg, WordReg%d[0xB800C%3x]=%x,\n", i+1, ((temp&0xfff0)>>4), temp_1);
			else if (i == 12)
				printk("SE_Reg, WordAddr0[0xB800C%3x]=%x,\n", ((temp&0xfff0)>>4), temp_1);
			else if (i == 13)
				printk("SE_Reg, WordPitch0[0xB800C%3x]=%x,\n", ((temp&0xfff0)>>4), temp_1);
			else if (i == 14)
				printk("SE_Reg, WordAddr1[0xB800C%3x]=%x,\n", ((temp&0xfff0)>>4), temp_1);
			else if (i == 15)
				printk("SE_Reg, WordPitch1[0xB800C%3x]=%x,\n", ((temp&0xfff0)>>4), temp_1);
			else if (i == 16)
				printk("SE_Reg, WordAddr2[0xB800C%3x]=%x,\n", ((temp&0xfff0)>>4), temp_1);
			else if (i == 17)
				printk("SE_Reg, WordPitch2[0xB800C%3x]=%x,\n", ((temp&0xfff0)>>4), temp_1);
			else if (i == 18)
				printk("SE_Reg, WordAddr3[0xB800C%3x]=%x,\n", ((temp&0xfff0)>>4), temp_1);
			else if (i == 19)
				printk("SE_Reg, WordPitch3[0xB800C%3x]=%x,\n", ((temp&0xfff0)>>4), temp_1);
			else {
				printk("SE_Reg, Word%d=%x,\n", (i-19)*2-1, temp);
				printk("SE_Reg, Word%d=%x,\n", (i-19)*2, temp_1);
			}
		}
	}
