...
typedef enum _SEINFO_WRITEREG
{
	...
	SE20INFO_REG_LIMIT_STA = 0xF04,
	SE20INFO_REG_LIMIT_END = 0xF10,
	SE20INFO_REG_LIMIT_SWAP = 0xF18,
	SE20INFO_REG_LIMIT_EN = 0xF30,
} SEINFO_WRITEREG;
#else
...
typedef enum _SEINFO_EXT_COLOR_FORMAT_T
{
	...
	SEINFO_EXT_COLOR_FORMAT_NV12_420_Y = 0x12,
	SEINFO_EXT_COLOR_FORMAT_NV12_420_CbCr = 0x13,
...
typedef struct _SE_BLEND_EX_T
{
	...
	uint8_t constAplhaValue;
	uint32_t constColorValue;
	uint8_t constAlphaValueForBlendColorAlpha;
	uint32_t constSrcColorKeyValue;
	uint32_t constDstColorKeyValue;
	...
	uint32_t srcColorRed;
	uint32_t srcColorGreen;
	uint32_t srcColorBlue;
	uint32_t srcColorAlpha;
...
bool SE_Set_mem(uint32_t i8ddr);
