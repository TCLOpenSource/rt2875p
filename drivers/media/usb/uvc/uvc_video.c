...
bool g_ehci_right_settings = false;
bool is_ehci_right_setting(void) {return g_ehci_right_settings;};
/* ------------------------------------------------------------------------
 * UVC Controls
 */
				    ...
				    gfp_t gfp_flags)
{
	...
	if (intf->num_altsetting > 1) {
        ...
        /*****if not ehci port, go the old flow**/
        if(udev->bus->busnum != 3 || is_ehci_right_setting()) {
