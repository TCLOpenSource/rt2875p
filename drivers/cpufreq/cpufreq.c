...
cpufreq_freq_attr_ro_perm(cpuinfo_min_freq, 0440);
cpufreq_freq_attr_ro_perm(cpuinfo_max_freq, 0440);
cpufreq_freq_attr_ro(cpuinfo_transition_latency);
cpufreq_freq_attr_ro_perm(scaling_available_governors, 0440);
cpufreq_freq_attr_ro(scaling_driver);
cpufreq_freq_attr_ro_perm(scaling_cur_freq, 0440);
cpufreq_freq_attr_ro(bios_limit);
cpufreq_freq_attr_ro(related_cpus);
cpufreq_freq_attr_ro(affected_cpus);
cpufreq_freq_attr_ro_perm(scaling_min_freq, 0640);
cpufreq_freq_attr_ro_perm(scaling_max_freq, 0640);
